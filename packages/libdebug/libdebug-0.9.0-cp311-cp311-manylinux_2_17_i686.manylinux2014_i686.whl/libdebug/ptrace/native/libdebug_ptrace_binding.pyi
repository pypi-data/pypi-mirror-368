...
class PtraceRegsStruct:
    ...
    @ebx.setter
    def ebx(self, arg: int, /) -> None: ...

    @property
    def ecx(self) -> int: ...

    @ecx.setter
    def ecx(self, arg: int, /) -> None: ...

    @property
    def edx(self) -> int: ...

    @edx.setter
    def edx(self, arg: int, /) -> None: ...

    @property
    def esi(self) -> int: ...

    @esi.setter
    def esi(self, arg: int, /) -> None: ...

    @property
    def edi(self) -> int: ...

    @edi.setter
    def edi(self, arg: int, /) -> None: ...

    @property
    def ebp(self) -> int: ...

    @ebp.setter
    def ebp(self, arg: int, /) -> None: ...

    @property
    def eax(self) -> int: ...

    @eax.setter
    def eax(self, arg: int, /) -> None: ...
    ...
    @property
    def orig_eax(self) -> int: ...

    @orig_eax.setter
    def orig_eax(self, arg: int, /) -> None: ...

    @property
    def eip(self) -> int: ...

    @eip.setter
    def eip(self, arg: int, /) -> None: ...
