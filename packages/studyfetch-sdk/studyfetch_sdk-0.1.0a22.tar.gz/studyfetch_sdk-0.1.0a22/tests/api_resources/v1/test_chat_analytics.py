...
class TestChatAnalytics:
    ...
    def test_method_analyze(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(ChatAnalyticAnalyzeResponse, chat_analytic, path=["response"])
    ...
    def test_method_get_component(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(ChatAnalyticGetComponentResponse, chat_analytic, path=["response"])
