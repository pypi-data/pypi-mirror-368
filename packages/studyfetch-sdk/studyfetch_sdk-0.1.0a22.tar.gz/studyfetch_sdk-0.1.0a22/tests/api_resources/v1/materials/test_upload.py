...
class TestUpload:
    ...
    def test_method_complete_upload(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(UploadCompleteUploadResponse, upload, path=["response"])
    ...
    def test_method_upload_file(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(UploadUploadFileResponse, upload, path=["response"])
    ...
    def test_method_upload_file_and_process(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(UploadUploadFileAndProcessResponse, upload, path=["response"])
    ...
    def test_method_upload_from_url(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(UploadUploadFromURLResponse, upload, path=["response"])
    ...
    def test_method_upload_from_url_and_process(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(UploadUploadFromURLAndProcessResponse, upload, path=["response"])
