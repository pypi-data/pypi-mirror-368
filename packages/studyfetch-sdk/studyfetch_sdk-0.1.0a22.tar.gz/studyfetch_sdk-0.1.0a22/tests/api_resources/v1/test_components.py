...
class TestComponents:
    ...
    def test_method_create(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(ComponentCreateResponse, component, path=["response"])
    ...
    def test_method_retrieve(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(ComponentRetrieveResponse, component, path=["response"])
    ...
    def test_method_update(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(ComponentUpdateResponse, component, path=["response"])
