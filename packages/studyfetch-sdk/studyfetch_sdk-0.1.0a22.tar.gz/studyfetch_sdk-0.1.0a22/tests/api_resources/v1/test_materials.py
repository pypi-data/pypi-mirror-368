...
class TestMaterials:
    ...
    def test_method_create(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(MaterialCreateResponse, material, path=["response"])
    ...
    def test_method_retrieve(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(MaterialRetrieveResponse, material, path=["response"])
    ...
    def test_method_create_and_process(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(MaterialCreateAndProcessResponse, material, path=["response"])
    ...
    def test_method_generate(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(MaterialGenerateResponse, material, path=["response"])
    ...
    def test_method_generate_and_process(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(MaterialGenerateAndProcessResponse, material, path=["response"])
    ...
    def test_method_move(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(MaterialMoveResponse, material, path=["response"])
    ...
    def test_method_rename(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(MaterialRenameResponse, material, path=["response"])
    ...
    def test_method_reprocess(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(MaterialReprocessResponse, material, path=["response"])
