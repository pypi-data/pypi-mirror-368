...
class TestRubricTemplates:
    ...
    def test_method_create(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(RubricTemplateCreateResponse, rubric_template, path=["response"])
    ...
    def test_method_get_by_id(self, client: StudyfetchSDK) -> None:
        ...
        assert_matches_type(RubricTemplateGetByIDResponse, rubric_template, path=["response"])
