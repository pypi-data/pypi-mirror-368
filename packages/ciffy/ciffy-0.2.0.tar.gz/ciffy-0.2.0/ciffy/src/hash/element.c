...
/* Command-line: gperf element.gperf  */
...
#line 5 "element.gperf"

#include "lookup.h"
#line 8 "element.gperf"
struct _LOOKUP;

#define ELEMENTTOTAL_KEYWORDS 6
#define ELEMENTMIN_WORD_LENGTH 1
#define ELEMENTMAX_WORD_LENGTH 1
#define ELEMENTMIN_HASH_VALUE 0
#define ELEMENTMAX_HASH_VALUE 7
...
#pragma GCC diagnostic ignored "-Wmissing-field-initializers"
  ...
  static struct _LOOKUP wordlist[] =
    {
#line 15 "element.gperf"
      {"S", 16},
#line 11 "element.gperf"
      {"C", 6},
#line 13 "element.gperf"
      {"O", 8},
      {""},
#line 10 "element.gperf"
      {"H", 1},
#line 14 "element.gperf"
      {"P", 15},
      {""},
#line 12 "element.gperf"
      {"N", 7}
    };
#if (defined __GNUC__ && __GNUC__ + (__GNUC_MINOR__ >= 6) > 4) || (defined __clang__ && __clang_major__ >= 3)
