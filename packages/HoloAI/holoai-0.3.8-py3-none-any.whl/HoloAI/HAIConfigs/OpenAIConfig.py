...
class OpenAIConfig(BaseConfig):
    ...
    def _setModels(self):
        self.RModel = os.getenv("OPENAI_RESPONSE_MODEL", "gpt-4.1-mini")
    ...
    def Response(self, **kwargs) -> str:
        ...
        # Now use params["model"], params["system"], etc.
        messages = []
        ...
        response = self._endPoint(**args)# self.client.responses.create(**args)
    ...
    def processSkills(self, instructions, user, tokens) -> str:
        ...
        response = self._endPoint(**args)# self.client.responses.create(**args).output_text
