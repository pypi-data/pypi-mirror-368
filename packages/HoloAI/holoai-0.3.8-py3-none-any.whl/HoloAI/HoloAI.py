...
class HoloAI:
    ...
    def HoloCompletion(self, **kwargs):
        ...
        :param kwargs: Keyword arguments to customize the request.
            ...
            - tools: (list) Tools to use (Optional) [skills, actions].
            - toolCoice/tool_choice: (str) Controls model tool-calling behavior.
                Valid values:
    ...
    def HoloAgent(self, **kwargs):
        # - skills: (list) Skills to use (Optional) [skills, actions].
        """
