...
def _start_interactive_mode(agent: SingleAgent, config: AgentConfig, session_id: str = None):
    ...
    if RICH_AVAILABLE:
        ...
        help_table.add_row("  [cyan]> Create a Python web app with FastAPI[/cyan]")
        help_table.add_row("  [cyan]> Analyze the code in this project[/cyan]")
        help_table.add_row("  [cyan]> Search for information about quantum computing[/cyan]")
        help_table.add_row("  [cyan]> Help me debug this error[/cyan]")
        help_table.add_row("")
...
def _stream_text_response(text: str, console):
    """Stream text response word by word like Claude Code."""
    import re
