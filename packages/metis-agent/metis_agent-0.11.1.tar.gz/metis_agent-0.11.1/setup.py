...
setup(
    ...
    description="A comprehensive framework for building powerful AI agents with enhanced developer experience, featuring intelligent TODO checklist system, fast/stream operation modes, smart confirmation system, progressive disclosure interface, Graph-Enhanced Knowledge Base system with relationship intelligence, local model support (HuggingFace/Ollama), autonomous capability expansion, and advanced memory management",
