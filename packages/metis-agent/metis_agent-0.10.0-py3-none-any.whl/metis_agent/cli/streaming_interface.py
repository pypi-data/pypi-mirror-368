...
class GeminiStreamingInterface:
    ...
    def start_session(self):
        ...
        if self.operation_mode == 'fast':
            click.echo(click.style("⚡ [FAST MODE] Metis Session", fg="green", bold=True))
        elif self.operation_mode == 'stream':
            click.echo(click.style("🌊 [STREAMING MODE] Metis Session", fg="blue", bold=True))
        else:
        ...
        if self.operation_mode == 'fast':
            click.echo(click.style("Fast mode: Minimal prompts, direct execution", fg="dim"))
        elif self.operation_mode == 'stream':
            click.echo(click.style("Streaming mode: Full interface, detailed progress", fg="dim"))
...
"""
    ...
    def _handle_slash_command(self, command: str):
        ...
        if cmd_name == 'help':
            ...
            click.echo(click.style("Type /help to see available commands.", fg="dim"))
