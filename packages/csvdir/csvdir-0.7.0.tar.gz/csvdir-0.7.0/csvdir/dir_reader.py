...
class CsvDir:
    ...
    def _iter_file(self, p: str) -> Iterator[Dict[str, str]]:
        # Header read + (optional) strict/expected checks
    ...
    # Iterator helpers
    def with_paths(self) -> Iterator[Tuple[str, Dict[str, str]]]:
        from .iterators import IterPathCsvDir
        return iter(IterPathCsvDir(
            self.path,
    ...
    def enumerate(self) -> Iterator[Tuple[str, Dict[str, str]]]:
        from .iterators import IterEnumCsvDir
        return iter(IterEnumCsvDir(
            self.path,
            extension=self.extension,
            delimiter=self.delimiter,
            encoding=self.encoding,
    ...
    def with_names(self) -> Iterator[Tuple[str, Dict[str, str]]]:
