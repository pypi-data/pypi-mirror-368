...
@register_op
def no_grad(input, *args, **kwargs):
    return torch.no_grad(input, *args, **kwargs)
...
@register_op
def floor_divide(input, *args, **kwargs):
    return torch.floor_divide(input, *args, **kwargs)
...
@register_op
def Pow(input, *args, **kwargs):
    return torch.pow(input, *args, **kwargs)
