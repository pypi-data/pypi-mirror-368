...
if __name__ == '__main__':
    ...
    circuit.generate_kicad_project(project_name="ESP32_C6_Dev_Board_reference_generated")
    # Generate KiCad netlist (required for ratsnest display)
    circuit.generate_kicad_netlist("ESP32_C6_Dev_Board_reference_generated/ESP32_C6_Dev_Board_reference_generated.net")