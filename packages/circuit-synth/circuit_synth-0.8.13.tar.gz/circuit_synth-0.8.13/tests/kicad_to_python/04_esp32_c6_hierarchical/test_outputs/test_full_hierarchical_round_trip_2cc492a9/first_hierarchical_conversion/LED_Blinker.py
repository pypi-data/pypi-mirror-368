...
def led_blinker(gnd, led_control):
    ...
    # Create components
    d3 = Component(symbol="Device:LED", ref="D3", value="~", footprint="LED_SMD:LED_0805_2012Metric")
    r3 = Component(symbol="Device:R", ref="R3", value="330", footprint="Resistor_SMD:R_0805_2012Metric")
