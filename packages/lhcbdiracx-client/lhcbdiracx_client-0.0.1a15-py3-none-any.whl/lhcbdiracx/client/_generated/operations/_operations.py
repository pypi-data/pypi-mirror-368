...
def build_well_known_get_security_txt_request(
    **kwargs: Any,
) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_bookkeeping_dump_paths_request(**kwargs: Any) -> HttpRequest:
    # Construct URL
    _url = "/api/bookkeeping/dump-paths"

    return HttpRequest(method="GET", url=_url, **kwargs)


def build_bookkeeping_search_datasets_request(  # pylint: disable=name-too-long
    *, page: int = 1, per_page: int = 100, **kwargs: Any
    ...
    # Construct URL
    _url = "/api/bookkeeping/datasets/search"
...
def build_bookkeeping_summary_datasets_request(
    **kwargs: Any,
) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/api/bookkeeping/datasets/summary"
...
def build_bookkeeping_search_files_request(
    *, page: int = 1, per_page: int = 100, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/api/bookkeeping/datasets/files/search"
...
def build_bookkeeping_summary_files_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/api/bookkeeping/datasets/files/summary"
...
def build_jobs_unassign_bulk_jobs_sandboxes_request(
    **kwargs: Any,
) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_jobs_reschedule_jobs_request(
    *, reset_jobs: bool = False, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class BookkeepingOperations:
    ...
    def dump_paths(
        ...
        _request = build_bookkeeping_dump_paths_request(
            headers=_headers,
            params=_params,
        )
        _request.url = self._client.format_url(_request.url)
    ...
    def search_datasets(
        self,
        body: Optional[_models.BKSearchParams] = None,
        *,
        page: int = 1,
        per_page: int = 100,
        ...
        **TODO: Add more docs**.
        ...
        :type body: ~_generated.models.BKSearchParams
    ...
    def search_datasets(
        self,
        body: Optional[Union[_models.BKSearchParams, IO[bytes]]] = None,
        *,
        page: int = 1,
        per_page: int = 100,
        **kwargs: Any,
        ...
        **TODO: Add more docs**.
        ...
        :param body: Is either a BKSearchParams type or a IO[bytes] type. Default value is None.
        :type body: ~_generated.models.BKSearchParams or IO[bytes]
        :keyword page: Default value is 1.
        :paramtype page: int
        :keyword per_page: Default value is 100.
        :paramtype per_page: int
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            if body is not None:
                _json = self._serialize.body(body, "BKSearchParams")
            else:
                _json = None

        _request = build_bookkeeping_search_datasets_request(
            page=page,
            per_page=per_page,
    ...
    def summary_datasets(
        ...
        **kwargs: Any,
        ...
        :param body: Required.
        :type body: ~_generated.models.BKSummaryParams
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: any
    ...
    @distributed_trace
    def summary_datasets(
        self, body: Union[_models.BKSummaryParams, IO[bytes]], **kwargs: Any
    ) -> Any:
        """Summary Datasets.

        Show information suitable for plotting.

        :param body: Is either a BKSummaryParams type or a IO[bytes] type. Required.
        :type body: ~_generated.models.BKSummaryParams or IO[bytes]
        :return: any
        :rtype: any
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = self._serialize.body(body, "BKSummaryParams")

        _request = build_bookkeeping_summary_datasets_request(
            content_type=content_type,
            json=_json,
            content=_content,
            headers=_headers,
    ...
    def search_files(
        ...
        **TODO: Add more docs**.
        ...
        _request = build_bookkeeping_search_files_request(
            page=page,
            per_page=per_page,
            content_type=content_type,
            json=_json,
    ...
    def summary_files(
        ...
        _request = build_bookkeeping_summary_files_request(
            content_type=content_type,
            json=_json,
            content=_content,
            headers=_headers,
...
class JobsOperations:
    ...
    def unassign_bulk_jobs_sandboxes(
        self,
        body: _models.BodyJobsUnassignBulkJobsSandboxes,
        *,
        content_type: str = "application/json",
        **kwargs: Any,
    ) -> None:
    ...
    def unassign_bulk_jobs_sandboxes(  # pylint: disable=inconsistent-return-statements
        self,
        body: Union[_models.BodyJobsUnassignBulkJobsSandboxes, IO[bytes]],
        **kwargs: Any,
    ) -> None:
        """Unassign Bulk Jobs Sandboxes.
    ...
    def reschedule_jobs(
        self,
        body: Union[_models.BodyJobsRescheduleJobs, IO[bytes]],
        *,
        reset_jobs: bool = False,
        **kwargs: Any,
    ) -> Dict[str, Any]:
    ...
    def patch_metadata(
        self,
        body: Dict[str, _models.JobMetaData],
        *,
        content_type: str = "application/json",
        **kwargs: Any,
    ) -> None:
    ...
    @distributed_trace
    def summary(
        self, body: Union[_models.SummaryParams, IO[bytes]], **kwargs: Any
    ) -> Any:
        """Summary.
