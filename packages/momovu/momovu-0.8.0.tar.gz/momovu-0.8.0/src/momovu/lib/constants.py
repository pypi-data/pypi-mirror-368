...
# Zoom factors
# Standard zoom increments used in most document viewers
ZOOM_IN_FACTOR: Final[float] = (
    1.25  # 25% increase - matches common zoom steps (125%, 150%, etc.)
)
ZOOM_OUT_FACTOR: Final[float] = 0.8  # 20% decrease - inverse of zoom in (1/1.25)
