...
class ZoomController(QObject):
    ...
    def zoom_in(self) -> None:
        """Increase zoom level by the standard zoom factor (1.2x)."""
    ...
    def zoom_out(self) -> None:
        """Decrease zoom level by the standard zoom factor (0.8x)."""
    ...
    def _calculate_side_by_side_pages(
        ...
        if current_page % 2 == 0:
            ...
            if (
                document_presenter
                and current_page + 1 < document_presenter.get_page_count()
            ):
