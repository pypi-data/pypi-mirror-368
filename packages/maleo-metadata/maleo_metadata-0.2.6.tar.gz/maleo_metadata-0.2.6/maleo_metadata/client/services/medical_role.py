...
from maleo_metadata.client.controllers import MaleoMetadataMedicalRoleControllers
from maleo_metadata.enums.general import ClientControllerType
from maleo_metadata.constants.medical_role import RESOURCE
...
from maleo_metadata.schemas.parameter.general.medical_role import ReadSingleParameter
...
class MaleoMetadataMedicalRoleClientService(MaleoClientService):
    ...
    def __init__(
        ...
        controllers: MaleoMetadataMedicalRoleControllers,
    ):
        super().__init__(
            environment,
            key,
    ...
    async def read_medical_roles(
        ...
        if result_str is not None:
            ...
            ReadMultipleResourceOperationSchema[
                ...
                summary="Successfully retrieved multiple medical roles",
        ...
        if controller_type is ClientControllerType.HTTP:
            response = await self._controllers.http.read_medical_roles(
    ...
    async def read_medical_roles_specializations(
        ...
        if result_str is not None:
            ...
            ReadMultipleResourceOperationSchema[
                ...
                summary="Successfully retrieved multiple root medical roles specializations",
                request_context=request_context,
                authentication=authentication,
                action=operation_action,
                resource=self._resource,
        ...
        # Retrieve medical roles using chosen controller
        if controller_type is ClientControllerType.HTTP:
            response = await self._controllers.http.read_medical_roles_specializations(
                operation_id=operation_id,
                authentication=authentication,
                parameters=parameters,
                authorization=authorization,
    ...
    async def read_medical_role(
        ...
        if result_str is not None:
            ...
            ReadSingleResourceOperationSchema[MedicalRoleDataSchema, None](
                ...
                summary="Successfully retrieved single medical role",
                request_context=request_context,
                authentication=authentication,
                action=operation_action,
                resource=self._resource,
        ...
        # Retrieve medical roles using chosen controller
        if controller_type is ClientControllerType.HTTP:
            response = await self._controllers.http.read_medical_role(
                operation_id=operation_id,
                authentication=authentication,
                parameters=parameters,
                authorization=authorization,
            ...
            if response.is_success:
                ...
                result = ReadSingleResourceOperationResult[MedicalRoleDataSchema, None](
                    data=data,
                    pagination=validated_response.pagination,
                    metadata=None,
                    other=None,
                ...
                ReadSingleResourceOperationSchema[MedicalRoleDataSchema, None](
                    ...
                    summary="Successfully retrieved single medical roles",
                    request_context=request_context,
                    authentication=authentication,
                    action=operation_action,
                    resource=self._resource,
    ...
    async def read_medical_role_specializations(
        ...
        if result_str is not None:
            ...
            ReadMultipleResourceOperationSchema[
                ...
                summary="Successfully retrieved multiple medical role specializations",
                request_context=request_context,
                authentication=authentication,
                action=operation_action,
                resource=self._resource,
        ...
        # Retrieve medical roles using chosen controller
        if controller_type is ClientControllerType.HTTP:
            response = await self._controllers.http.read_medical_role_specializations(
                operation_id=operation_id,
                authentication=authentication,
                parameters=parameters,
                authorization=authorization,
