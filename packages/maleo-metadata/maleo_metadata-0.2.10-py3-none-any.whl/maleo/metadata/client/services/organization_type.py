...
from maleo.metadata.client.controllers import MaleoMetadataOrganizationTypeControllers
    ...
    async def read_organization_types(
        ...
        if result_str is not None:
            ...
            ReadMultipleResourceOperationSchema[
                ...
                summary="Successfully retrieved multiple organization types",
        ...
        if controller_type is ClientControllerType.HTTP:
            response = await self._controllers.http.read_organization_types(
    ...
    async def read_organization_type(
        ...
        if result_str is not None:
            ...
            ReadSingleResourceOperationSchema[OrganizationTypeDataSchema, None](
                ...
                summary="Successfully retrieved single organization type",
                request_context=request_context,
                authentication=authentication,
                action=operation_action,
                resource=self._resource,
        ...
        # Retrieve organization types using chosen controller
        if controller_type is ClientControllerType.HTTP:
            response = await self._controllers.http.read_organization_type(
                operation_id=operation_id,
                authentication=authentication,
                parameters=parameters,
                authorization=authorization,
            ...
            if response.is_success:
                ...
                ReadSingleResourceOperationSchema[OrganizationTypeDataSchema, None](
                    ...
                    summary="Successfully retrieved single organization types",
                    request_context=request_context,
                    authentication=authentication,
                    action=operation_action,
                    resource=self._resource,
