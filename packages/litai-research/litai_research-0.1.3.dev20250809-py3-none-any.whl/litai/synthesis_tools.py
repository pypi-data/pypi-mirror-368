        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "depth": {
                        "type": "string",
                        "enum": ["abstracts", "key_points", "notes", "agent_notes", "sections", "full_text"],
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "paper_id": {
                        "type": "string",
                        "description": "ID of the paper to add notes to",
                    },
                    "content": {
                        "type": "string",
            ...
            if "tool_calls" in response and response["tool_calls"]:
                ...
                with Live(refresh_per_second=10) as live:
                    ...
                    def build_display() -> Text:
                        ...
                        for idx, status_info in tool_statuses.items():
                            if status_info["status"] == "running":
                                display.append("⚡ ", style="bold yellow blink")
                            ...
                            if hasattr(status_info, 'args') and status_info.get('args'):
                                args_str = str(status_info['args'])
                                if len(args_str) > 40:
                                    args_str = args_str[:37] + "..."
                                display.append(f" ({args_str})", style="dim")
                    ...
                    for i, tool_call in enumerate(response["tool_calls"]):
                        ...
                        if tool_call.id in approved_by_id:
                            ...
                            # Initialize status
                            tool_statuses[i] = {"name": approved_call.name, "status": "pending", "args": approved_call.arguments}
