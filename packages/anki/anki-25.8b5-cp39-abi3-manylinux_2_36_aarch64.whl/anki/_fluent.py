...
not work correctly if one of your clients is older. '''
    ...
    def deck_config_fsrs_simulator_ratio_tooltip(self, time: str) -> str:
        ...
        return self._translate(11, 91, {"time": time})
...
this option. '''
    ...
    def deck_config_ignore_before_info(self, included: str, total_cards: str) -> str:
        ...
        return self._translate(11, 106, {"included": included, "totalCards": total_cards})
...
the manual before changing this option. '''
    ...
    def deck_config_iterations(self, count: int) -> str:
        r''' Iteration: {$count}... '''
        return self._translate(11, 114, {"count": count})
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_400_reviews(self, count: int) -> str:
        ...
        return self._translate(11, 128, {"count": count})
...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_optimizing_preset(self, current_count: int, total_count: int) -> str:
        ...
        return self._translate(11, 154, {"current_count": current_count, "total_count": total_count})
    ...
    def deck_config_percent_input(self, pct: str) -> str:
        r''' {$pct}% '''
        return self._translate(11, 156, {"pct": pct})


    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        r''' {$pct}% of {$reviews} reviews '''
        return self._translate(11, 157, {"reviews": reviews, "pct": pct})
    ...
    def deck_config_predicted_minimum_recommended_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 160, {"num": num})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 181, {"cards": cards, "expected": expected})
...
taking to study each card. '''
    ...
    def deck_config_slow_suffix(self, text: str) -> str:
        r''' {$text} (slow) '''
        return self._translate(11, 198, {"text": text})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 229, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 230, {"decks": decks})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_FSRS_SIMULATOR_EXPERIMENTAL = (11, 87)
    DECK_CONFIG_FSRS_SIMULATOR_RADIO_COUNT = (11, 88)
    DECK_CONFIG_FSRS_SIMULATOR_RADIO_MEMORIZED = (11, 89)
    DECK_CONFIG_FSRS_SIMULATOR_RADIO_RATIO = (11, 90)
    DECK_CONFIG_FSRS_SIMULATOR_RATIO_TOOLTIP = (11, 91)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_COUNT = (11, 92)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_MEMORIZED = (11, 93)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_TIME = (11, 94)
    DECK_CONFIG_FSRS_TOOLTIP = (11, 95)
    DECK_CONFIG_GET_PARAMS = (11, 96)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 97)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 98)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 99)
    DECK_CONFIG_HEALTH_CHECK = (11, 100)
    DECK_CONFIG_HEALTH_CHECK_TOOLTIP1 = (11, 101)
    DECK_CONFIG_HEALTH_CHECK_TOOLTIP2 = (11, 102)
    DECK_CONFIG_HISTORICAL_RETENTION = (11, 103)
    DECK_CONFIG_HISTORICAL_RETENTION_TOOLTIP = (11, 104)
    DECK_CONFIG_IGNORE_BEFORE = (11, 105)
    DECK_CONFIG_IGNORE_BEFORE_INFO = (11, 106)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP = (11, 107)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP_2 = (11, 108)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 109)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 110)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 111)
    DECK_CONFIG_INVALID_PARAMETERS = (11, 112)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 113)
    DECK_CONFIG_ITERATIONS = (11, 114)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 115)
    DECK_CONFIG_LEARNING_STEPS = (11, 116)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 117)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 118)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 119)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 120)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 121)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 122)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 123)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 124)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 125)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 126)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 127)
    DECK_CONFIG_MUST_HAVE_400_REVIEWS = (11, 128)
    DECK_CONFIG_NAME_PROMPT = (11, 129)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 130)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 131)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 132)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 133)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 134)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 135)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 136)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 137)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 138)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 139)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 140)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 141)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 142)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 143)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 144)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 145)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 146)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 147)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 148)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 149)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 150)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 151)
    DECK_CONFIG_OPTIMIZE_ALL_TIP = (11, 152)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 153)
    DECK_CONFIG_OPTIMIZING_PRESET = (11, 154)
    DECK_CONFIG_ORDERING_TITLE = (11, 155)
    DECK_CONFIG_PERCENT_INPUT = (11, 156)
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 157)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 158)
    DECK_CONFIG_PLOTTED_ON_X_AXIS = (11, 159)
    DECK_CONFIG_PREDICTED_MINIMUM_RECOMMENDED_RETENTION = (11, 160)
    DECK_CONFIG_PREDICTED_OPTIMAL_RETENTION = (11, 161)
    DECK_CONFIG_QUESTION_ACTION = (11, 162)
    DECK_CONFIG_QUESTION_ACTION_SHOW_ANSWER = (11, 163)
    DECK_CONFIG_QUESTION_ACTION_SHOW_REMINDER = (11, 164)
    DECK_CONFIG_QUESTION_ACTION_TOOL_TIP = (11, 165)
    DECK_CONFIG_RELEARNING_STEPS = (11, 166)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 167)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 168)
    DECK_CONFIG_REMOVE_GROUP = (11, 169)
    DECK_CONFIG_RENAME_GROUP = (11, 170)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 171)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 172)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 173)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 174)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 175)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 176)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 177)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 178)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 179)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 180)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 181)
    DECK_CONFIG_SAVE_AND_OPTIMIZE = (11, 182)
    DECK_CONFIG_SAVE_BUTTON = (11, 183)
    DECK_CONFIG_SAVE_OPTIONS_TO_PRESET = (11, 184)
    DECK_CONFIG_SAVE_OPTIONS_TO_PRESET_CONFIRM = (11, 185)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 186)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 187)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP_2 = (11, 188)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 189)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP = (11, 190)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_2 = (11, 191)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_3 = (11, 192)
    DECK_CONFIG_SHARED_PRESET = (11, 193)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 194)
    DECK_CONFIG_SHOW_REMINDER = (11, 195)
    DECK_CONFIG_SIMULATE = (11, 196)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 197)
    DECK_CONFIG_SLOW_SUFFIX = (11, 198)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 199)
    DECK_CONFIG_SMOOTH_GRAPH = (11, 200)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 201)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 202)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 203)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 204)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 205)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 206)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 207)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 208)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 209)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 210)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 211)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 212)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 213)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_ASCENDING = (11, 214)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_DESCENDING = (11, 215)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 216)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 217)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 218)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 219)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 220)
    DECK_CONFIG_SUSPEND_LEECHES = (11, 221)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 222)
    DECK_CONFIG_TIME_TO_OPTIMIZE = (11, 223)
    DECK_CONFIG_TIMER_TITLE = (11, 224)
    DECK_CONFIG_TITLE = (11, 225)
    DECK_CONFIG_TODAY_ONLY = (11, 226)
    DECK_CONFIG_TOO_SHORT_MAXIMUM_INTERVAL = (11, 227)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 228)
    DECK_CONFIG_UPDATING_CARDS = (11, 229)
    DECK_CONFIG_USED_BY_DECKS = (11, 230)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 231)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 232)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP_2 = (11, 233)
    DECK_CONFIG_WEIGHTS = (11, 234)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 235)
    DECK_CONFIG_WEIGHTS_TOOLTIP2 = (11, 236)
    DECK_CONFIG_WHICH_DECK = (11, 237)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 238)
    DECK_CONFIG_WORKLOAD_FACTOR_CHANGE = (11, 239)
    DECK_CONFIG_WORKLOAD_FACTOR_UNCHANGED = (11, 240)
