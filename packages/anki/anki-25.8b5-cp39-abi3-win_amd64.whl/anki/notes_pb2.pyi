...
class NoteId(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["nid", b"nid"]) -> None: ...
...
class NoteIds(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["note_ids", b"note_ids"]) -> None: ...
...
class Note(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["fields", b"fields", "guid", b"guid", "id", b"id", "mtime_secs", b"mtime_secs", "notetype_id", b"notetype_id", "tags", b"tags", "usn", b"usn"]) -> None: ...
...
class AddNoteRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["deck_id", b"deck_id", "note", b"note"]) -> None: ...
...
class AddNoteResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["changes", b"changes", "note_id", b"note_id"]) -> None: ...
...
class AddNotesResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["changes", b"changes"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["changes", b"changes", "nids", b"nids"]) -> None: ...
...
class UpdateNotesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["notes", b"notes", "skip_undo_entry", b"skip_undo_entry"]) -> None: ...
...
class DefaultsForAddingRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["home_deck_of_current_review_card", b"home_deck_of_current_review_card"]) -> None: ...
...
class DeckAndNotetype(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["deck_id", b"deck_id", "notetype_id", b"notetype_id"]) -> None: ...
...
class RemoveNotesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["card_ids", b"card_ids", "note_ids", b"note_ids"]) -> None: ...
...
class ClozeNumbersInNoteResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["numbers", b"numbers"]) -> None: ...
...
class AfterNoteUpdatesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["generate_cards", b"generate_cards", "mark_notes_modified", b"mark_notes_modified", "nids", b"nids"]) -> None: ...
...
class FieldNamesForNotesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["nids", b"nids"]) -> None: ...
