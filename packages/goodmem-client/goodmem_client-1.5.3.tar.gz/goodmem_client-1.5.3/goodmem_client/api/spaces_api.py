...
class SpacesApi:
    ...
    def list_spaces(
        self,
        owner_id: Annotated[Optional[StrictStr], Field(description="Filter spaces by owner ID. If not provided, shows spaces based on permissions.")] = None,
        name_filter: Annotated[Optional[StrictStr], Field(description="Filter spaces by name using glob pattern matching")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="Maximum number of results to return in a single page")] = None,
        next_token: Annotated[Optional[StrictStr], Field(description="Pagination token for retrieving the next set of results")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="Field to sort by. Supported values: \"created_time\", \"name\", \"updated_time\"")] = None,
        ...
        :param owner_id: Filter spaces by owner ID. If not provided, shows spaces based on permissions.
        :type owner_id: str
        :param name_filter: Filter spaces by name using glob pattern matching
        :type name_filter: str
        :param max_results: Maximum number of results to return in a single page
        :type max_results: int
        :param next_token: Pagination token for retrieving the next set of results
        :type next_token: str
        :param sort_by: Field to sort by. Supported values: \"created_time\", \"name\", \"updated_time\"
        :type sort_by: str
