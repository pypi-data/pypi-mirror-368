...
class AmountService():
    ...
    def get_Local_IncomeSummary(self, driver, shop_data, options):
        '''
        @Desc    : 获取资金申报-收入概括（本土）
        @Author  : 洪润涛
        @Time    : 2024/08/09 16:02:48
        '''
        # 获取资金申报-收入概括
        incomeSummaryApi.income_summary(driver, options)

    def get_Local_ReadyGrant(self, driver, shop_data, options):
        '''
        @Desc    : 获取资金申报--准备发放账单（本土）
        @Author  : 洪润涛
        @Time    : 2024/08/09 16:02:48
        '''
        # 获取资金申报-准备发放账单
    ...
    def get_Local_WalletBalance(self, driver, shop_data, options):
        '''
        @Desc    : 获取资金申报--钱包余额（本土）
        @Author  : 洪润涛
        @Time    : 2024/08/09 16:02:48
