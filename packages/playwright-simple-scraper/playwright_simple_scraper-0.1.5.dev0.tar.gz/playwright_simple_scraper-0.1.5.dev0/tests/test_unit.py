import pytest
from playwright_simple_scraper.core import scrape_context
from playwright_simple_scraper.model import ScrapeResult
from playwright_simple_scraper import utils
