...
def wells_aquifer_mon(
    ...
    df_for_table = webapp_utils.prep_table_for_html(aqmon, query)
    df_for_table = df_for_table.set_index(index_cols)[aqmon_cols]
    table = webapp_utils.frame_to_html(df_for_table)
...
def wells_salinity(
    ...
    df_for_table = webapp_utils.prep_table_for_html(df3, query)
    table = webapp_utils.frame_to_html(df_for_table)
...
def wells_water_level(
    ...
    df_for_table = webapp_utils.prep_table_for_html(df3[cols].fillna(""), query)
    table = webapp_utils.frame_to_html(df_for_table)
