...
class CreditCardExpiryDate(BaseModel):
    """
    Schema: CreditCardExpiryDate
    """ # noqa: E501
    month: Optional[Annotated[int, Field(le=99, strict=True, ge=1)]] = Field(default=None, description="credit card expiration month 2 digit")
    year: Optional[Annotated[int, Field(le=9999, strict=True, ge=1)]] = Field(default=None, description="credit card expiration year 4 digit")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CreditCardExpiryDate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CreditCardExpiryDate from a dict"""
        if obj is None:
            return None
