...
if __name__ == '__main__':
    ...
    GenericProcessor.GenericFileProcessor(modifier_function=parseJson, default_values=defaultVal,
                                          filter_function=filterFun,
