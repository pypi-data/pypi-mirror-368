...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  omnicite process references.txt --output-format bibtex
  omnicite process references.bib --input-type bib --template conference_paper 
  omnicite process references.txt --interactive --output results.bib
        """
    )
    ...
    process_parser = subparsers.add_parser(
        'process',
        help='Process references through the OmniCite pipeline'
    )
...
def process_command(args) -> int:
    ...
    try:
        ...
        if args.quiet:
            ...
            for logger_name in ['omnicite', 'scholarly', 'httpx', 'fake_useragent']:
