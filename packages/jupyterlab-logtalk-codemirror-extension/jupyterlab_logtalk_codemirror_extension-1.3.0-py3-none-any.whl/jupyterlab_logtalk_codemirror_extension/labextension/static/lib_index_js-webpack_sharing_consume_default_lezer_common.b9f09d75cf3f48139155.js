"use strict";
(self["webpackChunkjupyterlab_logtalk_codemirror_extension"] = self["webpackChunkjupyterlab_logtalk_codemirror_extension"] || []).push([["lib_index_js-webpack_sharing_consume_default_lezer_common"],{
...
/* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @codemirror/language */ "webpack/sharing/consume/default/@codemirror/language");
/* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_codemirror_language__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @codemirror/view */ "webpack/sharing/consume/default/@codemirror/view");
/* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_codemirror_view__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @codemirror/state */ "webpack/sharing/consume/default/@codemirror/state");
/* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_codemirror_state__WEBPACK_IMPORTED_MODULE_8__);
...
function logtalkEnterHandler(view) {
    ...
    const currentIndentColumn = ((_b = (_a = line.text.match(/^(\t*)/)) === null || _a === void 0 ? void 0 : _a[1]) === null || _b === void 0 ? void 0 : _b.length) || 0;
...
const logtalkLanguage = {
    ...
    load: async () => {
        const streamLanguage = _codemirror_language__WEBPACK_IMPORTED_MODULE_5__.StreamLanguage.define(logtalkStreamParser);
        return new _codemirror_language__WEBPACK_IMPORTED_MODULE_5__.LanguageSupport(streamLanguage, [
            _codemirror_language__WEBPACK_IMPORTED_MODULE_5__.indentUnit.of('\t'),
            (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_5__.indentOnInput)(),
            (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_5__.foldGutter)(),
            (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_5__.codeFolding)(),
            _codemirror_language__WEBPACK_IMPORTED_MODULE_5__.foldService.of(logtalkFoldService),
            _codemirror_state__WEBPACK_IMPORTED_MODULE_8__.Prec.high(_codemirror_view__WEBPACK_IMPORTED_MODULE_6__.keymap.of([
...
const plugin = {
    ...
    autoStart: true,
    requires: [_jupyterlab_codemirror__WEBPACK_IMPORTED_MODULE_0__.IEditorLanguageRegistry, _jupyterlab_launcher__WEBPACK_IMPORTED_MODULE_2__.ILauncher, _jupyterlab_filebrowser__WEBPACK_IMPORTED_MODULE_3__.IFileBrowserFactory, _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ICommandPalette],
    activate: (app, languages, launcher, browserFactory, palette) => {
        ...
        const logtalkTextIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_4__.LabIcon({
        ...
        commands.addCommand(commandID, {
            ...
            execute: async () => {
                ...
                const model = await commands.execute('docmanager:new-untitled', {
                    path: (_a = browserFactory.tracker.currentWidget) === null || _a === void 0 ? void 0 : _a.model.path,
                    type: 'file',
                    ext: 'lgt'
                });
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_lezer_common.b9f09d75cf3f48139155.js.map