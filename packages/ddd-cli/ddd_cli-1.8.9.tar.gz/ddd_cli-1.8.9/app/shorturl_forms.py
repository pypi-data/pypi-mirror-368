...
class ShorturlBaseForm(forms.Form):
    """
    Formulario base para la entidad shorturl.
    """
...
class ShorturlCreateForm(ShorturlBaseForm):
    """
    Formulario para crear una nueva instancia de shorturl. Sin modificaciones adicionales.
    """
...
class ShorturlEditGetForm(ShorturlBaseForm):
    """
    Formulario para editar mediante GET una instancia de shorturl. 
    """
...
class ShorturlEditPostForm(ShorturlBaseForm):
    """
    Formulario para editar mediante POST una instancia de shorturl. 
    """
...
class ShorturlViewForm(ShorturlBaseForm):
    """
    Formulario de solo lectura para Visualizar una instancia de shorturl
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
