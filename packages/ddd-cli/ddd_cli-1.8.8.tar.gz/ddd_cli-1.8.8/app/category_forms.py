...
class CategoryBaseForm(forms.Form):
    """
    Formulario base para la entidad category.
    """
...
class CategoryCreateForm(CategoryBaseForm):
    """
    Formulario para crear una nueva instancia de category. Sin modificaciones adicionales.
    """
...
class CategoryEditGetForm(CategoryBaseForm):
    """
    Formulario para editar mediante GET una instancia de category. 
    """
...
class CategoryEditPostForm(CategoryBaseForm):
    """
    Formulario para editar mediante POST una instancia de category. 
    """
...
class CategoryViewForm(CategoryBaseForm):
    """
    Formulario de solo lectura para Visualizar una instancia de category
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
