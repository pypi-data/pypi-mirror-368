...
class ScraperApp(APIApplication):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # Handle case where integration is None (e.g., during README generation)
        if self.integration is None:
            # Create a default integration for README generation
            from universal_mcp.integrations import Integration
            self.integration = Integration(name="default")
        
        self.integration.api_key = os.getenv("SCRAPER_API")
