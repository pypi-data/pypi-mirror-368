...
from lamoom.response_parsers.response_parser import get_json_from_response, get_thinking_from_response
...
class AIResponse:
    ...
    @property
    def thinking(self) -> t.Optional[str]:
        thinking_response = get_thinking_from_response(self.response)
        return thinking_response.parsed_content if thinking_response else None
