...
class ModelDeploymentClient(object):
    ...
    def predict(self, model_deployment_id, request_body, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/modeldeployment/predict.py.html>`__ to see an example of how to use predict API.
        """
    ...
    def predict_with_response_stream(self, model_deployment_id, request_body, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/modeldeployment/predict_with_response_stream.py.html>`__ to see an example of how to use predict_with_response_stream API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelDeploymentId']
