...
class DistributedDbServiceClient(object):
    ...
    def add_distributed_database_gds_control_node(self, distributed_database_id, add_distributed_database_gds_control_node_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/add_distributed_database_gds_control_node.py.html>`__ to see an example of how to use add_distributed_database_gds_control_node API.
        """
    ...
    def change_distributed_database_compartment(self, change_distributed_database_compartment_details, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/change_distributed_database_compartment.py.html>`__ to see an example of how to use change_distributed_database_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def change_distributed_db_backup_config(self, distributed_database_id, change_distributed_db_backup_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/change_distributed_db_backup_config.py.html>`__ to see an example of how to use change_distributed_db_backup_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def configure_distributed_database_gsms(self, configure_distributed_database_gsms_details, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/configure_distributed_database_gsms.py.html>`__ to see an example of how to use configure_distributed_database_gsms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def configure_distributed_database_sharding(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/configure_distributed_database_sharding.py.html>`__ to see an example of how to use configure_distributed_database_sharding API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def create_distributed_database(self, create_distributed_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/create_distributed_database.py.html>`__ to see an example of how to use create_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_distributed_database(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/delete_distributed_database.py.html>`__ to see an example of how to use delete_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def download_distributed_database_gsm_certificate_signing_request(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/download_distributed_database_gsm_certificate_signing_request.py.html>`__ to see an example of how to use download_distributed_database_gsm_certificate_signing_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def generate_distributed_database_gsm_certificate_signing_request(self, distributed_database_id, ca_bundle_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/generate_distributed_database_gsm_certificate_signing_request.py.html>`__ to see an example of how to use generate_distributed_database_gsm_certificate_signing_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def generate_distributed_database_wallet(self, distributed_database_id, generate_distributed_database_wallet_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/generate_distributed_database_wallet.py.html>`__ to see an example of how to use generate_distributed_database_wallet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def get_distributed_database(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/get_distributed_database.py.html>`__ to see an example of how to use get_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        resource_path = "/distributedDatabases/{distributedDatabaseId}"
    ...
    def list_distributed_databases(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/list_distributed_databases.py.html>`__ to see an example of how to use list_distributed_databases API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def patch_distributed_database(self, distributed_database_id, patch_distributed_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/patch_distributed_database.py.html>`__ to see an example of how to use patch_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        resource_path = "/distributedDatabases/{distributedDatabaseId}"
    ...
    def rotate_distributed_database_passwords(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/rotate_distributed_database_passwords.py.html>`__ to see an example of how to use rotate_distributed_database_passwords API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def start_distributed_database(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/start_distributed_database.py.html>`__ to see an example of how to use start_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def stop_distributed_database(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/stop_distributed_database.py.html>`__ to see an example of how to use stop_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def update_distributed_database(self, distributed_database_id, update_distributed_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/update_distributed_database.py.html>`__ to see an example of how to use update_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        resource_path = "/distributedDatabases/{distributedDatabaseId}"
    ...
    def upload_distributed_database_signed_certificate_and_generate_wallet(self, distributed_database_id, upload_distributed_database_signed_certificate_and_generate_wallet_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/upload_distributed_database_signed_certificate_and_generate_wallet.py.html>`__ to see an example of how to use upload_distributed_database_signed_certificate_and_generate_wallet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
    ...
    def validate_distributed_database_network(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/validate_distributed_database_network.py.html>`__ to see an example of how to use validate_distributed_database_network API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
