...
class DistributedDbPrivateEndpointServiceClient(object):
    ...
    def change_distributed_database_private_endpoint_compartment(self, change_distributed_database_private_endpoint_compartment_details, distributed_database_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/change_distributed_database_private_endpoint_compartment.py.html>`__ to see an example of how to use change_distributed_database_private_endpoint_compartment API.
        """
    ...
    def create_distributed_database_private_endpoint(self, create_distributed_database_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/create_distributed_database_private_endpoint.py.html>`__ to see an example of how to use create_distributed_database_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_distributed_database_private_endpoint(self, distributed_database_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/delete_distributed_database_private_endpoint.py.html>`__ to see an example of how to use delete_distributed_database_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabasePrivateEndpointId']
    ...
    def get_distributed_database_private_endpoint(self, distributed_database_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/get_distributed_database_private_endpoint.py.html>`__ to see an example of how to use get_distributed_database_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabasePrivateEndpointId']
        resource_path = "/distributedDatabasePrivateEndpoints/{distributedDatabasePrivateEndpointId}"
    ...
    def list_distributed_database_private_endpoints(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/list_distributed_database_private_endpoints.py.html>`__ to see an example of how to use list_distributed_database_private_endpoints API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def reinstate_proxy_instance(self, distributed_database_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/reinstate_proxy_instance.py.html>`__ to see an example of how to use reinstate_proxy_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabasePrivateEndpointId']
    ...
    def update_distributed_database_private_endpoint(self, distributed_database_private_endpoint_id, update_distributed_database_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/distributeddatabase/update_distributed_database_private_endpoint.py.html>`__ to see an example of how to use update_distributed_database_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabasePrivateEndpointId']
        resource_path = "/distributedDatabasePrivateEndpoints/{distributedDatabasePrivateEndpointId}"
