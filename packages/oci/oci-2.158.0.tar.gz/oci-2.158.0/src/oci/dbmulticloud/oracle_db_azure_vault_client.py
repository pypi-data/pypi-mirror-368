...
class OracleDbAzureVaultClient(object):
    ...
    def change_oracle_db_azure_vault_compartment(self, oracle_db_azure_vault_id, change_oracle_db_azure_vault_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/change_oracle_db_azure_vault_compartment.py.html>`__ to see an example of how to use change_oracle_db_azure_vault_compartment API.
        """
    ...
    def create_oracle_db_azure_vault(self, create_oracle_db_azure_vault_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/create_oracle_db_azure_vault.py.html>`__ to see an example of how to use create_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_oracle_db_azure_vault(self, oracle_db_azure_vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/delete_oracle_db_azure_vault.py.html>`__ to see an example of how to use delete_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultId']
    ...
    def get_oracle_db_azure_vault(self, oracle_db_azure_vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/get_oracle_db_azure_vault.py.html>`__ to see an example of how to use get_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultId']
        resource_path = "/oracleDbAzureVault/{oracleDbAzureVaultId}"
    ...
    def list_oracle_db_azure_vaults(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/list_oracle_db_azure_vaults.py.html>`__ to see an example of how to use list_oracle_db_azure_vaults API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def refresh_oracle_db_azure_vault(self, oracle_db_azure_vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/refresh_oracle_db_azure_vault.py.html>`__ to see an example of how to use refresh_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultId']
    ...
    def update_oracle_db_azure_vault(self, oracle_db_azure_vault_id, update_oracle_db_azure_vault_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/update_oracle_db_azure_vault.py.html>`__ to see an example of how to use update_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultId']
        resource_path = "/oracleDbAzureVault/{oracleDbAzureVaultId}"
