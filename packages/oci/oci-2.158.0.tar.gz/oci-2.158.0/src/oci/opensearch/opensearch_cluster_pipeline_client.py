...
class OpensearchClusterPipelineClient(object):
    ...
    def create_opensearch_cluster_pipeline(self, create_opensearch_cluster_pipeline_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/opensearch/create_opensearch_cluster_pipeline.py.html>`__ to see an example of how to use create_opensearch_cluster_pipeline API.
        """
    ...
    def delete_opensearch_cluster_pipeline(self, opensearch_cluster_pipeline_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/opensearch/delete_opensearch_cluster_pipeline.py.html>`__ to see an example of how to use delete_opensearch_cluster_pipeline API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_opensearch_cluster_pipeline(self, opensearch_cluster_pipeline_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/opensearch/get_opensearch_cluster_pipeline.py.html>`__ to see an example of how to use get_opensearch_cluster_pipeline API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['opensearchClusterPipelineId']
        resource_path = "/opensearchClusterPipelines/{opensearchClusterPipelineId}"
    ...
    def list_opensearch_cluster_pipelines(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/opensearch/list_opensearch_cluster_pipelines.py.html>`__ to see an example of how to use list_opensearch_cluster_pipelines API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_opensearch_cluster_pipeline(self, opensearch_cluster_pipeline_id, update_opensearch_cluster_pipeline_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/opensearch/update_opensearch_cluster_pipeline.py.html>`__ to see an example of how to use update_opensearch_cluster_pipeline API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['opensearchClusterPipelineId']
        resource_path = "/opensearchClusterPipelines/{opensearchClusterPipelineId}"
