...
class OracleDbAzureVaultAssociationClient(object):
    ...
    def cascading_delete_oracle_db_azure_vault_association(self, oracle_db_azure_vault_association_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/cascading_delete_oracle_db_azure_vault_association.py.html>`__ to see an example of how to use cascading_delete_oracle_db_azure_vault_association API.
        """
    ...
    def change_oracle_db_azure_vault_association_compartment(self, oracle_db_azure_vault_association_id, change_oracle_db_azure_vault_association_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/change_oracle_db_azure_vault_association_compartment.py.html>`__ to see an example of how to use change_oracle_db_azure_vault_association_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultAssociationId']
    ...
    def create_oracle_db_azure_vault_association(self, create_oracle_db_azure_vault_association_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/create_oracle_db_azure_vault_association.py.html>`__ to see an example of how to use create_oracle_db_azure_vault_association API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_oracle_db_azure_vault_association(self, oracle_db_azure_vault_association_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/delete_oracle_db_azure_vault_association.py.html>`__ to see an example of how to use delete_oracle_db_azure_vault_association API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultAssociationId']
    ...
    def get_oracle_db_azure_vault_association(self, oracle_db_azure_vault_association_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/get_oracle_db_azure_vault_association.py.html>`__ to see an example of how to use get_oracle_db_azure_vault_association API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultAssociationId']
        resource_path = "/oracleDbAzureVaultAssociation/{oracleDbAzureVaultAssociationId}"
    ...
    def list_oracle_db_azure_vault_associations(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/list_oracle_db_azure_vault_associations.py.html>`__ to see an example of how to use list_oracle_db_azure_vault_associations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_oracle_db_azure_vault_association(self, oracle_db_azure_vault_association_id, update_oracle_db_azure_vault_association_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/update_oracle_db_azure_vault_association.py.html>`__ to see an example of how to use update_oracle_db_azure_vault_association API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultAssociationId']
        resource_path = "/oracleDbAzureVaultAssociation/{oracleDbAzureVaultAssociationId}"
