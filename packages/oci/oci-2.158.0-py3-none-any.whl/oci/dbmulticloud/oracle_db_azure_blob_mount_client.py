...
class OracleDBAzureBlobMountClient(object):
    ...
    def change_oracle_db_azure_blob_mount_compartment(self, oracle_db_azure_blob_mount_id, change_oracle_db_azure_blob_mount_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/change_oracle_db_azure_blob_mount_compartment.py.html>`__ to see an example of how to use change_oracle_db_azure_blob_mount_compartment API.
        """
    ...
    def create_oracle_db_azure_blob_mount(self, create_oracle_db_azure_blob_mount_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/create_oracle_db_azure_blob_mount.py.html>`__ to see an example of how to use create_oracle_db_azure_blob_mount API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_oracle_db_azure_blob_mount(self, oracle_db_azure_blob_mount_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/delete_oracle_db_azure_blob_mount.py.html>`__ to see an example of how to use delete_oracle_db_azure_blob_mount API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureBlobMountId']
    ...
    def get_oracle_db_azure_blob_mount(self, oracle_db_azure_blob_mount_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/get_oracle_db_azure_blob_mount.py.html>`__ to see an example of how to use get_oracle_db_azure_blob_mount API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureBlobMountId']
        resource_path = "/oracleDbAzureBlobMount/{oracleDbAzureBlobMountId}"
    ...
    def list_oracle_db_azure_blob_mounts(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/list_oracle_db_azure_blob_mounts.py.html>`__ to see an example of how to use list_oracle_db_azure_blob_mounts API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_oracle_db_azure_blob_mount(self, oracle_db_azure_blob_mount_id, update_oracle_db_azure_blob_mount_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/update_oracle_db_azure_blob_mount.py.html>`__ to see an example of how to use update_oracle_db_azure_blob_mount API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureBlobMountId']
        resource_path = "/oracleDbAzureBlobMount/{oracleDbAzureBlobMountId}"
