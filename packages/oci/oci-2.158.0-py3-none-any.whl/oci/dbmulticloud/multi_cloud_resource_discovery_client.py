...
class MultiCloudResourceDiscoveryClient(object):
    ...
    def change_multi_cloud_resource_discovery_compartment(self, multi_cloud_resource_discovery_id, change_multi_cloud_resource_discovery_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/change_multi_cloud_resource_discovery_compartment.py.html>`__ to see an example of how to use change_multi_cloud_resource_discovery_compartment API.
        """
    ...
    def create_multi_cloud_resource_discovery(self, create_multi_cloud_resource_discovery_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/create_multi_cloud_resource_discovery.py.html>`__ to see an example of how to use create_multi_cloud_resource_discovery API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_multi_cloud_resource_discovery(self, multi_cloud_resource_discovery_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/delete_multi_cloud_resource_discovery.py.html>`__ to see an example of how to use delete_multi_cloud_resource_discovery API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['multiCloudResourceDiscoveryId']
    ...
    def get_multi_cloud_resource_discovery(self, multi_cloud_resource_discovery_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/get_multi_cloud_resource_discovery.py.html>`__ to see an example of how to use get_multi_cloud_resource_discovery API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['multiCloudResourceDiscoveryId']
        resource_path = "/multiCloudResourceDiscovery/{multiCloudResourceDiscoveryId}"
    ...
    def list_multi_cloud_resource_discoveries(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/list_multi_cloud_resource_discoveries.py.html>`__ to see an example of how to use list_multi_cloud_resource_discoveries API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_multi_cloud_resource_discovery(self, multi_cloud_resource_discovery_id, update_multi_cloud_resource_discovery_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/dbmulticloud/update_multi_cloud_resource_discovery.py.html>`__ to see an example of how to use update_multi_cloud_resource_discovery API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['multiCloudResourceDiscoveryId']
        resource_path = "/multiCloudResourceDiscovery/{multiCloudResourceDiscoveryId}"
