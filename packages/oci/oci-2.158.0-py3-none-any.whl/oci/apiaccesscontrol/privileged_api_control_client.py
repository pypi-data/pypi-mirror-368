...
class PrivilegedApiControlClient(object):
    ...
    def change_privileged_api_control_compartment(self, privileged_api_control_id, change_privileged_api_control_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/change_privileged_api_control_compartment.py.html>`__ to see an example of how to use change_privileged_api_control_compartment API.
        """
    ...
    def create_privileged_api_control(self, create_privileged_api_control_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/create_privileged_api_control.py.html>`__ to see an example of how to use create_privileged_api_control API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_privileged_api_control(self, privileged_api_control_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/delete_privileged_api_control.py.html>`__ to see an example of how to use delete_privileged_api_control API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privilegedApiControlId']
    ...
    def get_privileged_api_control(self, privileged_api_control_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/get_privileged_api_control.py.html>`__ to see an example of how to use get_privileged_api_control API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privilegedApiControlId']
        resource_path = "/privilegedApiControls/{privilegedApiControlId}"
    ...
    def list_privileged_api_controls(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/list_privileged_api_controls.py.html>`__ to see an example of how to use list_privileged_api_controls API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/privilegedApiControls"
    ...
    def update_privileged_api_control(self, privileged_api_control_id, update_privileged_api_control_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/update_privileged_api_control.py.html>`__ to see an example of how to use update_privileged_api_control API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privilegedApiControlId']
        resource_path = "/privilegedApiControls/{privilegedApiControlId}"
