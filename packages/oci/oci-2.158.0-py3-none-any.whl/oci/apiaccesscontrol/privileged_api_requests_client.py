...
class PrivilegedApiRequestsClient(object):
    ...
    def approve_privileged_api_request(self, privileged_api_request_id, approve_privileged_api_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/approve_privileged_api_request.py.html>`__ to see an example of how to use approve_privileged_api_request API.
        """
    ...
    def close_privileged_api_request(self, privileged_api_request_id, close_privileged_api_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/close_privileged_api_request.py.html>`__ to see an example of how to use close_privileged_api_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privilegedApiRequestId']
    ...
    def create_privileged_api_request(self, create_privileged_api_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/create_privileged_api_request.py.html>`__ to see an example of how to use create_privileged_api_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def get_privileged_api_request(self, privileged_api_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/get_privileged_api_request.py.html>`__ to see an example of how to use get_privileged_api_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privilegedApiRequestId']
    ...
    def list_privileged_api_requests(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/list_privileged_api_requests.py.html>`__ to see an example of how to use list_privileged_api_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/privilegedApiRequests"
    ...
    def reject_privileged_api_request(self, privileged_api_request_id, reject_privileged_api_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/reject_privileged_api_request.py.html>`__ to see an example of how to use reject_privileged_api_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privilegedApiRequestId']
    ...
    def revoke_privileged_api_request(self, privileged_api_request_id, revoke_privileged_api_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apiaccesscontrol/revoke_privileged_api_request.py.html>`__ to see an example of how to use revoke_privileged_api_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privilegedApiRequestId']
