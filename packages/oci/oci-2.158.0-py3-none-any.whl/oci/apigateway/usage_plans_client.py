...
class UsagePlansClient(object):
    ...
    def add_usage_plan_lock(self, usage_plan_id, add_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apigateway/add_usage_plan_lock.py.html>`__ to see an example of how to use add_usage_plan_lock API.
        """
    ...
    def change_usage_plan_compartment(self, usage_plan_id, change_usage_plan_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apigateway/change_usage_plan_compartment.py.html>`__ to see an example of how to use change_usage_plan_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['usagePlanId']
    ...
    def create_usage_plan(self, create_usage_plan_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apigateway/create_usage_plan.py.html>`__ to see an example of how to use create_usage_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_usage_plan(self, usage_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apigateway/delete_usage_plan.py.html>`__ to see an example of how to use delete_usage_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['usagePlanId']
    ...
    def get_usage_plan(self, usage_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apigateway/get_usage_plan.py.html>`__ to see an example of how to use get_usage_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['usagePlanId']
        resource_path = "/usagePlans/{usagePlanId}"
    ...
    def list_usage_plans(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apigateway/list_usage_plans.py.html>`__ to see an example of how to use list_usage_plans API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def remove_usage_plan_lock(self, usage_plan_id, remove_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apigateway/remove_usage_plan_lock.py.html>`__ to see an example of how to use remove_usage_plan_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['usagePlanId']
    ...
    def update_usage_plan(self, usage_plan_id, update_usage_plan_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/apigateway/update_usage_plan.py.html>`__ to see an example of how to use update_usage_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['usagePlanId']
        resource_path = "/usagePlans/{usagePlanId}"
