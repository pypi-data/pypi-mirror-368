...
class FleetAppsManagementClient(object):
    ...
    def change_fleet_compartment(self, fleet_id, change_fleet_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/change_fleet_compartment.py.html>`__ to see an example of how to use change_fleet_compartment API.
        """
    ...
    def check_resource_tagging(self, check_resource_tagging_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/check_resource_tagging.py.html>`__ to see an example of how to use check_resource_tagging API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def confirm_targets(self, confirm_targets_details, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/confirm_targets.py.html>`__ to see an example of how to use confirm_targets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def create_fleet(self, create_fleet_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/create_fleet.py.html>`__ to see an example of how to use create_fleet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_fleet_credential(self, create_fleet_credential_details, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/create_fleet_credential.py.html>`__ to see an example of how to use create_fleet_credential API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def create_fleet_property(self, create_fleet_property_details, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/create_fleet_property.py.html>`__ to see an example of how to use create_fleet_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def create_fleet_resource(self, create_fleet_resource_details, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/create_fleet_resource.py.html>`__ to see an example of how to use create_fleet_resource API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def delete_fleet(self, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/delete_fleet.py.html>`__ to see an example of how to use delete_fleet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def delete_fleet_credential(self, fleet_credential_id, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/delete_fleet_credential.py.html>`__ to see an example of how to use delete_fleet_credential API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_fleet_property(self, fleet_property_id, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/delete_fleet_property.py.html>`__ to see an example of how to use delete_fleet_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_fleet_resource(self, fleet_resource_id, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/delete_fleet_resource.py.html>`__ to see an example of how to use delete_fleet_resource API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def generate_compliance_report(self, generate_compliance_report_details, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/generate_compliance_report.py.html>`__ to see an example of how to use generate_compliance_report API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def get_compliance_report(self, fleet_id, compliance_report_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/get_compliance_report.py.html>`__ to see an example of how to use get_compliance_report API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_fleet(self, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/get_fleet.py.html>`__ to see an example of how to use get_fleet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
        resource_path = "/fleets/{fleetId}"
    ...
    def get_fleet_credential(self, fleet_credential_id, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/get_fleet_credential.py.html>`__ to see an example of how to use get_fleet_credential API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetCredentialId', 'fleetId']
        resource_path = "/fleets/{fleetId}/fleetCredentials/{fleetCredentialId}"
    ...
    def get_fleet_property(self, fleet_property_id, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/get_fleet_property.py.html>`__ to see an example of how to use get_fleet_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetPropertyId', 'fleetId']
        resource_path = "/fleets/{fleetId}/fleetProperties/{fleetPropertyId}"
    ...
    def get_fleet_resource(self, fleet_resource_id, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/get_fleet_resource.py.html>`__ to see an example of how to use get_fleet_resource API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetResourceId', 'fleetId']
        resource_path = "/fleets/{fleetId}/fleetResources/{fleetResourceId}"
    ...
    def list_announcements(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/list_announcements.py.html>`__ to see an example of how to use list_announcements API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_fleet_credentials(self, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/list_fleet_credentials.py.html>`__ to see an example of how to use list_fleet_credentials API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
        resource_path = "/fleets/{fleetId}/fleetCredentials"
    ...
    def list_fleet_products(self, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/list_fleet_products.py.html>`__ to see an example of how to use list_fleet_products API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def list_fleet_properties(self, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/list_fleet_properties.py.html>`__ to see an example of how to use list_fleet_properties API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
        resource_path = "/fleets/{fleetId}/fleetProperties"
    ...
    def list_fleet_resources(self, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/list_fleet_resources.py.html>`__ to see an example of how to use list_fleet_resources API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
        resource_path = "/fleets/{fleetId}/fleetResources"
    ...
    def list_fleet_targets(self, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/list_fleet_targets.py.html>`__ to see an example of how to use list_fleet_targets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def list_fleets(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/list_fleets.py.html>`__ to see an example of how to use list_fleets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/fleets"
    ...
    def list_inventory_resources(self, compartment_id, resource_compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/list_inventory_resources.py.html>`__ to see an example of how to use list_inventory_resources API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_targets(self, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/list_targets.py.html>`__ to see an example of how to use list_targets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def request_resource_validation(self, request_resource_validation_details, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/request_resource_validation.py.html>`__ to see an example of how to use request_resource_validation API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def request_target_discovery(self, request_target_discovery_details, fleet_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/request_target_discovery.py.html>`__ to see an example of how to use request_target_discovery API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
    ...
    def update_fleet(self, fleet_id, update_fleet_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/update_fleet.py.html>`__ to see an example of how to use update_fleet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetId']
        resource_path = "/fleets/{fleetId}"
    ...
    def update_fleet_credential(self, fleet_credential_id, fleet_id, update_fleet_credential_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/update_fleet_credential.py.html>`__ to see an example of how to use update_fleet_credential API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetCredentialId', 'fleetId']
        resource_path = "/fleets/{fleetId}/fleetCredentials/{fleetCredentialId}"
    ...
    def update_fleet_property(self, fleet_property_id, fleet_id, update_fleet_property_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/update_fleet_property.py.html>`__ to see an example of how to use update_fleet_property API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetPropertyId', 'fleetId']
        resource_path = "/fleets/{fleetId}/fleetProperties/{fleetPropertyId}"
    ...
    def update_fleet_resource(self, fleet_resource_id, fleet_id, update_fleet_resource_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/fleetappsmanagement/update_fleet_resource.py.html>`__ to see an example of how to use update_fleet_resource API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fleetResourceId', 'fleetId']
        resource_path = "/fleets/{fleetId}/fleetResources/{fleetResourceId}"
