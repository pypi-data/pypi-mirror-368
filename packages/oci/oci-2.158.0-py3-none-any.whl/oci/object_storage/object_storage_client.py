...
class ObjectStorageClient(object):
    ...
    def abort_multipart_upload(self, namespace_name, bucket_name, object_name, upload_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/abort_multipart_upload.py.html>`__ to see an example of how to use abort_multipart_upload API.
        """
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def commit_multipart_upload(self, namespace_name, bucket_name, object_name, upload_id, commit_multipart_upload_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/commit_multipart_upload.py.html>`__ to see an example of how to use commit_multipart_upload API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'objectName', 'uploadId']
        resource_path = "/n/{namespaceName}/b/{bucketName}/u/{objectName}"
    ...
    def copy_object(self, namespace_name, bucket_name, copy_object_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/copy_object.py.html>`__ to see an example of how to use copy_object API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_bucket(self, namespace_name, create_bucket_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/create_bucket.py.html>`__ to see an example of how to use create_bucket API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_multipart_upload(self, namespace_name, bucket_name, create_multipart_upload_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/create_multipart_upload.py.html>`__ to see an example of how to use create_multipart_upload API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def create_preauthenticated_request(self, namespace_name, bucket_name, create_preauthenticated_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/create_preauthenticated_request.py.html>`__ to see an example of how to use create_preauthenticated_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def create_private_endpoint(self, namespace_name, create_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/create_private_endpoint.py.html>`__ to see an example of how to use create_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName']
    ...
    def create_replication_policy(self, namespace_name, bucket_name, create_replication_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/create_replication_policy.py.html>`__ to see an example of how to use create_replication_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def create_retention_rule(self, namespace_name, bucket_name, create_retention_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/create_retention_rule.py.html>`__ to see an example of how to use create_retention_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def delete_bucket(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/delete_bucket.py.html>`__ to see an example of how to use delete_bucket API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def delete_object(self, namespace_name, bucket_name, object_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/delete_object.py.html>`__ to see an example of how to use delete_object API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_object_lifecycle_policy(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/delete_object_lifecycle_policy.py.html>`__ to see an example of how to use delete_object_lifecycle_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def delete_preauthenticated_request(self, namespace_name, bucket_name, par_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/delete_preauthenticated_request.py.html>`__ to see an example of how to use delete_preauthenticated_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_private_endpoint(self, namespace_name, pe_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/delete_private_endpoint.py.html>`__ to see an example of how to use delete_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_replication_policy(self, namespace_name, bucket_name, replication_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/delete_replication_policy.py.html>`__ to see an example of how to use delete_replication_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_retention_rule(self, namespace_name, bucket_name, retention_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/delete_retention_rule.py.html>`__ to see an example of how to use delete_retention_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_bucket(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_bucket.py.html>`__ to see an example of how to use get_bucket API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
        resource_path = "/n/{namespaceName}/b/{bucketName}"
    ...
    def get_namespace(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_namespace.py.html>`__ to see an example of how to use get_namespace API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/n"
    ...
    def get_namespace_metadata(self, namespace_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_namespace_metadata.py.html>`__ to see an example of how to use get_namespace_metadata API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName']
    ...
    def get_object(self, namespace_name, bucket_name, object_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_object.py.html>`__ to see an example of how to use get_object API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'objectName']
        resource_path = "/n/{namespaceName}/b/{bucketName}/o/{objectName}"
    ...
    def get_object_lifecycle_policy(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_object_lifecycle_policy.py.html>`__ to see an example of how to use get_object_lifecycle_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
        resource_path = "/n/{namespaceName}/b/{bucketName}/l"
    ...
    def get_preauthenticated_request(self, namespace_name, bucket_name, par_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_preauthenticated_request.py.html>`__ to see an example of how to use get_preauthenticated_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'parId']
        resource_path = "/n/{namespaceName}/b/{bucketName}/p/{parId}"
    ...
    def get_private_endpoint(self, namespace_name, pe_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_private_endpoint.py.html>`__ to see an example of how to use get_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'peName']
        resource_path = "/n/{namespaceName}/pe/{peName}"
    ...
    def get_replication_policy(self, namespace_name, bucket_name, replication_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_replication_policy.py.html>`__ to see an example of how to use get_replication_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'replicationId']
        resource_path = "/n/{namespaceName}/b/{bucketName}/replicationPolicies/{replicationId}"
    ...
    def get_retention_rule(self, namespace_name, bucket_name, retention_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_retention_rule.py.html>`__ to see an example of how to use get_retention_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'retentionRuleId']
        resource_path = "/n/{namespaceName}/b/{bucketName}/retentionRules/{retentionRuleId}"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def head_bucket(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/head_bucket.py.html>`__ to see an example of how to use head_bucket API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
        resource_path = "/n/{namespaceName}/b/{bucketName}"
    ...
    def head_object(self, namespace_name, bucket_name, object_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/head_object.py.html>`__ to see an example of how to use head_object API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'objectName']
        resource_path = "/n/{namespaceName}/b/{bucketName}/o/{objectName}"
    ...
    def list_buckets(self, namespace_name, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_buckets.py.html>`__ to see an example of how to use list_buckets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_multipart_upload_parts(self, namespace_name, bucket_name, object_name, upload_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_multipart_upload_parts.py.html>`__ to see an example of how to use list_multipart_upload_parts API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'objectName', 'uploadId']
        resource_path = "/n/{namespaceName}/b/{bucketName}/u/{objectName}"
    ...
    def list_multipart_uploads(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_multipart_uploads.py.html>`__ to see an example of how to use list_multipart_uploads API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
        resource_path = "/n/{namespaceName}/b/{bucketName}/u"
    ...
    def list_object_versions(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_object_versions.py.html>`__ to see an example of how to use list_object_versions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def list_objects(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_objects.py.html>`__ to see an example of how to use list_objects API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def list_preauthenticated_requests(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_preauthenticated_requests.py.html>`__ to see an example of how to use list_preauthenticated_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
        resource_path = "/n/{namespaceName}/b/{bucketName}/p"
    ...
    def list_private_endpoints(self, namespace_name, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_private_endpoints.py.html>`__ to see an example of how to use list_private_endpoints API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'compartmentId']
        resource_path = "/n/{namespaceName}/pe"
    ...
    def list_replication_policies(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_replication_policies.py.html>`__ to see an example of how to use list_replication_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
        resource_path = "/n/{namespaceName}/b/{bucketName}/replicationPolicies"
    ...
    def list_replication_sources(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_replication_sources.py.html>`__ to see an example of how to use list_replication_sources API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def list_retention_rules(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_retention_rules.py.html>`__ to see an example of how to use list_retention_rules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
        resource_path = "/n/{namespaceName}/b/{bucketName}/retentionRules"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def make_bucket_writable(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/make_bucket_writable.py.html>`__ to see an example of how to use make_bucket_writable API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def put_object(self, namespace_name, bucket_name, object_name, put_object_body, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/put_object.py.html>`__ to see an example of how to use put_object API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'objectName']
        resource_path = "/n/{namespaceName}/b/{bucketName}/o/{objectName}"
    ...
    def put_object_lifecycle_policy(self, namespace_name, bucket_name, put_object_lifecycle_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/put_object_lifecycle_policy.py.html>`__ to see an example of how to use put_object_lifecycle_policy API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
        resource_path = "/n/{namespaceName}/b/{bucketName}/l"
    ...
    def reencrypt_bucket(self, namespace_name, bucket_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/reencrypt_bucket.py.html>`__ to see an example of how to use reencrypt_bucket API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def reencrypt_object(self, namespace_name, bucket_name, object_name, reencrypt_object_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/reencrypt_object.py.html>`__ to see an example of how to use reencrypt_object API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'objectName']
    ...
    def rename_object(self, namespace_name, bucket_name, rename_object_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/rename_object.py.html>`__ to see an example of how to use rename_object API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def restore_objects(self, namespace_name, bucket_name, restore_objects_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/restore_objects.py.html>`__ to see an example of how to use restore_objects API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def update_bucket(self, namespace_name, bucket_name, update_bucket_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/update_bucket.py.html>`__ to see an example of how to use update_bucket API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
        resource_path = "/n/{namespaceName}/b/{bucketName}"
    ...
    def update_namespace_metadata(self, namespace_name, update_namespace_metadata_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/update_namespace_metadata.py.html>`__ to see an example of how to use update_namespace_metadata API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName']
        resource_path = "/n/{namespaceName}"
    ...
    def update_object_storage_tier(self, namespace_name, bucket_name, update_object_storage_tier_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/update_object_storage_tier.py.html>`__ to see an example of how to use update_object_storage_tier API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName']
    ...
    def update_private_endpoint(self, namespace_name, pe_name, update_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/update_private_endpoint.py.html>`__ to see an example of how to use update_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'peName']
        resource_path = "/n/{namespaceName}/pe/{peName}"
    ...
    def update_retention_rule(self, namespace_name, bucket_name, retention_rule_id, update_retention_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/update_retention_rule.py.html>`__ to see an example of how to use update_retention_rule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['namespaceName', 'bucketName', 'retentionRuleId']
        resource_path = "/n/{namespaceName}/b/{bucketName}/retentionRules/{retentionRuleId}"
    ...
    def upload_part(self, namespace_name, bucket_name, object_name, upload_id, upload_part_num, upload_part_body, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/objectstorage/upload_part.py.html>`__ to see an example of how to use upload_part API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
