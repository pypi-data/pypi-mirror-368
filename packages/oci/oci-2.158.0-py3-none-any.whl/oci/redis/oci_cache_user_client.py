...
class OciCacheUserClient(object):
    ...
    def change_oci_cache_user_compartment(self, oci_cache_user_id, change_oci_cache_user_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/redis/change_oci_cache_user_compartment.py.html>`__ to see an example of how to use change_oci_cache_user_compartment API.
        """
    ...
    def create_oci_cache_user(self, create_oci_cache_user_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/redis/create_oci_cache_user.py.html>`__ to see an example of how to use create_oci_cache_user API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_oci_cache_user(self, oci_cache_user_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/redis/delete_oci_cache_user.py.html>`__ to see an example of how to use delete_oci_cache_user API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['ociCacheUserId']
    ...
    def get_oci_cache_user(self, oci_cache_user_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/redis/get_oci_cache_user.py.html>`__ to see an example of how to use get_oci_cache_user API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['ociCacheUserId']
        resource_path = "/ociCacheUsers/{ociCacheUserId}"
    ...
    def list_attached_redis_clusters(self, oci_cache_user_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/redis/list_attached_redis_clusters.py.html>`__ to see an example of how to use list_attached_redis_clusters API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['ociCacheUserId']
    ...
    def list_oci_cache_users(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/redis/list_oci_cache_users.py.html>`__ to see an example of how to use list_oci_cache_users API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/ociCacheUsers"
    ...
    def update_oci_cache_user(self, oci_cache_user_id, update_oci_cache_user_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.158.0/redis/update_oci_cache_user.py.html>`__ to see an example of how to use update_oci_cache_user API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['ociCacheUserId']
        resource_path = "/ociCacheUsers/{ociCacheUserId}"
