...
class LayoutData():
    ...
    def clear_data_layout(self):
        self._structure_layout.clear()
        self._custom_layout.clear()
...
class ExecuteLayout():
            ...
            match calculate["calculate_type"]:
                ...
                case "cycle_through_widgets":
                    ...
                    for widget in widgets_layout:
                        ...
                        if widget == widgets_layout[-1]:
                            w_or_h += width_or_height + padding
                        else:
    ...
    def _apply_grid_layout(self, widgets_layout, layout_data, parent_tag):
        ...
        available_width_space = (width_space - (padding * 2)) - (gap * (columns - 1))
        available_height_space = (height_space - (padding * 2)) - (gap * (rows - 1))
