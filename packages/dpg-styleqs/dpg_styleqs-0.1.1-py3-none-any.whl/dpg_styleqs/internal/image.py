...
image_registration.parent.mkdir(parents=True, exist_ok=True)
compressed_images.parent.mkdir(parents=True, exist_ok=True)
compressed_images_temp.parent.mkdir(parents=True, exist_ok=True)
