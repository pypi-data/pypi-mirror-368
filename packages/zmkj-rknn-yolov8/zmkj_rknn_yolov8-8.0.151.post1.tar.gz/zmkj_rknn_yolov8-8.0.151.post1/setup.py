...
setup(
    name='zmkj-rknn-yolov8',  # name of pypi package
    version=get_version(),  # version of pypi package
    python_requires='>=3.7',
    license='AGPL-3.0',
    description=('自用rknn yolov8 版本  只修复了 weights_only=False 问题 来源https://github.com/airockchip/ultralytics_yolov8 8.0.151 v1.6分支'),
