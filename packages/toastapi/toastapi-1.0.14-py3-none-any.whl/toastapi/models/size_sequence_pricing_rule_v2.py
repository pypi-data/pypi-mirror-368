...
class SizeSequencePricingRuleV2(BaseModel):
    """
    Defines the pricing rules for modifier options that belong to a modifier group.
    """ # noqa: E501
    size_name: Optional[StrictStr] = Field(default=None, description="A string that represents the size of a modifier option.", alias="sizeName")
    size_guid: Optional[StrictStr] = Field(default=None, description="The GUID of the modifier option where a menu item size has been defined.", alias="sizeGuid")
    sequence_prices: Optional[List[SequencePriceV2]] = Field(default=None, description="An array of SequencePrice objects.", alias="sequencePrices")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sequencePrices": [SequencePriceV2.from_dict(_item) for _item in obj["sequencePrices"]] if obj.get("sequencePrices") is not None else None
        })
        return _obj
