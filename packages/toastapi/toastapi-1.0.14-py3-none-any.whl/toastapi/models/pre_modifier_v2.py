...
class PreModifierV2(BaseModel):
    """
    Information about a pre-modifier configured for this restaurant.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="A descriptive name for this pre-modifier.")
    guid: Optional[StrictStr] = Field(default=None, description="A unique identifier for this pre-modifier.")
    fixed_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="An optional fixed price for this pre-modifier.", alias="fixedPrice")
    multiplication_factor: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="An optional number that specifies how much the cost is multiplied by.", alias="multiplicationFactor")
    display_mode: Optional[StrictStr] = Field(default=None, description="How the pre-modifier is displayed on tickets and receipts.", alias="displayMode")
    __properties: ClassVar[List[str]] = ["name", "guid", "fixedPrice", "multiplicationFactor", "displayMode"]
