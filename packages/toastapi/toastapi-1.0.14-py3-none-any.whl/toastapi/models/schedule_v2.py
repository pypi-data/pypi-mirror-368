...
class ScheduleV2(BaseModel):
    """
    A multi-use object that defines when a menu is available.
    """ # noqa: E501
    days: Optional[List[StrictStr]] = Field(default=None, description="An array of days of the week.")
    time_ranges: Optional[List[TimeRangeV2]] = Field(default=None, description="An array of TimeRange objects.", alias="timeRanges")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "days": obj.get("days"),
            "timeRanges": [TimeRangeV2.from_dict(_item) for _item in obj["timeRanges"]] if obj.get("timeRanges") is not None else None
        })
        return _obj
