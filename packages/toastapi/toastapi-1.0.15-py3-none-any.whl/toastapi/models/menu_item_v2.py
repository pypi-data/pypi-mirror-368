...
class MenuItemV2(BaseModel):
    ...
    sales_category: Optional[SalesCategoryV2] = Field(default=None, alias="salesCategory")
    ...
    item_tags: Optional[List[ItemTagV2]] = Field(default=None, description="An array of `ItemTag` objects that are assigned to this menu item. Item tags are used to assign identifying characteristics to a menu item, for example, vegetarian, gluten-free, or alcohol. ", alias="itemTags")
    ...
    content_advisories: Optional[ContentAdvisoriesV2] = Field(default=None, alias="contentAdvisories")
    ...
    length: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The length of the menu item.")
    height: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The height of the menu item.")
    width: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The width of the menu item.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salesCategory": SalesCategoryV2.from_dict(obj["salesCategory"]) if obj.get("salesCategory") is not None else None,
            ...
            "contentAdvisories": ContentAdvisoriesV2.from_dict(obj["contentAdvisories"]) if obj.get("contentAdvisories") is not None else None,
            "unitOfMeasure": obj.get("unitOfMeasure"),
            "portions": [PortionV2.from_dict(_item) for _item in obj["portions"]] if obj.get("portions") is not None else None,
