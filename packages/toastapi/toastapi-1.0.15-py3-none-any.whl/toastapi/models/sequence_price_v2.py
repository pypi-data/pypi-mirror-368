...
class SequencePriceV2(BaseModel):
    """
    Defines the size, sequence, or size/sequence prices for modifier options.
    """ # noqa: E501
    sequence: Optional[StrictInt] = Field(default=None, description="Specifies the order of the prices.")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price for a modifier option when it is ordered at the specified point in the sequence.")
    __properties: ClassVar[List[str]] = ["sequence", "price"]
