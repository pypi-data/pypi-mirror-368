...
class ImagesV2(BaseModel):
    """
    Multiple images for a menu item.
    """ # noqa: E501
    high_res_image: Optional[StrictStr] = Field(default=None, description="The URL to a high resolution image.", alias="highResImage")
    image: Optional[StrictStr] = Field(default=None, description="The URL to a standard image.")
    __properties: ClassVar[List[str]] = ["highResImage", "image"]
