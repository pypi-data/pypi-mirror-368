...
class TimeRangeV2(BaseModel):
    """
    Represents a time range for when a menu is available.
    """ # noqa: E501
    start: Optional[StrictStr] = Field(default=None, description="The start time of the time range.")
    end: Optional[StrictStr] = Field(default=None, description="The end time of the time range.")
