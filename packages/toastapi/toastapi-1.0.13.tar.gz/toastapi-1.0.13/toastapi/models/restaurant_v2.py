...
class RestaurantV2(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "menus": [MenuV2.from_dict(_item) for _item in obj["menus"]] if obj.get("menus") is not None else None,
            "modifierGroupReferences": dict(
                (_k, ModifierGroupV2.from_dict(_v))
            ...
            "modifierOptionReferences": dict(
                (_k, ModifierOptionV2.from_dict(_v))
            ...
            "preModifierGroupReferences": dict(
                (_k, PreModifierGroupV2.from_dict(_v))
