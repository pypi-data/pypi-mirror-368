...
class ModifierOptionV2(BaseModel):
    """
    Information about a modifier option configured for this restaurant.
    """ # noqa: E501
    reference_id: Optional[StrictInt] = Field(default=None, description="An integer identifier that is used to refer to this modifier option.", alias="referenceId")
    name: Optional[StrictStr] = Field(default=None, description="A descriptive name for this modifier option.")
    guid: Optional[StrictStr] = Field(default=None, description="A unique identifier for this modifier option.")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price of this modifier option.")
    pricing_strategy: Optional[StrictStr] = Field(default=None, description="A string that indicates how this modifier option has been priced.", alias="pricingStrategy")
    __properties: ClassVar[List[str]] = ["referenceId", "name", "guid", "price", "pricingStrategy"]
