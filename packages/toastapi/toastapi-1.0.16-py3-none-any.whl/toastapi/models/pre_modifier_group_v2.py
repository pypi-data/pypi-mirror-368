...
class PreModifierGroupV2(BaseModel):
    """
    ...
    guid: Optional[StrictStr] = Field(default=None, description="A unique identifier for this pre-modifier group.")
    pre_modifiers: Optional[List[PreModifierV2]] = Field(default=None, description="An array of PreModifier objects.", alias="preModifiers")
    __properties: ClassVar[List[str]] = ["name", "guid", "preModifiers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "guid": obj.get("guid"),
            "preModifiers": [PreModifierV2.from_dict(_item) for _item in obj["preModifiers"]] if obj.get("preModifiers") is not None else None
        })
        return _obj
