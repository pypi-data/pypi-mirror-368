...
class Pipette(Handler):
    ...
    def transfer(self, 
        ...
        # TODO: hot fix, remove this after app updated
        blow_out = False
        blow_out_location = 'trash_bin'
        ...
        if blow_out_location == 'source':
            _blow_out_location = 'source_well'
        elif blow_out_location == 'destination':
            _blow_out_location = 'dest_well'
        elif blow_out_location == 'trash_bin':
            _blow_out_location = self._get_context()._get_trash_bin().id().split(":")[0]+':trashBin'
        ...
        self._get_context()._append_saved_step_form(
            TransferCommand(
                ...
                # TODO: pending to be removed (blow_out, blow_out_location)
                blowout_checkbox=blow_out,
                blowout_location=_blow_out_location, 
    ...
    def pick_up_tip(self, location: Union[TipRack, Well, Column, None] = None) -> 'Pipette':
        ...
        if isinstance(location, (Well, Column)):
            ...
            self.__current_tip_location = tiprack._get_new_tip(self.n_channel, self._get_context()._get_pick_up_tip_order())
