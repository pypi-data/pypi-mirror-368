...
def send_signed_request(ws_config: WebServiceConfig, method: str, url: str, path: str, headers: Dict[str, str] = None, parameters: Dict[str, str] = None, body: str = None) -> tuple[int, str]:
...
def get_hmac_signature(secret_key: str, method: str, path: str, headers: Dict[str, str] = None, parameters: Dict[str, str] = None, body: str = None)-> tuple[str, str] | None:
