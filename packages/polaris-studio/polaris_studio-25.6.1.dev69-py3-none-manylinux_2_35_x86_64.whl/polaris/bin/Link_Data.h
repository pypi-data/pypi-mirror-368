...
namespace Link_Components::Implementations
{
    ...
    struct Link_Data
    {
        ...
        t_static_data(float, max_acc);
        t_static_data(float, max_dec);
    ...
    Link_Components::Types::ImpactsDefinition Link_Data::_impact_definition_type =
        Link_Components::Types::ImpactsDefinition::ALL_HOMOGENEOUS;
    std::vector<Link_Components::Types::ClassSpecificImpact> Link_Data::_multi_class_impacts;
    float                                                    Link_Data::_max_acc     = -1.0;
    float                                                    Link_Data::_max_dec     = -1.0;
    bool                                                     Link_Data::_bounded_acc = false;
