...
class Workflow:
    ...
    # monitoring=True logs Workflow information to globalgenie.com for monitoring
    monitoring: bool = field(default_factory=lambda: getenv("GLOBALGENIE_MONITOR", "false").lower() == "true")
    # telemetry=True logs minimal telemetry for analytics
    # This helps us improve the Workflow and provide better support
    telemetry: bool = field(default_factory=lambda: getenv("GLOBALGENIE_TELEMETRY", "true").lower() == "true")
