...
from globalgenie.exceptions import ModelProviderError, ModelRateLimitError
from globalgenie.models.base import Model
from globalgenie.models.message import Citations, DocumentCitation, Message, UrlCitation
from globalgenie.models.response import ModelResponse
from globalgenie.utils.log import log_debug, log_error, log_warning
from globalgenie.utils.models.claude import MCPServerConfiguration, format_messages
...
try:
    ...
    from anthropic.types import MessageStopEvent  # MessageDeltaEvent,  # Currently broken
    from anthropic.types import (  # MessageDeltaEvent,  # Currently broken
...
# Import Beta types
try:
    from anthropic.types.beta import BetaMessage, BetaRawContentBlockDeltaEvent, BetaTextDelta
except ImportError as e:
    raise ImportError(
