...
from globalgenie.utils.code_execution import prepare_python_code
from globalgenie.utils.log import log_debug, log_error, log_info, log_warning

try:
    from daytona import CodeLanguage, CreateSandboxFromSnapshotParams, Daytona, DaytonaConfig, Sandbox
except ImportError:
...
class DaytonaTools(Toolkit):
    ...
    def _create_new_sandbox(self, agent: Optional[Union[Agent, Team]] = None) -> Sandbox:
        ...
        try:
            ...
            labels.setdefault("created_by", "globalgenie_daytona_toolkit")
