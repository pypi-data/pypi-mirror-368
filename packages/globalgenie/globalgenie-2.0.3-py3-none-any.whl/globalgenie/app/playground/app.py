...
from globalgenie.api.playground import PlaygroundEndpointCreate
from globalgenie.app.playground.async_router import get_async_playground_router
from globalgenie.app.playground.sync_router import get_sync_playground_router
from globalgenie.app.utils import generate_id
from globalgenie.cli.console import console
from globalgenie.cli.settings import globalgenie_cli_settings
from globalgenie.playground.settings import PlaygroundSettings
...
class Playground:
    ...
    def _set_monitoring(self) -> None:
        ...
        monitor_env = getenv("GLOBALGENIE_MONITOR")
    ...
    def serve(
        ...
        **kwargs,
        ...
        url = f"{globalgenie_cli_settings.playground_url}?endpoint={encoded_endpoint}"
        panel = Panel(
    ...
    def register_app_on_platform(self) -> None:
        ...
        from globalgenie.api.app import AppCreate, create_app
