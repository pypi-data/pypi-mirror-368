...
from globalgenie.media import AudioArtifact, AudioResponse, ImageArtifact, VideoArtifact
from globalgenie.models.message import Citations, Message
from globalgenie.models.response import ToolExecution
from globalgenie.run.base import BaseRunResponseEvent, RunResponseExtraData, RunStatus
from globalgenie.run.response import RunEvent, RunResponse, RunResponseEvent, run_response_event_from_dict
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "TeamRunResponse":
        ...
        for event in events or []:
            if "agent_id" in event:
                ...
                from globalgenie.run.response import run_response_event_from_dict
