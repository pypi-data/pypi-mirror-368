...
from globalgenie.api.schemas.user import TeamSchema
from globalgenie.api.schemas.workspace import WorkspaceSchema
from globalgenie.infra.base import InfraBase
from globalgenie.infra.resources import InfraResources
from globalgenie.utils.log import logger
from globalgenie.workspace.settings import WorkspaceSettings
...
class WorkspaceConfig(BaseModel):
    """The WorkspaceConfig holds the configuration for an GlobalGenie workspace."""
    ...
    def workspace_settings(self) -> Optional[WorkspaceSettings]:
        ...
        try:
            from globalgenie.utils.py_io import get_python_objects_from_module
    ...
    def set_local_env(self) -> None:
        ...
        from globalgenie.constants import (
            AWS_REGION_ENV_VAR,
