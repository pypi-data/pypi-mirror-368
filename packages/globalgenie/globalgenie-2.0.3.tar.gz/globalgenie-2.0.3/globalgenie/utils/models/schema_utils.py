...
This module provides model-globalgeniestic schema transformations and validations.
"""
...
def _normalize_for_openai(schema: Dict[str, Any]) -> Dict[str, Any]:
    ...
    from globalgenie.utils.models.openai_responses import sanitize_response_schema
