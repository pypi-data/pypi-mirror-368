...
from globalgenie.media import Audio, AudioArtifact, Image, ImageArtifact, Video, VideoArtifact
from globalgenie.run.base import RunStatus
from globalgenie.run.v2.workflow import (
...
from globalgenie.storage.base import Storage
...
from globalgenie.utils.log import log_debug, logger, set_log_level_to_debug, set_log_level_to_info, use_workflow_logger
...
from globalgenie.workflow.v2.types import StepInput, StepMetrics, StepOutput, WorkflowExecutionInput, WorkflowMetrics
...
class Workflow:
    ...
    def _set_debug(self) -> None:
        ...
        if self.debug_mode or getenv("GLOBALGENIE_DEBUG", "false").lower() == "true":
            use_workflow_logger()
    ...
    def _print_response(
        ...
        **kwargs: Any,
        ...
        from globalgenie.utils.response import create_panel
        from globalgenie.utils.timer import Timer
        ...
        if console is None:
            from globalgenie.cli.console import console
                    ...
                    **kwargs,
                    ...
                    if isinstance(response, WorkflowStartedEvent):
                        ...
                        if isinstance(response, str):
                            ...
                            from globalgenie.run.response import RunResponseContentEvent
                            ...
                            if isinstance(
                                response, (TeamRunResponseContentEvent, WorkflowRunResponseEvent)
                            ):  # type: ignore
            ...
            for step in steps_list:
                if isinstance(step, Step):
                    ...
                    if hasattr(executor, "workflow_session_state") and executor.workflow_session_state:
                        ...
                        from globalgenie.utils.merge_dict import merge_dictionaries
