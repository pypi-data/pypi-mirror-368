...
from globalgenie.exceptions import ModelProviderError, StopAgentRun
...
from globalgenie.memory.agent import AgentMemory, AgentRun
...
from globalgenie.models.message import Citations, Message, MessageMetrics, MessageReferences
...
from globalgenie.run.response import RunEvent, RunResponse, RunResponseEvent, RunResponsePausedEvent
...
from globalgenie.utils.prompts import get_json_output_prompt, get_response_model_format_prompt
...
class Agent:
    ...
    # monitoring=True logs Agent information to globalgenie.com for monitoring
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if last_exception is not None:
            ...
            if stream:
                return generator_wrapper(create_run_response_error_event(run_response,
                    error=str(last_exception)))  # type: ignore
            ...
            if isinstance(self.memory, AgentMemory):
                try:
                    ...
                    if "memories" in session.memory:
                        from globalgenie.memory.memory import Memory as AgentUserMemory
    ...
    def get_run_messages(
        ...
        **kwargs: Any,
        ...
        run_messages = self.get_run_messages(
            message=message, session_id=session_id, user_id=user_id, audio=audio, images=images, videos=videos,
                files=files, messages=messages, **kwargs
        )
        """
    ...
    def get_transfer_function(self, member_agent: Agent, index: int, session_id: Optional[str] = None) -> Function:
        ...
        # If the member agent is set to respond directly,
            # show the result of the function call and stop the model execution
    ...
    def _log_agent_session(self, session_id: str, user_id: Optional[str] = None):
        ...
        from globalgenie.api.agent import AgentSessionCreate, create_agent_session
    ...
    def _log_agent_run(self, session_id: str, user_id: Optional[str] = None) -> None:
        ...
        from globalgenie.api.agent import AgentRunCreate, create_agent_run
    ...
    async def _alog_agent_run(self, session_id: str, user_id: Optional[str] = None) -> None:
        ...
        from globalgenie.api.agent import AgentRunCreate, acreate_agent_run
    ...
    def _append_to_reasoning_content(self, content: str) -> None:
        ...
        if not hasattr(self.run_response,
            "reasoning_content") or not self.run_response.reasoning_content:  # type: ignore
