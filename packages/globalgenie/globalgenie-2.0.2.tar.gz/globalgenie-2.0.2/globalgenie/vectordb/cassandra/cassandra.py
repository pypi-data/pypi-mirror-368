...
from globalgenie.embedder import Embedder
from globalgenie.utils.log import log_debug, log_info
from globalgenie.vectordb.base import VectorDb
from globalgenie.vectordb.cassandra.index import GlobalGenieMetadataVectorCassandraTable
...
class Cassandra(VectorDb):
    ...
    def initialize_table(self):
        self.table = GlobalGenieMetadataVectorCassandraTable(
