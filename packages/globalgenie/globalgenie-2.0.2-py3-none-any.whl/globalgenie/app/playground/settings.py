...
class PlaygroundSettings(BaseSettings):
    ...
    env: str = "dev"
    title: str = "globalgenie-playground"
    ...
    def set_cors_origin_list(cls, cors_origin_list):
        ...
        # Add GlobalGenie domains to cors origin list
        valid_cors.extend(
            [
                "http://localhost:3000",
                "https://globalgenie.com",
                "https://www.globalgenie.com",
                "https://app.globalgenie.com",
                "https://app-stg.globalgenie.com",
            ]
        )
