...
from globalgenie.tools.function import Function
from globalgenie.utils.log import log_debug, log_info, log_warning, logger
from globalgenie.utils.mcp import get_entrypoint_for_tool
...
class MCPTools(Toolkit):
    """
    A toolkit for integrating Model Context Protocol (MCP) servers with GlobalGenie agents.
...
class MultiMCPTools(Toolkit):
    """
    A toolkit for integrating multiple Model Context Protocol (MCP) servers with GlobalGenie agents.
    This allows agents to access tools, resources, and prompts exposed by MCP servers.
