...
class WorkspaceSettings(BaseSettings):
    ...
    # default env for globalgenie ws commands
    default_env: Optional[str] = "dev"
    # default infra for globalgenie ws commands
    default_infra: Optional[str] = None

    # Image Settings
    # Repository for images
    image_repo: str = "globalgeniehq"
    ...
    # ag cli settings
    # Set to True if GlobalGenie should continue creating
    # resources after a resource creation has failed
    continue_on_create_failure: bool = False
    # Set to True if GlobalGenie should continue deleting
    ...
    # Set to True if GlobalGenie should continue patching
