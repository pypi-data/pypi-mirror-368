...
from globalgenie.utils.log import log_error
from pydantic import BaseModel

if TYPE_CHECKING:
    from globalgenie.workflow.v2.types import StepOutput, WorkflowMetrics
...
class WorkflowRunResponse:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "WorkflowRunResponse":
        ...
        from globalgenie.workflow.v2.step import StepOutput

        workflow_metrics_dict = data.pop("workflow_metrics", {})
        workflow_metrics = None
        if workflow_metrics_dict:
            from globalgenie.workflow.v2.workflow import WorkflowMetrics
