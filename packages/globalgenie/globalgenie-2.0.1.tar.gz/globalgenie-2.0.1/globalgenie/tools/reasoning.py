...
from globalgenie.reasoning.step import NextAction, ReasoningStep
from globalgenie.team.team import Team
from globalgenie.tools import Toolkit
from globalgenie.utils.log import log_debug, log_error
...
"""
    ...
    DEFAULT_INSTRUCTIONS = dedent(
        ...
        1. **Think** (scratchpad):
            ...
            - Usage: Call `think` before making tool calls or generating a response. Explain your reasoning and specify the intended action (e.g.,
        ...
        2. **Analyze** (evaluation):
            ...
            - Usage: Call `analyze` after a set of tool calls. Determine the `next_action` based on your analysis: `continue` (more reasoning needed),
                ...
                `validate` (seek external confirmation/validation if possible), or `final_answer` (ready to conclude).
    ...
    FEW_SHOT_EXAMPLES = dedent(
        ...
        *--(Agent internally recalls the fact)--*
        ...
        analyze(
          title="Evaluate Fact",
          result="Standard geographical models list 7 continents: Africa, Antarctica, Asia, Australia, Europe,
