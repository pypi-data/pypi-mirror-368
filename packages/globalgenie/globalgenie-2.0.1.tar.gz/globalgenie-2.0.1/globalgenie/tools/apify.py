...
from globalgenie.utils.log import log_info, logger
...
class ApifyTools(Toolkit):
    def __init__(self, actors: Optional[Union[str, List[str]]] = None, apify_api_token: Optional[str] = None):
        ...
        Examples:
            ...
            pip install globalgenie apify-client
            ...
            from globalgenie.tools.apify import ApifyTools
            ...
            agent.print_response("Summarize the content from https://docs.globalgenie.com/introduction", markdown=True)
...
def create_apify_client(token: str) -> ApifyClient:
    ...
    if http_client := getattr(client.http_client, "httpx_client", None):
        http_client.headers["user-agent"] += "; Origin/globalgenie"
    return client
