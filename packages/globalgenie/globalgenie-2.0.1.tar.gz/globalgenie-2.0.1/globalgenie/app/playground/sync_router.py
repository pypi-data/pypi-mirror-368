...
from globalgenie.agent.agent import Agent, RunResponse
from globalgenie.app.playground.operator import (
    format_tools,
    get_agent_by_id,
    get_session_title,
...
from globalgenie.app.playground.schemas import (
    AgentGetResponse,
    AgentModel,
    AgentRenameRequest,
...
from globalgenie.app.playground.utils import process_audio, process_document, process_image, process_video
from globalgenie.media import Audio
from globalgenie.media import File as FileMedia
from globalgenie.media import Image, Video
from globalgenie.memory.agent import AgentMemory
from globalgenie.memory.v2 import Memory
from globalgenie.run.response import RunResponseErrorEvent, RunResponseEvent
from globalgenie.run.team import RunResponseErrorEvent as TeamRunResponseErrorEvent
from globalgenie.run.v2.workflow import WorkflowErrorEvent
...
from globalgenie.workflow.v2.workflow import Workflow as WorkflowV2
from globalgenie.workflow.workflow import Workflow
            ...
            for file in files:
                if file.content_type in ["image/png", "image/jpeg", "image/jpg", "image/webp"]:
                    ...
                    if file.content_type == "application/pdf":
                        from globalgenie.document.reader.pdf_reader import PDFReader
                        ...
                        if agent.knowledge is not None:
                            ...
                            # If no knowledge base, treat as direct file input (similar to readygenie examples)
                            input_files.append(FileMedia(content=contents))

                    elif file.content_type == "text/csv":
                        from globalgenie.document.reader.csv_reader import CSVReader
                        ...
                        from globalgenie.document.reader.docx_reader import DocxReader
                        ...
                        from globalgenie.document.reader.text_reader import TextReader
                        ...
                        from globalgenie.document.reader.json_reader import JSONReader
