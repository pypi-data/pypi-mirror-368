...
from globalgenie.api.playground import deploy_playground_archive
...
def deploy_archive(name: str, tar_path: Path) -> None:
    """Deploying the tar archive to globalgenie-cloud.
...
def deploy_playground_app(
    ...
    """Deploy a playground application to globalgenie-cloud.

    This function:
    1. Creates a tar archive of the root directory.
    2. Uploades the archive to globalgenie-cloud.
    ...
    globalgenie_cli_settings.gate_alpha_feature()
