...
class GetPredictionSetResponse(BaseModel):
    """
    GetPredictionSetResponse
    """ # noqa: E501
    prediction: Optional[PredictionPrediction] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prediction": PredictionPrediction.from_dict(obj["prediction"]) if obj.get("prediction") is not None else None
        })
        return _obj
