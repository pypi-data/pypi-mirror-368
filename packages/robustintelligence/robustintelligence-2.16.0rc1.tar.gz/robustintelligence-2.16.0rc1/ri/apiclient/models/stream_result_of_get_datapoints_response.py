...
class StreamResultOfGetDatapointsResponse(BaseModel):
    """
    StreamResultOfGetDatapointsResponse
    """ # noqa: E501
    error: Optional[RpcStatus] = None
    result: Optional[GetDatapointsResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": GetDatapointsResponse.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
