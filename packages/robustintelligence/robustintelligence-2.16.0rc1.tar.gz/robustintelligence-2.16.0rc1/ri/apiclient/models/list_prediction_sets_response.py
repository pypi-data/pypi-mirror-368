...
class ListPredictionSetsResponse(BaseModel):
    """
    ...
    predictions: Optional[List[PredictionPrediction]] = None
    __properties: ClassVar[List[str]] = ["hasMore", "nextPageToken", "predictions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "predictions": [PredictionPrediction.from_dict(_item) for _item in obj["predictions"]] if obj.get("predictions") is not None else None
        })
        return _obj
