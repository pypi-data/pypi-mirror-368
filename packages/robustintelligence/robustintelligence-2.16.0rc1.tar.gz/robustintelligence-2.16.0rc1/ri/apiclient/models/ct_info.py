...
class CTInfo(BaseModel):
    ...
    """ # noqa: E501
    ct_dataset_type: Optional[CTDatasetType] = None
    end_time: datetime = Field(alias="endTime")
    firewall_id: Optional[ID] = Field(default=None, alias="firewallId")
    start_time: datetime = Field(description="Start and end time are the start and end time of this dataset.", alias="startTime")
    __properties: ClassVar[List[str]] = ["ctDatasetType", "endTime", "firewallId", "startTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ctDatasetType": obj.get("ctDatasetType"),
