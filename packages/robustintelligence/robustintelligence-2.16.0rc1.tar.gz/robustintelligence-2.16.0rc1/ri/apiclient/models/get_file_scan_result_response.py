...
class GetFileScanResultResponse(BaseModel):
    """
    GetFileScanResultResponse
    """ # noqa: E501
    file_scan_result: Optional[FilescanningFileScanResult] = Field(default=None, alias="fileScanResult")
    __properties: ClassVar[List[str]] = ["fileScanResult"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fileScanResult": FilescanningFileScanResult.from_dict(obj["fileScanResult"]) if obj.get("fileScanResult") is not None else None
        })
        return _obj
