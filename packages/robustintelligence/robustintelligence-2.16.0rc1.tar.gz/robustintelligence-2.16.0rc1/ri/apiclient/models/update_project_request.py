...
class UpdateProjectRequest(BaseModel):
    ...
    project_id: Optional[Dict[str, Any]] = Field(default=None, description="Uniquely specifies a Project to update.", alias="projectId")
    __properties: ClassVar[List[str]] = ["mask", "project", "projectId"]
