...
class ArchivedJobLogs(BaseModel):
    """
    ...
    url: Optional[SafeURL] = None
    __properties: ClassVar[List[str]] = ["expirationTime", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": SafeURL.from_dict(obj["url"]) if obj.get("url") is not None else None
        })
        return _obj
