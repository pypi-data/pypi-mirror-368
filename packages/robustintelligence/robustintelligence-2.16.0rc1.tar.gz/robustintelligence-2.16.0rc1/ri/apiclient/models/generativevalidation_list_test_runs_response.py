...
class GenerativevalidationListTestRunsResponse(BaseModel):
    """
    ...
    test_runs: Optional[List[GenerativeValidationTestRun]] = Field(default=None, description="The list of generative testing results.", alias="testRuns")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testRuns": [GenerativeValidationTestRun.from_dict(_item) for _item in obj["testRuns"]] if obj.get("testRuns") is not None else None
        })
        return _obj
