...
class CustomPiiEntity(BaseModel):
    """
    CustomPiiEntity
    """ # noqa: E501
    context_words: Optional[List[StrictStr]] = Field(default=None, description="Words to use as context that will boost the score if detected around the matching entity. These words are case-insensitive.", alias="contextWords")
    name: Optional[StrictStr] = Field(default=None, description="The name of the entity type.")
    patterns: Optional[List[StrictStr]] = Field(default=None, description="The regex patterns to match against for this entity.")
    __properties: ClassVar[List[str]] = ["contextWords", "name", "patterns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contextWords": obj.get("contextWords"),
            "name": obj.get("name"),
