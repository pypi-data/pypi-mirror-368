...
class ApiGenerativefirewallRuleSensitivity(str, Enum):
    """
    Sensitivity levels for the ruleset.   - RULE_SENSITIVITY_DEFAULT: protolint:disable:next ENUM_FIELD_NAMES_ZERO_VALUE_END_WITH
    """

    """
    allowed enum values
    """
    RULE_SENSITIVITY_DEFAULT = 'RULE_SENSITIVITY_DEFAULT'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApiGenerativefirewallRuleSensitivity from a JSON string"""
