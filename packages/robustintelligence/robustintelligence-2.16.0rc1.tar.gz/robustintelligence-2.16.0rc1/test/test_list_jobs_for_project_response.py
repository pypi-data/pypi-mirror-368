...
class TestListJobsForProjectResponse(unittest.TestCase):
    """ListJobsForProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListJobsForProjectResponse:
        """Test ListJobsForProjectResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListJobsForProjectResponse`
        """
        model = ListJobsForProjectResponse()
        if include_optional:
            return ListJobsForProjectResponse(
                has_more = True,
                jobs = [
                    ri.apiclient.models.job_metadata.JobMetadata(
    ...
    def testListJobsForProjectResponse(self):
        """Test ListJobsForProjectResponse"""
