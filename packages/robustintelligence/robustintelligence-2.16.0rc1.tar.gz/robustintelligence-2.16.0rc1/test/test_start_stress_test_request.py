...
class TestStartStressTestRequest(unittest.TestCase):
    """StartStressTestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartStressTestRequest:
        """Test StartStressTestRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartStressTestRequest`
        """
        model = StartStressTestRequest()
        if include_optional:
            return StartStressTestRequest(
    ...
    def testStartStressTestRequest(self):
        """Test StartStressTestRequest"""
