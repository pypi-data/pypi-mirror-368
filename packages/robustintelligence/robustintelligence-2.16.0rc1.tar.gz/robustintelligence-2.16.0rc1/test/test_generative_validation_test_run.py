...
class TestGenerativeValidationTestRun(unittest.TestCase):
    """GenerativeValidationTestRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerativeValidationTestRun:
        """Test GenerativeValidationTestRun
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerativeValidationTestRun`
        """
        model = GenerativeValidationTestRun()
        if include_optional:
            return GenerativeValidationTestRun(
    ...
    def testGenerativeValidationTestRun(self):
        """Test GenerativeValidationTestRun"""
