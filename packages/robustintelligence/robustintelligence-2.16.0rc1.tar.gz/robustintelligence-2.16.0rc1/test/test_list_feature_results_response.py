...
class TestListFeatureResultsResponse(unittest.TestCase):
    """ListFeatureResultsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListFeatureResultsResponse:
        """Test ListFeatureResultsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListFeatureResultsResponse`
        """
        model = ListFeatureResultsResponse()
        if include_optional:
            return ListFeatureResultsResponse(
                feature_results = [
                    ri.apiclient.models.test_feature_result.TestFeatureResult(
    ...
    def testListFeatureResultsResponse(self):
        """Test ListFeatureResultsResponse"""
