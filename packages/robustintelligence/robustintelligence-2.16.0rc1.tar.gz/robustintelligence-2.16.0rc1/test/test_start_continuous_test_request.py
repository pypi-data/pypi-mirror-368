...
class TestStartContinuousTestRequest(unittest.TestCase):
    """StartContinuousTestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartContinuousTestRequest:
        """Test StartContinuousTestRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartContinuousTestRequest`
        """
        model = StartContinuousTestRequest()
        if include_optional:
            return StartContinuousTestRequest(
                ...
                test_run_incremental_config = ri.apiclient.models.test_run_incremental_config.TestRunIncrementalConfig(
                    eval_dataset_id = '', 
    ...
    def testStartContinuousTestRequest(self):
        """Test StartContinuousTestRequest"""
