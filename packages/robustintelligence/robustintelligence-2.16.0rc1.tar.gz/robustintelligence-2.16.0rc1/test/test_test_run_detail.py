...
class TestTestRunDetail(unittest.TestCase):
    """TestRunDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestRunDetail:
        """Test TestRunDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestRunDetail`
        """
        model = TestRunDetail()
        if include_optional:
