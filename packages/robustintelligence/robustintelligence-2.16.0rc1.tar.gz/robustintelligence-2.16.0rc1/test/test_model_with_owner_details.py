...
class TestModelWithOwnerDetails(unittest.TestCase):
    """ModelWithOwnerDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelWithOwnerDetails:
        """Test ModelWithOwnerDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelWithOwnerDetails`
        """
        model = ModelWithOwnerDetails()
        if include_optional:
            return ModelWithOwnerDetails(
...
to provide identity of the owner of the Project(
    ...
    def testModelWithOwnerDetails(self):
        """Test ModelWithOwnerDetails"""
