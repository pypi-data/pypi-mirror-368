...
class TestCategoryMetric(unittest.TestCase):
    """CategoryMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoryMetric:
        """Test CategoryMetric
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryMetric`
        """
