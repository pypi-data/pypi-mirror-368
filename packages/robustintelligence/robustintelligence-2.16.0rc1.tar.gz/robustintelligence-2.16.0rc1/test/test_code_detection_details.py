...
class TestCodeDetectionDetails(unittest.TestCase):
    """CodeDetectionDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodeDetectionDetails:
        """Test CodeDetectionDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeDetectionDetails`
        """
        model = CodeDetectionDetails()
        if include_optional:
            return CodeDetectionDetails(
    ...
    def testCodeDetectionDetails(self):
        """Test CodeDetectionDetails"""
