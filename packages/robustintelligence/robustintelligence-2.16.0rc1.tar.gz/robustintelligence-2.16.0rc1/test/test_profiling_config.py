...
class TestProfilingConfig(unittest.TestCase):
    """ProfilingConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfilingConfig:
        """Test ProfilingConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfilingConfig`
        """
        model = ProfilingConfig()
        if include_optional:
