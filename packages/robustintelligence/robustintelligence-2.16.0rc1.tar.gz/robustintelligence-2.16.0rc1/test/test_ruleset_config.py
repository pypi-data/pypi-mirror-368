...
class TestRulesetConfig(unittest.TestCase):
    """RulesetConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RulesetConfig:
        """Test RulesetConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RulesetConfig`
        """
        model = RulesetConfig()
        if include_optional:
