...
class TestContinuousTestJobProgress(unittest.TestCase):
    """ContinuousTestJobProgress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContinuousTestJobProgress:
        """Test ContinuousTestJobProgress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContinuousTestJobProgress`
        """
        model = ContinuousTestJobProgress()
        if include_optional:
            return ContinuousTestJobProgress(
                test_runs = [
    ...
    def testContinuousTestJobProgress(self):
        """Test ContinuousTestJobProgress"""
