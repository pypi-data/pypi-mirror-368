...
class TestGetValidateModelTaskStatusResponse(unittest.TestCase):
    """GetValidateModelTaskStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetValidateModelTaskStatusResponse:
        """Test GetValidateModelTaskStatusResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetValidateModelTaskStatusResponse`
        """
        model = GetValidateModelTaskStatusResponse()
        if include_optional:
            return GetValidateModelTaskStatusResponse(
                ...
                resp = ri.apiclient.models.validate_model_response.ValidateModelResponse(
                    error_message = '', 
                    is_valid = True, 
                    validation_status = 'VALIDITY_STATUS_UNSPECIFIED', )
            )
    ...
    def testGetValidateModelTaskStatusResponse(self):
        """Test GetValidateModelTaskStatusResponse"""
