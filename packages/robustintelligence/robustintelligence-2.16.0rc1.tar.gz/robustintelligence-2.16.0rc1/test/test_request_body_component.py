...
class TestRequestBodyComponent(unittest.TestCase):
    """RequestBodyComponent unit test stubs"""
    ...
    def testRequestBodyComponent(self):
        """Test RequestBodyComponent"""
        # inst = RequestBodyComponent()
