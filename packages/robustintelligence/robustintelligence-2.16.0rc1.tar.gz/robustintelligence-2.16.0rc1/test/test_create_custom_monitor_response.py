...
class TestCreateCustomMonitorResponse(unittest.TestCase):
    """CreateCustomMonitorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCustomMonitorResponse:
        """Test CreateCustomMonitorResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCustomMonitorResponse`
        """
        model = CreateCustomMonitorResponse()
        if include_optional:
            return CreateCustomMonitorResponse(
                monitor = ri.apiclient.models.monitor.Monitor(
...
Transformations take in a time series and output a time series(
    ...
    def testCreateCustomMonitorResponse(self):
        """Test CreateCustomMonitorResponse"""
