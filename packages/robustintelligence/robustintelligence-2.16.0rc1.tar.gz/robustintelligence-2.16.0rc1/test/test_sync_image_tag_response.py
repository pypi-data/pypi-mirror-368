...
class TestSyncImageTagResponse(unittest.TestCase):
    """SyncImageTagResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncImageTagResponse:
        """Test SyncImageTagResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncImageTagResponse`
        """
        model = SyncImageTagResponse()
        if include_optional:
            return SyncImageTagResponse(
    ...
    def testSyncImageTagResponse(self):
        """Test SyncImageTagResponse"""
