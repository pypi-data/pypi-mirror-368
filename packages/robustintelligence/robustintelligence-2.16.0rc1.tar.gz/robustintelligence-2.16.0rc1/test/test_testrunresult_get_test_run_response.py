...
class TestTestrunresultGetTestRunResponse(unittest.TestCase):
    """TestrunresultGetTestRunResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestrunresultGetTestRunResponse:
        """Test TestrunresultGetTestRunResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestrunresultGetTestRunResponse`
        """
        model = TestrunresultGetTestRunResponse()
        if include_optional:
    ...
    def testTestrunresultGetTestRunResponse(self):
        """Test TestrunresultGetTestRunResponse"""
