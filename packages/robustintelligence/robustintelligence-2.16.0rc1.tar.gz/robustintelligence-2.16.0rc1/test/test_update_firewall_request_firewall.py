...
class TestUpdateFirewallRequestFirewall(unittest.TestCase):
    """UpdateFirewallRequestFirewall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFirewallRequestFirewall:
        """Test UpdateFirewallRequestFirewall
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFirewallRequestFirewall`
        """
        model = UpdateFirewallRequestFirewall()
        if include_optional:
            return UpdateFirewallRequestFirewall(
                bin_size = '',
                firewall_id = None,
    ...
    def testUpdateFirewallRequestFirewall(self):
        """Test UpdateFirewallRequestFirewall"""
