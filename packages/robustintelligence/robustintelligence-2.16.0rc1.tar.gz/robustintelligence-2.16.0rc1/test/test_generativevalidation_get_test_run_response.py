...
class TestGenerativevalidationGetTestRunResponse(unittest.TestCase):
    """GenerativevalidationGetTestRunResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerativevalidationGetTestRunResponse:
        """Test GenerativevalidationGetTestRunResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerativevalidationGetTestRunResponse`
        """
        model = GenerativevalidationGetTestRunResponse()
        if include_optional:
            return GenerativevalidationGetTestRunResponse(
                test_run = ri.apiclient.models.generative_validation_test_run.GenerativeValidationTestRun(
    ...
    def testGenerativevalidationGetTestRunResponse(self):
        """Test GenerativevalidationGetTestRunResponse"""
