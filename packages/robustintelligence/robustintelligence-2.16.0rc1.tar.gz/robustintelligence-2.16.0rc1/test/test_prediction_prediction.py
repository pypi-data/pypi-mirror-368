...
class TestPredictionPrediction(unittest.TestCase):
    """PredictionPrediction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PredictionPrediction:
        """Test PredictionPrediction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PredictionPrediction`
        """
        model = PredictionPrediction()
        if include_optional:
            return PredictionPrediction(
    ...
    def testPredictionPrediction(self):
        """Test PredictionPrediction"""
