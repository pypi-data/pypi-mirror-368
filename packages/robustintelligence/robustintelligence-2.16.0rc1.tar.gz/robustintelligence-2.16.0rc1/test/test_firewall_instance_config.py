...
class TestFirewallInstanceConfig(unittest.TestCase):
    """FirewallInstanceConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FirewallInstanceConfig:
        """Test FirewallInstanceConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FirewallInstanceConfig`
        """
        model = FirewallInstanceConfig()
        if include_optional:
    ...
    def testFirewallInstanceConfig(self):
        """Test FirewallInstanceConfig"""
