...
class TestStartContinuousTestResponse(unittest.TestCase):
    """StartContinuousTestResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartContinuousTestResponse:
        """Test StartContinuousTestResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartContinuousTestResponse`
        """
        model = StartContinuousTestResponse()
        if include_optional:
            return StartContinuousTestResponse(
    ...
    def testStartContinuousTestResponse(self):
        """Test StartContinuousTestResponse"""
