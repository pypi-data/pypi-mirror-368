...
class TestListFirewallInstancesResponse(unittest.TestCase):
    """ListFirewallInstancesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListFirewallInstancesResponse:
        """Test ListFirewallInstancesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListFirewallInstancesResponse`
        """
        model = ListFirewallInstancesResponse()
        if include_optional:
            return ListFirewallInstancesResponse(
                fw_instances = [
                    ri.apiclient.models.firewall_instance_info.FirewallInstanceInfo(
    ...
    def testListFirewallInstancesResponse(self):
        """Test ListFirewallInstancesResponse"""
