...
class TestGetFirewallResponse(unittest.TestCase):
    """GetFirewallResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFirewallResponse:
        """Test GetFirewallResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFirewallResponse`
        """
        model = GetFirewallResponse()
        if include_optional:
    ...
    def testGetFirewallResponse(self):
        """Test GetFirewallResponse"""
