...
class TestGetPredictionSetResponse(unittest.TestCase):
    """GetPredictionSetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPredictionSetResponse:
        """Test GetPredictionSetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPredictionSetResponse`
        """
        model = GetPredictionSetResponse()
        if include_optional:
            return GetPredictionSetResponse(
                prediction = ri.apiclient.models.prediction/prediction.prediction.Prediction(
    ...
    def testGetPredictionSetResponse(self):
        """Test GetPredictionSetResponse"""
