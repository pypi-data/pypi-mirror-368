...
class TestIndividualRulesConfig(unittest.TestCase):
    """IndividualRulesConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndividualRulesConfig:
        """Test IndividualRulesConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndividualRulesConfig`
        """
        model = IndividualRulesConfig()
        if include_optional:
            return IndividualRulesConfig(
    ...
    def testIndividualRulesConfig(self):
        """Test IndividualRulesConfig"""
