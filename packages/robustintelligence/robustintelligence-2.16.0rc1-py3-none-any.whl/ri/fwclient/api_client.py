...
from ri.fwclient.api_response import ApiResponse, T as ApiResponseT
import ri.fwclient.models
from ri.fwclient import rest
from ri.fwclient.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ri.fwclient.models, klass)
