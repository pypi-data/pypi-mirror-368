...
class YaraConfig(BaseModel):
    ...
    YaraConfig
    """ # noqa: E501
    rime_yara_git_ref: Optional[StrictStr] = Field(default=None, description="Git ref of the rime-yara repo to load for the YARA server. This is the primary lever for updating the YARA version and for hotfixing the firewall in general.", alias="rimeYaraGitRef")
    __properties: ClassVar[List[str]] = ["rimeYaraGitRef"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of YaraConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of YaraConfig from a dict"""
        if obj is None:
            return None
