...
class ProcessedRequest(BaseModel):
    ...
    ProcessedRequest
    """ # noqa: E501
    input_text_sha: Optional[StrictStr] = Field(default=None, description="Information about the `user_input_text`. The raw input is truncated if it exceeds a certain token length so we do not denial of service downstream logging and data systems.", alias="inputTextSha")
    input_tokens: Optional[StrictInt] = Field(default=None, alias="inputTokens")
    output_text_sha: Optional[StrictStr] = Field(default=None, description="Information about the `output_text`. The output text is truncated if it exceeds a certain token length so we do not denial of service downstream logging and data systems.", alias="outputTextSha")
    output_tokens: Optional[StrictInt] = Field(default=None, alias="outputTokens")
    __properties: ClassVar[List[str]] = ["inputTextSha", "inputTokens", "outputTextSha", "outputTokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputTextSha": obj.get("inputTextSha"),
            "inputTokens": obj.get("inputTokens"),
            "outputTextSha": obj.get("outputTextSha"),
