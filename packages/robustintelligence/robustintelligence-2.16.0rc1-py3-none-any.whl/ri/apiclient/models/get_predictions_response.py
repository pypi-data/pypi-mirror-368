...
class GetPredictionsResponse(BaseModel):
    ...
    """ # noqa: E501
    predictions: Optional[List[DatacollectorPrediction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "predictions": [DatacollectorPrediction.from_dict(_item) for _item in obj["predictions"]] if obj.get("predictions") is not None else None
        })
        return _obj
