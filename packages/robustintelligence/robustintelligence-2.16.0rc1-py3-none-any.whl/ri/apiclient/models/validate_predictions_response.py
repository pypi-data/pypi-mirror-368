...
class ValidatePredictionsResponse(BaseModel):
    """
    ValidatePredictionsResponse
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, alias="errorMessage")
    is_valid: Optional[StrictBool] = Field(default=None, alias="isValid")
    validation_status: Optional[ValidityStatus] = None
    __properties: ClassVar[List[str]] = ["errorMessage", "isValid", "validationStatus"]
