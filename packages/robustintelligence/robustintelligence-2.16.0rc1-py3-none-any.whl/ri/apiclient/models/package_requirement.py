...
class PackageRequirement(BaseModel):
    ...
    package_type: Optional[ManagedImagePackageType] = None
    version_specifier: Optional[StrictStr] = Field(default=None, alias="versionSpecifier")
    __properties: ClassVar[List[str]] = ["name", "packageType", "versionSpecifier"]
