...
class CreateAgentResponse(BaseModel):
    ...
    config: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, description="File that contains configuration values for installing the agent.")
    __properties: ClassVar[List[str]] = ["agentId", "config"]
