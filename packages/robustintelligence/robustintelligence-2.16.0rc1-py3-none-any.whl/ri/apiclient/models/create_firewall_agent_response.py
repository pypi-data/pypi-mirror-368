...
class CreateFirewallAgentResponse(BaseModel):
    """
    CreateFirewallAgentResponse
    """ # noqa: E501
    agent_id: Optional[ID] = Field(default=None, alias="agentId")
    api_token: Optional[StrictStr] = Field(default=None, description="The API token used by the agent for registration.", alias="apiToken")
    __properties: ClassVar[List[str]] = ["agentId", "apiToken"]
