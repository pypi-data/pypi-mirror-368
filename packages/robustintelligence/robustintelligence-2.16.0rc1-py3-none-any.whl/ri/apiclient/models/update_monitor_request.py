...
class UpdateMonitorRequest(BaseModel):
    ...
    """ # noqa: E501
    mask: Optional[StrictStr] = Field(default=None, description="The field mask.")
    monitor: Optional[UpdateMonitorRequestMonitor] = None
    __properties: ClassVar[List[str]] = ["mask", "monitor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mask": obj.get("mask"),
            "monitor": UpdateMonitorRequestMonitor.from_dict(obj["monitor"]) if obj.get("monitor") is not None else None
        })
        return _obj
