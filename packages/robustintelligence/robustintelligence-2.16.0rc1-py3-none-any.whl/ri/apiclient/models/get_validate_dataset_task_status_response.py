...
class GetValidateDatasetTaskStatusResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resp": ValidateDatasetResponse.from_dict(obj["resp"]) if obj.get("resp") is not None else None
        })
        return _obj
