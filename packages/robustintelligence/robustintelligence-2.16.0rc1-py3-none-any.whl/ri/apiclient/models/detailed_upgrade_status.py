...
class DetailedUpgradeStatus(BaseModel):
    """
    DetailedUpgradeStatus is an UpgradeStatus with additional information.
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="The error message if the status is failed.", alias="errorMessage")
    last_update_time: datetime = Field(alias="lastUpdateTime")
    status: Optional[UpgradeStatus] = None
    __properties: ClassVar[List[str]] = ["errorMessage", "lastUpdateTime", "status"]
