...
class UpdateUserOfProjectRequestUser(BaseModel):
    """
    Specifies a User ID and a corresponding Role.
    """ # noqa: E501
    user_id: Optional[Dict[str, Any]] = Field(default=None, description="Unique ID of an object in RIME.", alias="userId")
    user_role: Optional[ActorRole] = None
    __properties: ClassVar[List[str]] = ["userId", "userRole"]
