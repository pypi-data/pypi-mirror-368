...
class UpdateUserOfWorkspaceRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["user", "workspaceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": UpdateUserOfProjectRequestUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
