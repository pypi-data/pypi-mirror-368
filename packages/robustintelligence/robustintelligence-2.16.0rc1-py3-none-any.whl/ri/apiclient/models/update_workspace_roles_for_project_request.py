...
class UpdateWorkspaceRolesForProjectRequest(BaseModel):
    """
    ...
    role_pairs: List[ParentRoleSubjectRolePair] = Field(description="The elements of role_pairs maps each Workspace role to a Project role. For example, you can specify that a user with admin rights on a Workspace will get viewer rights on Projects in that Workspace.", alias="rolePairs")
