...
class SyncImageTagResponse(BaseModel):
    """
    SyncImageTagResponse
    """ # noqa: E501
    image: Optional[ManagedImage] = None
    job: Optional[JobMetadata] = None
    __properties: ClassVar[List[str]] = ["image", "job"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": ManagedImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "job": JobMetadata.from_dict(obj["job"]) if obj.get("job") is not None else None
        })
        return _obj
