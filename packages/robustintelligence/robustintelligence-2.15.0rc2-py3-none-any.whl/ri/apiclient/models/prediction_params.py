...
class PredictionParams(BaseModel):
    ...
    pred_col: Optional[StrictStr] = Field(default=None, description="Column used for predictions.", alias="predCol")
    timestamp_col: Optional[StrictStr] = Field(default=None, description="Column used for CT timestamp.", alias="timestampCol")
    __properties: ClassVar[List[str]] = ["experimentalFields", "predCol", "timestampCol"]
