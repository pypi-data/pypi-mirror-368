...
class ConfigureIntegrationRequest(BaseModel):
    ...
    """ # noqa: E501
    integration_id: Optional[Dict[str, Any]] = Field(default=None, description="Unique ID of an object in RIME.", alias="integrationId")
    variables: List[ConfigureIntegrationRequestIntegrationVariable]
    __properties: ClassVar[List[str]] = ["integrationId", "variables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "variables": [ConfigureIntegrationRequestIntegrationVariable.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None
        })
        return _obj
