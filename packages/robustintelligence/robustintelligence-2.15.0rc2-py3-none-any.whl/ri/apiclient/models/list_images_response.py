...
class ListImagesResponse(BaseModel):
    ...
    ListImagesResponse
    """ # noqa: E501
    images: Optional[List[ManagedImage]] = None
    next_page_token: Optional[StrictStr] = Field(default=None, alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["images", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "images": [ManagedImage.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
