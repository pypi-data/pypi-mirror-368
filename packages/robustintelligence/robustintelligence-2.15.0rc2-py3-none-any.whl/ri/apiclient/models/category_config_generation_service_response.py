...
class CategoryConfigGenerationServiceResponse(BaseModel):
    """
    CategoryConfigGenerationServiceResponse
    """ # noqa: E501
    continuous_test_categories: Optional[List[TestCategoryType]] = Field(default=None, alias="continuousTestCategories")
    stress_test_categories: Optional[List[TestCategoryType]] = Field(default=None, alias="stressTestCategories")
    __properties: ClassVar[List[str]] = ["continuousTestCategories", "stressTestCategories"]
