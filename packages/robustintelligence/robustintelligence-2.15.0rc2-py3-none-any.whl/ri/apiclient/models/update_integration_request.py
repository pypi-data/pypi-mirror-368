...
class UpdateIntegrationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["integration", "mask"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integration": UpdateIntegrationRequestIntegration.from_dict(obj["integration"]) if obj.get("integration") is not None else None,
            "mask": obj.get("mask")
        })
        return _obj
