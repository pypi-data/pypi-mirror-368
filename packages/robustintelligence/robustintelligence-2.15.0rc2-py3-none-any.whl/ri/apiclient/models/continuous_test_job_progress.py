...
class ContinuousTestJobProgress(BaseModel):
    """
    ContinuousTestJobProgress
    """ # noqa: E501
    test_runs: Optional[List[ContinuousTestRunProgress]] = Field(default=None, alias="testRuns")
    __properties: ClassVar[List[str]] = ["testRuns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testRuns": [ContinuousTestRunProgress.from_dict(_item) for _item in obj["testRuns"]] if obj.get("testRuns") is not None else None
        })
        return _obj
