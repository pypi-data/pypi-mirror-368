...
class GetFeatureFlagsResponse(BaseModel):
    ...
    """ # noqa: E501
    feature_flags: Optional[FeatureFlags] = Field(default=None, alias="featureFlags")
    __properties: ClassVar[List[str]] = ["featureFlags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "featureFlags": FeatureFlags.from_dict(obj["featureFlags"]) if obj.get("featureFlags") is not None else None
        })
        return _obj
