...
class LanguageSubstring(BaseModel):
    """
    LanguageSubstring
    """ # noqa: E501
    flagged_substring: Optional[FlaggedSubstring] = Field(default=None, alias="flaggedSubstring")
    language_code: Optional[StrictStr] = Field(default=None, description="Language code is the language code of the detected language according to the ISO 639-3 standard.", alias="languageCode")
    __properties: ClassVar[List[str]] = ["flaggedSubstring", "languageCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LanguageSubstring from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LanguageSubstring from a dict"""
        if obj is None:
            return None
