...
class CodeSubstring(BaseModel):
    """
    CodeSubstring
    """ # noqa: E501
    flagged_substring: Optional[FlaggedSubstring] = Field(default=None, alias="flaggedSubstring")
    language: Optional[StrictStr] = Field(default=None, description="Language is the programmatic language name of the detected code snippet.")
    __properties: ClassVar[List[str]] = ["flaggedSubstring", "language"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CodeSubstring from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CodeSubstring from a dict"""
        if obj is None:
            return None
