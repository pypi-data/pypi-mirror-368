...
class KubernetesResourceConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["limits", "maxReplicas", "minReplicas", "requests"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KubernetesResourceConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KubernetesResourceConfig from a dict"""
        if obj is None:
            return None
