...
class TestTestRunConfig(unittest.TestCase):
    """TestRunConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestRunConfig:
        """Test TestRunConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestRunConfig`
        """
        model = TestRunConfig()
        if include_optional:
