...
class TestPiiDetectionDetails(unittest.TestCase):
    """PiiDetectionDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PiiDetectionDetails:
        """Test PiiDetectionDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PiiDetectionDetails`
        """
        model = PiiDetectionDetails()
        if include_optional:
            return PiiDetectionDetails(
                flagged_entities = [
    ...
    def testPiiDetectionDetails(self):
        """Test PiiDetectionDetails"""
