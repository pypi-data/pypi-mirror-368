...
class TestUpdateMonitorResponse(unittest.TestCase):
    """UpdateMonitorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMonitorResponse:
        """Test UpdateMonitorResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMonitorResponse`
        """
...
Transformations take in a time series and output a time series(
    ...
    def testUpdateMonitorResponse(self):
        """Test UpdateMonitorResponse"""
