...
class TestDigestConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DigestConfig:
        """Test DigestConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DigestConfig`
        """
        model = DigestConfig()
        if include_optional:
            return DigestConfig(
