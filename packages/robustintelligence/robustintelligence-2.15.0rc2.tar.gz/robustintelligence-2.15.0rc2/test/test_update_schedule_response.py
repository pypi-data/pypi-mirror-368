...
class TestUpdateScheduleResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateScheduleResponse:
        """Test UpdateScheduleResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduleResponse`
        """
        model = UpdateScheduleResponse()
        if include_optional:
            return UpdateScheduleResponse(
                schedule = ri.apiclient.models.schedule.Schedule(
                    frequency_cron_expr = '', 
