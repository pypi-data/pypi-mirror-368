...
class TestStartFileScanResponse(unittest.TestCase):
    """StartFileScanResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartFileScanResponse:
        """Test StartFileScanResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartFileScanResponse`
        """
        model = StartFileScanResponse()
        if include_optional:
            return StartFileScanResponse(
    ...
    def testStartFileScanResponse(self):
        """Test StartFileScanResponse"""
