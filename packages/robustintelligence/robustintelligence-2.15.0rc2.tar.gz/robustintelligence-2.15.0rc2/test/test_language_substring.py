...
class TestLanguageSubstring(unittest.TestCase):
    """LanguageSubstring unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LanguageSubstring:
        """Test LanguageSubstring
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LanguageSubstring`
        """
        model = LanguageSubstring()
        if include_optional:
    ...
    def testLanguageSubstring(self):
        """Test LanguageSubstring"""
