...
class TestUpdateIntegrationRequestIntegration(unittest.TestCase):
    """UpdateIntegrationRequestIntegration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateIntegrationRequestIntegration:
        """Test UpdateIntegrationRequestIntegration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateIntegrationRequestIntegration`
        """
        model = UpdateIntegrationRequestIntegration()
        if include_optional:
            return UpdateIntegrationRequestIntegration(
                creation_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                id = None,
                level = 'INTEGRATION_LEVEL_UNSPECIFIED',
                name = '',
                var_schema = ri.apiclient.models.integration_schema.IntegrationSchema(
                    variables = [
...
https://docs.robustintelligence.com/en/latest/administration/workspace_configuration/integrations/configuring_integrations.html(
    ...
    def testUpdateIntegrationRequestIntegration(self):
        """Test UpdateIntegrationRequestIntegration"""
