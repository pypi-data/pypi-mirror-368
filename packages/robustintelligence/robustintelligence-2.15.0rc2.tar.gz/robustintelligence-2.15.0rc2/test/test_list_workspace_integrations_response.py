...
class TestListWorkspaceIntegrationsResponse(unittest.TestCase):
    """ListWorkspaceIntegrationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListWorkspaceIntegrationsResponse:
        """Test ListWorkspaceIntegrationsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListWorkspaceIntegrationsResponse`
        """
        model = ListWorkspaceIntegrationsResponse()
        if include_optional:
            return ListWorkspaceIntegrationsResponse(
                integration_infos = [
                    ri.apiclient.models.integration_info.IntegrationInfo(
                        configured = True, 
...
https://docs.robustintelligence.com/en/latest/administration/workspace_configuration/integrations/configuring_integrations.html(
    ...
    def testListWorkspaceIntegrationsResponse(self):
        """Test ListWorkspaceIntegrationsResponse"""
