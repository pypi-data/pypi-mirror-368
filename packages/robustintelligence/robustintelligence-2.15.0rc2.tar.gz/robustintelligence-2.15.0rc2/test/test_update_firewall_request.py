...
class TestUpdateFirewallRequest(unittest.TestCase):
    """UpdateFirewallRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFirewallRequest:
        """Test UpdateFirewallRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFirewallRequest`
        """
        model = UpdateFirewallRequest()
        if include_optional:
            return UpdateFirewallRequest(
                firewall = ri.apiclient.models.update_firewall_request_firewall.UpdateFirewall_request_firewall(
                    bin_size = '', 
    ...
    def testUpdateFirewallRequest(self):
        """Test UpdateFirewallRequest"""
