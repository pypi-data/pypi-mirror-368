...
class TestListGAITestJobResponse(unittest.TestCase):
    """ListGAITestJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGAITestJobResponse:
        """Test ListGAITestJobResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGAITestJobResponse`
        """
        model = ListGAITestJobResponse()
        if include_optional:
            return ListGAITestJobResponse(
                has_more = True,
                jobs = [
    ...
    def testListGAITestJobResponse(self):
        """Test ListGAITestJobResponse"""
