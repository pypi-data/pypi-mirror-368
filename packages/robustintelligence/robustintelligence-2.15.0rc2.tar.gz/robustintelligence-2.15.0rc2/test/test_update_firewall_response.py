...
class TestUpdateFirewallResponse(unittest.TestCase):
    """UpdateFirewallResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFirewallResponse:
        """Test UpdateFirewallResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFirewallResponse`
        """
        model = UpdateFirewallResponse()
        if include_optional:
            return UpdateFirewallResponse(
                firewall = ri.apiclient.models.firewall.Firewall(
                    bin_size = '', 
    ...
    def testUpdateFirewallResponse(self):
        """Test UpdateFirewallResponse"""
