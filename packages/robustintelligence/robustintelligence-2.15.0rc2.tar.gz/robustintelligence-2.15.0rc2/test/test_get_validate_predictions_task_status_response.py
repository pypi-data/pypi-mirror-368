...
class TestGetValidatePredictionsTaskStatusResponse(unittest.TestCase):
    """GetValidatePredictionsTaskStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetValidatePredictionsTaskStatusResponse:
        """Test GetValidatePredictionsTaskStatusResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetValidatePredictionsTaskStatusResponse`
        """
        model = GetValidatePredictionsTaskStatusResponse()
        if include_optional:
            return GetValidatePredictionsTaskStatusResponse(
                job_metadata = ri.apiclient.models.job_metadata.JobMetadata(
                ...
                resp = ri.apiclient.models.validate_predictions_response.ValidatePredictionsResponse(
                    error_message = '', 
                    is_valid = True, 
                    validation_status = 'VALIDITY_STATUS_UNSPECIFIED', )
            )
    ...
    def testGetValidatePredictionsTaskStatusResponse(self):
        """Test GetValidatePredictionsTaskStatusResponse"""
