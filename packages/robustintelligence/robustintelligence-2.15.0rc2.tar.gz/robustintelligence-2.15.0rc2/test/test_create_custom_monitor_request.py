...
class TestCreateCustomMonitorRequest(unittest.TestCase):
    """CreateCustomMonitorRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCustomMonitorRequest:
        """Test CreateCustomMonitorRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCustomMonitorRequest`
        """
        model = CreateCustomMonitorRequest()
        if include_optional:
            return CreateCustomMonitorRequest(
...
Transformations take in a time series and output a time series(
    ...
    def testCreateCustomMonitorRequest(self):
        """Test CreateCustomMonitorRequest"""
