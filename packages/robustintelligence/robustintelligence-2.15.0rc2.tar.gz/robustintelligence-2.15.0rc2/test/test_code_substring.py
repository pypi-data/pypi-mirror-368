...
class TestCodeSubstring(unittest.TestCase):
    """CodeSubstring unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodeSubstring:
        """Test CodeSubstring
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeSubstring`
        """
        model = CodeSubstring()
        if include_optional:
