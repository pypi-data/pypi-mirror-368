...
class TestListDetectionEventsResponse(unittest.TestCase):
    """ListDetectionEventsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDetectionEventsResponse:
        """Test ListDetectionEventsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDetectionEventsResponse`
        """
        model = ListDetectionEventsResponse()
        if include_optional:
            return ListDetectionEventsResponse(
                events = [
                    ri.apiclient.models.detection_event.DetectionEvent(
                        description = '', 
                        description_html = '', 
    ...
    def testListDetectionEventsResponse(self):
        """Test ListDetectionEventsResponse"""
