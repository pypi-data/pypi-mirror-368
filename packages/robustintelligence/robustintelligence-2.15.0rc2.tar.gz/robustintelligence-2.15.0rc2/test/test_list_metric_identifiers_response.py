...
class TestListMetricIdentifiersResponse(unittest.TestCase):
    """ListMetricIdentifiersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMetricIdentifiersResponse:
        """Test ListMetricIdentifiersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMetricIdentifiersResponse`
        """
        model = ListMetricIdentifiersResponse()
        if include_optional:
            return ListMetricIdentifiersResponse(
                aggregated_metrics = [
                    ri.apiclient.models.aggregated_metric_is_a_metric_that_doesn't_have_a_subset_or_a_metric/
currently_could_map_to_a_test_case_metric_identifier_without_a_feature
or_a_category_test_identifier.AggregatedMetric is a metric that doesn't have a subset or a metric.
Currently could map to a TestCaseMetricIdentifier without a feature
or a CategoryTestIdentifier(
                ...
                feature_metrics = {
                    'key' : ri.apiclient.models.feature_metrics_contain_all_metric_ids_for_a_particular_feature.FeatureMetrics contain all metric IDs for a particular feature(
...
We can specify TestCaseMetricIdentifier as:
{
   ...
   metric = 'names',
    ...
    def testListMetricIdentifiersResponse(self):
        """Test ListMetricIdentifiersResponse"""
