...
class TestProjectWithDetails(unittest.TestCase):
    """ProjectWithDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectWithDetails:
        """Test ProjectWithDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectWithDetails`
        """
        model = ProjectWithDetails()
        if include_optional:
...
to provide identity of the owner of the Project(
                    email = '', 
                    name = '', ),
                project = ri.apiclient.models.project.Project(
    ...
    def testProjectWithDetails(self):
        """Test ProjectWithDetails"""
