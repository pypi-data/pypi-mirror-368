...
class TestUpdateMonitorRequestMonitor(unittest.TestCase):
    """UpdateMonitorRequestMonitor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMonitorRequestMonitor:
        """Test UpdateMonitorRequestMonitor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMonitorRequestMonitor`
        """
        model = UpdateMonitorRequestMonitor()
        if include_optional:
            return UpdateMonitorRequestMonitor(
...
Transformations take in a time series and output a time series(
    ...
    def testUpdateMonitorRequestMonitor(self):
        """Test UpdateMonitorRequestMonitor"""
