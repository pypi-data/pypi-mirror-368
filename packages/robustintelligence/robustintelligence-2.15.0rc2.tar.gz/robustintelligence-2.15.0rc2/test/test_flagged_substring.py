...
class TestFlaggedSubstring(unittest.TestCase):
    """FlaggedSubstring unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlaggedSubstring:
        """Test FlaggedSubstring
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlaggedSubstring`
        """
        model = FlaggedSubstring()
        if include_optional:
            return FlaggedSubstring(
