...
class TestGuardrailScanRuleset(unittest.TestCase):
    """GuardrailScanRuleset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuardrailScanRuleset:
        """Test GuardrailScanRuleset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuardrailScanRuleset`
        """
        model = GuardrailScanRuleset()
        if include_optional:
            return GuardrailScanRuleset(
                name = ''
            )
        else:
            return GuardrailScanRuleset(
    ...
    def testGuardrailScanRuleset(self):
        """Test GuardrailScanRuleset"""
