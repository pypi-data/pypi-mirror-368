...
class TestYaraVersionInfo(unittest.TestCase):
    """YaraVersionInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YaraVersionInfo:
        """Test YaraVersionInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YaraVersionInfo`
        """
        model = YaraVersionInfo()
        if include_optional:
            return YaraVersionInfo(
                git_ref = '',
                latest_commit_hash = ''
            )
        else:
