...
class TestGetValidateDatasetTaskStatusResponse(unittest.TestCase):
    """GetValidateDatasetTaskStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetValidateDatasetTaskStatusResponse:
        """Test GetValidateDatasetTaskStatusResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetValidateDatasetTaskStatusResponse`
        """
        model = GetValidateDatasetTaskStatusResponse()
        if include_optional:
            return GetValidateDatasetTaskStatusResponse(
                ...
                resp = ri.apiclient.models.validate_dataset_response.ValidateDatasetResponse(
                    error_message = '', 
                    is_valid = True, 
                    size_bytes = '', 
                    validation_status = 'VALIDITY_STATUS_UNSPECIFIED', )
    ...
    def testGetValidateDatasetTaskStatusResponse(self):
        """Test GetValidateDatasetTaskStatusResponse"""
