...
class TestGenerativevalidationListTestRunsResponse(unittest.TestCase):
    """GenerativevalidationListTestRunsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerativevalidationListTestRunsResponse:
        """Test GenerativevalidationListTestRunsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerativevalidationListTestRunsResponse`
        """
        model = GenerativevalidationListTestRunsResponse()
        if include_optional:
            return GenerativevalidationListTestRunsResponse(
                has_more = True,
                next_page_token = '',
                test_runs = [
                    ri.apiclient.models.generative_validation_test_run.GenerativeValidationTestRun(
                        attempted_attacks = 56, 
                        config = ri.apiclient.models.generative_validation_config.GenerativeValidationConfig(
                            config_id = '', 
                        ...
                        id = ri.apiclient.models.id.ID(
                            uuid = '', ), 
                        job_info = ri.apiclient.models.job_info.JobInfo(
    ...
    def testGenerativevalidationListTestRunsResponse(self):
        """Test GenerativevalidationListTestRunsResponse"""
