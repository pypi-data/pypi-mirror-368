...
class TestArtifactIdentifier(unittest.TestCase):
    """ArtifactIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtifactIdentifier:
        """Test ArtifactIdentifier
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtifactIdentifier`
        """
        model = ArtifactIdentifier()
        if include_optional:
...
We can specify TestCaseMetricIdentifier as:
{
   ...
   metric = 'names',
    ...
    def testArtifactIdentifier(self):
        """Test ArtifactIdentifier"""
