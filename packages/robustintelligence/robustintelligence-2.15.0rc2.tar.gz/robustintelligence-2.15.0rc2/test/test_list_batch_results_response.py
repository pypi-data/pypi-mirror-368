...
class TestListBatchResultsResponse(unittest.TestCase):
    """ListBatchResultsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBatchResultsResponse:
        """Test ListBatchResultsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListBatchResultsResponse`
        """
        model = ListBatchResultsResponse()
        if include_optional:
            return ListBatchResultsResponse(
                has_more = True,
                next_page_token = '',
                test_batches = [
                    ri.apiclient.models.testrunresult/test_batch_result.testrunresult.TestBatchResult(
                        category = '', 
                        description = '', 
    ...
    def testListBatchResultsResponse(self):
        """Test ListBatchResultsResponse"""
