...
class TestRunProgress(BaseModel):
    ...
    test_batches: Optional[List[TestBatchProgress]] = Field(default=None, alias="testBatches")
    test_run_id: Optional[StrictStr] = Field(default=None, alias="testRunId")
    __properties: ClassVar[List[str]] = ["status", "testBatches", "testRunId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testBatches": [TestBatchProgress.from_dict(_item) for _item in obj["testBatches"]] if obj.get("testBatches") is not None else None,
