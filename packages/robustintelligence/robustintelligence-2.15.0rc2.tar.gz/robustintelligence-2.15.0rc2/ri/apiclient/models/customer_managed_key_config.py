...
class CustomerManagedKeyConfig(BaseModel):
    """
    ...
    kms_key_arn: StrictStr = Field(description="The ARN of the AWS KMS key to use as the customer managed key.", alias="kmsKeyArn")
    __properties: ClassVar[List[str]] = ["keyProvider", "kmsKeyArn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keyProvider": obj.get("keyProvider"),
