...
class StorePredictionsRequestPrediction(BaseModel):
    """
    StorePredictionsRequestPrediction
    """ # noqa: E501
    datapoint_id: Optional[ID] = Field(default=None, alias="datapointId")
    prediction: Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]] = Field(description="A JSON-encoded prediction dictionary.")
    __properties: ClassVar[List[str]] = ["datapointId", "prediction"]
