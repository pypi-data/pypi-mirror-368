...
class IntegrationSchema(BaseModel):
    ...
    IntegrationSchema
    """ # noqa: E501
    variables: Optional[List[IntegrationIntegrationVariable]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "variables": [IntegrationIntegrationVariable.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None
        })
        return _obj
