...
class CreateCustomerManagedKeyResponse(BaseModel):
    """
    CreateCustomerManagedKeyResponse
    """ # noqa: E501
    cmk_config: Optional[CustomerManagedKeyConfig] = Field(default=None, alias="cmkConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cmkConfig": CustomerManagedKeyConfig.from_dict(obj["cmkConfig"]) if obj.get("cmkConfig") is not None else None
        })
        return _obj
