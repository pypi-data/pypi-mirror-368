...
class StartContinuousTestRequest(BaseModel):
    """
    ...
    firewall_id: Optional[Dict[str, Any]] = Field(default=None, description="Uniquely specifies a Firewall.", alias="firewallId")
    override_existing_bins: Optional[StrictBool] = Field(default=None, alias="overrideExistingBins")
    test_run_incremental_config: Optional[TestRunIncrementalConfig] = Field(default=None, alias="testRunIncrementalConfig")
    __properties: ClassVar[List[str]] = ["agentId", "experimentalFields", "firewallId", "overrideExistingBins", "testRunIncrementalConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of test_run_incremental_config
        if self.test_run_incremental_config:
            _dict['testRunIncrementalConfig'] = self.test_run_incremental_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overrideExistingBins": obj.get("overrideExistingBins"),
            "testRunIncrementalConfig": TestRunIncrementalConfig.from_dict(obj["testRunIncrementalConfig"]) if obj.get("testRunIncrementalConfig") is not None else None
        })
        return _obj
