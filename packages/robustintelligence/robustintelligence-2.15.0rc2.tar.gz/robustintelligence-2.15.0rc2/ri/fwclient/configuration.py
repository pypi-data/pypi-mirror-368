...
conf = ri.fwclient.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://https://<ai-firewall-domain>.rbst.io" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ri.fwclient")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'X-Firewall-Auth-Token' in self.api_key:
            auth['X-Firewall-Auth-Token'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Firewall-Auth-Token',
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "http://https://<ai-firewall-domain>.rbst.io",
                'description': "No description provided",
            },
            {
                'url': "https://https://<ai-firewall-domain>.rbst.io",
                'description': "No description provided",
            }
        ]
