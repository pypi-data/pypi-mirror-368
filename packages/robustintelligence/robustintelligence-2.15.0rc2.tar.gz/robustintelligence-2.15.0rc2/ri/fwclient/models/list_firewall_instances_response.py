...
class ListFirewallInstancesResponse(BaseModel):
    """
    ListFirewallInstancesResponse
    """ # noqa: E501
    firewall_instances: Optional[List[FirewallInstanceInfo]] = Field(default=None, alias="firewallInstances")
    __properties: ClassVar[List[str]] = ["firewallInstances"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in firewall_instances (list)
        _items = []
        if self.firewall_instances:
            for _item in self.firewall_instances:
                if _item:
                    _items.append(_item.to_dict())
            _dict['firewallInstances'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "firewallInstances": [FirewallInstanceInfo.from_dict(_item) for _item in obj["firewallInstances"]] if obj.get("firewallInstances") is not None else None
        })
        return _obj
