...
class TextClassificationPred(BaseModel):
    """
    TextClassificationPred
    """ # noqa: E501
    scores: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="Vector of scores, sorted by class index.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TextClassificationPred from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TextClassificationPred from a dict"""
        if obj is None:
            return None
