...
class GuardrailScanRuleset(BaseModel):
    """
    This conforms to the `guardrailRequest` schema in AI Defense. protolint:disable MAX_LINE_LENGTH https://github.com/cisco-sbg/ai-firewall-services/blob/b5161bc8eb5a271d4cf5238d418d7ecbf1575c63/orchestrator/guardrails/types.go#L65-L68.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GuardrailScanRuleset from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GuardrailScanRuleset from a dict"""
        if obj is None:
            return None
