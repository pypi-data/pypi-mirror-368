...
class RulesetConfig(BaseModel):
    ...
    sensitivity: Optional[ApiGenerativefirewallRuleSensitivity] = None
    __properties: ClassVar[List[str]] = ["name", "sensitivity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RulesetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RulesetConfig from a dict"""
        if obj is None:
            return None
