...
T = TypeVar("T", bound="ModelAmendOrderResponse")


@_attrs_define
class ModelAmendOrderResponse:
    """
    Attributes:
    ...
    old_order: Union[Unset, "ModelOrder"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_old_order, Unset):
            ...
            old_order = ModelOrder.from_dict(_old_order)
        ...
        model_amend_order_response = cls(
            old_order=old_order,
            order=order,
        )

        model_amend_order_response.additional_properties = d
        return model_amend_order_response
