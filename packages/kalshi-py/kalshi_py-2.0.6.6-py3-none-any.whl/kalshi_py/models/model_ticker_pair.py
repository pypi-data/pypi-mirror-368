...
from ..models.model_ticker_pair_side import ModelTickerPairSide
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelTickerPair")


@_attrs_define
class ModelTickerPair:
    """
    Attributes:
        event_ticker (Union[Unset, str]): Event ticker identifier.
        market_ticker (Union[Unset, str]): Market ticker identifier.
        side (Union[Unset, ModelTickerPairSide]): Side of the market (yes or no).
    """

    event_ticker: Union[Unset, str] = UNSET
    market_ticker: Union[Unset, str] = UNSET
    side: Union[Unset, ModelTickerPairSide] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_side, Unset):
            ...
            side = ModelTickerPairSide(_side)

        model_ticker_pair = cls(
            event_ticker=event_ticker,
            market_ticker=market_ticker,
            side=side,
        )

        model_ticker_pair.additional_properties = d
        return model_ticker_pair
