...
T = TypeVar("T", bound="ModelGetOrderQueuePositionsResponseQueuePositionsItem")


@_attrs_define
class ModelGetOrderQueuePositionsResponseQueuePositionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_get_order_queue_positions_response_queue_positions_item = cls(
            market_ticker=market_ticker,
            order_id=order_id,
            queue_position=queue_position,
        )

        model_get_order_queue_positions_response_queue_positions_item.additional_properties = d
        return model_get_order_queue_positions_response_queue_positions_item
