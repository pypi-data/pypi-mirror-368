...
T = TypeVar("T", bound="ModelGetExchangeAnnouncementsResponseAnnouncementsItem")


@_attrs_define
class ModelGetExchangeAnnouncementsResponseAnnouncementsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_get_exchange_announcements_response_announcements_item = cls(
        ...
        model_get_exchange_announcements_response_announcements_item.additional_properties = d
        return model_get_exchange_announcements_response_announcements_item
