...
from ..models.model_get_settlements_response_settlements_item_market_result import (
    ModelGetSettlementsResponseSettlementsItemMarketResult,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelGetSettlementsResponseSettlementsItem")


@_attrs_define
class ModelGetSettlementsResponseSettlementsItem:
    """
    Attributes:
    ...
    market_result: Union[Unset, ModelGetSettlementsResponseSettlementsItemMarketResult] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_market_result, Unset):
            ...
            market_result = ModelGetSettlementsResponseSettlementsItemMarketResult(_market_result)
        ...
        model_get_settlements_response_settlements_item = cls(
        ...
        model_get_settlements_response_settlements_item.additional_properties = d
        return model_get_settlements_response_settlements_item
