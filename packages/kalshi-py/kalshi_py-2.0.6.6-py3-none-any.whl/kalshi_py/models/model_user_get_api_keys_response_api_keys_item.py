...
T = TypeVar("T", bound="ModelUserGetApiKeysResponseApiKeysItem")


@_attrs_define
class ModelUserGetApiKeysResponseApiKeysItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_user_get_api_keys_response_api_keys_item = cls(
            api_key_id=api_key_id,
            created_ts=created_ts,
            name=name,
        )

        model_user_get_api_keys_response_api_keys_item.additional_properties = d
        return model_user_get_api_keys_response_api_keys_item
