...
from ...models.model_get_exchange_schedule_response import ModelGetExchangeScheduleResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ModelGetExchangeScheduleResponse.from_dict(response.json())
