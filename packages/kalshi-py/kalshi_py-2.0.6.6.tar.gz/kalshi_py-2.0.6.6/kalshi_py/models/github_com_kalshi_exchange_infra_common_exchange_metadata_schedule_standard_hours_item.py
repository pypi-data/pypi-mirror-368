...
if TYPE_CHECKING:
    ...
    from ..models.github_com_kalshi_exchange_infra_common_exchange_metadata_schedule_standard_hours_item_monday_item import (
        GithubComKalshiExchangeInfraCommonExchangeMetadataScheduleStandardHoursItemMondayItem,
    )


T = TypeVar("T", bound="GithubComKalshiExchangeInfraCommonExchangeMetadataScheduleStandardHoursItem")


@_attrs_define
class GithubComKalshiExchangeInfraCommonExchangeMetadataScheduleStandardHoursItem:
    """
    Attributes:
        ...
        monday (Union[Unset,
            list['GithubComKalshiExchangeInfraCommonExchangeMetadataScheduleStandardHoursItemMondayItem']]): Trading hours
            for Monday. May contain multiple sessions.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_com_kalshi_exchange_infra_common_exchange_metadata_schedule_standard_hours_item = cls(
            end_time=end_time,
            friday=friday,
            monday=monday,
            saturday=saturday,
        ...
        github_com_kalshi_exchange_infra_common_exchange_metadata_schedule_standard_hours_item.additional_properties = d
        return github_com_kalshi_exchange_infra_common_exchange_metadata_schedule_standard_hours_item
