...
T = TypeVar("T", bound="ModelGetPositionsResponseEventPositionsItem")


@_attrs_define
class ModelGetPositionsResponseEventPositionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_get_positions_response_event_positions_item = cls(
        ...
        model_get_positions_response_event_positions_item.additional_properties = d
        return model_get_positions_response_event_positions_item
