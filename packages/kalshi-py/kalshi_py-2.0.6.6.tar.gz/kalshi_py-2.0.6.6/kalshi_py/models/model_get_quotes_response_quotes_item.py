...
T = TypeVar("T", bound="ModelGetQuotesResponseQuotesItem")


@_attrs_define
class ModelGetQuotesResponseQuotesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_get_quotes_response_quotes_item = cls(
        ...
        model_get_quotes_response_quotes_item.additional_properties = d
        return model_get_quotes_response_quotes_item
