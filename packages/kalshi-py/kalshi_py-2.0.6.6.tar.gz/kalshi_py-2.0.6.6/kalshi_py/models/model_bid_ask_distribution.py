...
T = TypeVar("T", bound="ModelBidAskDistribution")


@_attrs_define
class ModelBidAskDistribution:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_bid_ask_distribution = cls(
            close=close,
        ...
        model_bid_ask_distribution.additional_properties = d
        return model_bid_ask_distribution
