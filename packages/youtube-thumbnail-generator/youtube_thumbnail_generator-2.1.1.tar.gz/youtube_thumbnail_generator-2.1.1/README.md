...
#### Chinese Sample
![Chinese Thumbnail Sample](https://raw.githubusercontent.com/preangelleo/youtube-thumbnail-generator/main/template_samples/chinese_sample_template_1.jpg)

*Shows Chinese title "终极人工智能技术革命完整指南" with smart 9-character line-breaking, professional layout with logo and right-side image.*

#### English Sample  
![English Thumbnail Sample](https://raw.githubusercontent.com/preangelleo/youtube-thumbnail-generator/main/template_samples/english_sample_template_1.jpg)

*Shows English title "The Ultimate Complete Guide to Advanced AI Technology" with word-based line-breaking, same professional template.*

> **Note**: If images don't display on PyPI, visit the [GitHub repository](https://github.com/preangelleo/youtube-thumbnail-generator) to see the full template showcase.
