...
/* @@protoc_insertion_point(class_definition:xla.cpu.FusionBackendConfig) */ {
 ...
 public:
  ...
  [[nodiscard]] ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NULLABLE release_xnn_fusion_config();
  ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NONNULL mutable_xnn_fusion_config();
  void set_allocated_xnn_fusion_config(::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NULLABLE value);
  void unsafe_arena_set_allocated_xnn_fusion_config(::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NULLABLE value);
  ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NULLABLE unsafe_arena_release_xnn_fusion_config();

  private:
  const ::xla::cpu::XnnFusionBackendConfig& _internal_xnn_fusion_config() const;
  ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NONNULL _internal_mutable_xnn_fusion_config();
 ...
 private:
  ...
  struct Impl_ {
    ...
    union CustomFusionConfigOneofUnion {
      ...
      ::google::protobuf::internal::ConstantInitialized _constinit_;
      ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NULLABLE xnn_fusion_config_;
...
inline ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NULLABLE FusionBackendConfig::release_xnn_fusion_config() {
...
inline ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NULLABLE FusionBackendConfig::unsafe_arena_release_xnn_fusion_config() {
...
inline void FusionBackendConfig::unsafe_arena_set_allocated_xnn_fusion_config(
    ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NULLABLE value) {
...
inline ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NONNULL FusionBackendConfig::_internal_mutable_xnn_fusion_config() {
  if (custom_fusion_config_oneof_case() != kXnnFusionConfig) {
    clear_custom_fusion_config_oneof();
    set_has_xnn_fusion_config();
...
inline ::xla::cpu::XnnFusionBackendConfig* PROTOBUF_NONNULL FusionBackendConfig::mutable_xnn_fusion_config()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
