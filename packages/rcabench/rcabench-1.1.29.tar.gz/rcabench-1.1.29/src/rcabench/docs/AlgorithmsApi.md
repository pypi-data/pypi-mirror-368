...
> DtoGenericResponseDtoAlgorithmResultUploadResponse api_v2_algorithms_algorithm_id_results_post(algorithm_id, request, execution_id=execution_id)
...
with rcabench.openapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload granularity algorithm results
        api_response = api_instance.api_v2_algorithms_algorithm_id_results_post(algorithm_id, request, execution_id=execution_id)
