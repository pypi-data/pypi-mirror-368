...
class CustomOAuth2ClientRegistration(object):
    ...
    def __init__(self, registration_id=None, provider=None, issuer_url=None, client_id=None, client_secret=None, scope=None, is_system_configured=None, login_button_text=None, system_configured=None, secrets_uid=None):  # noqa: E501
