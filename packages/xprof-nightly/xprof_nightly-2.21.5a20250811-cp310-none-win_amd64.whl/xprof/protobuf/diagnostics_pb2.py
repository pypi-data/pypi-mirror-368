...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'plugin.xprof.protobuf.diagnostics_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _DIAGNOSTICS._serialized_start=64
  _DIAGNOSTICS._serialized_end=125
