...
class JobMessage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aether_job", b"aether_job", "insight_job", b"insight_job", "job", b"job", "org", b"org", "simulator_job", b"simulator_job"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aether_job", b"aether_job", "id", b"id", "insight_job", b"insight_job", "job", b"job", "org", b"org", "simulator_job", b"simulator_job"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["job", b"job"]) -> typing.Literal["aether_job", "insight_job", "simulator_job"] | None: ...
...
class SimulatorJob(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_test_suite", b"_test_suite", "agent_config", b"agent_config", "insight_agent", b"insight_agent", "test_suite", b"test_suite"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_test_suite", b"_test_suite", "agent", b"agent", "agent_config", b"agent_config", "id", b"id", "inputs", b"inputs", "insight_agent", b"insight_agent", "test_suite", b"test_suite"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_test_suite", b"_test_suite"]) -> typing.Literal["test_suite"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["agent_config", b"agent_config"]) -> typing.Literal["insight_agent"] | None: ...
...
class InsightAgentConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["command_config", b"command_config", "investigate", b"investigate", "run_agent", b"run_agent"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["command_config", b"command_config", "investigate", b"investigate", "run_agent", b"run_agent"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["command_config", b"command_config"]) -> typing.Literal["investigate", "run_agent"] | None: ...
