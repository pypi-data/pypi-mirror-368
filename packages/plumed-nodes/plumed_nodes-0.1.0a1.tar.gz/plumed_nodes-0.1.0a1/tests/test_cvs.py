...
def test_distance_cv_first_strategy(small_ethnol_water):
    ...
    distance_cv = pn.DistanceCV(
        ...
        x2=x2_selector,
        prefix="d12",
        multi_group=pn.MultiGroupStrategy.FIRST,
    )

    labels, plumed_str = distance_cv.to_plumed(small_ethnol_water)

    expected = """d12_g1_0_com: COM ATOMS=1,2,3,4,5,6,7,8,9
...
def test_distance_cv_all_pairs(small_ethnol_water):
    ...
    distance_cv = pn.DistanceCV(
        ...
        x2=x2_selector,
        prefix="d",
        multi_group=pn.MultiGroupStrategy.ALL_PAIRS,
    )

    labels, plumed_str = distance_cv.to_plumed(small_ethnol_water)

    # Should create 2x2=4 distances
    expected = """d_g1_0_com: COM ATOMS=1,2,3,4,5,6,7,8,9
...
def test_distance_cv_corresponding(small_ethnol_water):
    ...
    distance_cv = pn.DistanceCV(
        ...
        x2=x2_selector,
        prefix="d",
        multi_group=pn.MultiGroupStrategy.CORRESPONDING,
    )
...
def test_distance_cv_first_to_all(small_ethnol_water):
    ...
    distance_cv = pn.DistanceCV(
        ...
        x2=x2_selector,
        prefix="d",
        multi_group=pn.MultiGroupStrategy.FIRST_TO_ALL,
    )
...
def test_distance_cv_first_atom_reduction(small_ethnol_water):
    ...
    distance_cv = pn.DistanceCV(
        ...
        x2=x2_selector,
        prefix="d",
        group_reduction=pn.GroupReductionStrategy.FIRST_ATOM,
        multi_group=pn.MultiGroupStrategy.FIRST,
    )
...
def test_distance_cv_cog_reduction(small_ethnol_water):
    ...
    distance_cv = pn.DistanceCV(
        ...
        x2=x2_selector,
        prefix="d",
        group_reduction=pn.GroupReductionStrategy.CENTER_OF_GEOMETRY,
        multi_group=pn.MultiGroupStrategy.FIRST,
    )
    ...
    expected = """d_g1_0_cog: CENTER ATOMS=1,2,3,4,5,6,7,8,9
