...
class TestParallel:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Parallel(base_url=base_url, api_key=api_key, _strict_response_validation=False)
...
class TestAsyncParallel:
    ...
    def test_base_url_trailing_slash(self, client: AsyncParallel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncParallel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncParallel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncParallel(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_get_platform(self) -> None:
        ...
        from parallel._base_client import get_platform
