...
from arshai.core.interfaces.ifile_loader import IFileLoader, IFileLoaderConfig
from arshai.core.interfaces.itext_processor import ITextProcessor, ITextProcessorConfig
