...
class FieldDefinition(BaseModel):
    ...
    field_type: Literal["string"] = Field(description="Type of the field (currently only 'string' is supported)")
    format_example: str = Field(description="Example of the expected format for this field")
