...
class BillApi():
    ...
    def getNativeBill(self, driver: unChrome, options):
        '''
        @Desc    : 获取账单（本土）
        @Author  : 祁国庆
        @Time    : 2024/05/31 15:42:22
        ...
        # 参数检测
        shopApi.TaskParamsException('本土获取账单', start_time, end_time, merchant_id, shop_id, site)
    ...
    def getNoNativeBillDetails(self, driver: unChrome, options):
        ...
        # 参数检测
        shopApi.TaskParamsException('非本土获取账单详情', order_id_list, merchant_id, shop_id)
    ...
    def getNoNativeBillTime(self, driver: unChrome, options):
        ...
        # 参数检测
        shopApi.TaskParamsException('非本土获取账单详细日期', order_id_list, merchant_id, shop_id)
    ...
    def getNoNativeShopAmount(self, driver: unChrome, options):
        '''
        ...
        for amount_dict in amount.get('list', []):
            if amount_dict['type'] == 1:
                amount_data['uncompleted_order_amount'] = amount_dict['amount']
            elif amount_dict['type'] == 2:
                amount_data['approaching'] = amount_dict['amount']

        amount_data['currency'] = currency
        amount_data['fund_declaration_amount'] = amount_data['approaching'] + amount_data['uncompleted_order_amount']
    ...
    def getNativeShopAmount(self, driver: unChrome, options):
        '''
        ...
        # 参数检测
        shopApi.TaskParamsException('本土获取资金申报', site, merchant_id, shop_id)
