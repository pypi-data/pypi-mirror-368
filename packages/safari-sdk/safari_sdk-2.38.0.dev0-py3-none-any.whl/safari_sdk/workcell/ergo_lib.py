...
def get_ergo_images() -> list[str]:
  """Returns a list of ergo images from the ergo/images directory.

  Returns:
      A list of ergo images.
  """
  images = []
  try:
    anchor_pkg = "google3.third_party.safari.sdk.safari.workcell"
    images_path = resources.files(anchor_pkg).joinpath("ergo", "images")
