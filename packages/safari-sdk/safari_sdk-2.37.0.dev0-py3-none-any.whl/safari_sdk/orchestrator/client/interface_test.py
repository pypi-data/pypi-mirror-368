...
class InterfaceTest(absltest.TestCase):
  ...
  @mock.patch(
      ...
      return_value=interface.artifact._RESPONSE(
          success=True, artifact_uri="test_artifact_uri"
      ),
  )
  def test_artifact_get_artifact_uri_good(self, *_):
  ...
  def test_artifact_get_artifact_uri_bad_active_connection(self):
