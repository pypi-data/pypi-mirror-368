...
See :class:`whoosh_update.analysis.CharsetTokenizer` and :class:`whoosh_update.analysis.CharsetFilter`.
"""

from collections import defaultdict
import re

from whoosh_update.compat import izip, u, iteritems, unichr, xrange
