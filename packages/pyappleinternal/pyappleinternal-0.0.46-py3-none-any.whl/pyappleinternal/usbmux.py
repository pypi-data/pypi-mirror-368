...
from pyappleinternal.exceptions import BadCommandError, BadDevError, ConnectionFailedError, \
...
class PlistMuxConnection(BinaryMuxConnection):
    ...
    def _send(self, data: dict):
        request = {'ClientVersionString': 'qt4i-usbmuxd', 'ProgName': 'pyappleinternal', 'kLibUSBMuxVersion': 3}
        request.update(data)
