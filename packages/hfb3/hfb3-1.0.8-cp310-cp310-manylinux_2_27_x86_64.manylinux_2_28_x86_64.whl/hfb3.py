...
class DataTree(Generic):
    ...
    listOfKeys = property(_hfb3.DataTree_listOfKeys_get, _hfb3.DataTree_listOfKeys_set)
    ...
    def isValid(self, key, type):
        return _hfb3.DataTree_isValid(self, key, type)
...
class SolverHFBBroyden(Solver):
    ...
    lambdaMax = property(_hfb3.SolverHFBBroyden_lambdaMax_get, _hfb3.SolverHFBBroyden_lambdaMax_set)
    lambdaIterMax = property(_hfb3.SolverHFBBroyden_lambdaIterMax_get, _hfb3.SolverHFBBroyden_lambdaIterMax_set)
...
class SolverHFBGradient(Solver):
    ...
    lambdaMax = property(_hfb3.SolverHFBGradient_lambdaMax_get, _hfb3.SolverHFBGradient_lambdaMax_set)
    lambdaIterMax = property(_hfb3.SolverHFBGradient_lambdaIterMax_get, _hfb3.SolverHFBGradient_lambdaIterMax_set)
