...
def setup_flashrl(name, parser):
    ...
    subparser.add_argument(
        '--fn', 
        required=False, 
        choices=['fp8', 'fp8_channel', 'fp8_tensor', 'int8', 'int8_wo_prune', 'int8_prune', 'bf16'],
        default='int8',
...
def setup_flashrl_runner(args):
    ...
    assert args.model is not None or args.fn == 'bf16', f"model path is required for quantization {args.fn}"
