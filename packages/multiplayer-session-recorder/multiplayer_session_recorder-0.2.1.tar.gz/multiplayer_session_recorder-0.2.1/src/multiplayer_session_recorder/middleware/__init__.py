...
def create_django_middleware(config: Optional[HttpMiddlewareConfig] = None):
    ...
    try:
        ...
        return DjangoOtelHttpPayloadRecorderMiddleware(config=config or HttpMiddlewareConfig())
...
def create_flask_middleware(config: Optional[HttpMiddlewareConfig] = None) -> Tuple[Callable, Callable]:
    ...
    try:
        ...
        return FlaskOtelHttpPayloadRecorderMiddleware(config or HttpMiddlewareConfig())
    except ImportError as e:
