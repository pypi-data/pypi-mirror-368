...
setup(
    ...
    license='MIT',
    url="https://github.com/ajgouhier/hic_straw_ajg",
    description='Straw bound with pybind11 from hic-straw 1.3.1',
    long_description=read('README.md'),
    long_description_content_type='text/markdown',
    ext_modules=ext_modules,
    install_requires=['numpy', 'pybind11>=2.4'],
    setup_requires=['numpy', 'pybind11>=2.4'],
    python_requires='>3.3',
    cmdclass={'build_ext': BuildExt},
    zip_safe=False,
    data_files=[
        ('hic_straw_ajg', glob.glob('hic_straw_ajg/*.h') + glob.glob('hic_straw_ajg/*.hpp'))
    ],
)
