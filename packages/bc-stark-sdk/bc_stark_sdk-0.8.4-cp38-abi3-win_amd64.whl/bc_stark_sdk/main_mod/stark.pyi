...
import bc_stark_sdk.main_mod.ethercat as ethercat
import builtins
import typing
...
class PyDeviceContext:
    ...
    def ec_start_dfu(self, slave_pos:builtins.int, dfu_type:ethercat.EtherCATFoeType, file_path:builtins.str) -> typing.Any: ...
...
def init_config(fw_type:StarkHardwareType, protocol_type:typing.Optional[StarkProtocolType]=StarkProtocolType.Modbus, level:typing.Optional[main.LogLevel]=main.LogLevel.Info, max_bytes:typing.Optional[builtins.int]=None) -> None: ...
