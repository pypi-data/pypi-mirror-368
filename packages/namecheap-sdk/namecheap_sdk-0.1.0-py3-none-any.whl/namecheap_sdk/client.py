...
class Namecheap:
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ConfigurationError("Failed to load configuration. Ensure you have set:\n" "- NAMECHEAP_API_KEY\n" "- NAMECHEAP_USERNAME\n" "Or pass them as parameters to the client.") from e
    ...
    def _get_api_url(self) -> str:
        ...
        return "https://api.sandbox.namecheap.com/xml.response" if self.config.sandbox else "https://api.namecheap.com/xml.response"
