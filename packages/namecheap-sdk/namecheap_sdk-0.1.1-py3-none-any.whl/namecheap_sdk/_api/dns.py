...
from namecheap_sdk.models import DNSRecord
...
class DNSRecordBuilder:
    ...
    def a(self, name: str, ip: str, ttl: int = 1800) -> Self:
        ...
        Returns:
            Self for chaining
        """
        self._records.append(DNSRecord.model_validate({"@Name": name, "@Type": "A", "@Address": ip, "@TTL": ttl}))
        return self
    ...
    def aaaa(self, name: str, ipv6: str, ttl: int = 1800) -> Self:
        ...
        Returns:
            Self for chaining
        """
        self._records.append(DNSRecord.model_validate({"@Name": name, "@Type": "AAAA", "@Address": ipv6, "@TTL": ttl}))
        return self
    ...
    def cname(self, name: str, target: str, ttl: int = 1800) -> Self:
        ...
        Returns:
            Self for chaining
        """
        self._records.append(DNSRecord.model_validate({"@Name": name, "@Type": "CNAME", "@Address": target, "@TTL": ttl}))
        return self
    ...
    def txt(self, name: str, value: str, ttl: int = 1800) -> Self:
        ...
        Returns:
            Self for chaining
        """
        self._records.append(DNSRecord.model_validate({"@Name": name, "@Type": "TXT", "@Address": value, "@TTL": ttl}))
        return self
    ...
    def ns(self, name: str, nameserver: str, ttl: int = 1800) -> Self:
        ...
        Returns:
            Self for chaining
        """
        self._records.append(DNSRecord.model_validate({"@Name": name, "@Type": "NS", "@Address": nameserver, "@TTL": ttl}))
        return self
    ...
    def url(
        ...
        *,
        ...
        self._records.append(DNSRecord.model_validate({"@Name": name, "@Type": record_type, "@Address": url, "@TTL": ttl}))
        return self
...
class DnsAPI(BaseAPI):
    ...
    def add(self, domain: str, record: DNSRecord) -> bool:
        ...
        for existing_record in existing:
            if existing_record.name == record.name and existing_record.type == record.type and existing_record.value == record.value:
