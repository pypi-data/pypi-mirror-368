...
Online Documentation: <https://calcpy.github.io/>
...
Python 3.8+ is required. [why](https://calcpy.github.io/compat.html)
...
Documentation: <https://calcpy.github.io/compo.html>
...
``calcpy`` also provides many ready-made components for function compositions.
List of APIs: <https://calcpy.github.io/compo.html#shorthand-functions-that-support-composition>
...
Documentation: <https://calcpy.github.io/fun.html#reorder-arguments>
...
Documentation: <https://calcpy.github.io/set.html>
...
Documentation: <https://calcpy.github.io/builtin.html>

- `calcpy.argchecker(*keys, *, default)` instantiates a callable object that checks whether position arguments and/or keyword arguments are all present, with optional default value for missing arguments.
...
- `calcpy.attrchecker(*attrs, *, default)` instantiates a callable object that checks whether the given attribute(s) are all present in its operand, with optional default value for missing attributes.
...
- `calcpy.itemchecker(*items, *, default)` instantiates a callable object that checks whether the given item(s) are all present in its operand, with muti-level keys and optional default value for missing items.
...
- `calcpy.methodcaller(name, *args, **kwargs)` instantiates a callable object that calls a method with the given name and arguments, supporting `pandas` accessor.
...
Documentation: <https://calcpy.github.io/fill.html>
...
Documentation: <https://calcpy.github.io/cls.html>
...
Documentation: <https://calcpy.github.io/nppd.html>
...
- `calcpy.mapi(arg, f)` applies a function to every element in the inputs.
...
Documentation: <https://calcpy.github.io/seq.html#repetend-analysis>
...
Documentation: <https://calcpy.github.io/seq.html#permutation>
...
Documentation: <http://calcpy.github.io/seq.html#sequence-generator>

- `calcpy.oeis.A276128()` generates elements of the sequence [OEIS A276128](https://oeis.org/A276128).

### Combinatics

Documentation: <http://calcpy.github.io/comb.html>

- `calcpy.bellpartition()` generates all subset partitions of a set.
