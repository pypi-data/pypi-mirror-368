...
class OcmOpt:
    ...
    """
    BEST_SCORE: typing.ClassVar[OcmOpt]  # value = <OcmOpt.BEST_SCORE: 4>
    ...
    __members__: typing.ClassVar[dict[str, OcmOpt]]  # value = {'NONE': <OcmOpt.NONE: 0>, 'OPTION1': <OcmOpt.OPTION1: 1>, 'OPTION2': <OcmOpt.OPTION2: 2>, 'OPTION3': <OcmOpt.OPTION3: 3>, 'BEST_SCORE': <OcmOpt.BEST_SCORE: 4>}
...
class ZG330Backend(xir.ObjectRef):
    ...
    def zg330backend_id(self) -> int:
        ...
        当前zg330backend的id
        """
BEST_SCORE: OcmOpt  # value = <OcmOpt.BEST_SCORE: 4>
