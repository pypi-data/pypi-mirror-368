...
if __name__ == '__main__':
    setup_dict = {
        'name': 'mvulib',
        'version': '3.0',
        'description': 'A Python Interface to MATLAB implementation of Maximum Variance Unfolding (MVU) dimensionality reduction algorithm. MATLAB Runtime 24.1 installation is required.',
