...
class ProcedureRecommendationSchema(BaseModel):
    primary: List[ProcedureDataDTO] = Field(..., description="Primary recommendations")
    alternatives: List[ProcedureDataDTO] = Field(
        ..., description="Alternative recommendations"
    )


class ProcedureRecommendationSchemaMixin(BaseModel):
    procedure: ProcedureRecommendationSchema = Field(..., description="Recommendation")
