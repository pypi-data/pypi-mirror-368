...
version_file = 'uworld/version.py'
...
if __name__ == '__main__':
    ...
    setup(
        ...
        version=get_version(),
        description=
        'U-World: Exploring the World with AI Agents Powered by Large Language Models',
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='wangxingjun778',
        author_email='wangxingjun778@163.com',
        keywords='Agent, LLM, World Model, Multimodal',
        url='https://github.com/wangxingjun778/u-world',
        ...
        entry_points={
            'console_scripts': ['u-world=uworld.cli.cli:run_cmd']
        },
