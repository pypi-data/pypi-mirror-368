...
```bash
pip install f1-fantasy-py
```

### Basic Usage

```python
from f1_fantasy_py import get_driver_points, get_constructor_points
...
from f1_fantasy_py import get_driver_breakdown
...
```python
from f1_fantasy_py import list_drivers, list_constructors, get_latest_round
...
```bash
# Driver points
python -m f1_fantasy_py.cli VER 14          # VER round 14: 11 points
python -m f1_fantasy_py.cli NOR latest      # NOR latest round: 0 points

# Constructor points  
python -m f1_fantasy_py.cli RBR 14          # RBR round 14: 39 points

# Specific breakdowns
python -m f1_fantasy_py.cli VER 14 race overtakeBonus  # VER overtakeBonus: 7
python -m f1_fantasy_py.cli RBR 14 race overtakes      # RBR overtakes: 7
```
...
```bash
# Get full breakdown
python -m f1_fantasy_py.cli VER 14 --breakdown
# Shows: VER race breakdown for round 14: {dotd: 0, position: 10, ...}

# Get driver/constructor info
python -m f1_fantasy_py.cli VER --info
# Shows: Driver: Max Verstappen, Team: Red Bull Racing, Season: 335 points

# List available options
python -m f1_fantasy_py.cli --drivers        # List all drivers
python -m f1_fantasy_py.cli --constructors   # List all constructors
```
...
```python
from f1_fantasy_py import F1FantasyError
...
1. Check the [issues page](https://github.com/yourusername/f1-fantasy-py/issues)
