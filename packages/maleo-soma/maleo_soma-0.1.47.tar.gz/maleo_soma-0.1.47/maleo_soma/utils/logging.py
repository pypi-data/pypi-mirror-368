...
from maleo_soma.enums.logging import LoggerType, LogLevel
from maleo_soma.enums.service import Service
from maleo_soma.schemas.logging import LogLabels
from maleo_soma.types.base import OptionalString, OptionalStringToStringDict
from maleo_soma.utils.loaders.credential.google import load
from maleo_soma.utils.merger import merge_dicts


class GoogleCloudLogging:
    def __init__(self, credentials_path: Optional[Union[Path, str]] = None) -> None:
        self._credentials = load(credentials_path=credentials_path)
...
class BaseLogger(logging.Logger):
    def __init__(
        ...
        service_key: Optional[Service] = None,
        ...
        if actual_service_key is None:
            ...
            self._service_key = Service(actual_service_key)
