...
class PaginationLimits(DataModelBase):
    ...
    page_size: Optional[StrictInt] = Field(
        None, description="Number of objects returned in current page.", examples=[20]
    )
    page: Optional[StrictInt] = Field(None, description="Current page number of returned objects.", examples=[8])
    total_pages: Optional[StrictInt] = Field(
        None, description="Total pages available based on current request parameters.", examples=[39]
    )
    total_items: Optional[StrictInt] = Field(
        None, description="Total number of objects based on current request parameters.", examples=[628]
    )
