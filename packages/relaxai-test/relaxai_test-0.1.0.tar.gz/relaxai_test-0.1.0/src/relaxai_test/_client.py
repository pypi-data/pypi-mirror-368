...
class RelaxaiTest(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        if base_url is None:
            base_url = os.environ.get("RELAXAI_TEST_BASE_URL")
        if base_url is None:
            base_url = f"/"
...
class AsyncRelaxaiTest(AsyncAPIClient):
...
class RelaxaiTestWithRawResponse:
    def __init__(self, client: RelaxaiTest) -> None:
...
class AsyncRelaxaiTestWithRawResponse:
    def __init__(self, client: AsyncRelaxaiTest) -> None:
