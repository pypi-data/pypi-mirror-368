...
def quick_save(cell_id=None):
    ...
    dill.dump(nb_funcs, open(filepath(nb_name, ISType.PICKLE, cell_id=cell_id, funcs=True), 'wb'))
    ...
    dill.dump_module(filepath(nb_name, ISType.PICKLE, cell_id=cell_id), saved_module,  refimported=True)


def quick_load(cell_id=None):
    ...
    loaded_module = dill.load_module(filepath(nb_name, ISType.PICKLE, cell_id=cell_id))  # Module
    loaded_funcs = dill.load(open(filepath(nb_name, ISType.PICKLE, cell_id=cell_id, funcs=True), 'rb'))  # Notebook Funcs
