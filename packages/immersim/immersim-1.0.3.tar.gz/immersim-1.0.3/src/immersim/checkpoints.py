...
def load_ipython_extension(ipython):
    ...
    _load_js_extension()  # The js extension only works in a browser, not in PyCharm
...
def _load_js_extension():
    ...
    # Explicitly require the module and call its load function
    display(Javascript("""
            require(['nb_cell_indexing'], function(ext) {
                ext.load_ipython_extension();
            });
        """))
    print("Cell indexing JS extension loaded and initialized!")