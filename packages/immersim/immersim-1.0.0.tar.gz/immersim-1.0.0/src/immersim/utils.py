...
saved_vars_blacklist = ['In', 'Out', 'open', 'exit', 'quit', 'get_ipython', 'ipykernal',  # IPython vars
                        ...
                        'pydev_jupyter_vars', 'remove_imported_pydev_package',  # Pycharm vars
...
def filepath(filename: str, method: ISType, directory: str=warehouse_directory, index: int=None) -> str:
