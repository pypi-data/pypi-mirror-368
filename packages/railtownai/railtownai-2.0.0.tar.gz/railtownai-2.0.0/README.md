...
# Get the RailtownHandler instance
root_logger = logging.getLogger()
railtown_handler = None

for handler in root_logger.handlers:
    if isinstance(handler, railtownai.handler.RailtownHandler):
...
success = railtown_handler.upload_agent_run(agent_run_data)
if success:
...
success = railtown_handler.upload_agent_run(agent_run_data_array)
if success:
