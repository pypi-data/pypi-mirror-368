...
class AdMCPServer:
    ...
    def _init_tools(self):
        ...
        self.ad_query_tool = AdQueryTool(
            self.api_client, self.indicator_manager, self.propmap_manager, Config
        )
        ...
        # 指标推荐工具
        self.indicator_recommend_tool = IndicatorRecommendTool(
            self.indicator_manager, Config
        )
        self.indicator_recommend_tool.register(self.mcp)

        # 游戏指标查询工具
        self.game_indicator_query_tool = GameIndicatorQueryTool(
            self.indicator_manager, Config
        )
        self.game_indicator_query_tool.register(self.mcp)
