...
Benchmarking FoaPy with Airspeed Velocity.
...
development version of FoaPy to your current Python environment.
...
To run all benchmarks, navigate to the root FoaPy directory at
the command line and execute::

    spin bench

This builds FoaPy and runs all available benchmarks
...
.. _benchmark results repository: https://github.com/HaoZeke/asv-FoaPy
...
- The benchmark suite should be importable with any FoaPy version.

- The benchmark parameters etc. should not depend on which FoaPy version
  is installed.
