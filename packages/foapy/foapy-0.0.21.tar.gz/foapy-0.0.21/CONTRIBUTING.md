...
Welcome to `foapy` contributor's guide.
...
If you experience bugs or general issues with `foapy`, please have a look
...
```
conda create -n foapy python=3 six virtualenv pytest pytest-cov
conda activate foapy
```
...
6. Install [pre-commit]:
   ...
   `foapy` comes with a lot of hooks configured to automatically help the
