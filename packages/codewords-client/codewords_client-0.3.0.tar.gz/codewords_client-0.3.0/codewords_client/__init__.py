...
from .codewords_client import AsyncCodewordsClient, CodewordsClient, AsyncCodewordsResponse, CodewordsResponse
...
def _setup_exception_handlers(app: FastAPI):
    ...
    async def unhandled_exception_handler(request: Request, exc: Exception):
        ...
        return JSONResponse(status_code=500, content={"detail": "Internal server error"}, headers={"Error-Origin": "service"})
