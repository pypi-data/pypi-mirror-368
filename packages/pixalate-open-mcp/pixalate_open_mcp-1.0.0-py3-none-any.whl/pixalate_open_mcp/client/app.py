...
async def echo_message(message: str, transform: Optional[str] = None) -> str:
    ...
    server_params = StdioServerParameters(
        command="pixalate_open_mcp-server",  # Use the installed script
...
@click.option(
    "--transform", type=click.Choice(["upper", "lower"], case_sensitive=False), help="Optional case transformation"
)
