"""Logging configuration for pixalate-open-mcp MCP server"""
...
from pixalate_open_mcp.config import ServerConfig
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the pixalate-open-mcp MCP server"""
