...
from gable.cli.converters.mssql import MsSqlConverter
...
class MsSQLAssetPlugin(AssetPluginAbstract):
    ...
    def click_options_keys(self) -> set[str]:
        return set(MsSQLConfig.__annotations__.keys())
    ...
    def extract_assets(
        ...
        MSSQL_CONVERTER = MsSqlConverter()
        fields_by_table = {}
        ...
        for table_name, fields in fields_by_table.items():
            ...
            recap_fields = []
            for field in fields:
                schema_recap_type = MSSQL_CONVERTER.to_recap([field]).fields.pop()
