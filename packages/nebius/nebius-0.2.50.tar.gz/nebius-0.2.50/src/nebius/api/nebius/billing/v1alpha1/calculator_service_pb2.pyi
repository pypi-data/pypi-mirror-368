...
class EstimateRequest(_message.Message):
    __slots__ = ["resource_spec"]
    RESOURCE_SPEC_FIELD_NUMBER: _ClassVar[int]
    resource_spec: _calculator_pb2.ResourceSpec
    def __init__(self, resource_spec: _Optional[_Union[_calculator_pb2.ResourceSpec, _Mapping]] = ...) -> None: ...
...
class EstimateBatchRequest(_message.Message):
    ...
    def __init__(self, resource_specs: _Optional[_Iterable[_Union[_calculator_pb2.ResourceSpec, _Mapping]]] = ...) -> None: ...
