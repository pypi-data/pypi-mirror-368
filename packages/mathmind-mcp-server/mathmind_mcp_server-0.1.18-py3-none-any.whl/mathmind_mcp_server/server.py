...
def imgs2video( 
                ...
                voiceUrl:Annotated[str|None,Field(description="配音URL (可选,非必填)",default=None)],
                bgmUrl:Annotated[str|None,Field(description="背景音乐URL (可选，非必填)",default=None)],
                ...
                coverImageUrl:Annotated[str|None,Field(description="封面图片链接 (可选,非必填) ",default=None)],
    ...
    x_api_key = headers.get("x-api-key") or X_API_KEY
    print("测试输入参数：",headers)
    results = Imgs2Video()(
        imageUrls=imageUrls,
        voiceUrl=voiceUrl,
        bgmUrl= bgmUrl,
...
def video2video(
    ...
    voiceUrl:Annotated[str|None,Field(description="配音URL(可选,非必填)")]=None,
    bgmUrl:Annotated[str|None,Field(description="背景音乐URL(可选,非必填)")]=None,
    voiceVolume:Annotated[int|None,Field(description="配音音量(可选,非必填)")]=None,
    bgmVolume:Annotated[int|None,Field(description="背景音乐音量(可选,非必填)")]=None,
    headerVideoUrl:Annotated[str|None,Field(description="片头视频URL(可选,非必填)")]=None,
    footerVideoUrl:Annotated[str|None,Field(description="片尾视频URL(可选,非必填)")]=None,
    coverImageUrl :Annotated[str|None,Field(description="封面图片URL(可选,非必填)")]=None,
    coverImageDuration:Annotated[float|None,Field(description="封面图片时长(可选,非必填)")]=None
    ):
    """
    ...
    if isinstance(bgmVolume,str):
        bgmVolume = int(bgmVolume)
    if isinstance(voiceVolume,str):
        voiceVolume = int(voiceVolume)
        
    if isinstance(coverImageDuration,float):
        coverImageDuration = float(coverImageDuration)
...
def subtitleDynamic(
    ...
    fontSize:Annotated[str|None,Field(description="字体大小（可选、非必填）")]=None,
    primaryColor:Annotated[str|None,Field(description="字体颜色（可选、非必填）")]=None,
    marginV :Annotated[str|None,Field(description="垂直边距（可选、非必填）")]=None,
    text:Annotated[str|None,Field(description=" 字幕文本（可选、非必填）")]=None,
    isFontAuto:Annotated[int|None,Field(description="是否自动调整字体大小，1自适应，0不自适应（可选、非必填）")]=None,
    isFontBold:Annotated[int|None,Field(description="是否加粗，1为加粗，0为不加粗，1自适应，0不自适应（可选、非必填）")]=None,
    textStrokeColor:Annotated[str|None,Field(description="描边颜色（可选、非必填）")]=None,
    textStrokeWidth:Annotated[str|None,Field(description="描边宽度（可选、非必填）")]=None,
    selectFont :Annotated[int|None,Field(description="选择字体编码，从1开始（可选、非必填）")]=None,
    textBgColor:Annotated[str|None,Field(description="字幕背景颜色（可选、非必填）")]=None,
):
    """
...
def videoCutRandom(
    ...
    startPlace:Annotated[float|None,Field(description="裁剪视频的起始位置，时长的百分比",default=0,ge=0,le=100)]=None,
    endPlace:Annotated[float|None,Field(description="裁剪视频的结束位置，时长的百分比",default=100,ge=0,le=100)]=None,
):
    """
...
def image2video(imageUrl: Annotated[str, Field(description="图片链接地址")],
                prompt: Annotated[str|None, Field(description="生成视频的文本提示词（非必填）")]=None) -> str:
...
def imgpip(
        ...
        mStartTime :Annotated[int|None,Field(description="素材出现时间（可选、非必填）")]=None,
        mDuration :Annotated[float|None,Field(description="素材持续时间（可选、非必填）")]=None,
        mXY :Annotated[list[int]|None,Field(description="素材坐标（可选、非必填）")]=None,
        Width :Annotated[int|None,Field(description="资源在输出视频画布上的宽度，单位为 pixel。（可选、非必填）")]=None,
        Height :Annotated[int|None,Field(description="资源在输出视频画布上的高度，单位为 pixel。（可选、非必填）")]=None,
        mEntrAnimo :Annotated[str|None,Field(description="入场动画id（可选、非必填）")]=None,
        mEntrAniDuration :Annotated[float|None,Field(description="入场动画持续时间（可选、非必填）")]=None,
        mExitAnimo :Annotated[str|None,Field(description="出场动画id（可选、非必填）")]=None,
        mExitAniDuration:Annotated[float|None,Field(description="出场动画持续时间（可选、非必填）")]=None,
