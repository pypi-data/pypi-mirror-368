...
from EnclaveSDK.models.write_file_data import WriteFileData
...
class DataApi:
    ...
    @validate_call
    def api_v1_data_file_put(
        self,
        write_file_data: WriteFileData,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Write/upload a file to remote storage

        This endpoint allows writing data back to the remote storage system, supporting both binary file uploads and JSON data.

        :param write_file_data: (required)
        :type write_file_data: WriteFileData
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._api_v1_data_file_put_serialize(
    ...
    @validate_call
    def api_v1_data_file_put_with_http_info(
        self,
        write_file_data: WriteFileData,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v1_data_file_put_without_preload_content(
        self,
        write_file_data: WriteFileData,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_data_file_put_serialize(
        self,
        write_file_data,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if write_file_data is not None:
            _body_params = write_file_data
