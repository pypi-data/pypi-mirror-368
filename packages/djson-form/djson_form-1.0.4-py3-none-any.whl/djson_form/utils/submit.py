...
class SubmitProcessor:
    ...
    def process(self, submit_type: str, json_schema: dict, form_data: dict, query_params: dict):
    ...
    def _save_form_in_model(self, form_data: dict, json_schema: dict, query_params: dict):
