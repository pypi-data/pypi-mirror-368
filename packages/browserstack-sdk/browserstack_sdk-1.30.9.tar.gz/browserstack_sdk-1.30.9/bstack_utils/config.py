...
conf = {
    bstack11l1_opy_ (u"ࠬࡧࡰࡱࡡࡤࡹࡹࡵ࡭ࡢࡶࡨࠫគ"): False,
    bstack11l1_opy_ (u"࠭ࡢࡴࡶࡤࡧࡰࡥࡳࡦࡵࡶ࡭ࡴࡴࠧឃ"): True,
    bstack11l1_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭ង"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11ll111l11l_opy_ = conf
    @classmethod
    def bstack1l1lll11l_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll1111lll_opy_=None):
        return self._11ll111l11l_opy_.get(property_name, bstack11ll1111lll_opy_)
    def bstack11lll11l_opy_(self, property_name, bstack11ll111l111_opy_):
        self._11ll111l11l_opy_[property_name] = bstack11ll111l111_opy_
    def bstack1l1llll11l_opy_(self, val):
        self._11ll111l11l_opy_[bstack11l1_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧច")] = bool(val)
    def bstack1111l1ll11_opy_(self):
        return self._11ll111l11l_opy_.get(bstack11l1_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨឆ"), False)