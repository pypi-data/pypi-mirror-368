...
class bstack111111l11l_opy_:
    timeout: int
    bstack111111l1l1_opy_: Union[None, Callable]
    bstack111111ll1l_opy_: Union[None, Callable]
    def __init__(self, timeout=1, bstack111111l1ll_opy_=1, bstack111111l1l1_opy_=None, bstack111111ll1l_opy_=None):
    ...
    def enqueue(self, job: Callable):
        if not callable(job):
            raise ValueError(bstack11l1_opy_ (u"ࠤ࡬ࡲࡻࡧ࡬ࡪࡦࠣ࡮ࡴࡨ࠺ࠡࠤႍ") + type(job))
        self.queue.put(job)
    def start(self):
        if self.threads:
            return
        ...
        while not self.bstack111111lll1_opy_.is_set():
            try:
                ...
                try:
                    ...
                    if callable(self.bstack111111l1l1_opy_):
                        self.bstack111111l1l1_opy_(e, job)
                finally:
