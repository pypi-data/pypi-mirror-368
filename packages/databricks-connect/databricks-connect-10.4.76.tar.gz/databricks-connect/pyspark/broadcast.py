...
class Broadcast(object):
    ...
    def __init__(self, sc=None, value=None, pickle_registry=None, path=None,
        ...
        if sc is not None:
            ...
            if sc._conf.get(sc._jvm.PythonSecurityUtils
                            .SPARK_PYTHON_TO_JVM_TRUSTED_DATA_TRANSFER_ENABLED()):
    ...
    def init_with_process_isolation(self, sc, value, pickle_registry):
        ...
        self._jbroadcast = session._jsparkSession \
            .createBroadcastVariableFromTrustedPath(broadcast_out.name, self._sc._jsc)
