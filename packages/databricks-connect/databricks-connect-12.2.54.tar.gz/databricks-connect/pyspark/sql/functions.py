...
from pyspark.databricks.sql.functions import _create_edge_udf

# Keep pandas_udf and PandasUDFType import for backwards compatible import; moved in SPARK-28264
from pyspark.sql.pandas.functions import pandas_udf, PandasUDFType  # noqa: F401
from pyspark.sql.utils import to_str, try_remote_functions
...
def udf(
    ...
    if f is None or isinstance(f, (str, DataType)):
        ...
        return functools.partial(
            _create_edge_udf, returnType=return_type, evalType=PythonEvalType.SQL_BATCHED_UDF
        )
    else:
        return _create_edge_udf(f=f, returnType=returnType, evalType=PythonEvalType.SQL_BATCHED_UDF)
