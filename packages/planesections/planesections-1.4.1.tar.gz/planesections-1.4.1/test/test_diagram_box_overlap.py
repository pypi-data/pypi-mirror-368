...
def test_inside_1():
    assert checkBoxesForOverlap(baseBox, insideBox2) == True

def test_outside_1():
    assert checkBoxesForOverlap(baseBox, outsideBox1) == False

def test_outside_2():
    assert checkBoxesForOverlap(baseBox, outsideBox2) == False
