...
TARGET_FILE = './testdir/did_innerpuz.klvm.hex'
...
def test_compile_klvm(source, output, paths, want_sha256):
    compile_klvm(source, output, paths)
...
test_compile_klvm(SOURCE_FILE, TARGET_FILE, SEARCH_PATHS, COMPILED_HASH)
...
try:
    test_compile_klvm(SOURCE_FILE, TARGET_FILE, SEARCH_PATHS, None)
