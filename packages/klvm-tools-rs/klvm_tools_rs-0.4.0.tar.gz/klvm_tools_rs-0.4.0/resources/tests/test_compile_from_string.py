...
compiled_code = klvm_tools_rs.compile(
    classic_code,
    ["."],
    True
)
...
assert symbols["__chik__main_arguments"] == "(N X)"
...
compiled_code = klvm_tools_rs.compile_klvm(
...
dependencies = klvm_tools_rs.check_dependencies(
