...
FULL_NODE='chik/full_node/puzzles'
CAT_WALLET='chik/wallet/cat_wallet/puzzles'
DID_WALLET='chik/wallet/did_wallet/puzzles'
NFT_WALLET='chik/wallet/nft_wallet/puzzles'
POOLS='chik/pools/puzzles'
CONSENSUS='chik/consensus/puzzles'
...
for recompile_entry in recompile_list:
    ...
    os.unlink(hexfile)
    try:
        compiled = subprocess.check_output(['../target/release/run', '-i', dirname, '-i', 'chik/wallet/puzzles', srcfile]).strip()
