...
def mol_embed_and_optimize(mol: Chem.Mol): ...
def mol_props_summary(mol: Chem.Mol): ...
def mol_to_serialize(mol: Chem.Mol) -> bytes: ...
def mol_to_unserialize(serialized_mol: bytes) -> Chem.Mol: ...
