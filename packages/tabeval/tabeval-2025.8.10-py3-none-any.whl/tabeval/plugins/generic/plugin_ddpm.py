...
from tabeval.plugins.core.distribution import Distribution, IntegerDistribution, IntLogDistribution, LogDistribution
from tabeval.plugins.core.models.tabular_ddpm import TabDDPM
...
from tabeval.utils.callbacks import Callback
from tabeval.utils.constants import DEVICE


class TabDDPMPlugin(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.generic.plugin_tab_ddpm.TabDDPMPlugin
        :parts: 1
