...
from tabeval.plugins.core.distribution import Distribution, IntegerDistribution
from tabeval.plugins.core.models.tabular_great import TabularGReaT
...
class GReaTPlugin(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.generic.plugin_great.GReaTPlugin
        :parts: 1
