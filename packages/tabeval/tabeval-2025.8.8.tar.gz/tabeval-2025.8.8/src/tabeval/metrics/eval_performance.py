...
from tabeval.metrics._utils import evaluate_auc
from tabeval.metrics.core import MetricEvaluator
from tabeval.plugins.core.dataloader import DataLoader
from tabeval.plugins.core.models.convnet import suggest_image_classifier_arch
from tabeval.plugins.core.models.mlp import MLP
from tabeval.plugins.core.models.survival_analysis import (CoxPHSurvivalAnalysis, DeephitSurvivalAnalysis,
                                                           XGBSurvivalAnalysis, evaluate_survival_model)
from tabeval.plugins.core.models.time_series_survival.benchmarks import evaluate_ts_survival_model
from tabeval.plugins.core.models.time_series_survival.ts_surv_coxph import CoxTimeSeriesSurvival
from tabeval.plugins.core.models.time_series_survival.ts_surv_dynamic_deephit import DynamicDeephitTimeSeriesSurvival
from tabeval.plugins.core.models.time_series_survival.ts_surv_xgb import XGBTimeSeriesSurvival
from tabeval.plugins.core.models.ts_model import TimeSeriesModel
from tabeval.utils.serialization import load_from_file, save_to_file


class PerformanceEvaluator(MetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_performance.PerformanceEvaluator
        :parts: 1
...
class PerformanceEvaluatorXGB(PerformanceEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_performance.PerformanceEvaluatorXGB
        :parts: 1
...
class PerformanceEvaluatorLinear(PerformanceEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_performance.PerformanceEvaluatorLinear
        :parts: 1
...
class PerformanceEvaluatorMLP(PerformanceEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_performance.PerformanceEvaluatorMLP
        :parts: 1
...
class FeatureImportanceRankDistance(MetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_performance.FeatureImportanceRankDistance
        :parts: 1
