...
class SurvivalGANPlugin(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.survival_analysis.plugin_survival_gan.SurvivalGANPlugin
        :parts: 1
    ...
    Example:
        ...
        >>> from tabeval.plugins.core.dataloader import SurvivalAnalysisDataLoader
        >>>
        >>> X = load_rossi()
