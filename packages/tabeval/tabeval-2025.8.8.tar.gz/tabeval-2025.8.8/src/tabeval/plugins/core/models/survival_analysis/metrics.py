...
try:
    ...
    from numpy import trapz  # As a fallback for older versions if scipy's import path changes

# tabeval absolute
from tabeval.plugins.core.models.survival_analysis.third_party.metrics import brier_score, concordance_index_ipcw
