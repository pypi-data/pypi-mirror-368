...
import numpy as np
import pandas as pd
from pydantic import (BaseModel, ConfigDict, Field, FieldValidationInfo, PrivateAttr, ValidationInfo, field_validator,
                      model_validator)
...
class Distribution(BaseModel, metaclass=ABCMeta):
    """
    .. inheritance-diagram:: tabeval.plugins.core.distribution.Distribution
        :parts: 1
...
class CategoricalDistribution(Distribution):
    """
    .. inheritance-diagram:: tabeval.plugins.core.distribution.CategoricalDistribution
        :parts: 1
    """
...
class FloatDistribution(Distribution):
    """
    .. inheritance-diagram:: tabeval.plugins.core.distribution.FloatDistribution
        :parts: 1
    """
...
class IntegerDistribution(Distribution):
    """
    .. inheritance-diagram:: tabeval.plugins.core.distribution.IntegerDistribution
        :parts: 1
    """
...
class DatetimeDistribution(Distribution):
    """
    .. inheritance-diagram:: tabeval.plugins.core.distribution.DatetimeDistribution
        :parts: 1
    """
...
class PassThroughDistribution(Distribution):
    """
    .. inheritance-diagram:: tabeval.plugins.core.distribution.PassThroughDistribution
        :parts: 1
    """
