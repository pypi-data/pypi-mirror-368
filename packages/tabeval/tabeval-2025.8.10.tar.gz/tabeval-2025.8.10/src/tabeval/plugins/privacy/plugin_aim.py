...
from tabeval.plugins.core.distribution import Distribution, FloatDistribution, IntegerDistribution, LogDistribution
from tabeval.plugins.core.models.tabular_aim import TabularAIM
...
class AIMPlugin(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.privacy.plugin_adsgan.AdsGANPlugin
        :parts: 1
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        .. inheritance-diagram:: tabeval.plugins.generic.plugin_aim.AIMPlugin
        :parts: 1
