...
from tabeval.plugins.core.dataset import FlexibleDataset, TensorDataset
from tabeval.plugins.core.models.feature_encoder import DatetimeEncoder
from tabeval.utils.compression import compress_dataset, decompress_dataset
from tabeval.utils.serialization import dataframe_hash


class DataLoader(metaclass=ABCMeta):
    """
    .. inheritance-diagram:: tabeval.plugins.core.dataloader.DataLoader
        :parts: 1
...
class GenericDataLoader(DataLoader):
    """
    .. inheritance-diagram:: tabeval.plugins.core.dataloader.GenericDataLoader
        :parts: 1
    ...
    Example:
        ...
        >>> # tabeval handles feature encoding and standardization internally.
...
class SurvivalAnalysisDataLoader(DataLoader):
    """
    .. inheritance-diagram:: tabeval.plugins.core.dataloader.SurvivalAnalysisDataLoader
        :parts: 1
...
class TimeSeriesDataLoader(DataLoader):
    """
    .. inheritance-diagram:: tabeval.plugins.core.dataloader.TimeSeriesDataLoader
        :parts: 1
...
class TimeSeriesSurvivalDataLoader(TimeSeriesDataLoader):
    """
    .. inheritance-diagram:: tabeval.plugins.core.dataloader.TimeSeriesSurvivalDataLoader
        :parts: 1
...
class ImageDataLoader(DataLoader):
    """
    .. inheritance-diagram:: tabeval.plugins.core.dataloader.ImageDataLoader
        :parts: 1
