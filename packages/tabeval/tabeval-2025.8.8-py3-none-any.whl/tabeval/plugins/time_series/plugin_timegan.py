...
from tabeval.plugins.core.distribution import (CategoricalDistribution, Distribution, FloatDistribution,
                                               IntegerDistribution)
from tabeval.plugins.core.models.tabular_encoder import BinEncoder, TabularEncoder
from tabeval.plugins.core.models.ts_model import TimeSeriesModel, modes
from tabeval.plugins.core.models.ts_tabular_gan import TimeSeriesTabularGAN
...
from tabeval.utils.samplers import ImbalancedDatasetSampler


class TimeGANPlugin(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.time_series.plugin_timegan.TimeGANPlugin
        :parts: 1
    ...
    Example:
        ...
        >>> from tabeval.utils.datasets.time_series.google_stocks import GoogleStocksDataloader
        >>> from tabeval.plugins.core.dataloader import TimeSeriesDataLoader
