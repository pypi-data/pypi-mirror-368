...
from tabeval.plugins.core.models.tabular_encoder import TabularEncoder, TimeSeriesTabularEncoder
...
class FourierFlowsPlugin(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.time_series.plugin_fflows.FourierFlowsPlugin
        :parts: 1
