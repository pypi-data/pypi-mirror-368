...
from tabeval.plugins.core.models.ts_tabular_vae import TimeSeriesTabularVAE
...
class TimeVAEPlugin(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.time_series.plugin_timevae.TimeVAEPlugin
        :parts: 1
