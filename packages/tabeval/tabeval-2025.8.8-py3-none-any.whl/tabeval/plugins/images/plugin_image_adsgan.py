...
from tabeval.plugins.core.dataset import TensorDataset
...
from tabeval.plugins.core.models.image_gan import ImageGAN
...
class ImageAdsGANPlugin(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.images.plugin_image_adsgan.ImageAdsGANPlugin
        :parts: 1
    ...
    Example:
        ...
        >>> from tabeval.plugins.core.dataloader import ImageDataLoader
        >>>
