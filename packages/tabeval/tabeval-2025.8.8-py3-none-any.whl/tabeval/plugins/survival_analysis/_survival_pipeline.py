...
from tabeval.plugins.core.models.time_to_event import TimeToEventPlugin
from tabeval.plugins.core.models.time_to_event import get_model_template as get_tte_model_template
...
class SurvivalPipeline(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.survival_analysis._survival_pipeline.SurvivalPipeline
        :parts: 1
