...
class RadialGAN(nn.Module):
    """
    .. inheritance-diagram:: tabeval.plugins.domain_adaptation.plugin_radialgan.RadialGAN
        :parts: 1
...
class RadialGANPlugin(Plugin):
    """
    .. inheritance-diagram:: tabeval.plugins.domain_adaptation.plugin_radialgan.RadialGANPlugin
        :parts: 1
