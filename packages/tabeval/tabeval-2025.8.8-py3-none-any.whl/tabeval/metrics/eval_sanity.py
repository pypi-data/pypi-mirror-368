...
class BasicMetricEvaluator(MetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_sanity.BasicMetricEvaluator
        :parts: 1
    """
...
class DataMismatchScore(BasicMetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_sanity.DataMismatchScore
        :parts: 1
...
class CommonRowsProportion(BasicMetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_sanity.CommonRowsProportion
        :parts: 1
...
class NearestSyntheticNeighborDistance(BasicMetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_sanity.NearestSyntheticNeighborDistance
        :parts: 1
...
class CloseValuesProbability(BasicMetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_sanity.CloseValuesProbability
        :parts: 1
...
class DistantValuesProbability(BasicMetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_sanity.DistantValuesProbability
        :parts: 1
