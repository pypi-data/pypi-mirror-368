...
from tabeval.plugins.core.dataset import NumpyDataset
...
class DetectionEvaluator(MetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_detection.DetectionEvaluator
        :parts: 1
...
class SyntheticDetectionXGB(DetectionEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_detection.SyntheticDetectionXGB
        :parts: 1
...
class SyntheticDetectionMLP(DetectionEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_detection.SyntheticDetectionMLP
        :parts: 1
...
class SyntheticDetectionLinear(DetectionEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_detection.SyntheticDetectionLinear
        :parts: 1
...
class SyntheticDetectionGMM(DetectionEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_detection.SyntheticDetectionGMM
        :parts: 1
