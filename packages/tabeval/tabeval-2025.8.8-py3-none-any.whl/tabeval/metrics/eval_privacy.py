...
from tabeval.metrics import _utils
...
class kAnonymization(PrivacyEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_privacy.kAnonymization
        :parts: 1
...
class lDiversityDistinct(PrivacyEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_privacy.lDiversityDistinct
        :parts: 1
...
class kMap(PrivacyEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_privacy.kMap
        :parts: 1
...
class DeltaPresence(PrivacyEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_privacy.DeltaPresence
        :parts: 1
...
class IdentifiabilityScore(PrivacyEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_privacy.IdentifiabilityScore
        :parts: 1
...
class DomiasMIA(PrivacyEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_privacy.domias
        :parts: 1
