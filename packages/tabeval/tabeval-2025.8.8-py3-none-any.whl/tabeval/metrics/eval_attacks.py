...
class AttackEvaluator(MetricEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_attacks.AttackEvaluator
        :parts: 1
...
class DataLeakageMLP(AttackEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_attacks.DataLeakageMLP
        :parts: 1
...
class DataLeakageXGB(AttackEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_attacks.DataLeakageXGB
        :parts: 1
...
class DataLeakageLinear(AttackEvaluator):
    """
    .. inheritance-diagram:: tabeval.metrics.eval_attacks.DataLeakageLinear
        :parts: 1
