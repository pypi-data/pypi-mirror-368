...
if python3 -m mypy core/ --ignore-missing-imports; then
...
if python3 -m pytest tests/ -v --cov=core --cov-report=term --cov-report=html; then
...
if python3 -c "import core; print('✅ Imports OK')"; then
