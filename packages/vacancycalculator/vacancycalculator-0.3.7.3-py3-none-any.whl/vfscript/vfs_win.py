...
class SettingsWindow(QMainWindow):
    def __init__(self):
        ...
        self.edit_lattice.setReadOnly(False)
        self.edit_lattice.setFocusPolicy(Qt.StrongFocus)
        self.edit_lattice_a = QLineEdit(str(gr[1]))
        self.edit_lattice_a.setReadOnly(False)
        self.edit_lattice_a.setFocusPolicy(Qt.StrongFocus)
        ...
        self.edit_atom.setReadOnly(False)
        self.edit_atom.setFocusPolicy(Qt.StrongFocus)
        ...
        # Selectores de dump (ahora envueltos en QWidget para habilitar foco)
        self.edit_relax = QLineEdit(cfg.get('relax', ''))
        self.edit_relax.setReadOnly(False)
        self.edit_relax.setFocusPolicy(Qt.StrongFocus)
        ...
        relax_layout.addWidget(self.edit_relax)
        relax_layout.addWidget(btn_relax)
        relax_widget = QWidget()
        relax_widget.setLayout(relax_layout)
        form_layout.addRow("Relax Dump:", relax_widget)

        self.edit_defect = QLineEdit(cfg.get('defect', [''])[0])
        self.edit_defect.setReadOnly(False)
        self.edit_defect.setFocusPolicy(Qt.StrongFocus)
        ...
        defect_layout.addWidget(self.edit_defect)
        defect_layout.addWidget(btn_defect)
