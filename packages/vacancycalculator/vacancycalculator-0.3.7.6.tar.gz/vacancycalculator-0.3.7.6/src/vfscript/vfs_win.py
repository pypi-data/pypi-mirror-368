...
class SettingsWindow(QMainWindow):
    def __init__(self):
        ...
        # Lattice 'a' como QDoubleSpinBox con paso 0.1
        ...
        # Widget de controles con scroll
        ...
        controls_widget.setFocusPolicy(Qt.StrongFocus)
        scroll = QScrollArea()
    ...
    def _configure_spin(self, spin, mn, mx, val, step=None, decimals=None):
        """Configura SpinBox/DoubleSpinBox, con paso 0.1 para flotantes."""
        spin.setRange(mn, mx)
