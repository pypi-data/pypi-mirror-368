...
class DeployService:
    ...
    def generate_statements_from_object_actions(
        ...
        return [
            [
                [
                    action.generate_statement_object(snow_client=self._snow_client_meta, policy_service=self._policy_service)
                    for action in l3 if action.generate_statement_object(snow_client=self._snow_client_meta, policy_service=self._policy_service).statement
                ]
                for l3 in l2
            ]
