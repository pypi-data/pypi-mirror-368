...
class GroqProvider(BaseModelProvider):
    ...
    def __init__(self, provider_config: Dict[str, Any]):
        ...
        self.base_url = provider_config.get("base_url", "https://api.groq.com")
    ...
    def _get_default_models(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # Mixtral Series - Updated to current models
            "mixtral-8x7b-32768": {
                "context_length": 32768,
    ...
    async def generate_text(self, request: GenerationRequest, model_id: str) -> GenerationResponse:
        ...
        try:
            ...
            if model_id in self.model_configs and self.model_configs[model_id].get("deprecated"):
                replacement = self.model_configs[model_id].get("replacement")
                if replacement:
                    logger.warning(f"Model {model_id} is deprecated, using {replacement} instead")
            ...
            # Filter out invalid parameters for Groq API
