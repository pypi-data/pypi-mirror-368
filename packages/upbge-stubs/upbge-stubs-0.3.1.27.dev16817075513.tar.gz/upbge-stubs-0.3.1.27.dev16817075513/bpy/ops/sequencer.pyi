...
def effect_strip_add(*args, type: str = 'CROSS', move_strips: bool = True, frame_start: int = 0, frame_end: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, skip_locked_or_muted_channels: bool = True, color: mathutils.Color = (0.0, 0.0, 0.0)) -> None:
