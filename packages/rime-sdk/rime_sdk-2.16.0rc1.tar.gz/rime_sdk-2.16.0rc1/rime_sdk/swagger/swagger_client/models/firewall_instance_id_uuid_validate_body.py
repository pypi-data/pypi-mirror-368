...
class FirewallInstanceIdUuidValidateBody(object):
    ...
    @property
    def config(self):
        """Gets the config of this FirewallInstanceIdUuidValidateBody.  # noqa: E501


        :return: The config of this FirewallInstanceIdUuidValidateBody.  # noqa: E501
    ...
    def config(self, config):
        """Sets the config of this FirewallInstanceIdUuidValidateBody.


        :param config: The config of this FirewallInstanceIdUuidValidateBody.  # noqa: E501
