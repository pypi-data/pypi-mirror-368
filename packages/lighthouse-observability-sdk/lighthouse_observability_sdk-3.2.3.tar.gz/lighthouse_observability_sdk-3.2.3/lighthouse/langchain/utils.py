...
#   Decided to not make this a dependency of lighthouse as few people will have this. Need to match these models manually
...
def _extract_model_name(
    ...
    **kwargs: Any,
    ...
    """Extracts the model name from the serialized or kwargs object. This is used to get the model names for lighthouse."""
    ...
    # Third, for some models, we are unable to extract the model by a path in an object. lighthouse provides us with a string representation of the model pbjects
