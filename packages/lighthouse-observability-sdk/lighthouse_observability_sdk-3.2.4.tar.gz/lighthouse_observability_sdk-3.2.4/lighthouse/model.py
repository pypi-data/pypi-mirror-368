...
from lighthouse.api.resources.commons.types.dataset import (
    Dataset,  # noqa: F401
)

# these imports need to stay here, otherwise imports from our clients wont work
from lighthouse.api.resources.commons.types.dataset_item import DatasetItem  # noqa: F401

# noqa: F401
from lighthouse.api.resources.commons.types.dataset_run import DatasetRun  # noqa: F401

# noqa: F401
from lighthouse.api.resources.commons.types.dataset_status import (  # noqa: F401
    DatasetStatus,
)
from lighthouse.api.resources.commons.types.map_value import MapValue  # noqa: F401
from lighthouse.api.resources.commons.types.observation import Observation  # noqa: F401
from lighthouse.api.resources.commons.types.trace_with_full_details import (  # noqa: F401
    TraceWithFullDetails,
)

# noqa: F401
from lighthouse.api.resources.dataset_items.types.create_dataset_item_request import (  # noqa: F401
    CreateDatasetItemRequest,
)
from lighthouse.api.resources.dataset_run_items.types.create_dataset_run_item_request import (  # noqa: F401
    CreateDatasetRunItemRequest,
)

# noqa: F401
from lighthouse.api.resources.datasets.types.create_dataset_request import (  # noqa: F401
    CreateDatasetRequest,
)
from lighthouse.api.resources.prompts import Prompt, Prompt_Chat, Prompt_Text
...
class TextPromptClient(BasePromptClient):
    ...
    def get_langchain_prompt(self, **kwargs: Union[str, Any]) -> str:
        """Convert lighthouse prompt into string compatible with Langchain PromptTemplate.

        This method adapts the mustache-style double curly braces {{variable}} used in lighthouse
...
class ChatPromptClient(BasePromptClient):
    ...
    def compile(
        ...
        **kwargs: Union[str, Any],
                    ...
                    if isinstance(placeholder_value, list):
                        for msg in placeholder_value:
                            if (
                                ...
                                lighthouse_logger.warning(no_role_content_in_placeholder)
                    else:
                        compiled_messages.append(
                            ChatMessageDict(
                                role="NOT_GIVEN",
                        ...
                        lighthouse_logger.warning(placeholder_not_a_list)
                else:
        ...
        if unresolved_placeholders:
            ...
            lighthouse_logger.warning(unresolved_placeholders_message)
    ...
    def get_langchain_prompt(
        ...
        """Convert lighthouse prompt into string compatible with Langchain ChatPromptTemplate.

        It specifically adapts the mustache-style double curly braces {{variable}} used in lighthouse
        to the single curly brace {variable} format expected by Langchain.
