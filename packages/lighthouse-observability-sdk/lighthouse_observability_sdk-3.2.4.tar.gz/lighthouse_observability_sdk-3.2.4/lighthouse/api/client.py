...
class Fernlighthouse:
    ...
    x_lighthouse_sdk_name : typing.Optional[str]
    x_lighthouse_sdk_version : typing.Optional[str]
    x_lighthouse_public_key : typing.Optional[str]
