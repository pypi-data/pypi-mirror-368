...
class CreateScoreRequest(pydantic_v1.BaseModel):
    ...
    """
    The environment of the score. Can be any lowercase alphanumeric string with hyphens and underscores that does not start with 'lighthouse'.
    """
    ...
    """
    Reference a score config on a score. The unique lighthouse identifier of a score config. When passing this field, the dataType and stringValue fields are automatically populated.
    """
