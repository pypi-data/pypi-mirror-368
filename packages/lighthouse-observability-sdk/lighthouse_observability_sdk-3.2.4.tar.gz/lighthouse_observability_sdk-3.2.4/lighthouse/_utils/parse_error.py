...
# our own api errors
from lighthouse._utils.request import APIError, APIErrors
from lighthouse.api.core import ApiError

# fern api errors
from lighthouse.api.resources.commons.errors import (
    AccessDeniedError,
    Error,
...
from lighthouse.api.resources.health.errors import ServiceUnavailableError

SUPPORT_URL = "https://lighthouse.com/support"
API_DOCS_URL = "https://api.reference.lighthouse.com"
RBAC_DOCS_URL = "https://lighthouse.com/docs/rbac"
INSTALLATION_DOCS_URL = "https://lighthouse.com/docs/sdk/typescript/guide"
RATE_LIMITS_URL = "https://lighthouse.com/faq/all/api-limits"
PYPI_PACKAGE_URL = "https://pypi.org/project/lighthouse/"
