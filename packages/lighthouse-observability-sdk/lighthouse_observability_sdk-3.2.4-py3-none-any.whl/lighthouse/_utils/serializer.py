...
from lighthouse.api.core import pydantic_utilities, serialize_datetime
...
class EventSerializer(JSONEncoder):
    ...
    def default(self, obj: Any) -> Any:
        try:
            ...
            if isinstance(obj, lighthouseMedia):
                return (
                    obj._reference_string
                    or f"<Upload handling failed for lighthouseMedia of type {obj._content_type}>"
                )
