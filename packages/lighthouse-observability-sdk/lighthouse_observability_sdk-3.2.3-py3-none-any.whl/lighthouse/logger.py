"""Logger configuration for lighthouse OpenTelemetry integration.

This module initializes and configures loggers used by the lighthouse OpenTelemetry integration.
It sets up the main 'lighthouse' logger and configures the httpx logger to reduce noise.

Log levels used throughout lighthouse:
...
# Create the main lighthouse logger
lighthouse_logger = logging.getLogger("lighthouse")
lighthouse_logger.setLevel(logging.WARNING)
