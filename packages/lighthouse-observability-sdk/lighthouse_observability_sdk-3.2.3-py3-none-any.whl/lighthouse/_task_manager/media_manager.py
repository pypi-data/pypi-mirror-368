...
from lighthouse._client.environment_variables import lighthouse_MEDIA_UPLOAD_ENABLED
from lighthouse._utils import _get_timestamp
from lighthouse.api import GetMediaUploadUrlRequest, PatchMediaBody
from lighthouse.api.client import Fernlighthouse
from lighthouse.api.core import ApiError
from lighthouse.api.resources.media.types.media_content_type import MediaContentType
    ...
    def _find_and_process_media(
        ...
        *,
        ...
        def _process_data_recursively(data: Any, level: int) -> Any:
            ...
            if isinstance(data, lighthouseMedia):
                self._process_media(
                    media=data,
                    trace_id=trace_id,
