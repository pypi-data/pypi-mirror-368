...
import logging
from .span import lighthouseSpan
from typing import TYPE_CHECKING, Any, Generator, List, Optional

from opentelemetry.util._decorator import _agnosticcontextmanager

from lighthouse.model import (
...
class DatasetItemClient:
    """Class for managing dataset items in lighthouse.
    ...
    Args:
        ...
        lighthouse (lighthouse): Instance of lighthouse client for API interactions.
    ...
    Example:
        ...
        dataset = lighthouse.get_dataset("<dataset_name>")
    ...
    def __init__(self, dataset_item: DatasetItem, lighthouse: "lighthouse"):
    ...
    def run(
        ...
        *,
    ...
    ) -> Generator[lighthouseSpan, None, None]:
        """Create a context manager for the dataset item run that links the execution to a lighthouse trace.
        ...
        Yields:
            span: A lighthouseSpan that can be used to trace the execution of the run.
        """
        trace_name = f"Dataset run: {run_name}"

        with self.lighthouse.start_as_current_span(name=trace_name) as span:
            span.update_trace(
                name=trace_name,
                metadata={
            ...
            self.lighthouse.api.dataset_run_items.create(
...
class DatasetClient:
    """Class for managing datasets in lighthouse.
