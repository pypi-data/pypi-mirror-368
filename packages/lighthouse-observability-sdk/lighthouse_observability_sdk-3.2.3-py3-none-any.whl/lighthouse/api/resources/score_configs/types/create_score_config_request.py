...
class CreateScoreConfigRequest(pydantic_v1.BaseModel):
    ...
    """
    Description is shown across the lighthouse UI and can be used to e.g. explain the config categories in detail, why a numeric range was set, or provide additional context on config name or usage
    """
