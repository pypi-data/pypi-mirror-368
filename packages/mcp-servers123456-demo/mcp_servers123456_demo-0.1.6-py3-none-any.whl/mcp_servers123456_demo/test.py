...
# 获取当前本地 ip 地址
@mcp.tool( description="Fetch the current public IP address.",
    parameters={}  )
...
@mcp.tool( description="Export a list of {'question', 'answer'} dicts to a CSV file and upload it to a remote server.",
          parameters={"json_data": {"type": "List", "description": "upload json data to export"}})
