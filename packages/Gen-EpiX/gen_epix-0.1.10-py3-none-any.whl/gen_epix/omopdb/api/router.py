...
from gen_epix.omopdb.api.auth import create_auth_endpoints
from gen_epix.omopdb.api.omop import create_omop_endpoints
from gen_epix.omopdb.api.organization import create_organization_endpoints
from gen_epix.omopdb.api.rbac import create_rbac_endpoints
from gen_epix.omopdb.api.system import create_system_endpoints
