            ...
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_0__.Grid, { item: true, xs: 12 },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("nav", { "aria-label": "job history list" },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_0__.List, { dense: dense },
                        jobs.map(job => (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_0__.ListItem, { key: job.job_id, button: true, secondaryAction: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_0__.IconButton, { edge: "end", "aria-label": "delete", onClick: async () => {
...
const activate = async (app, factory, palette, mainMenu, settings) => {
    ...
    // Set initial width for sidebar panel
    sideBarWidget.node.style.minWidth = '400px'; // ancho mínimo
    sideBarWidget.node.style.width = '500px'; // ancho inicial preferido
...
//# sourceMappingURL=lib_index_js.15914c2089c591970463.js.map