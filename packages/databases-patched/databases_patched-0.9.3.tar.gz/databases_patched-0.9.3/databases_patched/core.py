...
from databases_patched.importer import import_from_string
from databases_patched.interfaces import DatabaseBackend, Record, TransactionBackend
...
logger = logging.getLogger("databases_patched")
...
class Database:
    SUPPORTED_BACKENDS = {
        "postgresql": "databases_patched.backends.postgres:PostgresBackend",
        "postgresql+aiopg": "databases_patched.backends.aiopg:AiopgBackend",
        "postgres": "databases_patched.backends.postgres:PostgresBackend",
        "mysql": "databases_patched.backends.mysql:MySQLBackend",
        "mysql+asyncmy": "databases_patched.backends.asyncmy:AsyncMyBackend",
        "sqlite": "databases_patched.backends.sqlite:SQLiteBackend",
    }
