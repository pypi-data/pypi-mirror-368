...
from databases_patched.backends.aiopg import AiopgBackend
from databases_patched.backends.postgres import PostgresBackend
from databases_patched.core import DatabaseURL
from tests.test_databases import DATABASE_URLS, async_adapter

if sys.version_info >= (3, 7):  # pragma: no cover
    from databases_patched.backends.asyncmy import AsyncMyBackend


if sys.version_info < (3, 10):  # pragma: no cover
    from databases_patched.backends.mysql import MySQLBackend
