...
class TestWatchlistAction(unittest.TestCase):
    """WatchlistAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatchlistAction:
        """Test WatchlistAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchlistAction`
        """
        model = WatchlistAction()
        if include_optional:
