...
class ISICClass(BaseModel):
    ...
    ISICClass
    """ # noqa: E501
    code: StrictStr = Field(description="ISIC Class code.")
    name: StrictStr = Field(description="ISIC Class name.")
    industry: ISICGroup = Field(description="Parent ISIC Group.")
