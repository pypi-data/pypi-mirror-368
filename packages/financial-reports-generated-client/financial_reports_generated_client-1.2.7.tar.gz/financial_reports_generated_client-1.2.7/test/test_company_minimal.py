...
class TestCompanyMinimal(unittest.TestCase):
    """CompanyMinimal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyMinimal:
        """Test CompanyMinimal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyMinimal`
        """
        model = CompanyMinimal()
        if include_optional:
