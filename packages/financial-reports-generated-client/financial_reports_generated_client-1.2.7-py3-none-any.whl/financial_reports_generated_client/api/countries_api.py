...
class CountriesApi:
    ...
    async def countries_list(
        ...
        _param = self._countries_list_serialize(
            page=page,
            page_size=page_size,
    ...
    @validate_call
    async def countries_list_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="A page number within the paginated result set.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def countries_list_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="A page number within the paginated result set.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def countries_retrieve_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this country.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def countries_retrieve_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="A unique integer value identifying this country.")],
        _request_timeout: Union[
            None,
