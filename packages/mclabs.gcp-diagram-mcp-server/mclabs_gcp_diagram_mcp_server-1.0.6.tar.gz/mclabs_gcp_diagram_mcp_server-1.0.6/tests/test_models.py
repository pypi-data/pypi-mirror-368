...
class TestDiagramType:
    ...
    def test_diagram_type_from_string(self):
        ...
        assert DiagramType('gcp') == DiagramType.GCP
...
class TestDiagramExampleResponse:
    ...
    def test_example_response(self):
        ...
        assert 'gcp' in response.examples
        assert 'sequence' in response.examples
        assert response.examples['gcp'].startswith('with Diagram("GCP", show=False):')
...
class TestDiagramIconsResponse:
    ...
    def test_icons_response(self):
        ...
        assert 'SQL' in response.providers['gcp']['database']
        assert 'BigQuery' in response.providers['gcp']['database']
