...
@pytest.fixture
def gcp_diagram_code() -> str:
    """Return example GCP diagram code for testing."""
    return """with Diagram("Test GCP Diagram", show=False):
...
def example_diagrams() -> Dict[str, str]:
    ...
    return {
        DiagramType.GCP: """with Diagram("GCP Example", show=False):
    LoadBalancing("lb") >> ComputeEngine("web") >> SQL("userdb")
""",
