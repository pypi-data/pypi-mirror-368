...
from zut import Secret, Color, get_logger, log_warnings, skip_utf8_bom
...
def configure_logging(level: str|int|None = None, *, names = False, file_level: str|int|None = None, loggers: Mapping[str,str|int|dict|None]|None = None, count = True, exit_handler = True, override = False):
...
def get_logging_config(level: str|int|None = None, *, names = False, file_level: str|int|None = None, loggers: Mapping[str,str|int|dict|None]|None = None, count = True, exit_handler = True):
