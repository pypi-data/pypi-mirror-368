...
from zut import Column, DelayedStr, skip_utf8_bom
...
class PgDb(Db[Connection]):
    ...
    def enforce_pg_seq_offset(self, app_label: str|None = None, *, min_offset: int|None = None, max_offset: int|None = None):
        """
