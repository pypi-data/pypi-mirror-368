...
torch_npu._npu_fused_infer_attention_score_v2_get_max_workspace = torch.ops.npu._npu_fused_infer_attention_score_v2_get_max_workspace
...
torch_npu.npu_moe_token_permute_with_routing_map_grad = torch.ops.npu.npu_moe_token_permute_with_routing_map_grad
...
torch_npu.npu_moe_token_unpermute_grad = torch.ops.npu.npu_moe_token_unpermute_grad
...
torch_npu.npu_moe_token_unpermute_with_routing_map_grad = torch.ops.npu.npu_moe_token_unpermute_with_routing_map_grad
...
torch_npu._npu_moe_token_unpermute_with_routing_map = torch.ops.npu._npu_moe_token_unpermute_with_routing_map
...
torch_npu.npu_moe_token_permute_with_routing_map = torch.ops.npu.npu_moe_token_permute_with_routing_map
...
torch_npu.npu_moe_token_permute_grad = torch.ops.npu.npu_moe_token_permute_grad
...
torch_npu.npu_fused_infer_attention_score_v2 = torch.ops.npu.npu_fused_infer_attention_score_v2
...
torch_npu._npu_dtype_cast_backward = torch.ops.npu._npu_dtype_cast_backward
...
torch_npu._npu_dtype_cast = torch.ops.npu._npu_dtype_cast
...
torch_npu.npu_moe_token_unpermute_with_routing_map = torch.ops.npu.npu_moe_token_unpermute_with_routing_map
