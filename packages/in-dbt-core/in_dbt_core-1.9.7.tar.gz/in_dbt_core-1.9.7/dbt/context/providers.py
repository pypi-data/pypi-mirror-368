...
class ProviderContext(ManifestContext):
    ...
    def submit_python_job(self, parsed_model: Dict, compiled_code: str) -> AdapterResponse:
        ...
        ###  changed the condition to check for the macro call stack depth and the specific macro name as we are pushing linkedin specific macros to the macro stack.
        ### noqa

        if not (
            self.context_macro_stack.depth == 3
            and self.context_macro_stack.call_stack[2] == "macro.dbt.statement"
