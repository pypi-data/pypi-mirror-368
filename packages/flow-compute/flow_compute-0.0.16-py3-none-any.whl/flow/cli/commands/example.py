...
echo "Hello from Flow SDK!" && hostname && date""",
                ...
                "upload_code": False,  # No code upload needed for simple echo command
            },
            "gpu-test": {
                "name": "gpu-test",
                "unique_name": True,
...
nvidia-smi && echo "GPU test completed!"''',
            ...
            "system-info": {
                ...
                "max_price_per_hour": 98.32,
                "upload_code": False,  # No code upload needed for system info
            },
            "training": {
                "name": "basic-training",
                "unique_name": True,
                "instance_type": "8xh100",
                "max_price_per_hour": 98.32,
                "upload_code": False,  # No code upload needed for simulated training
                "volumes": [
