...
from flow.providers.mithril.runtime.script_size.exceptions import ScriptTooLargeError
...
from flow.providers.mithril.storage import IStorageBackend
...
class ScriptSizeHandler:
    ...
    def prepare_script(self, script: str) -> PreparedScript:
        ...
        suggestions = self.get_failure_suggestions(script_size, strategies_tried)
