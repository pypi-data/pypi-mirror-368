...
class AuthConfig:
    ...
    def __init__(
        ...
        """
        # Support both canonical and legacy env var names used in tests
        self.api_key = api_key or os.getenv("MITHRIL_API_KEY") or os.getenv("Mithril_API_KEY")
        self.email = email
...
class Authenticator:
    ...
    def authenticate(self) -> str:
        ...
        raise AuthenticationError(
            ...
            "Set MITHRIL_API_KEY (or Mithril_API_KEY) or provide email/password."
        )
...
def create_authenticator(
    ...
    Args:
        api_key: API key (or from MITHRIL_API_KEY env)
