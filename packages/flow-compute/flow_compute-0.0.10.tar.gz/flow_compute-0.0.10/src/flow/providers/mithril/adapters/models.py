...
from ..core.models import MithrilBid, MithrilInstance, MithrilVolume
...
class MithrilAdapter:
    ...
    def bid_to_task(
        cls,
        bid: MithrilBid,
        instances: Optional[List[MithrilInstance]] = None,
    ...
    def _build_status_message(
        cls, bid: MithrilBid, instances: Optional[List[MithrilInstance]]
    ) -> str:
