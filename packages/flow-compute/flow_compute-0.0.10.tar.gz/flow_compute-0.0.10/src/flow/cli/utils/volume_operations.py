...
class VolumeOperations:
    ...
    def delete_volumes(
        self,
        volumes: List[Any],
        progress_callback: Optional[Callable[[OperationResult], None]] = None,
    ...
    def find_volumes_by_pattern(self, pattern: Optional[str] = None) -> Tuple[List[Any], int]:
        ...
        """
        all_volumes = self.client.list_volumes()
