...
class Flow:
    ...
    def _find_gpus_by_memory(
        ...
        try:
            raw = provider.find_instances(
                {"gpu_memory_gb": min_memory_gb, "max_price": max_price}, limit=100
            )
                ...
                suitable.append(
                    {
                        ...
                        "gpu_memory_gb": getattr(inst, "gpu_memory_gb", min_memory_gb),
                        "price_per_hour": inst.price_per_hour,
                        "gpu_model": getattr(inst, "gpu_type", "unknown"),
                    }
                )
