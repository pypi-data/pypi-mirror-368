    ...
    def get_configuration_fields(self) -> list[ConfigField]:
        ...
        return [
            ConfigField(
                ...
                required=True,
                mask_display=True,
                help_url=__import__('flow.links', fromlist=['WebLinks']).links.WebLinks.api_keys(),
            ...
            ConfigField(
                ...
                required=True,
                dynamic_choices=True,
                help_url=__import__('flow.links', fromlist=['WebLinks']).links.WebLinks.ssh_keys(),
                help_text=(
                    "Choose how you'll SSH into instances. Pick an existing key from your "
                    "Mithril account or select Auto‑generate per instance (recommended)."
                ),
