...
Type-safe interface for managing secrets in tasks. Ensures sensitive data is not
exposed in logs, configurations, or code. Secrets are injected at runtime via
