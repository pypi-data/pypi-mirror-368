...
from .selection import Selection, SelectionParseError


def parse_selection_to_task_ids(expr: str) -> Tuple[Optional[List[str]], Optional[str]]:
    """Parse an index/range expression to concrete task IDs via cache.

    Accepts optional leading colon, e.g. ":1-3,5" or "2".
