...
This module provides a centralized template system for generating bootstrap
scripts used by various script size strategies. Templates are versioned and
parameterized for maintainability and testability.
"""
...
"""
    ...
    def render(cls, template_name: str, **kwargs) -> str:
        ...
        try:
            from ..startup.origin import get_flow_origin_header
