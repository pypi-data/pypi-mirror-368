        ...
        def pricing(compact: bool = False, market: bool = False, region: str | None = None):
            ...
            if market:
                try:
                    ...
                    table.add_column("Region", style=theme_manager.get_color("accent"), no_wrap=True)
                    ...
                    # Link to provider console for richer graphs
                    console.print(
                        "More details and price graphs: https://app.mithril.ai/instances/spot\n"
                    )
