"""Storage backend implementation for Mithril provider.

This module provides a local HTTP server backend for handling large files
like startup scripts during development and testing.
"""
