...
class AnimationSelector:
    ...
    def __init__(self, default_style: Optional[AnimationStyle] = None):
        ...
        self._override_style: Optional[AnimationStyle] = None

    def select(self, requested_style: Optional[AnimationStyle] = None) -> AnimationStyle:
    ...
    def set_override(self, style: Optional[AnimationStyle]) -> None:
...
def get_animation_style(requested: Optional[AnimationStyle] = None) -> AnimationStyle:
