                ...
                if not volumes:
                    ...
                    self.show_next_actions(
                        [
                            ...
                            "Create a named volume: [accent]flow volumes create --size 50 --name training-data[/accent]",
                            "Create file storage: [accent]flow volumes create --size 200 --interface file[/accent]",
                        ]
                    )
                    return
