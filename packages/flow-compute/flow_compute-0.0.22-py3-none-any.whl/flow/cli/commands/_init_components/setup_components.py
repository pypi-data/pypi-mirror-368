        ...
        if not projects:
            ...
            self.console.print(
                (
                    ...
                    f"{__import__('flow.links', fromlist=['WebLinks']).links.WebLinks.projects_settings()}[/dim]"
                )
            )
...
Steps:
1. Upload a public key: {__import__('flow.links', fromlist=['WebLinks']).links.WebLinks.ssh_keys()}
...
[dim]SSH access is optional; you can configure it later.[/dim]
        ...
        self.console.print(
            (
                ...
                f"{__import__('flow.links', fromlist=['WebLinks']).links.WebLinks.ssh_keys()}[/link]"
            )
        )
        self.console.print(
