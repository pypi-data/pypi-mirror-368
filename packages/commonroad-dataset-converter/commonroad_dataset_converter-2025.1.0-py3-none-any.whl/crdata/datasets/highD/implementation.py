...
from crdata.datasets.common.levelx_datasets import LevelXRecording
from crdata.datasets.common.obstacle_utils import (
    get_acceleration,
    get_orientation,
    get_velocity,
)
...
class HighdRecordingGenerator(IRecordingGenerator):
    ...
    def __iter__(self) -> Iterable[Tuple[Window, LevelXRecording]]:
        for tracks_path in self.data_path.rglob("*_tracks.csv"):
            ...
            recording_meta.replace({"locationId": self.locations}, inplace=True)
