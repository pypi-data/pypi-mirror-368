...
async def test_dict():
    ...
    param_obj = DabPumpsParam(key="tst_key", type=DabPumpsParamType.MEASURE, unit="tst", weight=10, values={"1":"one","2":"two"}, min=None, max=None, family="tst_family", group="tst_group", view="ci", change="", log="", report="")
    ...
    param_object = DabPumpsParam(**param_dict)
