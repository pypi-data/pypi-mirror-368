...
if __name__ == "__main__":
    df = pd.read_csv(r"C:\Users\HemaKalyanMurapaka\Desktop\Congress Reports\ERS 2025\all_sessions_218 15-07.csv")
    format(dataframe=df, output_path=r"C:\Users\HemaKalyanMurapaka\Desktop\all_sessions_218 15-07.xlsx")