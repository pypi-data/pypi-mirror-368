        ...
        if zone_analysis:
            ...
            for zone_name, zone_count in zone_analysis.items():
                ...
                if zone_total > 0:
                    ...
                    human_text_lines.append(f"\t\t\t- Total people in abandoned zone: {zone_total}")
                    # Main people counting incident
        ...
        if zone_analysis:
                ...
                def robust_zone_total(zone_count):
                    if isinstance(zone_count, dict):
                        ...
                        return 0
                human_text_lines.append(f"\t- People Detected in Abandoned Area: {total_people}")
                ...
                for zone_name, zone_count in zone_analysis.items():
                        ...
                        human_text_lines.append(f"\t- Zone name: {zone_name}")
                        human_text_lines.append(f"\t\t- Total count in Abandoned Area: {zone_total-1}")
