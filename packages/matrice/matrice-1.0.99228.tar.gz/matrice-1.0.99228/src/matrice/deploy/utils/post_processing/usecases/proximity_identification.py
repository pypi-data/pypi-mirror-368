"""
Proximity Identification use case implementation.

This module provides a clean implementation of proximity functionality
...
class ProximityUseCase(BaseProcessor):
    """Proximity Identification use case with zone analysis and alerting."""
    
    def __init__(self):
        """Initialize Proximity Identification use case."""
        super().__init__("proximity_identification")
        self.category = "security"
        self.CASE_TYPE: Optional[str] = 'proximity_identification'
    ...
    def process(self, data: Any, config: ConfigProtocol, 
        ...
        """
        Process Proximity Identification use case - automatically detects single or multi-frame structure.
        
        Args:
            data: Raw model output (detection or tracking format)
            config: Proximity Identification configuration
        ...
        try:
            ...
            if not isinstance(config, ProximityConfig):
                return self.create_error_result(
                    "Invalid configuration type for Proximity Identification",
                    usecase=self.name,
            ...
            self.logger.error(f"Proximity Identification failed: {str(e)}", exc_info=True)
    ...
    def _update_zone_tracking(self, zone_analysis: Dict[str, Dict[str, int]], detections: List[Dict], config: ProximityConfig) -> Dict[str, Dict[str, Any]]:
        ...
        Args:
            ...
            config: Proximity Identification configuration with zone polygons
    ...
    def get_config_schema(self) -> Dict[str, Any]:
        """Get configuration schema for Proximity Identification."""
        return {
            "type": "object",
            "properties": {
