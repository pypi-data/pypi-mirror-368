...
from typing import Any, AsyncGenerator, Iterator, Optional, List, Dict, cast
...
class Knowledgebase:
    ...
    def retrieve(
        ...
        **kwargs,
        ...
        Returns:
            tuple[str | None, list[Document] | None]: A tuple containing a prompt for an LLM and the retrieved documents.
        """
        raise NotImplementedError
    ...
    async def aretrieve(
        ...
        **kwargs,
        ...
        """Asynchronously retrieve from the knowledge base.
    ...
    async def aget_documents(
        ...
        """
        raise NotImplementedError
        yield  # makes it a true async generator
...
class RWKnowledgebase(Knowledgebase):
    ...
    async def aindex(self, data_source: Optional[DataSourceOrLoader] = None):
        """Do an index run on either a provides data source or the data sources passed in the constructor.
