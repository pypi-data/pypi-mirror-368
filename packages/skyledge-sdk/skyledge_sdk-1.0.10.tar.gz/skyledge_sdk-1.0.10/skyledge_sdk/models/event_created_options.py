...
class EventCreatedOptions(BaseModel):
    """
    EventCreatedOptions
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["eventTypeIds", "assetTypeIds", "assetIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventCreatedOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventCreatedOptions from a dict"""
        if obj is None:
            return None
