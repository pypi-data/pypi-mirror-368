...
class AttachedEntity(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['asset', 'task']):
            raise ValueError("must be one of enum values ('asset', 'task')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttachedEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttachedEntity from a dict"""
        if obj is None:
            return None
