...
class UpdateAssetRequest(BaseModel):
    ...
    location: Optional[GeometryCollectionAllOfGeometries] = None
    attributes: Dict[str, Any]
    metrics: Dict[str, Union[StrictFloat, StrictInt]]
    external_urls: Dict[str, StrictStr] = Field(alias="externalUrls")
    __properties: ClassVar[List[str]] = ["name", "description", "timestamp", "location", "attributes", "metrics", "externalUrls"]
