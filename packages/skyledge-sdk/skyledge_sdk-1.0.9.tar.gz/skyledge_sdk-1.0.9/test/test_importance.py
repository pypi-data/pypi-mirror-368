...
class TestImportance(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Importance:
        """Test Importance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Importance`
        """
        model = Importance()
        if include_optional:
            return Importance(
