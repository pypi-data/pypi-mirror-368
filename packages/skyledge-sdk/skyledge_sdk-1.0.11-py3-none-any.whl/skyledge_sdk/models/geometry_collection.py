...
class GeometryCollection(GeoJsonObject):
    ...
    GeometryCollection
    """ # noqa: E501
    geometries: Optional[List[GeoJsonObject]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bbox": obj.get("bbox"),
            "type": obj.get("type"),
            "geometries": [GeoJsonObject.from_dict(_item) for _item in obj["geometries"]] if obj.get("geometries") is not None else None
        })
        return _obj
