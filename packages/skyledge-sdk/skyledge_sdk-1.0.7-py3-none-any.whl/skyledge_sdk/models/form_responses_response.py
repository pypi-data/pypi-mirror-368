...
class FormResponsesResponse(BaseModel):
    ...
    responses: Optional[FormsResponseForms] = None
    __properties: ClassVar[List[str]] = ["totalCount", "responses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FormResponsesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FormResponsesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "responses": FormsResponseForms.from_dict(obj["responses"]) if obj.get("responses") is not None else None
        })
        return _obj
