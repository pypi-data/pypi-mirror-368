...
class UpdateAssetTableViewRequest(BaseModel):
    """
    UpdateAssetTableViewRequest
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, alias="displayName")
    fields: Optional[List[ModelField]] = None
    __properties: ClassVar[List[str]] = ["displayName", "fields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateAssetTableViewRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateAssetTableViewRequest from a dict"""
        if obj is None:
            return None
