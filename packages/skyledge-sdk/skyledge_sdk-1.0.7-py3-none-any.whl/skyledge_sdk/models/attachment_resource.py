...
class AttachmentResource(BaseModel):
    ...
    file_attributes: Optional[Dict[str, Any]] = Field(default=None, alias="fileAttributes")
    __properties: ClassVar[List[str]] = ["fileId", "originalFileName", "mimeType", "fileAttributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttachmentResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttachmentResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fileAttributes": obj.get("fileAttributes")
        })
        return _obj
