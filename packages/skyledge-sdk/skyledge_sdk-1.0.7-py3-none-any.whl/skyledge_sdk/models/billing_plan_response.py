...
class BillingPlanResponse(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    billing_interval: StrictStr = Field(alias="billingInterval")
    limits: List[PlanConstraint]
    permissions: List[StrictStr]
    __properties: ClassVar[List[str]] = ["name", "billingInterval", "limits", "permissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limits": [PlanConstraint.from_dict(_item) for _item in obj["limits"]] if obj.get("limits") is not None else None,
