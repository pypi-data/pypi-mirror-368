...
class AssetMetricResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["times", "values", "totalCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetMetricResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetMetricResponse from a dict"""
        if obj is None:
            return None
