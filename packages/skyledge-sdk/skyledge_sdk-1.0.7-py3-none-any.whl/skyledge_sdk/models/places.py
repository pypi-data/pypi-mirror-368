...
class Places(BaseModel):
    ...
    places: Optional[List[PlaceResponse]] = None
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["totalCount", "places", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "places": [PlaceResponse.from_dict(_item) for _item in obj["places"]] if obj.get("places") is not None else None,
            "_links": dict(
