...
class PaymentMethodResponse(BaseModel):
    ...
    expiry_month: StrictInt = Field(alias="expiryMonth")
    expiry_year: StrictInt = Field(alias="expiryYear")
    last4_digits: StrictStr = Field(alias="last4Digits")
    __properties: ClassVar[List[str]] = ["primary", "name", "expiryMonth", "expiryYear", "last4Digits"]
