...
FEATUREALLOFGEOMETRY_ONE_OF_SCHEMAS = ["FeatureCollection", "GeometryCollection", "LineString", "MultiLineString", "MultiPoint", "MultiPolygon", "Point", "Polygon"]

class FeatureAllOfGeometry(BaseModel):
    """
    FeatureAllOfGeometry
    """
    # data type: FeatureCollection
    oneof_schema_1_validator: Optional[FeatureCollection] = None
    # data type: GeometryCollection
    oneof_schema_2_validator: Optional[GeometryCollection] = None
    ...
    oneof_schema_5_validator: Optional[MultiPoint] = None
    # data type: MultiPolygon
    oneof_schema_6_validator: Optional[MultiPolygon] = None
    # data type: Point
    oneof_schema_7_validator: Optional[Point] = None
    # data type: Polygon
    oneof_schema_8_validator: Optional[Polygon] = None
    actual_instance: Optional[Union[FeatureCollection, GeometryCollection, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon]] = None
    one_of_schemas: Set[str] = { "FeatureCollection", "GeometryCollection", "LineString", "MultiLineString", "MultiPoint", "MultiPolygon", "Point", "Polygon" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = FeatureAllOfGeometry.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in FeatureAllOfGeometry with oneOf schemas: FeatureCollection, GeometryCollection, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in FeatureAllOfGeometry with oneOf schemas: FeatureCollection, GeometryCollection, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into FeatureAllOfGeometry with oneOf schemas: FeatureCollection, GeometryCollection, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FeatureAllOfGeometry with oneOf schemas: FeatureCollection, GeometryCollection, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], FeatureCollection, GeometryCollection, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon]]:
...
FeatureAllOfGeometry.model_rebuild(raise_errors=False)
