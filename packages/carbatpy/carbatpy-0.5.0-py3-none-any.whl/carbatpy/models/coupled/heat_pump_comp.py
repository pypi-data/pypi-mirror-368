...
def heat_pump(dir_name, power=1000., **kwargs):
    ...
    at ambient temperature. The power is set and fixed. The starting point of the
...
if __name__ == "__main__":
    ...
    conf_m = {"cold_storage": {"temp_low": 254.},
              "working_fluid": {"p_high": 1.49e6,
                                'fractions': [.74, 0.26, .0, 0.0000]}}
    conf_m2 = {"cold_storage": {"temp_low": 274.},
              "working_fluid": {"p_high": 1.91e6,
                                'fractions': [0.75,
                                              0.25,
                                              0.01e-4,
                                              0.01e-4]},
