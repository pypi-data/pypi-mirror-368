...
class CampaignManager:
    ...
    def create_or_load_campaign(self, folder_path: str) -> int:
    ...
    def configure_smtp(self) -> int:
        ...
        smtp_config = self._get_smtp_config_from_user()
    ...
    def _get_smtp_config_from_user(self) -> Dict[str, Any]:
