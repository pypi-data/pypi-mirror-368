...
class TestFileUpload:
    ...
    @patch('contextbase.http_client.HttpClient.post')
    def test_publish_file_convenience_method_with_file_object(self, mock_post):
        """Test publish_file convenience method with ContextbaseFile object."""
        # Setup
        mock_response = Mock()
        mock_response.status_code = 200
        ...
        # Create ContextbaseFile object
        content = "Convenience method with ContextbaseFile object"
        file_obj = ContextbaseFile.from_data(content, "convenience.txt")
        
        client = Contextbase(api_key="test-key")
        
        # Execute using convenience method with ContextbaseFile object
        ...
        assert data["component_name"] == "documents"
...
class TestFileUploadDecorator:
    ...
    def test_decorator_as_file_string_content(self, mock_contextbase_class):
        ...
        assert call_args[1]["component_name"] == "daily-summary"
