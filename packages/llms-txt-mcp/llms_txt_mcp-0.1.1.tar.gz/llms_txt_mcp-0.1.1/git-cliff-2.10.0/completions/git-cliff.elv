...
set edit:completion:arg-completer[git-cliff] = {|@words|
    ...
    var completions = [
        &'git-cliff'= {
            ...
            cand --config-url 'Sets the URL for the configuration file'
            ...
            cand --gitea-repo 'Sets the Gitea repository'
            ...
            cand --use-branch-tags 'Include only the tags that belong to the current branch'
            ...
            cand --use-native-tls 'Load TLS certificates from the native certificate store'
        }
    ]
    $completions[$command]
}
