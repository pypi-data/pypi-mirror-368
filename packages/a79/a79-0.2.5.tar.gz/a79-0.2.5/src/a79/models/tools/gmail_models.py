...
class FetchEmailsInput(BaseModel):
    ...
    label_ids: Optional[list[Any]] = Field(
        default=None,
        description="""Filter by label IDs; only messages with all specified labels are returned. Common IDs: 'INBOX', 'SPAM', 'TRASH', 'UNREAD', 'STARRED', 'IMPORTANT', 'CATEGORY_PERSONAL' (alias 'CATEGORY_PRIMARY'), 'CATEGORY_SOCIAL', 'CATEGORY_PROMOTIONS', 'CATEGORY_UPDATES', 'CATEGORY_FORUMS'. Use 'listLabels' action for custom IDs.""",
    )  # noqa: E501
