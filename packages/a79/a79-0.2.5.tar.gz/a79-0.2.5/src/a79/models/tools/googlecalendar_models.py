...
class EventsListInput(BaseModel):
    ...
    timeMax: Optional[str] = Field(
        default="2025-08-04T11:06:22.660042",
    ...
    timeMin: Optional[str] = Field(
        default="2025-07-28T11:06:22.660060",
...
class QuickAddInput(BaseModel):
    """Input model for GOOGLECALENDAR_QUICK_ADD"""
    ...
    send_updates: Optional[Literal["all", "externalOnly", "none"]] = Field(
        default="none",
...
class CalendarListUpdateInput(BaseModel):
    """Input model for GOOGLECALENDAR_CALENDAR_LIST_UPDATE"""
