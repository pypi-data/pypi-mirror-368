...
class TestCryptoWalletSanctionsCheckResponseM(unittest.TestCase):
    """CryptoWalletSanctionsCheckResponseM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CryptoWalletSanctionsCheckResponseM:
        """Test CryptoWalletSanctionsCheckResponseM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CryptoWalletSanctionsCheckResponseM`
        """
        model = CryptoWalletSanctionsCheckResponseM()
        if include_optional:
            return CryptoWalletSanctionsCheckResponseM(
                message_id = '',
                correlation_id = '',
                idempotency_key = '',
                in_error = True,
    ...
    def testCryptoWalletSanctionsCheckResponseM(self):
        """Test CryptoWalletSanctionsCheckResponseM"""
