...
class TestEntitySanctionsCheckResponseM(unittest.TestCase):
    """EntitySanctionsCheckResponseM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntitySanctionsCheckResponseM:
        """Test EntitySanctionsCheckResponseM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntitySanctionsCheckResponseM`
        """
        model = EntitySanctionsCheckResponseM()
        if include_optional:
            return EntitySanctionsCheckResponseM(
                message_id = '',
                correlation_id = '',
                idempotency_key = '',
                in_error = True,
    ...
    def testEntitySanctionsCheckResponseM(self):
        """Test EntitySanctionsCheckResponseM"""
