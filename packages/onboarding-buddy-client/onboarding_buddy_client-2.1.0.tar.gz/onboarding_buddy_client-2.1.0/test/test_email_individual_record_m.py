...
class TestEmailIndividualRecordM(unittest.TestCase):
    """EmailIndividualRecordM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailIndividualRecordM:
        """Test EmailIndividualRecordM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailIndividualRecordM`
        """
        model = EmailIndividualRecordM()
        if include_optional:
            return EmailIndividualRecordM(
                full_name = '',
                first_name = '',
                last_name = '',
                program = '',
    ...
    def testEmailIndividualRecordM(self):
        """Test EmailIndividualRecordM"""
