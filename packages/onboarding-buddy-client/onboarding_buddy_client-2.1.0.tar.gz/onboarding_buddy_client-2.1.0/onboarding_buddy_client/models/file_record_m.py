...
class FileRecordM(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["globalId", "organisationGlobalId", "applicationGlobalId", "fileName", "mimeType", "originType", "originalFileName", "fileSize", "fileStatus", "fileHash", "fileGroup", "prompt", "idempotencyKey", "title", "description", "tags", "reasoning", "createdDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileRecordM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileRecordM from a dict"""
        if obj is None:
            return None
