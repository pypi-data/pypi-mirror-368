...
class SearchFileResponseM(BaseModel):
    """
    SearchFileResponseM
    """ # noqa: E501
    ...
    file_records: Optional[List[SearchFileRecordM]] = Field(default=None, alias="fileRecords")
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "query", "status", "fileRecords"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchFileResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchFileResponseM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fileRecords": [SearchFileRecordM.from_dict(_item) for _item in obj["fileRecords"]] if obj.get("fileRecords") is not None else None
        })
        return _obj
