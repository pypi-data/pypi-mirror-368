...
class BrowserGetBatchResponseM(BaseModel):
    """
    ...
    result_data: Optional[List[BrowserResultM]] = Field(default=None, alias="resultData")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserGetBatchResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserGetBatchResponseM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "resultData": [BrowserResultM.from_dict(_item) for _item in obj["resultData"]] if obj.get("resultData") is not None else None
        })
        return _obj
