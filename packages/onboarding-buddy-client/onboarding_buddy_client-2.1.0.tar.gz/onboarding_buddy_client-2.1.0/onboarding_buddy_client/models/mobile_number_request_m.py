...
class MobileNumberRequestM(BaseModel):
    """
    MobileNumberRequestM
    """ # noqa: E501
    ...
    mobile_number: MobileNumberM = Field(alias="mobileNumber")
    __properties: ClassVar[List[str]] = ["correlationId", "idempotencyKey", "mobileNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MobileNumberRequestM from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.mobile_number:
            _dict['mobileNumber'] = self.mobile_number.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MobileNumberRequestM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "mobileNumber": MobileNumberM.from_dict(obj["mobileNumber"]) if obj.get("mobileNumber") is not None else None
        })
        return _obj
