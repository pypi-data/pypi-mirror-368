...
class IndividualSanctionsCheckResponseM(BaseModel):
    """
    ...
    results: Optional[List[IndividualSanctionRecordM]] = None
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "matched", "results"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IndividualSanctionsCheckResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IndividualSanctionsCheckResponseM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [IndividualSanctionRecordM.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
