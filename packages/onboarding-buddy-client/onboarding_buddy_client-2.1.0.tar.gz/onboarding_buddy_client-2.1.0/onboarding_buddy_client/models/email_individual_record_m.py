...
class EmailIndividualRecordM(BaseModel):
    """
    EmailIndividualRecordM
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["fullName", "firstName", "lastName", "program", "title", "aliasList", "nationality", "gender", "linkedTo", "secondarySanctionsRisk", "digitalCurrencyAddress", "websites", "emailAddress", "alsoKnownAs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailIndividualRecordM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailIndividualRecordM from a dict"""
        if obj is None:
            return None
