...
class BrowserRequestM(BaseModel):
    """
    BrowserRequestM
    """ # noqa: E501
    ...
    user_agent: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="userAgent")
    __properties: ClassVar[List[str]] = ["correlationId", "idempotencyKey", "userAgent"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserRequestM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserRequestM from a dict"""
        if obj is None:
            return None
