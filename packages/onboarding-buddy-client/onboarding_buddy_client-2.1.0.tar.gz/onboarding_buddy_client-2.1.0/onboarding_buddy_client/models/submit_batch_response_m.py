...
class SubmitBatchResponseM(BaseModel):
    """
    ...
    batch_status: Optional[StrictInt] = Field(default=None, alias="batchStatus")
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "batchId", "batchStatus"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitBatchResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitBatchResponseM from a dict"""
        if obj is None:
            return None
