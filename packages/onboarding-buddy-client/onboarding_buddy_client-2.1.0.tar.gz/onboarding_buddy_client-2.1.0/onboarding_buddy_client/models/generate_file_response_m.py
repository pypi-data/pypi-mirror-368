...
class GenerateFileResponseM(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "fileGlobalId", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenerateFileResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenerateFileResponseM from a dict"""
        if obj is None:
            return None
