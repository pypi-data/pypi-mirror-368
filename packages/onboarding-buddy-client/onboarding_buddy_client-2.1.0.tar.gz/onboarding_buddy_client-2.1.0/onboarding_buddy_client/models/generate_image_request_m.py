...
class GenerateImageRequestM(BaseModel):
    """
    GenerateImageRequestM
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["correlationId", "idempotencyKey", "prompt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenerateImageRequestM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenerateImageRequestM from a dict"""
        if obj is None:
            return None
