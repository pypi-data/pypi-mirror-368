...
class FileRecordListResponseM(BaseModel):
    """
    ...
    file_records: Optional[List[FileRecordM]] = Field(default=None, alias="fileRecords")
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "fileRecords"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileRecordListResponseM from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in file_records (list)
        _items = []
        if self.file_records:
            for _item_file_records in self.file_records:
                if _item_file_records:
                    _items.append(_item_file_records.to_dict())
            _dict['fileRecords'] = _items
        ...
        # set to None if file_records (nullable) is None
        # and model_fields_set contains the field
        if self.file_records is None and "file_records" in self.model_fields_set:
            _dict['fileRecords'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileRecordListResponseM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fileRecords": [FileRecordM.from_dict(_item) for _item in obj["fileRecords"]] if obj.get("fileRecords") is not None else None
        })
        return _obj
