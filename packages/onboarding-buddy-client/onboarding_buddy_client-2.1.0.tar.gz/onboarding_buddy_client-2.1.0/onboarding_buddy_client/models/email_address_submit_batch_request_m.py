...
class EmailAddressSubmitBatchRequestM(BaseModel):
    """
    EmailAddressSubmitBatchRequestM
    """ # noqa: E501
    ...
    item_list: List[StrictStr] = Field(alias="itemList")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailAddressSubmitBatchRequestM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailAddressSubmitBatchRequestM from a dict"""
        if obj is None:
            return None
