...
class IpAddressRequestM(BaseModel):
    """
    IpAddressRequestM
    """ # noqa: E501
    ...
    ip_address: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="ipAddress")
    __properties: ClassVar[List[str]] = ["correlationId", "idempotencyKey", "ipAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IpAddressRequestM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IpAddressRequestM from a dict"""
        if obj is None:
            return None
