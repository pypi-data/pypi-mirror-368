...
class PollBatchResponseM(BaseModel):
    """
    PollBatchResponseM
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "batchId", "batchStatus", "batchSize", "batchType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PollBatchResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PollBatchResponseM from a dict"""
        if obj is None:
            return None
