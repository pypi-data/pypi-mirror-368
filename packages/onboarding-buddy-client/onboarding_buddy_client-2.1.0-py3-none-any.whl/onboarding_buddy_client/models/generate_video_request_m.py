...
class GenerateVideoRequestM(BaseModel):
    """
    GenerateVideoRequestM
    """ # noqa: E501
    ...
    image_file_global_id: Optional[StrictStr] = Field(default=None, alias="imageFileGlobalId")
    __properties: ClassVar[List[str]] = ["correlationId", "idempotencyKey", "prompt", "imageFileGlobalId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenerateVideoRequestM from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if image_file_global_id (nullable) is None
        # and model_fields_set contains the field
        if self.image_file_global_id is None and "image_file_global_id" in self.model_fields_set:
            _dict['imageFileGlobalId'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenerateVideoRequestM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "imageFileGlobalId": obj.get("imageFileGlobalId")
        })
        return _obj
