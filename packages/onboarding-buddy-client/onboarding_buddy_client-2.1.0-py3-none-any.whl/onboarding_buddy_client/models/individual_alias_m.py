...
class IndividualAliasM(BaseModel):
    """
    IndividualAliasM
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["fullName", "firstName", "lastName", "remarks"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IndividualAliasM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IndividualAliasM from a dict"""
        if obj is None:
            return None
