...
class AircraftSanctionsCheckResponseM(BaseModel):
    """
    ...
    match: Optional[List[AircraftSanctionRecordM]] = None
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "matched", "match"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AircraftSanctionsCheckResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AircraftSanctionsCheckResponseM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "match": [AircraftSanctionRecordM.from_dict(_item) for _item in obj["match"]] if obj.get("match") is not None else None
        })
        return _obj
