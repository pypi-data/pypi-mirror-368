...
class RagQueryResponseM(BaseModel):
    """
    RagQueryResponseM
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "generatedText"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RagQueryResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RagQueryResponseM from a dict"""
        if obj is None:
            return None
