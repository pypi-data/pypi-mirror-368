...
class FileRecordResponseM(BaseModel):
    """
    FileRecordResponseM
    """ # noqa: E501
    ...
    file_record: Optional[FileRecordM] = Field(default=None, alias="fileRecord")
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "fileRecord"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileRecordResponseM from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of file_record
        if self.file_record:
            _dict['fileRecord'] = self.file_record.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileRecordResponseM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fileRecord": FileRecordM.from_dict(obj["fileRecord"]) if obj.get("fileRecord") is not None else None
        })
        return _obj
