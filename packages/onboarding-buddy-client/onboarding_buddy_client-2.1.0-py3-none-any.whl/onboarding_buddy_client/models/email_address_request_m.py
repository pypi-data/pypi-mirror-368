...
class EmailAddressRequestM(BaseModel):
    """
    EmailAddressRequestM
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["correlationId", "idempotencyKey", "emailAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailAddressRequestM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailAddressRequestM from a dict"""
        if obj is None:
            return None
