...
class DigitalCurrencyAddressM(BaseModel):
    """
    DigitalCurrencyAddressM
    """ # noqa: E501
    instrument: Optional[StrictStr] = None
    address: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["instrument", "address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DigitalCurrencyAddressM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DigitalCurrencyAddressM from a dict"""
        if obj is None:
            return None
