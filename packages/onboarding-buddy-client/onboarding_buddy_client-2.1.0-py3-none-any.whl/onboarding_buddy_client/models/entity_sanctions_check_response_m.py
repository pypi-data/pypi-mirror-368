...
class EntitySanctionsCheckResponseM(BaseModel):
    """
    ...
    match: Optional[List[OtherSanctionRecordM]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntitySanctionsCheckResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntitySanctionsCheckResponseM from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "match": [OtherSanctionRecordM.from_dict(_item) for _item in obj["match"]] if obj.get("match") is not None else None
        })
        return _obj
