...
def validate_directory_size(
    directory_path: Path, max_size_gb: float = MAX_DIRECTORY_SIZE_GB
) -> None:
    """Check that the total directory size is less than the specified limit."""
    max_size_bytes = int(max_size_gb * 1024 * 1024 * 1024)
    total_size = 0
