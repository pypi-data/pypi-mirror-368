...
class IPerformStoreActionSingleWithBodyAuthPayload(BaseModel):
    ...
    data_secret: Optional[StrictStr] = Field(default=None, description="The data secret. Needed if you are not signed in as creator. Not applicable to public stores", alias="dataSecret")
