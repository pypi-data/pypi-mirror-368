...
class IUpdateUtilityPagePayload(BaseModel):
    """
    ...
    content: List[IUtilityPageContent] = Field(description="The content for the listing. This is only used for a dedicated listing page (not compatible with direct link or inherited metadata).")
    links: List[IUtilityPageLink] = Field(description="The links for the listing. This is only used for a dedicated listing page (not compatible with direct link or inherited metadata).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateUtilityPagePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateUtilityPagePayload from a dict"""
        if obj is None:
            return None
