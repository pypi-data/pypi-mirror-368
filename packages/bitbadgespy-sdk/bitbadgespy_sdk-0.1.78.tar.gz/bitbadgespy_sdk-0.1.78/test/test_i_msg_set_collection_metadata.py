...
class TestIMsgSetCollectionMetadata(unittest.TestCase):
    """IMsgSetCollectionMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetCollectionMetadata:
        """Test IMsgSetCollectionMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetCollectionMetadata`
        """
        model = IMsgSetCollectionMetadata()
        if include_optional:
            return IMsgSetCollectionMetadata(
                creator = '',
                collection_id = None,
    ...
    def testIMsgSetCollectionMetadata(self):
        """Test IMsgSetCollectionMetadata"""
