...
class TestIETHSignatureProof(unittest.TestCase):
    """IETHSignatureProof unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IETHSignatureProof:
        """Test IETHSignatureProof
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IETHSignatureProof`
        """
        model = IETHSignatureProof()
        if include_optional:
            return IETHSignatureProof(
                nonce = '',
                signature = ''
            )
        else:
    ...
    def testIETHSignatureProof(self):
        """Test IETHSignatureProof"""
