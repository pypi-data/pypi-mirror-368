...
class IDynamicStoreChallenge(BaseModel):
    """
    IDynamicStoreChallenge
    """ # noqa: E501
    store_id: NumberType = Field(description="The ID of the dynamic store to check.", alias="storeId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IDynamicStoreChallenge from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IDynamicStoreChallenge from a dict"""
        if obj is None:
            return None
