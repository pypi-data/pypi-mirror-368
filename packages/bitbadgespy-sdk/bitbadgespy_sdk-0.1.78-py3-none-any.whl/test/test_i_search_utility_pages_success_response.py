...
class TestISearchUtilityPagesSuccessResponse(unittest.TestCase):
    """ISearchUtilityPagesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchUtilityPagesSuccessResponse:
        """Test ISearchUtilityPagesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchUtilityPagesSuccessResponse`
        """
        model = ISearchUtilityPagesSuccessResponse()
        if include_optional:
            return ISearchUtilityPagesSuccessResponse(
                docs = [
                    {
                        'key' : null
                        }
    ...
    def testISearchUtilityPagesSuccessResponse(self):
        """Test ISearchUtilityPagesSuccessResponse"""
