...
from bitbadgespy_sdk.api.utility_pages_api import UtilityPagesApi


class TestUtilityPagesApi(unittest.TestCase):
    """UtilityPagesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UtilityPagesApi()

    def tearDown(self) -> None:
        pass

    def test_create_utility_page(self) -> None:
        """Test case for create_utility_page

        Create Utility Page
        """
        pass

    def test_delete_utility_page(self) -> None:
        """Test case for delete_utility_page

        Delete Utility Page
        """
        pass

    def test_get_utility_page(self) -> None:
        """Test case for get_utility_page

        Get Utility Page
        """
        pass

    def test_get_utility_pages(self) -> None:
        """Test case for get_utility_pages

        Get Utility Pages - Batch
        """
        pass

    def test_search_utility_pages(self) -> None:
        """Test case for search_utility_pages

        Search Utility Pages
        """
        pass

    def test_update_utility_page(self) -> None:
        """Test case for update_utility_page
