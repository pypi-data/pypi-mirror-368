...
class TestIGetBalanceByAddressPayload(unittest.TestCase):
    """IGetBalanceByAddressPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBalanceByAddressPayload:
        """Test IGetBalanceByAddressPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBalanceByAddressPayload`
        """
        model = IGetBalanceByAddressPayload()
        if include_optional:
            return IGetBalanceByAddressPayload(
    ...
    def testIGetBalanceByAddressPayload(self):
        """Test IGetBalanceByAddressPayload"""
