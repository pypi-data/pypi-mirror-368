...
from bitbadgespy_sdk.models.i_filter_suggestions_success_response_attributes_inner_floor_price import IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice

class TestIFilterSuggestionsSuccessResponseAttributesInnerFloorPrice(unittest.TestCase):
    """IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice:
        """Test IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice`
        """
        model = IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice()
        if include_optional:
            return IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice(
                amount = None,
                denom = ''
            )
        else:
    ...
    def testIFilterSuggestionsSuccessResponseAttributesInnerFloorPrice(self):
        """Test IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice"""
