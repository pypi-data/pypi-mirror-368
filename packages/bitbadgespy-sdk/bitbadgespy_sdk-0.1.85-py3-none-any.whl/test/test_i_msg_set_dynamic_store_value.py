...
class TestIMsgSetDynamicStoreValue(unittest.TestCase):
    """IMsgSetDynamicStoreValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetDynamicStoreValue:
        """Test IMsgSetDynamicStoreValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetDynamicStoreValue`
        """
        model = IMsgSetDynamicStoreValue()
        if include_optional:
            return IMsgSetDynamicStoreValue(
                creator = '',
                store_id = None,
                address = '',
                value = None
    ...
    def testIMsgSetDynamicStoreValue(self):
        """Test IMsgSetDynamicStoreValue"""
