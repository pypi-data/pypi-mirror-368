...
class TestIMsgSetValidBadgeIds(unittest.TestCase):
    """IMsgSetValidBadgeIds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetValidBadgeIds:
        """Test IMsgSetValidBadgeIds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetValidBadgeIds`
        """
        model = IMsgSetValidBadgeIds()
        if include_optional:
            return IMsgSetValidBadgeIds(
                creator = '',
                collection_id = None,
                valid_badge_ids = [
                    {
    ...
    def testIMsgSetValidBadgeIds(self):
        """Test IMsgSetValidBadgeIds"""
