...
class TestITransactionEntry(unittest.TestCase):
    """ITransactionEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ITransactionEntry:
        """Test ITransactionEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ITransactionEntry`
        """
        model = ITransactionEntry()
        if include_optional:
    ...
    def testITransactionEntry(self):
        """Test ITransactionEntry"""
