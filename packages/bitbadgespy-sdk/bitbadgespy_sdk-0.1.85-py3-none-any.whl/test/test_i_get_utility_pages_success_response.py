...
class TestIGetUtilityPagesSuccessResponse(unittest.TestCase):
    """IGetUtilityPagesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetUtilityPagesSuccessResponse:
        """Test IGetUtilityPagesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetUtilityPagesSuccessResponse`
        """
        model = IGetUtilityPagesSuccessResponse()
        if include_optional:
            return IGetUtilityPagesSuccessResponse(
                docs = [
                    {
                        'key' : null
                        }
    ...
    def testIGetUtilityPagesSuccessResponse(self):
        """Test IGetUtilityPagesSuccessResponse"""
