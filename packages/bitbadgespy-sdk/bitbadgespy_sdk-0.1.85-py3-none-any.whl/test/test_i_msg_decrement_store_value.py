...
class TestIMsgDecrementStoreValue(unittest.TestCase):
    """IMsgDecrementStoreValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgDecrementStoreValue:
        """Test IMsgDecrementStoreValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgDecrementStoreValue`
        """
        model = IMsgDecrementStoreValue()
        if include_optional:
            return IMsgDecrementStoreValue(
                creator = '',
                store_id = None,
                address = '',
                amount = None
    ...
    def testIMsgDecrementStoreValue(self):
        """Test IMsgDecrementStoreValue"""
