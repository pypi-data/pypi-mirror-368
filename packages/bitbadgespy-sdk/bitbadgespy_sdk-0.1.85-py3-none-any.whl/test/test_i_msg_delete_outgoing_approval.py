...
class TestIMsgDeleteOutgoingApproval(unittest.TestCase):
    """IMsgDeleteOutgoingApproval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgDeleteOutgoingApproval:
        """Test IMsgDeleteOutgoingApproval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgDeleteOutgoingApproval`
        """
        model = IMsgDeleteOutgoingApproval()
        if include_optional:
            return IMsgDeleteOutgoingApproval(
                creator = '',
                collection_id = '',
                approval_id = ''
            )
    ...
    def testIMsgDeleteOutgoingApproval(self):
        """Test IMsgDeleteOutgoingApproval"""
