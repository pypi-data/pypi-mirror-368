...
class TestIDeleteUtilityPagePayload(unittest.TestCase):
    """IDeleteUtilityPagePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteUtilityPagePayload:
        """Test IDeleteUtilityPagePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteUtilityPagePayload`
        """
        model = IDeleteUtilityPagePayload()
        if include_optional:
            return IDeleteUtilityPagePayload(
                listing_id = ''
            )
        else:
            return IDeleteUtilityPagePayload(
    ...
    def testIDeleteUtilityPagePayload(self):
        """Test IDeleteUtilityPagePayload"""
