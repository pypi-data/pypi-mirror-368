...
class IMsgSetStandards(BaseModel):
    """
    IMsgSetStandards
    """ # noqa: E501
    ...
    standards_timeline: List[IStandardsTimeline] = Field(description="New standards timeline to set.", alias="standardsTimeline")
    can_update_standards: List[ITimedUpdatePermission] = Field(description="Permission to update standards timeline.", alias="canUpdateStandards")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "standardsTimeline", "canUpdateStandards"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetStandards from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetStandards from a dict"""
        if obj is None:
            return None
