...
class IDynamicDataDoc(BaseModel):
    ...
    data_secret: StrictStr = Field(description="The data secret. Used in cases where you are not signed in as creator. This authenticates the request. Not applicable to public stores", alias="dataSecret")
    data: Optional[Any]
    ...
    public_use_in_claims: Optional[StrictBool] = Field(default=None, description="Whether the dynamic data store is public. If true, the data can be accessed without authentication.", alias="publicUseInClaims")
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "handlerId", "dynamicDataId", "label", "dataSecret", "data", "createdBy", "managedBy", "publicUseInClaims", "createdAt", "lastUpdated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publicUseInClaims": obj.get("publicUseInClaims"),
