...
class IGetBrowseSuccessResponse(BaseModel):
    ...
    utility_pages: Optional[Dict[str, List[IUtilityPageDoc]]] = Field(default=None, alias="utilityPages")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["collections", "addressLists", "profiles", "activity", "badges", "applications", "maps", "claims", "claimActivity", "pointsActivity", "utilityPages"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in utility_pages (dict of array)
        _field_dict_of_array = {}
        if self.utility_pages:
            for _key_utility_pages in self.utility_pages:
                if self.utility_pages[_key_utility_pages] is not None:
                    _field_dict_of_array[_key_utility_pages] = [
                        _item.to_dict() for _item in self.utility_pages[_key_utility_pages]
                    ]
            _dict['utilityPages'] = _field_dict_of_array
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "utilityPages": dict(
                (_k,
                        [IUtilityPageDoc.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
                for _k, _v in obj.get("utilityPages", {}).items()
            )
        })
