...
class IMsgSetCollectionApprovals(BaseModel):
    """
    ...
    collection_approvals: List[ICollectionApproval] = Field(description="New collection approvals to set.", alias="collectionApprovals")
    can_update_collection_approvals: List[ICollectionApprovalPermission] = Field(description="Permission to update collection approvals.", alias="canUpdateCollectionApprovals")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "collectionApprovals", "canUpdateCollectionApprovals"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetCollectionApprovals from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetCollectionApprovals from a dict"""
        if obj is None:
            return None
