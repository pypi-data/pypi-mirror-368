...
class IAutoDeletionOptions(BaseModel):
    ...
    allow_counterparty_purge: StrictBool = Field(description="Allow counterparty to purge this approval if they are the only initiator", alias="allowCounterpartyPurge")
    allow_purge_if_expired: StrictBool = Field(description="Allow others to call PurgeApprovals on behalf of this approval owner", alias="allowPurgeIfExpired")
    __properties: ClassVar[List[str]] = ["afterOneUse", "afterOverallMaxNumTransfers", "allowCounterpartyPurge", "allowPurgeIfExpired"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allowCounterpartyPurge": obj.get("allowCounterpartyPurge"),
            "allowPurgeIfExpired": obj.get("allowPurgeIfExpired")
        })
        return _obj
