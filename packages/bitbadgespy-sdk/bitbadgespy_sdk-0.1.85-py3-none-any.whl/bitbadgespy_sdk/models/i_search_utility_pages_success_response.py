...
class ISearchUtilityPagesSuccessResponse(BaseModel):
    """
    ISearchUtilityPagesSuccessResponse
    """ # noqa: E501
    docs: List[IUtilityPageDoc]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISearchUtilityPagesSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISearchUtilityPagesSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "docs": [IUtilityPageDoc.from_dict(_item) for _item in obj["docs"]] if obj.get("docs") is not None else None,
