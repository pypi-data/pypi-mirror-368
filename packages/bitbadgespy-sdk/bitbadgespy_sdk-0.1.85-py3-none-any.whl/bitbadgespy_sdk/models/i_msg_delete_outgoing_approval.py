...
class IMsgDeleteOutgoingApproval(BaseModel):
    """
    ...
    approval_id: StrictStr = Field(description="The ID of the approval to delete.", alias="approvalId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "approvalId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgDeleteOutgoingApproval from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgDeleteOutgoingApproval from a dict"""
        if obj is None:
            return None
