...
class IExchangeSIWBBAuthorizationCodeSuccessResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "chain", "ownershipRequirements", "bitbadgesAddress", "verificationResponse", "access_token", "token_type", "access_token_expires_at", "refresh_token", "refresh_token_expires_at"]
