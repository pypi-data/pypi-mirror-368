...
class IUserOutgoingApproval(BaseModel):
    ...
    """ # noqa: E501
    to_list_id: StrictStr = Field(description="The list ID for the user(s) who is sending the tokens. The ID is either registered on-chain for reusability or follows the reserved ID system.", alias="toListId")
    ...
    approval_criteria: Optional[IOutgoingApprovalCriteria] = Field(default=None, description="The criteria to be met. These represent the restrictions that must be obeyed such as the total amount approved, max num transfers, merkle challenges, must own tokens, etc.", alias="approvalCriteria")
