...
class IIncomingApprovalCriteria(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["coinTransfers", "merkleChallenges", "mustOwnBadges", "predeterminedBalances", "approvalAmounts", "maxNumTransfers", "autoDeletionOptions", "requireFromEqualsInitiatedBy", "requireFromDoesNotEqualInitiatedBy", "dynamicStoreChallenges", "ethSignatureChallenges"]
