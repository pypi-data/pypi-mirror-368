...
class IUpdateAccountInfoPayload(BaseModel):
    ...
    hidden_badges: Optional[List[IBatchBadgeDetails]] = Field(default=None, description="The tokens to hide and not view for this profile's portfolio", alias="hiddenBadges")
