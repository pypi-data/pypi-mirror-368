...
class IFilterBadgesInCollectionPayload(BaseModel):
    ...
    """ # noqa: E501
    badge_ids: Optional[List[IUintRange]] = Field(default=None, description="Limit to specific token IDs. Leave undefined to not filter by token ID.", alias="badgeIds")
    ...
    most_viewed: Optional[StrictStr] = Field(default=None, description="mostViewed is a special view that sorts by most viewed tokens. May be incompatible with other filters.", alias="mostViewed")
