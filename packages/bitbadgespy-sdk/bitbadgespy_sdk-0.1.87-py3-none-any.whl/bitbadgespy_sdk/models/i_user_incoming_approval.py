...
class IUserIncomingApproval(BaseModel):
    ...
    approval_criteria: Optional[IIncomingApprovalCriteria] = Field(default=None, description="The criteria to be met. These represent the restrictions that must be obeyed such as the total amount approved, max num transfers, merkle challenges, must own tokens, etc.", alias="approvalCriteria")
