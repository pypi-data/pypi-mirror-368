...
class EncodeObject(BaseModel):
    """
    name is the string used when registering a concrete type into the Amino type registry, via the Amino codec's `RegisterConcrete()` method. This string MUST be at most 39 characters long, or else the message will be rejected by the Ledger hardware device. @generated from extension: string name = 11110001;
    """ # noqa: E501
