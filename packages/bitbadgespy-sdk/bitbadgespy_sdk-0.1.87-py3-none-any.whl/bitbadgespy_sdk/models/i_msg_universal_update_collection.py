...
class IMsgUniversalUpdateCollection(BaseModel):
    ...
    invariants: Optional[ICollectionInvariants] = Field(default=None, description="Collection-level invariants that cannot be broken. These are set upon genesis and cannot be modified.")
    ...
    update_badge_metadata_timeline: Optional[StrictBool] = Field(default=None, description="Whether or not to update the token metadata timeline.", alias="updateBadgeMetadataTimeline")
