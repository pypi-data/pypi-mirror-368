...
class IFilterSuggestionsSuccessResponseAttributesInner(BaseModel):
    ...
    type: StrictStr
    floor_price: Optional[IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice] = Field(default=None, alias="floorPrice")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "value", "count", "type", "floorPrice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "type": obj.get("type"),
            "floorPrice": IFilterSuggestionsSuccessResponseAttributesInnerFloorPrice.from_dict(obj["floorPrice"]) if obj.get("floorPrice") is not None else None
        })
