...
class IApprovalCriteria(BaseModel):
    ...
    must_own_badges: Optional[List[IMustOwnBadge]] = Field(default=None, description="The list of must own tokens that need valid proofs to be approved.", alias="mustOwnBadges")
    ...
    __properties: ClassVar[List[str]] = ["coinTransfers", "merkleChallenges", "mustOwnBadges", "predeterminedBalances", "approvalAmounts", "maxNumTransfers", "autoDeletionOptions", "requireToEqualsInitiatedBy", "requireFromEqualsInitiatedBy", "requireToDoesNotEqualInitiatedBy", "requireFromDoesNotEqualInitiatedBy", "overridesFromOutgoingApprovals", "overridesToIncomingApprovals", "userRoyalties", "dynamicStoreChallenges", "ethSignatureChallenges"]
