...
class ParsedQsValue(BaseModel):
    ...
    anyof_schema_3_validator: Optional[Dict[str, ParsedQsValue]] = Field(default=None, description="Safe adds two uints and returns an error if the result is invalid. Keeps the right type.")
