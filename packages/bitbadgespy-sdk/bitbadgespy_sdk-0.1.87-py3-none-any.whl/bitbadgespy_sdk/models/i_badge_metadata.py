...
class IBadgeMetadata(BaseModel):
    ...
    IBadgeMetadata
    """ # noqa: E501
    uri: StrictStr = Field(description="The URI where to fetch the token metadata from.")
    badge_ids: List[IUintRange] = Field(description="The token IDs corresponding to the URI.", alias="badgeIds")
