...
class ITransactionEntry(BaseModel):
    """
    ITransactionEntry
    """ # noqa: E501
    amount: NumberType = Field(description="The amount of the transaction")
    limit: NumberType = Field(description="The gas limit of the transaction")
    timestamp: NumberType = Field(description="Numeric timestamp - value is equal to the milliseconds since the UNIX epoch.")
    __properties: ClassVar[List[str]] = ["amount", "limit", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ITransactionEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ITransactionEntry from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "limit": NumberType.from_dict(obj["limit"]) if obj.get("limit") is not None else None,
