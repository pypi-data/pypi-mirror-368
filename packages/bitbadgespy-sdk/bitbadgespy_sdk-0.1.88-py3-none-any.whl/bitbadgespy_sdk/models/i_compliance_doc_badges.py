...
class IComplianceDocBadges(BaseModel):
    ...
    """ # noqa: E501
    nsfw: List[IBatchTokenDetails]
    reported: List[IBatchTokenDetails]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nsfw": [IBatchTokenDetails.from_dict(_item) for _item in obj["nsfw"]] if obj.get("nsfw") is not None else None,
            "reported": [IBatchTokenDetails.from_dict(_item) for _item in obj["reported"]] if obj.get("reported") is not None else None
        })
