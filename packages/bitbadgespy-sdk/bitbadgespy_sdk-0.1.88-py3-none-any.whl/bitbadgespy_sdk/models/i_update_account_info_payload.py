...
class IUpdateAccountInfoPayload(BaseModel):
    ...
    hidden_badges: Optional[List[IBatchTokenDetails]] = Field(default=None, description="The tokens to hide and not view for this profile's portfolio", alias="hiddenBadges")
