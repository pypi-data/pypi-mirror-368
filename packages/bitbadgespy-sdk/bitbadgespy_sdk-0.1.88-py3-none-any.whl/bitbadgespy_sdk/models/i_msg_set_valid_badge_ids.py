...
class IMsgSetValidBadgeIds(BaseModel):
    ...
    valid_badge_ids: List[IUintRange] = Field(description="New token IDs to add to this collection.", alias="validBadgeIds")
    can_update_valid_badge_ids: List[IBadgeIdsActionPermission] = Field(description="Permission to update valid token IDs.", alias="canUpdateValidBadgeIds")
