...
from bitbadgespy_sdk.models.i_batch_token_details import IBatchTokenDetails
...
class IBitBadgesUserInfo(BaseModel):
    ...
    hidden_badges: Optional[List[IBatchTokenDetails]] = Field(default=None, description="The hidden badges of the account", alias="hiddenBadges")
    ...
    collected: List[IBalanceDoc] = Field(description="A list of tokens that the account has collected. Paginated and fetched as needed. To be used in conjunction with views.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hiddenBadges": [IBatchTokenDetails.from_dict(_item) for _item in obj["hiddenBadges"]] if obj.get("hiddenBadges") is not None else None,
