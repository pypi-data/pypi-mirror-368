...
class ICustomPage(BaseModel):
    ...
    items: List[IBatchTokenDetails] = Field(description="The token IDs to display on the custom page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [IBatchTokenDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
