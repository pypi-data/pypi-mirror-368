...
from bitbadgespy_sdk.models.i_get_balance_by_address_payload import IGetBalanceByAddressPayload
from bitbadgespy_sdk.models.i_get_balance_by_address_specific_token_success_response import IGetBalanceByAddressSpecificTokenSuccessResponse
from bitbadgespy_sdk.models.i_get_balance_by_address_success_response import IGetBalanceByAddressSuccessResponse
...
from bitbadgespy_sdk.models.i_get_owners_payload import IGetOwnersPayload
from bitbadgespy_sdk.models.i_get_owners_success_response import IGetOwnersSuccessResponse
from bitbadgespy_sdk.models.i_get_token_activity_payload import IGetTokenActivityPayload
from bitbadgespy_sdk.models.i_get_token_activity_success_response import IGetTokenActivitySuccessResponse
...
class TokensApi:
    ...
    def get_badge_metadata(
        ...
        badge_id: Annotated[StrictStr, Field(description="Token ID")],
    ...
    def get_balance_by_address(
        ...
        address: Annotated[StrictStr, Field(description="The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply.")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        payload: Annotated[Optional[IGetBalanceByAddressPayload], Field(description="The payload for the request. Anything here should be specified as query parameters (e.g. ?key1=value1&key2=)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Retrieves the balances of a specific address for a collection.  ```tsx const res = await BitBadgesApi.getBalanceByAddress(collectionId, address, { ...options }); console.log(res); ```   SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetBalanceByAddressPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetBalanceByAddressSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#getbalancebyaddress)**  Scopes: - `readPrivateClaimData` - Required if fetching private claim data (user-level approvals)  Alternative Flow: Note that you can also set up a claim that checks token ownership and check the success per user of that claim as well 

        :param collection_id: The ID of the collection. (required)
        :type collection_id: int
        :param address: The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply. (required)
        :type address: str
        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param payload: The payload for the request. Anything here should be specified as query parameters (e.g. ?key1=value1&key2=)
        :type payload: IGetBalanceByAddressPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_balance_by_address_serialize(
            collection_id=collection_id,
            address=address,
            x_api_key=x_api_key,
            payload=payload,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IGetBalanceByAddressSuccessResponse",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '500': "ErrorResponse",
        }
    ...
    @validate_call
    def get_balance_by_address_with_http_info(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection.")],
        address: Annotated[StrictStr, Field(description="The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply.")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IGetBalanceByAddressSuccessResponse]:
        """Get Balances By Address
    ...
    @validate_call
    def get_balance_by_address_without_preload_content(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection.")],
        address: Annotated[StrictStr, Field(description="The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply.")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
    ...
    def _get_balance_by_address_serialize(
        self,
        collection_id,
        address,
        x_api_key,
    ...
    @validate_call
    def get_balance_by_address_specific_token(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection.")],
        address: Annotated[StrictStr, Field(description="The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply.")],
        badge_id: Annotated[StrictInt, Field(description="The ID for which the balance is to be retrieved.")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Retrieves the balance of a specific token for a specific address at the current time.  For more advanced queries returning the whole balance document, please use the POST `/collection/{collectionId}/balance/{address}` endpoint.  ```tsx const res = await BitBadgesApi.getBalanceByAddressSpecificToken(collectionId, address, badgeId); console.log(res); ```  SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetBalanceByAddressSpecificTokenPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetBalanceByAddressSpecificTokenSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#getbalancebyaddressspecificbadge)**  Alternative Flow: Note that you can also set up a claim that checks token ownership and check the success per user of that claim as well 

        :param collection_id: The ID of the collection. (required)
        :type collection_id: int
        :param address: The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply. (required)
        :type address: str
        :param badge_id: The ID for which the balance is to be retrieved. (required)
        :type badge_id: int
        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_balance_by_address_specific_token_serialize(
            collection_id=collection_id,
            address=address,
            badge_id=badge_id,
            x_api_key=x_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IGetBalanceByAddressSpecificTokenSuccessResponse",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '500': "ErrorResponse",
        }
    ...
    @validate_call
    def get_balance_by_address_specific_token_with_http_info(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection.")],
        address: Annotated[StrictStr, Field(description="The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply.")],
        badge_id: Annotated[StrictInt, Field(description="The ID for which the balance is to be retrieved.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IGetBalanceByAddressSpecificTokenSuccessResponse]:
        """Get Balance By Address - Specific Token
    ...
    @validate_call
    def get_balance_by_address_specific_token_without_preload_content(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection.")],
        address: Annotated[StrictStr, Field(description="The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply.")],
        badge_id: Annotated[StrictInt, Field(description="The ID for which the balance is to be retrieved.")],
    ...
    def _get_balance_by_address_specific_token_serialize(
        self,
        collection_id,
        address,
        badge_id,
    ...
    def get_owners(
        ...
        badge_id: Annotated[StrictInt, Field(description="The numeric token ID to retrieve owners for.")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        payload: Annotated[Optional[IGetOwnersPayload], Field(description="The payload for the request. Anything here should be specified as query parameters (e.g. ?key1=value1&key2=)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Retrieves the owners in a paginated format for a specific token in a collection. Returns a list of addresses and their corresponding balances for the specified token ID.  ```tsx const res = await BitBadgesApi.getOwners(   collectionId,   badgeId,   {     bookmark: '...'   } ); ```   SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetOwnersPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetOwnersSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#getownersforbadge)** 

        :param collection_id: The numeric collection ID. (required)
        :type collection_id: int
        :param badge_id: The numeric token ID to retrieve owners for. (required)
        :type badge_id: int
        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param payload: The payload for the request. Anything here should be specified as query parameters (e.g. ?key1=value1&key2=)
        :type payload: IGetOwnersPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def get_owners_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IGetOwnersSuccessResponse]:
        """Get Token Owners
    ...
    def get_token_activity(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection.")],
        badge_id: Annotated[StrictInt, Field(description="The ID for which activity is to be retrieved.")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        payload: Annotated[Optional[IGetTokenActivityPayload], Field(description="The payload for the request. Anything here should be specified as query parameters (e.g. ?key1=value1&key2=)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Retrieves the activity in a paginated format for a specific token in a collection.  ```tsx const res = await BitBadgesApi.getTokenActivity(   collectionId,   badgeId,   {     bookmark: '...'   } ); ```  SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetTokenActivityPayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetTokenActivitySuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#getbadgeactivity)** 

        :param collection_id: The ID of the collection. (required)
        :type collection_id: int
        :param badge_id: The ID for which activity is to be retrieved. (required)
        :type badge_id: int
        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param payload: The payload for the request. Anything here should be specified as query parameters (e.g. ?key1=value1&key2=)
        :type payload: IGetTokenActivityPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_token_activity_serialize(
            collection_id=collection_id,
            badge_id=badge_id,
            x_api_key=x_api_key,
            payload=payload,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IGetTokenActivitySuccessResponse",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '500': "ErrorResponse",
        }
    ...
    @validate_call
    def get_token_activity_with_http_info(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection.")],
        badge_id: Annotated[StrictInt, Field(description="The ID for which activity is to be retrieved.")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IGetTokenActivitySuccessResponse]:
        """Get Token Activity
    ...
    @validate_call
    def get_token_activity_without_preload_content(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection.")],
        badge_id: Annotated[StrictInt, Field(description="The ID for which activity is to be retrieved.")],
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
    ...
    def _get_token_activity_serialize(
        self,
        collection_id,
        badge_id,
        x_api_key,
