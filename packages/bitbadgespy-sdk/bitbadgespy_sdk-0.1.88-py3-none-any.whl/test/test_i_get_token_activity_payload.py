...
class TestIGetTokenActivityPayload(unittest.TestCase):
    """IGetTokenActivityPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetTokenActivityPayload:
        """Test IGetTokenActivityPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetTokenActivityPayload`
        """
        model = IGetTokenActivityPayload()
        if include_optional:
            return IGetTokenActivityPayload(
                bookmark = '',
                bitbadges_address = ''
            )
        else:
    ...
    def testIGetTokenActivityPayload(self):
        """Test IGetTokenActivityPayload"""
