...
class TestIBatchTokenDetails(unittest.TestCase):
    """IBatchTokenDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBatchTokenDetails:
        """Test IBatchTokenDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBatchTokenDetails`
        """
        model = IBatchTokenDetails()
        if include_optional:
            return IBatchTokenDetails(
                collection_id = '',
                badge_ids = [
                    {
                        'key' : null
    ...
    def testIBatchTokenDetails(self):
        """Test IBatchTokenDetails"""
