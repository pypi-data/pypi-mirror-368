...
class TestIGetBalanceByAddressSpecificTokenSuccessResponse(unittest.TestCase):
    """IGetBalanceByAddressSpecificTokenSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBalanceByAddressSpecificTokenSuccessResponse:
        """Test IGetBalanceByAddressSpecificTokenSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBalanceByAddressSpecificTokenSuccessResponse`
        """
        model = IGetBalanceByAddressSpecificTokenSuccessResponse()
        if include_optional:
            return IGetBalanceByAddressSpecificTokenSuccessResponse(
                balance = None
            )
        else:
            return IGetBalanceByAddressSpecificTokenSuccessResponse(
    ...
    def testIGetBalanceByAddressSpecificTokenSuccessResponse(self):
        """Test IGetBalanceByAddressSpecificTokenSuccessResponse"""
