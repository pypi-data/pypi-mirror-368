...
class TestIGetOwnersPayload(unittest.TestCase):
    """IGetOwnersPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetOwnersPayload:
        """Test IGetOwnersPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetOwnersPayload`
        """
        model = IGetOwnersPayload()
        if include_optional:
            return IGetOwnersPayload(
                bookmark = '',
                sort_by = 'amount'
            )
        else:
    ...
    def testIGetOwnersPayload(self):
        """Test IGetOwnersPayload"""
