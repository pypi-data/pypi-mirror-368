...
class TestIMsgSetBadgeMetadata(unittest.TestCase):
    """IMsgSetBadgeMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetBadgeMetadata:
        """Test IMsgSetBadgeMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetBadgeMetadata`
        """
        model = IMsgSetBadgeMetadata()
        if include_optional:
            return IMsgSetBadgeMetadata(
                creator = '',
                collection_id = None,
    ...
    def testIMsgSetBadgeMetadata(self):
        """Test IMsgSetBadgeMetadata"""
