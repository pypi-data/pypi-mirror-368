...
class TestIUpdateUtilityPagePayload(unittest.TestCase):
    """IUpdateUtilityPagePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateUtilityPagePayload:
        """Test IUpdateUtilityPagePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateUtilityPagePayload`
        """
        model = IUpdateUtilityPagePayload()
        if include_optional:
            return IUpdateUtilityPagePayload(
                listing_id = '',
                metadata = {
                    'key' : null
                    },
    ...
    def testIUpdateUtilityPagePayload(self):
        """Test IUpdateUtilityPagePayload"""
