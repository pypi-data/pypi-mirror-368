...
class IMsgSetIncomingApproval(BaseModel):
    """
    ...
    approval: IUserIncomingApproval = Field(description="The incoming approval to set.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetIncomingApproval from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetIncomingApproval from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "approval": IUserIncomingApproval.from_dict(obj["approval"]) if obj.get("approval") is not None else None
        })
