...
class IMsgSetCollectionMetadata(BaseModel):
    """
    ...
    collection_id: NumberType = Field(description="The ID of the collection.", alias="collectionId")
    collection_metadata_timeline: List[ICollectionMetadataTimeline] = Field(description="New collection metadata timeline to set.", alias="collectionMetadataTimeline")
    can_update_collection_metadata: List[ITimedUpdatePermission] = Field(description="Permission to update collection metadata timeline.", alias="canUpdateCollectionMetadata")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "collectionMetadataTimeline", "canUpdateCollectionMetadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetCollectionMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetCollectionMetadata from a dict"""
        if obj is None:
            return None
