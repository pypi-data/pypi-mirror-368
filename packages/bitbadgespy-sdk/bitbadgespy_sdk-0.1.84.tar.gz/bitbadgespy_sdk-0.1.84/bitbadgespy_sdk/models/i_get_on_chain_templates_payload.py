...
class IGetOnChainTemplatesPayload(BaseModel):
    """
    IGetOnChainTemplatesPayload
    """ # noqa: E501
    template_ids: List[StrictStr] = Field(description="The specific template IDs to fetch", alias="templateIds")
    locale: Optional[StrictStr] = Field(default=None, description="The locale to filter by")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["templateIds", "locale"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetOnChainTemplatesPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetOnChainTemplatesPayload from a dict"""
        if obj is None:
            return None
