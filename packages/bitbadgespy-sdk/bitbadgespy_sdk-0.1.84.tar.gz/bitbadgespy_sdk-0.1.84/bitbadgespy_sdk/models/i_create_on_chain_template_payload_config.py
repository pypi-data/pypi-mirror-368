...
class ICreateOnChainTemplatePayloadConfig(BaseModel):
    """
    The configuration for the template
    """ # noqa: E501
    must_own_badges: List[IMustOwnBadges] = Field(description="The requirements for badges that must be owned", alias="mustOwnBadges")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["mustOwnBadges"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateOnChainTemplatePayloadConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateOnChainTemplatePayloadConfig from a dict"""
        if obj is None:
            return None
