...
from bitbadgespy_sdk.models.i_create_on_chain_template_payload_config import ICreateOnChainTemplatePayloadConfig
from bitbadgespy_sdk.models.i_metadata_without_internals import IMetadataWithoutInternals
from typing import Optional, Set
from typing_extensions import Self

class IUpdateOnChainTemplatePayload(BaseModel):
    """
    IUpdateOnChainTemplatePayload
    """ # noqa: E501
    template_id: StrictStr = Field(description="The unique template ID", alias="templateId")
    locale: Optional[StrictStr] = Field(default=None, description="The locale of the template")
    metadata: Optional[IMetadataWithoutInternals] = Field(default=None, description="The metadata for the template")
    config: Optional[ICreateOnChainTemplatePayloadConfig] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["templateId", "locale", "metadata", "config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateOnChainTemplatePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateOnChainTemplatePayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ICreateOnChainTemplatePayloadConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
