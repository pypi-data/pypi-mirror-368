...
from bitbadgespy_sdk.models.ion_chain_template_doc import IOnChainTemplateDoc
from typing import Optional, Set
from typing_extensions import Self

class ISearchOnChainTemplatesSuccessResponse(BaseModel):
    """
    ISearchOnChainTemplatesSuccessResponse
    """ # noqa: E501
    templates: List[IOnChainTemplateDoc]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISearchOnChainTemplatesSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISearchOnChainTemplatesSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "templates": [IOnChainTemplateDoc.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None,
