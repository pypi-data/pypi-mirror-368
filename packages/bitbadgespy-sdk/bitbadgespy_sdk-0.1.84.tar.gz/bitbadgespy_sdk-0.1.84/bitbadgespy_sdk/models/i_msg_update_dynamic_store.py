...
class IMsgUpdateDynamicStore(BaseModel):
    """
    ...
    store_id: NumberType = Field(description="The ID of the dynamic store to update.", alias="storeId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgUpdateDynamicStore from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgUpdateDynamicStore from a dict"""
        if obj is None:
            return None
