...
class IGetDynamicDataStorePayload(BaseModel):
    ...
    """ # noqa: E501
    data_secret: Optional[StrictStr] = Field(default=None, description="The data secret to fetch. Only needed if you are not signed in as creator. Not applicable to public stores", alias="dataSecret")
