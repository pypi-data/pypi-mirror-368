...
class IGetUtilityPageSuccessResponse(BaseModel):
    """
    IGetUtilityPageSuccessResponse
    """ # noqa: E501
    listing: IUtilityPageDoc
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetUtilityPageSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetUtilityPageSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "listing": IUtilityPageDoc.from_dict(obj["listing"]) if obj.get("listing") is not None else None
        })
        return _obj
