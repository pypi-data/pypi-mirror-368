...
from bitbadgespy_sdk.models.i_create_on_chain_template_payload import ICreateOnChainTemplatePayload

class TestICreateOnChainTemplatePayload(unittest.TestCase):
    """ICreateOnChainTemplatePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateOnChainTemplatePayload:
        """Test ICreateOnChainTemplatePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateOnChainTemplatePayload`
        """
        model = ICreateOnChainTemplatePayload()
        if include_optional:
            return ICreateOnChainTemplatePayload(
                locale = '',
                template_id = '',
                metadata = {
                    'key' : null
    ...
    def testICreateOnChainTemplatePayload(self):
        """Test ICreateOnChainTemplatePayload"""
