...
class TestIOnChainTemplateConfig(unittest.TestCase):
    """IOnChainTemplateConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IOnChainTemplateConfig:
        """Test IOnChainTemplateConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IOnChainTemplateConfig`
        """
        model = IOnChainTemplateConfig()
        if include_optional:
            return IOnChainTemplateConfig(
                must_own_badges = [
                    {
                        'key' : null
                        }
    ...
    def testIOnChainTemplateConfig(self):
        """Test IOnChainTemplateConfig"""
