...
from bitbadgespy_sdk.models.i_update_on_chain_template_payload import IUpdateOnChainTemplatePayload

class TestIUpdateOnChainTemplatePayload(unittest.TestCase):
    """IUpdateOnChainTemplatePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateOnChainTemplatePayload:
        """Test IUpdateOnChainTemplatePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateOnChainTemplatePayload`
        """
        model = IUpdateOnChainTemplatePayload()
        if include_optional:
            return IUpdateOnChainTemplatePayload(
                template_id = '',
                locale = '',
                metadata = {
                    'key' : null
    ...
    def testIUpdateOnChainTemplatePayload(self):
        """Test IUpdateOnChainTemplatePayload"""
