...
from bitbadgespy_sdk.models.i_delete_on_chain_template_payload import IDeleteOnChainTemplatePayload

class TestIDeleteOnChainTemplatePayload(unittest.TestCase):
    """IDeleteOnChainTemplatePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDeleteOnChainTemplatePayload:
        """Test IDeleteOnChainTemplatePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDeleteOnChainTemplatePayload`
        """
        model = IDeleteOnChainTemplatePayload()
        if include_optional:
            return IDeleteOnChainTemplatePayload(
                template_id = ''
            )
        else:
            return IDeleteOnChainTemplatePayload(
    ...
    def testIDeleteOnChainTemplatePayload(self):
        """Test IDeleteOnChainTemplatePayload"""
