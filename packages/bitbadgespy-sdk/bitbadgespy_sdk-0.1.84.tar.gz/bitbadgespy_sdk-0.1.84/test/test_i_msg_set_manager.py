...
class TestIMsgSetManager(unittest.TestCase):
    """IMsgSetManager unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetManager:
        """Test IMsgSetManager
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetManager`
        """
        model = IMsgSetManager()
        if include_optional:
            return IMsgSetManager(
                creator = '',
                collection_id = None,
                manager_timeline = [
