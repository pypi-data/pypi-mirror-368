...
from bitbadgespy_sdk.models.i_get_on_chain_templates_success_response import IGetOnChainTemplatesSuccessResponse

class TestIGetOnChainTemplatesSuccessResponse(unittest.TestCase):
    """IGetOnChainTemplatesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetOnChainTemplatesSuccessResponse:
        """Test IGetOnChainTemplatesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetOnChainTemplatesSuccessResponse`
        """
        model = IGetOnChainTemplatesSuccessResponse()
        if include_optional:
            return IGetOnChainTemplatesSuccessResponse(
                templates = [
                    {
                        'key' : null
                        }
    ...
    def testIGetOnChainTemplatesSuccessResponse(self):
        """Test IGetOnChainTemplatesSuccessResponse"""
