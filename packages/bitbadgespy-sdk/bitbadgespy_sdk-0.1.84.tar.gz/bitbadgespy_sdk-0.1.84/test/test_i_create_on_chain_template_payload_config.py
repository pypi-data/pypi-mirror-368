...
class TestICreateOnChainTemplatePayloadConfig(unittest.TestCase):
    """ICreateOnChainTemplatePayloadConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateOnChainTemplatePayloadConfig:
        """Test ICreateOnChainTemplatePayloadConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateOnChainTemplatePayloadConfig`
        """
        model = ICreateOnChainTemplatePayloadConfig()
        if include_optional:
            return ICreateOnChainTemplatePayloadConfig(
                must_own_badges = [
                    {
                        'key' : null
                        }
    ...
    def testICreateOnChainTemplatePayloadConfig(self):
        """Test ICreateOnChainTemplatePayloadConfig"""
