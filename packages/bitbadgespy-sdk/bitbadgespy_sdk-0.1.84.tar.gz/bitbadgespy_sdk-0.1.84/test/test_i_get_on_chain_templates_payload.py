...
from bitbadgespy_sdk.models.i_get_on_chain_templates_payload import IGetOnChainTemplatesPayload

class TestIGetOnChainTemplatesPayload(unittest.TestCase):
    """IGetOnChainTemplatesPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetOnChainTemplatesPayload:
        """Test IGetOnChainTemplatesPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetOnChainTemplatesPayload`
        """
        model = IGetOnChainTemplatesPayload()
        if include_optional:
            return IGetOnChainTemplatesPayload(
                template_ids = [
                    ''
                    ],
                locale = ''
    ...
    def testIGetOnChainTemplatesPayload(self):
        """Test IGetOnChainTemplatesPayload"""
