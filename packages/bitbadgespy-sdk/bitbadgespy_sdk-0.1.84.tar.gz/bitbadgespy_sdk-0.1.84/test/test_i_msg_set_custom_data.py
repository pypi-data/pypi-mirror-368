...
class TestIMsgSetCustomData(unittest.TestCase):
    """IMsgSetCustomData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetCustomData:
        """Test IMsgSetCustomData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetCustomData`
        """
        model = IMsgSetCustomData()
        if include_optional:
            return IMsgSetCustomData(
                creator = '',
                collection_id = None,
    ...
    def testIMsgSetCustomData(self):
        """Test IMsgSetCustomData"""
