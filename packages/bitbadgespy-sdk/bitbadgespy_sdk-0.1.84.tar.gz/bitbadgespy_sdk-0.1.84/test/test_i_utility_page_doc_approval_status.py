...
class TestIUtilityPageDocApprovalStatus(unittest.TestCase):
    """IUtilityPageDocApprovalStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityPageDocApprovalStatus:
        """Test IUtilityPageDocApprovalStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityPageDocApprovalStatus`
        """
        model = IUtilityPageDocApprovalStatus()
        if include_optional:
            return IUtilityPageDocApprovalStatus(
                is_approved = True,
                is_featured = True,
    ...
    def testIUtilityPageDocApprovalStatus(self):
        """Test IUtilityPageDocApprovalStatus"""
