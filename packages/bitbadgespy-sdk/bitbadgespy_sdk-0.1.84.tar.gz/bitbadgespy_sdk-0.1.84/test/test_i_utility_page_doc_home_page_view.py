...
class TestIUtilityPageDocHomePageView(unittest.TestCase):
    """IUtilityPageDocHomePageView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityPageDocHomePageView:
        """Test IUtilityPageDocHomePageView
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityPageDocHomePageView`
        """
        model = IUtilityPageDocHomePageView()
        if include_optional:
            return IUtilityPageDocHomePageView(
                type = 'badges',
                category = ''
            )
        else:
    ...
    def testIUtilityPageDocHomePageView(self):
        """Test IUtilityPageDocHomePageView"""
