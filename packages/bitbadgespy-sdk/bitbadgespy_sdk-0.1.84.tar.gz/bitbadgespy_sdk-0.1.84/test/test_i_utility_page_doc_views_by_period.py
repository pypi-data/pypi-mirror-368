...
class TestIUtilityPageDocViewsByPeriod(unittest.TestCase):
    """IUtilityPageDocViewsByPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityPageDocViewsByPeriod:
        """Test IUtilityPageDocViewsByPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityPageDocViewsByPeriod`
        """
        model = IUtilityPageDocViewsByPeriod()
        if include_optional:
            return IUtilityPageDocViewsByPeriod(
                hourly = 1.337,
                daily = 1.337,
                weekly = 1.337,
                monthly = 1.337
    ...
    def testIUtilityPageDocViewsByPeriod(self):
        """Test IUtilityPageDocViewsByPeriod"""
