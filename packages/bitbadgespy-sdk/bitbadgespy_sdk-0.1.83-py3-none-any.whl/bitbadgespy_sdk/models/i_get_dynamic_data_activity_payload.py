...
class IGetDynamicDataActivityPayload(BaseModel):
    ...
    data_secret: Optional[StrictStr] = Field(default=None, description="The data secret to fetch activity for. Needed if you are not signed in as creator. Not applicable to public stores", alias="dataSecret")
