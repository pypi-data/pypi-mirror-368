...
class IBitBadgesCollection(BaseModel):
    ...
    valid_badge_ids: List[IUintRange] = Field(description="Valid token IDs for the collection", alias="validBadgeIds")
    ...
    nsfw: Optional[ICollectionNSFW] = Field(default=None, description="The token IDs in this collection that are marked as NSFW.")
    reported: Optional[ICollectionNSFW] = Field(default=None, description="The token IDs in this collection that have been reported.")
