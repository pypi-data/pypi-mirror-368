...
class ITransferWithIncrements(BaseModel):
    ...
    to_addresses_length: Optional[NumberType] = Field(default=None, description="The number of addresses to send the tokens to. This takes priority over toAddresses.length (used when you don't know exact addresses (i.e. you know number of codes)).", alias="toAddressesLength")
