...
class TestIMsgSetIsArchived(unittest.TestCase):
    """IMsgSetIsArchived unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetIsArchived:
        """Test IMsgSetIsArchived
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetIsArchived`
        """
        model = IMsgSetIsArchived()
        if include_optional:
            return IMsgSetIsArchived(
                creator = '',
                collection_id = None,
    ...
    def testIMsgSetIsArchived(self):
        """Test IMsgSetIsArchived"""
