...
class TestIMsgCreateDynamicStore(unittest.TestCase):
    """IMsgCreateDynamicStore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgCreateDynamicStore:
        """Test IMsgCreateDynamicStore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgCreateDynamicStore`
        """
        model = IMsgCreateDynamicStore()
        if include_optional:
            return IMsgCreateDynamicStore(
                creator = ''
            )
        else:
            return IMsgCreateDynamicStore(
    ...
    def testIMsgCreateDynamicStore(self):
        """Test IMsgCreateDynamicStore"""
