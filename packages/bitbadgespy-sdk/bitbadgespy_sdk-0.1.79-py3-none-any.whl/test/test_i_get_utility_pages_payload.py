...
class TestIGetUtilityPagesPayload(unittest.TestCase):
    """IGetUtilityPagesPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetUtilityPagesPayload:
        """Test IGetUtilityPagesPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetUtilityPagesPayload`
        """
        model = IGetUtilityPagesPayload()
        if include_optional:
            return IGetUtilityPagesPayload(
                listing_ids = [
                    ''
                    ]
            )
    ...
    def testIGetUtilityPagesPayload(self):
        """Test IGetUtilityPagesPayload"""
