...
class TestIUtilityPageLink(unittest.TestCase):
    """IUtilityPageLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityPageLink:
        """Test IUtilityPageLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityPageLink`
        """
        model = IUtilityPageLink()
        if include_optional:
            return IUtilityPageLink(
                url = '',
                claim_id = '',
                application_id = '',
                collection_id = '',
