...
class TestIETHSignatureChallenge(unittest.TestCase):
    """IETHSignatureChallenge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IETHSignatureChallenge:
        """Test IETHSignatureChallenge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IETHSignatureChallenge`
        """
        model = IETHSignatureChallenge()
        if include_optional:
            return IETHSignatureChallenge(
                signer = '',
    ...
    def testIETHSignatureChallenge(self):
        """Test IETHSignatureChallenge"""
