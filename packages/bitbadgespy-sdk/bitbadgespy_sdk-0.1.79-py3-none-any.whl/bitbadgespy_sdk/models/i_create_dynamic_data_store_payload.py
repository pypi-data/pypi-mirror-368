...
class ICreateDynamicDataStorePayload(BaseModel):
    ...
    public_use_in_claims: Optional[StrictBool] = Field(default=None, description="Whether the dynamic data store should be public. If true, the data can be accessed without authentication. Defaults to false (private).", alias="publicUseInClaims")
    __properties: ClassVar[List[str]] = ["handlerId", "label", "publicUseInClaims"]
