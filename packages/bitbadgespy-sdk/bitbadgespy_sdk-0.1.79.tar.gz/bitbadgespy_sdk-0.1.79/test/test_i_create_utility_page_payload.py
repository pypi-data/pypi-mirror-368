...
class TestICreateUtilityPagePayload(unittest.TestCase):
    """ICreateUtilityPagePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateUtilityPagePayload:
        """Test ICreateUtilityPagePayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateUtilityPagePayload`
        """
        model = ICreateUtilityPagePayload()
        if include_optional:
            return ICreateUtilityPagePayload(
                metadata = {
                    'key' : null
                    },
                content = [
    ...
    def testICreateUtilityPagePayload(self):
        """Test ICreateUtilityPagePayload"""
