...
class ITransferActivityDoc(BaseModel):
    ...
    balances: List[IBalance] = Field(description="The list of balances and token IDs that were transferred.")
    ...
    badge_id: Optional[NumberType] = Field(default=None, description="The token ID for the transfer", alias="badgeId")
