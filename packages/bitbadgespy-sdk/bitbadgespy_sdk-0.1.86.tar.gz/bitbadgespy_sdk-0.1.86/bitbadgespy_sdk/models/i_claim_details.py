...
class IClaimDetails(BaseModel):
    ...
    standalone_claim: Optional[StrictBool] = Field(default=None, description="Standalone claims are not linked with a token or list.", alias="standaloneClaim")
    ...
    seed_code: Optional[StrictStr] = Field(default=None, description="Seed code for the claim. Only used for on-chain token claims.  This is how we produce all reserved codes for the on-chain merkle challenge / proofs.", alias="seedCode")
