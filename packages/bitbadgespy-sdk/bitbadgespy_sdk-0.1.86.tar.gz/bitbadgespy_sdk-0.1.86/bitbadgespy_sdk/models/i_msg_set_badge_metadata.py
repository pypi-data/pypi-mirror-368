...
class IMsgSetBadgeMetadata(BaseModel):
    ...
    badge_metadata_timeline: List[IBadgeMetadataTimeline] = Field(description="New token metadata timeline to set.", alias="badgeMetadataTimeline")
    can_update_badge_metadata: List[ITimedUpdateWithBadgeIdsPermission] = Field(description="Permission to update token metadata timeline.", alias="canUpdateBadgeMetadata")
