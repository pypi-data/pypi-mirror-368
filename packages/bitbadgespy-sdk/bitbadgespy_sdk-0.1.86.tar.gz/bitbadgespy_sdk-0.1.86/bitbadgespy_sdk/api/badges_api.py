...
from bitbadgespy_sdk.models.i_get_balance_by_address_specific_badge_success_response import IGetBalanceByAddressSpecificBadgeSuccessResponse
...
class BadgesApi:
    ...
    @validate_call
    def get_balance_by_address_specific_badge(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection containing the badge.")],
        address: Annotated[StrictStr, Field(description="The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply.")],
        ...
        _param = self._get_balance_by_address_specific_badge_serialize(
            collection_id=collection_id,
            address=address,
            badge_id=badge_id,
            x_api_key=x_api_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IGetBalanceByAddressSpecificBadgeSuccessResponse",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '500': "ErrorResponse",
        }
    ...
    @validate_call
    def get_balance_by_address_specific_badge_with_http_info(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection containing the badge.")],
        address: Annotated[StrictStr, Field(description="The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply.")],
        badge_id: Annotated[StrictInt, Field(description="The ID for which the balance is to be retrieved.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IGetBalanceByAddressSpecificBadgeSuccessResponse]:
        """Get Badge Balance By Address - Specific Badge
    ...
    @validate_call
    def get_balance_by_address_specific_badge_without_preload_content(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection containing the badge.")],
        address: Annotated[StrictStr, Field(description="The address for which the balance is to be retrieved. Can be \"Total\" for the circulating supply.")],
        badge_id: Annotated[StrictInt, Field(description="The ID for which the balance is to be retrieved.")],
    ...
    def _get_balance_by_address_specific_badge_serialize(
        self,
        collection_id,
        address,
        badge_id,
    ...
    def get_owners_for_badge(
        ...
        Retrieves the owners in a paginated format for a specific token in a collection. Returns a list of addresses and their corresponding balances for the specified token ID.  ```tsx const res = await BitBadgesApi.getOwnersForBadge(   collectionId,   badgeId,   {     bookmark: '...'   } ); ```   SDK Links: - **[Request Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetOwnersForBadgePayload)** - **[Response Type](https://bitbadges.github.io/bitbadgesjs/interfaces/iGetOwnersForBadgeSuccessResponse)** - **[SDK API Function](https://bitbadges.github.io/bitbadgesjs/classes/BitBadgesAPI.html#getownersforbadge)** 
