...
from bitbadgespy_sdk.models.i_search_on_chain_templates_success_response import ISearchOnChainTemplatesSuccessResponse

class TestISearchOnChainTemplatesSuccessResponse(unittest.TestCase):
    """ISearchOnChainTemplatesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchOnChainTemplatesSuccessResponse:
        """Test ISearchOnChainTemplatesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchOnChainTemplatesSuccessResponse`
        """
        model = ISearchOnChainTemplatesSuccessResponse()
        if include_optional:
            return ISearchOnChainTemplatesSuccessResponse(
                templates = [
                    {
                        'key' : null
                        }
    ...
    def testISearchOnChainTemplatesSuccessResponse(self):
        """Test ISearchOnChainTemplatesSuccessResponse"""
