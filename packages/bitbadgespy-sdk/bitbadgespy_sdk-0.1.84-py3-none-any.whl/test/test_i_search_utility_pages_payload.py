...
class TestISearchUtilityPagesPayload(unittest.TestCase):
    """ISearchUtilityPagesPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchUtilityPagesPayload:
        """Test ISearchUtilityPagesPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchUtilityPagesPayload`
        """
        model = ISearchUtilityPagesPayload()
        if include_optional:
            return ISearchUtilityPagesPayload(
                bookmark = ''
            )
        else:
            return ISearchUtilityPagesPayload(
    ...
    def testISearchUtilityPagesPayload(self):
        """Test ISearchUtilityPagesPayload"""
