...
class TestIMsgDeleteDynamicStore(unittest.TestCase):
    """IMsgDeleteDynamicStore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgDeleteDynamicStore:
        """Test IMsgDeleteDynamicStore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgDeleteDynamicStore`
        """
        model = IMsgDeleteDynamicStore()
        if include_optional:
            return IMsgDeleteDynamicStore(
                creator = '',
                store_id = None
            )
        else:
    ...
    def testIMsgDeleteDynamicStore(self):
        """Test IMsgDeleteDynamicStore"""
