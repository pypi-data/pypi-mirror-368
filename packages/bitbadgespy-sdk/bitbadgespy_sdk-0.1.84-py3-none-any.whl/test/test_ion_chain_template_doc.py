...
class TestIOnChainTemplateDoc(unittest.TestCase):
    """IOnChainTemplateDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IOnChainTemplateDoc:
        """Test IOnChainTemplateDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IOnChainTemplateDoc`
        """
        model = IOnChainTemplateDoc()
        if include_optional:
            return IOnChainTemplateDoc(
                doc_id = '',
                id = '',
                locale = '',
                template_id = '',
    ...
    def testIOnChainTemplateDoc(self):
        """Test IOnChainTemplateDoc"""
