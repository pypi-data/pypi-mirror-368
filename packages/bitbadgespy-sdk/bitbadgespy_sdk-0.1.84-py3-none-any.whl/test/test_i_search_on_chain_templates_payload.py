...
from bitbadgespy_sdk.models.i_search_on_chain_templates_payload import ISearchOnChainTemplatesPayload

class TestISearchOnChainTemplatesPayload(unittest.TestCase):
    """ISearchOnChainTemplatesPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ISearchOnChainTemplatesPayload:
        """Test ISearchOnChainTemplatesPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ISearchOnChainTemplatesPayload`
        """
        model = ISearchOnChainTemplatesPayload()
        if include_optional:
            return ISearchOnChainTemplatesPayload(
                search_value = '',
                locale = '',
                bookmark = ''
            )
    ...
    def testISearchOnChainTemplatesPayload(self):
        """Test ISearchOnChainTemplatesPayload"""
