...
class TestIMsgSetCollectionApprovals(unittest.TestCase):
    """IMsgSetCollectionApprovals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetCollectionApprovals:
        """Test IMsgSetCollectionApprovals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetCollectionApprovals`
        """
        model = IMsgSetCollectionApprovals()
        if include_optional:
            return IMsgSetCollectionApprovals(
                creator = '',
                collection_id = None,
    ...
    def testIMsgSetCollectionApprovals(self):
        """Test IMsgSetCollectionApprovals"""
