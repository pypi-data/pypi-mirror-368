...
class TestIGetBalanceByAddressSpecificBadgeSuccessResponse(unittest.TestCase):
    """IGetBalanceByAddressSpecificBadgeSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBalanceByAddressSpecificBadgeSuccessResponse:
        """Test IGetBalanceByAddressSpecificBadgeSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBalanceByAddressSpecificBadgeSuccessResponse`
        """
        model = IGetBalanceByAddressSpecificBadgeSuccessResponse()
        if include_optional:
            return IGetBalanceByAddressSpecificBadgeSuccessResponse(
                balance = None
            )
        else:
            return IGetBalanceByAddressSpecificBadgeSuccessResponse(
    ...
    def testIGetBalanceByAddressSpecificBadgeSuccessResponse(self):
        """Test IGetBalanceByAddressSpecificBadgeSuccessResponse"""
