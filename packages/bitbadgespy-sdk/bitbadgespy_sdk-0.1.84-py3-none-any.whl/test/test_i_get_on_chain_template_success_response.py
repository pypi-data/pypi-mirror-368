...
from bitbadgespy_sdk.models.i_get_on_chain_template_success_response import IGetOnChainTemplateSuccessResponse

class TestIGetOnChainTemplateSuccessResponse(unittest.TestCase):
    """IGetOnChainTemplateSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetOnChainTemplateSuccessResponse:
        """Test IGetOnChainTemplateSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetOnChainTemplateSuccessResponse`
        """
        model = IGetOnChainTemplateSuccessResponse()
        if include_optional:
            return IGetOnChainTemplateSuccessResponse(
                template = {
                    'key' : null
                    }
            )
    ...
    def testIGetOnChainTemplateSuccessResponse(self):
        """Test IGetOnChainTemplateSuccessResponse"""
