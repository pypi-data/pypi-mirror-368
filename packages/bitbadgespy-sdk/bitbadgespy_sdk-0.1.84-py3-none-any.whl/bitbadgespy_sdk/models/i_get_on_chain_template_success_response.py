...
class IGetOnChainTemplateSuccessResponse(BaseModel):
    """
    IGetOnChainTemplateSuccessResponse
    """ # noqa: E501
    template: IOnChainTemplateDoc
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IGetOnChainTemplateSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IGetOnChainTemplateSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "template": IOnChainTemplateDoc.from_dict(obj["template"]) if obj.get("template") is not None else None
        })
