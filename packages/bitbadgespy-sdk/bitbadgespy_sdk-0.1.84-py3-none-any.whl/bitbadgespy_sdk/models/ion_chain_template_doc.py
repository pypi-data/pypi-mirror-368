...
from bitbadgespy_sdk.models.ion_chain_template_config import IOnChainTemplateConfig
from bitbadgespy_sdk.models.number_type import NumberType
from typing import Optional, Set
from typing_extensions import Self

class IOnChainTemplateDoc(BaseModel):
    """
    ...
    locale: StrictStr = Field(description="The locale of the template")
    template_id: StrictStr = Field(description="The unique template ID", alias="templateId")
    ...
    metadata: IMetadata = Field(description="The metadata for the template")
    config: IOnChainTemplateConfig = Field(description="The configuration for the template")
    verified: StrictBool = Field(description="Whether this template has been verified by the platform (managed behind the scenes)")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["_docId", "_id", "locale", "templateId", "createdBy", "createdAt", "deletedAt", "lastUpdated", "metadata", "config", "verified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IOnChainTemplateDoc from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IOnChainTemplateDoc from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": IOnChainTemplateConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
