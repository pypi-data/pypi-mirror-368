...
class ICreateOnChainTemplatePayload(BaseModel):
    """
    ICreateOnChainTemplatePayload
    """ # noqa: E501
    ...
    metadata: IMetadataWithoutInternals = Field(description="The metadata for the template")
    config: ICreateOnChainTemplatePayloadConfig
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["locale", "templateId", "metadata", "config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateOnChainTemplatePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateOnChainTemplatePayload from a dict"""
        if obj is None:
            return None
