...
class IMsgSetManager(BaseModel):
    """
    IMsgSetManager
    """ # noqa: E501
    ...
    manager_timeline: List[IManagerTimeline] = Field(description="New manager timeline to set.", alias="managerTimeline")
    can_update_manager: List[ITimedUpdatePermission] = Field(description="Permission to update manager timeline.", alias="canUpdateManager")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "managerTimeline", "canUpdateManager"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetManager from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetManager from a dict"""
        if obj is None:
            return None
