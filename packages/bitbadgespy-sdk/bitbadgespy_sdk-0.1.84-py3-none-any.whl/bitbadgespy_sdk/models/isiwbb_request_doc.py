...
class ISIWBBRequestDoc(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "code", "bitbadgesAddress", "address", "chain", "name", "description", "image", "scopes", "expiresAt", "createdAt", "deletedAt", "clientId", "redirectUri", "codeChallenge", "codeChallengeMethod"]
