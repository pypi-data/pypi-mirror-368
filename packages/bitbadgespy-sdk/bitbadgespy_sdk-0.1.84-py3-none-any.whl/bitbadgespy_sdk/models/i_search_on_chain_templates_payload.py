...
class ISearchOnChainTemplatesPayload(BaseModel):
    """
    ISearchOnChainTemplatesPayload
    """ # noqa: E501
    search_value: Optional[StrictStr] = Field(default=None, description="The search value to search for", alias="searchValue")
    locale: Optional[StrictStr] = Field(default=None, description="The locale to filter by")
    bookmark: Optional[StrictStr] = Field(default=None, description="The pagination bookmark to start from")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["searchValue", "locale", "bookmark"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISearchOnChainTemplatesPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISearchOnChainTemplatesPayload from a dict"""
        if obj is None:
            return None
