...
class IETHSignatureProof(BaseModel):
    """
    IETHSignatureProof
    """ # noqa: E501
    nonce: StrictStr = Field(description="The nonce that was signed. The signature scheme is ETHSign(nonce + \"-\" + creatorAddress).")
    signature: StrictStr = Field(description="The Ethereum signature of the nonce.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["nonce", "signature"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IETHSignatureProof from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IETHSignatureProof from a dict"""
        if obj is None:
            return None
