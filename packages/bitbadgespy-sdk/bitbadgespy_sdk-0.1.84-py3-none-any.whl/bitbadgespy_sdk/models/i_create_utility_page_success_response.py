...
class ICreateUtilityPageSuccessResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICreateUtilityPageSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICreateUtilityPageSuccessResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "doc": IUtilityPageDoc.from_dict(obj["doc"]) if obj.get("doc") is not None else None
        })
        return _obj
