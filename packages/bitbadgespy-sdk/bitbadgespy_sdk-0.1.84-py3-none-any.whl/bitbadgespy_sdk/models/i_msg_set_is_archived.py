...
class IMsgSetIsArchived(BaseModel):
    """
    IMsgSetIsArchived
    """ # noqa: E501
    ...
    is_archived_timeline: List[IIsArchivedTimeline] = Field(description="New isArchived timeline to set.", alias="isArchivedTimeline")
    can_archive_collection: List[ITimedUpdatePermission] = Field(description="Permission to archive collection.", alias="canArchiveCollection")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "isArchivedTimeline", "canArchiveCollection"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetIsArchived from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetIsArchived from a dict"""
        if obj is None:
            return None
