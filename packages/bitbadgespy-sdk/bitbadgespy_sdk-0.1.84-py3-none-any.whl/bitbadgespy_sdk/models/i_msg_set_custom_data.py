...
class IMsgSetCustomData(BaseModel):
    """
    IMsgSetCustomData
    """ # noqa: E501
    ...
    custom_data_timeline: List[ICustomDataTimeline] = Field(description="New custom data timeline to set.", alias="customDataTimeline")
    can_update_custom_data: List[ITimedUpdatePermission] = Field(description="Permission to update custom data timeline.", alias="canUpdateCustomData")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "customDataTimeline", "canUpdateCustomData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetCustomData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetCustomData from a dict"""
        if obj is None:
            return None
