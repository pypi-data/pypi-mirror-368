...
class IMsgSetDynamicStoreValue(BaseModel):
    """
    ...
    store_id: NumberType = Field(description="The ID of the dynamic store.", alias="storeId")
    ...
    value: NumberType = Field(description="The usage count to set (number of times this address can use the approval).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "storeId", "address", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetDynamicStoreValue from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of store_id
        if self.store_id:
            _dict['storeId'] = self.store_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetDynamicStoreValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "storeId": NumberType.from_dict(obj["storeId"]) if obj.get("storeId") is not None else None,
            "address": obj.get("address"),
            "value": NumberType.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
