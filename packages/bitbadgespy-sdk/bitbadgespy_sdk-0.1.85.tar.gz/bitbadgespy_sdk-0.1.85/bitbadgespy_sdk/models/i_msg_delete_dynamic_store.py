...
class IMsgDeleteDynamicStore(BaseModel):
    """
    ...
    store_id: NumberType = Field(description="The ID of the dynamic store to delete.", alias="storeId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "storeId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgDeleteDynamicStore from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgDeleteDynamicStore from a dict"""
        if obj is None:
            return None
