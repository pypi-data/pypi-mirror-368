...
class IMsgSetValidBadgeIds(BaseModel):
    """
    IMsgSetValidBadgeIds
    """ # noqa: E501
    ...
    valid_badge_ids: List[IUintRange] = Field(description="New badge IDs to add to this collection.", alias="validBadgeIds")
    can_update_valid_badge_ids: List[IBadgeIdsActionPermission] = Field(description="Permission to update valid badge IDs.", alias="canUpdateValidBadgeIds")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "validBadgeIds", "canUpdateValidBadgeIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetValidBadgeIds from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetValidBadgeIds from a dict"""
        if obj is None:
            return None
