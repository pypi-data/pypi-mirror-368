...
class IMsgIncrementStoreValue(BaseModel):
    """
    IMsgIncrementStoreValue
    """ # noqa: E501
    ...
    amount: NumberType = Field(description="The amount to increment by.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgIncrementStoreValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgIncrementStoreValue from a dict"""
        if obj is None:
            return None
