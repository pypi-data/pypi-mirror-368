...
class IGetBrowsePayload(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['collections', 'badges', 'addressLists', 'maps', 'claims', 'activity', 'utilityPages', 'applications', 'claimActivity', 'pointsActivity']):
            raise ValueError("must be one of enum values ('collections', 'badges', 'addressLists', 'maps', 'claims', 'activity', 'utilityPages', 'applications', 'claimActivity', 'pointsActivity')")
        return value
