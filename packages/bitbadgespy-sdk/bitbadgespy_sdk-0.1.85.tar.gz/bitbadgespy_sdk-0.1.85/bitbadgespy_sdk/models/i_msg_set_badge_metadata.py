...
class IMsgSetBadgeMetadata(BaseModel):
    """
    IMsgSetBadgeMetadata
    """ # noqa: E501
    ...
    badge_metadata_timeline: List[IBadgeMetadataTimeline] = Field(description="New badge metadata timeline to set.", alias="badgeMetadataTimeline")
    can_update_badge_metadata: List[ITimedUpdateWithBadgeIdsPermission] = Field(description="Permission to update badge metadata timeline.", alias="canUpdateBadgeMetadata")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "badgeMetadataTimeline", "canUpdateBadgeMetadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetBadgeMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetBadgeMetadata from a dict"""
        if obj is None:
            return None
