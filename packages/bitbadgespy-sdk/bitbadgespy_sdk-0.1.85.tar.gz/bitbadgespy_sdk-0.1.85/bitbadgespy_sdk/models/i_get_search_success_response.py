...
class IGetSearchSuccessResponse(BaseModel):
    ...
    utility_pages: Optional[List[IUtilityPageDoc]] = Field(default=None, alias="utilityPages")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["collections", "accounts", "addressLists", "badges", "maps", "applications", "claims", "utilityPages"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.claims:
            ...
            _dict['claims'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in utility_pages (list)
        _items = []
        if self.utility_pages:
            for _item_utility_pages in self.utility_pages:
                if _item_utility_pages:
                    _items.append(_item_utility_pages.to_dict())
            _dict['utilityPages'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "utilityPages": [IUtilityPageDoc.from_dict(_item) for _item in obj["utilityPages"]] if obj.get("utilityPages") is not None else None
        })
