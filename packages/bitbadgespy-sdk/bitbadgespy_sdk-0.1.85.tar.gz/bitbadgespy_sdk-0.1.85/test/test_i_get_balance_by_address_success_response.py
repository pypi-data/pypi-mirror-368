...
class TestIGetBalanceByAddressSuccessResponse(unittest.TestCase):
    """IGetBalanceByAddressSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBalanceByAddressSuccessResponse:
        """Test IGetBalanceByAddressSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBalanceByAddressSuccessResponse`
        """
        model = IGetBalanceByAddressSuccessResponse()
        if include_optional:
            return IGetBalanceByAddressSuccessResponse(
                balances = [
    ...
    def testIGetBalanceByAddressSuccessResponse(self):
        """Test IGetBalanceByAddressSuccessResponse"""
