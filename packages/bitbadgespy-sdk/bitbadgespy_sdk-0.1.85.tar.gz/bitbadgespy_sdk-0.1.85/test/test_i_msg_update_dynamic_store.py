...
class TestIMsgUpdateDynamicStore(unittest.TestCase):
    """IMsgUpdateDynamicStore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgUpdateDynamicStore:
        """Test IMsgUpdateDynamicStore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgUpdateDynamicStore`
        """
        model = IMsgUpdateDynamicStore()
        if include_optional:
            return IMsgUpdateDynamicStore(
                creator = '',
                store_id = None
            )
        else:
    ...
    def testIMsgUpdateDynamicStore(self):
        """Test IMsgUpdateDynamicStore"""
