...
class TestIMsgIncrementStoreValue(unittest.TestCase):
    """IMsgIncrementStoreValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgIncrementStoreValue:
        """Test IMsgIncrementStoreValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgIncrementStoreValue`
        """
        model = IMsgIncrementStoreValue()
        if include_optional:
            return IMsgIncrementStoreValue(
                creator = '',
                store_id = None,
                address = '',
                amount = None
    ...
    def testIMsgIncrementStoreValue(self):
        """Test IMsgIncrementStoreValue"""
