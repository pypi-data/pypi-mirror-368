...
class TestIUtilityPageContent(unittest.TestCase):
    """IUtilityPageContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityPageContent:
        """Test IUtilityPageContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityPageContent`
        """
        model = IUtilityPageContent()
        if include_optional:
            return IUtilityPageContent(
                type = '',
                label = '',
                content = ''
            )
    ...
    def testIUtilityPageContent(self):
        """Test IUtilityPageContent"""
