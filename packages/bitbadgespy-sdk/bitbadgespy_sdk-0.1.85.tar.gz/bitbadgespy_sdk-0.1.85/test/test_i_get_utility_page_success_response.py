...
class TestIGetUtilityPageSuccessResponse(unittest.TestCase):
    """IGetUtilityPageSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetUtilityPageSuccessResponse:
        """Test IGetUtilityPageSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetUtilityPageSuccessResponse`
        """
        model = IGetUtilityPageSuccessResponse()
        if include_optional:
            return IGetUtilityPageSuccessResponse(
                listing = {
                    'key' : null
                    }
            )
    ...
    def testIGetUtilityPageSuccessResponse(self):
        """Test IGetUtilityPageSuccessResponse"""
