...
class TestIMsgPurgeApprovals(unittest.TestCase):
    """IMsgPurgeApprovals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgPurgeApprovals:
        """Test IMsgPurgeApprovals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgPurgeApprovals`
        """
        model = IMsgPurgeApprovals()
        if include_optional:
            return IMsgPurgeApprovals(
                creator = '',
                collection_id = '',
                purge_expired = True,
                approver_address = '',
                purge_counterparty_approvals = True,
                approvals_to_purge = [
    ...
    def testIMsgPurgeApprovals(self):
        """Test IMsgPurgeApprovals"""
