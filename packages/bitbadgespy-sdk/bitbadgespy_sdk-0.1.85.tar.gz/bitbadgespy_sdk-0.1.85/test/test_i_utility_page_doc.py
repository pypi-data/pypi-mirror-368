...
class TestIUtilityPageDoc(unittest.TestCase):
    """IUtilityPageDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUtilityPageDoc:
        """Test IUtilityPageDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUtilityPageDoc`
        """
        model = IUtilityPageDoc()
        if include_optional:
            return IUtilityPageDoc(
                doc_id = '',
                id = '',
                listing_id = '',
                type = '',
                ...
                inherit_metadata_from = bitbadgespy_sdk.models.i_inherit_metadata_from.iInheritMetadataFrom(
                    ...
                    badge_id = '', ),
                content = [
                    bitbadgespy_sdk.models.i_utility_page_content.iUtilityPageContent(
                        type = '', 
                        label = '', 
                        content = '', )
                    ],
                links = [
                    bitbadgespy_sdk.models.i_utility_page_link.iUtilityPageLink(
                        url = '', 
                        claim_id = '', 
                        application_id = '', 
                        collection_id = '', 
                ...
                approval_status = bitbadgespy_sdk.models.i_utility_page_doc_approval_status.iUtilityPageDoc_approvalStatus(
                    is_approved = True, 
                    is_featured = True, 
                ...
                estimated_cost = bitbadgespy_sdk.models.i_estimated_cost.iEstimatedCost(
                    ...
                    denom = '', ),
                estimated_time = '',
                views_by_period = bitbadgespy_sdk.models.i_utility_page_doc_views_by_period.iUtilityPageDoc_viewsByPeriod(
                    hourly = 1.337, 
                    daily = 1.337, 
                    weekly = 1.337, 
                    monthly = 1.337, ),
                linked_to = bitbadgespy_sdk.models.i_linked_to.iLinkedTo(
                    ...
                    list_id = '', ),
                locale = '',
                home_page_view = bitbadgespy_sdk.models.i_utility_page_doc_home_page_view.iUtilityPageDoc_homePageView(
                    type = 'badges', 
                    category = '', )
            )
        else:
