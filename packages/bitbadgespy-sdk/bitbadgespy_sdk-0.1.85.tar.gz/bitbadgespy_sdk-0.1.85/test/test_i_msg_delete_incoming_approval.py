...
class TestIMsgDeleteIncomingApproval(unittest.TestCase):
    """IMsgDeleteIncomingApproval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgDeleteIncomingApproval:
        """Test IMsgDeleteIncomingApproval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgDeleteIncomingApproval`
        """
        model = IMsgDeleteIncomingApproval()
        if include_optional:
            return IMsgDeleteIncomingApproval(
                creator = '',
                collection_id = '',
                approval_id = ''
            )
    ...
    def testIMsgDeleteIncomingApproval(self):
        """Test IMsgDeleteIncomingApproval"""
