...
class TestICollectionInvariants(unittest.TestCase):
    """ICollectionInvariants unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICollectionInvariants:
        """Test ICollectionInvariants
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICollectionInvariants`
        """
        model = ICollectionInvariants()
        if include_optional:
            return ICollectionInvariants(
    ...
    def testICollectionInvariants(self):
        """Test ICollectionInvariants"""
