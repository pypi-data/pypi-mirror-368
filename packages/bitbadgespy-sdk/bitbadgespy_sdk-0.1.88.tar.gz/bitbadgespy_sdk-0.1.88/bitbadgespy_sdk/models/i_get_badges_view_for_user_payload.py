...
class IGetBadgesViewForUserPayload(BaseModel):
    ...
    view_type: Optional[StrictStr] = Field(default=None, description="The view type to search for. Default is 'collected'  - 'collected' will return the tokens the user has a balance of - 'managing' will return the tokens the user is managing - 'created' will return the tokens the user has created", alias="viewType")
