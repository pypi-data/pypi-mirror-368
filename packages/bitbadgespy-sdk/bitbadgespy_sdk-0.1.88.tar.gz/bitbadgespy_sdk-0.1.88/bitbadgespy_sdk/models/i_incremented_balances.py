...
class IIncrementedBalances(BaseModel):
    ...
    increment_badge_ids_by: NumberType = Field(description="The amount to increment the token IDs by after each transfer.", alias="incrementBadgeIdsBy")
    ...
    allow_override_with_any_valid_badge: StrictBool = Field(description="Whether to allow the override with any valid ID.", alias="allowOverrideWithAnyValidBadge")
