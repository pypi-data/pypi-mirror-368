...
class IBatchTokenDetails(BaseModel):
    """
    IBatchTokenDetails
    """ # noqa: E501
    collection_id: StrictStr = Field(alias="collectionId")
    badge_ids: List[IUintRange] = Field(description="The corresponding token IDs for this collection ID.", alias="badgeIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IBatchTokenDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IBatchTokenDetails from a dict"""
        if obj is None:
            return None
