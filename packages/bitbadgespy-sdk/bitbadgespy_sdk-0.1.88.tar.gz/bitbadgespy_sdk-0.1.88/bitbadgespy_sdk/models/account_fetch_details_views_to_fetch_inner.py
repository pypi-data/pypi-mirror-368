...
class AccountFetchDetailsViewsToFetchInner(BaseModel):
    ...
    specific_collections: Optional[List[IBatchTokenDetails]] = Field(default=None, description="If defined, we will filter the view to only include the specified collections.", alias="specificCollections")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specificCollections": [IBatchTokenDetails.from_dict(_item) for _item in obj["specificCollections"]] if obj.get("specificCollections") is not None else None,
