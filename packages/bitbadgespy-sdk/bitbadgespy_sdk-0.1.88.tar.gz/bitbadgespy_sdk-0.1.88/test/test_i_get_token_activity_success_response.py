...
class TestIGetTokenActivitySuccessResponse(unittest.TestCase):
    """IGetTokenActivitySuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetTokenActivitySuccessResponse:
        """Test IGetTokenActivitySuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetTokenActivitySuccessResponse`
        """
        model = IGetTokenActivitySuccessResponse()
        if include_optional:
            return IGetTokenActivitySuccessResponse(
                activity = [
    ...
    def testIGetTokenActivitySuccessResponse(self):
        """Test IGetTokenActivitySuccessResponse"""
