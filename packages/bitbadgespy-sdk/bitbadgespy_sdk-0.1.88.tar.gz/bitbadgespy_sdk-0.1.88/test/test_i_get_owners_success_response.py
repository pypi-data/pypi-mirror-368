...
class TestIGetOwnersSuccessResponse(unittest.TestCase):
    """IGetOwnersSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetOwnersSuccessResponse:
        """Test IGetOwnersSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetOwnersSuccessResponse`
        """
        model = IGetOwnersSuccessResponse()
        if include_optional:
            return IGetOwnersSuccessResponse(
                owners = [
    ...
    def testIGetOwnersSuccessResponse(self):
        """Test IGetOwnersSuccessResponse"""
