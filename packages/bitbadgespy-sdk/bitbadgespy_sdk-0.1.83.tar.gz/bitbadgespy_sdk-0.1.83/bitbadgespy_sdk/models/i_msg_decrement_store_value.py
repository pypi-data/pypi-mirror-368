...
class IMsgDecrementStoreValue(BaseModel):
    """
    IMsgDecrementStoreValue
    """ # noqa: E501
    ...
    amount: NumberType = Field(description="The amount to decrement by.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "storeId", "address", "amount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgDecrementStoreValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgDecrementStoreValue from a dict"""
        if obj is None:
            return None
