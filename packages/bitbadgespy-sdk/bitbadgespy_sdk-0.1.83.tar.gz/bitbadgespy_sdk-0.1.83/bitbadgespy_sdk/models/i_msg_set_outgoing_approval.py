...
class IMsgSetOutgoingApproval(BaseModel):
    """
    ...
    approval: IUserOutgoingApproval = Field(description="The outgoing approval to set.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creator", "collectionId", "approval"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMsgSetOutgoingApproval from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMsgSetOutgoingApproval from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "approval": IUserOutgoingApproval.from_dict(obj["approval"]) if obj.get("approval") is not None else None
        })
