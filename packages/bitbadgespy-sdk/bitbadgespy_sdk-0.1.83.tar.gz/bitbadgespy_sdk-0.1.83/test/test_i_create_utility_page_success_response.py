...
class TestICreateUtilityPageSuccessResponse(unittest.TestCase):
    """ICreateUtilityPageSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICreateUtilityPageSuccessResponse:
        """Test ICreateUtilityPageSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICreateUtilityPageSuccessResponse`
        """
        model = ICreateUtilityPageSuccessResponse()
        if include_optional:
            return ICreateUtilityPageSuccessResponse(
                doc = {
                    'key' : null
                    }
            )
    ...
    def testICreateUtilityPageSuccessResponse(self):
        """Test ICreateUtilityPageSuccessResponse"""
