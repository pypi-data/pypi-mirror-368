...
class TestIUpdateUtilityPageSuccessResponse(unittest.TestCase):
    """IUpdateUtilityPageSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUpdateUtilityPageSuccessResponse:
        """Test IUpdateUtilityPageSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUpdateUtilityPageSuccessResponse`
        """
        model = IUpdateUtilityPageSuccessResponse()
        if include_optional:
            return IUpdateUtilityPageSuccessResponse(
                doc = {
                    'key' : null
                    }
            )
    ...
    def testIUpdateUtilityPageSuccessResponse(self):
        """Test IUpdateUtilityPageSuccessResponse"""
