...
class TestIMsgSetStandards(unittest.TestCase):
    """IMsgSetStandards unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetStandards:
        """Test IMsgSetStandards
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetStandards`
        """
        model = IMsgSetStandards()
        if include_optional:
            return IMsgSetStandards(
                creator = '',
                collection_id = None,
                standards_timeline = [
