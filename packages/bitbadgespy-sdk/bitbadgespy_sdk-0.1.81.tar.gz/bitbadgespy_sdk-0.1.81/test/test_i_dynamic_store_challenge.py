...
class TestIDynamicStoreChallenge(unittest.TestCase):
    """IDynamicStoreChallenge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDynamicStoreChallenge:
        """Test IDynamicStoreChallenge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDynamicStoreChallenge`
        """
        model = IDynamicStoreChallenge()
        if include_optional:
            return IDynamicStoreChallenge(
                store_id = None
            )
        else:
            return IDynamicStoreChallenge(
    ...
    def testIDynamicStoreChallenge(self):
        """Test IDynamicStoreChallenge"""
