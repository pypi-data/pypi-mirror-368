...
class ICollectionInvariants(BaseModel):
    """
    CollectionInvariants defines the invariants that apply to a collection. These are set upon genesis and cannot be modified.
    """ # noqa: E501
    no_custom_ownership_times: StrictBool = Field(description="If true, all ownership times must be full ranges [{ start: 1, end: GoMaxUInt64 }]. This prevents time-based restrictions on badge ownership.", alias="noCustomOwnershipTimes")
    __properties: ClassVar[List[str]] = ["noCustomOwnershipTimes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICollectionInvariants from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICollectionInvariants from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "noCustomOwnershipTimes": obj.get("noCustomOwnershipTimes")
        })
        return _obj
