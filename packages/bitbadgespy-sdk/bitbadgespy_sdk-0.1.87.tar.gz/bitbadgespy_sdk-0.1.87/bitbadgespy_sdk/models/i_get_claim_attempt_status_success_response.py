...
class IGetClaimAttemptStatusSuccessResponse(BaseModel):
    ...
    success: StrictBool
    error: StrictStr
    code: Optional[StrictStr] = Field(default=None, description="The code for the on-chain transaction. Only provided if you have permissions and this is an on-chain token claim.")
