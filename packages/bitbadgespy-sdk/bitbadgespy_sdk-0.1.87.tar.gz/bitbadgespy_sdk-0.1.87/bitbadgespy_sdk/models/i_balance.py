...
class IBalance(BaseModel):
    ...
    IBalance
    """ # noqa: E501
    amount: NumberType = Field(description="The amount or balance of the owned token.")
    badge_ids: List[IUintRange] = Field(description="The token IDs corresponding to the balance.", alias="badgeIds")
    ownership_times: List[IUintRange] = Field(description="The times that the token is owned from.", alias="ownershipTimes")
