...
class ICollectionPermissions(BaseModel):
    ...
    can_update_valid_badge_ids: List[IBadgeIdsActionPermission] = Field(description="The permissions for creating more tokens.", alias="canUpdateValidBadgeIds")
    can_update_badge_metadata: List[ITimedUpdateWithBadgeIdsPermission] = Field(description="The permissions for updating the token metadata.", alias="canUpdateBadgeMetadata")
