...
class IMetadataWithoutInternals(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "image", "bannerImage", "category", "externalUrl", "tags", "socials", "offChainTransferabilityInfo", "attributes", "additionalInfo"]
