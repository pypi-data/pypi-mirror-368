...
class ICollectionApproval(BaseModel):
    ...
    ICollectionApproval
    """ # noqa: E501
    to_list_id: StrictStr = Field(description="The list ID for the user(s) who is receiving the tokens. The ID is either registered on-chain for reusability or follows the reserved ID system.", alias="toListId")
    to_list: IAddressList = Field(alias="toList")
    from_list_id: StrictStr = Field(description="The list ID for the user(s) who is sending the tokens. The ID is either registered on-chain for reusability or follows the reserved ID system.", alias="fromListId")
    ...
    badge_ids: List[IUintRange] = Field(description="The token IDs to be transferred.", alias="badgeIds")
    ownership_times: List[IUintRange] = Field(description="The ownership times of the tokens being transferred.", alias="ownershipTimes")
    ...
    approval_criteria: Optional[IApprovalCriteria] = Field(default=None, description="The criteria to be met. These represent the restrictions that must be obeyed such as the total amount approved, max num transfers, merkle challenges, must own tokens, etc.", alias="approvalCriteria")
