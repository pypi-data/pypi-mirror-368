...
class TestIMsgSetIncomingApproval(unittest.TestCase):
    """IMsgSetIncomingApproval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetIncomingApproval:
        """Test IMsgSetIncomingApproval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetIncomingApproval`
        """
        model = IMsgSetIncomingApproval()
        if include_optional:
            return IMsgSetIncomingApproval(
                creator = '',
                collection_id = '',
                approval = bitbadgespy_sdk.models.i_user_incoming_approval.iUserIncomingApproval(
                    from_list_id = '', 
    ...
    def testIMsgSetIncomingApproval(self):
        """Test IMsgSetIncomingApproval"""
