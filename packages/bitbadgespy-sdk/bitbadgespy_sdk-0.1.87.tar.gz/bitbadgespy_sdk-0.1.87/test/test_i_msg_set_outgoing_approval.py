...
class TestIMsgSetOutgoingApproval(unittest.TestCase):
    """IMsgSetOutgoingApproval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgSetOutgoingApproval:
        """Test IMsgSetOutgoingApproval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgSetOutgoingApproval`
        """
        model = IMsgSetOutgoingApproval()
        if include_optional:
            return IMsgSetOutgoingApproval(
                creator = '',
                collection_id = '',
                approval = bitbadgespy_sdk.models.i_user_outgoing_approval.iUserOutgoingApproval(
                    to_list_id = '', 
    ...
    def testIMsgSetOutgoingApproval(self):
        """Test IMsgSetOutgoingApproval"""
