...
public:
  ...
  ShapedInputLoader(void *dtensor_ptr,
    ...
    // assert(stensor.data_type == yirage::type::DT_FLOAT16);
    // assert(dtensor.data_type == yirage::type::DT_FLOAT16);
    MatrixCoord extent({dtensor_matrix_shape.x, dtensor_matrix_shape.y});
    // yirage::layout::DmemLayout dlayout = dtensor.layout;
    // yirage::layout::SmemLayout slayout = stensor.layout;
    if (dlayout == yirage::layout::DmemRowMajor) {
      using DmemLayout = cutlass::layout::RowMajor;
      if (slayout == yirage::layout::SmemRowMajor) {
        ...
        InputLoader loader(((cutlass::half_t *)dtensor_ptr) + global_offset,
          ...
          slayout ==
              yirage::layout::SmemRowMajorTensorOpMultiplicand_Crosswise16 ||
          slayout ==
              yirage::layout::SmemRowMajorTensorOpMultiplicand_Crosswise32 ||
          slayout ==
              yirage::layout::SmemRowMajorTensorOpMultiplicand_Crosswise64) {
        using SmemLayout =
      ...
      // assert(dlayout == yirage::layout::DmemColumnMajor);
      using DmemLayout = cutlass::layout::ColumnMajor;
      if (slayout == yirage::layout::SmemColumnMajor) {
        ...
        InputLoader loader(((cutlass::half_t *)dtensor_ptr) + global_offset,
          ...
          slayout ==
              yirage::layout::SmemColumnMajorTensorOpMultiplicand_Crosswise16 ||
          slayout ==
              yirage::layout::SmemColumnMajorTensorOpMultiplicand_Crosswise32 ||
          slayout ==
              yirage::layout::SmemColumnMajorTensorOpMultiplicand_Crosswise64) {
