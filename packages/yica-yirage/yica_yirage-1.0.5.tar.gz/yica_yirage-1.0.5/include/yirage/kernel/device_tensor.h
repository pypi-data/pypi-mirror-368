...
struct alignas(16) DTensor {
  ...
  bool has_same_fingerprint(yirage::cpu::CTensor const &ref) const;
  yirage::cpu::CTensor copy_fingerprint_to_ctensor() const;
...
namespace std {
template <>
struct hash<yirage::kernel::DTensor> {
  size_t operator()(yirage::kernel::DTensor const &) const;
};
}; // namespace std
