...
# Import version from version.py for consistency check
try:
    from .version import __version__ as version_py_version
    ...
    # Keep using the version defined above if version.py is not available
    pass
