...
def vector_nonlinear(architecture_dict: OrderedDict, workload_dict: OrderedDict=None)->OrderedDict:
    ...
    accumulator_vector_dim = get_prod(architecture_dict['accumulator_vector']['instance'][-2:])
    register_vector_dim = get_prod(architecture_dict['register_vector']['instance'][-2:])
    mac_register_vector = get_prod(architecture_dict['mac_register_vector']['instance'][-2:])
