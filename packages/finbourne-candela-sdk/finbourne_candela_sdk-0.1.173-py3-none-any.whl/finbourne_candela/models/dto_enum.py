...
class DTOEnum(BaseModel):
    ...
    __properties = ["type", "options", "is_nullable", "description", "default_value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DTOEnum:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DTOEnum:
        """Create an instance of DTOEnum from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DTOEnum.parse_obj(obj)

        _obj = DTOEnum.parse_obj({
