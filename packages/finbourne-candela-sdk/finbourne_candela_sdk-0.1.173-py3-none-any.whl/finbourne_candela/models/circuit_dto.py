...
class CircuitDTO(BaseModel):
    ...
    CircuitDTO
    """
    first:  StrictStr = Field(...,alias="first") 
    nodes: Optional[Any] = Field(...)
    additional_properties: Dict[str, Any] = {}
    __properties = ["first", "nodes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CircuitDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CircuitDTO:
        """Create an instance of CircuitDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CircuitDTO.parse_obj(obj)

        _obj = CircuitDTO.parse_obj({
            "first": obj.get("first"),
        })
