...
from finbourne_candela.extensions.api_configuration import ApiConfiguration
from finbourne_candela.extensions.file_access_token import FileAccessToken
...
ENVIRONMENT_CONFIG_KEYS = {
    ...
    "api_url": "FBN_CANDELA_URL",
    "previous_api_url": "FBN_FINBOURNE_CANDELA_API_URL",
...
SECRETS_FILE_CONFIG_KEYS = {
    "token_url": "tokenUrl",
    "api_url": "candelaUrl",
    "previous_api_url": "finbourne_candelaUrl",
    "username": "username",
    "password": "password",
    "client_id": "clientId",
