...
class DTOConst(BaseModel):
    ...
    __properties = ["type", "value", "is_nullable", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DTOConst:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DTOConst:
        """Create an instance of DTOConst from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DTOConst.parse_obj(obj)

        _obj = DTOConst.parse_obj({
