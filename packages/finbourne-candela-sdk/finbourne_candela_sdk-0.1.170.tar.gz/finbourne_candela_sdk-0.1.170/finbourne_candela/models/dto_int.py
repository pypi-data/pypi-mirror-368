...
from pydantic.v1 import StrictStr, Field, BaseModel, StrictBool, StrictInt, StrictStr, conlist, validator 
...
class DTOInt(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DTOInt:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DTOInt:
        """Create an instance of DTOInt from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DTOInt.parse_obj(obj)
