...
import finbourne_candela.models
from finbourne_candela.extensions import rest
from finbourne_candela.exceptions import ApiValueError, ApiException
...
class SyncApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        package_version = version("finbourne_candela-sdk")
        self.default_headers = {
            "X-LUSID-SDK-Language": "Python",
            "X-LUSID-SDK-Version":  version("finbourne_candela-sdk")
        }
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(finbourne_candela.models, klass)
