...
SPEC_ONE_OF_SCHEMAS = ["DTOArr", "DTOBool", "DTODict", "DTOEnum", "DTOInt", "DTOObj", "DTOReal", "DTOStr"]
...
class Spec(BaseModel):
    ...
    if TYPE_CHECKING:
        ...
        actual_instance: Any
    one_of_schemas: List[str] = Field(SPEC_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Spec with oneOf schemas: DTOArr, DTOBool, DTODict, DTOEnum, DTOInt, DTOObj, DTOReal, DTOStr. Details: Matched classes " + matchclass)
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Spec with oneOf schemas: DTOArr, DTOBool, DTODict, DTOEnum, DTOInt, DTOObj, DTOReal, DTOStr. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Spec:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Spec with oneOf schemas: DTOArr, DTOBool, DTODict, DTOEnum, DTOInt, DTOObj, DTOReal, DTOStr. Matches: "+matchclass+", Details: " + ", ".join(error_messages) + ", JSON: " + json_str)
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Spec with oneOf schemas: DTOArr, DTOBool, DTODict, DTOEnum, DTOInt, DTOObj, DTOReal, DTOStr. Details: " + ", ".join(error_messages))
        else:
            return instance
