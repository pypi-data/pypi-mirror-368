...
OBJ1_ONE_OF_SCHEMAS = ["DTOArr", "DTOBool", "DTOConst", "DTODict", "DTOEnum", "DTOInt", "DTOObj", "DTOReal", "DTOStr"]
...
class Obj1(BaseModel):
    ...
    if TYPE_CHECKING:
        ...
        actual_instance: Any
    one_of_schemas: List[str] = Field(OBJ1_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Obj1 with oneOf schemas: DTOArr, DTOBool, DTOConst, DTODict, DTOEnum, DTOInt, DTOObj, DTOReal, DTOStr. Details: Matched classes " + matchclass)
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Obj1 with oneOf schemas: DTOArr, DTOBool, DTOConst, DTODict, DTOEnum, DTOInt, DTOObj, DTOReal, DTOStr. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> Obj1:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> Obj1:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Obj1 with oneOf schemas: DTOArr, DTOBool, DTOConst, DTODict, DTOEnum, DTOInt, DTOObj, DTOReal, DTOStr. Matches: "+matchclass+", Details: " + ", ".join(error_messages) + ", JSON: " + json_str)
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Obj1 with oneOf schemas: DTOArr, DTOBool, DTOConst, DTODict, DTOEnum, DTOInt, DTOObj, DTOReal, DTOStr. Details: " + ", ".join(error_messages))
        else:
            return instance
