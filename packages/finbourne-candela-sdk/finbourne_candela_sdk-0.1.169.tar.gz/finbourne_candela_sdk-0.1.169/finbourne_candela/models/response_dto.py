...
class ResponseDTO(BaseModel):
    ...
    __properties = ["type", "node_id", "child_id", "as_block", "template", "context", "inserts"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('response', 'intent', 'confirm', 'no-op', 'use-tool', 'switch', 'insert'):
            raise ValueError("must be one of enum values ('response', 'intent', 'confirm', 'no-op', 'use-tool', 'switch', 'insert')")
        return value
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDTO:
        """Create an instance of ResponseDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDTO.parse_obj(obj)

        _obj = ResponseDTO.parse_obj({
            "type": obj.get("type") if obj.get("type") is not None else 'response',
