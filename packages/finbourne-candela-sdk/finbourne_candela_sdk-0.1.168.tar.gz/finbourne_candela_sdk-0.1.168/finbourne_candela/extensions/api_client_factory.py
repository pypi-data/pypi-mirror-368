...
from finbourne_candela.extensions.retry import (
    RetryingRestWrapper,
...
from finbourne_candela.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A finbourne_candela.api class.


        Returns
        -------
        T
            An instance of the finbourne_candela.api class with a configured ApiClient
        """
