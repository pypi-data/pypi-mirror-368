...
|   |   |   |
| --- | --- | --- |
| [`feature 1`](./bluer_plugin/docs/feature_1.md) [![image](https://github.com/kamangir/assets/raw/main/blue-plugin/marquee.png?raw=true)](./bluer_plugin/docs/feature_1.md) description of feature 1 ... | [`feature 2`](./bluer_plugin/docs/feature_2) [![image](https://github.com/kamangir/assets/raw/main/blue-plugin/marquee.png?raw=true)](./bluer_plugin/docs/feature_2) description of feature 2 ... | [`feature 3`](./bluer_plugin/docs/feature_3) [![image](https://github.com/kamangir/assets/raw/main/blue-plugin/marquee.png?raw=true)](./bluer_plugin/docs/feature_3) description of feature 3 ... |
...
built by 🌀 [`bluer README`](https://github.com/kamangir/bluer-objects/tree/main/bluer_objects/README), based on 🌀 [`bluer_plugin-4.50.1`](https://github.com/kamangir/bluer-plugin).
