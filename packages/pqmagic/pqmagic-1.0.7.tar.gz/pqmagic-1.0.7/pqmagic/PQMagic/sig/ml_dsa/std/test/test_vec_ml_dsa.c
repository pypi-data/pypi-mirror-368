...
int     gen_ml_dsa_test_vec(void);
int     check_ml_dsa_use_test_vec(void);
...
int gen_ml_dsa_test_vec(void) {
    ...
    char filename[32] = {0};
    sprintf(filename, "./ml_dsa_%d_test_vectors.txt", ML_DSA_MODE);
...
int check_ml_dsa_use_test_vec(void) {
    ...
    char filename[32] = {0};
    sprintf(filename, "./ml_dsa_%d_test_vectors.txt", ML_DSA_MODE);
    printf("Check ml_dsa_%d using test vector file: %s\n", ML_DSA_MODE, filename);
