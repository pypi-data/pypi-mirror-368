...
def main():
    ...
    if args.command == 'help' or not args.command:
        ...
        print("\nExample usage:")
        print("  python -m sage_frontend.sage_server.main start")
        print("  python -m sage_frontend.sage_server.main start --host 0.0.0.0 --port 8080")
        print("  python -m sage_frontend.sage_server.main start --reload")
        return 0
