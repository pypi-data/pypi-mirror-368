...
The stubs are generated by pybind11-stubgen (2.5.5). It is contained in the development
requirements. To generate the stubs execute the following script. It adds the shared object path of
pyds to the python search path and executes pybind11-stubgen after that.
