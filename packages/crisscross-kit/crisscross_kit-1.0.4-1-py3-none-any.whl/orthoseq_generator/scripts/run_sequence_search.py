...
if __name__ == "__main__":
    ...
    offtarget_limit = -7.5    # Maximum allowed off-target binding strength
    max_ontarget = -12.5     # Maximum acceptable on-target binding energy
    min_ontarget = -14.0      # Minimum acceptable on-target binding energy
    ...
    hf.save_sequence_pairs_to_txt(orthogonal_seq_pairs, filename='10mers_my_sequences101.txt')
    ...
    stats = sc.plot_on_off_target_histograms(
        onef,
        offef,
        output_path='/Users/matt/Desktop/10mer_result_energy_plot.pdf'
    )
