...
def test_api_examples():
    ...
    # analyze_types.py requires additional arguments
    script_path = Path(__file__).parent.parent / 'examples' / 'analyze_types.py'
    til_path = Path(__file__).parent / 'resources' / 'example.til'
    cmd = [sys.executable, str(script_path), '-f', str(idb_path), '-t', til_path]
