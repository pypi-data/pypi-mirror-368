...
class LibraryAddFlags(IntFlag):
    ...
    ADD_DEFAULT = ida_typeinf.ADDTIL_DEFAULT  # default behavior
    ADD_INCOMPATIBLE = ida_typeinf.ADDTIL_INCOMP  # add incompatible type libraries
    ADD_SILENT = ida_typeinf.ADDTIL_SILENT  # do not ask any questions
...
class LibraryAddResult(IntEnum):
    ...
    INCOMPATIBLE = ida_typeinf.ADDTIL_INCOMP
