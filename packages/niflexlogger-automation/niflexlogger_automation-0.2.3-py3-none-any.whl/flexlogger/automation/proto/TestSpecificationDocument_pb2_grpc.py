...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in flexlogger/automation/proto/TestSpecificationDocument_pb2_grpc.py depends on'
...
def add_TestSpecificationDocumentServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('national_instruments.flex_logger.automation.protocols.TestSpecificationDocument', rpc_method_handlers)
