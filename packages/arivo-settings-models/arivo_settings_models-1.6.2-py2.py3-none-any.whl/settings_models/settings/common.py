...
class Gate(SettingsModel):
    ...
    is_wide: Optional[bool] = Field(None, description="This field in the gate settings model indicates whether the "
                                                      "gate is wide. For gates of type entry and exit in Freeflow mode, "
                                                      "the value must be either true or false. "
                                                      "For all other gate types, the value must be null.")
