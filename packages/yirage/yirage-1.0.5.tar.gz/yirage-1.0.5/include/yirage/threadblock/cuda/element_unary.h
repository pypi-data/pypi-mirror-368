...
public:
  CUTLASS_DEVICE
  ElementUnaryExecutor(yirage::type::TBOperatorType op_type,
    ...
    if (op_type == yirage::type::TB_EXP_OP) {
    ...
    } else if (op_type == yirage::type::TB_CLAMP_OP) {
