...
class DocumentField(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.source_coordinates:
            for _item in self.source_coordinates:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "source_coordinates": [FieldSourceCoordinates.from_dict(_item) for _item in obj.get("source_coordinates")] if obj.get("source_coordinates") is not None else None,
            "edit_history": [ModificationObject.from_dict(_item) for _item in obj.get("edit_history")] if obj.get("edit_history") is not None else None,
            "confidence": DocumentFieldConfidence.from_dict(obj.get("confidence")) if obj.get("confidence") is not None else None,
            "validations": DocumentFieldValidations.from_dict(obj.get("validations")) if obj.get("validations") is not None else None
        })
        return _obj
