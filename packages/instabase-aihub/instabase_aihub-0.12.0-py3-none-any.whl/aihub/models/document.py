...
class Document(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.class_edit_history:
            for _item in self.class_edit_history:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "fields": [DocumentField.from_dict(_item) for _item in obj.get("fields")] if obj.get("fields") is not None else None,
            ...
            "class_edit_history": [ModificationObject.from_dict(_item) for _item in obj.get("class_edit_history")] if obj.get("class_edit_history") is not None else None,
            "validations": DocumentValidations.from_dict(obj.get("validations")) if obj.get("validations") is not None else None,
            "classification_confidence": DocumentClassificationConfidence.from_dict(obj.get("classification_confidence")) if obj.get("classification_confidence") is not None else None
        })
        return _obj
