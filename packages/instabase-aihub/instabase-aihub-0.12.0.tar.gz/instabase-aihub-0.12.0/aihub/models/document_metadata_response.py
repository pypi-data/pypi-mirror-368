...
class DocumentMetadataResponse(BaseModel):
    ...
    ibdoc_path: Optional[StrictStr] = Field(default=None, description="Path to the document's internal representation.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the document.")
    metadata: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["id", "ibdoc_path", "name", "metadata"]
