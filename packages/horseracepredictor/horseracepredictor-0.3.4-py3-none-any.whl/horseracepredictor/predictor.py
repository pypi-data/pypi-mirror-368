...
class HorseRacePredictor:
    ...
    def evaluate(self, predicted):
        """Return accuracy statistics for FinishPosition == 1 (winners only)"""
        # Only evaluate rows where the actual horse is a winner
        winners_mask = (self.y == 1)  # Assuming 1 = winner
    ...
    def summary(self, threshold=0.35, save_csv=False):
        ...
        print("===== Prediction Summary (Winners Only) =====")
