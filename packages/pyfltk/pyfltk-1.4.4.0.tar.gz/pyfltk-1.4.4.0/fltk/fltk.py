...
class Fl_Tile(Fl_Group):
    ...
    def size_range(self, *args):
        r"""
        size_range(Fl_Tile self, int index, int minw, int minh, int maxw=0x7FFFFFFF, int maxh=0x7FFFFFFF)
        size_range(Fl_Tile self, Fl_Widget w, int minw, int minh, int maxw=0x7FFFFFFF, int maxh=0x7FFFFFFF)
        """
...
class Fl_Tree(Fl_Group):
    ...
    def next_selected_item(self, *args):
        r"""next_selected_item(Fl_Tree self, Fl_Tree_Item item=None, int dir=0xff54) -> Fl_Tree_Item"""
