...
from sthg_ontology_base.utils.snowflake_generator import SnowflakeGenerator
...
class BaseModel(Base):
    ...
    _snowflake_generator = SNOWFLAKE_GENERATOR  # 使用全局ID生成器
    ...
    def create(cls, **kwargs):
        ...
        if cls._should_generate_id(kwargs):
            ...
            kwargs[pk_col.name] = cls._generate_id(pk_col.type)
    ...
    def bulk_create(cls, data_list):
        ...
        for data in data_list:
            if cls._should_generate_id(data):
                data[pk_col.name] = cls._generate_id(pk_col.type)
    ...
    @classmethod
    def _generate_id(cls,obj_type):
        """生成雪花ID"""
        return cls._snowflake_generator.get_id(obj_type)
