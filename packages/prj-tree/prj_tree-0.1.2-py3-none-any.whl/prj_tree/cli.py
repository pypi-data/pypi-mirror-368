...
def main(argv=None) -> int:
    ...
    parser.add_argument("--max-file-chars", type=int, default=None, help="Максимум символов на файл (по умолчанию — без обрезки)")
    parser.add_argument("--no-truncate", action="store_true", help="Отключить обрезку содержимого (эквивалентно max-file-chars=None)")
    ...
    cli_map = {
        ...
        "max_file_chars": None if args.no_truncate else args.max_file_chars,
        "title": args.title,
