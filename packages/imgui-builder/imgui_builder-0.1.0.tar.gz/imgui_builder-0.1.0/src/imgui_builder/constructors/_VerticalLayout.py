...
class VerticalLayoutArgs(TypedDict):
...
class VerticalLayout(BaseLayout):
    ...
    def __init__(self, size: Tuple[int, int] = (0, 0), *, flexbox: Optional[Flexbox] = None, align: Literal['left', 'middle', 'right'] | float = 0, parent_relative_alignment: Literal['top', 'middle', 'bottom'] | float = 0, **kwargs: Unpack[VerticalLayoutArgs]): 
