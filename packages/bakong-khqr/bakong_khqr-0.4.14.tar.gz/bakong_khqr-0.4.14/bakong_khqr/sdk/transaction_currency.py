...
class TransactionCurrency:
    def __init__(self):
        ...
        self.__transaction_currency = emv.transaction_currency
        self.__currency_usd = emv.transaction_currency_usd
        self.__currency_khr = emv.transaction_currency_khr
    ...
    def value(self, currency: str) -> str:
        ...
        if currency == "USD":
            currency_value = self.__currency_usd
            
        elif currency == "KHR":
            currency_value = self.__currency_khr
        ...
        return f"{self.__transaction_currency}{length_of_currency}{currency_value}"
