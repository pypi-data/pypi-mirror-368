...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile ObservationResultsRadiologyUvIps
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:category/f:coding/f:display</sch:title>
