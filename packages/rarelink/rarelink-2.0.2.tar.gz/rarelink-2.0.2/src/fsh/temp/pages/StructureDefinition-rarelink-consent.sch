...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Consent">
      <sch:assert test="count(f:extension[@url = 'https://github.com/BIH-CEI/RareLink/StructureDefinition/consent-to-reuse-data']) &lt;= 1">extension with URL = 'https://github.com/BIH-CEI/RareLink/StructureDefinition/consent-to-reuse-data': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/BIH-CEI/RareLink/StructureDefinition/agreement-to-be-contacted']) &lt;= 1">extension with URL = 'https://github.com/BIH-CEI/RareLink/StructureDefinition/agreement-to-be-contacted': maximum cardinality of 'extension' is 1</sch:assert>
