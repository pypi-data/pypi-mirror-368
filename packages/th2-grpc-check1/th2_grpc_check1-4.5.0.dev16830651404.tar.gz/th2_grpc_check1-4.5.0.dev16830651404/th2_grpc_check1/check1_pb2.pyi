...
class MultiRulesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["default_chain", b"default_chain", "default_parent_event_id", b"default_parent_event_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["default_chain", b"default_chain", "default_parent_event_id", b"default_parent_event_id", "rules", b"rules"]) -> None: ...
