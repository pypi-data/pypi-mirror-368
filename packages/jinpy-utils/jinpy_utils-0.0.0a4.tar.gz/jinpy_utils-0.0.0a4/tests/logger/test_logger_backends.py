...
from jpy_utils.base.exceptions import (
    ExceptionRegistry,
    JPYBaseException,
    JPYConnectionError,
)
from jpy_utils.logger import config as logger_config
from jpy_utils.logger import exceptions as logger_exceptions
from jpy_utils.logger.backends import (
    BackendFactory,
    BackendInterface,
    BaseBackend,
    ConsoleBackend,
...
from jpy_utils.logger.enums import (
    BackendType,
    CompressionType,
    ConnectionState,
    LogFormat,
...
from jpy_utils.logger.exceptions import (
...
class TestLogEntry:
    ...
    def test_log_entry_basic_creation(self, current_datetime: datetime) -> None:
        ...
        with patch(
            "jpy_utils.logger.backends.get_current_datetime",
...
class TestBackendIntegration:
    ...
    async def test_all_backends_inheritance(self) -> None:
        ...
        from jpy_utils.logger.backends import ConsoleBackend, FileBackend
