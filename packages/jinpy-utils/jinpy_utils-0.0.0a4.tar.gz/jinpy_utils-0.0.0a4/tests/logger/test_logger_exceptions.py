...
from jpy_utils.base.exceptions import JPYLoggingError
...
class TestLoggerExceptionsIntegration:
    ...
    def test_all_handler_types_formatting(self) -> None:
        ...
        details = JPYLoggerBackendError("test", backend_type="mysql").error_details.details
        assert details is not None
        ...
        details = JPYLoggerConnectionError("test", connection_type="HTTP").error_details.details
        assert details is not None
