...
from jpy_utils.logger.enums import ConnectionState, LogFormat, LogLevel
...
from jpy_utils.utils.timing import get_current_datetime
...
class RestApiBackend(BaseBackend):
    ...
    async def _send_batch(self, entries: list[LogEntry]) -> None:
        ...
        try:
            ...
            request_ctx_cm = await request_ctx_any if inspect.isawaitable(request_ctx_any) else request_ctx_any
    ...
    async def _connect(self) -> None:
        ...
        try:
            ...
            if inspect.isawaitable(ws_connect_result):
                ...
                self._websocket = ws_connect_result  # type: ignore[assignment]
