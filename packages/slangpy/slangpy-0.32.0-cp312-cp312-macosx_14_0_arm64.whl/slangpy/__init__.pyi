...
SGL_VERSION_MINOR: int = 32

SGL_VERSION_PATCH: int = 0

SGL_VERSION: str = '0.32.0'

SGL_GIT_VERSION: str = 'commit: 75a72fe / branch: unknown'
...
class Surface(Object):
    ...
    @overload
    def configure(self, width: int, height: int, format: Format = Format.undefined, usage: TextureUsage = 0, desired_image_count: int = 3, vsync: bool = True) -> None:
...
class Device(Object):
    ...
    @overload
    def create_buffer(self, size: int = 0, element_count: int = 0, struct_size: int = 0, resource_type_layout: object | None = None, format: Format = Format.undefined, memory_type: MemoryType = MemoryType.device_local, usage: BufferUsage = 0, default_state: ResourceState = ResourceState.undefined, label: str = '', data: ArrayLike | None = None) -> Buffer:
        """
        Create a new buffer.
