...
# def parse_json_markdown(text: str) -> Dict[str, Any]:
#     """
#     Parses a JSON object from a string, tolerating markdown code fences.

#     Args:
#         text: The raw string output from an LLM.

#     Returns:
#         A Python dictionary parsed from the JSON object.
...
#         return json.loads(json_str)
#     except json.JSONDecodeError as e:
#         raise ValueError(f"Failed to decode JSON. Raw text: {json_str}") from e