...
class LoaderUpgradeable:
    ...
    def write(cls, offset: int, data: bytearray) -> bytearray:
        ...
        return pxsol.bincode.Enum.encode(1) + pxsol.bincode.Struct([
            pxsol.bincode.U32,
            pxsol.bincode.ListVariable(pxsol.bincode.U8),
        ]).encode([offset, data])
...
class System:
    ...
    def create_account(cls, lamports: int, size: int, host: pxsol.core.PubKey) -> bytearray:
        ...
        return pxsol.bincode.Enum.encode(0x00) + pxsol.bincode.Struct([
            pxsol.bincode.U64,
            pxsol.bincode.U64,
            pxsol.bincode.ListConstant(pxsol.bincode.U8, 32),
    ...
    def assign(cls, host: pxsol.core.PubKey) -> bytearray:
        ...
        return pxsol.bincode.Enum.encode(0x01) + pxsol.bincode.ListConstant(pxsol.bincode.U8, 32).encode(host.p)
    ...
    def initialize_nonce_account(cls, host: pxsol.core.PubKey) -> bytearray:
        ...
        # 1. -r recent blockhashes sysvar.
        # 2. -r rent sysvar.
        return pxsol.bincode.Enum.encode(0x06) + pxsol.bincode.ListConstant(pxsol.bincode.U8, 32).encode(host.p)
    ...
    def authorize_nonce_account(cls, host: pxsol.core.PubKey) -> bytearray:
        ...
        return pxsol.bincode.Enum.encode(0x07) + pxsol.bincode.ListConstant(pxsol.bincode.U8, 32).encode(host.p)
...
class Token:
    ...
    def initialize_mint(cls, decimals: int, auth_mint: pxsol.core.PubKey, auth_freeze: pxsol.core.PubKey) -> bytearray:
        ...
        return pxsol.borsh.Enum.encode(0x00) + pxsol.borsh.Struct([
            pxsol.borsh.U8,
            pxsol.borsh.ListConstant(pxsol.borsh.U8, 32),
            pxsol.borsh.Option(pxsol.borsh.ListConstant(pxsol.borsh.U8, 32)),
    ...
    def initialize_account2(cls, host: pxsol.core.PubKey) -> bytearray:
        ...
        # 1. -r the mint this account will be associated with.
        # 2. -r rent sysvar
        return pxsol.borsh.Enum.encode(0x10) + pxsol.borsh.ListConstant(pxsol.borsh.U8, 32).encode(host.p)
    ...
    def initialize_account3(cls, host: pxsol.core.PubKey) -> bytearray:
        ...
        # 0. -w the account to initialize.
        # 1. -r the mint this account will be associated with.
        return pxsol.borsh.Enum.encode(0x12) + pxsol.borsh.ListConstant(pxsol.borsh.U8, 32).encode(host.p)
    ...
    def get_account_data_size(cls, extension_type: typing.List[int]) -> bytearray:
        ...
        return pxsol.borsh.Enum.encode(0x15) + pxsol.borsh.ListVariable(pxsol.borsh.U16).encode(extension_type)
    ...
    def metadata_initialize(cls, name: str, symbol: str, uri: str) -> bytearray:
        ...
        return pxsol.borsh.Struct([
            pxsol.borsh.ListConstant(pxsol.borsh.U8, 8),
            pxsol.borsh.String,
            pxsol.borsh.String,
            pxsol.borsh.String,
