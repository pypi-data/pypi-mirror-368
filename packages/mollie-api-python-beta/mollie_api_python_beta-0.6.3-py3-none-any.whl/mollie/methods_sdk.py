...
class MethodsSDK(BaseSDK):
    def list(
        ...
        *,
        ...
        include: OptionalNullable[models.ListMethodsInclude] = UNSET,
        ...
        **not** paginated — unlike most other list endpoints in our API.
        ...
        request = models.ListMethodsRequest(
            ...
            locale=locale,
            amount=utils.get_pydantic_model(amount, Optional[models.ListMethodsAmount]),
            resource=resource,
        ...
        if utils.match_response(http_res, "400", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.ListMethodsHalJSONErrorData, http_res
            )
            raise models.ListMethodsHalJSONError(response_data, http_res)
    ...
    def all(
        self,
        *,
        locale: Optional[models.ListAllMethodsLocale] = None,
        amount: Optional[
        ...
        request = models.ListAllMethodsRequest(
            ...
            amount=utils.get_pydantic_model(
                amount, Optional[models.ListAllMethodsAmount]
            ),
            include=include,
            sequence_type=sequence_type,
            profile_id=profile_id,
        ...
        if utils.match_response(http_res, "400", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.ListAllMethodsHalJSONErrorData, http_res
            )
            raise models.ListAllMethodsHalJSONError(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    def get(
        ...
        *,
        id: str,
        locale: Optional[models.GetMethodLocale] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/hal+json"):
            return unmarshal_json_response(models.GetMethodResponse, http_res)
        if utils.match_response(http_res, "400", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.GetMethodBadRequestHalJSONErrorData, http_res
            )
            raise models.GetMethodBadRequestHalJSONError(response_data, http_res)
        if utils.match_response(http_res, "404", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.GetMethodNotFoundHalJSONErrorData, http_res
            )
            raise models.GetMethodNotFoundHalJSONError(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
