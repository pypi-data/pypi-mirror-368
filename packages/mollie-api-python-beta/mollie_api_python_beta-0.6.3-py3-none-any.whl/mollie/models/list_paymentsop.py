...
class ListPaymentsLine(BaseModel):
    ...
    type: Optional[ListPaymentsLineType] = ListPaymentsLineType.PHYSICAL
    r"""The type of product purchased. For example, a physical or a digital product.
...
class ListPaymentsPaymentOutputTypedDict(TypedDict):
    ...
    parameter.
    """
    sequence_type: NotRequired[Nullable[ListPaymentsSequenceType]]
    r"""**Only relevant for recurring payments.**
...
class ListPaymentsPaymentOutput(BaseModel):
    ...
    sequence_type: Annotated[
        OptionalNullable[ListPaymentsSequenceType], pydantic.Field(alias="sequenceType")
    ] = ListPaymentsSequenceType.ONEOFF
    r"""**Only relevant for recurring payments.**
