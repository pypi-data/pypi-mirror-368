            ...
            if re.search(pattern, text):
                try:
                    ...
                    if func_name == 'play_youtube_song':
                        ...
                        # Extract city from weather commands
                        # Patterns: "weather in [city]", "weather for [city]", "weather [city]", "[city] weather"
                        weather_patterns = [
                            r'weather\s+(?:in|for|of|at)\s+([a-zA-Z\s]+)',     # "weather in/for/of/at [city]"
                            r'(?:in|for|of|at)\s+([a-zA-Z\s]+)\s+weather',     # "in/for/of/at [city] weather"
                            r'weather\s+([a-zA-Z\s]+)',                        # "weather [city]"
                            r'([a-zA-Z\s]+)\s+weather',                        # "[city] weather"
                        ]
                        ...
                        if city:
                            ...
                            return self.call(func_name, city)
                        else:
                            # Default city if none specified
                            return self.call(func_name, "New York")
