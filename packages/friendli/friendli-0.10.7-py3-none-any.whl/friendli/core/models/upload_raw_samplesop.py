...
from .body_upload_raw_samples import BodyUploadRawSamples, BodyUploadRawSamplesTypedDict


class UploadRawSamplesRequestTypedDict(TypedDict):
    dataset_id: str
    "ID of the dataset."
    split_id: str
    "ID of the split."
    body_upload_raw_samples: BodyUploadRawSamplesTypedDict
    x_friendli_team: NotRequired[Nullable[str]]
    "ID of team to run requests as (optional parameter)."


class UploadRawSamplesRequest(BaseModel):
    ...
    "ID of the split."
    body_upload_raw_samples: Annotated[
