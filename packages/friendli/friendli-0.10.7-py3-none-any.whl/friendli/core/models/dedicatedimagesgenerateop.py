...
class DedicatedImagesGenerateRequestTypedDict(TypedDict):
    dedicated_image_generation_body: DedicatedImageGenerationBodyTypedDict
    x_friendli_team: NotRequired[Nullable[str]]
    "ID of team to run requests as (optional parameter)."


class DedicatedImagesGenerateRequest(BaseModel):
    dedicated_image_generation_body: Annotated[
        DedicatedImageGenerationBody,
