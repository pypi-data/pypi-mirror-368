...
class DedicatedEndpointWandbArtifactCreateRequestTypedDict(TypedDict):
    dedicated_endpoint_wandb_artifact_create_body: (
        DedicatedEndpointWandbArtifactCreateBodyTypedDict
    )
...
class DedicatedEndpointWandbArtifactCreateRequest(BaseModel):
    dedicated_endpoint_wandb_artifact_create_body: Annotated[
        DedicatedEndpointWandbArtifactCreateBody,
