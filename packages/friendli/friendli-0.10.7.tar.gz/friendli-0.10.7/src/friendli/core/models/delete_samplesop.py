...
RequestBodyTypedDict = TypeAliasType("RequestBodyTypedDict", Union[str, int])
RequestBody = TypeAliasType("RequestBody", Union[str, int])


class DeleteSamplesRequestTypedDict(TypedDict):
    dataset_id: str
    "ID of the dataset."
    split_id: str
    "ID of the split."
