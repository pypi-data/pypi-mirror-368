...
class BaseContainerCompletions(BaseSDK):
    pass


class SyncContainerCompletions(BaseContainerCompletions, SyncSDK):
    def complete(
        self,
        *,
        request: Union[
...
class AsyncContainerCompletions(BaseContainerCompletions, AsyncSDK):
    async def complete(
        self,
        *,
        request: Union[
