...
class Canvas:
    ...
    def empty_frame(
        ...
        """
        Get an empty frame, which is a frame of
        the instance's 'color' parameter.
        """
        return Canvas.get(self.color, self.size)
    ...
    def fit_image_at(
        ...
        # TODO: What if the image is bigger than the canvas (?)
    ...
    def default(
        ...
        """
        # TODO: Validate size
        return Canvas.get(Colors.BLACK.for_opencv, size)