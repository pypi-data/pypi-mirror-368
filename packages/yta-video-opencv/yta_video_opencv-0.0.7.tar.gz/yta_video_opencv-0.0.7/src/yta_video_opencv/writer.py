...
class OpencvWriter:
    ...
    def auto_detected(
        ...
        'output_filename' provided includes an
        extension that cannot be handled by our
        library.
        """
        ...
        writer = {
            ...
            # TODO: Add more options, of course
        }.get(extension, None)

        if writer is None:
            raise Exception('The provided "{extension}" cannot be handled by this library.')
