...
:mod:`cubicweb_web.views.massmailing`.
...
* a subject field, limited to 256 characters (hence we know a
  :class:`~cubicweb_web.formwidgets.TextInput` will be used, as explained in
  :class:`~cubicweb_web.formfields.StringField`)
...
:class:`cubicweb_web.formwidgets.ImgButton`.
