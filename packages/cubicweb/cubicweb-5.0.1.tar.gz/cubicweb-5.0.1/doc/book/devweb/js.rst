...
:class:`cubicweb_web.views.ajaxcontroller.AjaxFunction` object. The
simplest way to do that is to use the
:func:`cubicweb_web.views.ajaxcontroller.ajaxfunc` decorator (for more
...
:func:`cubicweb_web.views.ajaxcontroller.component` *AjaxFunction* appobject.
...
* `url` (mandatory) should be a complete url (typically referencing
  the :class:`cubicweb_web.views.ajaxcontroller.AjaxController`,
