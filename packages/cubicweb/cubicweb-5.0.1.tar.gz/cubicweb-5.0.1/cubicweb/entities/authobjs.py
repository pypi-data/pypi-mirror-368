...
class CWGroup(AnyEntity):
    ...
    def num_users(self):
        ...
        return self._cw.execute(
            "Any COUNT(U) WHERE U in_group G, G eid %(g)s", {"g": self.eid}
        )[0][0]
...
class CWUser(AnyEntity):
    ...
    def matching_groups(self, groups):
        ...
        return len(
            groups & self.groups
        )  # XXX return the resulting set instead of its size
