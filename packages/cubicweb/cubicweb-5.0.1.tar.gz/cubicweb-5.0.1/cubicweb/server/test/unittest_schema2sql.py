...
schema = SchemaLoader().load(
    [
        ("cubicweb", "cubicweb.server.test.data-schema2sql.schema.schema"),
        ("cubicweb", "cubicweb.server.test.data-schema2sql.schema.State"),
        ("cubicweb", "cubicweb.server.test.data-schema2sql.schema.Dates"),
        ("cubicweb", "cubicweb.server.test.data-schema2sql.schema.Company"),
    ]
)
