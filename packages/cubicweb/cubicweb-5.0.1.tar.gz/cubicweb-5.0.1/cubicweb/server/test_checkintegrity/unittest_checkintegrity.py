...
import cubicweb.devtools.apptest_config
import cubicweb.devtools.testlib
from cubicweb.devtools import get_test_db_handler, startpgcluster, stoppgcluster
...
class PGCheckIndexesTC(SqliteCheckIndexesTC):
    configcls = cubicweb.devtools.apptest_config.PostgresApptestConfiguration
