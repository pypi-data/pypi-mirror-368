...
def add_env_to_suffix(name: Optional[str]) -> Optional[str]:
    ...
    # These are the table names that we want to add the environment name to.
    match name:
        case "test_county_view"| "test_county_table"| "profile_table" | "contact_table" | "user_table" | "profile_view" | "contact_view" | "user_view":
