...
from vihi_nova_act.impl.backend import Backend, get_urls_for_backend
from vihi_nova_act.impl.common import get_default_extension_path, rsync
from vihi_nova_act.impl.custom_actuation.custom_dispatcher import CustomActDispatcher
...
from vihi_nova_act.impl.custom_actuation.playwright.default_nova_local_browser_actuator import (
    DefaultNovaLocalBrowserActuator,
)

from vihi_nova_act.impl.dispatcher import ActDispatcher
from vihi_nova_act.impl.extension import ExtensionActuator, ExtensionDispatcher
from vihi_nova_act.impl.inputs import (
...
from vihi_nova_act.impl.run_info_compiler import RunInfoCompiler
from vihi_nova_act.impl.telemetry import send_act_telemetry, send_environment_telemetry
from vihi_nova_act.types.act_errors import ActError
from vihi_nova_act.types.act_result import ActResult
from vihi_nova_act.types.errors import AuthError, ClientNotStarted, IAMAuthError, StartFailed, StopFailed, ValidationFailed
from vihi_nova_act.types.features import PreviewFeatures
from vihi_nova_act.types.hooks import StopHook
from vihi_nova_act.types.state.act import Act
from vihi_nova_act.util.jsonschema import add_schema_to_prompt, populate_json_schema_response, validate_jsonschema_schema
from vihi_nova_act.util.logging import get_session_id_prefix, make_trace_logger, set_logging_session, setup_logging
        ...
        *,
        ...
        try:
            if self._stream:
                ...
                gen = self.dispatcher.dispatch_and_wait_for_prompt_completion(act)
                
                try: 
                    while True:
                        line = next(gen)
                        # _LOGGER.info(f"streaming: {line}")
                        yield line
