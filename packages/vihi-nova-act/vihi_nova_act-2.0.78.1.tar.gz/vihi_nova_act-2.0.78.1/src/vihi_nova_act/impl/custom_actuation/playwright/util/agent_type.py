...
from vihi_nova_act.impl.custom_actuation.interface.types.element_dict import ElementDict
from vihi_nova_act.impl.custom_actuation.playwright.dom_actuation.type_events import get_after_type_events
...
from vihi_nova_act.impl.custom_actuation.playwright.util.element_helpers import (
    blur,
...
def agent_type(
    ...
    # type the value
    delay = 0 if len(value) > 10 else 100
