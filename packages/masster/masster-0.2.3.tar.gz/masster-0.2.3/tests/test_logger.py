...
class TestLogger:
    ...
    def test_logger_output_capture(self):
        ...
        try:
            ...
            logger = get_logger("test_capture", sink=log_capture_string)
    ...
    def test_logger_file_output(self):
        ...
        try:
            ...
            try:
                ...
                logger = get_logger("test_file", sink=temp_file)
    ...
    def test_logger_formatting(self):
        ...
        try:
            ...
            logger = get_logger("test_format", sink=log_capture)
    ...
    def test_logger_configuration(self):
        ...
        try:
            from masster.logger import configure_logger
            ...
            logger = configure_logger("test_config", **config)
            assert logger is not None
