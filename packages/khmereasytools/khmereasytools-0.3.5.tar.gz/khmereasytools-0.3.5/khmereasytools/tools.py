...
try:
    ...
    KHMERCUT_AVAILABLE = True
except ImportError:
    KHMERCUT_AVAILABLE = False
...
def khfilter(text, stop_words=None):
    if not KHMERCUT_AVAILABLE:
        raise ImportError("khmercut is not installed. Please install it with: pip install khmereasytools[khmercut]")
