...
# def merge_tool_input_schema(tool: Tool):
...
#             para_desc = para_descs[para_name]['description']
...
def main(host: str, port: int):
    ...
    asyncio.run(run_sse(mcp_box_url))
