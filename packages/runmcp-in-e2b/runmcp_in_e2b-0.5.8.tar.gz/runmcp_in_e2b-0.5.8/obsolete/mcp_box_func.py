...
def run_mcp_box(name:str, host:str, port:int) :
    ...
    async def parse_code(request: Request)-> str:
        ...
        try:
            ...
            print(f'# parse_code error: {raw_code} \n{e}')
        return code
    ...
    #load_code_from_db()
    start()
    return handle_add_mcp_tool, handle_remove_mcp_tool
...
def main(host: str, port: int):
    handle_add_mcp_tool, handle_remove_mcp_tool  = run_mcp_box(name="Dynamic MCP Box Server", host=host, port=port)
