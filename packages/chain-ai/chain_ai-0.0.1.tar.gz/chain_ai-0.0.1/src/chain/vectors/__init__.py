...
"""
from chain.vectors.base import BaseVectorStore
...
try:
    from chain.vectors.faiss import FAISSVectorStore # type: ignore
...
try:
    ...
    class AzureAISearchVectorStore:
         def __init__(self, *args, **kwargs):
            raise ImportError(
                "Azure Search dependencies not found. Please run `pip install chain-ai[azure]` "
