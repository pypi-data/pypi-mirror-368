...
class WebhookProcessor:
    ...
    def _validate_webhook(self, payload: bytes, signature: str) -> dict[str, Any]:
        ...
        try:
            return stripe.Webhook.construct_event(payload, signature, self.webhook_secret)  # type: ignore[no-any-return,no-untyped-call]
    ...
    def _handle_invoice_created(self, event: dict[str, Any]) -> dict[str, Any]:
    ...
    def _handle_invoice_finalized(self, event: dict[str, Any]) -> dict[str, Any]:
    ...
    def _handle_invoice_voided(self, event: dict[str, Any]) -> dict[str, Any]:
    ...
    def _handle_payment_intent_succeeded(self, event: dict[str, Any]) -> dict[str, Any]:
    ...
    def _handle_payment_intent_failed(self, event: dict[str, Any]) -> dict[str, Any]:
        ...
        return {"payment_intent_id": intent_id, "error": error_message, "status": "failed"}

    def _get_customer_id_from_metadata(self, stripe_object: dict[str, Any]) -> Optional[str]:
    ...
    def _update_invoice_status(
        ...
        if invoice:
            ...
            if amount_paid is not None:
                ...
                expr_values[":amount_paid"] = amount_paid  # type: ignore[assignment]
            ...
            try:
                self.db_client.update_item(
                    ...
                    sk="METADATA",
                    update_expression=update_expr.replace("#status", "status"),
