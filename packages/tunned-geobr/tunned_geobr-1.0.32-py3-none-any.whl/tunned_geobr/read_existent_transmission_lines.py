...
def read_existent_transmission_lines(simplified=False, verbose=False):
    """Download data of existing transmission lines in Brazil.

    This function downloads and returns data of existing transmission lines
    ...
    -------
    gpd.GeoDataFrame
        A GeoDataFrame containing data on existing transmission lines in Brazil.
    ...
    Example
    -------
    >>> from tunned_geobr import read_existent_transmission_lines
    >>> 
    >>> # Read the data
    >>> transmission_lines = read_existent_transmission_lines()
    >>> 
    >>> # Plot the data
    ...
    if verbose:
        print("Downloading data of existing transmission lines in Brazil")
    
    # Define the URL for the API request
    url = "https://gisepeprd2.epe.gov.br/arcgis/rest/services/Download_Dados_Webmap_EPE/GPServer/Extract%20Data%20Task/execute?f=json&env%3AoutSR=102100&Layers_to_Clip=%5B%22Linhas%20de%20Transmiss%C3%A3o%20-%20Base%20Existente%22%5D&Area_of_Interest=%7B%22geometryType%22%3A%22esriGeometryPolygon%22%2C%22features%22%3A%5B%7B%22geometry%22%3A%7B%22rings%22%3A%5B%5B%5B-8655251.47456396%2C-4787514.465591563%5D%2C%5B-8655251.47456396%2C1229608.401015912%5D%2C%5B-3508899.2341809804%2C1229608.401015912%5D%2C%5B-3508899.2341809804%2C-4787514.465591563%5D%2C%5B-8655251.47456396%2C-4787514.465591563%5D%5D%5D%2C%22spatialReference%22%3A%7B%22wkid%22%3A102100%7D%7D%7D%5D%2C%22sr%22%3A%7B%22wkid%22%3A102100%7D%7D&Feature_Format=Shapefile%20-%20SHP%20-%20.shp&Raster_Format=Tagged%20Image%20File%20Format%20-%20TIFF%20-%20.tif"
