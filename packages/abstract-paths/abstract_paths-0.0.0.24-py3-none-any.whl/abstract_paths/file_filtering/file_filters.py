...
def get_default_handlers(
    ...
    dirs_to_skip = get_default_modular(extra_dirs,default=DEFAULT_EXCLUDE_DIRS,add=add,typ=list),
    patterns_to_skip = get_default_modular(extra_patterns,default=DEFAULT_EXCLUDE_PATTERNS,add=add,typ=list)
    return allowed_exts,unallowed_exts,exclude_types,dirs_to_skip,patterns_to_skip
...
def make_allowed_predicate(
    *,
    ...
    allowed_exts,unallowed_exts,exclude_types,dirs_to_skip,patterns_to_skip = get_default_handlers(allowed_exts,unallowed_exts,exclude_types,dirs_to_skip,patterns_to_skip)
