...
class Run(MutableObject):
    ...
    def add_metrics_table(self, metrics_table: Table | Url) -> None:
        ...
        """
    def add_metrics(self, metrics: dict[str, MetricData], column_schemas: dict[str, Schema] | None = None, foreign_table_url: Url | str | None = None, foreign_table_display_name: str = '') -> list[MetricTableInfo]:
