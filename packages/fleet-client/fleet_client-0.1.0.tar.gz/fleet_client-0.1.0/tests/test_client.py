...
class TestFleet:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Fleet(base_url=base_url, api_key=api_key, _strict_response_validation=False)
...
class TestAsyncFleet:
    ...
    def test_base_url_trailing_slash(self, client: AsyncFleet) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncFleet) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncFleet) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncFleet(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_get_platform(self) -> None:
        ...
        from fleet._base_client import get_platform
