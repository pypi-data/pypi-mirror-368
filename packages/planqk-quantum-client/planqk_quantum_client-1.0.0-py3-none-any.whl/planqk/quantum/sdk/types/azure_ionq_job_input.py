...
from .azure_ionq_job_input_circuits_item import AzureIonqJobInputCircuitsItem


class AzureIonqJobInput(UniversalBaseModel):
    """
    Azure IonQ input schema for job input (based on IonQ API Qis v0.4 multi-circuit reference)
    """

    circuits: typing.List[AzureIonqJobInputCircuitsItem] = pydantic.Field()
    """
