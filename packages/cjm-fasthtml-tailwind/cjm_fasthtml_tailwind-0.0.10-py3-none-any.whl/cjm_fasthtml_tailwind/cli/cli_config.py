...
# %% auto 0
__all__ = ['LibraryConfig', 'get_tailwind_config', 'get_daisyui_config', 'set_active_config', 'get_active_config', 'reset_config',
           'get_config_by_name', 'list_available_configs', 'get_config_info']
