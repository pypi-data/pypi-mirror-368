...
# %% auto 0
__all__ = ['FORCED_COLOR_ADJUST_VALUES', 'forced_color_adjust', 'sr_only', 'not_sr_only',
           'test_accessibility_forced_color_adjust_examples', 'test_accessibility_screen_reader_examples',
           'test_accessibility_fasthtml_examples', 'test_accessibility_factory_documentation', 'visually_hidden',
           'high_contrast_safe', 'test_accessibility_helper_examples']
