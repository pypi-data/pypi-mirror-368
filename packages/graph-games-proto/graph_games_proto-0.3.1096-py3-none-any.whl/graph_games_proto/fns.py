...
def is_move_pieces_to_path_action_legal(game, action):
    ...
    print("******************************1234 is_move_pieces_to_path_action_legal 1.5: ", proposed_cards_uuids, path_idx, [card.__todict__() for card in proposed_cards], [piece.__todict__() for piece in proposed_pieces], [segment.__todict__() for segment in remaining_segments])
    ...
    print("******************************1234 is_move_pieces_to_path_action_legal 2", card_fulfillment, piece_fulfillment)
