...
def score_public_items(game, player_idx):
    ...
    items = []
    print("******************************12356 len(game.edges): ", len(game.edges))
    for edge_idx, edge in enumerate(game.edges):
        print(f"******************************12356 edge [{edge_idx}]: ", edge)
        for path in edge.paths:
            print("******************************12356 path: ", path)
            for segment in path.segments:
                print("******************************12356 segment.pieces: ", segment.pieces)
    ...
    print("******************************12356 score_public_items: ", items)
