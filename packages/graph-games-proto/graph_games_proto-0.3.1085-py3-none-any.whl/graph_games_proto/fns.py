...
def is_move_pieces_to_path_action_legal(game, action):
    ...
    fulfillment = []
    remaining_cards = [card for card in game.players[player_idx].cards if card.uuid in proposed_cards_uuids]
    remaining_segments = path.path.segments
    sample = get_sample_path_fulfillment_from_resources(
        game,
        fulfillment, 
        remaining_cards, 
        remaining_segments,
...
def get_sample_path_fulfillment(game, player_idx, path_idx):
    ...
    remaining_segments = path.path.segments
    return get_sample_path_fulfillment_from_resources(
        game,
        fulfillment, 
        remaining_cards, 
        remaining_segments,
...
def get_sample_path_fulfillment_from_resources(game, fulfillment, remaining_cards, remaining_segments):
