...
# Singleton empty class
class ActionFaceupDraw(PClass):
...
class LegalActionFaceupDraw(PClass):
    deck_idx = field(type=int)
    spot_idx = field(type=int)
    sample = field(type=ActionFaceupDraw)  # Optional[ClaimPathAction]
    def __todict__(self):
        return {
            "deck_idx": self.deck_idx,
            "spot_idx": self.spot_idx,
    ...
    def __fromdict__(d):
        return LegalActionFaceupDraw(
            deck_idx=d["deck_idx"],
            spot_idx=d["spot_idx"],
            sample=ActionFaceupDraw.__fromdict__(d["sample"]) if d.get("sample") else None
        )
...
class Action2(PClass):
    ...
    faceup_draw = field(type=(ActionFaceupDraw, type(None)), initial=None)  # ActionFaceupDraw
    def __todict__(self):
        return {
    ...
    def __fromdict__(d):
        return Action2(
            ...
            faceup_draw=ActionFaceupDraw.__fromdict__(d["faceup_draw"]) if d.get("faceup_draw") else None
        )
...
HOOK_NAMESPACE = {
    ...
    'ActionFaceupDraw': ActionFaceupDraw,
}
