...
class PlayerGraph(PClass):
    ...
    def __fromdict__(d):
        return PlayerGraph(
            player_idx=d["player_idx"],
            neighbors=d["neighbors"] if d.get("neighbors") is not None else []  # Handle None case
        )
