...
class BiEdge(PClass):
    uuid = field(type=str)
    node_idx_1 = field(type=str)
    node_idx_2 = field(type=str)
    paths = field(type=list)  # List[Path2]
    def __todict__(self):
        return {
            "uuid": self.uuid,
            "node_idx_1": self.node_idx_1,
            "node_idx_2": self.node_idx_2,
    ...
    def __fromdict__(d):
        return BiEdge(
            uuid=d["uuid"],
            node_idx_1=d["node_idx_1"],
            node_idx_2=d["node_idx_2"],
...
def handle_move_pieces_to_path_action(game, action):
    ...
    game = game.set(player_graphs=game.player_graphs) # 
