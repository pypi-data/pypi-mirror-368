...
def score_public_items(game, player_idx):
    ...
    return [ScoreItem2(amount=3, description="Player {} public score".format(player_idx))]


def score_private_items(game, player_idx):
    # Implement scoring logic for private items
    return [ScoreItem2(amount=4, description="Player {} private score".format(player_idx))]
