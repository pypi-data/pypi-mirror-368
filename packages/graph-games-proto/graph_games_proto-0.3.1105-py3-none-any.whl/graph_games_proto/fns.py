...
class ActionClaimPathOptional(PClass):
    ...
    @staticmethod
    def __fromdict__(d):
        return ActionClaimPathOptional(
...
class LegalActionClaimPath(PClass):
    path_idx = field(type=int)
    optional = field(type=ActionClaimPathOptional)  # Optional[ClaimPathAction]
    def __todict__(self):
        return {
            "path_idx": self.path_idx,
    ...
    def __fromdict__(d):
        return LegalActionClaimPath(
            path_idx=d["path_idx"],
            optional=ActionClaimPathOptional.__fromdict__(d["optional"])
        )
...
class Action2(PClass):
    ...
    move_pieces_to_path = field(type=(ActionClaimPathOptional, type(None)), initial=None)  # ActionClaimPath
    ...
    def __fromdict__(d):
        return Action2(
            ...
            move_pieces_to_path=ActionClaimPathOptional.__fromdict__(d["move_pieces_to_path"]) if d.get("move_pieces_to_path") else None,
...
HOOK_NAMESPACE = {
    ...
    'ActionClaimPath': ActionClaimPathOptional,
