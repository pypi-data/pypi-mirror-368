...
def get_goals(s, player_idx):
    ...
    print("s.goals: ", [goal.__todict__() for goal in s.goals])
    goaluuid2goal = {goal.uuid: goal for goal in s.goals}
    print("goaluuid2goal: ", goaluuid2goal)
    goal_uuids = [card.goal_uuid for card in player.cards if card.goal_uuid]
    print("goal_uuids: ", goal_uuids)
    return [
        goaluuid2goal[goal_uuid] for goal_uuid in goal_uuids
    ]
