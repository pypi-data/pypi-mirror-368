...
### Changed
* Update MCP tool descriptions and titles to be more descriptive and user-friendly
* Improve tool registration with detailed descriptions for better user experience
* Update entity creation rules and relationship creation guidelines
