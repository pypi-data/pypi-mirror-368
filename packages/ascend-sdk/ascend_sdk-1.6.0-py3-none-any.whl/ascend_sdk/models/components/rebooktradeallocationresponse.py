...
class RebookTradeAllocationResponseAccruedInterestAmountTypedDict(TypedDict):
...
class RebookTradeAllocationResponseAccruedInterestAmount(BaseModel):
    r"""The amount of interest that has been accrued in the issuing currency for a single instrument."""
...
class RebookTradeAllocationResponseBrokerCapacity(
...
class RebookTradeAllocationResponseCommissionAmountTypedDict(TypedDict):
...
class RebookTradeAllocationResponseCommissionAmount(BaseModel):
    r"""Commission amount of the trade allocation that will only be applied to the to_account_id."""
...
class RebookTradeAllocationResponseGrossAmountTypedDict(TypedDict):
...
class RebookTradeAllocationResponseGrossAmount(BaseModel):
    r"""Gross amount is calculated by the Booking service by multiplying price and quantity and fixing it to 2 fractional precision. Optionally specifiable. If present, will override the gross_amount calculated above."""
...
class RebookTradeAllocationResponseIdentifierType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class RebookTradeAllocationResponsePrevailingMarketPriceTypedDict(TypedDict):
...
class RebookTradeAllocationResponsePrevailingMarketPrice(BaseModel):
    r"""The price for the instrument that is prevailing in the market. Required for FIXED_INCOME trade allocations when the broker_capacity is PRINCIPAL."""
...
class RebookTradeAllocationResponsePriceTypedDict(TypedDict):
...
class RebookTradeAllocationResponsePrice(BaseModel):
    r"""Price with requirement of 8 or less integral number and 8 or less fractional precision."""
...
class RebookTradeAllocationResponsePriceAdjustmentAmountTypedDict(TypedDict):
...
class RebookTradeAllocationResponsePriceAdjustmentAmount(BaseModel):
    r"""Total monetary value of the price_adjustment"""
...
class RebookTradeAllocationResponsePriceAdjustmentType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class RebookTradeAllocationResponsePriceAdjustmentTypedDict(TypedDict):
    r"""Price adjustment that will be applied to the net price of the security."""

    price_adjustment_amount: NotRequired[
        Nullable[RebookTradeAllocationResponsePriceAdjustmentAmountTypedDict]
    ]
    r"""Total monetary value of the price_adjustment"""
    price_adjustment_type: NotRequired[RebookTradeAllocationResponsePriceAdjustmentType]
    r"""The type of price adjustment being applied by the broker to the net price of the security."""


class RebookTradeAllocationResponsePriceAdjustment(BaseModel):
    r"""Price adjustment that will be applied to the net price of the security."""
    ...
    price_adjustment_type: Annotated[
        Optional[RebookTradeAllocationResponsePriceAdjustmentType],
...
class RebookTradeAllocationResponseQuantityTypedDict(TypedDict):
...
class RebookTradeAllocationResponseQuantity(BaseModel):
    r"""Quantity with requirement of 12 or less integral number and 5 or less fractional precision."""
...
class RebookTradeAllocationResponseSettlementDateTypedDict(TypedDict):
...
class RebookTradeAllocationResponseSettlementDate(BaseModel):
    r"""Defaults to T+1 for equities if this is not provided. Calculated using the execution_time field in Eastern Time."""
...
class RebookTradeAllocationResponseSideModifier(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class RebookTradeAllocationResponseSpecialInstructions(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class RebookTradeAllocationResponseState(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RebookTradeAllocationResponseToSide(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RebookTradeAllocationResponseWhenIssued(str, Enum, metaclass=utils.OpenEnumMeta):
...
class NewTradeAllocationTypedDict(TypedDict):
    r"""The new trade allocation that is booked."""

    accrued_interest_amount: NotRequired[
        Nullable[RebookTradeAllocationResponseAccruedInterestAmountTypedDict]
    ]
    r"""The amount of interest that has been accrued in the issuing currency for a single instrument."""
    ...
    commission_amount: NotRequired[
        Nullable[RebookTradeAllocationResponseCommissionAmountTypedDict]
    ]
    r"""Commission amount of the trade allocation that will only be applied to the to_account_id."""
    ...
    gross_amount: NotRequired[
        Nullable[RebookTradeAllocationResponseGrossAmountTypedDict]
    ]
    r"""Gross amount is calculated by the Booking service by multiplying price and quantity and fixing it to 2 fractional precision. Optionally specifiable. If present, will override the gross_amount calculated above."""
    identifier: NotRequired[str]
    r"""Identifier (of the type specified in `identifier_type`). Responses will supply the originally requested identifier."""
    identifier_type: NotRequired[RebookTradeAllocationResponseIdentifierType]
    r"""Identifier type for the asset being traded."""
    ...
    prevailing_market_price: NotRequired[
        Nullable[RebookTradeAllocationResponsePrevailingMarketPriceTypedDict]
    ]
    r"""The price for the instrument that is prevailing in the market. Required for FIXED_INCOME trade allocations when the broker_capacity is PRINCIPAL."""
    price: NotRequired[Nullable[RebookTradeAllocationResponsePriceTypedDict]]
    r"""Price with requirement of 8 or less integral number and 8 or less fractional precision."""
    price_adjustment: NotRequired[
        Nullable[RebookTradeAllocationResponsePriceAdjustmentTypedDict]
    ]
    r"""Price adjustment that will be applied to the net price of the security."""
    quantity: NotRequired[Nullable[RebookTradeAllocationResponseQuantityTypedDict]]
    r"""Quantity with requirement of 12 or less integral number and 5 or less fractional precision."""
    settlement_date: NotRequired[
        Nullable[RebookTradeAllocationResponseSettlementDateTypedDict]
    ]
    r"""Defaults to T+1 for equities if this is not provided. Calculated using the execution_time field in Eastern Time."""
    side_modifier: NotRequired[RebookTradeAllocationResponseSideModifier]
    r"""Side modifier for the trade allocation."""
    source_application: NotRequired[str]
    r"""The source of the submission."""
    special_instructions: NotRequired[
        List[RebookTradeAllocationResponseSpecialInstructions]
    ]
    ...
    state: NotRequired[RebookTradeAllocationResponseState]
    r"""The state that the trade allocation is in."""
    ...
    to_side: NotRequired[RebookTradeAllocationResponseToSide]
    r"""Denotes the side of the position going into the to_account_id. A to_side of SELL indicates the position will be allocated with a BUY out of the from_account, and a SELL into the to_account."""
    trade_allocation_id: NotRequired[str]
    r"""A ULID to uniquely identify the trade allocation globally."""
    when_issued: NotRequired[RebookTradeAllocationResponseWhenIssued]
    r"""Denotes that this trade allocation was either when_issued or when_distributed."""


class NewTradeAllocation(BaseModel):
    r"""The new trade allocation that is booked."""
    ...
    broker_capacity: Annotated[
        Optional[RebookTradeAllocationResponseBrokerCapacity],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Broker capacity for the trade."""
    ...
    gross_amount: OptionalNullable[RebookTradeAllocationResponseGrossAmount] = UNSET
    r"""Gross amount is calculated by the Booking service by multiplying price and quantity and fixing it to 2 fractional precision. Optionally specifiable. If present, will override the gross_amount calculated above."""
    ...
    identifier_type: Annotated[
        Optional[RebookTradeAllocationResponseIdentifierType],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Identifier type for the asset being traded."""
    ...
    side_modifier: Annotated[
        Optional[RebookTradeAllocationResponseSideModifier],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Side modifier for the trade allocation."""
    ...
    state: Annotated[
        Optional[RebookTradeAllocationResponseState],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""The state that the trade allocation is in."""
    ...
    to_side: Annotated[
        Optional[RebookTradeAllocationResponseToSide],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Denotes the side of the position going into the to_account_id. A to_side of SELL indicates the position will be allocated with a BUY out of the from_account, and a SELL into the to_account."""
    ...
    when_issued: Annotated[
        Optional[RebookTradeAllocationResponseWhenIssued],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Denotes that this trade allocation was either when_issued or when_distributed."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationAccruedInterestAmountTypedDict(
    TypedDict
):
    r"""The amount of interest that has been accrued in the issuing currency for a single instrument."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationAccruedInterestAmount(
    BaseModel
):
    r"""The amount of interest that has been accrued in the issuing currency for a single instrument."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationBrokerCapacity(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Broker capacity for the trade."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationCommissionAmountTypedDict(
    TypedDict
):
    r"""Commission amount of the trade allocation that will only be applied to the to_account_id."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationCommissionAmount(BaseModel):
    r"""Commission amount of the trade allocation that will only be applied to the to_account_id."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationGrossAmountTypedDict(
    TypedDict
):
    r"""Gross amount is calculated by the Booking service by multiplying price and quantity and fixing it to 2 fractional precision. Optionally specifiable. If present, will override the gross_amount calculated above."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationGrossAmount(BaseModel):
    r"""Gross amount is calculated by the Booking service by multiplying price and quantity and fixing it to 2 fractional precision. Optionally specifiable. If present, will override the gross_amount calculated above."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationIdentifierType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Identifier type for the asset being traded."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationPrevailingMarketPriceTypedDict(
    TypedDict
):
    r"""The price for the instrument that is prevailing in the market. Required for FIXED_INCOME trade allocations when the broker_capacity is PRINCIPAL."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationPrevailingMarketPrice(
    BaseModel
):
    r"""The price for the instrument that is prevailing in the market. Required for FIXED_INCOME trade allocations when the broker_capacity is PRINCIPAL."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationPriceTypedDict(TypedDict):
    r"""Price with requirement of 8 or less integral number and 8 or less fractional precision."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationPrice(BaseModel):
    r"""Price with requirement of 8 or less integral number and 8 or less fractional precision."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationPriceAdjustmentAmountTypedDict(
    TypedDict
):
    r"""Total monetary value of the price_adjustment"""
...
class RebookTradeAllocationResponseOriginalTradeAllocationPriceAdjustmentAmount(
    BaseModel
):
    r"""Total monetary value of the price_adjustment"""
...
class RebookTradeAllocationResponseOriginalTradeAllocationPriceAdjustmentType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""The type of price adjustment being applied by the broker to the net price of the security."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationPriceAdjustmentTypedDict(
    TypedDict
):
    r"""Price adjustment that will be applied to the net price of the security."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationPriceAdjustment(BaseModel):
    r"""Price adjustment that will be applied to the net price of the security."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationQuantityTypedDict(TypedDict):
    r"""Quantity with requirement of 12 or less integral number and 5 or less fractional precision."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationQuantity(BaseModel):
    r"""Quantity with requirement of 12 or less integral number and 5 or less fractional precision."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationSettlementDateTypedDict(
    TypedDict
):
    r"""Defaults to T+1 for equities if this is not provided. Calculated using the execution_time field in Eastern Time."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationSettlementDate(BaseModel):
    r"""Defaults to T+1 for equities if this is not provided. Calculated using the execution_time field in Eastern Time."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationSideModifier(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Side modifier for the trade allocation."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationSpecialInstructions(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    SPECIAL_INSTRUCTIONS_UNSPECIFIED = "SPECIAL_INSTRUCTIONS_UNSPECIFIED"
    RULE_144 = "RULE_144"
...
class RebookTradeAllocationResponseOriginalTradeAllocationState(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""The state that the trade allocation is in."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationToSide(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Denotes the side of the position going into the to_account_id. A to_side of SELL indicates the position will be allocated with a BUY out of the from_account, and a SELL into the to_account."""
...
class RebookTradeAllocationResponseOriginalTradeAllocationWhenIssued(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Denotes that this trade allocation was either when_issued or when_distributed."""
...
class OriginalTradeAllocationTypedDict(TypedDict):
    r"""The original trade allocation that was rebooked."""
    ...
    r"""The price for the instrument that is prevailing in the market. Required for FIXED_INCOME trade allocations when the broker_capacity is PRINCIPAL."""
    price: NotRequired[
        Nullable[RebookTradeAllocationResponseOriginalTradeAllocationPriceTypedDict]
    ]
    r"""Price with requirement of 8 or less integral number and 8 or less fractional precision."""
    price_adjustment: NotRequired[
        Nullable[
    ...
    quantity: NotRequired[
        Nullable[RebookTradeAllocationResponseOriginalTradeAllocationQuantityTypedDict]
    ]
    r"""Quantity with requirement of 12 or less integral number and 5 or less fractional precision."""
    settlement_date: NotRequired[
        Nullable[
    ...
    r"""An enumerated list of values used to indicate certain attributes about a trade allocation (E.g. BROKER_LIQUIDATION) and/or trigger downstream processing rules (e.g. SUPPRESS_TRACE_REPORTING)"""
    state: NotRequired[RebookTradeAllocationResponseOriginalTradeAllocationState]
    r"""The state that the trade allocation is in."""
    to_account_id: NotRequired[str]
    r"""The ULID formatted account_id that the positions will be moved to."""
    to_activity_id: NotRequired[str]
    r"""The current activity_id of the trade allocation that positions will be moved to in the Ledger."""
    to_side: NotRequired[RebookTradeAllocationResponseOriginalTradeAllocationToSide]
    r"""Denotes the side of the position going into the to_account_id. A to_side of SELL indicates the position will be allocated with a BUY out of the from_account, and a SELL into the to_account."""
    trade_allocation_id: NotRequired[str]
    r"""A ULID to uniquely identify the trade allocation globally."""
    when_issued: NotRequired[
        RebookTradeAllocationResponseOriginalTradeAllocationWhenIssued
    ]
    r"""Denotes that this trade allocation was either when_issued or when_distributed."""


class OriginalTradeAllocation(BaseModel):
    r"""The original trade allocation that was rebooked."""
    ...
    broker_capacity: Annotated[
        Optional[RebookTradeAllocationResponseOriginalTradeAllocationBrokerCapacity],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Broker capacity for the trade."""
    ...
    identifier_type: Annotated[
        Optional[RebookTradeAllocationResponseOriginalTradeAllocationIdentifierType],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Identifier type for the asset being traded."""
    ...
    side_modifier: Annotated[
        Optional[RebookTradeAllocationResponseOriginalTradeAllocationSideModifier],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Side modifier for the trade allocation."""
    ...
    state: Annotated[
        Optional[RebookTradeAllocationResponseOriginalTradeAllocationState],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""The state that the trade allocation is in."""
    ...
    to_side: Annotated[
        Optional[RebookTradeAllocationResponseOriginalTradeAllocationToSide],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Denotes the side of the position going into the to_account_id. A to_side of SELL indicates the position will be allocated with a BUY out of the from_account, and a SELL into the to_account."""
    ...
    when_issued: Annotated[
        Optional[RebookTradeAllocationResponseOriginalTradeAllocationWhenIssued],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Denotes that this trade allocation was either when_issued or when_distributed."""
...
class RebookTradeAllocationResponseTypedDict(TypedDict):
    r"""Rebooking a trade allocation will always return a new resource that contains the rebooked trade allocation."""

    new_trade_allocation: NotRequired[Nullable[NewTradeAllocationTypedDict]]
    r"""The new trade allocation that is booked."""
    original_trade_allocation: NotRequired[Nullable[OriginalTradeAllocationTypedDict]]
    r"""The original trade allocation that was rebooked."""


class RebookTradeAllocationResponse(BaseModel):
    r"""Rebooking a trade allocation will always return a new resource that contains the rebooked trade allocation."""

    new_trade_allocation: OptionalNullable[NewTradeAllocation] = UNSET
    r"""The new trade allocation that is booked."""

    original_trade_allocation: OptionalNullable[OriginalTradeAllocation] = UNSET
    r"""The original trade allocation that was rebooked."""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["new_trade_allocation", "original_trade_allocation"]
        nullable_fields = ["new_trade_allocation", "original_trade_allocation"]
        null_default_fields = []
