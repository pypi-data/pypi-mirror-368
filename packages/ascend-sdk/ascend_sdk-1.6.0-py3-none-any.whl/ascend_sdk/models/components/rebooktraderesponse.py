...
class RebookTradeResponseIdentifierType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RebookTradeResponseLocalMarketTradeDateTypedDict(TypedDict):
...
class RebookTradeResponseLocalMarketTradeDate(BaseModel):
    r"""Date field to support extended trading hours."""
...
class RebookTradeResponseRouteType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RebookTradeResponseSettlementDateTypedDict(TypedDict):
...
class RebookTradeResponseSettlementDate(BaseModel):
    r"""Defaults to T+1 for equities if this is not provided. Calculated by the execution's execution_time field in Eastern Time."""
...
class RebookTradeResponseSide(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RebookTradeResponseSideModifier(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RebookTradeResponseSpecialInstructions(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RebookTradeResponseVenue(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Exchange venue"""
...
class RebookTradeResponseWhenIssued(str, Enum, metaclass=utils.OpenEnumMeta):
...
class NewTradeTypedDict(TypedDict):
    ...
    identifier_type: NotRequired[RebookTradeResponseIdentifierType]
    r"""Identifier type for the asset being traded."""
    ...
    local_market_trade_date: NotRequired[
        Nullable[RebookTradeResponseLocalMarketTradeDateTypedDict]
    ]
    r"""Date field to support extended trading hours."""
    ...
    route_type: NotRequired[RebookTradeResponseRouteType]
    r"""Route type for the trade."""
    settlement_date: NotRequired[Nullable[RebookTradeResponseSettlementDateTypedDict]]
    r"""Defaults to T+1 for equities if this is not provided. Calculated by the execution's execution_time field in Eastern Time."""
    side: NotRequired[RebookTradeResponseSide]
    r"""Denotes if the trade is a SELL or a BUY."""
    side_modifier: NotRequired[RebookTradeResponseSideModifier]
    r"""Side modifier for the trade."""
    source_application: NotRequired[str]
    r"""The source of the submission."""
    special_instructions: NotRequired[List[RebookTradeResponseSpecialInstructions]]
    ...
    venue: NotRequired[RebookTradeResponseVenue]
    r"""Exchange venue"""
    when_issued: NotRequired[RebookTradeResponseWhenIssued]
    r"""Denotes that this trade was either when_issued or when_distributed."""
...
class NewTrade(BaseModel):
    ...
    identifier_type: Annotated[
        Optional[RebookTradeResponseIdentifierType],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Identifier type for the asset being traded."""
    ...
    route_type: Annotated[
        Optional[RebookTradeResponseRouteType],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Route type for the trade."""

    settlement_date: OptionalNullable[RebookTradeResponseSettlementDate] = UNSET
    r"""Defaults to T+1 for equities if this is not provided. Calculated by the execution's execution_time field in Eastern Time."""

    side: Annotated[
        Optional[RebookTradeResponseSide], PlainValidator(validate_open_enum(False))
    ] = None
    r"""Denotes if the trade is a SELL or a BUY."""

    side_modifier: Annotated[
        Optional[RebookTradeResponseSideModifier],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Side modifier for the trade."""
    ...
    venue: Annotated[
        Optional[RebookTradeResponseVenue], PlainValidator(validate_open_enum(False))
    ] = None
    r"""Exchange venue"""

    when_issued: Annotated[
        Optional[RebookTradeResponseWhenIssued],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Denotes that this trade was either when_issued or when_distributed."""
...
class RebookTradeResponseOriginalTradeIdentifierType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Identifier type for the asset being traded."""
...
class RebookTradeResponseOriginalTradeLocalMarketTradeDateTypedDict(TypedDict):
    r"""Date field to support extended trading hours."""
...
class RebookTradeResponseOriginalTradeLocalMarketTradeDate(BaseModel):
    r"""Date field to support extended trading hours."""
...
class RebookTradeResponseOriginalTradeRouteType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Route type for the trade."""
...
class RebookTradeResponseOriginalTradeSettlementDateTypedDict(TypedDict):
    r"""Defaults to T+1 for equities if this is not provided. Calculated by the execution's execution_time field in Eastern Time."""
...
class RebookTradeResponseOriginalTradeSettlementDate(BaseModel):
    r"""Defaults to T+1 for equities if this is not provided. Calculated by the execution's execution_time field in Eastern Time."""
...
class RebookTradeResponseOriginalTradeSide(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Denotes if the trade is a SELL or a BUY."""
...
class RebookTradeResponseOriginalTradeSideModifier(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Side modifier for the trade."""
...
class RebookTradeResponseOriginalTradeSpecialInstructions(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    SPECIAL_INSTRUCTIONS_UNSPECIFIED = "SPECIAL_INSTRUCTIONS_UNSPECIFIED"
    RULE_144 = "RULE_144"
...
class RebookTradeResponseOriginalTradeVenue(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Exchange venue"""
...
class RebookTradeResponseOriginalTradeWhenIssued(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Denotes that this trade was either when_issued or when_distributed."""
...
class OriginalTradeTypedDict(TypedDict):
    ...
    identifier: NotRequired[str]
    r"""Identifier (of the type specified in `identifier_type`). Responses will supply the originally requested identifier."""
    identifier_type: NotRequired[RebookTradeResponseOriginalTradeIdentifierType]
    r"""Identifier type for the asset being traded."""
    issuing_region_code: NotRequired[str]
    r"""Unicode CLDR region code. Issuing Region Code is required for some `identifier_type`s, especially CUSIP."""
    local_market_trade_date: NotRequired[
        Nullable[RebookTradeResponseOriginalTradeLocalMarketTradeDateTypedDict]
    ]
    r"""Date field to support extended trading hours."""
    lot_matching_instructions: NotRequired[List[BookingLotTypedDict]]
    r"""One or many lot matching instructions for the trade."""
    ...
    order_id: NotRequired[str]
    r"""Street-level order id, unique by day per broker."""
    route_type: NotRequired[RebookTradeResponseOriginalTradeRouteType]
    r"""Route type for the trade."""
    settlement_date: NotRequired[
        Nullable[RebookTradeResponseOriginalTradeSettlementDateTypedDict]
    ]
    r"""Defaults to T+1 for equities if this is not provided. Calculated by the execution's execution_time field in Eastern Time."""
    side: NotRequired[RebookTradeResponseOriginalTradeSide]
    r"""Denotes if the trade is a SELL or a BUY."""
    side_modifier: NotRequired[RebookTradeResponseOriginalTradeSideModifier]
    r"""Side modifier for the trade."""
    source_application: NotRequired[str]
    r"""The source of the submission."""
    special_instructions: NotRequired[
        List[RebookTradeResponseOriginalTradeSpecialInstructions]
    ]
    r"""An enumerated list of values used to indicate certain attributes about a trade (E.g. DISCRETION_EXERCISED, BROKER_LIQUIDATION) and/or trigger downstream processing rules (e.g. SUPPRESS_TRACE_REPORTING)"""
    trade_id: NotRequired[str]
    r"""A ULID to uniquely identify the trade globally."""
    venue: NotRequired[RebookTradeResponseOriginalTradeVenue]
    r"""Exchange venue"""
    when_issued: NotRequired[RebookTradeResponseOriginalTradeWhenIssued]
    r"""Denotes that this trade was either when_issued or when_distributed."""
...
class OriginalTrade(BaseModel):
    ...
    identifier_type: Annotated[
        Optional[RebookTradeResponseOriginalTradeIdentifierType],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Identifier type for the asset being traded."""
    ...
    route_type: Annotated[
        Optional[RebookTradeResponseOriginalTradeRouteType],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Route type for the trade."""
    ...
    side: Annotated[
        Optional[RebookTradeResponseOriginalTradeSide],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Denotes if the trade is a SELL or a BUY."""

    side_modifier: Annotated[
        Optional[RebookTradeResponseOriginalTradeSideModifier],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Side modifier for the trade."""
    ...
    venue: Annotated[
        Optional[RebookTradeResponseOriginalTradeVenue],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Exchange venue"""

    when_issued: Annotated[
        Optional[RebookTradeResponseOriginalTradeWhenIssued],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Denotes that this trade was either when_issued or when_distributed."""
