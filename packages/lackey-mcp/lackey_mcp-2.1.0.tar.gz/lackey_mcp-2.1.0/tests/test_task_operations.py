...
def core_with_project() -> tuple[LackeyCore, Project]:
    ...
    mock_storage = Mock()
    mock_storage.get_task = Mock()
    mock_storage.update_task = Mock()
    mock_storage.create_task = Mock()
    mock_storage.delete_task = Mock()
    mock_storage.list_project_tasks = Mock()
    mock_storage.list_projects = Mock()
    mock_storage.find_project_id_by_task_id = Mock()
...
def core_with_project_and_tasks(
    ...
    core.storage.get_task.side_effect = mock_get_task
    core.storage.update_task.side_effect = mock_update_task
    core.storage.create_task.side_effect = mock_create_task
    core.storage.delete_task.side_effect = mock_delete_task
    core.storage.list_project_tasks.side_effect = mock_list_project_tasks
    ...
    core.storage.list_projects.side_effect = mock_list_projects
    core.storage.find_project_id_by_task_id.side_effect = (
