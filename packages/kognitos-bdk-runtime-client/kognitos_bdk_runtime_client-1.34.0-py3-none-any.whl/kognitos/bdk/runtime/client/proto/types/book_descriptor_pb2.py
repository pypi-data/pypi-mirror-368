...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 27, 3, '', 'types/book_descriptor.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BOOKDESCRIPTOR']._serialized_start = 118
    _globals['_BOOKDESCRIPTOR']._serialized_end = 818