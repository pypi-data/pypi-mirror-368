...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 27, 3, '', 'requests/resolve_promise.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_RESOLVEPROMISEREQUEST']._serialized_start = 152
    _globals['_RESOLVEPROMISEREQUEST']._serialized_end = 504