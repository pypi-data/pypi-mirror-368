...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 27, 3, '', 'services/library.proto')
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x16services/library.proto\x12\x08protocol\x1a\x1cgoogle/api/annotations.proto\x1a"requests/discover_procedures.proto\x1a&requests/environment_information.proto\x1a\x1frequests/invoke_procedure.proto\x1a\x1crequests/retrieve_book.proto\x1a\'requests/retrieve_book_procedures.proto\x1a\x1drequests/retrieve_books.proto\x1a\x1crequests/retrieve_tags.proto\x1a\x1erequests/test_connection.proto\x1a#responses/discover_procedures.proto\x1a\'responses/environment_information.proto\x1a responses/invoke_procedure.proto\x1a\x1dresponses/retrieve_book.proto\x1a(responses/retrieve_book_procedures.proto\x1a\x1eresponses/retrieve_books.proto\x1a\x1dresponses/retrieve_tags.proto\x1a\x1fresponses/test_connection.proto2\x94\x05\n\x0eLibraryService\x12g\n\rRetrieveBooks\x12\x1e.protocol.RetrieveBooksRequest\x1a\x1f.protocol.RetrieveBooksResponse"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/api/v1/books\x12u\n\x0cRetrieveBook\x12\x1d.protocol.RetrieveBookRequest\x1a\x1e.protocol.RetrieveBookResponse"&\x82\xd3\xe4\x93\x02 \x12\x1e/api/v1/books/{name}/{version}\x12\x9e\x01\n\x16RetrieveBookProcedures\x12\'.protocol.RetrieveBookProceduresRequest\x1a(.protocol.RetrieveBookProceduresResponse"1\x82\xd3\xe4\x93\x02+\x12)/api/v1/books/{name}/{version}/procedures\x12\x9b\x01\n\x0eTestConnection\x12\x1f.protocol.TestConnectionRequest\x1a .protocol.TestConnectionResponse"F\x82\xd3\xe4\x93\x02@"./api/v1/books/{name}/{version}/test-connection:\x0eauthentication\x12c\n\x0cRetrieveTags\x12\x1d.protocol.RetrieveTagsRequest\x1a\x1e.protocol.RetrieveTagsResponse"\x14\x82\xd3\xe4\x93\x02\x0e\x12\x0c/api/v1/tagsB\x1fZ\x1dgithub.com/kognitos/bdk-protob\x06proto3')
_globals = globals()
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LIBRARYSERVICE'].methods_by_name['RetrieveBooks']._loaded_options = None
    _globals['_LIBRARYSERVICE'].methods_by_name['RetrieveBooks']._serialized_options = b'\x82\xd3\xe4\x93\x02\x0f\x12\r/api/v1/books'
    _globals['_LIBRARYSERVICE'].methods_by_name['RetrieveBook']._loaded_options = None
    ...
    _globals['_LIBRARYSERVICE'].methods_by_name['RetrieveBookProcedures']._loaded_options = None
    ...
    _globals['_LIBRARYSERVICE'].methods_by_name['TestConnection']._loaded_options = None
    ...
    _globals['_LIBRARYSERVICE'].methods_by_name['RetrieveTags']._loaded_options = None
    _globals['_LIBRARYSERVICE'].methods_by_name['RetrieveTags']._serialized_options = b'\x82\xd3\xe4\x93\x02\x0e\x12\x0c/api/v1/tags'
    _globals['_LIBRARYSERVICE']._serialized_start = 621
    _globals['_LIBRARYSERVICE']._serialized_end = 1281