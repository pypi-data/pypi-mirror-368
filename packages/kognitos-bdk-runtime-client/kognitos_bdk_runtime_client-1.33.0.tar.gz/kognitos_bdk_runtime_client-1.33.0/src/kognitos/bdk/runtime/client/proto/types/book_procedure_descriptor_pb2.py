...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 27, 3, '', 'types/book_procedure_descriptor.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BOOKPROCEDUREDESCRIPTOR']._serialized_start = 187
    _globals['_BOOKPROCEDUREDESCRIPTOR']._serialized_end = 818