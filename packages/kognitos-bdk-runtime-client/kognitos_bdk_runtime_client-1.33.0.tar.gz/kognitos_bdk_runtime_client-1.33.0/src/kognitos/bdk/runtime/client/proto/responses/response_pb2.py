...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 27, 3, '', 'responses/response.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_RESPONSE']._serialized_start = 409
    _globals['_RESPONSE']._serialized_end = 1316