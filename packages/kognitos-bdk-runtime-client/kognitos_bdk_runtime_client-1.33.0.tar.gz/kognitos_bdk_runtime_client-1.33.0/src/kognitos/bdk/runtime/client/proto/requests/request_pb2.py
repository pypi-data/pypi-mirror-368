...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 27, 3, '', 'requests/request.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_REQUEST']._serialized_start = 373
    _globals['_REQUEST']._serialized_end = 1197