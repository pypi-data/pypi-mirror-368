...
class Exporter:
    ...
    def __init__(self, channel_data: list[ChannelData], allowed_metadata_list: Literal['title', 'description', 'publishedAt'] = ['title', 'description', 'publishedAt'], timing: bool = True, filename: str = 'data', output_dir: str = None):
