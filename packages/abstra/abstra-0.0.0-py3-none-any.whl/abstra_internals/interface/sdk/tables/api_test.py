...
from abstra_internals.interface.sdk.tables.api import (_make_count_query,
                                                       _make_delete_query,
                                                       _make_insert_query,
                                                       _make_row_dict,
                                                       _make_select_query,
...
class TestTables(unittest.TestCase):
    ...
    def test_count(self):
        query, params = _make_count_query(table="foo")
        self.assertEqual(query, 'SELECT COUNT(*) FROM "foo"')
