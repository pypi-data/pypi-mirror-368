...
from abstra_internals.experimental.blueprint import get_experimental_bp
...
def get_cloud_app(controller: MainController):
    ...
    experimental = get_experimental_bp()
    app.register_blueprint(experimental, url_prefix="/_experimental")
