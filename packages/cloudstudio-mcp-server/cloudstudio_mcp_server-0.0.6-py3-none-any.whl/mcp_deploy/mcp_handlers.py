...
def createLiteapp(
    ...
    logger.info(f"Created workspace {workspace_response.data}")
    return {
        "workspace_key": workspace_response.data.workspace.spaceKey,
        ...
        "edit_url": f"https://cloudstudio.net/{workspace_response.data.id}/edit",
    }
...
def uploadfile(api_token: str, workspace_key: str, region: str, files: list[File],
