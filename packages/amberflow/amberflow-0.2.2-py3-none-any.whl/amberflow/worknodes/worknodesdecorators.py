...
from amberflow.primitives import WorkNodeError, DEFAULT_RESOURCES_PATH, filepath_t, WorkNodeRunningError, dirpath_t, \
    CommandRegistryMeta
...
def worknodehelper(
    ...
    def filter_input_artifacts(
        ...
        if len(set_expected_artifact_types) > 0:
        ...
        def run_wrapper(self, *args, **kwargs):
            ...
            try:
                ...
                if self.command is None:
                    ...
                    self.command = CommandRegistryMeta.name[self.command_str](self.remote_server, self.remote_base_dir,
                                                                              self.root_dir)
