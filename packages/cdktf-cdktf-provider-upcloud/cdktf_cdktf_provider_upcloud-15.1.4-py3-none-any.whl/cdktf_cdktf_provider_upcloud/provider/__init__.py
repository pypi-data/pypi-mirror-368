...
class UpcloudProvider(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs upcloud} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs#alias UpcloudProvider#alias}
        :param password: Password for UpCloud API user. Can also be configured using the ``UPCLOUD_PASSWORD`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs#password UpcloudProvider#password}
        :param request_timeout_sec: The duration (in seconds) that the provider waits for an HTTP request towards UpCloud API to complete. Defaults to 120 seconds Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs#request_timeout_sec UpcloudProvider#request_timeout_sec}
        :param retry_max: Maximum number of retries. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs#retry_max UpcloudProvider#retry_max}
        :param retry_wait_max_sec: Maximum time to wait between retries. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs#retry_wait_max_sec UpcloudProvider#retry_wait_max_sec}
        :param retry_wait_min_sec: Minimum time to wait between retries. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs#retry_wait_min_sec UpcloudProvider#retry_wait_min_sec}
        :param token: Token for authenticating to UpCloud API. Can also be configured using the ``UPCLOUD_TOKEN`` environment variable or using the system keyring. Use ``upctl account login`` command to save a token to the system keyring. (EXPERIMENTAL) Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs#token UpcloudProvider#token}
        :param username: UpCloud username with API access. Can also be configured using the ``UPCLOUD_USERNAME`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs#username UpcloudProvider#username}
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing UpcloudProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.23.4/docs#import import section} in the documentation of this resource for the id to use
