...
class TerraBaseWidget(anywidget.AnyWidget):
    ...
    def get_autoloader(cls):
        ...
        terraStyles.href = 'https://cdn.jsdelivr.net/npm/@nasa-terra/components@0.0.60/cdn/themes/horizon.css'
        ...
        terraAutoloader.src = "https://cdn.jsdelivr.net/npm/@nasa-terra/components@0.0.60/cdn/terra-ui-components-autoloader.js"
