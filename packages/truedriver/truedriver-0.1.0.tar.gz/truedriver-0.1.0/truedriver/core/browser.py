...
class Browser:
    ...
    but rather create additional :class:`truedriver.Tab` objects.
    ...
    note:
    the Browser object is not instantiated by __init__ but using the asynchronous :meth:`truedriver.Browser.create` method.
