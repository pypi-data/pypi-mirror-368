...
class NewPersistentSheafLaplacian {
    using storage = float;
    public:
        /********************/
        /* Member variables */
        ...
        std::function<void(FilteredBoundaryMatrix<float>*, filtration_type, filtration_type, DenseMatrix_PL&)> up_algorithm_func;        
        //may need to be void* instead of FilteredBoundaryMatrix*

        /****************/
        /* Constructors */
        /****************/
        NewPersistentSheafLaplacian(sheaf_simplex_tree& sst){
        ...
        /**
         * @param boundaries a vector of Eigen::SparseMatrix of type float. Boundaries must be sorted in order of dimension.
         ...
         */
        NewPersistentSheafLaplacian(std::vector<Eigen::SparseMatrix<storage>> boundaries,
        ...
        void set_up_func(std::function<void(FilteredBoundaryMatrix<float>*, filtration_type, filtration_type, DenseMatrix_PL&)> _up_algorithm_func){
         ...
         */
        Eigen::SparseMatrix<storage> get_down(int dim, filtration_type a){
