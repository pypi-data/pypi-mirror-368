...
latex_documents = [
    (master_doc, "Plot2LLM.tex", "Plot2LLM Documentation", "Osc2405", "manual"),
]
...
man_pages = [(master_doc, "plot2llm", "Plot2LLM Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "Plot2LLM",
        "Plot2LLM Documentation",
        author,
        "Plot2LLM",
        "Convert figures to LLM formats.",
        "Miscellaneous",
    ),
]
...
def autolink(pattern):
    ...
    def role(name, rawtext, text, lineno, inliner, options={}, content=[]):
        ...
        set_classes(options)
        node = nodes.reference(rawtext, "#" + text, refuri=pattern % text, **options)
        return [node], []
