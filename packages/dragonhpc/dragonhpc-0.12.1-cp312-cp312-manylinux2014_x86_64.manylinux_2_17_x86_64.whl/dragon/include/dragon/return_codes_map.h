...
#ifndef DRAGON_RETURN_CODES_MAP
#define DRAGON_RETURN_CODES_MAP

/* This defines a static array to map
 * return values in return_codes.h
 * to a string representation. This
 * source file was auto-generated by
 * the tool return_codes_map_maker.py
*/

/* This file is not to be included by other C code.
 * Instead, use the dragon_get_rc_string API call
 * to translate a return code to its string representation.
*/

#include <dragon/return_codes.h>

static const char* dragon_rc_map[] = {
    "DRAGON_SUCCESS",
    ...
    "DRAGON_BAD_RETURN_CODE"
};

static const dragonError_t dragon_max_rc_value = DRAGON_BAD_RETURN_CODE;
