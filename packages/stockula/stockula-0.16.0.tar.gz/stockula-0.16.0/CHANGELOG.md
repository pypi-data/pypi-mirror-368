...
- update Docker build workflow to improve version tagging and trig…
  ([b38426c](https://github.com/mkm29/stockula/commit/b38426cc612fbd4c49abdc7c1ea13f2bc873561c))
- update Docker build workflow to improve version tagging and trigger conditions
  ([fd1c556](https://github.com/mkm29/stockula/commit/fd1c556cdbf70847fd7aadd803806523b1e65de6))

## [0.15.5](https://github.com/mkm29/stockula/compare/v0.15.4...v0.15.5) (2025-08-11)

### Bug Fixes

- updated Python versions of GPU packages
  ([2d58318](https://github.com/mkm29/stockula/commit/2d583189c8f7f0f1abe1efbdf04fd4c5d100e7c4))
- updated Python versions of GPU packages
  ([8fb31da](https://github.com/mkm29/stockula/commit/8fb31dadf82ee7c5a162a25db5e43fdbe1ef4209))

## [0.15.4](https://github.com/mkm29/stockula/compare/v0.15.3...v0.15.4) (2025-08-11)

### Bug Fixes

- optimize Dockerfile and update requirements for improved build e…
  ([777a650](https://github.com/mkm29/stockula/commit/777a650df48c38dc6586f2965bbbd9534f77b2f5))
- optimize Dockerfile and update requirements for improved build efficiency and dependency management
  ([25621fa](https://github.com/mkm29/stockula/commit/25621fab2f4dce364c9ddd55ac8ffe6f5c626d43))

## [0.15.3](https://github.com/mkm29/stockula/compare/v0.15.2...v0.15.3) (2025-08-11)

### Bug Fixes

- remove unnecessary SHA-based tagging for Docker image builds
  ([330ee1d](https://github.com/mkm29/stockula/commit/330ee1d2bab31b35744386dd903014b61e45a568))
- remove unnecessary SHA-based tagging for Docker image builds
  ([f4a3104](https://github.com/mkm29/stockula/commit/f4a3104085a9e425b3aa0911c9a71903e751fbcb))

## [0.15.2](https://github.com/mkm29/stockula/compare/v0.15.1...v0.15.2) (2025-08-11)

### Bug Fixes

- enhance Docker build workflow with disk space checks and cleanup for GPU builds
  ([05ad83f](https://github.com/mkm29/stockula/commit/05ad83f6c3de393ae4655c6167e47210ac44aca7))
- enhance Docker build workflow with disk space checks and cleanup…
  ([ec6cde9](https://github.com/mkm29/stockula/commit/ec6cde9b93032d3b1e6c41058f3d9ae767084c6e))

## [0.15.1](https://github.com/mkm29/stockula/compare/v0.15.0...v0.15.1) (2025-08-10)

### Bug Fixes

- update Dockerfile to use runtime image for reduced size and inst…
  ([9418932](https://github.com/mkm29/stockula/commit/9418932510b6b8713a9202d5bd9ca96bc236cc82))
- update Dockerfile to use runtime image for reduced size and install necessary build dependencies
  ([eac93cf](https://github.com/mkm29/stockula/commit/eac93cf8b62eab5e636eaa6cb1ea4f02edc0c57b))
...
- add hotfix workflow for PR validation and backporting
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
...
- create promote to production workflow
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
- **database:** Implement strategy and strategy preset models with mi…
  ([88f67f6](https://github.com/mkm29/stockula/commit/88f67f6a25bb772adad8d683146ddc33d640a25c))
- **database:** Implement strategy and strategy preset models with migration handling
  ([07ac5a9](https://github.com/mkm29/stockula/commit/07ac5a9ecf422812b1c2c50d41114512125b3267))
- **docker:** Add GPU-enabled Dockerfile and Docker Compose configuration for Stockula
  ([772fccd](https://github.com/mkm29/stockula/commit/772fccdff496131a50de9a6f0657136e06124f34))
...
- **docker:** Update GPU-enabled Dockerfile for improved dependency management and clarity
  ([d455774](https://github.com/mkm29/stockula/commit/d455774e9003983d6134aab4540820c6ea36d654))
...
- enhance release workflow for develop branch
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
...
- **portfolio:** Enhance portfolio creation with validation error handling and suggestions
  ([0f63341](https://github.com/mkm29/stockula/commit/0f633418aa688e58c9c46ebf0bc6bad3d92dc172))
...
- **tests:** Update integration and unit test workflows with coverage reporting and cleanup steps
  ([4043ab0](https://github.com/mkm29/stockula/commit/4043ab0684de94bd66c28af53a5ccd49e9787538))
...
- add chronos availability check and update ForecastingManager import logic
  ([58d1d9e](https://github.com/mkm29/stockula/commit/58d1d9efe0c288dc0a9609a134dd894257c1aa75))
- add UV_LINK_MODE environment variable for improved bytecode handling
  ([45c3d97](https://github.com/mkm29/stockula/commit/45c3d970debcc12475051c51dcd96d8f32c50db1))
...
- correct GPU acceleration documentation for clarity
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
...
- improve YAML formatting documentation
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
...
- update docker validation documentation for clarity
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
- update integration test workflow to include additional paths
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
...
- create contributing guide for development workflow
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
- enhance Docker deployment documentation
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
...
- update README with Git Flow and release process details
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
...
- streamline test workflow by removing integration tests
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
...
- **develop:** release 0.12.0
  ([21845fb](https://github.com/mkm29/stockula/commit/21845fb5815f13776b9ee63c0baad0e486b8ec03))
- **develop:** release 0.12.0
  ([56929ac](https://github.com/mkm29/stockula/commit/56929acd719103cdf57c1007a0fee9b223e9d7af))
- **develop:** release 0.13.0
  ([bbedafa](https://github.com/mkm29/stockula/commit/bbedafa693b3a8e81c1236e6581884a8fba7ec75))
- **develop:** release 0.13.0
  ([edde3fe](https://github.com/mkm29/stockula/commit/edde3feb7e9b2f4754f3174c0a5b1e094b5517cc))
- **develop:** release 0.13.1
  ([aadd2c9](https://github.com/mkm29/stockula/commit/aadd2c9d59ca0265dbdc7b60bbac297fb33d8bbe))
- **develop:** release 0.13.1
  ([1ca7e57](https://github.com/mkm29/stockula/commit/1ca7e571f5ea0461b9f0baf2cffd78e714a31022))
...
- **main:** release 0.10.0
  ([7d1f841](https://github.com/mkm29/stockula/commit/7d1f84100866bc4a3c125cfad76e4dc044c0233a))
- **main:** release 0.10.0
  ([c7c589e](https://github.com/mkm29/stockula/commit/c7c589ef58b179cdd40a392cdc740d6cc05e03b4))
- **main:** release 0.11.0
  ([22821c4](https://github.com/mkm29/stockula/commit/22821c49ff26383e457ddecc828e33f95fe2ffc6))
- **main:** release 0.11.0
  ([a379879](https://github.com/mkm29/stockula/commit/a37987951ba5594314c759a582ff96bf99e00ddd))
...
- update release-please configuration for prerelease tagging
  ([a6092aa](https://github.com/mkm29/stockula/commit/a6092aaa483c3bef61da100e91db0ea538aa72e0))
...
- update version to 0.14.0 and adjust Python version to 3.11 in workflows and configuration files; add chronos
  availability check in tests
  ([5cbfc84](https://github.com/mkm29/stockula/commit/5cbfc842ce7dcd4c4267baca01f4e9c8d959b37b))
