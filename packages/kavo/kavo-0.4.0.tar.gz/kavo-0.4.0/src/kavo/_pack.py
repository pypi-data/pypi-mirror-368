...
from ._models import CacheEntry, ResponseLastUsageInfo, StampedeInfo
import msgpack
...
@overload
def unpack(
    data: bytes, kind: Literal["staleness_tracker"]
) -> ResponseLastUsageInfo: ...
...
def unpack(
    data: bytes,
    kind: Literal[
        "response", "response_chunk", "request", "request_chunk", "staleness_tracker"
    ],
) -> Mapping[str, Any]: ...
