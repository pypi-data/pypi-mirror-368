...
class CameraAdmin(DjangoObjectActions, admin.ModelAdmin):
    ...
    # def playback_html(self, obj):
    #     res = f'''<a href="/hikvision/playback?index_code={obj.index_code}">视频回放</a>'''
    #     return format_html(res)

    # playback_html.short_description = "回放"

    def history_html(self, obj):
        res = f'''<a href="/hikvision/history?index_code={obj.index_code}" target='_blank'>查看状态</a>'''
        return format_html(res)
