...
This module provides the core API Client functionality for TestAPIX. The client
...
class APIClient:
    """Enhanced API client for testing APIs.
...
class SyncAPIClient:
    ...
    Note: For new projects, we recommend using the async APIClient for better
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._async_client = APIClient(*args, **kwargs)
    ...
    def _get_event_loop(self) -> asyncio.AbstractEventLoop:
        ...
        try:
            ...
            raise RuntimeError(
                "SyncAPIClient cannot be used within an async context. "
                "Use APIClient (async) instead."
            )
        except RuntimeError:
