...
class Ieee488_2:  # noqa: N801
    ...
    _STAT_OPER_SETTLING = 0x0002      # The instrument is waiting for signals it controls to
                                      # stabilize enough to begin measurements
    ...
    _STAT_OPER_WAIT_TRIG = 0x0020     # The instrument is in a “wait for trigger” state of the
                                      # trigger model
    _STAT_OPER_WAIT_ARM = 0x0040      # The instrument is in a “wait for arm” state of the
                                      # trigger model
    _STAT_OPER_CORRECTING = 0x0080    # The instrument is currently performing a correction
    _STAT_OPER_INST_SUMMARY = 0x2000  # One of n multiple logical instruments is reporting
                                      # OPERational status
