...
class Publish(Default):
    ...
    version: str = 'ed9bff22f51f8b70c47a326e1e73a48174a8c6d2'

@dataclass(slots=True, frozen=True, eq=True)
class Draft(Default):
    """Draft release patterns for packaged project."""

    version: str = 'cabcb89f38f90863aa0217f0b4b2dba02262b004'

@dataclass(slots=True, frozen=True, eq=True)
class Release(Default):
    """Release patterns for packaged project."""

    version: str = 'd3920f3f0471dec9369a2245cc6e6b42756d27f8'
...
class Checkpoint(Default):
    ...
    version: str = 'f475dbf6078211f784f6e7b3bb7c1b00ce0d05b9'
