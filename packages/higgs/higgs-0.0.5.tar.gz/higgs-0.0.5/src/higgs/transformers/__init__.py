...
from higgs.transformers.utils import (
...
try:
    ...
    from higgs.transformers.utils import dummy_sentencepiece_objects
...
try:
    ...
    from higgs.transformers.utils import dummy_tokenizers_objects
...
try:
    ...
    from higgs.transformers.utils import dummy_sentencepiece_and_tokenizers_objects
...
try:
    ...
    from higgs.transformers.utils import dummy_tensorflow_text_objects
...
try:
    ...
    from higgs.transformers.utils import dummy_keras_nlp_objects
...
try:
    ...
    from higgs.transformers.utils import dummy_vision_objects
...
try:
    ...
    from higgs.transformers.utils import dummy_pt_objects
...
try:
    ...
    from higgs.transformers.utils import dummy_tf_objects
...
try:
    ...
    from higgs.transformers.utils import dummy_flax_objects
...
if TYPE_CHECKING:
    ...
    from higgs.transformers.models.herbert import HerbertTokenizer
    from higgs.transformers.models.hiera import HieraConfig
    from higgs.transformers.models.hubert import HubertConfig
    from higgs.transformers.models.ibert import IBertConfig
    from higgs.transformers.models.idefics import (
        IdeficsConfig,
    )
    ...
    from higgs.transformers.models.llama import LlamaConfig
    from higgs.transformers.models.llava import (
        LlavaConfig,
        LlavaProcessor,
    )
    from higgs.transformers.models.llava_next import (
        LlavaNextConfig,
        LlavaNextProcessor,
    )
    ...
    from higgs.transformers.models.t5 import T5Config
    ...
    # bitsandbytes config
    from higgs.transformers.utils.quantization_config import (
        AqlmConfig,
        AwqConfig,
        BitNetConfig,
        BitsAndBytesConfig,
    ...
    try:
        ...
        from higgs.transformers.models.llama import LlamaTokenizer
        ...
        from higgs.transformers.models.t5 import T5Tokenizer
    ...
    try:
        ...
        from higgs.transformers.utils.dummy_tokenizers_objects import *
    else:
        ...
        from higgs.transformers.models.herbert import HerbertTokenizerFast
        from .models.layoutlm import LayoutLMTokenizerFast
        from .models.layoutlmv2 import LayoutLMv2TokenizerFast
        from .models.layoutlmv3 import LayoutLMv3TokenizerFast
        from .models.layoutxlm import LayoutXLMTokenizerFast
        from .models.led import LEDTokenizerFast
        from higgs.transformers.models.llama import LlamaTokenizerFast
        ...
        from higgs.transformers.models.whisper import WhisperTokenizerFast
        from .models.xglm import XGLMTokenizerFast
        from .models.xlm_roberta import XLMRobertaTokenizerFast
        from .models.xlnet import XLNetTokenizerFast
        from higgs.transformers.tokenization_utils_fast import PreTrainedTokenizerFast

    try:
        if not (is_sentencepiece_available() and is_tokenizers_available()):
            raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable:
        from higgs.transformers.utils.dummy_sentencepiece_and_tokenizers_objects import *
    else:
    ...
    try:
        ...
        from higgs.transformers.utils.dummy_tensorflow_text_objects import *
    else:
        from higgs.transformers.models.bert import TFBertTokenizer

    try:
        if not is_keras_nlp_available():
            raise OptionalDependencyNotAvailable()
    except OptionalDependencyNotAvailable:
        from higgs.transformers.utils.dummy_keras_nlp_objects import *
    else:
