...
```
pip install breeze-connect==1.0.14rc59
```
<hr>
...
<!-- <h4> NOTE: </h4>
<p><ol><li>The validity_date parameter has no impact on the order execution and if you include it while placing the order, it will be excluded from order processing.</li></ol></p> -->
...
<h4> NOTE: </h4>
<p><ol><li>The validity_date parameter has no impact on the modfication of the order  and even if you pass it while modifying the order, it will be excluded from order modificaion processing.</li></ol></p>
