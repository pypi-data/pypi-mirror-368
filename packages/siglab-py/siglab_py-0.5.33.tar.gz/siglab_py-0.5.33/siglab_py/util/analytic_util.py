...
def compute_candles_stats(
    ...
    pd_candles['ema_bullish_cross_last_id'] = bullish_indices.rolling(window=pd_candles.shape[0]).max()
    pd_candles['ema_bearish_cross_last_id'] = bearish_indices.rolling(window=pd_candles.shape[0]).min()
    pd_candles['ema_bullish_cross_last_id'].astype('Int64')
    pd_candles['ema_bearish_cross_last_id'].astype('Int64')
