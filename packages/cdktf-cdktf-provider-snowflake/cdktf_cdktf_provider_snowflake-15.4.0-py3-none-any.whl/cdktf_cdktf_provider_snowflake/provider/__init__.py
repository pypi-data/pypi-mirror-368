...
class SnowflakeProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#alias SnowflakeProvider#alias}
        ...
        :param client_ip: IP address for network checks. Can also be sourced from the ``SNOWFLAKE_CLIENT_IP`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#client_ip SnowflakeProvider#client_ip}
        ...
        :param disable_telemetry: Disables telemetry in the driver. Can also be sourced from the ``DISABLE_TELEMETRY`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#disable_telemetry SnowflakeProvider#disable_telemetry}
        ...
        :param host: Specifies a custom host value used by the driver for privatelink connections. Can also be sourced from the ``SNOWFLAKE_HOST`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#host SnowflakeProvider#host}
        :param include_retry_reason: Should retried request contain retry reason. Can also be sourced from the ``SNOWFLAKE_INCLUDE_RETRY_REASON`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#include_retry_reason SnowflakeProvider#include_retry_reason}
        ...
        :param jwt_expire_timeout: JWT expire after timeout in seconds. Can also be sourced from the ``SNOWFLAKE_JWT_EXPIRE_TIMEOUT`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#jwt_expire_timeout SnowflakeProvider#jwt_expire_timeout}
        ...
        :param params: Sets other connection (i.e. session) parameters. `Parameters <https://docs.snowflake.com/en/sql-reference/parameters>`_. This field can not be set with environmental variables. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#params SnowflakeProvider#params}
        ...
        :param profile: Sets the profile to read from ~/.snowflake/config file. Can also be sourced from the ``SNOWFLAKE_PROFILE`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#profile SnowflakeProvider#profile}
        :param protocol: A protocol used in the connection. Valid options are: ``http`` | ``https``. Can also be sourced from the ``SNOWFLAKE_PROTOCOL`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#protocol SnowflakeProvider#protocol}
        ...
        :param role: Specifies the role to use by default for accessing Snowflake objects in the client session. Can also be sourced from the ``SNOWFLAKE_ROLE`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#role SnowflakeProvider#role}
        ...
        :param token_accessor: token_accessor block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#token_accessor SnowflakeProvider#token_accessor}
        ...
        :param user: Username. Required unless using ``profile``. Can also be sourced from the ``SNOWFLAKE_USER`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#user SnowflakeProvider#user}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SnowflakeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.5.0/docs#import import section} in the documentation of this resource for the id to use
