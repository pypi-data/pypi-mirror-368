...
addpath('../animation_toolbox/');addpath('../colorthemes/');
fig = figure;
...
f2 = @(r,v,w) 0.005*((v-w*r).^3).*b(r)./(abs(v-w*25)+20);
...
approx_line1 = animation(@(c) plot3(r, y, f2(r,c{1}, c{2}), "LineWidth", 1.2, "Color", [0,1,1]), {0,1}, {10,0} );
approx_line2 = animation(@(c) plot3(r, y, f2(r,c{1}, c{2}), "LineWidth", 1.2, "Color", [0,1,1]), {10,0}, {5,1} );
approx_line3 = animation(@(c) plot3(r, y, f2(r,c{1}, c{2}), "LineWidth", 1.2, "Color", [0,1,1]), {5,1}, {-5,1} );
approx_line4 = animation(@(c) plot3(r, y, f2(r,c{1}, c{2}), "LineWidth", 1.2, "Color", [0,1,1]), {-5,1}, {-5,-1} );
approx_line5 = animation(@(c) plot3(r, y, f2(r,c{1}, c{2}), "LineWidth", 1.2, "Color", [0,1,1]), {-5,-1}, {0,1} );

approx_text1 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 (|v_0 - \omega r_{ref}|+20)^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {0,1}, {10,0} );
approx_text2 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 (|v_0 - \omega r_{ref}|+20)^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {10,0}, {5,1} );
approx_text3 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 (|v_0 - \omega r_{ref}|+20)^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {5,1}, {-5,1} );
approx_text4 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 (|v_0 - \omega r_{ref}|+20)^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {-5,1}, {-5,-1} );
approx_text5 = animation(@(c) text(r_text+10, y_text, f2(r_text+10,c{1}, c{2}) + 5,"$(v_0 - \omega r)^3 (|v_0 - \omega r_{ref}|+20)^{-1} b(r) $", "Interpreter", "latex", "Color", [0 1 1]), {-5,-1}, {0,1} );
...
delete Documentation/integrand_approximation.gif
saver =  save_to_gif(ax, "Documentation/integrand_approximation.gif");

animate({rocket, r_ax, b_ax, integrand_line1, text1, omega_text1, v_text1, approx_line1, approx_text1, saver}, 1:2:100)
animate({rocket, r_ax, b_ax, integrand_line2, text2, omega_text2, v_text2, approx_line2, approx_text2, saver}, 1:2:100)
animate({rocket, r_ax, b_ax, integrand_line3, text3, omega_text3, v_text3, approx_line3, approx_text3, saver}, 1:2:100)
animate({rocket, r_ax, b_ax, integrand_line4, text4, omega_text4, v_text4, approx_line4, approx_text4, saver}, 1:2:100)
animate({rocket, r_ax, b_ax, integrand_line5, text5, omega_text5, v_text5, approx_line5, approx_text5, saver}, 1:2:100)
animate({rocket, r_ax, b_ax, integrand_line5, text5, omega_text5, v_text5, approx_line5, approx_text5, saver}, 100*ones(1,50));
