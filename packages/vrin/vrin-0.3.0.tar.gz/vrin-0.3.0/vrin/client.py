...
class VRINClient:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                response_data = {
                    ...
                    'search_time': f"{result.get('search_time', 0):.2f}s",
    ...
    def get_facts(self, query: str, max_results: int = 10) -> Dict[str, Any]:
        """
        Get detailed facts and raw search results for power users
        ...
        Returns:
            Dict containing detailed facts, graph traversal data, and raw results
        """
        try:
            payload = {
                'query': query,
    ...
    def specialize(self, specialization_config: Dict[str, Any]) -> Dict[str, Any]:
        """
        Configure VRIN's reasoning approach for your specific domain/use case
        
        Args:
            specialization_config: Dict containing specialization parameters:
                - reasoning_focus: List of reasoning types to prioritize
                - domain_keywords: Industry-specific keywords
                - analysis_depth: "surface", "detailed", or "expert"
                - output_style: "executive_summary", "technical_analysis", "legal_brief", etc.
                - confidence_threshold: Minimum confidence for insights (0-1)
                - max_reasoning_chains: Maximum reasoning paths to explore (1-20)
                - custom_prompts: Dict of custom prompts for specific reasoning types
    ...
    def specialize_for_legal_analysis(self) -> Dict[str, Any]:
        """
        Configure VRIN for legal document analysis and due diligence
        
        Returns:
            Dict containing specialization result
        """
        config = {
            "reasoning_focus": ["entity_relationships", "temporal_analysis", "cross_document_synthesis"],
            "domain_keywords": ["contract", "liability", "compliance", "regulation", "intellectual property", "precedent"],
            "analysis_depth": "expert",
            "output_style": "legal_brief",
            "custom_prompts": {
                "synthesis": "Focus on legal implications, precedent analysis, and risk assessment. Include citation of relevant laws and regulations."
            },
            "confidence_threshold": 0.7,
            "max_reasoning_chains": 8
        }
        return self.specialize(config)
    
    def specialize_for_financial_analysis(self) -> Dict[str, Any]:
        """
        Configure VRIN for financial analysis and M&A due diligence
        
        Returns:
            Dict containing specialization result
        """
        config = {
            "reasoning_focus": ["causal_chains", "temporal_analysis", "pattern_recognition"],
            "domain_keywords": ["revenue", "profit", "valuation", "risk", "market", "investment", "synergy"],
            "analysis_depth": "expert",
            "output_style": "business_report",
            "custom_prompts": {
                "synthesis": "Emphasize quantitative metrics, financial implications, and strategic value. Include ROI analysis and risk-adjusted returns."
            },
    ...
    def specialize_for_due_diligence(self) -> Dict[str, Any]:
        """
        Configure VRIN for comprehensive M&A due diligence analysis
        
        Returns:
            Dict containing specialization result
        """
        config = {
            "reasoning_focus": ["entity_relationships", "causal_chains", "cross_document_synthesis", "temporal_analysis"],
            "domain_keywords": ["ownership", "subsidiary", "acquisition", "asset", "liability", "compliance", "strategic"],
            "analysis_depth": "expert",
            "output_style": "due_diligence",
            "custom_prompts": {
                "synthesis": "Comprehensive due diligence analysis focusing on hidden assets, ownership chains, strategic value, and potential risks. Identify patterns across corporate structure, financial, and legal documents."
            },
            "confidence_threshold": 0.6,
    ...
    def specialize_for_technical_research(self) -> Dict[str, Any]:
        """
        Configure VRIN for technical research and analysis
        
        Returns:
            Dict containing specialization result
        """
        config = {
            "reasoning_focus": ["logical_inference", "pattern_recognition", "cross_document_synthesis"],
            "domain_keywords": ["algorithm", "performance", "scalability", "architecture", "implementation", "innovation"],
            "analysis_depth": "detailed",
            "output_style": "research_summary",
            "custom_prompts": {
                "synthesis": "Focus on technical accuracy, methodology validation, and innovation assessment. Include performance metrics and comparative analysis."
            },
            "confidence_threshold": 0.5,
            "max_reasoning_chains": 7
        }
        return self.specialize(config)
