...
if len(sys.argv) > 1:
	...
	msg = '\n python3-radexreader-pypi ' + radexreader.__version__ + ' − python ' + python_version() + ', pyusb ' + usb.__version__ + ', pyserial ' + serial.__version__
...
print('Usage: radexreader-cli.py erase|tail|jsontail|last|jsonlast|all|jsonall')
exit(-1)