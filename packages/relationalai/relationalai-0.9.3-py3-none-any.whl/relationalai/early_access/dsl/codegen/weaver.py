...
class Weaver:
    ...
    def __init__(self, model, config=None):
        ...
        self._filtering_subtype_binding_to_entity_map: dict[SubtypeConceptBinding, EntitySubtypeMap] = OrderedDict()
    ...
    def _composite_entity_map_combinations(self, bound_uc: BoundIdentifierConstraint) -> list[list[Union[ValueMap, SimpleConstructorEntityMap, ReferentEntityMap]]]:
