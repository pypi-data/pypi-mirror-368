...
def linear_prefix_sum(list):
    result = list._model.Relationship(f"The number of elements at index {{Integer}} is {{Integer}} {time.time_ns()}")
...
def dynamic_prefix_sum(list):
    result = list._model.Relationship(f"The number of elements at index {{Integer}} is {{Integer}} {time.time_ns()}")
    L = list._model.Relationship(f"{{Integer}} {{Integer}} {{Integer}} {time.time_ns()}")
    B = list._model.Relationship(f"{{Integer}} {{Integer}} {{Integer}} {time.time_ns()}")
    B_max = list._model.Relationship(f"{{Integer}} {{Integer}} {time.time_ns()}")
