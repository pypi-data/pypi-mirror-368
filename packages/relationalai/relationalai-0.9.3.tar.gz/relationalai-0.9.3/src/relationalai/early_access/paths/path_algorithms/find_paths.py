...
from relationalai.early_access.builder import where, define, rank, sum, not_
...
def find_shortest_paths(g: Graph, Source, Target, max_length=None, num_paths=None):
    ...
    ord_source = g.model.Relationship(f"The {{Integer}}th source node is {{{Node}}} {time.time_ns()}")
    total_paths = g.model.Relationship(f"The total number of paths to return is {{Integer}} {time.time_ns()}")
    int_source = g.model.Relationship(f"The paths starting at {{{Node}}} go from {{Integer}} to {{Integer}} {time.time_ns()}")
    paths_listing = g.model.Relationship(f"Paths listing {{{Node}}} {{Integer}} {{Integer}} {{Integer}} {time.time_ns()}")
    paths = g.model.Relationship(f"The path with number {{Integer}} has at level {{Integer}} the vertex {{{Node}}} {time.time_ns()}")
    neighbor = g.model.Relationship(f"{{{Node}}} has neighbor number {{Integer}} who is {{{Node}}} {time.time_ns()}")
    edge_nsp = g.model.Relationship(f"The number of shortest paths from {{{Node}}} that go through its {{Integer}} neighbor is {{Integer}} {time.time_ns()}")
    acc_nsp = g.model.Relationship(f"The number of shortest paths from {{{Node}}} that go through its neighbor from 1 to {{Integer}} is {{Integer}} {time.time_ns()}")
    nsp_interval = g.model.Relationship(f"NSP interval {{{Node}}} {{Integer}} {{Integer}} {{Integer}} {time.time_ns()}")
    path_routing = g.model.Relationship(f"Path routing {{{Node}}} {{Integer}} {{{Node}}} {{Integer}} {time.time_ns()}")
...
def find_walks(g: Graph, Source, Target, max_length, num_paths=None):
    ...
    paths_listing = g.model.Relationship(f"Paths listing {{{Node}}} {{Integer}} {{Integer}} {{Integer}} {time.time_ns()}")
    paths = g.model.Relationship(f"The path with number {{Integer}} has at level {{Integer}} the vertex {{{Node}}} {time.time_ns()}")
    neighbor = g.model.Relationship(f"Pair {{{Node}}} {{Integer}} has neighbor number {{Integer}} who is {{{Node}}} {time.time_ns()}")
    edge_nsp = g.model.Relationship(f"The number of shortest paths from the pair {{{Node}}} {{Integer}} that go through its {{Integer}} neighbor is {{Integer}} {time.time_ns()}")
    acc_nsp = g.model.Relationship(f"The number of shortest paths from {{{Node}}} that go through its neighbor from 1 to {{Integer}} is {{Integer}} {time.time_ns()}")
    nsp_interval = g.model.Relationship(f"NSP interval {{{Node}}} {{Integer}} {{Integer}} {{Integer}} {{Integer}} {time.time_ns()}")
    path_routing = g.model.Relationship(f"Path routing {{{Node}}} {{Integer}} {{Integer}} {{{Node}}} {{Integer}} {time.time_ns()}")
