...
from netpicker.utilities import get_logo


def lazy_label():
    return SafeText('Netpicker ' + get_logo(style="height:16px;padding:0px 12px 0px 8px;").strip('\n').strip())
    ...
    groups=(
        (
            'Netpicker', (
                ...
                PluginMenuItem(
                    link='plugins:netpicker:setting',
                    link_text='Settings',
