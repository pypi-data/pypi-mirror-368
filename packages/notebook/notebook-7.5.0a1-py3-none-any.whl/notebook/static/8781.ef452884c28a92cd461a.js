...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96616);
...
async function main() {
  const mimeExtensionsMods = [
    ...
    __webpack_require__(36595),
    __webpack_require__(19511),
    __webpack_require__(94369),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(98284),
  __webpack_require__(42055),
  __webpack_require__(21880),
  __webpack_require__(22549),
  __webpack_require__(20858),
  __webpack_require__(39933),
  __webpack_require__(14857),
  
      (__webpack_require__(17198)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(50470)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(90710),
  __webpack_require__(46379),
  
      (__webpack_require__(84848)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(36211)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(32269),
  
      (__webpack_require__(33872)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(413)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(16054)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(14098)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(86699)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(83302),
  __webpack_require__(99701),
  __webpack_require__(23109),
  __webpack_require__(79635),
  
      (__webpack_require__(19299)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(42252),
  __webpack_require__(43333),
  __webpack_require__(33716),
  
      (__webpack_require__(86894)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(46060),
  __webpack_require__(12403),
  __webpack_require__(65163),
  __webpack_require__(25144),
  __webpack_require__(29930),
  __webpack_require__(5648),
  __webpack_require__(74857),
  __webpack_require__(43864),
  __webpack_require__(74774),
  __webpack_require__(45371),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(12205),
  
      (__webpack_require__(44788)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(25062),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(67994),
  __webpack_require__(8753),
  
      (__webpack_require__(11179)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:sources',
      ...
      __webpack_require__(63048),
  __webpack_require__(72169),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(63504)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(8300)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(51716).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(60938).IServiceManager);
...
//# sourceMappingURL=8781.ef452884c28a92cd461a.js.map?v=ef452884c28a92cd461a