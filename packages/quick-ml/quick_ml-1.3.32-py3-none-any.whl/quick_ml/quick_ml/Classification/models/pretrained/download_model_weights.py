...
MODELS = {
    'alexnet': {
        True: {
            'imagenet': "alexnet/alexnet.keras",
        },
        False: {
            'imagenet': "alexnet_notop.keras",
        }
    },
    'vgg11' : {
        True: {
            'imagenet': "vgg/vgg11/vgg11.keras",

        },
        False: {
            'imagenet': "vgg/vgg/vgg11_notop.keras",
        }
    }
}
...
def download_model_weights(model, include_top = True, weights = 'imagenet'):
    ...
    url = base_url + "/" + MODELS[model][include_top][weights]
