...
class FeaturesAlex(tf.keras.Model):
    ...
    def __init__(self): #, weights, conv_layers):
        ...
        self.conv1 = Convolution2D(out_channels=64, kernel_size=(11, 11), stride=(4,4), padding=(2,2))
        self.act1 = ReLU()
        
        ###  complete implementation
        self.maxpool1 = MAXPOOL2D(kernel_size = (3,3), stride = 2, padding = 0, dilation = 1)
        self.conv2 = Convolution2D(out_channels = 192, kernel_size = (5,5), stride = (1,1), padding = (2,2))
        self.act2 = ReLU()
        self.maxpool2 = MAXPOOL2D(kernel_size = (3,3), stride = 2, padding = 0, dilation = 1)

        self.conv3 = Convolution2D(384, kernel_size = (3,3), stride = (1,1), padding = (1,1))
        self.act3 = ReLU()
        self.conv4 = Convolution2D(256, kernel_size = (3,3), stride =(1, 1), padding=(1, 1) )
        self.act4 = ReLU()
        self.conv5 = Convolution2D(256, kernel_size = (3,3), stride = (1,1), padding = (1,1))
        self.act5 = ReLU()

        self.maxpool3 = MAXPOOL2D(kernel_size = (3,3), stride = 2, padding = 0, dilation = 1)
