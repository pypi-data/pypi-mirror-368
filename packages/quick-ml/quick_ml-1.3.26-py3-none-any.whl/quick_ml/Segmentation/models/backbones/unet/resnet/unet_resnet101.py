...
class UNETResNet101(Model):
    ...
    def __init__(self, input_shape = (512, 512, 3)):
        ...
        resnet101 = ResNet101(include_top = False, weights = 'imagenet', input_shape = self.input_shape)

        encoder = tf.keras.Model(inputs = resnet101.input, outputs = resnet101.get_layer("conv4_block23_out").output)
