...
class UNETResNet152(Model):
    ...
    def __init__(self, input_shape = (512, 512, 3)):
        ...
        resnet152 = ResNet152(include_top = False, weights = 'imagenet', input_shape = self.input_shape)

        encoder = tf.keras.Model(inputs = resnet152.input, outputs = resnet152.get_layer("conv4_block36_out").output)
        ...
        self.eb4_layers = encoder.layers[39 : 121]

        self.eb4_inp = self.eb4_layers[0].input
        self.eb4_out = self.eb4_layers[-1].output

        self.eb5_layers = encoder.layers[121 : 483]
