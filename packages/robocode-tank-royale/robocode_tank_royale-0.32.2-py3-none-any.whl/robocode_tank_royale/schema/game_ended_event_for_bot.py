"""
Generated Python class from game-ended-event-for-bot.schema.yaml
...
class GameEndedEventForBot(Message):
    ...
    def __init__(self, number_of_rounds: int | None, results: ResultsForBot | None, type: 'Message.Type | None'):
        if results is None:
