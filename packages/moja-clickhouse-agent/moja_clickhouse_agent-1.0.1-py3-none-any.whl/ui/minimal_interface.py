...
class MinimalInterface:
    ...
    def show_tool_execution(self, tool_name: str, description: str = ""):
        """Smooth tool execution animation"""
    ...
    def show_agent_response_markdown(self, message: str, reasoning: str = None):
        """Show agent response with markdown rendering if it contains markdown"""
        # Show reasoning first if provided (in muted quote style like Notion)
        if reasoning:
