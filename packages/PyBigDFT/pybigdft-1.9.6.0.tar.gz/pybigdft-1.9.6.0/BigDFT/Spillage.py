...
class MatrixMetadata:
    ...
    def get_frag_indices(self, system):
        """
        Retrieve the indices of the matrix associated with each fragment
        of a system.
    ...
    def get_at_indices(self, id_at):
        ...
        Return:
            (dict): a mapping from atom indices to matrix indices
        """
        at_indices = {}
        for id_i in id_at:
            at_indices[id_i] = self.atoms[id_i].get('indices')
