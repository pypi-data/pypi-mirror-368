...
# just bringing one set of skip events for the coverage handler to hook onto
...
html_logo = p.join('sphinx_static', 'logo-bigdft-white.svg')
html_favicon = p.join('sphinx_static', 'bigdft-logo-reduced.svg')
...
# Remove the names of the modules from the documentation
...
# jinja_contexts = {'input_actions': { 'actions': { a: getattr(A,a).__doc__
# for a in dir(A) if '__' not in a and a !='dict_set'}}}
