...
class Translation(RotoTranslation):
    ...
    def __init__(self, t):
        import numpy
        self.R = None
        self.t = numpy.asmatrix(t).reshape(3, 1)
        self.J = 0.0
...
class Fragment(MutableSequence):
    ...
    def ellipsoid(self, center=0.0):
        ...
        """
        import numpy as np
        Imat = np.asmatrix(np.zeros(9).reshape(3, 3))
        for at in self:
    ...
    def rotate_on_axis(self, angle, axis, centroid=None, units="radians"):
        ...
        Args:
          ...
          centroid (lismatt): a list of floats defining the center from which
    ...
    def rotate(self, x=None, y=None, z=None, units="radians"):
        ...
        from numpy import asmatrix, identity
