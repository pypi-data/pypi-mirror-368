...
class BaseSchema(BaseModel):
    ...
    def from_json(cls, json: str, *, on_unknown_field_override=None) -> Self:  # noqa: ARG003 ignore for backward compat
        """Parse from JSON."""
    ...
    def replace(self: Self, **kwargs) -> Self:
        ...
        This is compatible with dataclasses.replace(self, ...).
        """

        # doesn't work with defaults? But does validate
