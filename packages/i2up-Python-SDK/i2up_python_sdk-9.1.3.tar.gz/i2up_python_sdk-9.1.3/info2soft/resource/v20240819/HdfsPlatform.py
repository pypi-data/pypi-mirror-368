...
class HdfsPlatform (object):
     ...
     * @return list
    '''
    def refreshHdfsHiveEntity(self, body):
        
        url = '{0}/hdfs_platform/refresh_hive_entity'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def maintainHdfsPlatform(self, body):
        
        url = '{0}/hdfs_platform/operate'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def listHdfsPlatformStatus(self, body):
        
        url = '{0}/hdfs_platform/status'.format(config.get_default('default_api_host'))
