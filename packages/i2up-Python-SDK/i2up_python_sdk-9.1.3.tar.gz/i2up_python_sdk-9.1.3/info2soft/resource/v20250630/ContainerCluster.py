...
class ContainerCluster (object):
    ...
    def createBackupDestination(self, body):
        ...
        url = '{0}/vers/v3/backup_destination'.format(config.get_default('default_api_host'))
    ...
    def descibeBackupDestination(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/backup_destination/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def listBackupDestinationStatus(self, body):
        ...
        url = '{0}/v3/backup_destination/status'.format(config.get_default('default_api_host'))
    ...
    def listContainerClusterInfo(self, body):
        ...
        url = '{0}/v3/container_cluster/cls_info'.format(config.get_default('default_api_host'))
    ...
    def syncContainerClusterInfo(self, body):
        ...
        url = '{0}/v3/container_cluster/sync_info'.format(config.get_default('default_api_host'))
    ...
    def listContainerClusterResource(self, body):
        ...
        url = '{0}/vers/v3/container_cluster/resource'.format(config.get_default('default_api_host'))
    ...
    def listContainerClsNamespace(self, body):
        ...
        url = '{0}/vers/v3/container_cluster/namespace'.format(config.get_default('default_api_host'))
    ...
    def createContainerCluster(self, body):
        ...
        url = '{0}/v3/container_cluster'.format(config.get_default('default_api_host'))
    ...
    def describeContainerCluster(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/v3/container_cluster/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def createCallbackSettings(self, body):
        ...
        url = '{0}/vers/v3/callback_settings'.format(config.get_default('default_api_host'))
    ...
    def describeCallbackSettings(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/callback_settings/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def cloneCallbackSettings(self, body):
        ...
        url = '{0}/v3/callback_settings/operate'.format(config.get_default('default_api_host'))
    ...
    def verifyCallbackSettingsPod(self, body):
        ...
        url = '{0}/v3/callback_settings/pod_verify'.format(config.get_default('default_api_host'))
