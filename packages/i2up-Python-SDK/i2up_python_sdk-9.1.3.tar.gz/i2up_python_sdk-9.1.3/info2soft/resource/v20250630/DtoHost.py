...
class DtoHost (object):
     ...
     * @return list
    '''
    def listDtoHostClusterNode(self, body):
        
        url = '{0}/dto/host/node'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def deleteDtoHostClusterNode(self, body):
