...
class OracleBkTakeover (object):
     ...
     * @return list
    '''
    def listBkTakeoverNetworkCard(self, body):
     ...
     * @return list
    '''
    def listSyncBkTakeoverStatus(self, body):
        
        url = '{0}/vers/v3/sync_bk_takeover/status'.format(config.get_default('default_api_host'))
