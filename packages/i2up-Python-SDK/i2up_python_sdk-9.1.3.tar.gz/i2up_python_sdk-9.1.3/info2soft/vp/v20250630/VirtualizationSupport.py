...
class VirtualizationSupport (object):
    ...
    def listVpBackupStatus(self, body):
        ...
        url = '{0}/vers/v3/vp/backup/status'.format(config.get_default('default_api_host'))
    ...
    def startVpBackup(self, body):
        ...
        url = '{0}/vers/v3/vp/backup/operate'.format(config.get_default('default_api_host'))
    ...
    def deleteVpBackupPoint(self, body):
        ...
        url = '{0}/vers/v3/vp/backup/backup_data'.format(config.get_default('default_api_host'))
    ...
    def listVpRecoveryStatus(self, body):
        ...
        url = '{0}/vers/v3/vp/recovery/status'.format(config.get_default('default_api_host'))
    ...
    def startVpRecovery(self, body):
        ...
        url = '{0}/vers/v3/vp/recovery/operate'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def startImmediatelyVpRep(self, body):
     ...
     * @return list
    '''
    def listMovePointList(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vp/rep/{1}/point_list'.format(config.get_default('default_api_host'), uuid)
     ...
     * @return list
    '''
    def describeSnapshotInfo(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vp/rep/{1}/snapshot_info'.format(config.get_default('default_api_host'), uuid)
    ...
    def listVpDrill(self, body):
        ...
        url = '{0}/vers/v3/vp/drill'.format(config.get_default('default_api_host'))
    ...
    def describeVpDrill(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/vp/drill/group/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def listVpDrillStatus(self, body):
        ...
        url = '{0}/vers/v3/vp/drill/status'.format(config.get_default('default_api_host'))
    ...
    def getConsoleUrl(self, body):
        ...
        url = '{0}/vers/v3/vp/drill/console_url'.format(config.get_default('default_api_host'))
    ...
    def stopVpDrill(self, body):
        ...
        url = '{0}/vers/v3/vp/drill/operate'.format(config.get_default('default_api_host'))
    ...
    def createVpFileRecovery(self, body):
        ...
        url = '{0}/vers/v3/vp/file_recovery'.format(config.get_default('default_api_host'))
    ...
    def modifyVpFileRecovery(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/vp/file_recovery/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def attachVpFileRecovery(self, body):
        ...
        url = '{0}/vers/v3/vp/file_recovery/operate'.format(config.get_default('default_api_host'))
    ...
    def listVpFileRecoveryStatus(self, body):
        ...
        url = '{0}/vers/v3/vp/file_recovery/status'.format(config.get_default('default_api_host'))
