...
class RepBackup (object):
    ...
    def listRepBackupCdpZfs(self, body):
        ...
        url = '{0}/vers/v3/rep/backup/cdp_zfs'.format(config.get_default('default_api_host'))
    ...
    def repBackupVerifyDevice(self, body):
        ...
        url = '{0}/vers/v3/rep/backup/verify_device'.format(config.get_default('default_api_host'))
    ...
    def getRepBackupCdpSnapNum(self, body):
        ...
        url = '{0}/vers/v3/rep/backup/cdp_snap_num'.format(config.get_default('default_api_host'))
    ...
    def createRepBackup(self, body):
        ...
        url = '{0}/vers/v3/rep/backup'.format(config.get_default('default_api_host'))
    ...
    def modifyRepBackup(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/rep/backup/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def startRepBackup(self, body):
        ...
        url = '{0}/vers/v3/rep/backup/operate'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def startSyncRepBackup(self, body):
     ...
     * @return list
    '''
    def stopSyncRepBackup(self, body):
    ...
    def listRepBackupStatus(self, body):
        ...
        url = '{0}/vers/v3/rep/backup/status'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def listRepBackupSyncStatus(self, body):
        
        url = '{0}/rep/backup/sync_status'.format(config.get_default('default_api_host'))
    ...
    def listRepBackupBaseLine(self, body):
        ...
        url = '{0}/vers/v3/rep/backup/cdp_bl_list'.format(config.get_default('default_api_host'))
    ...
    def listRepBackupSnapshot(self, body):
        ...
        url = '{0}/vers/v3/rep/backup/snapshot_list'.format(config.get_default('default_api_host'))
    ...
    def batchCreateRepBackup(self, body):
        ...
        url = '{0}/vers/v3/rep/backup/batch'.format(config.get_default('default_api_host'))
    ...
    def chkRules(self, body):
        ...
        url = '{0}/vers/v3/rep/backup/rules_chk'.format(config.get_default('default_api_host'))
