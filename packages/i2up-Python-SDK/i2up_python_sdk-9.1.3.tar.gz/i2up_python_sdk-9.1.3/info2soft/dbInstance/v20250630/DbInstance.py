...
class DbInstance (object):
    ...
    def verifyDbInstances(self, body):
        ...
        url = '{0}/vers/v3/db_instance/verify'.format(config.get_default('default_api_host'))
    ...
    def describeDbInstance(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/db_instance/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def listDbs(self, body):
        ...
        url = '{0}/vers/v3/db_instance/list_db'.format(config.get_default('default_api_host'))
    ...
    def listTables(self, body):
        ...
        url = '{0}/vers/v3/db_instance/list_tables'.format(config.get_default('default_api_host'))
    ...
    def listTableSpaces(self, body):
        ...
        url = '{0}/vers/v3/db_instance/list_table_spaces'.format(config.get_default('default_api_host'))
