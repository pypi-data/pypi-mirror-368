...
class Nas (object):
    ...
    def createNAS(self, body):
        ...
        url = '{0}/vers/v3/nas/sync'.format(config.get_default('default_api_host'))
    ...
    def listNasStatus(self, body):
        ...
        url = '{0}/vers/v3/nas/sync/status'.format(config.get_default('default_api_host'))
    ...
    def startNAS(self, body):
        ...
        url = '{0}/vers/v3/nas/sync/operate'.format(config.get_default('default_api_host'))
