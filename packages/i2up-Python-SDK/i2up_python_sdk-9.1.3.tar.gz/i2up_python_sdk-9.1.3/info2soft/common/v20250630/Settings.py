...
class Settings (object):
    ...
    def updateSecuritySetting(self, body):
        ...
        url = '{0}/vers/v3/sys/settings/security_settings'.format(config.get_default('default_api_host'))
    ...
    def describeCCip(self, body):
        ...
        url = '{0}/vers/v3/sys/settings/ips'.format(config.get_default('default_api_host'))
    ...
    def listPublicSettings(self, body):
        ...
        url = '{0}/vers/v3/sys/public_settings'.format(config.get_default('default_api_host'))
    ...
    def updateNotifySetting(self, body):
        ...
        url = '{0}/vers/v3/sys/settings/notify_settings'.format(config.get_default('default_api_host'))
    ...
    def updateNodeConf(self, body):
        ...
        url = '{0}/vers/v3/sys/settings/node_conf'.format(config.get_default('default_api_host'))
    ...
    def listDownloadCustomAudio(self, body):
        ...
        url = '{0}/vers/v3/sys/settings/custom_audio_list'.format(config.get_default('default_api_host'))
    ...
    def uploadDownloadCustomAudio(self, body):
        ...
        url = '{0}/vers/v3/sys/settings/custom_audio'.format(config.get_default('default_api_host'))
    ...
    def listErrorCode(self, body):
        ...
        url = '{0}/vers/v3/cc/error_code'.format(config.get_default('default_api_host'))
