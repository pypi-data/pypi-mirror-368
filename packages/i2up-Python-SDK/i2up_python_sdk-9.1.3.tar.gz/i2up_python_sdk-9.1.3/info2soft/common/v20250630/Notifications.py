...
class Notifications (object):
    ...
    def addNotifications(self, body):
        ...
        url = '{0}/vers/v3/notifications'.format(config.get_default('default_api_host'))
    ...
    def describeNotifications(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/notifications/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def readNotifications(self, body):
        ...
        url = '{0}/vers/v3/notifications/operate'.format(config.get_default('default_api_host'))
