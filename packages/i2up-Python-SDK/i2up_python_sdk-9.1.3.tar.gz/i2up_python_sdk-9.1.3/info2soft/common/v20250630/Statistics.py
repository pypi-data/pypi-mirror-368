...
class Statistics (object):
     ...
     * @return list
    '''
    def listStatisticsDisplayItems(self, body):
        
        url = '{0}/statistics/display_items'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def setStatisticsDisplayItems(self, body):
