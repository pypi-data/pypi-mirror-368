...
class RestrpcServer (object):
    ...
    def listRestRpcTasks(self, body):
        ...
        url = '{0}/api/client/rest_rpc/task_list'.format(config.get_default('default_api_host'))
    ...
    def addRestRpcLog(self, body):
        ...
        url = '{0}/api/client/rest_rpc/log'.format(config.get_default('default_api_host'))
