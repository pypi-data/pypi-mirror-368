...
class VpRecoveryRule (object):
     ...
     * @return list
    '''
    def createVpRecoveryRule(self, body):
    ...
    def listVpRecoveryRule(self, body):
        ...
        url = '{0}/vers/v3/vp/recovery_rule'.format(config.get_default('default_api_host'))
    ...
    def listVpRecoveryRuleStatus(self, body):
        ...
        url = '{0}/vers/v3/vp/recovery_rule/status'.format(config.get_default('default_api_host'))
