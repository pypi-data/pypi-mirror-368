...
class RepRecovery (object):
    ...
    def createRepRecovery(self, body):
        ...
        url = '{0}/vers/v3/rep/recovery'.format(config.get_default('default_api_host'))
    ...
    def describeRepRecovery(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/rep/recovery/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def startRepRecovery(self, body):
        ...
        url = '{0}/vers/v3/rep/recovery/operate'.format(config.get_default('default_api_host'))
    ...
    def listRepRecoveryStatus(self, body):
        ...
        url = '{0}/vers/v3/rep/recovery/status'.format(config.get_default('default_api_host'))
    ...
    def listRepRecoveryCdpRange(self, body):
        ...
        url = '{0}/vers/v3/rep/recovery/cdp_range'.format(config.get_default('default_api_host'))
    ...
    def listRepRecoveryCdpLog(self, body):
        ...
        url = '{0}/vers/v3/rep/recovery/cdp_log'.format(config.get_default('default_api_host'))
