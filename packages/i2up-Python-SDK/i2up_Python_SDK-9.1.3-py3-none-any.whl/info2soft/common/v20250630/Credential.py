...
class Credential (object):
    ...
    def listCredential(self, body):
        ...
        url = '{0}/vers/v3/credential'.format(config.get_default('default_api_host'))
    ...
    def describeCredential(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/credential/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def batchImportCredential(self, body):
        ...
        url = '{0}/vers/v3/credential/batch'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def listBindUkey(self, body):
        
        url = '{0}/credential/ukey_list'.format(config.get_default('default_api_host'))
