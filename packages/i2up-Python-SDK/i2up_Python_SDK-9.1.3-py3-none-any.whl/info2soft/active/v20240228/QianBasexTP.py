...
class QianBasexTP (object):
     ...
     * @return list
    '''
    def listQianbasexTPRule(self, body):
     ...
     * @return list
    '''
    def createQianbasexTPRule(self, body):
     ...
     * @return list
    '''
    def modifyQianbasexTPRule(self, body):
     ...
     * @return list
    '''
    def deleteQianbasexTPRule(self, body):
     ...
     * @return list
    '''
    def listQianbasexTPStatus(self, body):
     ...
     * @return list
    '''
    def listQianbasexTPRuleLog(self, body):
