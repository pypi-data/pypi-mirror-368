...
class OracleRule (object):
     ...
     * @return list
    '''
    def diffFix(self, body):
        
        url = '{0}/active/tb_cmp/diff_fix'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def describeTbCmpResultTimeList(self, body):
    ...
    def describeTbCmpCmpResult(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/active/tb_cmp/{1}/cmp_result/'.format(config.get_default('default_api_host'), uuid)
     ...
     * @return list
    '''
    def deleteTbCmpOracle(self, body):
        
        url = '{0}/active/tb_cmp/tb_cmp_oracle'.format(config.get_default('default_api_host'))
    ...
    def listBkTakeoveNetworkCard(self, body):
        ...
        url = '{0}/vers/v3/active/bk_takeover/bk_network_card'.format(config.get_default('default_api_host'))
    ...
    def createBkTakeover(self, body):
        ...
        url = '{0}/vers/v3/active/bk_takeover'.format(config.get_default('default_api_host'))
    ...
    def describeBkTakeover(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/vers/v3/active/bk_takeover/{1}'.format(config.get_default('default_api_host'), uuid)
    ...
    def describeBkTakeoverResult(self, body):
        ...
        url = '{0}/vers/v3/active/bk_takeover/result'.format(config.get_default('default_api_host'))
    ...
    def stopBkTakeover(self, body):
        ...
        url = '{0}/vers/v3/active/bk_takeover/operate'.format(config.get_default('default_api_host'))
    ...
    def listBkTakeoverStatus(self, body):
        ...
        url = '{0}/vers/v3/active/bk_takeover/status'.format(config.get_default('default_api_host'))
    ...
    def createReverse(self, body):
        ...
        url = '{0}/vers/v3/active/reverse'.format(config.get_default('default_api_host'))
    ...
    def describeReverse(self, body):
        ...
        url = '{0}/vers/v3/active/reverse/rule_single'.format(config.get_default('default_api_host'))
    ...
    def listReverseStatus(self, body):
        ...
        url = '{0}/vers/v3/active/reverse/status'.format(config.get_default('default_api_host'))
    ...
    def stopReverse(self, body):
        ...
        url = '{0}/vers/v3/active/reverse/stop'.format(config.get_default('default_api_host'))
    ...
    def restartReverse(self, body):
        ...
        url = '{0}/vers/v3/active/reverse/restart'.format(config.get_default('default_api_host'))
