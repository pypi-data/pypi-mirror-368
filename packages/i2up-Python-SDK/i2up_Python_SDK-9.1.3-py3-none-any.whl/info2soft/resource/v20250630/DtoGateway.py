...
class DtoGateway (object):
     ...
     * @return list
    '''
    def listDtoGatewayCert(self, body):
        
        url = '{0}/vers/v3/dto_gateway_cert'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def deleteDtoGatewayCert(self, body):
     ...
     * @return list
    '''
    def createDtoGatewayCert(self, body):
