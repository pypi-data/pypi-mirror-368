...
class Node (object):
    ...
    def precreateNode(self, body):
        ...
        url = '{0}/node/precreate'.format(config.get_default('default_api_host'))
    ...
    def describeNodeInfo(self, body, uuid):
        if uuid is None:
            exit()
        url = '{0}/node/{1}/info'.format(config.get_default('default_api_host'), uuid)
    ...
    def batchAuthNode(self, body):
        ...
        url = '{0}/node/batch_auth'.format(config.get_default('default_api_host'))
    ...
    def listKernels(self, body):
        ...
        url = '{0}/node/kernels'.format(config.get_default('default_api_host'))
