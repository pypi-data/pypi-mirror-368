...
class Dto (object):
     ...
     * @return list
    '''
    def listDtoRuleSyncStatus(self, body):
        
        url = '{0}/dto/rule/sync_status'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def getDtoRecoveryPoint(self, body):
        
        url = '{0}/dto/rule/rc_point'.format(config.get_default('default_api_host'))
     ...
     * @return list
    '''
    def downloadDtoRuleReport(self, body):
        
        url = '{0}/dto/rule/download_report'.format(config.get_default('default_api_host'))
