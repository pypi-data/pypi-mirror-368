...
exports.VibeCommands = void 0;
const vscode = require("vscode");
/**
 * Handles Vibe workflow commands
 */
class VibeCommands {
    constructor(context, mcpServerManager, workflowProvider) {
    ...
    async startWorkflow() {
        ...
        if (!this.mcpServerManager.getStatus().running) {
            const startServer = await vscode.window.showInformationMessage('Vibe MCP server is not running. Start it now?', 'Yes', 'No');
            if (startServer === 'Yes') {
    ...
    async openWorkflowGuide() {
        const panel = vscode.window.createWebviewPanel('vibeWorkflowGuide', 'Vibe Workflow Guide', vscode.ViewColumn.One, {
            enableScripts: true,
     ...
     */
    async simulateWorkflowExecution(input, progress) {
        const steps = [
            'Analyzing request...',
     ...
     */
    async executeWorkflow(workflow, progress) {
...
exports.VibeCommands = VibeCommands;
//# sourceMappingURL=vibeCommands.js.map