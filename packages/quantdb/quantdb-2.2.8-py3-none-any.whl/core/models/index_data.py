...
class IndexData(Base):
    ...
    symbol = Column(String(20), nullable=False, index=True, comment="Index symbol (e.g., '000001', '399001')")
...
class IndexListCache(Base):
    ...
    # Cache metadata
    cache_date = Column(Date, nullable=False, default=date.today, 
                       comment="Date when data was cached")
    created_at = Column(DateTime, nullable=False, default=datetime.utcnow,
                       comment="Record creation time")
    updated_at = Column(DateTime, nullable=False, default=datetime.utcnow,
                       onupdate=datetime.utcnow, comment="Record update time")
...
class IndexListCacheManager(Base):
    ...
    total_count = Column(Integer, nullable=False, default=0,
                        comment="Total number of indexes cached")
    created_at = Column(DateTime, nullable=False, default=datetime.utcnow,
