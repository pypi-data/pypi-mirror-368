...
if __name__ == '__main__':
    ...
    plot_hardness_evaluation_all([
        ...
        title=f'{pretrusted_percentage}% of PRE-TRUSTED PEERS',
        save_output=f'{pretrusted_percentage}_target_detection.png'
    )
    ...
    plot_hardness_evaluation_all([
        ...
        title=f'{pretrusted_percentage}% of PRE-TRUSTED PEERS',
        save_output=f'{pretrusted_percentage}_peer_trust.png'
    )
