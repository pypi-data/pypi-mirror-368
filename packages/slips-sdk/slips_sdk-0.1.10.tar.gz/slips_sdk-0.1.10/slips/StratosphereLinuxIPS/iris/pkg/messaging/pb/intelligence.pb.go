...
type IntelligenceResponse struct {
	...
	Responses [][]byte `protobuf:"bytes,4,rep,name=responses,proto3" json:"responses,omitempty"`
}
...
func (x *IntelligenceResponse) GetProcessed() bool {
	if x != nil {
		return x.Processed
	}
	return false
...
func (x *SingleEntityResponse) Reset() {
	*x = SingleEntityResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SingleEntityResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SingleEntityResponse) ProtoMessage() {}

func (x *SingleEntityResponse) ProtoReflect() protoreflect.Message {
	mi := &file_intelligence_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SingleEntityResponse.ProtoReflect.Descriptor instead.
func (*SingleEntityResponse) Descriptor() ([]byte, []int) {
	return file_intelligence_proto_rawDescGZIP(), []int{3}
}

func (x *SingleEntityResponse) GetMetadata() *MetaData {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *SingleEntityResponse) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
var file_intelligence_proto_rawDesc = []byte{
	...
	,
	...
	0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x14, 0x5a, 0x12, 0x2e, 0x2f, 0x70, 0x6b, 0x67,
	0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_intelligence_proto_goTypes = []interface{}{
	...
	(*SingleEntityResponse)(nil),    // 3: pb.SingleEntityResponse
...
var file_intelligence_proto_depIdxs = []int32{
	...
	4, // 1: pb.IntelligenceRequest.metadata:type_name -> pb.MetaData
	4, // 2: pb.IntelligenceResponse.metadata:type_name -> pb.MetaData
	4, // 3: pb.SingleEntityResponse.metadata:type_name -> pb.MetaData
...
func file_intelligence_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_intelligence_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SingleEntityResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
