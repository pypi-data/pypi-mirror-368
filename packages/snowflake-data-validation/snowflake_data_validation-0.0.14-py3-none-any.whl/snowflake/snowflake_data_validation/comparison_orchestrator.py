...
from snowflake.snowflake_data_validation.utils.constants import (
    TEMPORARY_DEFAULT_OPTIMAL_POOL_SIZE,
    ExecutionMode,
)
...
class ComparisonOrchestrator:
    ...
    def from_validation_environment(
        ...
        optimal_max_threads: int = CpuOptimizer.get_optimal_thread_count(
            num_tables=num_tables, max_threads=max_threads_config
        )
        # Hardcoded optimal pool size for now, can be adjusted later on based on changes in SnowConvert AI
        optimal_pool_size: int = (
            TEMPORARY_DEFAULT_OPTIMAL_POOL_SIZE  # optimal_max_threads
        )
