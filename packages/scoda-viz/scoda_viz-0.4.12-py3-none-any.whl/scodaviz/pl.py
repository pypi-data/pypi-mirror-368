...
def plot_cnv( adata_in, groupby = 'ploidy_dec', N_cells_min = 20, N_cells_max = 0.4,
    ...
    if spot_llst is None:
        if show_cna_spots:
            results = find_signif_CNV_gain_regions( adata, std_scale = 0.5, 
                                            gmm_ncomp_t = 3, gmm_ncomp_n = 1, 
                                            n_cells_min = 50, n_samples_min = 4 )
