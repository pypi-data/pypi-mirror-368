...
class CommitsApi:
    ...
    def commit(self, repository : StrictStr, branch : StrictStr, commit_creation : CommitCreation, source_metarange : Annotated[Optional[StrictStr], Field(description="The source metarange to commit. Branch must not have uncommitted changes.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[Commit, Awaitable[Commit]]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the commit_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def get_commit(self, repository : StrictStr, commit_id : StrictStr, async_req: Optional[bool]=None, **kwargs) -> Union[Commit, Awaitable[Commit]]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_commit_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
