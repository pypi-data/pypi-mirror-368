...
class MetadataApi:
    ...
    def get_meta_range(self, repository : StrictStr, meta_range : StrictStr, async_req: Optional[bool]=None, **kwargs) -> Union[StorageURI, Awaitable[StorageURI]]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_meta_range_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def get_range(self, repository : StrictStr, range : StrictStr, async_req: Optional[bool]=None, **kwargs) -> Union[StorageURI, Awaitable[StorageURI]]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_range_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
