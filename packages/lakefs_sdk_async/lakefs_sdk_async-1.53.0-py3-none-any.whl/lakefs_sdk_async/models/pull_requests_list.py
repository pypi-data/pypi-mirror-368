...
class PullRequestsList(BaseModel):
    ...
    results: conlist(PullRequest) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PullRequestsList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PullRequestsList:
        """Create an instance of PullRequestsList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PullRequestsList.parse_obj(obj)

        _obj = PullRequestsList.parse_obj({
            "pagination": Pagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "results": [PullRequest.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
