currency_data = {
    ...
    "AUD": {"symbol": "$", "name": "Australian dollar", "prefix": ["A$", "AU$"]},
    ...
    "CAD": {"symbol": "$", "name": "Canadian dollar", "prefix": ["CAN$", "CA$", "C$"]},
    "CDF": {"symbol": "F", "name": "Congolese franc"},
    "CHF": {"symbol": "Fr.", "name": "Swiss franc"},
    "CLP": {"symbol": "$", "name": "Chilean peso"},
    "CNY": {"symbol": "\u00a5", "name": "Chinese Yuan", "prefix": ["Yuan", "renminbi"]},
    ...
    "PKR": {"symbol": "Rs.", "name": "Pakistani rupee", "prefix": ["Rs"]},
    ...
    "USD": {"symbol": "$", "name": "United States dollar", "prefix": ["US$", "dollar"]},
...
def _convert_normalize_currency_mapping(mapping):
    retval = {}
    for cc, currency in mapping.items():
        retval[cc.lower()] = cc
        if "prefix" in currency:
            for value in currency["prefix"]:
                retval[value.lower()] = cc
        if "symbol" in currency and "$" in currency["symbol"]:
            retval[currency["symbol"].lower()] = cc
        if "name" in currency:
            retval[currency["name"].lower()] = cc

    return retval


normalize_currency_data = _convert_normalize_currency_mapping(currency_data)
