...
def main():
    ...
    # Decomposition
    decomposer = DecomposeQuestion(api_key=api_key, model=model, base_url=base_url)
    ...
    question_filter = QuestionFilter(api_key=api_key, model=model, base_url=base_url)
    ...
    # Feed to LLM
    llm_caller = final_query(api_key=api_key, model=model, base_url=base_url)
    print("\n--- Querying LLM --- \n")
