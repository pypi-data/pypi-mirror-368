...
DATA_LOADING_TESTING_SPEC = StepSpecification(
    ...
    outputs=[
        OutputSpec(
            ...
            semantic_keywords=["testing", "test", "data", "input", "raw", "dataset", "model_testing", "source"]
        ),
        OutputSpec(
            ...
            semantic_keywords=["testing", "test", "metadata", "schema", "info", "description", "model_testing"]
        ),
        OutputSpec(
            ...
            semantic_keywords=["testing", "test", "signature", "validation", "checksum", "model_testing"]
        )
    ]
)
