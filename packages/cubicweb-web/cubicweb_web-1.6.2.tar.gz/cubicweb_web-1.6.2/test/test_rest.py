...
""",
    ...
    def test_rql_role_with_vid(self):
        with self.admin_access.web_request() as req:
            ...
            self.assertTrue(
                out.endswith(
                    f'<a href="{BASE_URL}cwuser/anon" '
                    f'title="">anon</a></td></tr>\n</tbody></table>'
                    f"</div></p>\n"
                )
            )
    ...
    def test_rql_role_without_vid(self):
        with self.admin_access.web_request() as req:
            ...
            self.assertEqual(
                out,
                f'<p><h1>CWUser_plural</h1><div class="section">'
                f'<a href="{BASE_URL}cwuser/admin" title="">admin</a>'
                f'</div><div class="section">'
    ...
    def test_bookmark_role(self):
        with self.admin_access.web_request() as req:
            ...
            self.assertEqual(
                out,
                f'<p><h1>CWUser_plural</h1><div class="section">'
                f'<a href="{BASE_URL}cwuser/admin" title="">admin'
                f'</a></div><div class="section">'
                f'<a href="{BASE_URL}cwuser/anon" title="">anon'
                f"</a></div></p>\n",
            )
