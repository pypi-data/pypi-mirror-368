...
class ScalarAffineFunction:
    ...
    @overload
    @staticmethod
    def from_numpy(coefficients: Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='A', writable=False)], variables: Annotated[ArrayLike, dict(dtype='int32', shape=(None), order='A', writable=False)]) -> ScalarAffineFunction: ...

    @overload
    @staticmethod
    def from_numpy(coefficients: Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='A', writable=False)], variables: Annotated[ArrayLike, dict(dtype='int32', shape=(None), order='A', writable=False)], constant: float) -> ScalarAffineFunction: ...
...
class ScalarQuadraticFunction:
    ...
    @property
    def affine_part(self) -> Optional[ScalarAffineFunction]: ...
