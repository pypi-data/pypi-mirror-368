...
class DistributedDataParallel(MegatronModule):
    ...
    def __init__(
        ...
        self.param_to_bucket_group = {}  # type: ignore
        ...
        def _allocate_buffers_for_parameters(input_params, data_parallel_group, gradient_scaling_factor):
            ...
            if not config.calculate_per_token_loss:
                ...
                if self.ddp_config.average_in_collective:
                    ...
                    assert (
                        gradient_scaling_factor / torch.distributed.get_world_size(group=data_parallel_group)
            ...
            bucket_groups = partition_buckets(
                buffers, force_single_bucket_group=disable_bucketing, local_sgd_config=local_sgd_config
            )
            ...
            if self.ddp_config.use_distributed_optimizer and self.ddp_config.overlap_param_gather:
                ...
                for i in range(1, num_bucket_groups):
                    bucket_groups[num_bucket_groups - i].next_param_gather_bucket_group = bucket_groups[
        ...
        if config.calculate_per_token_loss:
            ...
            if self.ddp_config.average_in_collective:
                gradient_scaling_factor = 1.0
                expert_gradient_scaling_factor = 1.0 / parallel_state.get_expert_model_parallel_world_size()
            else:
        ...
        self.remove_forward_pre_hook_handles = {}  # type: ignore # NOQA
    ...
    def _make_forward_pre_hook(self):
        ...
        def hook(module, *unused):
            assert self.use_forward_hook, "Should use pre-hook only when overlap_param_gather is True"
            ...
            for param in module.parameters(recurse=False):
                ...
                self.param_to_bucket_group[param].finish_param_sync(skip_next_bucket_dispatch=skip_next_bucket_dispatch)
    ...
    def broadcast_params(self):
        ...
        for param in self.module.parameters():
            ...
            if is_expert_parallel:
                data_parallel_group = parallel_state.get_data_modulo_expert_parallel_group(with_context_parallel=True)
            else:
