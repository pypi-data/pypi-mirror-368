...
SubMessage1 = _reflection.GeneratedProtocolMessageType(
    "SubMessage1",
    (_message.Message,),
    {
...
SubMessage2 = _reflection.GeneratedProtocolMessageType(
    "SubMessage2",
    (_message.Message,),
    {
...
MessageBytesExtra = _reflection.GeneratedProtocolMessageType(
    "MessageBytesExtra",
    (_message.Message,),
    {
