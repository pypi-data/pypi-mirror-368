...
import cohesity_management_sdk.models.view_protocol
...
class View(object):
    ...
    Attributes:
        ...
        enable_live_indexing (bool): Specifies whether to enable live indexing
            for the view.
        enable_meta_data_accelerator (bool): Specifies whether view is blur enabled.
        ...
        s_3_access_path (string): Specifies the path to access this View as an
            S3 share.
        s_3_folder_support_enabled (bool): Specifies whether to support s3 folder
            support feature on the view. This
        ...
        view_pinning_config (ViewPinningConfig): Specifies the pinning config of this view.
        view_protection (ViewProtection): Specifies information about the
            Protection Jobs that are protecting the View.
        view_protocol (ViewProtocol): Specifies the supported Protocols for the View.
    ...
    _names = {
        ...
        "enable_meta_data_accelerator":'enableMetadataAccelerator',
    ...
    def __init__(self,
                 ...
                 enable_meta_data_accelerator=None,
        ...
        self.enable_meta_data_accelerator  = enable_meta_data_accelerator
    ...
    def from_dictionary(cls,
        ...
        enable_meta_data_accelerator = dictionary.get('enableMetadataAccelerator')
        ...
        netgroup_whitelist = None
        if dictionary.get("netgroupWhitelist") is not None:
        ...
        view_protocol = None
        if dictionary.get("viewProtocol") is not None:
            view_protocol = list()
            for structure in dictionary.get('viewProtocol'):
                view_protocol.append(
                    cohesity_management_sdk.models.view_protocol.ViewProtocol.from_dictionary(structure))
