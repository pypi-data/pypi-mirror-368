...
class ApplicationInfo(object):
    ...
    Attributes:
        ...
        environment (EnvironmentApplicationInfoEnum): Specifies the
            environment type of the application such as 'kSQL', 'kExchange'
            registered on the Protection Source. overrideDescription: true
            ...
            Protection Source environment. 'kRDSSnapshotManager' indicates
            AWS RDS Protection Source environment. 'kCassandra' indicates
    ...
    def from_dictionary(cls,
        ...
        application_tree_info = None
        if dictionary.get("applicationTreeInfo") is not None:
        ...
        return cls(application_tree_info,
                   environment)
