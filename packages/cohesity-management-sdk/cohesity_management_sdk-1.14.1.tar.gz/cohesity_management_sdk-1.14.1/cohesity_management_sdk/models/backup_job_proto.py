...
import cohesity_management_sdk.models.cloud_backup_job_pre_or_post_script
import cohesity_management_sdk.models.configuration_params
import cohesity_management_sdk.models.data_transfer_info
import cohesity_management_sdk.models.cancellation_timeout
...
class BackupJobProto(object):
    ...
    Attributes:
        ...
        cloud_post_backup_script (CloudBackupJobPreOrPostScript): Post backup
            script associated with the backup job for cloud based backups.
            (AWS, Azure, GCP)
        cloud_post_snapshot_script (CloudBackupJobPreOrPostScript): Post Snapshot
            script associated with the backup job for cloud based backups.
            (AWS, Azure, GCP)
        cloud_pre_backup_script (CloudBackupJobPreOrPostScript): Pre backup
            script associated with the backup job for cloud based backups.
            (AWS, Azure, GCP)
        config_vec (list of ConfigurationParams): Common Backup Configuration
            Parameters
        continue_on_error (bool): Indicates whether the backup should be failed on encountering an error.
        ...
        create_remote_view (bool): If set to false, a remote view will not be
            ...
            jobs (kPuppeteer).
        data_transfer_info (DataTransferInfo): Currently it is being used
            for Azure Native Backups.
        ...
        is_active (bool): Whether the backup job is active or not. Details
            ...
            https://goo.gl/1mLvS3.
        is_cdp_sync_replication_enabled (bool): If set to true and backup job policy
            has CDP parameters as well as snapshot replication target policy is
            specified then data is synchronously replicated to the replication
            target through Atom service.
        is_cloud_archive_direct (bool): Denotes whether the backup job is
            ...
            NAS direct archive jobs in native format can be
        ...
        is_source_paused_map (bool): A map from entity id of the source to
            whether the source backup is paused.
        ...
        last_pause_reason (int): Last reason for pausing the backup job.
            ...
            applicable.
        last_paused_by_username (string): The user who paused this protection group.
        last_start_time_modification_time_usecs (long|int):  Time when this job
            description was last updated.
        ...
        leverage_nutanix_snapshots (bool): This is set to true by the user if
            nutanix snapshot is requested
            This is applicable in case if the vcenter in question is registered
            as a management server on a prism endpoint. This flag will be
            ignored at the backend if it is not feasible to leverage nutanix
            snapshot.
        ...
        paused_note (string): Paused note provided by user containing the reasoning for pausing future
          runs if any.
        ...
        post_snapshot_script (BackupJobPreOrPostScript): Post snapshot script
        ...
        remote_view_params (BackupJobProto_RemoteViewParams): TODO:
        ...
        task_timeout_vec (list of CancellationTimeout): This is a vector of
            timeouts, for different backup types(kFull, kRegular). A
            cancellation will automatically gets triggered if the backup tasks
            inside a run has been running for more than this timeout duration.
    ...
    _names = {
        ...
        "cloud_post_backup_script": 'cloudPostBackupScript',
        "cloud_post_snapshot_script": 'cloudPostSnapshotScript',
        "cloud_pre_backup_script": 'cloudPreBackupScript',
        "config_vec": 'configVec',
        ...
        "last_start_time_modification_time_usecs": 'lastStartTimeModificationTimeUsecs',
        ...
        "tag_vec":'tagVec',
        "task_timeout_vec": 'taskTimeoutVec',
        "timezone":'timezone',
    ...
    def __init__(self,
                 ...
                 cloud_post_backup_script=None,
                 cloud_post_snapshot_script=None,
                 cloud_pre_backup_script=None,
                 config_vec=None,
                 ...
                 last_start_time_modification_time_usecs=None,
        ...
        self.cloud_post_backup_script = cloud_post_backup_script
        self.cloud_post_snapshot_script = cloud_post_snapshot_script
        self.cloud_pre_backup_script = cloud_pre_backup_script
        self.config_vec = config_vec
        ...
        self.last_start_time_modification_time_usecs = last_start_time_modification_time_usecs
        ...
        self.task_timeout_vec = task_timeout_vec
    ...
    def from_dictionary(cls,
        ...
        backup_source_params = None
        if dictionary.get("backupSourceParams") is not None:
        ...
        cloud_post_backup_script = cohesity_management_sdk.models.cloud_backup_job_pre_or_post_script.CloudBackupJobPreOrPostScript.from_dictionary(dictionary.get('cloudPostBackupScript')) if dictionary.get('cloudPostBackupScript') else None
        cloud_post_snapshot_script = cohesity_management_sdk.models.cloud_backup_job_pre_or_post_script.CloudBackupJobPreOrPostScript.from_dictionary(dictionary.get('cloudPostSnapshotScript')) if dictionary.get('cloudPostSnapshotScript') else None
        cloud_pre_backup_script = cohesity_management_sdk.models.cloud_backup_job_pre_or_post_script.CloudBackupJobPreOrPostScript.from_dictionary(dictionary.get('cloudPreBackupScript')) if dictionary.get('cloudPreBackupScript') else None
        config_vec = None
        if dictionary.get("configVec") is not None:
            config_vec = list()
            for structure in dictionary.get('configVec'):
                config_vec.append(cohesity_management_sdk.models.configuration_params.ConfigurationParams.from_dictionary(structure))
        ...
        exclude_sources = None
        if dictionary.get("excludeSources") is not None:
        ...
        exclude_sources_deprecated = None
        if dictionary.get("excludeSources_DEPRECATED") is not None:
        ...
        exclusion_ranges = None
        if dictionary.get("exclusionRanges") is not None:
        ...
        ignorable_errors_in_error_db = None
        if dictionary.get('ignorableErrorsInErrorDb'):
        ...
        is_source_paused_map = dictionary.get('isSourcePausedMap')
        ...
        last_start_time_modification_time_usecs = dictionary.get('lastStartTimeModificationTimeUsecs')
        ...
        post_snapshot_script = cohesity_management_sdk.models.backup_job_pre_or_post_script.BackupJobPreOrPostScript.from_dictionary(dictionary.get('postSnapshotScript')) if dictionary.get('postSnapshotScript') else None
        ...
        remote_job_uids = None
        if dictionary.get("remoteJobUids") is not None:
        ...
        standby_resource_vec = None
        if dictionary.get("standbyResourceVec") is not None:
        ...
        task_timeout_vec = None
        if dictionary.get("taskTimeoutVec") is not None:
            task_timeout_vec = list()
            for structure in dictionary.get('taskTimeoutVec'):
                task_timeout_vec.append(cohesity_management_sdk.models.cancellation_timeout.CancellationTimeout.from_dictionary(structure))
        ...
        return cls(abort_in_exclusion_window,
                   ...
                   cloud_post_backup_script,
                   cloud_post_snapshot_script,
                   cloud_pre_backup_script,
                   config_vec,
                   continue_on_error,
                   ...
                   last_start_time_modification_time_usecs,
