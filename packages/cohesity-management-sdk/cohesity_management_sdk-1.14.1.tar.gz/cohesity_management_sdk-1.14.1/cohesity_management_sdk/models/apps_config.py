...
class AppsConfig(object):
    ...
    Attributes:
        ...
        node_ids (list of long|int64): ID of nodes in the cluster
        overcommit_memory_pct (int): The system memory to overcommit for
            apps.
        override_node_resource_reservation (bool): Override node level resource
            reservation with cluster level
    ...
    _names = {
        ...
        "override_node_resource_reservation":'OverrideNodeResourceReservation',
    ...
    def __init__(self,
                 ...
                 override_node_resource_reservation=None,
        ...
        self.override_node_resource_reservation = override_node_resource_reservation
    ...
    def from_dictionary(cls,
        ...
        override_node_resource_reservation = dictionary.get('OverrideNodeResourceReservation')
        ...
        return cls(
                   ...
                   override_node_resource_reservation,
