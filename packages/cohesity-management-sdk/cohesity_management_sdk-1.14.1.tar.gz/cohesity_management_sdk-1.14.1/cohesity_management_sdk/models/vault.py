...
import cohesity_management_sdk.models.cloud_domain_list
...
class Vault(object):
    ...
    Attributes:
        ...
        cloud_domain_list (list of CloudDomainList): Specifies the cloud domain
            information.
        compression_policy (CompressionEnum): Specifies whether to send data to
            the Vault in a compressed format. 'kCompressionNone' indicates that
            data is not compressed. 'kCompressionLow' indicates that data is
            compressed using LZ4 or Snappy. 'kCompressionHigh' indicates that
            data is compressed in Gzip.
        config (VaultConfig): Specifies the settings required to connect to the
        ...
        encryption_policy (EncryptionLevelEnum): Specifies whether to send and
            store data in an encrypted format. 'kEncryptionNone' indicates the
            data is not encrypted. 'kEncryptionStrong' indicates the data is
            encrypted.
        ...
        full_archive_interval_days (long|int): Specifies the number days
            between full archives to the Vault. The current default is 90 days.
            This is only meaningful when incrementalArchivesEnabled is true and
            the Vault usage type is kArchival.
        global_id (string): Specifies the global identifier of the Vault.
        id (long|int): Specifies an id that identifies the Vault.
        incremental_archives_enabled (bool): Specifies whether to perform
            incremental archival when sending data to the Vault. If false, only
            full backups are performed. If true, incremental backups are
        ...
        is_password_encrypted (bool): Specifies if given password is not
            encrypted or not in the cluster config.
        ...
        removal_state (RemovalStateVaultEnum): Specifies the state of the vault
            to be removed. 'kDontRemove' means the state of object is
        ...
        mtype (TypeVaultEnum): Specifies the type of Vault. This field is
            ...
            (See the online help for supported types.) 'kQStarTape' indicates a
            QStar Tape Vault. 'kGoogleStandard' indicates a Google Standard
            Vault. 'kGoogleDRA' indicates a Google DRA Vault.
            'kAmazonS3StandardIA' indicates an Amazon S3 Standard-IA Vault.
            'kAWSGovCloud' indicates an AWS Gov Cloud Vault. 'kNAS' indicates a
            NAS Vault. 'kColdline' indicates a Google Coldline Vault.
            ...
            Vault. 'kOracleTierArchive' indicates an Oracle Tier Archive Vault.
        ...
        usage_type (UsageTypeEnum): Specifies the usage type of the Vault.
            'kArchival' indicates the Vault provides archive storage for backup
            data. 'kCloudSpill' indicates the Vault provides additional storage
            for cold data. 'kRpaasArchival' indicates the Vault is for RPaaS.
        vault_bandwidth_limits (VaultBandwidthLimits): Specifies bandwidth
            limit.
        vault_ownership (OwnershipContextEnum): Specifies the ownership context
            for consumption. 'kOwnershipContextLocal' indicates the Vault is
            used for local consumption 'kOwnershipContextFortKnox' indicates
            the Vault is used for Fortknox consumption
        view_box_name (string): Specifies the name of the associated viewbox
            that is to be created while registering vault in NextGen CE.
    """
    ...
    _names = {
        ...
        "cloud_domain_list":'cloudDomainList',
        ...
        "vault_ownership":'vaultOwnership',
    ...
    def __init__(self,
        ...
        self.cloud_domain_list = cloud_domain_list
        ...
        self.vault_ownership = vault_ownership
    ...
    def from_dictionary(cls,
        ...
        cloud_domain_list = None
        if dictionary.get("cloudDomainList") is not None:
            cloud_domain_list = list()
            for structure in dictionary.get('cloudDomainList'):
                cloud_domain_list.append(cohesity_management_sdk.models.cloud_domain_list.CloudDomainList.from_dictionary(structure))
        ...
        vault_ownership = dictionary.get('vaultOwnership')
