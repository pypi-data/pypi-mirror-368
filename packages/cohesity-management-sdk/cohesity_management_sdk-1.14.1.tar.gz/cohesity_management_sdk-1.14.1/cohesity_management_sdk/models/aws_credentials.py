...
class AwsCredentials(object):
    ...
    Attributes:
        ...
        aws_type (AwsTypeEnum): Specifies the entity type such as 'kIAMUser'
            ...
            'kSubTaskPermit' entity type will be used by slave sub-tasks to take
            permit for native backups,
            so that we can control the number of concurrent sub-tasks independent
            of the number of VMs being backed up concurrently.
