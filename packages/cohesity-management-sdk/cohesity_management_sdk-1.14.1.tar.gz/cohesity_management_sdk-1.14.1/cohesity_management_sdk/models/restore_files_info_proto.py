...
class RestoreFilesInfoProto(object):
    ...
    Attributes:
        ...
        expiry_time_usecs (long|int): The expiry time of the view. Applicable
            for download files task (if filled by adapter)
    ...
    def from_dictionary(cls,
        ...
        restore_files_result_vec = None
        if dictionary.get("restoreFilesResultVec") is not None:
