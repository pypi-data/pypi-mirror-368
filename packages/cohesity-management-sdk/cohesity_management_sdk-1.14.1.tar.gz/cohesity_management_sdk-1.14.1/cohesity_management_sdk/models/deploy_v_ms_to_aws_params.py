...
class DeployVMsToAWSParams(object):
    ...
    Attributes:
        ...
        custom_tag_vec (list of CustomTag): Custom Tags to be applied to
            ...
            and Deploy.
        encryption_params (EncryptionParams): This field defines the encryption params for restore task of type
    ...
    def from_dictionary(cls,
        ...
        encryption_params = cohesity_management_sdk.models.encryption_params.EncryptionParams.from_dictionary(
            dictionary.get('encryptionParams')) if dictionary.get('encryptionParams') else None
        ...
        network_security_groups = None
        if dictionary.get("networkSecurityGroups") is not None:
