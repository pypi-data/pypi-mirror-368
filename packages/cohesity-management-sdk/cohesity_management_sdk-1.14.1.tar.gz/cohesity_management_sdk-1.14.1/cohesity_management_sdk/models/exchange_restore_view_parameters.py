...
class ExchangeRestoreViewParameters(object):
    ...
    Attributes:
        endpoint (bool): Specifies whether we should allow all the IP
            addresses to be part of the allowlist. If this parameter is set to
            false, then only the machine on which the view is mounted will be
            allowed.
