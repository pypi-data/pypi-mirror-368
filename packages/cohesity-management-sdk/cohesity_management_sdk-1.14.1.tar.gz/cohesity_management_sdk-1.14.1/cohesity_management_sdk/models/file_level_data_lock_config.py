...
class FileLevelDataLockConfig(object):
    ...
    Attributes:
        ...
        coexisting_lock_mode (bool): Specified if files in the View can be locked
            in different modes.This property is immutable and can only be set when
            enabling File level datalock.
