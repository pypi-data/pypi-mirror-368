...
class NasAnalysisJobParams_ModTimeBucket(object):
    ...
    Attributes:
        ...
        mod_time_bucket_name (string): Tag representing the bucket for modified
            time of file. e.g. "1mo-3mo" represents 1 month to 3 month.
        mod_time_end_days (long|int): End time e.g. 1 year. Stored in days
            precision.
