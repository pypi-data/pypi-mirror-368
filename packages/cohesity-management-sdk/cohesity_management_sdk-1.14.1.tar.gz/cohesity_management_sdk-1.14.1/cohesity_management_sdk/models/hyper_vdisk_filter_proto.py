...
class HyperVDiskFilterProto(object):

    """Implementation of the 'HyperVDiskFilterProto' model.

    This message contains basic info of the disk to be excluded/included
    in backup. The info contained here:
    ...
    Attributes:
        ...
        controller_type (long|int):  Controller's type (SCSI, IDE etc).
    ...
    def __init__(self,
                 ...
                 unit_number=None):
        """Constructor for the HyperVDiskFilterProto class"""
