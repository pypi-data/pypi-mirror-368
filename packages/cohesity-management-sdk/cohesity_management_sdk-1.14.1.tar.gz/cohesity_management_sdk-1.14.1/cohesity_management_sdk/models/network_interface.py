...
class NetworkInterface(object):
    ...
    Attributes:
        active_bond_slave (string): Current active secondary. This is only valid
        ...
        bond_slaves (list of string): Specifies the names of any secondary if
            this interface is a bond.
        bond_slaves_details (list of BondSlaveInfo): Specifies the details
            of the bond secondaries.
    ...
    def from_dictionary(cls,
        ...
        bond_slaves_details = None
        if dictionary.get("bondSlavesDetails") is not None:
