...
class ActiveDirectoryEntry(object):
    ...
    Attributes:
        ...
        force_remove (bool): Specifies if Active Directory entry should be force
        ...
        whitelisted_domains (list of string): Specifies the Whitelisted
    ...
    def __init__(self,
                 ...
                 workgroup=None):
        """Constructor for the ActiveDirectoryEntry class"""
