...
import cohesity_management_sdk.models.o_365_one_drive_restore_entity_params
import cohesity_management_sdk.models.o_365_outlook_restore_entity_params
import cohesity_management_sdk.models.restore_acropolis_vm_param
import cohesity_management_sdk.models.restore_azure_sql_params
import cohesity_management_sdk.models.restore_rds_postgres_params
import cohesity_management_sdk.models.restore_exchange_params
import cohesity_management_sdk.models.restore_vapp_info
import cohesity_management_sdk.models.san_recover_params
...
class RestoreObject(object):
    ...
    Attributes:
        ...
        config_vec (list of ConfigurationParams): Common Configuration
        ...
        one_drive_restore_entity_params (O365OneDriveRestoreEntityParams): O365
            one drive specific parameters needed to restore the One Drive for a
            single user entity.
        outlook_restore_entity_params (O365OutlookRestoreEntityParams): O365 outlook specific parameters needed to restore a single Mailbox.
        ...
        restore_azure_sql_params (RestoreAzureSQLParams): This field defines
            the Azure SQL specific params for restore task of type
            kRecoverAzureSQL.
        restore_exchange_params (RestoreExchangeParams): This field contains
            params specific to the restore of a Exchange entities.
        restore_rds_postgres_params (RestoreRDSPostgresParams): TODO: Type
            description here.
        restore_vapp_info (RestoreVappInfo): This field contains params
            specific to restore of VCD vApp entity.
        san_recover_params (SANRecoverParams): This field contains params
            specific to the restore of a SAN entities.
    ...
    _names = {
        ...
        "one_drive_restore_entity_params": 'oneDriveRestoreEntityParams',
        "outlook_restore_entity_params":'outlookRestoreEntityParams',
        ...
        "restore_azure_sql_params": 'restoreAzureSqlParams',
        "restore_exchange_params":'restoreExchangeParams',
        "restore_rds_postgres_params": 'restoreRdsPostgresParams',
    ...
    def __init__(self,
                 ...
                 one_drive_restore_entity_params=None,
                 outlook_restore_entity_params=None,
                 parent_source=None,
                 ...
                 restore_azure_sql_params=None,
                 restore_exchange_params=None,
                 restore_rds_postgres_params=None,
                 restore_vapp_info=None,
                 san_recover_params=None,
        ...
        self.one_drive_restore_entity_params = one_drive_restore_entity_params
        self.outlook_restore_entity_params = outlook_restore_entity_params
        ...
        self.restore_azure_sql_params = restore_azure_sql_params
        self.restore_exchange_params = restore_exchange_params
        self.restore_rds_postgres_params = restore_rds_postgres_params
        self.restore_vapp_info = restore_vapp_info
        self.san_recover_params = san_recover_params
    ...
    def from_dictionary(cls,
        ...
        one_drive_restore_entity_params = cohesity_management_sdk.models.o_365_one_drive_restore_entity_params.O365OneDriveRestoreEntityParams.from_dictionary(dictionary.get('oneDriveRestoreEntityParams')) if dictionary.get('oneDriveRestoreEntityParams') else None
        outlook_restore_entity_params = cohesity_management_sdk.models.o_365_outlook_restore_entity_params.O365OutlookRestoreEntityParams.from_dictionary(dictionary.get('outlookRestoreEntityParams')) if dictionary.get('outlookRestoreEntityParams') else None
        ...
        restore_azure_sql_params = cohesity_management_sdk.models.restore_azure_sql_params.RestoreAzureSQLParams.from_dictionary(dictionary.get('restoreAzureSqlParams')) if dictionary.get('restoreAzureSqlParams') else None
        ...
        restore_rds_postgres_params = cohesity_management_sdk.models.restore_rds_postgres_params.RestoreRDSPostgresParams.from_dictionary(dictionary.get('restoreRdsPostgresParams')) if dictionary.get('restoreRdsPostgresParams') else None
        san_recover_params = cohesity_management_sdk.models.san_recover_params.SANRecoverParams.from_dictionary(dictionary.get('sanRecoverParams')) if dictionary.get('sanRecoverParams') else None
