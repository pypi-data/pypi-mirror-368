...
import cohesity_management_sdk.models.peristent_volume_status
...
class PVCInfo(object):
    ...
    Attributes:
        ...
        status (PeristentVolumeStatus): Status of persistent volume claim.
    ...
    def from_dictionary(cls,
        ...
        status = cohesity_management_sdk.models.peristent_volume_status.PeristentVolumeStatus.from_dictionary(dictionary.get('status')) if dictionary.get('status') else None
