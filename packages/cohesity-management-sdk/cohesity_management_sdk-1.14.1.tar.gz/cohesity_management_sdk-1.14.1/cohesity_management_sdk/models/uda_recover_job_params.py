...
class UdaRecoverJobParams(object):
    ...
    Attributes:
        ...
        deployment_type (int): Deployment type for the UDA agent.
        ...
        restore_job_arguments_map (list of
            ...
            scripts.
        restore_target_entity (EntityProto): EntityProto for
            CreateRestoreTaskArg::restore_target_entity_id.
            Set in magneto.
        restore_target_entity_parents (list of EntityProto): Includes
            UdaRecoverJobParams::restore_target_entity and its parents.
    ...
    _names = {
        ...
        "restore_target_entity": 'restoreTargetEntity',
        "restore_target_entity_parents": 'restoreTargetEntityParents',
    ...
    def __init__(self,
                 ...
                 restore_target_entity=None,
                 restore_target_entity_parents=None,
        ...
        self.restore_target_entity = restore_target_entity
        self.restore_target_entity_parents = restore_target_entity_parents
    ...
    def from_dictionary(cls,
        ...
        deployment_type = dictionary.get('deploymentType')
        ...
        restore_job_arguments_map = None
        if dictionary.get("restoreJobArgumentsMap") is not None:
        ...
        restore_target_entity = cohesity_management_sdk.models.entity_proto.EntityProto.from_dictionary(dictionary.get('restoreTargetEntity')) if dictionary.get('restoreTargetEntity') else None
        restore_target_entity_parents = None
        if dictionary.get("restoreTargetEntityParents") is not None:
            restore_target_entity_parents = list()
            for structure in dictionary.get('restoreTargetEntityParents'):
                restore_target_entity_parents.append(cohesity_management_sdk.models.entity_proto.EntityProto.from_dictionary(structure))
        ...
        source_arguments_map = None
        if dictionary.get("sourceArgumentsMap") is not None:
