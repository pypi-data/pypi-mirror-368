...
class RunJobSnapshotTarget(object):
    ...
    Attributes:
        ...
        update_retention_reason (string): The reason why this update is needed
    ...
    _names = {
        ...
        "mtype":'type',
        "update_retention_reason":'updateRetentionReason'
    }
    ...
    def __init__(self,
        ...
        self.mtype = mtype
        self.update_retention_reason = update_retention_reason
    ...
    def from_dictionary(cls,
        ...
        update_retention_reason = dictionary.get('updateRetentionReason')
