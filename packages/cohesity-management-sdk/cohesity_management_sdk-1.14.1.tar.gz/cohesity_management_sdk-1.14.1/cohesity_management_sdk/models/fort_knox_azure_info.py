...
class FortKnoxAzureInfo(object):

    """Implementation of the 'FortKnoxAzureInfo' model.

    FortKnoxAzureInfo holds information about the Fortknox
    ...
    def __init__(self,
                 ...
                 quantity=None,
                 start_date=None):
        """Constructor for the FortKnoxAzureInfo class"""
