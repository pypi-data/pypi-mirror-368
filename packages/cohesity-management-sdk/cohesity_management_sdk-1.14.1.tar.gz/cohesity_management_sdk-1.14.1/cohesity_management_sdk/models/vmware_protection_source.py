...
class VmwareProtectionSource(object):
    ...
    Attributes:
        ...
        is_saas_connector (bool): The field indicates whether the VM is a
            Rigel/HyX VM.
    ...
    _names = {
        ...
        "is_saas_connector": 'isSaasConnector',
        "name":'name',
    ...
    def __init__(self,
        ...
        self.is_saas_connector = is_saas_connector
        self.name = name
    ...
    def from_dictionary(cls,
        ...
        is_saas_connector = dictionary.get('isSaasConnector')
        ...
        vcloud_director_info = None
        if dictionary.get("vCloudDirectorInfo") is not None:
