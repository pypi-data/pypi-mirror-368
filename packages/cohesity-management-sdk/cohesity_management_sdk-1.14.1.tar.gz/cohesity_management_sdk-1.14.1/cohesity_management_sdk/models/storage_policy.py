...
class StoragePolicy(object):
    ...
    Attributes:
        aes_encryption_mode (string): If EncryptionLevel is
            'KEncryptionStrong' EncryptionMode tells whether encryption
            algorithm used is AES_CBC or AES_GCM.
        ...
        erasure_coding_info (ErasureCodingInfo): Specifies information about
            erasure coding if erasure coding is enabled.
