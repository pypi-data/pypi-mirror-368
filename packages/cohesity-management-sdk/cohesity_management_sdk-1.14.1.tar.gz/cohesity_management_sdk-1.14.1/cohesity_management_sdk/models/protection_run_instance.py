...
class ProtectionRunInstance(object):
    ...
    def from_dictionary(cls,
        ...
        copy_run = None
        if dictionary.get("copyRun") is not None:
            copy_run = list()
        ...
        protection_shell_info = cohesity_management_sdk.models.protection_shell_info.ProtectionShellInfo.from_dictionary(dictionary.get('protectionShellInfo'))
