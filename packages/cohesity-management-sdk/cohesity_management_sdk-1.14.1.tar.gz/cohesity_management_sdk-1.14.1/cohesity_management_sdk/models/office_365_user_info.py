...
import cohesity_management_sdk.models.group_membership_info
...
class Office365UserInfo(object):
    ...
    Attributes:
        ...
        graph_uuid (string): Specifies the MS Graph UUID for the given user
            entity.
        group_membership_info_list (list of GroupMembershipInfo): Specifies the
            Group entities which hold this user entity as its member.
    ...
    _names = {
        ...
        "group_membership_info_list": 'groupMembershipInfoList',
    ...
    def __init__(self,
                 ...
                 designation=None,
                 graph_uuid=None,
                 group_membership_info_list=None,
        ...
        self.group_membership_info_list = group_membership_info_list
    ...
    def from_dictionary(cls,
        ...
        group_membership_info_list = None
        if dictionary.get("groupMembershipInfoList") is not None:
            group_membership_info_list = list()
            for structure in dictionary.get('groupMembershipInfoList'):
                group_membership_info_list.append(cohesity_management_sdk.models.group_membership_info.GroupMembershipInfo.from_dictionary(structure))
