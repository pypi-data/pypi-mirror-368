...
import cohesity_management_sdk.models.pod_info_pod_spec_volume_info_secret_volume_source
...
class PodInfo_PodSpec_VolumeInfo(object):
    ...
    Attributes:
        ...
        scale_io (PodInfo_PodSpec_VolumeInfo_ScaleIO): TODO: Type
            description here.
        secret (PodInfo_PodSpec_VolumeInfo_ConfigMap): Changing the json_name
            of this field so that API responses of secret
            volumes do not get parsed into this message.
        secret_volume (PodInfo_PodSpec_VolumeInfo_SecretVolumeSource):TODO:
            Type description here.
    ...
    def from_dictionary(cls,
        ...
        secret_volume = cohesity_management_sdk.models.pod_info_pod_spec_volume_info_secret_volume_source.PodInfo_PodSpec_VolumeInfo_SecretVolumeSource.from_dictionary(dictionary.get('secretVolume')) if dictionary.get('secretVolume') else None
