...
class NoSqlRecoverJobParams(object):
    ...
    Attributes:
        ...
        continue_restore_on_error (bool): ENG-345531 (only for Cassandra
            currently) - whether to continue
    ...
    def from_dictionary(cls,
        ...
        mirror_job_params = cohesity_management_sdk.models.no_sql_mirror_recovery_job_params.NoSqlMirrorRecoveryJobParams.from_dictionary(dictionary.get('mirrorJobParams', None)) if dictionary.get('mirrorJobParams', None) else None
