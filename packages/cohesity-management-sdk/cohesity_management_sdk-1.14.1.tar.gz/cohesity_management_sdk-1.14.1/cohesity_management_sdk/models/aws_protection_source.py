...
import cohesity_management_sdk.models.s3_protection_params
...
class AwsProtectionSource(object):
    ...
    Attributes:
        ...
        aws_type (AwsTypeEnum): Specifies the entity type such as 'kIAMUser'
            ...
            cluster.
            'kSubTaskPermit' entity type will be used by slave sub-tasks to
            take permit for native backups,
            so that we can control the number of concurrent sub-tasks
            independent of the number of VMs being backed up concurrently.
        ...
        s3_protection_params (S3ProtectionParams): Params required for s3
            backups for the registered entity.
    ...
    def __init__(self,
        ...
        self.s3_protection_params = s3_protection_params
    ...
    def from_dictionary(cls,
        ...
        s3_protection_params = cohesity_management_sdk.models.s3_protection_params.S3ProtectionParams.from_dictionary(dictionary.get('s3ProtectionParams')) if dictionary.get('s3ProtectionParams') else None
