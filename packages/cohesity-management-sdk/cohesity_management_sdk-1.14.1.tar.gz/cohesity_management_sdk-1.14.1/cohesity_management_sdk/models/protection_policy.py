...
class ProtectionPolicy(object):
    ...
    Attributes:
        backup_run_timeouts (list of CancellationTimeoutParams): Backup Run
            timeouts after which a run will get cancelled.
        ...
        last_modification_time_usecs (long|int): Specifies the epoch time (in
    ...
    _names = {
        "backup_run_timeouts":'backupRunTimeouts',
    ...
    def __init__(self,
        ...
        self.backup_run_timeouts = backup_run_timeouts
    ...
    def from_dictionary(cls,
        ...
        blackout_periods = None
        if dictionary.get("blackoutPeriods") is not None:
        ...
        backup_run_timeouts = None
        if dictionary.get("backupRunTimeouts") is not None:
            backup_run_timeouts = list()
            for structure in dictionary.get('backupRunTimeouts'):
                backup_run_timeouts.append(cohesity_management_sdk.models.cancellation_timeout_params.CancellationTimeoutParams.from_dictionary(structure))
        ...
        cloud_deploy_policies = None
        if dictionary.get("cloudDeployPolicies") is not None:
        ...
        extended_retention_policies = None
        if dictionary.get("extendedRetentionPolicies") is not None:
        ...
        snapshot_archival_copy_policies = None
        if dictionary.get("snapshotArchivalCopyPolicies") is not None:
        ...
        snapshot_replication_copy_policies = None
        if dictionary.get("snapshotReplicationCopyPolicies") is not None:
