...
class ChangeServiceStateParameters(object):
    ...
    Attributes:
        action (ActionEnum): Specifies the action to take on the specified
            service. 'kStop' indicates that the specified services will be
            stopped. 'kStart' indicates that the specified services will be
            started. 'kRestart' indicates that the specified services will be
            restarted.
        services (list of ServiceEnum): Specifies the list of services to take
