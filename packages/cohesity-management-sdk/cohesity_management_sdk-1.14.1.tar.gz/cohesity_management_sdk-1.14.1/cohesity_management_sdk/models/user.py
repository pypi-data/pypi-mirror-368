...
import cohesity_management_sdk.models.ad_user_info
...
class User(object):
    ...
    Attributes:
        ad_user_info (ADUserInfo): Specifies additional information pertaining
        ...
        intercom_messenger_token (string): Specifies the messenger token for
        ...
        mfa_methods (list of string): Specifies MFA methods that enabled on the
            cluster.
        object_class (string): Specifies object class of user, could be either
            user or group.
    ...
    _names = {
        ...
        "intercom_messenger_token": 'intercomMessengerToken',
    ...
    def __init__(self,
        ...
        self.ad_user_info = ad_user_info
        ...
        self.intercom_messenger_token = intercom_messenger_token
    ...
    def from_dictionary(cls,
        ...
        ad_user_info = cohesity_management_sdk.models.ad_user_info.ADUserInfo.from_dictionary(dictionary.get('adUserInfo')) if dictionary.get('adUserInfo') else None
        ...
        cluster_identifiers = None
        if dictionary.get("clusterIdentifiers") is not None:
        ...
        intercom_messenger_token = dictionary.get('intercomMessengerToken')
        ...
        org_membership = None
        if dictionary.get("orgMembership") is not None:
            org_membership = list()
        ...
        tenant_accesses = None
        if dictionary.get("tenantAccesses") is not None:
