...
class AwsFleetPublicParams(object):

    """Implementation of the 'AwsFleetPublicParams' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AwsFleetPublicParams class"""
    ...
    def from_dictionary(cls,
        ...
        network_params_list = None
        if dictionary.get("networkParamsList") is not None:
