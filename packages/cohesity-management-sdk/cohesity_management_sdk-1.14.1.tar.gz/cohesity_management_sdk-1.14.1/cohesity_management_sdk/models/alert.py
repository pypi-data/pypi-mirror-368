...
import cohesity_management_sdk.models.alert_vault_info
...
class Alert(object):
    ...
    Attributes:
        ...
        label_ids (list of string): Specifies the labels for which this alert
            has been raised.
        ...
        region_id (string): Specifies the region id of the cluster.Specifies
        ...
        resolved_timestamp_usecs (long|int): Specifies Unix epoch Timestamps
            in microseconds when alert is resolved.
        ...
        vaults (list of AlertVaultInfo): Vaults where source object
            associated with alert is vaulted.
    ...
    _names = {
        ...
        "resolution_id_string": 'resolutionIdString',
    ...
    def __init__(self,
        ...
        self.resolution_id_string = resolution_id_string
    ...
    def from_dictionary(cls,
        ...
        property_list = None
        if dictionary.get("propertyList") is not None:
            property_list = list()
        ...
        resolution_id_string = dictionary.get('resolutionIdString')
        severity = dictionary.get('severity')
        suppression_id = dictionary.get('suppressionId')
        tenant_ids = dictionary.get('tenantIds')
        vaults = None
        if dictionary.get('vaults'):
            vaults = list()
            for structure in dictionary.get('vaults'):
                vaults.append(cohesity_management_sdk.models.alert_vault_info.AlertVaultInfo.from_dictionary(structure))
