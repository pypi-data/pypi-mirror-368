...
class SnapshotInfoProto(object):
    ...
    Attributes:
        ...
        post_snapshot_script_status (ScriptExecutionStatus): Captures the
            execution status of post snapshot script.
        ...
        success_files_rocks_db_name (string): The name of the rocksdb directory for
          success files seen during backup, stored in 'config' directory of the current view.
    ...
    _names = {
        ...
        "post_snapshot_script_status": 'postSnapshotScriptStatus',
        ...
        "success_files_rocks_db_name":'successFilesRocksdbName',
    ...
    def __init__(self,
                 ...
                 post_snapshot_script_status=None,
                 ...
                 success_files_rocks_db_name=None,
                 target_type=None,
        ...
        self.post_snapshot_script_status = post_snapshot_script_status
        ...
        self.success_files_rocks_db_name = success_files_rocks_db_name
    ...
    def from_dictionary(cls,
        ...
        post_snapshot_script_status = cohesity_management_sdk.models.script_execution_status.ScriptExecutionStatus.from_dictionary(dictionary.get('postSnapshotScriptStatus')) if dictionary.get('postSnapshotScriptStatus') else None
        ...
        success_files_rocks_db_name = dictionary.get('successFilesRocksdbName')
