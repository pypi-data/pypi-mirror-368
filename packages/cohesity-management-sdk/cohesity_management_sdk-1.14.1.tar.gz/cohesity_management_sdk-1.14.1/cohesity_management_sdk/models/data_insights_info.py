...
class DataInsightsInfo(object):

    """Implementation of the 'DataInsightsInfo' model.

    DataInsightsInfo holds information about the Data Insights
    subscription such as if it is active or not.

    Attributes:
        end_date (string): Specifies the end date of the subscription.
        is_active (bool): Specifies whether the Data Insights subscription is
            active.
    ...
    def __init__(self,
                 ...
                 is_free_trial=None,
                 start_date=None):
        """Constructor for the DataInsightsInfo class"""
