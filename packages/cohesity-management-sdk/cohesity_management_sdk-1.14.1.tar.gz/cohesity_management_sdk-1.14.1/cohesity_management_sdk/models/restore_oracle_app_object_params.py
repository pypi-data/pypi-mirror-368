...
class RestoreOracleAppObjectParams(object):
    ...
    Attributes:
        ...
        restore_as_rac (bool): Specifies whether it is restored to a RAC
            database.
    ...
    def __init__(self,
        ...
        self.restore_as_rac = restore_as_rac
    ...
    def from_dictionary(cls,
        ...
        oracle_clone_app_view_params_vec = None
        if dictionary.get("oracleCloneAppViewParamsVec") is not None:
        ...
        restore_as_rac = dictionary.get('restoreAsRac')
        ...
        shell_environment_vec = None
        if dictionary.get("shellEnvironmentVec") is not None:
