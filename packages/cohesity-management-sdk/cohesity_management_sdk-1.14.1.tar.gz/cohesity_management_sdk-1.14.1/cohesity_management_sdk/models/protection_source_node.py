...
import cohesity_management_sdk.models.maintenance_mode_config_proto
...
class ProtectionSourceNode(object):
    ...
    Attributes:
        ...
        maintenance_mode_config (MaintenanceModeConfigProto): Specifies the
            maintenance mode configuration of the protection source for the root
            node (we currently only support setting the maintenance mode of the root
            node only v7.1)
    ...
    def from_dictionary(cls,
        ...
        maintenance_mode_config = cohesity_management_sdk.models.maintenance_mode_config_proto.MaintenanceModeConfigProto.from_dictionary(dictionary.get('maintenanceModeConfig')) if dictionary.get('maintenanceModeConfig') else None
        logical_size = dictionary.get('logicalSize')
        nodes = dictionary.get('nodes')
        protected_sources_summary = None
        if dictionary.get("protectedSourcesSummary") is not None:
        ...
        unprotected_sources_summary = None
        if dictionary.get("unprotectedSourcesSummary") is not None:
