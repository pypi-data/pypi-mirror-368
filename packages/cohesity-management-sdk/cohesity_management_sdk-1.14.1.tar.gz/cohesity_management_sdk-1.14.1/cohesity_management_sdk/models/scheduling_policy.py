...
import cohesity_management_sdk.models.yearly_schedule
...
class SchedulingPolicy(object):
    ...
    Attributes:
        ...
        yearly_schedule (YearlySchedule): Specifies a yearly backup schedule.
    ...
    def from_dictionary(cls,
        ...
        yearly_schedule = cohesity_management_sdk.models.yearly_schedule.YearlySchedule.from_dictionary(dictionary.get('yearlySchedule')) if dictionary.get('yearlySchedule') else None
