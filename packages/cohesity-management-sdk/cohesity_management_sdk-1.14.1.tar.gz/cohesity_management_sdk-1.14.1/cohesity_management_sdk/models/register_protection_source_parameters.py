...
import cohesity_management_sdk.models.aws_fleet_public_params
...
class RegisterProtectionSourceParameters(object):
    ...
    Attributes:
        ...
        aws_fleet_params (AwsFleetPublicParams): Specifies information related to AWS
        ...
        ibm_flash_system_type (IbmFlashSystemTypeEnum): Specifies the entity
            type such as ''kStorageArray'' if the environment is kIbmFlashSystem.
    ...
    def __init__(self,
        ...
        self.ibm_flash_system_type = ibm_flash_system_type
    ...
    def from_dictionary(cls,
        ...
        aws_fleet_params = cohesity_management_sdk.models.aws_fleet_public_params.AwsFleetPublicParams.from_dictionary(dictionary.get('awsFleetParams')) if dictionary.get('awsFleetParams') else None
        ...
        ibm_flash_system_type = dictionary.get('ibm_flash_system_type')
        ...
        office_365_credentials_list = None
        if dictionary.get("office365CredentialsList") is not None:
        ...
        subnets = None
        if dictionary.get("subnets") is not None:
            subnets = list()
        ...
        throttling_policy_overrides = None
        if dictionary.get("throttlingPolicyOverrides") is not None:
