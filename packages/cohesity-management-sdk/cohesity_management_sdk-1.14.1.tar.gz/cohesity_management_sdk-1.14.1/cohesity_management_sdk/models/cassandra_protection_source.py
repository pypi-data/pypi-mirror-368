...
import cohesity_management_sdk.models.cassandra_table
...
class CassandraProtectionSource(object):
    ...
    Attributes:
        ...
        table_info (CassandraTable): Information of a cassandra table, only
            valid for an entity of type kTable.
    ...
    def from_dictionary(cls,
        ...
        table_info = cohesity_management_sdk.models.cassandra_table.CassandraTable.from_dictionary(dictionary.get('tableInfo')) if dictionary.get('tableInfo') else None
