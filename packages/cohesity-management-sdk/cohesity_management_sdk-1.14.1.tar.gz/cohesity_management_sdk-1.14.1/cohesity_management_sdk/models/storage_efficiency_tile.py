...
class StorageEfficiencyTile(object):
    ...
    def from_dictionary(cls,
        ...
        data_in_bytes_samples = None
        if dictionary.get("dataInBytesSamples") is not None:
        ...
        data_in_deduped_bytes_samples = None
        if dictionary.get("dataInDedupedBytesSamples") is not None:
        ...
        dedupe_ratio_samples = None
        if dictionary.get("dedupeRatioSamples") is not None:
        ...
        logical_used_bytes_samples = None
        if dictionary.get("logicalUsedBytesSamples") is not None:
        ...
        physical_used_bytes_samples = None
        if dictionary.get("physicalUsedBytesSamples") is not None:
        ...
        storage_reduction_samples = None
        if dictionary.get("storageReductionSamples") is not None:
