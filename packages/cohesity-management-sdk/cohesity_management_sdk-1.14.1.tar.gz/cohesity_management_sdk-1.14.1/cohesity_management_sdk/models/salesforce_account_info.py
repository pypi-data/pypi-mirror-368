...
class SalesforceAccountInfo(object):
    ...
    Attributes:
        ...
        is_gaia_user (bool): Specifies whether user is a Data Insights aka gaia
            licensed user.
    ...
    def __init__(self,
        ...
        self.is_gaia_user = is_gaia_user
    ...
    def from_dictionary(cls,
        ...
        is_gaia_user = dictionary.get('isGaiaUser')
