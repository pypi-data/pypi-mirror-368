...
class ClassificationInfo(object):
    ...
    """Implementation of the 'ClassificationInfo' model.

    ClassificationInfo holds information about the Datahawk Classification
    subscription such as if it is active or not.

    Attributes:
        end_date (string): Specifies the end date of the subscription.
        is_active (bool): Specifies whether the Datahawk Classification
    ...
    def __init__(self,
                 ...
                 is_free_trial=None,
                 start_date=None):
        """Constructor for the ClassificationInfo class"""
