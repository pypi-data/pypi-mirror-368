...
class CountByTier(object):
    ...
    Attributes:
        ...
        storage_tier (StorageTierEnum): StorageTier is the type of
            ...
            Storage Tier. 'PCIeSSD' indicates storage tier type of Pci Solid
            State Drive. 'SATAHDD' indicates storage tier type of SATA Solid
            State Drive. 'SATAHDD' indicates storage tier type of SATA Hard
