...
class UdaConnectParams(object):
    ...
    Attributes:
        ...
        et_enable_log_backup_policy (bool): Specifies whether to enable
            cohesity policy triggered log backups along with externally
            triggered backups.
            Only applicable if etLogBackup capability is true.
        et_enable_run_now (bool): Specifies if the user triggered runs are
            allowed along with externally triggered backups.
    ...
    _names = {
        ...
        "et_enable_log_backup_policy": 'etEnableLogBackupPolicy',
        "et_enable_run_now": 'etEnableRunNow',
        "host_type":'hostType',
        "hosts":'hosts',
    ...
    def __init__(self,
                 capabilities=None,
                 credentials=None,
                 et_enable_log_backup_policy=None,
                 et_enable_run_now=None,
                 host_type=None,
                 hosts=None,
                 live_data_view=None,
                 live_log_view=None,
        ...
        self.et_enable_log_backup_policy = et_enable_log_backup_policy
        self.et_enable_run_now = et_enable_run_now
    ...
    def from_dictionary(cls,
        ...
        et_enable_log_backup_policy = dictionary.get('etEnableLogBackupPolicy')
        et_enable_run_now = dictionary.get('etEnableRunNow')
