...
import cohesity_management_sdk.models.kubernetes_backup_source_params
...
import cohesity_management_sdk.models.uda_backup_source_params
...
class BackupSourceParams(object):
    ...
    Attributes:
        ...
        kubernetes_params (KubernetesBackupSourceParams): This is applicable to
            namepace sources for Kubernetes environment.
        ...
        uda_backup_source_params (UdaBackupSourceParams): Uda source params.
    ...
    def __init__(self,
        ...
        self.uda_backup_source_params = uda_backup_source_params
    ...
    def from_dictionary(cls,
        ...
        kubernetes_params = cohesity_management_sdk.models.kubernetes_backup_source_params.KubernetesBackupSourceParams.from_dictionary(dictionary.get('kubernetesParams')) if dictionary.get('kubernetesParams') else None
        ...
        uda_backup_source_params = cohesity_management_sdk.models.uda_backup_source_params.UdaBackupSourceParams.from_dictionary(dictionary.get('udaBackupSourceParams')) if dictionary.get('udaBackupSourceParams') else None
