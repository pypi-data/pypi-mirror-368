...
class AzureCloudCredentials(object):
    ...
    Attributes:
        auth_method (AuthMethodAzureCloudCredentialsEnum): Specifies the auth
        ...
        region (string): Specifies the region for Azure account. This is only
            populated for FortKnox vaults.
