...
class UpdateApplicationServerParameters(object):
    ...
    Attributes:
        ...
        last_modification_time_usecs (long| int): Specifies the last time this
            Application Servers in a Protection Source was updated. If this is
            passed into a PUT request, then the backend will validate that the
            timestamp passed in matches the time that the Protection Source was
