...
class O365OneDriveRestoreEntityParams_DriveItem(object):

    """Implementation of the 'O365OneDriveRestoreEntityParams_DriveItem' model.

    Attributes:
        drive_item_id (string):The unique identifier of the item within the
            Drive.
    ...
    def __init__(self,
                 ...
                 is_file_item=None):
        """Constructor for the O365OneDriveRestoreEntityParams_DriveItem class"""
