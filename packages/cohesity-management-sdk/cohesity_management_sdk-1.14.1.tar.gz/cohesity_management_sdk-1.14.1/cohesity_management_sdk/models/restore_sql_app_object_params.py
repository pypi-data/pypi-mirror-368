...
class RestoreSqlAppObjectParams(object):
    ...
    Attributes:
        ...
        replay_entire_last_log (bool): If this is set to true, we will replay
            the entire last log without STOPAT.
    ...
    def from_dictionary(cls,
        ...
        secondary_data_file_destination_vec = None
        if dictionary.get("secondaryDataFileDestinationVec") is not None:
