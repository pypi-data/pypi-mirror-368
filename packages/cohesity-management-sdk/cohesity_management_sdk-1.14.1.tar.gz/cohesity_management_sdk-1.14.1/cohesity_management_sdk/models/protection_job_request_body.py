...
import cohesity_management_sdk.models.source_info
...
class ProtectionJobRequestBody(object):
    ...
    Attributes:
        ...
        continue_on_error (bool): Specifies the behaviour of the file based backup
          on encountering an error.Can either continue with the backup or fail
          immediately.
        ...
        environment (EnvironmentProtectionJobRequestBodyEnum): Specifies the
            environment type (such as kVMware or kSQL) of the Protection Source
            this Job is protecting. Supported environment types such as
        ...
        modification_time_usecs (long|int): Specifies the last time this Job was updated.  If this is
        ...
        source_special_parameters (list of SourceSpecialParameter, required):
            ...
            here to take effect.
        sources (list of SourceInfo): Array of Protected Source Objects.
        ...
        task_timeouts (list of CancellationTimeoutParams): Specifies task level
            timeouts for a job.
    ...
    def from_dictionary(cls,
        ...
        remote_view_config_list = None
        if dictionary.get("remoteViewConfigList") is not None:
        ...
        source_special_parameters = None
        if dictionary.get("sourceSpecialParameters") is not None:
        ...
        if dictionary.get("sources") is not None:
            ...
            for structure in dictionary.get('sources'):
                sources.append(cohesity_management_sdk.models.source_info.SourceInfo.from_dictionary(structure))
        ...
        if dictionary.get("taskTimeouts") is not None:
            ...
            for structure in dictionary.get('taskTimeouts'):
                task_timeouts.append(cohesity_management_sdk.models.cancellation_timeout_params.CancellationTimeoutParams.from_dictionary(structure))
