...
class ServiceProcessEntry(object):
    ...
    Attributes:
        ...
        service_name (ServiceNameEnum): Specifies the name of the Service.
            ...
            customers. 'kIrisProxy' is a service that links the Iris service
            to other services on the Cluster. 'kScribe' is the service
            responsible for storing filesystem metadata. 'kStats' is the
            service that is responsible for retrieving and aggregating disk
            metrics across the Cluster. 'kYoda' is an elastic search indexing
            service. 'kAlerts' is a publisher and subscribing service for
            alerts. 'kKeychain' is a service for managing disk encryption
            ...
            service for accessing data on external entities. 'kRtClient' is a
