...
import cohesity_management_sdk.models.aws_rds_postgres_env_backup_params
import cohesity_management_sdk.models.aws_native_env_params
import cohesity_management_sdk.models.azure_sql_env_backup_params_proto
...
import cohesity_management_sdk.models.san_backup_job_params
...
class EnvBackupParams(object):
    ...
    Attributes:
        ...
        aws_native_env_params (AWSNativeEnvParams): This is applicable to AWS
            native backups.
        aws_rds_postgres_env_params (AwsRDSPostgresEnvBackupParams): This is
            applicable to Aws RDS Postgres environments.
        azure_sql_env_params (AzureSqlEnvBackupParamsProto:
        ...
        s3_backup_job_params (S3BackupJobParams): This is applicable to kAwsS3
            job type.
        san_backup_job_params (SanBackupJobParams): This is applicable to SAN
            environments.
    ...
    _names = {
        ...
        "aws_rds_postgres_env_params": 'awsRdsPostgresEnvParams',
        "azure_sql_env_params": 'azureSqlEnvParams',
    ...
    def __init__(self,
                 ...
                 aws_rds_postgres_env_params=None,
                 azure_sql_env_params=None,
        ...
        self.aws_rds_postgres_env_params = aws_rds_postgres_env_params
        self.azure_sql_env_params = azure_sql_env_params
        ...
        self.san_backup_job_params = san_backup_job_params
    ...
    def from_dictionary(cls,
        ...
        aws_rds_postgres_env_params = cohesity_management_sdk.models.aws_rds_postgres_env_backup_params.AwsRDSPostgresEnvBackupParams.from_dictionary(dictionary.get('awsRdsPostgresEnvParams')) if dictionary.get('awsRdsPostgresEnvParams') else None
        azure_sql_env_params = cohesity_management_sdk.models.azure_sql_env_backup_params_proto.AzureSqlEnvBackupParamsProto.from_dictionary(dictionary.get('azureSqlEnvParams')) if dictionary.get('azureSqlEnvParams') else None
        ...
        san_backup_job_params = cohesity_management_sdk.models.san_backup_job_params.SanBackupJobParams.from_dictionary(dictionary.get('sanBackupJobParams')) if dictionary.get('sanBackupJobParams') else None
