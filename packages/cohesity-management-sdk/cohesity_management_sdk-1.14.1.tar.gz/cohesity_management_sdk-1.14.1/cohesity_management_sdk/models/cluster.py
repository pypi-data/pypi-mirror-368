...
class Cluster(object):
    ...
    Attributes:
        aes_encryption_mode (string): Specifies the default AES Encryption
            mode on the cluster.
        ...
        claim_type (ClaimTypeEnum): Specifies the type from which the cluster was
            claimed to Helios.
        ...
        current_time_msecs (long|int): Specifies the current system time on
            ...
            Timestamp (in microseconds).
        disk_count_by_tier (list of CountByTier): Specifies the number of
            disks on the cluster by Storage Tier.
        ...
        google_analytics_enabled (bool): Specifies whether Google Analytics is
            enabled.
        hardware_encryption_enabled (bool): Specifies if hardware encryption(
            SED) is enabled.
        ...
        is_documentation_local (bool): Specifies what version of the
            ...
            version of Help.
        is_upgrade_aborted (bool): Flag to indicate if the current upgrade has
            been aborted.
        ...
        s3_virtual_hosted_domain_names (list of string): Specifies the list of
            domain names for S3 Virtual Hosted Style Paths. If set, all the
            Cohesity S3 Views in the cluster can be accessed using any of the
        ...
        upgrade_failure_error_string (string): Error string to capture why the
            upgrade failed.
    ...
    def from_dictionary(cls,
        ...
        claim_type = dictionary.get('claimType')
