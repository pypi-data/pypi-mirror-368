...
class NodeDeleteResult(object):
    ...
    Attributes:
        ...
        cleared_pre_check_result (bool): True if PreCheck result is cleared
    ...
    _names = {
        "cleared_pre_check_result":'clearedPreCheckResult',
        "id":'id',
    ...
    def __init__(self,
        ...
        self.cleared_pre_check_result = cleared_pre_check_result
        self.id = id
    ...
    def from_dictionary(cls,
        ...
        cleared_pre_check_result = dictionary.get('clearedPreCheckResult')
        id = dictionary.get('id')
        mark_node_for_removal = dictionary.get('markNodeForRemoval')
        timestamp_secs = dictionary.get('timestampSecs')
        validation_checks = None
        if dictionary.get("validationChecks") is not None:
