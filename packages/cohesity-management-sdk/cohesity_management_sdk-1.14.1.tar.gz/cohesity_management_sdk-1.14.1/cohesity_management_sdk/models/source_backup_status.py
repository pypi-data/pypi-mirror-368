...
class SourceBackupStatus(object):
    ...
    Attributes:
        ...
        attempt_num (long|int): Specifies the number of the attempts made by
            the Job Run to capture a snapshot of the object. For example, if
            an snapshot is successfully captured after three attempts, this
            field equals 3.
    ...
    def from_dictionary(cls,
        ...
        apps_backup_status = None
        if dictionary.get("appsBackupStatus") is not None:
