...
import cohesity_management_sdk.models.common_filter_expression
...
import cohesity_management_sdk.models.download_chats_params
import cohesity_management_sdk.models.encryption_params
...
import cohesity_management_sdk.models.restore_object_customization
...
import cohesity_management_sdk.models.restore_san_params
...
class PerformRestoreTaskStateProto(object):
    ...
    Attributes:
        ...
        custom_tag_vec (CustomTag): Custom Tags will be attached to each
            temporary and permanant entity
        ...
        download_chats_params (DownloadChatsParams): This field defines the
            download chat specific params for downloading
            chat/post messages for a user/team/channel.
        encryption_params (EncryptionParams): This field defines the encryption
            params for restore task of type kRecoverVMs.
        filter_params (CommonFilterExpression): This field defines the common filter params for filtering the entities
        ...
        request_sha1_checksum (int) Sha1 checksum of the restore request.
            This is used to identify the duplicate restore requests.
        ...
        restore_object_customizations (RestoreObjectCustomization): Field to
            indicate the objects specific customization.
        ...
        restore_s3_params (RestoreS3Params): This field defines the S3 specific
            ...
            kRecoverS3Objects.
        restore_san_params (RestoreSanParams): This field defines the SAN
            specific params for restore task. For example
        ...
        restore_target_entity_id (long|int): Entity Id of object inside which
            restored entities will be created.
    ...
    _names = {
        ...
        "request_sha1_checksum": 'requestSha1Checksum',
        ...
        "restore_san_params": 'restoreSanParams',
        ...
        "restore_target_entity_id": 'restoreTargetEntityId',
    ...
    def __init__(self,
        ...
        self.request_sha1_checksum = request_sha1_checksum
        ...
        self.restore_san_params = restore_san_params
        ...
        self.restore_target_entity_id =restore_target_entity_id
    ...
    def from_dictionary(cls,
        ...
        backup_run_lock_vec = None
        if dictionary.get("backupRunLockVec") is not None:
        ...
        custom_tag_vec = None
        if dictionary.get("customTagVec") is not None:
            custom_tag_vec = list()
        ...
        datastore_entity_vec = None
        if dictionary.get("datastoreEntityVec") is not None:
        ...
        download_chats_params = cohesity_management_sdk.models.download_chats_params.DownloadChatsParams.from_dictionary( dictionary.get('downloadChatsParams')) if dictionary.get('downloadChatsParams') else None
        encryption_params = cohesity_management_sdk.models.encryption_params.EncryptionParams.from_dictionary( dictionary.get('encryptionParams')) if dictionary.get('encryptionParams') else None
        filter_params = cohesity_management_sdk.models.common_filter_expression.CommonFilterExpression.from_dictionary(dictionary.get('filterParams')) if dictionary.get('filterParams') else None
        ...
        request_sha1_checksum = dictionary.get('requestSha1Checksum')
        ...
        if dictionary.get("restoreObjectCustomizations") is not None:
            for structure in dictionary.get('restoreObjectCustomizations'):
                ...
                restore_object_customizations.append(cohesity_management_sdk.models.restore_object_customization.RestoreObjectCustomization.from_dictionary(structure))
        ...
        restore_san_params = cohesity_management_sdk.models.restore_san_params.RestoreSanParams.from_dictionary(dictionary.get('restoreSanParams')) if dictionary.get('restoreSanParams') else None
        ...
        restore_target_entity_id = dictionary.get('restoreTargetEntityId')
        ...
        retrieve_archive_task_uid_vec = None
        if dictionary.get("retrieveArchiveTaskUidVec") is not None:
        ...
        retrieve_archive_task_vec = None
        if dictionary.get("retrieveArchiveTaskVec") is not None:
        ...
        volume_info_vec = None
        if dictionary.get("volumeInfoVec") is not None:
