...
class PDBRestoreParam(object):
    ...
    Attributes:
        ...
        include_in_restore (bool): Whether or not to restore the PDB when
            ...
            keeping the value as default true we will ensure the agent
            behaves the same way if someone upgrades agent service and the
            magneto service is still old.
    ...
    def from_dictionary(cls,
        ...
        return cls(drop_pdbs_if_exists,
                   existing_cdb,
                   include_in_restore,
                   pdb_entity_info_vec,
                   rename_pdb_map)
