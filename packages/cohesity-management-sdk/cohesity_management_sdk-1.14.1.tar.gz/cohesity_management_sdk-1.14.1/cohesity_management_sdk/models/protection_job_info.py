...
class ProtectionJobInfo(object):
    ...
    Attributes:
        ...
        mtype (TypeProtectionJobInfoEnum): Specifies the type of the
            Protection Job such as kView or kPuppeteer. 'kPuppeteer' refers to
            a Remote Adapter Job. Supported environment types such as 'kView',
            ...
            GCP Native Protection Source environment. 'kAzureNative' indicates
            the Azure Native Protection Source environment. 'kKubernetes'
