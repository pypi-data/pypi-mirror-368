...
class S3BucketConfigProto(object):
    ...
    Attributes:
        abac_enabled (bool): bool representing if the view is ABAC enabled or not
        ...
        max_subfiles_per_mpu (int): 'This tunable field defines the number of
            maximum subfiles a MPU directory can have.
    ...
    _names = {
        ...
        "max_subfiles_per_mpu": 'maxSubfilesPerMpu',
    ...
    def __init__(self,
        ...
        self.max_subfiles_per_mpu = max_subfiles_per_mpu
    ...
    def from_dictionary(cls,
        ...
        abac_enabled = dictionary.get('abacEnabled')
        ...
        max_subfiles_per_mpu = dictionary.get('maxSubfilesPerMpu')
        ...
        prefix_to_child_bucket_map = None
        if dictionary.get("prefixToChildBucketMap") is not None:
        ...
        tag_map = None
        if dictionary.get("tagMap") is not None:
            tag_map = list()
