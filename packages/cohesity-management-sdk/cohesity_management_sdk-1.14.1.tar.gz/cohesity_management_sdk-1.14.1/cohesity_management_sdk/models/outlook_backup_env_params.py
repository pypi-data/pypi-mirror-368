...
class OutlookBackupEnvParams(object):
    ...
    Attributes:
        attr_filter_policy (AttributeFilterPolicy): Specifies attribute filter policy to support inclusion/exclusions of
          entities.
    ...
    def from_dictionary(cls,
        ...
        attr_filter_policy = cohesity_management_sdk.models.attribute_filter_policy.AttributeFilterPolicy.from_dictionary(dictionary.get('attrFilterPolicy'))
