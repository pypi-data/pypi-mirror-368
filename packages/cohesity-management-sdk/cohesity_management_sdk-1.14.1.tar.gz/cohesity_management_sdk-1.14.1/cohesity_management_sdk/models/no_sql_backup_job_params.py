...
class NoSqlBackupJobParams(object):
    ...
    Attributes:
        auto_scale_concurrency (bool): Specifies a flag to auto scale concurrency.
        ...
        immediate_ancestor_map (list of
            ...
            immediate ancestor for each protected entites.
    ...
    def from_dictionary(cls,
        ...
        auto_scale_concurrency = dictionary.get('autoScaleConcurrency', None)
        ...
        immediate_ancestor_map = None
        if dictionary.get("immediateAncestorMap") is not None:
