...
class PerformRestoreJobStateProto(object):
    ...
    Attributes:
        ...
        encryption_params (EncryptionParams): This field defines the encryption
            ...
            For recovery to original location, this will not be set.
        ...
        request_sha1_checksum (list of int): Sha1 checksum of the restore
            request. This is used to identify the duplicate restore requests.
        ...
        restore_object_customizations (list of RestoreObjectCustomization): Field to
            indicate the objects specific customization.
        restore_outlook_params (RestoreOutlookParams): This field defines the Outlook specific params for restore task of type
        ...
        type (int): The type of restore being performed
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("restoreObjectCustomizations") is not None :
            ...
            for structure in dictionary.get('restoreObjectCustomizations') :
                restore_object_customizations.append(
                    cohesity_management_sdk.models.restore_object_customization.RestoreObjectCustomization.from_dictionary(structure))
        ...
        restore_task_vec = None
        if dictionary.get("restoreTaskVec") is not None:
