...
import cohesity_management_sdk.models.cluster_config_proto_vault_cloud_properties_s3_compatible_properties
...
class ClusterConfigProto_Vault_CloudProperties(object):
    ...
    Attributes:
        ...
        oracle_properties (ClusterConfigProto_Vault_CloudProperties_OracleProperties):
            TODO: Type description here.
        s3_compatible_properties (ClusterConfigProto_Vault_CloudProperties_S3CompatibleProperties)
            TODO: Type description here.
    ...
    _names = {
        ...
        "s3_compatible_properties": 's3CompatibleProperties'
    }
    ...
    def __init__(self,
        ...
        self.s3_compatible_properties = s3_compatible_properties
    ...
    def from_dictionary(cls,
        ...
        s3_compatible_properties = cohesity_management_sdk.models.cluster_config_proto_vault_cloud_properties_s3_compatible_properties.ClusterConfigProto_Vault_CloudProperties_S3CompatibleProperties.from_dictionary(dictionary.get('s3CompatibleProperties')) if dictionary.get('s3CompatibleProperties') else None
