...
class PhysicalTargetParams(object):
    ...
    Attributes:
        mount_target (RecoveryObjectIdentifier): Specifies the target entity where the
    ...
    def from_dictionary(cls,
        ...
        mount_target = cohesity_management_sdk.models_v2.recovery_object_identifier.RecoveryObjectIdentifier.from_dictionary(dictionary.get('mountTarget')) if dictionary.get('mountTarget') else None
        volume_mapping = None
