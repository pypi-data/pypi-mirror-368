...
class VmwareObjectProtectionUpdateRequestParams(object):
    ...
    Attributes:
        ...
        global_exclude_disks (list of DiskInformation): Specifies a list of disks to exclude from the backup.
    ...
    def __init__(self,
        ...
        """Constructor for the VmwareObjectProtectionUpdateRequestParams class"""
