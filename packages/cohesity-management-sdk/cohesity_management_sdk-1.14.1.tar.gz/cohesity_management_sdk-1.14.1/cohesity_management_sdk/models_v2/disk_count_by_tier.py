...
class DiskCountByTier(object):

    """Implementation of the 'DiskCountByTier' model.

    CountByTier provides the disk count of each storage tier.

    Attributes:
        disk_count (DiskCountEnum): DiskCount is the disk number of the storage tier.
    ...
    def __init__(self,
                 disk_count=None,
                 storage_tier=None):
        """Constructor for the DiskCountByTier class"""
    ...
    def from_dictionary(cls,
        ...
        return cls(disk_count, storage_tier)