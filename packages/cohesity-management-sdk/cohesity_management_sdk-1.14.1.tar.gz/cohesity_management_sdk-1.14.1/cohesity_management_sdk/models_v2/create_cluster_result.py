...
class CreateClusterResult(object):
    ...
    """Implementation of the 'Create Cluster Result.' model.

    Specifies the immediate result of a Cluster creation request Contains
      validation results for each node. If the request is valid, it also indicates
      that the individual node bringup operation is started in the background.
    ...
    def __init__(self,
        ...
        """Constructor for the Create Cluster Result class"""
