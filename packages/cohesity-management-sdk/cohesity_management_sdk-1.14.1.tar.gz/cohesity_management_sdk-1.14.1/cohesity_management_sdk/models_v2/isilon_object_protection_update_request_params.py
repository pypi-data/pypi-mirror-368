...
class IsilonObjectProtectionUpdateRequestParams(object):

    """Implementation of the 'IsilonObjectProtectionUpdateRequestParams' model.

    Specifies the update parameters which are specific to Isilon object
    protection.
    ...
    def __init__(self,
                 ...
                 use_changelist=None):
        """Constructor for the IsilonObjectProtectionUpdateRequestParams class"""
