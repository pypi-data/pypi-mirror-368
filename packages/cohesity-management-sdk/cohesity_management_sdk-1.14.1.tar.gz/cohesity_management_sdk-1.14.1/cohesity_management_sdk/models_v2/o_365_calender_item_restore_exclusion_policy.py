...
class O365CalendarItemRestoreExclusionPolicy(object):

    """Implementation of the 'O365CalendarItemRestoreExclusionPolicy' model.

    Specifies the filter policy to be applied for calendar item exclusions
    ...
    def __init__(self,
        ...
        """Constructor for the O365CalendarItemRestoreExclusionPolicy class"""
