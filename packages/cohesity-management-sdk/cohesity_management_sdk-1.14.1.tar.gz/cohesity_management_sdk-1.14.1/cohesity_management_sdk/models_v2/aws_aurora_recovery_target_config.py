...
class AWSAuroraRecoveryTargetConfig(object):

    """Implementation of the 'AWS Aurora Recovery Target Config.' model.
    ...
    Attributes:
        ...
        new_source_config (NewSourceConfig1): Specifies the new destination
            Source configuration parameters where the Aurora instances will be
    ...
    def __init__(self,
        ...
        """Constructor for the AWSAuroraRecoveryTargetConfig class"""
