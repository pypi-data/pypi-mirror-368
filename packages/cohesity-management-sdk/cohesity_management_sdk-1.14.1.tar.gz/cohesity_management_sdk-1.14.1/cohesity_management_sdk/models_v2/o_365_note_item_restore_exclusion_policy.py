...
class O365NoteItemRestoreExclusionPolicy(object):

    """Implementation of the 'O365NoteItemRestoreExclusionPolicy' model.

    Specifies the filter policy to be applied for note item exclusions
    ...
    def __init__(self,
        ...
        """Constructor for the O365NoteItemRestoreExclusionPolicy class"""
