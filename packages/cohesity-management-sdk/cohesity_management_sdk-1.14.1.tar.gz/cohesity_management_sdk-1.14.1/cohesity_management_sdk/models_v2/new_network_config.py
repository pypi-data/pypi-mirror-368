...
class NewNetworkConfig(object):
    ...
    Attributes:
        network_port_group (RecoveryObjectIdentifier): Specifies the network port
        ...
        mappings (list of RecoverVmwareVmNewNetworkConfigMapping): Specifies the target network
           mapping for each VM's network adapter.
    ...
    def from_dictionary(cls,
        ...
        network_port_group = cohesity_management_sdk.models_v2.recovery_object_identifier.RecoveryObjectIdentifier.from_dictionary(dictionary.get('networkPortGroup')) if dictionary.get('networkPortGroup') else None
