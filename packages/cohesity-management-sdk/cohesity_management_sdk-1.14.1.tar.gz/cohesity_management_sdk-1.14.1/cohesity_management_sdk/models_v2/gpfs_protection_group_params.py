...
class GpfsProtectionGroupParams(object):
    ...
    Attributes:
        ...
        filter_ip_config  (FilterIpConfigurations): Specifies the list of IP addresses that are allowed or denied
    ...
    def from_dictionary(cls,
        ...
        filer_ip_config = cohesity_management_sdk.models_v2.filter_ip_configuration.FilterIPConfiguration.from_dictionary(dictionary.get('filterIpConfig')) if dictionary.get('filterIpConfig') else None
