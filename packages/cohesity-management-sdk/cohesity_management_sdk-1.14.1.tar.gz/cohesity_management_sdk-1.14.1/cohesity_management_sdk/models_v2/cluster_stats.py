...
import cohesity_management_sdk.models_v2.usage_and_performance_stats
import cohesity_management_sdk.models_v2.data_usage_statistics
import cohesity_management_sdk.models_v2.logical_stats
...
class ClusterStats(object):
    ...
    def from_dictionary(cls,
        ...
        cloud_usage_perf_stats = cohesity_management_sdk.models_v2.usage_and_performance_stats.UsageAndPerformanceStats.from_dictionary(dictionary.get('cloudUsagePerfStats')) if dictionary.get('cloudUsagePerfStats') else None
        ...
        local_usage_perf_stats = cohesity_management_sdk.models_v2.usage_and_performance_stats.UsageAndPerformanceStats.from_dictionary(dictionary.get('localUsagePerfStats')) if dictionary.get('localUsagePerfStats') else None
        logical_stats = cohesity_management_sdk.models_v2.logical_stats.LogicalStats.from_dictionary(dictionary.get('logicalStats')) if dictionary.get('logicalStats') else None
        usage_perf_stats = cohesity_management_sdk.models_v2.usage_and_performance_stats.UsageAndPerformanceStats.from_dictionary(dictionary.get('usagePerfStats')) if dictionary.get('usagePerfStats') else None
