...
class FlashbladeObjectProtectionUpdateRequestParams(object):

    """Implementation of the 'FlashbladeObjectProtectionUpdateRequestParams' model.

    Specifies the update parameters which are specific to Flashblade object
    protection.
    ...
    def __init__(self,
                 ...
                 protocol=None):
        """Constructor for the FlashbladeObjectProtectionUpdateRequestParams class"""
