...
class HypervTargetParams5(object):
    ...
    Attributes:
        ...
        recover_excluded_disk (bool): Specifies whether to recover excluded disk while performing recovery
          of a VM by creating empty disks for them. Default value is false.
        use_smb_service (bool): Specifies if the HyperV recovery is using the SMB service to
          perform the restore. On-prem, this is the case by default. However, as of
          today, DMaaS does not support SMB, and HyperV VM VM restores will employ
    ...
    _names = {
        ...
        "recover_excluded_disk":'recoverExcludedDisk',
    ...
    def __init__(self,
        ...
        self.recover_excluded_disk = recover_excluded_disk
    ...
    def from_dictionary(cls,
        ...
        recover_excluded_disk = dictionary.get('recoverExcludedDisk')
