...
class UnprotectActionObjectLevelResponse(object):

    """Implementation of the 'UnprotectActionObjectLevelResponse' model.
    ...
    def __init__(self,
                 error=None):
        """Constructor for the UnprotectActionObjectLevelResponse class"""
