...
class GpfsObjectProtectionUpdateRequestParams(object):

    """Implementation of the 'GpfsObjectProtectionUpdateRequestParams' model.

    Specifies the update parameters which are specific to Gpfs object
    protection.
    ...
    def __init__(self,
                 ...
                 protocol=None):
        """Constructor for the GpfsObjectProtectionUpdateRequestParams class"""
