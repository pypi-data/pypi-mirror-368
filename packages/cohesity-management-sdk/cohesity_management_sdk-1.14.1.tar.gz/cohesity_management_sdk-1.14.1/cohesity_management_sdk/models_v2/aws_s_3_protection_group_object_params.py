...
class AWSS3ProtectionGroupObjectParams(object):

    """Implementation of the 'AWSS3ProtectionGroupObjectParams' model.
    ...
    def __init__(self,
                 id=None,
                 name=None):
        """Constructor for the AWSS3ProtectionGroupObjectParams class"""
