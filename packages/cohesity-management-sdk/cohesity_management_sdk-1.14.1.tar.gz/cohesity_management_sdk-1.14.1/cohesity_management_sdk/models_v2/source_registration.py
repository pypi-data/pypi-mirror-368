...
import cohesity_management_sdk.models_v2.entity_external_metadata
...
class SourceRegistration(object):
    ...
    Attributes:
        ...
        elastifilc_params (ElastifileRegistrationParams): Specifies the parameters to register
            an Elastifile Source.
        external_metadata (EntityExternalMetadata): Specifies the External Metadata registered
            for the entity.
    ...
    def from_dictionary(cls,
        ...
        source_info = cohesity_management_sdk.models_v2.object_information.Object.from_dictionary(dictionary.get('sourceInfo'))
        ...
        aws_params = cohesity_management_sdk.models_v2.aws_source_registration_params.AwsSourceRegistrationParams.from_dictionary(dictionary.get('awsParams'))
        azure_params = cohesity_management_sdk.models_v2.azure_source_registration_params.AzureSourceRegistrationParams.from_dictionary(dictionary.get('azureParams')) if dictionary.get('azureParams') else None
        elastifile_params = cohesity_management_sdk.models_v2.elastifile_protection_source.ElastifileProtectionSource.from_dictionary(dictionary.get('elastifileParams')) if dictionary.get('elastifileParams') else None
        ews_exchange_params = cohesity_management_sdk.models_v2.ews_exchange_source_registration_params.EwsExchangeSourceRegistrationParams.from_dictionary(dictionary.get('ewsExchangeParams')) if dictionary.get('ewsExchangeParams') else None
        external_metadata = cohesity_management_sdk.models_v2.entity_external_metadata.EntityExternalMetadata.from_dictionary(dictionary.get('externalMetadata')) if dictionary.get('externalMetadata') else None
        flashblade_params = cohesity_management_sdk.models_v2.flashblade_protection_source.FlashbladeProtectionSource.from_dictionary(dictionary.get('flashbladeParams')) if dictionary.get('flashbladeParams') else None
        generic_nas_params = cohesity_management_sdk.models_v2.generic_nas_protection_source.GenericNASProtectionSource.from_dictionary(dictionary.get('genericNasParams')) if dictionary.get('genericNasParams') else None
        gpfs_params = cohesity_management_sdk.models_v2.gpfs_protection_source.GPFSProtectionSource.from_dictionary(dictionary.get('gpfsParams')) if dictionary.get('gpfsParams') else None
        isilon_params = cohesity_management_sdk.models_v2.isilon_protection_source.IsilonProtectionSource.from_dictionary(dictionary.get('isilonParams')) if dictionary.get('isilonParams') else None
        netapp_params = cohesity_management_sdk.models_v2.netapp_protection_source.NetappProtectionSource.from_dictionary(dictionary.get('netappParams')) if dictionary.get('netappParams') else None
        office_365_params = cohesity_management_sdk.models_v2.office_365_source_registration_parameters.Office365SourceRegistrationParameters.from_dictionary(dictionary.get('office365Params')) if dictionary.get('office365Params') else None
        sfdc_params = cohesity_management_sdk.models_v2.register_sfdc_source_request_parameters.RegisterSFDCSourceRequestParameters.from_dictionary(dictionary.get('sfdcParams')) if dictionary.get('sfdcParams') else None
        uda_params = cohesity_management_sdk.models_v2.register_universal_data_adapter_source_registration_request_parameters.RegisterUniversalDataAdapterSourceRegistrationRequestParameters.from_dictionary(dictionary.get('udaParams')) if dictionary.get('udaParams') else None
        ...
        hyperv_params = cohesity_management_sdk.models_v2.hyper_v_source_registration_params.HyperVSourceRegistrationParams.from_dictionary(dictionary.get('hypervParams')) if dictionary.get('hypervParams') else None
