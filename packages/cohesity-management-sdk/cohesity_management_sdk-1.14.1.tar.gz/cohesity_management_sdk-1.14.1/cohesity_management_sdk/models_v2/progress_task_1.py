...
class ProgressTask1(object):

    """Implementation of the 'Progress Task1' model.

    This specifies the details about the Progress Task.

    Attributes:
        id (string): Specifies the task id of the Progress task.
        sub_tasks (list of ProgressTask): Specifies the list of Progress Task.
    ...
    def __init__(self,
                 ...
                 events=None,
                 stats=None):
        """Constructor for the ProgressTask1 class"""
    ...
    def from_dictionary(cls,
        ...
        sub_tasks = None
        if dictionary.get('subTasks') is not None:
            sub_tasks = list()
            for structure in dictionary.get('subTasks'):
                sub_tasks.append(cohesity_management_sdk.models_v2.progress_task.ProgressTask.from_dictionary(structure))
