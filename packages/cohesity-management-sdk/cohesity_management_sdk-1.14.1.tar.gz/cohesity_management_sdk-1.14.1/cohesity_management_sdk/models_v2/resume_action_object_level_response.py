...
class ResumeActionObjectLevelResponse(object):

    """Implementation of the 'ResumeActionObjectLevelResponse' model.
    ...
    def __init__(self,
                 error=None):
        """Constructor for the ResumeActionObjectLevelResponse class"""
