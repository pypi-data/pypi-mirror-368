...
class RecoverAWSAuroraNewSourceConfig(object):

    """Implementation of the 'Recover AWS Aurora New Source Config.' model.

    Specifies the new destination Source configuration where the Aurora
    instances will be recovered.

    Attributes:
        source (Source1): Specifies the id of the parent source to recover the
            Aurora.
        region (Region): Specifies the AWS region in which to deploy the
            Aurora instance.
    ...
    def __init__(self,
                 ...
                 region=None,
                 network_config=None):
        """Constructor for the RecoverAWSAuroraNewSourceConfig class"""
