...
class O365ContactItemRestoreExclusionPolicy(object):

    """Implementation of the 'O365ContactItemRestoreExclusionPolicy' model.

    Specifies the filter policy to be applied for contact item exclusions
    ...
    def __init__(self,
        ...
        """Constructor for the O365ContactItemRestoreExclusionPolicy class"""
