...
class UniversalId(object):
    ...
    Attributes:
        cluster_id (long|int): The id of the cluster at which the object was created.
        cluster_incarnation_id (long|int): The incarnation id of the above cluster.
        object_id (long|int): The object id - this is unique within the above cluster.
    ...
    def from_dictionary(cls,
        ...
        return cls(cluster_id, cluster_incarnation_id, object_id)