...
class CommonGenericNasProtectionParams(object):

    """Implementation of the 'CommonGenericNasProtectionParams' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CommonGenericNasProtectionParams class"""
