...
class SanEnvJobParams(object):

    """Implementation of the 'SanEnvJobParams' model.

    Specifies job parameters applicable for all SAN Environment types
      Protection Sources in a Protection Job.

    Attributes:
        max_snapshots_on_primary (long|int): Specifies how many recent snapshots of each backed up entity
          to retain on the primary environment. If not specified, then snapshots will
          not be be deleted from the primary environment.
    ...
    def __init__(self,
        ...
        """Constructor for the SanEnvJobParams class"""
