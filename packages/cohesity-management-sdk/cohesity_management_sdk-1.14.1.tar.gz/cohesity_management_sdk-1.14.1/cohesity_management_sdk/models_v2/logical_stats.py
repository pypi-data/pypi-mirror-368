...
class LogicalStats(object):
    ...
    Specifies the total logical data size of all the local and Cloud
      Tier data stored by the Cohesity Cluster

    Attributes:
        total_logical_usage_bytes (long|int): Specifies the size of data before
          reduction by deduplication and compression.
    """
