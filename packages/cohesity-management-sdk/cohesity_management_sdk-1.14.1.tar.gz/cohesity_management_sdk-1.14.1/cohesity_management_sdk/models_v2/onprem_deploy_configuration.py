...
import cohesity_management_sdk.models_v2.onprem_deploy_params

class OnpremDeployConfiguration(object):
    ...
    Attributes:
        ...
        restore_vm_ware_params (RestoreVMwareVMParams): Specifies information needed to identify various resources when
        ...
        params (OnpremDeployParams): Specifies the details about OnpremDeploy target where backup
    ...
    def from_dictionary(cls,
        ...
        params = cohesity_management_sdk.models_v2.onprem_deploy_params.OnpremDeployParams.from_dictionary(dictionary.get('params')) if dictionary.get('params') else None
