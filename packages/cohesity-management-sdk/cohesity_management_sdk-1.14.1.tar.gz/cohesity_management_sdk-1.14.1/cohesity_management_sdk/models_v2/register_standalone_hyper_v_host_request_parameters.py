...
class RegisterStandaloneHyperVhostrequestparameters(object):

    """Implementation of the 'Register standalone HyperV host request parameters' model.
    ...
    def __init__(self,
                 endpoint=None,
                 description=None):
        """Constructor for the RegisterStandaloneHyperVhostrequestparameters class"""
