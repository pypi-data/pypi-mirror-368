...
class NetworkConfig6(object):

    """Implementation of the 'NetworkConfig6' model.

    Specifies the networking configuration to be applied to this standby
    resource.
    ...
    def __init__(self,
        ...
        """Constructor for the NetworkConfig6 class"""
