...
class GoogleTier(object):

    """Implementation of the 'GoogleTier' model.
    ...
    Attributes:
        ...
        tier_type (TierType2Enum): Specifies the Google tier types.
    ...
    def __init__(self,
                 ...
                 move_after=None):
        """Constructor for the GoogleTier class"""
