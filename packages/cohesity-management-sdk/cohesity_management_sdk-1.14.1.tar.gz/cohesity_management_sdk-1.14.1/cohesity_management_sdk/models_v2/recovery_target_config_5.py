...
import cohesity_management_sdk.models_v2.recover_vmware_v_apps_new_source_config
...
class RecoveryTargetConfig5(object):
    ...
    Attributes:
        recover_to_new_source (bool): Specifies the parameter whether the
            ...
            Target.
        new_source_config (RecoverVmwareVAppsNewSourceConfig): Specifies the new destination
    ...
    def from_dictionary(cls,
        ...
        new_source_config = cohesity_management_sdk.models_v2.recover_vmware_v_apps_new_source_config.RecoverVmwareVAppsNewSourceConfig.from_dictionary(dictionary.get('newSourceConfig')) if dictionary.get('newSourceConfig') else None
