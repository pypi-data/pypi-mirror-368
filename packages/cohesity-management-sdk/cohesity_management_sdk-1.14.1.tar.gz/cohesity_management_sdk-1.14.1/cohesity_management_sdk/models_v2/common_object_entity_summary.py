...
class CommonObjectSummary(object):
    ...
    def from_dictionary(cls,
        ...
        sharepoint_site_summary = cohesity_management_sdk.models_v2.sharepoint_object_params.SharepointObjectParams.from_dictionary(
            dictionary.get('sharepointSiteSummary')) if dictionary.get('sharepointSiteSummary') else None
