...
import cohesity_management_sdk.models_v2.mssql_file_object_protection
import cohesity_management_sdk.models_v2.pre_and_post_script_params
import cohesity_management_sdk.models_v2.filter

class MssqlFileObjectProtectionParams(object):

    """Implementation of the 'MssqlFileObjectProtectionParams' model.

    Specifies the params to create a File based MSSQL Object Protection.

    Attributes:
        objects (list of MssqlFileObjectProtection): Specifies the list of
    ...
    def __init__(self,
        ...
        """Constructor for the MssqlFileObjectProtectionParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("objects") is not None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.mssql_file_object_protection.MssqlFileObjectProtection.from_dictionary(structure))
