...
class NewSourceConfig25(object):

    """Implementation of the 'NewSourceConfig25' model.
    ...
    Attributes:
        source (Source16): Specifies the id of the new target parent source to
    ...
    def __init__(self,
        ...
        """Constructor for the NewSourceConfig25 class"""
