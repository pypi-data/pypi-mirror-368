...
class IPMIConfigurationParams(object):

    """Implementation of the 'IPMIConfigurationParams' model.

    Specifies the parameters for configuration of IPMI.

    Attributes:
        ipmi_gateway (string): Specifies the default Gateway IP Address for the IPMI network
        ipmi_password (string): Specifies the IPMI Password
        ipmi_subnet_mask (string): Specifies the subnet mask for the IPMI network
    ...
    def __init__(self,
        ...
        """Constructor for the IPMIConfigurationParams class"""
