...
class RecoverVmwareParentSnapshotParams(object):

    """Implementation of the 'Recover VMware Parent Snapshot Params.' model.
    ...
    Attributes:
        ...
        child_snapshots (list of RecoverVmwareSnapshotParams): Specifies
            optional information about any child snapshots of this object. For
            example a VCD snapshot may have child VM information populated
            here.
    ...
    _names = {
        ...
        "child_snapshots":'childSnapshots'
    }
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverVmwareParentSnapshotParams class"""
        ...
        self.child_snapshots = child_snapshots
    ...
    def from_dictionary(cls,
        ...
        child_snapshots = None
        if dictionary.get("childSnapshots") is not None:
            child_snapshots = list()
            for structure in dictionary.get('childSnapshots'):
                child_snapshots.append(cohesity_management_sdk.models_v2.recover_vmware_snapshot_params.RecoverVmwareSnapshotParams.from_dictionary(structure))
