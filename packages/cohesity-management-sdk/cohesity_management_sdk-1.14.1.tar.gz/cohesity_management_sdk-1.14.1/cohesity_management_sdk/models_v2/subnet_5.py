...
class Subnet5(object):
    ...
    Attributes:
        ...
        nfs_all_squash (bool): Specifies whether all clients from this subnet can map view with
          view_all_squash_uid/view_all_squash_gid configured in the view.
        nfs_root_squash (bool): Specifies whether clients from this subnet can mount as root
          on NFS.
