...
import cohesity_management_sdk.models_v2.mssql_native_object_protection
import cohesity_management_sdk.models_v2.pre_and_post_script_params
import cohesity_management_sdk.models_v2.filter

class MssqlNativeObjectProtectionParams(object):
    ...
    def __init__(self,
        ...
        """Constructor for the MssqlNativeObjectProtectionParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("objects") is not None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.mssql_native_object_protection.MssqlNativeObjectProtection.from_dictionary(structure))
