...
import cohesity_management_sdk.models_v2.google_tier

class GoogleTiers(object):
    ...
    def __init__(self,
                 tiers=None):
        """Constructor for the GoogleTiers class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("tiers") is not None:
            ...
            for structure in dictionary.get('tiers'):
                tiers.append(cohesity_management_sdk.models_v2.google_tier.GoogleTier.from_dictionary(structure))
