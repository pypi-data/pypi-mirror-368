...
class AuroraConfig(object):
    ...
    """Implementation of the 'AuroraConfig' model.
    ...
    Attributes:
        ...
        db_parameter_group (DbParameterGroup): Specifies the entity
            ...
            DB.
        point_in_time_usecs (long|int): Specifies a point in time for recovery in microseconds.
    ...
    def __init__(self,
        ...
        """Constructor for the AuroraConfig class"""
