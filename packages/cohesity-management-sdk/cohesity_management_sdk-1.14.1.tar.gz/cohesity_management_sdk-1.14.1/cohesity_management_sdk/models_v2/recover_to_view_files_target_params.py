...
class RecoverToViewFilesTargetParams(object):
    """Implementation of the 'RecoverToViewFilesTargetParams' model.

    Specifies the params of the View recovery target.

    Attributes:
        alternate_path (string): Specifies the path location to recover files to.
    ...
    def __init__(self,
                 ...
                 vlan_config=None):
        """Constructor for the RecoverToViewFilesTargetParams class"""
