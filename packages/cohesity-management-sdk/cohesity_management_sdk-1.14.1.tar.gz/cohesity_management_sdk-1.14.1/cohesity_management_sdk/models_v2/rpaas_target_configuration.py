...
class RpaasTargetConfiguration(object):

    """Implementation of the 'Rpaas Target Configuration.' model.
    ...
    Attributes:
        ...
        target_id (long|int): Specifies the RPaaS target to copy the Snapshots.
        target_name (string): Specifies the RPaaS target name where Snapshots are copied.
        target_type (TargetTypeEnum): Specifies the RPaaS target type where Snapshots are copied.
    ...
    def __init__(self,
                 ...
                 target_name=None,
                 target_type=None):
        """Constructor for the RpaasTargetConfiguration class"""
