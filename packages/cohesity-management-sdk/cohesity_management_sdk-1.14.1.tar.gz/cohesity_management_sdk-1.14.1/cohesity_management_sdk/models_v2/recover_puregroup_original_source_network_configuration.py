...
class RecoverPuregroupOriginalSourceNetworkconfiguration(object):

    """Implementation of the 'RecoverPuregroupOriginalSourceNetworkconfiguration' model.

    Specifies the network config parameters to be applied for Pure group
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverPuregroupOriginalSourceNetworkconfiguration class"""
