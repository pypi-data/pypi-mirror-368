...
import cohesity_management_sdk.models_v2.recover_uda_object_params

class RecoverUniversalDataAdapterSnapshotParams(object):

    """Implementation of the 'Recover Universal Data Adapter Snapshot Params.' model.

    Specifies the snapshot parameters for a protected Universal Data Adapter
    object.
    ...
    Attributes:
        ...
        objects (list of RecoverUdaObjectParams): Specifies the local snapshot
            ids and other details of the objects to be recovered.
    ...
    def __init__(self,
                 ...
                 objects=None):
        """Constructor for the RecoverUniversalDataAdapterSnapshotParams class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("objects") is not None:
            ...
            for structure in dictionary.get('objects'):
                objects.append(cohesity_management_sdk.models_v2.recover_uda_object_params.RecoverUdaObjectParams.from_dictionary(structure))
