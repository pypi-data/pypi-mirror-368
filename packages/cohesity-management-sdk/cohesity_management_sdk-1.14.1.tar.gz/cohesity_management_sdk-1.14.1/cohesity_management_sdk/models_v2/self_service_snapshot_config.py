...
class SelfServiceSnapshotConfig(object):

    """Implementation of the 'SelfServiceSnapshotConfig' model.
    ...
    Attributes:
        ...
        nfs_access_enabled (bool): Specifies the configuration for
    ...
    def __init__(self,
        ...
        """Constructor for the SelfServiceSnapshotConfig class"""
