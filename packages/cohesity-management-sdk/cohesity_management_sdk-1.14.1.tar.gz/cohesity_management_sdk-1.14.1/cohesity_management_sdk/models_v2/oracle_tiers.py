...
import cohesity_management_sdk.models_v2.oracle_tier

class OracleTiers(object):

    """Implementation of the 'OracleTiers' model.

    Specifies Oracle tiers.

    Attributes:
        tiers (list of OracleTier): Specifies the tiers that are used to move
    ...
    def __init__(self,
                 tiers=None):
        """Constructor for the OracleTiers class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("tiers") is not None:
            ...
            for structure in dictionary.get('tiers'):
                tiers.append(cohesity_management_sdk.models_v2.oracle_tier.OracleTier.from_dictionary(structure))
