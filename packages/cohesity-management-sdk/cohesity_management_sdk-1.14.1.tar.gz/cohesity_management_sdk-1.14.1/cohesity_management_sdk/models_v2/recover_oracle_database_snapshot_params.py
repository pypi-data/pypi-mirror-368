...
import cohesity_management_sdk.models_v2.instant_recovery_info_1

class RecoverOracleDatabaseSnapshotParams(object):

    """Implementation of the 'Recover Oracle database Snapshot Params.' model.
    ...
    Attributes:
        ...
        instant_recovery_info (InstantRecoveryInfo1): Specifies the info about
    ...
    def __init__(self,
        ...
        """Constructor for the RecoverOracleDatabaseSnapshotParams class"""
    ...
    def from_dictionary(cls,
        ...
        instant_recovery_info = cohesity_management_sdk.models_v2.instant_recovery_info_1.InstantRecoveryInfo1.from_dictionary(dictionary.get('instantRecoveryInfo')) if dictionary.get('instantRecoveryInfo') else None
