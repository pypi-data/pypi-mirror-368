...
class O365TaskItemRestoreExclusionPolicy(object):

    """Implementation of the 'O365TaskItemRestoreExclusionPolicy' model.

    Specifies the filter policy to be applied for task item exclusions
    ...
    Attributes:
        ...
        exclude_before_time_secs (int|long): Any items before this time will be excluded from restore. The
    ...
    def __init__(self,
        ...
        """Constructor for the O365TaskItemRestoreExclusionPolicy class"""
