...
import cohesity_management_sdk.models_v2.version_info
import cohesity_management_sdk.models_v2.entity_identifiers
...
class StringEntityIds(object) :
    ...
    Attributes:
        latest_id (list of VersionInfo): Specifies the latest string entity id. This
    ...
    def from_dictionary(cls ,
        ...
        latest_id = cohesity_management_sdk.models_v2.version_info.VersionInfo.from_dictionary(
        ...
        if dictionary.get("latestSourceGeneratedIds") is not None :
            ...
            for structure in dictionary.get('latestSourceGeneratedIds') :
                latest_source_generated_ids.append(
                    cohesity_management_sdk.models_v2.entity_identifiers.EntityIdentifiers.from_dictionary(
                        structure))
        previous_ids = None
        if dictionary.get("previousIds") is not None :
            ...
            for structure in dictionary.get('previousIds') :
                previous_ids.append(
                    cohesity_management_sdk.models_v2.version_info.VersionInfo.from_dictionary(
                        structure))
        previous_source_generated_ids = None
