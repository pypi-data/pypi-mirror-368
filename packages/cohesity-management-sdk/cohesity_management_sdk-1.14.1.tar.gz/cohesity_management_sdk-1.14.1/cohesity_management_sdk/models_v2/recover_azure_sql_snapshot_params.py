...
import cohesity_management_sdk.models_v2.recover_azure_sql_object_params
...
class RecoverAzureSqlSnapshotParams(object):

    """Implementation of the 'RecoverAzureSqlSnapshotParams' model.

    Specifies the snapshot parameters for a protected Azure SQL object.

    Attributes:
        recover_azure_sql_object_params (RecoverAzureSqlObjectParams): Specifies the local snapshot ids and other details of the object
            to be recovered.
    ...
    _names = {
        ...
        "recover_azure_sql_object_params":'recoverAzureSqlObjectParams'
    }
    ...
    def __init__(self,
                 ...
                 recover_azure_sql_object_params=None):
        """Constructor for the RecoverAzureSqlSnapshotParams class"""
        ...
        self.recover_azure_sql_object_params = recover_azure_sql_object_params
    ...
    def from_dictionary(cls,
        ...
        object_info = cohesity_management_sdk.models_v2.object_summary.ObjectSummary.from_dictionary(dictionary.get('objectInfo')) if dictionary.get('objectInfo') else None
        snapshot_target_type = dictionary.get('snapshotTargetType')
        storage_domain_id = dictionary.get('storageDomainId')
        archival_target_info = cohesity_management_sdk.models_v2.archival_target.ArchivalTarget.from_dictionary(dictionary.get('archivalTargetInfo')) if dictionary.get('archivalTargetInfo') else None
        ...
        recover_azure_sql_object_params = cohesity_management_sdk.models_v2.recover_azure_sql_object_params.RecoverAzureSqlObjectParams.from_dictionary(
            dictionary.get('recoverAzureSqlObjectParams')) if dictionary.get('recoverAzureSqlObjectParams') else None
        ...
        recover_azure_sql_object_params)