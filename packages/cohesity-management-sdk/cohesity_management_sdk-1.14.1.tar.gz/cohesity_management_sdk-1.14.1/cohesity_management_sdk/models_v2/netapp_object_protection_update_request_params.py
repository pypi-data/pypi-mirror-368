...
class NetappObjectProtectionUpdateRequestParams(object):

    """Implementation of the 'NetappObjectProtectionUpdateRequestParams' model.

    Specifies the update parameters which are specific to Netapp object
    protection.
    ...
    def __init__(self,
        ...
        """Constructor for the NetappObjectProtectionUpdateRequestParams class"""
