...
class OracleEnvJobParams(object):
    """Implementation of the 'OracleEnvJobParams' model.

    Specifies job parameters applicable for all 'kOracle' Environment type Protection Sources in a Protection Job.

    Attributes:
        persist_mountpoints (bool): Specifies whether the mountpoints created while backing up Oracle DBs should be persisted. Note: This parameter is for the entire Job. For overriding persistence of mountpoints for a subset of Oracle hosts within the job, refer OracleSourceParams.
        vlan_params (object): Specifies the VLAN preference that is selected by the user for doing backup.
    """
    ...
    def __init__(self,
                 ...
                 vlan_params=None):
        """Constructor for the OracleEnvJobParams class"""
