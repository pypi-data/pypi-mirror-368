...
import cohesity_management_sdk.models_v2.mongo_db_cdp_job_info

class MongoDBProtectionGroupParams(object):

    """Implementation of the 'MongoDBProtectionGroupParams' model.
    ...
    Attributes:
        ...
        cdp_info (MongoDBCdpJobInfo): Specifies the CDP related information for a given protection
    ...
    def __init__(self,
                 ...
                 cdp_info=None):
        """Constructor for the MongoDBProtectionGroupParams class"""
    ...
    def from_dictionary(cls,
        ...
        cdp_info = cohesity_management_sdk.models_v2.mongo_db_cdp_job_info.MongoDBCdpJobInfo.from_dictionary(dictionary.get('cdpInfo'))
