...
class Cluster(object):
    ...
    Attributes:
        ...
        tenant_viewbox_sharing_enabled (bool): Specifies whether multiple tenants can be placed on the same
          viewbox.
        tiering_audit_log_config (AuditLogConfig): Specifies the SmartTier audit log configuration.
    ...
    def from_dictionary(cls,
        ...
        amqp_target_config = cohesity_management_sdk.models_v2.cluster_amqp_target_config.ClusterAMQPTargetConfig.from_dictionary(dictionary.get('amqpTargetConfig')) if dictionary.get('amqpTargetConfig') else None
        apps_subnet =cohesity_management_sdk.models_v2.subnet_5.Subnet5.from_dictionary(dictionary.get('appsSubnet')) if dictionary.get('appsSubnet') else None
        ...
        cluster_audit_log_config = cohesity_management_sdk.models_v2.cluster_audit_log_config.ClusterAuditLogConfig.from_dictionary(dictionary.get('clusterAuditLogConfig')) if dictionary.get('clusterAuditLogConfig') else None
        ...
        if dictionary.get('diskCountByTier') is not None:
            ...
            for structure in dictionary.get('diskCountByTier'):
                disk_count_by_tier.append(cohesity_management_sdk.models_v2.disk_count_by_tier.DiskCountByTier.from_dictionary(structure))
        ...
        eula_config = cohesity_management_sdk.models_v2.eula_config.EulaConfig.from_dictionary(dictionary.get('eulaConfig')) if dictionary.get('eulaConfig') else None
        fault_tolerance_level = dictionary.get('faultToleranceLevel')
        file_services_audit_log_config = cohesity_management_sdk.models_v2.audit_log_config.AuditLogConfig.from_dictionary(dictionary.get('fileServicesAuditLogConfig')) if dictionary.get('fileServicesAuditLogConfig') else None
        ...
        hardware_info = cohesity_management_sdk.models_v2.cluster_hardware_info.ClusterHardwareInfo.from_dictionary(dictionary.get('hardwareInfo')) if dictionary.get('hardwareInfo') else None
        ...
        license_state = cohesity_management_sdk.models_v2.license_state.LicenseState.from_dictionary(dictionary.get('licenseState')) if dictionary.get('licenseState') else None
        load_balancer_vip_config = cohesity_management_sdk.models_v2.load_balancer_config.LoadBalancerConfig.from_dictionary(dictionary.get('loadBalancerVipConfig')) if dictionary.get('loadBalancerVipConfig') else None
        ...
        ntp_settings = cohesity_management_sdk.models_v2.ntp_settings.NTPSettings.from_dictionary(dictionary.get('ntpSettings')) if dictionary.get('ntpSettings') else None
        ...
        rigel_cluster_params = cohesity_management_sdk.models_v2.rigel_cluster_params.RigelClusterParams.from_dictionary(dictionary.get('rigelClusterParams')) if dictionary.get('rigelClusterParams') else None
        ...
        if dictionary.get('schemaInfoList') is not None:
            ...
            for structure in dictionary.get('schemaInfoList'):
                schema_info_list.append(cohesity_management_sdk.models_v2.schema_info.SchemaInfo.from_dictionary(structure))
        ...
        stats = cohesity_management_sdk.models_v2.cluster_stats.ClusterStats.from_dictionary(dictionary.get('stats')) if dictionary.get('stats') else None
        supported_config = cohesity_management_sdk.models_v2.supported_config.SupportedConfig.from_dictionary(dictionary.get('supportedConfig')) if dictionary.get('supportedConfig') else None
        ...
        tiering_audit_log_config = cohesity_management_sdk.models_v2.audit_log_config.AuditLogConfig.from_dictionary(dictionary.get('tieringAuditLogConfig')) if dictionary.get('tieringAuditLogConfig') else None
        ...
        views_global_settings = cohesity_management_sdk.models_v2.views_global_settings.ViewsGlobalSettings.from_dictionary(dictionary.get('viewsGlobalSettings')) if dictionary.get('viewsGlobalSettings') else None
