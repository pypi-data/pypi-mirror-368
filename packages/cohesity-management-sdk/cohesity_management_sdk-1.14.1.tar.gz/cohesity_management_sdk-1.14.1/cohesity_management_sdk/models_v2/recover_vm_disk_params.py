...
import cohesity_management_sdk.models_v2.vmware_target_params_7
...
class RecoverVmDiskParams(object):
    ...
    Attributes:
        ...
        vmware_target_params (VmwareTargetParams7): Specifies the params for
    ...
    def from_dictionary(cls,
        ...
        vmware_target_params = cohesity_management_sdk.models_v2.vmware_target_params_7.VmwareTargetParams7.from_dictionary(dictionary.get('vmwareTargetParams')) if dictionary.get('vmwareTargetParams') else None
