...
class InstantRecoveryInfo1(object):

    """Implementation of the 'InstantRecoveryInfo1' model.

    Specifies the info about instant recovery. This is only applicable for
    RecoverOracle.

    Attributes:
        progress_task_id (string): Specifies the progress monitor id.
        status (Status16Enum): Specifies the status of the recovery.
    ...
    def __init__(self,
                 ...
                 end_time_usecs=None):
        """Constructor for the InstantRecoveryInfo1 class"""
