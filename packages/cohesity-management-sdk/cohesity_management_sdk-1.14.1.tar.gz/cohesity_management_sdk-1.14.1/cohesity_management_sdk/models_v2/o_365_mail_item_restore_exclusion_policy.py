...
class O365MailItemRestoreExclusionPolicy(object):

    """Implementation of the 'O365MailItemRestoreExclusionPolicy' model.

    Specifies the filter policy to be applied for mail item exclusions
    ...
    def __init__(self,
        ...
        """Constructor for the O365MailItemRestoreExclusionPolicy class"""
