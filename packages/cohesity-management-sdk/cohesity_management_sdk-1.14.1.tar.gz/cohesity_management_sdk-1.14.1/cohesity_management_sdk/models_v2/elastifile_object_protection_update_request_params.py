...
class ElastifileObjectProtectionUpdateRequestParams(object):

    """Implementation of the 'ElastifileObjectProtectionUpdateRequestParams' model.

    Specifies the update parameters which are specific to Elastifile object
    protection.
    ...
    def __init__(self,
                 ...
                 protocol=None):
        """Constructor for the ElastifileObjectProtectionUpdateRequestParams class"""
