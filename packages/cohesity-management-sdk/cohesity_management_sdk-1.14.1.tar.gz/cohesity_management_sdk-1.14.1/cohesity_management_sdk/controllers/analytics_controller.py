...
class AnalyticsController(BaseController):
    ...
    def delete_application(self, id):
        ...
        try:
            ...
            # Prepare headers
            self.logger.info('Preparing headers for delete_application.')
            _headers = {
                'accept'       : 'application/json' ,
                'content-type' : 'application/json; charset=utf-8'
            }
    ...
    def delete_mapper(self, id):
        ...
        try:
            ...
            # Prepare headers
            self.logger.info('Preparing headers for delete_mapper.')
            _headers = {
                'accept'       : 'application/json' ,
                'content-type' : 'application/json; charset=utf-8'
            }
    ...
    def delete_map_reduce_instance_run(self, id):
        ...
        try:
            ...
            # Prepare headers
            self.logger.info('Preparing headers for delete_map_ reduce_instance_run.')
            _headers = {
                'accept'       : 'application/json' ,
                'content-type' : 'application/json; charset=utf-8'
            }
    ...
    def delete_reducer(self, id):
        ...
        try:
            ...
            # Prepare headers
            self.logger.info('Preparing headers for delete_reducer.')
            _headers = {
                'accept'       : 'application/json' ,
                'content-type' : 'application/json; charset=utf-8'
            }
