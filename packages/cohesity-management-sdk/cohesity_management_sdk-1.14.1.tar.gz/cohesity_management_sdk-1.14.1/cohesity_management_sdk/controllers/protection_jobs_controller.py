    ...
    def get_protection_jobs(self,
        ...
        Args:
            ...
            prune_excluded_source_ids (bool, optional): If true, the list of
                ...
                not needed.
            include_source_names (bool): If true, both names and ids of Sources
                inside the protection group will be sent in the response.
        ...
        try:
            ...
            _query_parameters = {
                ...
                'includeSourceNames': include_source_names,
