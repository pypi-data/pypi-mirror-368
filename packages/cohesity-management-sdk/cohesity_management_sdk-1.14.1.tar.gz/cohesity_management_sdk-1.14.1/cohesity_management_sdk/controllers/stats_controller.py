...
class StatsController(BaseController):
    ...
    def get_consumer_stats(self,
        ...
        Args:
            ...
            msecs_before_current_time_to_compare (bool, optional): Specifies the
                time in msecs before current time to compare with.
    ...
    def get_view_box_stats(self,
        ...
        Args:
            ...
            max_count (long|int, optioanl): Specifies a limit on the number of stats
                groups returned.
            cookie (str, optional): Specifies the opaque string returned in the
                previous response.
