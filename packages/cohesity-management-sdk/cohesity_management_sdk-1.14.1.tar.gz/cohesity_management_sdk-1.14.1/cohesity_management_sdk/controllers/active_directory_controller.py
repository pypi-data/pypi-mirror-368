...
class ActiveDirectoryController(BaseController):
    ...
    def get_active_directory_entry(self,
                                   ...
                                   only_get_active_trusted_domains=None):
        ...
        Args:
            ...
            only_get_active_trusted_domains (bool, optional): Specifies whether to
                 retrieve only active trusted domains.
        ...
        try:
            ...
            _query_parameters = {
                ...
                'OnlyGetActiveTrustedDomains': only_get_active_trusted_domains
            }
