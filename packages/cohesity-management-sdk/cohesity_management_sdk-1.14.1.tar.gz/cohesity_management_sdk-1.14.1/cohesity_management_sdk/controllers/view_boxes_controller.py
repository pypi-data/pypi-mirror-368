...
class ViewBoxesController(BaseController):
    ...
    def get_view_boxes(self,
        ...
        Args:
            ...
            template_id (int|long, optional): Filter list of Storage Domain
                ...
                filtered.
            match_partial_names (bool, optional): If true, the names in 'names'
                field are matched by prefix rather than exactly matched.
    ...
    def delete_view_box(self, id):
        ...
        try:
            ...
            # Prepare headers
            self.logger.info('Preparing headers for delete_view_box.')
            _headers = {
                'accept'       : 'application/json' ,
                'content-type' : 'application/json; charset=utf-8'
            }
