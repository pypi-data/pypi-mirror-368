...
class ProtectionSourcesController(BaseController):
    ...
    def get_download_physical_agent(self,
        ...
        Args:
            host_type (HostTypeDownloadPhysicalAgentEnum): Specifies the host
                ...
                Sap Hana database system developed by SAP SE. 
                ...
                'kVOS' indicates the VOS database system.'kOther'
            ...
            agent_type (AgentTypeEnum, optional): Specifies agent type. Can be
                ...
                java agent. 'kGo' indicates a go agent. 'kLegacy' indicates a
                go agent.
            solaris_pkg_type (SolarisPkgTypeEnum): Specifies the Solaris
                installer package type applicable only to Solaris OS and the
                value can be any of ("kSolaris10x86","kSolaris10Sparc",
                "kSolaris11x86", "kSolaris11Sparc")
                'kSolaris10x86' indicates Solaris OS version 10 and x86
                architecture.
                'kSolaris10Sparc' indicates Solaris OS version 10 and Sparc
                architecture.
                'kSolaris11x86' indicates Solaris OS version 11 and x86
                architecture.
                'kSolaris11Sparc' indicates Solaris OS version 11 and Sparc
                architecture.
        ...
        try:
            ...
            _query_parameters = {
                ...
                'solarisPkgType': solaris_pkg_type
            }
    ...
    def list_protection_sources(self,
        ...
        Args:
            ...
            get_teams_channels (bool): Specifies whether to get the list of the
                ...
                in the query params.
            prune_membership_info (bool): Specifies whether to prune
                membershipInfo while fetching security groups. IsSecurityGroup
                should be true for pruning.
            ...
            exclude_azure_types (list of ExcludeAzureTypesEnum): Specifies the
                Object types to be filtered out for Azure that match the
                passed in types such as ''kVirtualMachine'', ''kSQLDatabase''.
                For example, set this parameter to ''kVirtualMachine'' to
                exclude azure VMs from being returned.
        ...
        try:
            ...
            _query_parameters = {
                ...
                'pruneMembershipInfo': prune_membership_info,
                ...
                'excludeAzureTypes': exclude_azure_types,
    ...
    def create_refresh_protection_source_by_id(self, id):
        ...
        try:
            ...
            # Prepare headers
            self.logger.info('Preparing headers for create_refresh_protection_source_by_id.')
            _headers = {
                'accept'       : 'application/json' ,
                'content-type' : 'application/json; charset=utf-8'
            }
    ...
    def list_protection_sources_registration_info(
        ...
        request_initiator_type=None,
        use_cached_data=None,
        include_external_metadata=None,
        ...
        Args:
            ...
            use_cached_data (bool, optional): Specifies whether we can serve
                ...
                master.
            include_external_metadata (bool, optional): Specifies if entity
                external metadata should be included within the response to get
                entity hierarchy call.
            include_applications_tree_info (bool, optional): Specifies whether
                to return applications tree info or not.
            maintenance_status (MaintenanceStatusEnum, optional): Specifies the
                maintenance status of a source
                ''UnderMaintenance'' indicates the source is currently under
                maintenance.
                ''ScheduledMaintenance'' indicates the source is scheduled for
                maintenance.
                ''NotConfigured'' indicates maintenance is not configured on
                the source.
            tenant_ids (list of string, optional): TenantIds contains ids of
                the tenants for which objects are to be returned.
            all_under_hierarchy (bool, optional): AllUnderHierarchy specifies
        ...
        try:
            ...
            _query_parameters = {
                ...
                'requestInitiatorType': request_initiator_type,
                'useCachedData': use_cached_data,
                'includeExternalMetadata': include_external_metadata,
...
Success
    ...
    def list_virtual_machines(self,
        ...
        Args:
            ...
            prune_non_critical_info (bool, optional): Specifies whether to
                prune non-critical info within entities.
    ...
    def delete_unregister_protection_source(self, id):
        ...
        try:
            ...
            # Prepare headers
            self.logger.info('Preparing headers for delete_unregister_protection_source.')
            _headers = {
                'accept'       : 'application/json' ,
                'content-type' : 'application/json; charset=utf-8'
            }
