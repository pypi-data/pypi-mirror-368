...
class ProtectionPoliciesController(BaseController):
    ...
    def get_protection_policies(self,
        ...
        Args:
            ...
            include_replicated (bool, optional): Specifies whether to fetch
                replicated policies in addition to local policies.
        ...
        try:
            ...
            _query_parameters = {
                ...
                'origin': origin,
                'types': types,
                'includeReplicated': include_replicated,
