...
class Requirements(object):
    ...
    def get():
        ...
        :return:
        """
        requirements = ["m-singleton>=0.3", "requests>=2.32.4", "unidecode==1.1.1", "elasticsearch>=8.0.0"]
        return requirements


version_dev='0.1.9'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
