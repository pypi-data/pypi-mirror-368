...
class RedisConnection:
    ...
    def _serialize_value(self, value: Any) -> str:
        ...
        # Handle asyncpg.Record objects
            ...
            return json.dumps({"type": "record", "value": dict(value)})
        elif isinstance(value, (list, tuple)):
            serialized_items = []
            for item in value:
                if hasattr(item, '_mapping'):
                    serialized_items.append({"type": "record", "value": dict(item)})
                else:
    ...
    def _deserialize_value(self, value: str) -> Any:
        ...
        try:
            ...
            if not isinstance(data, dict) or "type" not in data:
                # Fallback for old format or plain values
                return data
            ...
            if data_type == "primitive":
                ...
                # Return as dict since we can't recreate asyncpg.Record
                return data_value
            elif data_type == "list":
                result = []
            ...
            # Fallback to original value if deserialization fails
            return value
