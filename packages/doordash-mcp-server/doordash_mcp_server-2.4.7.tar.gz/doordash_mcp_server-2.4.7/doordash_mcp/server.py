...
- options: Array of {"option_id": "...", "name": "...", "quantity": 1} from menu item details
...
**✅ Working Example - McDonald's Apple Pie:**
- store_id: 653770, item_id: 6597052550
- item_name: "Apple Pie", unit_price: 363 (cents = $3.63)
- options: [{"option_id": "32988437816", "name": "Single", "quantity": 1}]
...
Args:
    ...
    options: Size/customization options from menu item details
