...
from zia import Config
from zia.models import NLIRResult, NLIRResultStatus
...
class TestImageRecognitionResults:
    ...
    @pytest.fixture
    def sample_base_ir_result_data(self):
        ...
        return {
            ...
            "image_url": "https://storage.googleapis.com/zia-web-public/production/ir-tasks/158ecfd4-f5c0-430d-9b2e-e5f43f753e0e/4599d2c8-a7ec-4fd2-81ab-a1972d74b5e0.jpeg",
            "status": "PROCESSED",
            "failure_reason": "",
            "duration": 16.546352,
                ...
                "images": [
                    {
                        ...
                        "license": 1,
                        "coco_url": "",
                        "file_name": "https://storage.googleapis.com/zia-web-public/production/ir-tasks/158ecfd4-f5c0-430d-9b2e-e5f43f753e0e/4599d2c8-a7ec-4fd2-81ab-a1972d74b5e0.jpeg",
                        "flickr_url": "",
                        "date_captured": "",
                    }
                ],
    ...
    @pytest.fixture
    def sample_ir_results_list_data(self, sample_base_ir_result_data):
    ...
    def test_ir_result_model_creation(self, sample_base_ir_result_data):
        ...
        assert result.postprocessing_results == {"realogram": None, "shares": []}
