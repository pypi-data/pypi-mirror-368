...
> AddGrafanaDatasource200Response add_grafana_datasource(datasource_name, datasource_type, datasource_url, database_name=database_name, username=username, password=password, is_default=is_default, basic_auth=basic_auth)
...
> DeployGrafanaDashboards200Response deploy_grafana_dashboards()
...
with ObservabilityAPI.ApiClient(configuration) as api_client:
    ...
    try:
        # Deploy Grafana Dashboards
        api_response = api_instance.deploy_grafana_dashboards()
