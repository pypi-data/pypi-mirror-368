...
pub fn node_from_stream_backrefs(
    ...
    // this contains the actual value and then an optional cached list which represents value stack as a chiklisp list
...
pub fn traverse_path_with_vec(
    ...
    // the vec is a stack so a ChikLisp list of (3 . (2 . (1 . NIL))) would be [1, 2, 3]
    // however entries in this vec may be ChikLisp SExps so it may look more like [1, (2 . NIL), 3]
