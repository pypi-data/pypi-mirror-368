...
#        )
    for ax in resistivity_axes:
        ...
        # Use a ScalarFormatter to force float/integer labels and disable scientific notation
        formatter = ticker.ScalarFormatter(useMathText=True, useOffset=False)
        ax.xaxis.set_major_formatter(formatter)

        # Manually set the tick labels with string conversion to be safe
        ax.set_xticklabels([str(tick) for tick in resistivity_ticks])
