...
get_proapi_origin = cycle(("https://pro.api.115.com", "https://proapi.115.com")).__next__
get_webapi_origin = cycle(("https://web.api.115.com", "https://webapi.115.com")).__next__
get_cdn_origin = cycle(("https://115cdn.com", "https://115vod.com")).__next__
...
def complete_proapi(
    ...
    if callable(base_url):
        ...
        base_url = "https://pro.api.115.com"
    if not app and path.startswith("/open/") and base_url == "https://pro.api.115.com":
        base_url = "https://proapi.115.com"
...
class P115Client(P115OpenClient):
    ...
    def fs_makedirs_app(
        ...
        **request_kwargs, 
        ...
        POST https://pro.api.115.com/app/chrome/add_path
    ...
    def life_batch_delete(
        ...
        **request_kwargs, 
        ...
        api = f"https://life.115.com/api/1.0/{app}/1.0/life/life_batch_delete"
        return self.request(
            url=api, 
            method="POST", 
            data=payload, 
    ...
    def life_calendar_getoption2(
        ...
        **request_kwargs, 
        ...
        """
        api = f"https://life.115.com/api/1.0/{app}/1.0/calendar/recent_operations_getoption"
        return self.request(url=api, async_=async_, **request_kwargs)
    ...
    def life_calendar_setoption2(
        ...
        **request_kwargs, 
        ...
        if isinstance(payload, dict):
            ...
            payload = {"locus": 1, "open_life": payload}
        api = f"https://life.115.com/api/1.0/{app}/1.0/calendar/recent_operations_setoption"
        return self.request(url=api, method="POST", data=payload, async_=async_, **request_kwargs)
    ...
    def life_clear_history(
        ...
        **request_kwargs, 
        ...
        if isinstance(payload, int):
            payload = {"tab_type": 0}
        api = f"https://life.115.com/api/1.0/{app}/1.0/life/life_clear_history"
        return self.request(url=api, method="POST", data=payload, async_=async_, **request_kwargs)
    ...
    def life_has_data(
        ...
        **request_kwargs, 
        ...
        """
        api = f"https://life.115.com/api/1.0/{app}/1.0/life/life_has_data"
        if isinstance(payload, int):
    ...
    def life_list2(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - type: int = <default> 💡 类型
        """
        api = f"https://life.115.com/api/1.0/{app}/1.0/life/recent_operations"
        if isinstance(payload, (int, str)):
            payload = {"start": payload}
        payload = {"limit": 1_000, "show_type": 0, "start": 0, **payload}
        return self.request(url=api, params=payload, async_=async_, **request_kwargs)
    ...
    def _offline_web_request(
        ...
        **request_kwargs, 
        ...
        api = "https://lixian.115.com/web/lixian/"
        if ac:
            payload["ac"] = ac
        if method.upper() == "POST":
            request_kwargs["data"] = payload
    ...
    def _offline_lixian_request(
        ...
        **request_kwargs, 
        ...
        api = "https://lixian.115.com/lixian/"
        if ac:
            payload["ac"] = ac
        if method.upper() == "POST":
            request_kwargs["data"] = payload
    ...
    def _offline_lixianssp_request(
        ...
        **request_kwargs, 
        ...
        api = "https://lixian.115.com/lixianssp/"
    ...
    def user_points_balance(
        ...
        **request_kwargs, 
        ...
        """
        api = f"https://points.115.com/api/1.0/{app}/1.0/user/balance"
        return self.request(url=api, async_=async_, **request_kwargs)
    ...
    def user_points_transaction(
        ...
        **request_kwargs, 
        ...
        if isinstance(payload, int):
            payload = {"start": payload}
        payload.setdefault("limit", 32)
        api = f"https://points.115.com/api/1.0/{app}/1.0/user/transaction"
        return self.request(url=api, params=payload, async_=async_, **request_kwargs)
