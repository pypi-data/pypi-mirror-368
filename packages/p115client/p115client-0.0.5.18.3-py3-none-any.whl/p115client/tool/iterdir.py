...
def ensure_attr_path[D: dict](
    ...
    **request_kwargs, 
    ...
    if not isinstance(client, P115Client) or app == "open":
        ...
        request_kwargs.setdefault("base_url", cycle(("https://web.api.115.com", "https://webapi.115.com")).__next__)
        get_info = client.fs_category_get
    else:
        request_kwargs.setdefault("base_url", cycle(("https://pro.api.115.com", "https://proapi.115.com")).__next__)
...
def iter_nodes(
    ...
    **request_kwargs, 
    ...
    request_kwargs.setdefault(
        "base_url", 
        cycle(("https://web.api.115.com", "https://webapi.115.com")).__next__, 
    )
...
def iter_nodes_by_pickcode(
    ...
    **request_kwargs, 
    ...
    if ignore_deleted or ignore_deleted is None:
        methods += (
            partial(client.fs_document, base_url="https://web.api.115.com"), 
            partial(client.fs_document_app, base_url="https://pro.api.115.com"), 
            partial(client.fs_document_app, base_url="https://proapi.115.com"), 
        )
    if not ignore_deleted:
       methods += (
            partial(client.fs_supervision, base_url="https://web.api.115.com"), 
            partial(client.fs_supervision_app, base_url="https://pro.api.115.com"), 
...
def iter_nodes_using_update(
    ...
    **request_kwargs, 
    ...
    request_kwargs.setdefault(
        "base_url", 
        cycle(("https://pro.api.115.com", "https://proapi.115.com")).__next__, 
    )
    def project(resp: dict, /) -> None | dict:
...
def iter_nodes_using_info(
    ...
    **request_kwargs, 
    ...
    if not isinstance(client, P115Client) or app == "open":
        ...
        get_method = cycle((
            partial(client.fs_category_get, base_url="https://web.api.115.com"), 
            partial(client.fs_category_get_app, base_url="https://pro.api.115.com"), 
        ...
        get_method = cycle((
            partial(client.fs_category_get_app, base_url="https://pro.api.115.com", app=app), 
    ...
    **request_kwargs, 
    ...
    def gen_step():
        ...
        if app in ("", "web", "desktop", "harmony"):
            get_base_url = cycle(("https://web.api.115.com", "https://webapi.115.com")).__next__
        else:
            get_base_url = cycle(("https://pro.api.115.com", "https://proapi.115.com")).__next__
