...
8.回复的文本对于价格、优惠、地址、医院名称、药品等信息模糊的描述相较于具体的描述更好，也就是回复中尽量不要出现类似“250元”、“九折”、“厦门中诺口腔”这样的具体的个性化信息。
9.回复的文本准确的知识越充分并且知识一定要逻辑合理，则认为回复越好。
10.回复的文本与对话历史的衔接，答疑的关联性，问诊的逻辑承接，套电的关联性越好，则认为回复越好。
11.回复的文本中包含有助于推进对对话的问诊或者合适套电时机就进行套电会更好。
12.回复的文本表达相对完整的，字符数不少于15，并且不超过80的，则认为回复更合理一些。
