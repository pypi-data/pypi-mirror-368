...
class SkillExtractorRefactored:
        ...
        try:
            ...
            if self.model_id == 'gemini':
                ...
                try:
                    ...
                    print(f"⚠️ Transformer model fallback also failed: {e}")
            else:
                ...
                try:
                    ...
                    print(f"⚠️ Transformer model initialization failed: {e}")
            
            # If all else fails, warn but continue
            print("⚠️ No model successfully initialized. Extraction methods may have limited functionality.")
            print("💡 Consider using Gemini API by setting model_id='gemini' and providing an api_key.")
    ...
    def _initialize_vllm(self):
        ...
        try:
            ...
            print(f"⚠️ vLLM model loading failed: {e}")
            self.llm = None
            raise e
        except Exception as e:
            print(f"⚠️ Unexpected vLLM initialization error: {e}")
            self.llm = None
            raise e
    ...
    def _extract_ksa_skills(self, input_data: Dict[str, str], input_type: str, id_column: str) -> List[Dict[str, Any]]:
        ...
        if self.llm is not None:
            ...
            esco_skills = self.get_top_esco_skills(input_data.get("description", ""), top_k=10)
            ...
            for skill in basic_skills:
                ksa_results.append({
                    ...
                    'Knowledge Required': ['domain knowledge', 'technical skills', 'best practices'],
                    'Task Abilities': ['problem solving', 'implementation', 'optimization'],
