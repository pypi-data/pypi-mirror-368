...
#$ -o /unix/cedar/jmb/Work/Regression_Rebuild/myscan00/13TeV/0001/contur.log # Output file path
...
cd /unix/cedar/jmb/Work/Regression_Rebuild/myscan00/13TeV/0001
Herwig read herwig.in -I /unix/cedar/jmb/Work/Regression_Rebuild/RunInfo -L /unix/cedar/jmb/Work/Regression_Rebuild/RunInfo;
Herwig run herwig.run --seed=101  --tag=runpoint_0001  --numevents=30000 ;
