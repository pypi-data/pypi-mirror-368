...
invMscale = Parameter(name = 'invMscale',
                      nature = 'external',
                      type = 'real',
                      value = 0.001,
                      texname = '\\text{invM}_{\\text{new}}',
                      lhablock = 'YUKAWA',
                      lhacode = [ 16 ])

invNscale = Parameter(name = 'invNscale',
                      nature = 'external',
                      type = 'real',
                      value = 0.001,
                      texname = '\\text{invN}_{\\text{new}}',
                      lhablock = 'YUKAWA',
                      lhacode = [ 17 ])
...
mphinew = Parameter(name = 'mphinew',
                    nature = 'external',
                    type = 'real',
                    value = 0.001,
                    texname = '\\text{mphinew}',
...
widthphi = Parameter(name = 'widthphi',
                     nature = 'external',
                     type = 'real',
                     value = 0.00407,
                     texname = '\\text{widthphi}',
                     lhablock = 'DECAY',
                     lhacode = [ 51 ])
