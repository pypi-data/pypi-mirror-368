...
V_63 = Vertex(name = 'V_63',
              particles = [ P.a, P.Y1, P.G__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_34})

V_64 = Vertex(name = 'V_64',
              particles = [ P.Y1, P.G0, P.H ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_33})

V_65 = Vertex(name = 'V_65',
              particles = [ P.Y1, P.G__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_69 = Vertex(name = 'V_69',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1, L.FFV2 ],
              couplings = {(0,1):C.GC_21,(0,0):C.GC_39})
...
V_79 = Vertex(name = 'V_79',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1, L.FFV2 ],
              couplings = {(0,1):C.GC_20,(0,0):C.GC_38})

V_80 = Vertex(name = 'V_80',
              particles = [ P.Xd__tilde__, P.Xd, P.Y1 ],
              color = [ '1' ],
              lorentz = [ L.FFV1, L.FFV2 ],
              couplings = {(0,1):C.GC_24,(0,0):C.GC_43})

V_81 = Vertex(name = 'V_81',
              particles = [ P.W__minus__, P.Y1, P.G0, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_67})

V_82 = Vertex(name = 'V_82',
              particles = [ P.W__minus__, P.Y1, P.G__plus__, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_66})

V_83 = Vertex(name = 'V_83',
              particles = [ P.W__minus__, P.Y1, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
              couplings = {(0,0):C.GC_92})

V_84 = Vertex(name = 'V_84',
              particles = [ P.W__plus__, P.Y1, P.G0, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_67})

V_85 = Vertex(name = 'V_85',
              particles = [ P.W__plus__, P.Y1, P.G__minus__, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_68})

V_86 = Vertex(name = 'V_86',
              particles = [ P.W__plus__, P.Y1, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
...
V_98 = Vertex(name = 'V_98',
              particles = [ P.Y1, P.Z, P.G0, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_78})

V_99 = Vertex(name = 'V_99',
              particles = [ P.Y1, P.Z, P.G__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_79})

V_100 = Vertex(name = 'V_100',
               particles = [ P.Y1, P.Z, P.H, P.H ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
               couplings = {(0,0):C.GC_78})

V_101 = Vertex(name = 'V_101',
               particles = [ P.Y1, P.Z, P.H ],
               color = [ '1' ],
               lorentz = [ L.VVS1 ],
...
V_141 = Vertex(name = 'V_141',
               ...
               couplings = {(0,0):C.GC_74,(0,1):C.GC_70})
...
V_144 = Vertex(name = 'V_144',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV3, L.FFV4 ],
               couplings = {(0,0):C.GC_73,(0,1):C.GC_69})
...
V_150 = Vertex(name = 'V_150',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV3, L.FFV4 ],
               couplings = {(0,0):C.GC_75,(0,1):C.GC_71})
