...
GC_192 = Coupling(name = 'GC_192',
                  value = '-((complex(0,1)*tanbeta*TH2x1*ymb)/vev)',
                  order = {'QED':1,'YB':1})

GC_193 = Coupling(name = 'GC_193',
                  value = '-((complex(0,1)*tanbeta*TH2x2*ymb)/vev)',
                  order = {'QED':1,'YB':1})
...
GC_196 = Coupling(name = 'GC_196',
                  value = '(complex(0,1)*tanbeta*TH2x1*ymt)/vev',
                  order = {'QED':1,'YT':1})

GC_197 = Coupling(name = 'GC_197',
                  value = '(complex(0,1)*tanbeta*TH2x2*ymt)/vev',
                  order = {'QED':1,'YT':1})

GC_198 = Coupling(name = 'GC_198',
                  value = '-((tanbeta*TH3x3*ymt)/vev)',
                  order = {'QED':1,'YT':1})
...
GC_203 = Coupling(name = 'GC_203',
                  value = '-((complex(0,1)*TH1x1*yt)/cmath.sqrt(2))',
                  order = {'QED':1})

GC_204 = Coupling(name = 'GC_204',
                  value = '-((complex(0,1)*TH1x2*yt)/cmath.sqrt(2))',
                  order = {'QED':1})
