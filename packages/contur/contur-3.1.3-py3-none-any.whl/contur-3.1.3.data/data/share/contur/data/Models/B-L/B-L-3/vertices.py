...
V_82 = Vertex(name = 'V_82',
              ...
              color = [ '1' ],
              lorentz = [ L.FFS3, L.FFS5 ],
              couplings = {(0,0):C.GC_182,(0,1):C.GC_196})
...
V_84 = Vertex(name = 'V_84',
              ...
              color = [ '1' ],
              lorentz = [ L.FFS3, L.FFS5 ],
              couplings = {(0,0):C.GC_247,(0,1):C.GC_208})
...
V_113 = Vertex(name = 'V_113',
               ...
               color = [ '1' ],
               lorentz = [ L.FFS3, L.FFS5 ],
               couplings = {(0,0):C.GC_191,(0,1):C.GC_199})

V_114 = Vertex(name = 'V_114',
               particles = [ P.nH3, P.ta__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS3, L.FFS5 ],
               couplings = {(0,0):C.GC_249,(0,1):C.GC_205})
...
V_140 = Vertex(name = 'V_140',
               ...
               color = [ '1' ],
               lorentz = [ L.FFS3, L.FFS5 ],
               couplings = {(0,0):C.GC_195,(0,1):C.GC_181})

V_141 = Vertex(name = 'V_141',
               particles = [ P.mu__plus__, P.n2, P.G__minus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS3, L.FFS5 ],
               couplings = {(0,0):C.GC_201,(0,1):C.GC_188})

V_142 = Vertex(name = 'V_142',
               particles = [ P.ta__plus__, P.n3, P.G__minus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS3, L.FFS5 ],
               couplings = {(0,0):C.GC_207,(0,1):C.GC_246})
...
V_144 = Vertex(name = 'V_144',
               ...
               color = [ '1' ],
               lorentz = [ L.FFS3, L.FFS5 ],
               couplings = {(0,0):C.GC_200,(0,1):C.GC_192})

V_145 = Vertex(name = 'V_145',
               particles = [ P.ta__plus__, P.nH3, P.G__minus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS3, L.FFS5 ],
               couplings = {(0,0):C.GC_206,(0,1):C.GC_250})
