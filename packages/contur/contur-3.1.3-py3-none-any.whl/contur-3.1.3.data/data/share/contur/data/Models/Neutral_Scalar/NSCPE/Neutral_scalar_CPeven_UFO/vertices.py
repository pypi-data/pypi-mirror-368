...
V_11 = Vertex(name = 'V_11',
              particles = [ P.a, P.a, P.G__minus__, P.G__plus__, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.VVSSS1 ],
              couplings = {(0,0):C.GC_13})

V_12 = Vertex(name = 'V_12',
              particles = [ P.G0, P.G0, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.SSS2 ],
...
V_14 = Vertex(name = 'V_14',
              particles = [ P.a, P.G__minus__, P.G__plus__, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.VSSS1 ],
              couplings = {(0,0):C.GC_12})

V_15 = Vertex(name = 'V_15',
              particles = [ P.G__minus__, P.G__plus__, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.SSS2 ],
              couplings = {(0,0):C.GC_11})

V_16 = Vertex(name = 'V_16',
              particles = [ P.H, P.H, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.SSS2 ],
              couplings = {(0,0):C.GC_11})
...
V_19 = Vertex(name = 'V_19',
              ...
              couplings = {(0,1):C.GC_17,(0,0):C.GC_131})
...
V_21 = Vertex(name = 'V_21',
              ...
              color = [ '1' ],
              lorentz = [ L.VVS1, L.VVS2 ],
              couplings = {(0,1):C.GC_111,(0,0):C.GC_140})
...
V_49 = Vertex(name = 'V_49',
              particles = [ P.g, P.g, P.g, P.g, P.phiNP ],
              color = [ 'f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
...
V_91 = Vertex(name = 'V_91',
              particles = [ P.a, P.W__minus__, P.G0, P.G__plus__, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.VVSSS1 ],
              couplings = {(0,0):C.GC_95})

V_92 = Vertex(name = 'V_92',
              particles = [ P.a, P.W__minus__, P.G__plus__, P.H, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.VVSSS1 ],
...
V_94 = Vertex(name = 'V_94',
              particles = [ P.a, P.W__minus__, P.G__plus__, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_96 = Vertex(name = 'V_96',
              particles = [ P.W__minus__, P.G0, P.G__plus__, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.VSSS1 ],
...
V_98 = Vertex(name = 'V_98',
              particles = [ P.W__minus__, P.G__plus__, P.H, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.VSSS1 ],
              couplings = {(0,0):C.GC_91})

V_99 = Vertex(name = 'V_99',
              particles = [ P.W__minus__, P.G__plus__, P.phiNP ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_104 = Vertex(name = 'V_104',
               particles = [ P.a, P.W__plus__, P.G0, P.G__minus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
               couplings = {(0,0):C.GC_95})

V_105 = Vertex(name = 'V_105',
               particles = [ P.a, P.W__plus__, P.G__minus__, P.H, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
...
V_107 = Vertex(name = 'V_107',
               particles = [ P.a, P.W__plus__, P.G__minus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_109 = Vertex(name = 'V_109',
               particles = [ P.W__plus__, P.G0, P.G__minus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
...
V_111 = Vertex(name = 'V_111',
               particles = [ P.W__plus__, P.G__minus__, P.H, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
               couplings = {(0,0):C.GC_91})

V_112 = Vertex(name = 'V_112',
               particles = [ P.W__plus__, P.G__minus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VSS1 ],
               couplings = {(0,0):C.GC_128})
...
V_116 = Vertex(name = 'V_116',
               particles = [ P.W__minus__, P.W__plus__, P.G0, P.G0, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
               couplings = {(0,0):C.GC_67})

V_117 = Vertex(name = 'V_117',
               particles = [ P.W__minus__, P.W__plus__, P.G__minus__, P.G__plus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
               couplings = {(0,0):C.GC_67})

V_118 = Vertex(name = 'V_118',
               particles = [ P.W__minus__, P.W__plus__, P.H, P.H, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
               couplings = {(0,0):C.GC_67})
...
V_120 = Vertex(name = 'V_120',
               particles = [ P.W__minus__, P.W__plus__, P.H, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_122 = Vertex(name = 'V_122',
               particles = [ P.a, P.a, P.W__minus__, P.W__plus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVVVS2 ],
...
V_126 = Vertex(name = 'V_126',
               particles = [ P.W__minus__, P.W__minus__, P.W__plus__, P.W__plus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVVVS2 ],
...
V_131 = Vertex(name = 'V_131',
               particles = [ P.a, P.Z, P.G__minus__, P.G__plus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
...
V_133 = Vertex(name = 'V_133',
               particles = [ P.Z, P.G0, P.H, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
               couplings = {(0,0):C.GC_105})

V_134 = Vertex(name = 'V_134',
               particles = [ P.Z, P.G0, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VSS1 ],
...
V_136 = Vertex(name = 'V_136',
               particles = [ P.Z, P.G__minus__, P.G__plus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
...
V_139 = Vertex(name = 'V_139',
               particles = [ P.W__minus__, P.Z, P.G0, P.G__plus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
               couplings = {(0,0):C.GC_15})

V_140 = Vertex(name = 'V_140',
               particles = [ P.W__minus__, P.Z, P.G__plus__, P.H, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
...
V_142 = Vertex(name = 'V_142',
               particles = [ P.W__minus__, P.Z, P.G__plus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_145 = Vertex(name = 'V_145',
               particles = [ P.W__plus__, P.Z, P.G0, P.G__minus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
               couplings = {(0,0):C.GC_15})

V_146 = Vertex(name = 'V_146',
               particles = [ P.W__plus__, P.Z, P.G__minus__, P.H, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
...
V_148 = Vertex(name = 'V_148',
               particles = [ P.W__plus__, P.Z, P.G__minus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
...
V_150 = Vertex(name = 'V_150',
               particles = [ P.a, P.W__minus__, P.W__plus__, P.Z, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVVVS5 ],
...
V_154 = Vertex(name = 'V_154',
               particles = [ P.Z, P.Z, P.G0, P.G0, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
               couplings = {(0,0):C.GC_113})

V_155 = Vertex(name = 'V_155',
               particles = [ P.Z, P.Z, P.G__minus__, P.G__plus__, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
               couplings = {(0,0):C.GC_112})

V_156 = Vertex(name = 'V_156',
               particles = [ P.Z, P.Z, P.H, P.H, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVSSS1 ],
               couplings = {(0,0):C.GC_113})
...
V_160 = Vertex(name = 'V_160',
               particles = [ P.W__minus__, P.W__plus__, P.Z, P.Z, P.phiNP ],
               color = [ '1' ],
               lorentz = [ L.VVVVS2 ],
...
V_173 = Vertex(name = 'V_173',
               ...
               couplings = {(0,0):C.GC_83,(0,1):C.GC_100})
...
V_191 = Vertex(name = 'V_191',
               ...
               couplings = {(0,0):C.GC_84,(0,1):C.GC_99})
...
V_209 = Vertex(name = 'V_209',
               ...
               couplings = {(0,0):C.GC_83,(0,1):C.GC_99})
