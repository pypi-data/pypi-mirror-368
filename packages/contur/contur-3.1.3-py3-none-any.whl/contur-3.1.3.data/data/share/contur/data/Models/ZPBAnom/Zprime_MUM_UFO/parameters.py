...
Cu1x1 = Parameter(name = 'Cu1x1',
                  nature = 'internal',
                  type = 'real',
                  value = '2*re(CKM1x2*complexconjugate(CKM1x3))',
                  texname = '\\text{Cu1x1}')

Cu1x2 = Parameter(name = 'Cu1x2',
                  nature = 'internal',
                  type = 'complex',
                  value = 'CKM1x3*complexconjugate(CKM2x2) + CKM1x2*complexconjugate(CKM2x3)',
                  texname = '\\text{Cu1x2}')

Cu1x3 = Parameter(name = 'Cu1x3',
                  nature = 'internal',
                  type = 'complex',
                  value = 'CKM1x3*complexconjugate(CKM3x2) + CKM1x2*complexconjugate(CKM3x3)',
                  texname = '\\text{Cu1x3}')

Cu2x1 = Parameter(name = 'Cu2x1',
                  nature = 'internal',
                  type = 'complex',
                  value = 'CKM2x3*complexconjugate(CKM1x2) + CKM2x2*complexconjugate(CKM1x3)',
                  texname = '\\text{Cu2x1}')

Cu2x2 = Parameter(name = 'Cu2x2',
                  nature = 'internal',
                  type = 'real',
                  value = '2*re(CKM2x2*complexconjugate(CKM2x3))',
                  texname = '\\text{Cu2x2}')

Cu2x3 = Parameter(name = 'Cu2x3',
                  nature = 'internal',
                  type = 'complex',
                  value = 'CKM3x3*complexconjugate(CKM3x2) + CKM2x2*complexconjugate(CKM3x3)',
                  texname = '\\text{Cu2x3}')

Cu3x1 = Parameter(name = 'Cu3x1',
                  nature = 'internal',
                  type = 'complex',
                  value = 'CKM3x3*complexconjugate(CKM1x2) + CKM3x2*complexconjugate(CKM1x3)',
                  texname = '\\text{Cu3x1}')

Cu3x2 = Parameter(name = 'Cu3x2',
                  nature = 'internal',
                  type = 'complex',
                  value = 'CKM3x2*complexconjugate(CKM2x3) + CKM3x3*complexconjugate(CKM3x2)',
                  texname = '\\text{Cu3x2}')

Cu3x3 = Parameter(name = 'Cu3x3',
                  nature = 'internal',
                  type = 'real',
                  value = '2*re(CKM3x2*complexconjugate(CKM3x3))',
                  texname = '\\text{Cu3x3}')
