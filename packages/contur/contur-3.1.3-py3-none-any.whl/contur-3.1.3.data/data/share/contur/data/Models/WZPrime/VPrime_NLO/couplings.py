...
GC_31 = Coupling(name = 'GC_31',
                 value = '-((ee*complex(0,1)*kL)/(sw*cmath.sqrt(2)))',
                 order = {'QED':1})

GC_32 = Coupling(name = 'GC_32',
                 value = '-((ee*complex(0,1)*gZpdL*kL)/(cw*sw))',
                 order = {'QED':1})

GC_33 = Coupling(name = 'GC_33',
                 value = '-((ee*complex(0,1)*gZpdR*kL)/(cw*sw))',
                 order = {'QED':1})

GC_34 = Coupling(name = 'GC_34',
                 value = '-((ee*complex(0,1)*gZpeL*kL)/(cw*sw))',
                 order = {'QED':1})

GC_35 = Coupling(name = 'GC_35',
                 value = '-((ee*complex(0,1)*gZpeR*kL)/(cw*sw))',
                 order = {'QED':1})

GC_36 = Coupling(name = 'GC_36',
                 value = '-((ee*complex(0,1)*gZpuL*kL)/(cw*sw))',
                 order = {'QED':1})

GC_37 = Coupling(name = 'GC_37',
                 value = '-((ee*complex(0,1)*gZpuR*kL)/(cw*sw))',
                 order = {'QED':1})

GC_38 = Coupling(name = 'GC_38',
                 value = '-((ee*complex(0,1)*gZpvL*kL)/(cw*sw))',
                 order = {'QED':1})

GC_39 = Coupling(name = 'GC_39',
                 value = '-((ee*complex(0,1)*gZpvR*kL)/(cw*sw))',
                 order = {'QED':1})
...
GC_40 = Coupling(name = 'GC_40',
                 value = '-((ee*complex(0,1)*kR)/(sw*cmath.sqrt(2)))',
                 order = {'QED':1})
