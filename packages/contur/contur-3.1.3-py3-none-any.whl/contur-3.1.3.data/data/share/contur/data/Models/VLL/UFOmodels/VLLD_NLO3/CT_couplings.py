...
R2GC_116_5 = Coupling(name = 'R2GC_116_5',
...
R2GC_118_9 = Coupling(name = 'R2GC_118_9',
                      value = '-(complex(0,1)*G**4)/(64.*cmath.pi**2)',
                      order = {'QCD':4})
...
R2GC_121_13 = Coupling(name = 'R2GC_121_13',
                       value = '-(complex(0,1)*G**4)/(16.*cmath.pi**2)',
                       order = {'QCD':4})

R2GC_121_14 = Coupling(name = 'R2GC_121_14',
                       value = '(complex(0,1)*G**4)/(4.*cmath.pi**2)',
                       order = {'QCD':4})

R2GC_122_15 = Coupling(name = 'R2GC_122_15',
                       value = '(-3*complex(0,1)*G**4)/(64.*cmath.pi**2)',
                       order = {'QCD':4})

R2GC_122_16 = Coupling(name = 'R2GC_122_16',
...
R2GC_149_25 = Coupling(name = 'R2GC_149_25',
...
R2GC_155_29 = Coupling(name = 'R2GC_155_29',
                       value = '(5*complex(0,1)*G**4)/(48.*cmath.pi**2)',
                       order = {'QCD':4})

R2GC_155_30 = Coupling(name = 'R2GC_155_30',
...
R2GC_157_32 = Coupling(name = 'R2GC_157_32',
                       value = '(31*complex(0,1)*G**4)/(64.*cmath.pi**2)',
                       order = {'QCD':4})

R2GC_158_33 = Coupling(name = 'R2GC_158_33',
                       value = '(-17*complex(0,1)*G**4)/(64.*cmath.pi**2)',
                       order = {'QCD':4})

R2GC_159_34 = Coupling(name = 'R2GC_159_34',
                       value = '(-7*complex(0,1)*G**4)/(32.*cmath.pi**2)',
                       order = {'QCD':4})

R2GC_160_35 = Coupling(name = 'R2GC_160_35',
                       value = '(7*complex(0,1)*G**4)/(64.*cmath.pi**2)',
                       order = {'QCD':4})

R2GC_164_36 = Coupling(name = 'R2GC_164_36',
...
R2GC_96_54 = Coupling(name = 'R2GC_96_54',
...
UVGC_104_1 = Coupling(name = 'UVGC_104_1',
                      value = {-1:'-(complex(0,1)*G**2)/(12.*cmath.pi**2)'},
                      order = {'QCD':2})

UVGC_105_2 = Coupling(name = 'UVGC_105_2',
                      value = {-1:'-(ee*complex(0,1)*G**2)/(36.*cmath.pi**2)'},
                      order = {'QCD':2,'QED':1})

UVGC_107_3 = Coupling(name = 'UVGC_107_3',
...
UVGC_125_22 = Coupling(name = 'UVGC_125_22',
                       value = {-1:'(complex(0,1)*G**3)/(48.*cmath.pi**2)'},
                       order = {'QCD':3})

UVGC_125_23 = Coupling(name = 'UVGC_125_23',
                       value = {-1:'(-19*complex(0,1)*G**3)/(128.*cmath.pi**2)'},
                       order = {'QCD':3})

UVGC_125_24 = Coupling(name = 'UVGC_125_24',
                       value = {-1:'-(complex(0,1)*G**3)/(128.*cmath.pi**2)'},
                       order = {'QCD':3})

UVGC_125_25 = Coupling(name = 'UVGC_125_25',
                       value = {-1:'( 0 if MT else (complex(0,1)*G**3)/(48.*cmath.pi**2) )'},
                       order = {'QCD':3})

UVGC_125_26 = Coupling(name = 'UVGC_125_26',
                       value = {-1:'(complex(0,1)*G**3)/(12.*cmath.pi**2)'},
                       order = {'QCD':3})

UVGC_126_27 = Coupling(name = 'UVGC_126_27',
                       value = {-1:'(-13*complex(0,1)*G**3)/(48.*cmath.pi**2)'},
                       order = {'QCD':3})

UVGC_128_28 = Coupling(name = 'UVGC_128_28',
                       value = {-1:'-(ee*complex(0,1)*G**2)/(18.*cmath.pi**2)'},
                       order = {'QCD':2,'QED':1})
...
UVGC_147_31 = Coupling(name = 'UVGC_147_31',
...
UVGC_148_32 = Coupling(name = 'UVGC_148_32',
                       value = {-1:'(3*complex(0,1)*G**2)/(64.*cmath.pi**2)'},
                       order = {'QCD':2})

UVGC_148_33 = Coupling(name = 'UVGC_148_33',
                       value = {-1:'(-3*complex(0,1)*G**2)/(64.*cmath.pi**2)'},
                       order = {'QCD':2})
...
UVGC_150_38 = Coupling(name = 'UVGC_150_38',
...
UVGC_151_40 = Coupling(name = 'UVGC_151_40',
                       value = {-1:'(33*G**3)/(128.*cmath.pi**2)'},
                       order = {'QCD':3})

UVGC_151_41 = Coupling(name = 'UVGC_151_41',
                       value = {-1:'(3*G**3)/(128.*cmath.pi**2)'},
                       order = {'QCD':3})

UVGC_152_42 = Coupling(name = 'UVGC_152_42',
                       value = {-1:'G**3/(48.*cmath.pi**2)'},
                       order = {'QCD':3})

UVGC_152_43 = Coupling(name = 'UVGC_152_43',
                       value = {-1:'(-33*G**3)/(128.*cmath.pi**2)'},
                       order = {'QCD':3})
...
UVGC_154_48 = Coupling(name = 'UVGC_154_48',
                       value = {-1:'(-51*G**3)/(128.*cmath.pi**2)'},
                       order = {'QCD':3})

UVGC_155_49 = Coupling(name = 'UVGC_155_49',
                       value = {-1:'(147*complex(0,1)*G**4)/(128.*cmath.pi**2)'},
                       order = {'QCD':4})

UVGC_155_50 = Coupling(name = 'UVGC_155_50',
...
UVGC_156_52 = Coupling(name = 'UVGC_156_52',
...
UVGC_157_54 = Coupling(name = 'UVGC_157_54',
                       value = {-1:'-(complex(0,1)*G**4)/(12.*cmath.pi**2)'},
                       order = {'QCD':4})

UVGC_157_55 = Coupling(name = 'UVGC_157_55',
...
UVGC_160_64 = Coupling(name = 'UVGC_160_64',
                       value = {-1:'(complex(0,1)*G**4)/(12.*cmath.pi**2)'},
                       order = {'QCD':4})
...
UVGC_162_69 = Coupling(name = 'UVGC_162_69',
...
UVGC_165_72 = Coupling(name = 'UVGC_165_72',
...
UVGC_166_73 = Coupling(name = 'UVGC_166_73',
...
UVGC_167_74 = Coupling(name = 'UVGC_167_74',
...
UVGC_168_75 = Coupling(name = 'UVGC_168_75',
                       value = {-1:'-(G**2*yt)/(24.*cmath.pi**2)'},
                       order = {'QCD':2,'QED':1})

UVGC_168_76 = Coupling(name = 'UVGC_168_76',
...
UVGC_168_77 = Coupling(name = 'UVGC_168_77',
                       value = {-1:'(G**2*yt)/(3.*cmath.pi**2)'},
                       order = {'QCD':2,'QED':1})

UVGC_169_78 = Coupling(name = 'UVGC_169_78',
                       value = {-1:'(G**2*yt)/(24.*cmath.pi**2)'},
                       order = {'QCD':2,'QED':1})
...
UVGC_169_80 = Coupling(name = 'UVGC_169_80',
                       value = {-1:'-(G**2*yt)/(3.*cmath.pi**2)'},
                       order = {'QCD':2,'QED':1})
...
UVGC_171_82 = Coupling(name = 'UVGC_171_82',
