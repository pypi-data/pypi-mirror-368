...
Decay_Y1 = Decay(name = 'Decay_Y1',
                 particle = P.Y1,
                 partial_widths = {(P.b,P.b__tilde__):'((24*gYq**2*MB**2 + 12*gYq**2*MY1**2)*cmath.sqrt(-4*MB**2*MY1**2 + MY1**4))/(48.*cmath.pi*abs(MY1)**3)',
                                   (P.c,P.c__tilde__):'(gYq**2*MY1**4)/(4.*cmath.pi*abs(MY1)**3)',
                                   (P.d,P.d__tilde__):'(gYq**2*MY1**4)/(4.*cmath.pi*abs(MY1)**3)',
                                   (P.s,P.s__tilde__):'(gYq**2*MY1**4)/(4.*cmath.pi*abs(MY1)**3)',
                                   (P.t,P.t__tilde__):'((24*gYq**2*MT**2 + 12*gYq**2*MY1**2)*cmath.sqrt(-4*MT**2*MY1**2 + MY1**4))/(48.*cmath.pi*abs(MY1)**3)',
                                   (P.u,P.u__tilde__):'(gYq**2*MY1**4)/(4.*cmath.pi*abs(MY1)**3)',
                                   (P.Xm,P.Xm):'((-64*gYXm**2*MXm**2 + 16*gYXm**2*MY1**2)*cmath.sqrt(-4*MXm**2*MY1**2 + MY1**4))/(96.*cmath.pi*abs(MY1)**3)'})
