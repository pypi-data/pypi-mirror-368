...
GC_12 = Coupling(name = 'GC_12',
                 value = '(9*cth**2*complex(0,1)*gB**2)/2.',
                 order = {'NP':2})

GC_13 = Coupling(name = 'GC_13',
                 value = '-((complex(0,1)*lame)/cmath.sqrt(2))',
                 order = {'NP':1})

GC_14 = Coupling(name = 'GC_14',
                 value = '-((complex(0,1)*lammu)/cmath.sqrt(2))',
                 order = {'NP':1})

GC_15 = Coupling(name = 'GC_15',
                 value = '-((complex(0,1)*lamtau)/cmath.sqrt(2))',
                 order = {'NP':1})

GC_16 = Coupling(name = 'GC_16',
                 value = '(-9*cth*complex(0,1)*gB**2*sth)/2.',
                 order = {'NP':2})

GC_17 = Coupling(name = 'GC_17',
                 value = '(9*complex(0,1)*gB**2*sth**2)/2.',
                 order = {'NP':2})

GC_18 = Coupling(name = 'GC_18',
                 value = '-3*cth**3*complex(0,1)*lam1*sth + 6*cth**3*complex(0,1)*lamS*sth + 3*cth*complex(0,1)*lam1*sth**3 - 6*cth*complex(0,1)*lamH*sth**3',
                 order = {'QED':2})

GC_19 = Coupling(name = 'GC_19',
                 value = '3*cth**3*complex(0,1)*lam1*sth - 6*cth**3*complex(0,1)*lamH*sth - 3*cth*complex(0,1)*lam1*sth**3 + 6*cth*complex(0,1)*lamS*sth**3',
                 order = {'QED':2})

GC_20 = Coupling(name = 'GC_20',
                 value = '-(cth**4*complex(0,1)*lam1) + 4*cth**2*complex(0,1)*lam1*sth**2 - 6*cth**2*complex(0,1)*lamH*sth**2 - 6*cth**2*complex(0,1)*lamS*sth**2 - complex(0,1)*lam1*sth**4',
                 order = {'QED':2})

GC_21 = Coupling(name = 'GC_21',
                 value = '-6*cth**4*complex(0,1)*lamS - 6*cth**2*complex(0,1)*lam1*sth**2 - 6*complex(0,1)*lamH*sth**4',
                 order = {'QED':2})

GC_22 = Coupling(name = 'GC_22',
                 value = '-6*cth**4*complex(0,1)*lamH - 6*cth**2*complex(0,1)*lam1*sth**2 - 6*complex(0,1)*lamS*sth**4',
                 order = {'QED':2})
...
GC_55 = Coupling(name = 'GC_55',
                 value = '(9*cth*complex(0,1)*gB**2*vB)/2.',
                 order = {'NP':1})

GC_56 = Coupling(name = 'GC_56',
                 value = '(-9*complex(0,1)*gB**2*sth*vB)/2.',
                 order = {'NP':1})

GC_57 = Coupling(name = 'GC_57',
                 value = '-6*cth**3*complex(0,1)*lamS*vB - 3*cth*complex(0,1)*lam1*sth**2*vB',
                 order = {'NP':-1,'QED':2})

GC_58 = Coupling(name = 'GC_58',
                 value = '-(cth**3*complex(0,1)*lam1*vB) + 2*cth*complex(0,1)*lam1*sth**2*vB - 6*cth*complex(0,1)*lamS*sth**2*vB',
                 order = {'NP':-1,'QED':2})

GC_59 = Coupling(name = 'GC_59',
                 value = '-2*cth**2*complex(0,1)*lam1*sth*vB + 6*cth**2*complex(0,1)*lamS*sth*vB + complex(0,1)*lam1*sth**3*vB',
                 order = {'NP':-1,'QED':2})

GC_60 = Coupling(name = 'GC_60',
                 value = '3*cth**2*complex(0,1)*lam1*sth*vB + 6*complex(0,1)*lamS*sth**3*vB',
                 order = {'NP':-1,'QED':2})
...
GC_63 = Coupling(name = 'GC_63',
                 value = '-6*cth**3*complex(0,1)*lamH*vev - 3*cth*complex(0,1)*lam1*sth**2*vev',
                 order = {'QED':1})

GC_64 = Coupling(name = 'GC_64',
                 value = '-(cth**3*complex(0,1)*lam1*vev) + 2*cth*complex(0,1)*lam1*sth**2*vev - 6*cth*complex(0,1)*lamH*sth**2*vev',
                 order = {'QED':1})

GC_65 = Coupling(name = 'GC_65',
                 value = '2*cth**2*complex(0,1)*lam1*sth*vev - 6*cth**2*complex(0,1)*lamH*sth*vev - complex(0,1)*lam1*sth**3*vev',
                 order = {'QED':1})

GC_66 = Coupling(name = 'GC_66',
                 value = '-3*cth**2*complex(0,1)*lam1*sth*vev - 6*complex(0,1)*lamH*sth**3*vev',
                 order = {'QED':1})
...
GC_73 = Coupling(name = 'GC_73',
                 value = '-(cth*complex(0,1)*ychi*cmath.sqrt(2))',
                 order = {'NP':1})

GC_74 = Coupling(name = 'GC_74',
                 value = 'complex(0,1)*sth*ychi*cmath.sqrt(2)',
                 order = {'NP':1})
...
GC_83 = Coupling(name = 'GC_83',
                 value = '-(cth*complex(0,1)*yrho*cmath.sqrt(2))',
                 order = {'NP':1})

GC_84 = Coupling(name = 'GC_84',
                 value = 'complex(0,1)*sth*yrho*cmath.sqrt(2)',
                 order = {'NP':1})
