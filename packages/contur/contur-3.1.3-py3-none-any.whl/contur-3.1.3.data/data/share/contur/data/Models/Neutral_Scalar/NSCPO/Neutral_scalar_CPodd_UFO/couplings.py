...
GC_10 = Coupling(name = 'GC_10',
                 value = '-complex(0,1)/(2.*f0G)',
                 order = {'f0':1})

GC_11 = Coupling(name = 'GC_11',
                 value = '(-2*complex(0,1))/f0W',
                 order = {'f0':1})
...
GC_87 = Coupling(name = 'GC_87',
                 value = '(2*cw*complex(0,1)*sw)/f0B - (2*cw*complex(0,1)*sw)/f0W',
                 order = {'f0':1})
...
GC_90 = Coupling(name = 'GC_90',
                 value = '(-2*cw**2*complex(0,1))/f0W - (2*complex(0,1)*sw**2)/f0B',
                 order = {'f0':1})

GC_91 = Coupling(name = 'GC_91',
                 value = '(-2*cw**2*complex(0,1))/f0B - (2*complex(0,1)*sw**2)/f0W',
                 order = {'f0':1})
