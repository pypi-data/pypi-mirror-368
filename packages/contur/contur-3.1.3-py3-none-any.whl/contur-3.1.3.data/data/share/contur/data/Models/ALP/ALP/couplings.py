...
GC_56 = Coupling(name = 'GC_56',
                 value = '(-2*cBB*ee**2*complex(0,1))/Lambda - (2*cWW*ee**2*complex(0,1))/Lambda',
                 order = {'NP':1})

GC_57 = Coupling(name = 'GC_57',
                 value = '(-2*cah*complex(0,1))/Lambda**2',
                 order = {'NP':1})

GC_58 = Coupling(name = 'GC_58',
                 value = '(cZh5*complex(0,1))/Lambda',
                 order = {'NP':1})
...
GC_60 = Coupling(name = 'GC_60',
                 value = '(-2*cZh5*ee)/Lambda',
                 order = {'NP':1})

GC_61 = Coupling(name = 'GC_61',
                 value = '-(cGG*complex(0,1)*G**2)/(2.*Lambda)',
                 order = {'NP':1})

GC_62 = Coupling(name = 'GC_62',
                 value = '-((cGG*G**3)/Lambda)',
                 order = {'NP':1})

GC_63 = Coupling(name = 'GC_63',
                 value = '(0.00504*gPd)/Lambda',
                 order = {'NP':1})

GC_64 = Coupling(name = 'GC_64',
                 value = '(0.101*gPd)/Lambda',
                 order = {'NP':1})

GC_65 = Coupling(name = 'GC_65',
                 value = '(4.7*gPd)/Lambda',
                 order = {'NP':1})

GC_66 = Coupling(name = 'GC_66',
                 value = '(0.000511*gPl)/Lambda',
                 order = {'NP':1})

GC_67 = Coupling(name = 'GC_67',
                 value = '(0.10566*gPl)/Lambda',
                 order = {'NP':1})

GC_68 = Coupling(name = 'GC_68',
                 value = '(1.777*gPl)/Lambda',
                 order = {'NP':1})

GC_69 = Coupling(name = 'GC_69',
                 value = '(0.00255*gPu)/Lambda',
                 order = {'NP':1})

GC_70 = Coupling(name = 'GC_70',
                 value = '(1.27*gPu)/Lambda',
                 order = {'NP':1})

GC_71 = Coupling(name = 'GC_71',
                 value = '(172*gPu)/Lambda',
                 order = {'NP':1})

GC_72 = Coupling(name = 'GC_72',
                 value = '(4*cw*cWW*ee**3*complex(0,1))/(Lambda*sw**3)',
                 order = {'NP':1})
...
GC_76 = Coupling(name = 'GC_76',
                 value = '(-2*cWW*ee**2*complex(0,1))/(Lambda*sw**2)',
                 order = {'NP':1})

GC_77 = Coupling(name = 'GC_77',
                 value = '(4*cWW*ee**3*complex(0,1))/(Lambda*sw**2)',
                 order = {'NP':1})
...
GC_99 = Coupling(name = 'GC_99',
                 value = '-((cZh5*ee*complex(0,1))/(Lambda*sw))',
                 order = {'NP':1})
...
GC_108 = Coupling(name = 'GC_108',
                  value = '-((cw*cZh5*ee)/(Lambda*sw)) + (cZh5*ee*sw)/(cw*Lambda)',
                  order = {'NP':1})
...
GC_110 = Coupling(name = 'GC_110',
                  value = '(-2*cw*cWW*ee**2*complex(0,1))/(Lambda*sw) + (2*cBB*ee**2*complex(0,1)*sw)/(cw*Lambda)',
                  order = {'NP':1})
...
GC_113 = Coupling(name = 'GC_113',
                  value = '(-2*cw**2*cWW*ee**2*complex(0,1))/(Lambda*sw**2) - (2*cBB*ee**2*complex(0,1)*sw**2)/(cw**2*Lambda)',
                  order = {'NP':1})
...
GC_118 = Coupling(name = 'GC_118',
                  value = '(-2*cah*complex(0,1)*vev)/Lambda**2',
                  order = {'NP':1})
...
GC_125 = Coupling(name = 'GC_125',
                  value = '-((cZh5*ee*complex(0,1)*vev)/(Lambda*sw))',
                  order = {'NP':1})
...
GC_131 = Coupling(name = 'GC_131',
                  value = '(cw*cZh5*ee*vev)/(Lambda*sw) + (cZh5*ee*sw*vev)/(cw*Lambda)',
                  order = {'NP':1})
