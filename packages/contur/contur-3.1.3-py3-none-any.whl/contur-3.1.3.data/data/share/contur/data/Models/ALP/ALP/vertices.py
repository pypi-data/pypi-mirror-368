...
V_11 = Vertex(name = 'V_11',
              particles = [ P.a, P.ALP, P.G__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VSSS1 ],
              couplings = {(0,0):C.GC_60})

V_12 = Vertex(name = 'V_12',
              particles = [ P.ALP, P.ALP, P.G0, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.SSSS2 ],
              couplings = {(0,0):C.GC_57})

V_13 = Vertex(name = 'V_13',
              particles = [ P.ALP, P.ALP, P.G__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS2 ],
              couplings = {(0,0):C.GC_57})
...
V_18 = Vertex(name = 'V_18',
              particles = [ P.ALP, P.G__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSS3 ],
...
V_61 = Vertex(name = 'V_61',
              particles = [ P.ta__plus__, P.ta__minus__, P.ALP ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
...
V_106 = Vertex(name = 'V_106',
               particles = [ P.W__minus__, P.ALP, P.G0, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
               couplings = {(0,0):C.GC_101})

V_107 = Vertex(name = 'V_107',
               particles = [ P.W__minus__, P.ALP, P.G__plus__, P.H ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
               couplings = {(0,0):C.GC_99})

V_108 = Vertex(name = 'V_108',
               particles = [ P.W__minus__, P.ALP, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.VSS1 ],
...
V_116 = Vertex(name = 'V_116',
               particles = [ P.W__plus__, P.ALP, P.G0, P.G__minus__ ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
               couplings = {(0,0):C.GC_101})

V_117 = Vertex(name = 'V_117',
               particles = [ P.W__plus__, P.ALP, P.G__minus__, P.H ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
               couplings = {(0,0):C.GC_100})

V_118 = Vertex(name = 'V_118',
               particles = [ P.W__plus__, P.ALP, P.G__minus__ ],
               color = [ '1' ],
               lorentz = [ L.VSS1 ],
...
V_133 = Vertex(name = 'V_133',
               particles = [ P.Z, P.ALP, P.G0, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
               couplings = {(0,0):C.GC_109})

V_134 = Vertex(name = 'V_134',
               particles = [ P.Z, P.ALP, P.G__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.VSSS1 ],
...
V_190 = Vertex(name = 'V_190',
               ...
               couplings = {(0,0):C.GC_92,(0,1):C.GC_102})
...
V_193 = Vertex(name = 'V_193',
               ...
               couplings = {(0,0):C.GC_91,(0,1):C.GC_102})
