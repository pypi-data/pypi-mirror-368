...
GC_11 = Coupling(name = 'GC_11',
                 value = '-((epstaupeL*complex(0,1))/cmath.sqrt(2))',
                 order = {'VLL':1})

GC_12 = Coupling(name = 'GC_12',
                 value = '-((epstaupmuL*complex(0,1))/cmath.sqrt(2))',
                 order = {'VLL':1})

GC_13 = Coupling(name = 'GC_13',
                 value = '-((epstauptaL*complex(0,1))/cmath.sqrt(2))',
                 order = {'VLL':1})
...
GC_25 = Coupling(name = 'GC_25',
                 value = '(epstaupeL*complex(0,1)*MW)/MTAUP',
                 order = {'VLL':1})

GC_26 = Coupling(name = 'GC_26',
                 value = '(epstaupmuL*complex(0,1)*MW)/MTAUP',
                 order = {'VLL':1})

GC_27 = Coupling(name = 'GC_27',
                 value = '(epstauptaL*complex(0,1)*MW)/MTAUP',
                 order = {'VLL':1})

GC_28 = Coupling(name = 'GC_28',
                 value = '(epstaupeL*complex(0,1)*MZ)/(MTAUP*cmath.sqrt(2))',
                 order = {'VLL':1})

GC_29 = Coupling(name = 'GC_29',
                 value = '(epstaupmuL*complex(0,1)*MZ)/(MTAUP*cmath.sqrt(2))',
                 order = {'VLL':1})
...
GC_30 = Coupling(name = 'GC_30',
                 value = '(epstauptaL*complex(0,1)*MZ)/(MTAUP*cmath.sqrt(2))',
                 order = {'VLL':1})
