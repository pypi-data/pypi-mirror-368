...
GC_11 = Coupling(name = 'GC_11',
                 value = '-((epstaupeR*complex(0,1))/cmath.sqrt(2))',
                 order = {'VLL':1})

GC_12 = Coupling(name = 'GC_12',
                 value = '-((epstaupmuR*complex(0,1))/cmath.sqrt(2))',
                 order = {'VLL':1})

GC_13 = Coupling(name = 'GC_13',
                 value = '-((epstauptaR*complex(0,1))/cmath.sqrt(2))',
                 order = {'VLL':1})
...
GC_19 = Coupling(name = 'GC_19',
                 value = '-((complex(0,1)*gtaupnupw3)/cw)',
                 order = {'VLL':1})
...
GC_26 = Coupling(name = 'GC_26',
                 value = '(epstaupeR*complex(0,1)*MW)/MTAUP',
                 order = {'VLL':1})

GC_27 = Coupling(name = 'GC_27',
                 value = '(epstaupmuR*complex(0,1)*MW)/MTAUP',
                 order = {'VLL':1})

GC_28 = Coupling(name = 'GC_28',
                 value = '(epstauptaR*complex(0,1)*MW)/MTAUP',
                 order = {'VLL':1})

GC_29 = Coupling(name = 'GC_29',
                 value = '(epstaupeR*complex(0,1)*MZ)/(MTAUP*cmath.sqrt(2))',
                 order = {'VLL':1})
...
GC_30 = Coupling(name = 'GC_30',
                 value = '(epstaupmuR*complex(0,1)*MZ)/(MTAUP*cmath.sqrt(2))',
                 order = {'VLL':1})

GC_31 = Coupling(name = 'GC_31',
                 value = '(epstauptaR*complex(0,1)*MZ)/(MTAUP*cmath.sqrt(2))',
                 order = {'VLL':1})
...
GC_60 = Coupling(name = 'GC_60',
                 value = 'cw*complex(0,1)*gtaupnupw3 - complex(0,1)*gtaupb*sw',
                 order = {'VLL':1})

GC_61 = Coupling(name = 'GC_61',
                 value = 'cw*complex(0,1)*gtaupb + complex(0,1)*gtaupnupw3*sw',
                 order = {'VLL':1})
