...
l1 = Parameter(name = 'l1',
               nature = 'internal',
               type = 'real',
               value = '-(-(mh2**2*sinbma**2) - mh1**2*(1 - sinbma**2))/(2.*vev**2)',
               texname = '\\lambda _1')

l4 = Parameter(name = 'l4',
               nature = 'internal',
               type = 'real',
               value = '(2*mh1**2 + 2*mh2**2 + 4*mh3**2 - 8*mhc**2 + 2*(-mh1**2 + mh2**2)*cmath.cos(2*cmath.asin(sinbma)))/(4.*vev**2)',
               texname = '\\lambda _4')

lR5 = Parameter(name = 'lR5',
                nature = 'internal',
                type = 'real',
                value = '(2*(mh1**2 + mh2**2 - 2*mh3**2) - 2*(mh1 - mh2)*(mh1 + mh2)*cmath.cos(2*cmath.asin(sinbma)))/(8.*vev**2)',
                texname = '\\text{lR5}')
...
I1a33 = Parameter(name = 'I1a33',
                  nature = 'internal',
                  type = 'complex',
                  value = '-((tanbeta*ymt*cmath.sqrt(2))/vev)',
                  texname = '\\text{I1a33}')
