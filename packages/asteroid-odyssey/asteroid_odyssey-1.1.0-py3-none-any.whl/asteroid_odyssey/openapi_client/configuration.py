...
conf = asteroid_odyssey.openapi_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://odyssey.asteroid.ai/api/v1" if host is None else host
        """Default Base url
        """
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://odyssey.asteroid.ai/api/v1",
                'description': "Version 1 of the Asteroid Agents API",
            },
            {
                'url': "https://odyssey.asteroid.ai/api/v1",
                'description': "Version 1 of the Asteroid Agents API",
