...
def create_section(model, type, tag, shape, material, warp=True, center=None):
    ...
    if type == "Elastic":
        ...
        model.material(mtype, 1, **material)
...
class Prism:
    ...
    def create_model(self,
        ...
        model = xara.Model(ndm=3, ndf=6+sum(warp))
        ...
        #
        shape.send_xara(model, section, 1, material)
