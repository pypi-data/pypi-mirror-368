...
class GRIBIClient(Base):
    """gRPC Port Specific Data
    The GRIBIClient class encapsulates a required gRIBIClient resource which will be retrieved from the server every time the property is accessed.
    """
    ...
    def find(self, Count=None, DescriptiveName=None, Name=None, RowNames=None):
        # type: (int, str, str, List[str]) -> GRIBIClient
