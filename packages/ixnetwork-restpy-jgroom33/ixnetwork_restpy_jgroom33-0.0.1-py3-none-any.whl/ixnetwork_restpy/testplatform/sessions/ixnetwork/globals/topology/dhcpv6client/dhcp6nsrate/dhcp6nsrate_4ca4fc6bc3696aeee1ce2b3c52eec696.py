...
class Dhcp6nsRate(Base):
    """Parameters used for controlling the rate of actions
    The Dhcp6nsRate class encapsulates a required dhcp6nsRate resource which will be retrieved from the server every time the property is accessed.
    """
    ...
    def __init__(self, parent, list_op=False):
        super(Dhcp6nsRate, self).__init__(parent, list_op)
    ...
    def update(self, ScaleMode=None):
        ...
        """Updates dhcp6nsRate resource on the server.
    ...
    def find(self, Count=None, RowNames=None, ScaleMode=None):
        # type: (int, List[str], str) -> Dhcp6nsRate
        """Finds and retrieves dhcp6nsRate resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve dhcp6nsRate resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all dhcp6nsRate resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching dhcp6nsRate resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of dhcp6nsRate data from the server.
        ...
        Returns
        -------
        - self: This instance with the dhcp6nsRate resources from the server available through an iterator or index
