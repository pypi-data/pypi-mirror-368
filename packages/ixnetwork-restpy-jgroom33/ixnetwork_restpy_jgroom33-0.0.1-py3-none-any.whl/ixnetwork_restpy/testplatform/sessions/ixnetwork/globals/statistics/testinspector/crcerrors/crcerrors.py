...
class CrcErrors(Base):
    """
    The CrcErrors class encapsulates a required crcErrors resource which will be retrieved from the server every time the property is accessed.
    """
    ...
    def __init__(self, parent, list_op=False):
        super(CrcErrors, self).__init__(parent, list_op)
    ...
    def update(self, Enable=None, Value=None):
        # type: (bool, int) -> CrcErrors
        """Updates crcErrors resource on the server.
    ...
    def find(
        ...
        # type: (bool, str, str, str, str, int) -> CrcErrors
        """Finds and retrieves crcErrors resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve crcErrors resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all crcErrors resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching crcErrors resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of crcErrors data from the server.
        ...
        Returns
        -------
        - self: This instance with the crcErrors resources from the server available through an iterator or index
