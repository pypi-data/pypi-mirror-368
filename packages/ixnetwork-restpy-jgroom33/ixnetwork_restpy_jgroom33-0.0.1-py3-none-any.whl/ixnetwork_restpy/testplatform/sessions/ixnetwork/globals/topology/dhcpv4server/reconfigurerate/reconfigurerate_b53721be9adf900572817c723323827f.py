...
class ReconfigureRate(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(ReconfigureRate, self).__init__(parent, list_op)
    ...
    def find(self, Count=None, RowNames=None, ScaleMode=None):
        # type: (int, List[str], str) -> ReconfigureRate
        """Finds and retrieves reconfigureRate resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve reconfigureRate resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all reconfigureRate resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching reconfigureRate resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of reconfigureRate data from the server.
        ...
        Returns
        -------
        - self: This instance with the reconfigureRate resources from the server available through an iterator or index
