...
class PortUpRate(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(PortUpRate, self).__init__(parent, list_op)
    ...
    def find(self, Count=None, RowNames=None, ScaleMode=None):
        # type: (int, List[str], str) -> PortUpRate
        """Finds and retrieves portUpRate resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve portUpRate resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all portUpRate resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching portUpRate resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of portUpRate data from the server.
        ...
        Returns
        -------
        - self: This instance with the portUpRate resources from the server available through an iterator or index
