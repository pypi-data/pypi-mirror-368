...
class EgtpS5S8SgwGlobals(Base):
    ...
    def GlobalEgtpApnS5S8(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.globals.protocolstack.egtps5s8sgwglobals.globalegtpapns5s8.globalegtpapns5s8 import (
            GlobalEgtpApnS5S8,
        )
    ...
    def GlobalTrafficProfileS5S8(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.globals.protocolstack.egtps5s8sgwglobals.globaltrafficprofiles5s8.globaltrafficprofiles5s8 import (
            GlobalTrafficProfileS5S8,
        )
