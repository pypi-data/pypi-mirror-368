...
class StopRateAndFlowControl(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(StopRateAndFlowControl, self).__init__(parent, list_op)
    ...
    def update(self, ScaleMode=None):
        # type: (str) -> StopRateAndFlowControl
        """Updates stopRateAndFlowControl resource on the server.
    ...
    def find(self, Count=None, RowNames=None, ScaleMode=None):
        # type: (int, List[str], str) -> StopRateAndFlowControl
        """Finds and retrieves stopRateAndFlowControl resources from the server.
    ...
    def read(self, href):
        """Retrieves a single instance of stopRateAndFlowControl data from the server.
    ...
    def get_device_ids(
        ...
        """Base class infrastructure that gets a list of stopRateAndFlowControl device ids encapsulated by this object.
