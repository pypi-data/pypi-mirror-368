...
class SupportedInstruction(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(SupportedInstruction, self).__init__(parent, list_op)
    ...
    def ActionSet(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.globals.topology.openflowcontroller.actionset_fee6f9deca9991c470dd851f2b49825f import (
            ActionSet,
        )
    ...
    def update(
        ...
        # type: (str, bool, bool, bool, str) -> SupportedInstruction
    ...
    def find(
        ...
        # type: (int, str, bool, bool, bool, str) -> SupportedInstruction
