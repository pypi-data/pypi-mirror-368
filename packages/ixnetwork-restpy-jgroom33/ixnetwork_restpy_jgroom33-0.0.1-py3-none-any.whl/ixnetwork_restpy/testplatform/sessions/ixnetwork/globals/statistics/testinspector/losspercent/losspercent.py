...
class LossPercent(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(LossPercent, self).__init__(parent, list_op)
    ...
    def update(self, Enable=None, Value=None):
        # type: (bool, int) -> LossPercent
        """Updates lossPercent resource on the server.
    ...
    def find(
        ...
        # type: (bool, str, str, str, str, int) -> LossPercent
        """Finds and retrieves lossPercent resources from the server.
    ...
    def read(self, href):
        """Retrieves a single instance of lossPercent data from the server.
