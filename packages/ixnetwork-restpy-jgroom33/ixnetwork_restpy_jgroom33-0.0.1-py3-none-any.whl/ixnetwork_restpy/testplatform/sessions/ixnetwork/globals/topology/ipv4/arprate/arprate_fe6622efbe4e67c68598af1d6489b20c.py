...
class ArpRate(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(ArpRate, self).__init__(parent, list_op)
    ...
    def find(self, Count=None, RowNames=None, ScaleMode=None):
        # type: (int, List[str], str) -> ArpRate
        """Finds and retrieves arpRate resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve arpRate resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all arpRate resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching arpRate resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of arpRate data from the server.
        ...
        Returns
        -------
        - self: This instance with the arpRate resources from the server available through an iterator or index
