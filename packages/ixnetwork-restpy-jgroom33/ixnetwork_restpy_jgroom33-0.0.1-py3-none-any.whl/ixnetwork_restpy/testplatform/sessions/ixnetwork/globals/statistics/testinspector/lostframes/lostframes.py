...
class LostFrames(Base):
    """
    The LostFrames class encapsulates a required lostFrames resource which will be retrieved from the server every time the property is accessed.
    """
    ...
    def update(self, Enable=None, Value=None):
        ...
        """Updates lostFrames resource on the server.
    ...
    def find(
        ...
        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve lostFrames resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all lostFrames resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching lostFrames resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of lostFrames data from the server.
        ...
        Returns
        -------
        - self: This instance with the lostFrames resources from the server available through an iterator or index
