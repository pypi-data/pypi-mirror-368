...
class Lac(Base):
    ...
    def EnableAggregatedCSUN(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.multivalue.Multivalue): Enables Aggregated CSUN
        """
        from ixnetwork_restpy.multivalue import Multivalue

        return Multivalue(
            self, self._get_attribute(self._SDM_ATT_MAP["EnableAggregatedCSUN"])
        )
