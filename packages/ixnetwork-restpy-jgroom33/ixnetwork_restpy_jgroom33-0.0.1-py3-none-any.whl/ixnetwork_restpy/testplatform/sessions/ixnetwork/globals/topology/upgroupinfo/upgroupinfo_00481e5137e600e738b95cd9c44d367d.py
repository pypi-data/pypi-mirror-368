...
class UpGroupInfo(Base):
    """CUSP CP Port Specific Data
    The UpGroupInfo class encapsulates a required upGroupInfo resource which will be retrieved from the server every time the property is accessed.
    """
    ...
    def find(self, Count=None, DescriptiveName=None, Name=None, RowNames=None):
        # type: (int, str, str, List[str]) -> UpGroupInfo
