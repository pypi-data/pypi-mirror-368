...
class Collisions(Base):
    """
    The Collisions class encapsulates a required collisions resource which will be retrieved from the server every time the property is accessed.
    """

    __slots__ = ()
    _SDM_NAME = "collisions"
    _SDM_ATT_MAP = {
        "Enable": "enable",
        "Name": "name",
        "Notes": "notes",
    ...
    def __init__(self, parent, list_op=False):
        super(Collisions, self).__init__(parent, list_op)
    ...
    def update(self, Enable=None, Value=None):
        # type: (bool, int) -> Collisions
        """Updates collisions resource on the server.
    ...
    def find(
        ...
        # type: (bool, str, str, str, str, int) -> Collisions
        """Finds and retrieves collisions resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve collisions resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all collisions resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching collisions resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of collisions data from the server.
        ...
        Returns
        -------
        - self: This instance with the collisions resources from the server available through an iterator or index
