...
class AverageLatency(Base):
    """
    The AverageLatency class encapsulates a required averageLatency resource which will be retrieved from the server every time the property is accessed.
    """

    __slots__ = ()
    _SDM_NAME = "averageLatency"
    _SDM_ATT_MAP = {
        "Enable": "enable",
        "Name": "name",
        "Notes": "notes",
    ...
    def __init__(self, parent, list_op=False):
        super(AverageLatency, self).__init__(parent, list_op)
    ...
    def update(self, Enable=None, Value=None):
        # type: (bool, int) -> AverageLatency
        """Updates averageLatency resource on the server.
    ...
    def find(
        ...
        # type: (bool, str, str, str, str, int) -> AverageLatency
        """Finds and retrieves averageLatency resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve averageLatency resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all averageLatency resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching averageLatency resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of averageLatency data from the server.
        ...
        Returns
        -------
        - self: This instance with the averageLatency resources from the server available through an iterator or index
