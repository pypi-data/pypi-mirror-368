...
class DhcpOptionSet(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(DhcpOptionSet, self).__init__(parent, list_op)
    ...
    def DhcpOptionTlv(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.globals.protocolstack.radiusglobals.dhcpoptionset.dhcpoptiontlv.dhcpoptiontlv.DhcpOptionTlv): An instance of the DhcpOptionTlv class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.globals.protocolstack.radiusglobals.dhcpoptionset.dhcpoptiontlv.dhcpoptiontlv import (
            DhcpOptionTlv,
        )

        if len(self._object_properties) > 0:
            if self._properties.get("DhcpOptionTlv", None) is not None:
    ...
    def update(self, Defaultp=None, IpType=None, Name=None):
        # type: (bool, str, str) -> DhcpOptionSet
    ...
    def find(self, Defaultp=None, IpType=None, Name=None, ObjectId=None):
        # type: (bool, str, str, str) -> DhcpOptionSet
