...
class Dhcpv6PdOptionSet(Base):
    ...
    def Dhcpv6PdOptionTlv(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.globals.protocolstack.dhcpv6pdclientglobals.dhcpv6pdoptionset.dhcpv6pdoptiontlv.dhcpv6pdoptiontlv import (
            Dhcpv6PdOptionTlv,
        )
