...
class SortingStatisticsFilters(Base):
    """Contains list of all the sorting statistics available which can be enabled for the custom view.
    ...
    __slots__ = ()
    _SDM_NAME = "sortingStatisticsFilters"
    _SDM_ATT_MAP = {
        "Caption": "caption",
        "Enabled": "enabled",
    }
    ...
    def __init__(self, parent, list_op=False):
        super(SortingStatisticsFilters, self).__init__(parent, list_op)
    ...
    def update(self, Enabled=None):
        # type: (bool) -> SortingStatisticsFilters
        """Updates sortingStatisticsFilters resource on the server.
    ...
    def add(self, Enabled=None):
        # type: (bool) -> SortingStatisticsFilters
        """Adds a new sortingStatisticsFilters resource on the json, only valid with batch add utility
    ...
    def find(self, Caption=None, Enabled=None):
        # type: (str, bool) -> SortingStatisticsFilters
        """Finds and retrieves sortingStatisticsFilters resources from the server.
    ...
    def read(self, href):
        """Retrieves a single instance of sortingStatisticsFilters data from the server.
