...
class UserDefinedAfiSafi(Base):
    ...
    def UserDefinedAfiSafiRoutes(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.userdefinedafisafiroutes_e29273deea974c8bb208222a3d127a0e import (
            UserDefinedAfiSafiRoutes,
        )
