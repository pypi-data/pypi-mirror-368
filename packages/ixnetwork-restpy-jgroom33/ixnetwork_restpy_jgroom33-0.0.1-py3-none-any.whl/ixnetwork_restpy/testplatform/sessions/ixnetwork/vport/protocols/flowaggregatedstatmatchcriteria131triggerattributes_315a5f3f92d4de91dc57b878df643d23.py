...
class FlowAggregatedStatMatchCriteria131TriggerAttributes(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(FlowAggregatedStatMatchCriteria131TriggerAttributes, self).__init__(
            parent, list_op
        )
    ...
    def find(
        ...
        """Finds and retrieves flowAggregatedStatMatchCriteria131TriggerAttributes resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve flowAggregatedStatMatchCriteria131TriggerAttributes resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all flowAggregatedStatMatchCriteria131TriggerAttributes resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching flowAggregatedStatMatchCriteria131TriggerAttributes resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of flowAggregatedStatMatchCriteria131TriggerAttributes data from the server.
        ...
        Returns
        -------
        - self: This instance with the flowAggregatedStatMatchCriteria131TriggerAttributes resources from the server available through an iterator or index
