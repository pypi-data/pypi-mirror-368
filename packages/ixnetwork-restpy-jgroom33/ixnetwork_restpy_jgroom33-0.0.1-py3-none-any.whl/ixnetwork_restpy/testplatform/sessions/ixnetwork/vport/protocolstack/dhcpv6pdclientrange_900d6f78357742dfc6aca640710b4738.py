...
class Dhcpv6PdClientRange(Base):
    ...
    def Dhcp6MasterRange(self):
        ...
        Returns
        -------
        - str(None | /api/v1/sessions/1/ixnetwork/vport/protocolStack/ethernet/ip/l2tp/dhcpoLacEndpoint/range/dhcpv6PdClientRange): The DHCP-PD range whose negotiated prefix will be used by this range to configure its addresses.
        """
    ...
    def update(
        ...
        - Dhcp6MasterRange (str(None | /api/v1/sessions/1/ixnetwork/vport/protocolStack/ethernet/ip/l2tp/dhcpoLacEndpoint/range/dhcpv6PdClientRange)): The DHCP-PD range whose negotiated prefix will be used by this range to configure its addresses.
