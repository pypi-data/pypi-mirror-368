...
class L2tpRange(Base):
    ...
    def DomainGroup(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.domaingroup_695770cefa25f4649b6c1b5bdc5c2b4d import (
            DomainGroup,
        )
    ...
    def LnsIp(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.lnsip_d4eb5af3e3a70d8e85283c6e7758faa8 import (
            LnsIp,
        )
