...
class CpMacRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(CpMacRange, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (int, bool, str, str, int, str) -> CpMacRange
        """Updates cpMacRange resource on the server.
    ...
    def find(
        ...
        # type: (int, bool, str, str, int, str, str) -> CpMacRange
        """Finds and retrieves cpMacRange resources from the server.
    ...
    def read(self, href):
        """Retrieves a single instance of cpMacRange data from the server.
