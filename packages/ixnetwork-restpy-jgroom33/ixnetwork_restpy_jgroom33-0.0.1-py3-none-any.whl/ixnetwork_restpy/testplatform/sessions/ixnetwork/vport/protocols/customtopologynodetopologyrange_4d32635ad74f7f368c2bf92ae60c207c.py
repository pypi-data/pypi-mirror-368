...
class CustomTopologyNodeTopologyRange(Base):
    ...
    def CustomTopologyInterestedVlanRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.customtopologyinterestedvlanrange_83977d105f4d179465b55fa6725a4487.CustomTopologyInterestedVlanRange): An instance of the CustomTopologyInterestedVlanRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.customtopologyinterestedvlanrange_83977d105f4d179465b55fa6725a4487 import (
            CustomTopologyInterestedVlanRange,
        )

        if len(self._object_properties) > 0:
            if (
                self._properties.get("CustomTopologyInterestedVlanRange", None)
                is not None
            ):
    ...
    def update(
        self,
        NicknameCount=None,
        NodeNicknameIncrement=None,
        NumberOftreesToCompute=None,
        StartNickname=None,
    ):
