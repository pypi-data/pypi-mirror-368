...
class EgtpS5S8SgwEndpoint(Base):
    ...
    The EgtpS5S8SgwEndpoint class encapsulates a list of egtpS5S8SgwEndpoint resources that are managed by the user.
    A list of resources can be retrieved from the server using the EgtpS5S8SgwEndpoint.find() method.
    The list can be managed by using the EgtpS5S8SgwEndpoint.add() and EgtpS5S8SgwEndpoint.remove() methods.
    """
    ...
    def EnbS5S8SecondaryRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.enbs5s8secondaryrange_8a9723bda9b47f712adf16ebd9da25d1.EnbS5S8SecondaryRange): An instance of the EnbS5S8SecondaryRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.enbs5s8secondaryrange_8a9723bda9b47f712adf16ebd9da25d1 import (
    ...
    def MmeS5S8SecondaryRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.mmes5s8secondaryrange_852b3778e51e94b8b3582c4a1117becf.MmeS5S8SecondaryRange): An instance of the MmeS5S8SecondaryRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.mmes5s8secondaryrange_852b3778e51e94b8b3582c4a1117becf import (
    ...
    def Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_3e88999ba7ecd3f4ed17f238744103e6.Range): An instance of the Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_3e88999ba7ecd3f4ed17f238744103e6 import (
            Range,
        )
    ...
    def UeS5S8SecondaryRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.ues5s8secondaryrange_5eacd6d4523a5dcc9278eb67a74a249d.UeS5S8SecondaryRange): An instance of the UeS5S8SecondaryRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.ues5s8secondaryrange_5eacd6d4523a5dcc9278eb67a74a249d import (
    ...
    def update(self, Name=None):
        ...
        """Updates egtpS5S8SgwEndpoint resource on the server.
    ...
    def add(self, Name=None):
        # type: (str) -> EgtpS5S8SgwEndpoint
        """Adds a new egtpS5S8SgwEndpoint resource on the server and adds it to the container.
        ...
        Returns
        -------
        - self: This instance with all currently retrieved egtpS5S8SgwEndpoint resources using find and the newly added egtpS5S8SgwEndpoint resources available through an iterator or index
    ...
    def remove(self):
        """Deletes all the contained egtpS5S8SgwEndpoint resources in this instance from the server.
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> EgtpS5S8SgwEndpoint
        """Finds and retrieves egtpS5S8SgwEndpoint resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve egtpS5S8SgwEndpoint resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all egtpS5S8SgwEndpoint resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching egtpS5S8SgwEndpoint resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        ...
        Returns
        -------
        - self: This instance with the egtpS5S8SgwEndpoint resources from the server available through an iterator or index
