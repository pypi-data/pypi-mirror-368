...
class UpVlanRangeS5S8(Base):
    ...
    def VlanIdInfo(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_7c40339b808e6208557eaa5d656d20b4.VlanIdInfo): An instance of the VlanIdInfo class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_7c40339b808e6208557eaa5d656d20b4 import (
            VlanIdInfo,
        )
    ...
    def find(
        ...
        # type: (bool, int, int, int, int, bool, int, int, int, int, str, int, str, str, int, str, int) -> UpVlanRangeS5S8
        """Finds and retrieves upVlanRangeS5S8 resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve upVlanRangeS5S8 resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all upVlanRangeS5S8 resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching upVlanRangeS5S8 resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of upVlanRangeS5S8 data from the server.
        ...
        Returns
        -------
        - self: This instance with the upVlanRangeS5S8 resources from the server available through an iterator or index
