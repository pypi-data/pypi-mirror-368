...
class FcClientFdiscRange(Base):
    ...
    def find(
        ...
        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve fcClientFdiscRange resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all fcClientFdiscRange resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching fcClientFdiscRange resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of fcClientFdiscRange data from the server.
        ...
        Returns
        -------
        - self: This instance with the fcClientFdiscRange resources from the server available through an iterator or index
    ...
    def FcClientFdisc(self, *args, **kwargs):
        ...
        fcClientFdisc(async_operation=bool)
        -----------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        fcClientFdisc(Arg2=enum, async_operation=bool)
        ----------------------------------------------
    ...
    def FcClientNpivFlogo(self, *args, **kwargs):
        ...
        fcClientNpivFlogo(async_operation=bool)
        ---------------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        fcClientNpivFlogo(Arg2=enum, async_operation=bool)
        --------------------------------------------------
        - Arg2 (str(async | sync)): kArray[kObjref=/vport/protocolStack/fcClientEndpoint,/vport/protocolStack/fcClientEndpoint/range/fcClientFdiscRange]
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
