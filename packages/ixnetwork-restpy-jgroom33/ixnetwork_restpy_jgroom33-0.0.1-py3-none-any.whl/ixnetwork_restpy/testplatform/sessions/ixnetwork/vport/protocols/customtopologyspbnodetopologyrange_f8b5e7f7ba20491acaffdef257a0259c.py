...
class CustomTopologySpbNodeTopologyRange(Base):
    ...
    def CustomTopologySpbNodeBaseVidRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.customtopologyspbnodebasevidrange_de0058a944364add436467ad4dd6ff34.CustomTopologySpbNodeBaseVidRange): An instance of the CustomTopologySpbNodeBaseVidRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.customtopologyspbnodebasevidrange_de0058a944364add436467ad4dd6ff34 import (
            CustomTopologySpbNodeBaseVidRange,
        )

        if len(self._object_properties) > 0:
            if (
                self._properties.get("CustomTopologySpbNodeBaseVidRange", None)
                is not None
            ):
