...
class TwampServer(Base):
    """A network stack element representing an RFC 4656 TWAMP Control-Server and Session-Reflector
    The TwampServer class encapsulates a list of twampServer resources that are managed by the user.
    A list of resources can be retrieved from the server using the TwampServer.find() method.
    The list can be managed by using the TwampServer.add() and TwampServer.remove() methods.
    """

    __slots__ = ()
    _SDM_NAME = "twampServer"
    _SDM_ATT_MAP = {
        "Name": "name",
        "ObjectId": "objectId",
    }
    ...
    def __init__(self, parent, list_op=False):
        super(TwampServer, self).__init__(parent, list_op)
    ...
    def update(self, Name=None):
        # type: (str) -> TwampServer
        """Updates twampServer resource on the server.
    ...
    def add(self, Name=None):
        # type: (str) -> TwampServer
        """Adds a new twampServer resource on the server and adds it to the container.
        ...
        Returns
        -------
        - self: This instance with all currently retrieved twampServer resources using find and the newly added twampServer resources available through an iterator or index
    ...
    def remove(self):
        """Deletes all the contained twampServer resources in this instance from the server.
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> TwampServer
        """Finds and retrieves twampServer resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve twampServer resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all twampServer resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching twampServer resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of twampServer data from the server.
        ...
        Returns
        -------
        - self: This instance with the twampServer resources from the server available through an iterator or index
    ...
    def TwampServerClearStats(self, *args, **kwargs):
        # type: (*Any, **Any) -> None
        """Executes the twampServerClearStats operation on the server.

        Clear TWAMP statistics for selected plugins

        twampServerClearStats(async_operation=bool)
        -------------------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
        ...
        for item in kwargs.items():
            payload[item[0]] = item[1]
        return self._execute(
            "twampServerClearStats", payload=payload, response_object=None
        )

    def TwampServerStart(self, *args, **kwargs):
        # type: (*Any, **Any) -> None
        """Executes the twampServerStart operation on the server.

        Initiate TWAMP control and test sessions for selected ranges and start measurements

        The IxNetwork model allows for multiple method Signatures with the same name while python does not.

        twampServerStart(async_operation=bool)
        --------------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        twampServerStart(Arg2=enum, async_operation=bool)
        -------------------------------------------------
        - Arg2 (str(async | sync)): kArray[kObjref=/vport/protocolStack/atm/emulatedRouter/ip/twampServer,/vport/protocolStack/atm/emulatedRouter/ipEndpoint/twampServer,/vport/protocolStack/atm/ip/twampServer,/vport/protocolStack/atm/ipEndpoint/twampServer,/vport/protocolStack/ethernet/emulatedRouter/ip/twampServer,/vport/protocolStack/ethernet/emulatedRouter/ipEndpoint/twampServer,/vport/protocolStack/ethernet/ip/twampServer,/vport/protocolStack/ethernet/ipEndpoint/twampServer]
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
        ...
        for item in kwargs.items():
            payload[item[0]] = item[1]
        return self._execute("twampServerStart", payload=payload, response_object=None)

    def TwampServerStop(self, *args, **kwargs):
        # type: (*Any, **Any) -> None
        """Executes the twampServerStop operation on the server.

        Teardown TWAMP sessions for selected ranges

        The IxNetwork model allows for multiple method Signatures with the same name while python does not.

        twampServerStop(async_operation=bool)
        -------------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        twampServerStop(Arg2=enum, async_operation=bool)
        ------------------------------------------------
        - Arg2 (str(async | sync)): kArray[kObjref=/vport/protocolStack/atm/emulatedRouter/ip/twampServer,/vport/protocolStack/atm/emulatedRouter/ipEndpoint/twampServer,/vport/protocolStack/atm/ip/twampServer,/vport/protocolStack/atm/ipEndpoint/twampServer,/vport/protocolStack/ethernet/emulatedRouter/ip/twampServer,/vport/protocolStack/ethernet/emulatedRouter/ipEndpoint/twampServer,/vport/protocolStack/ethernet/ip/twampServer,/vport/protocolStack/ethernet/ipEndpoint/twampServer]
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
        ...
        for item in kwargs.items():
            payload[item[0]] = item[1]
        return self._execute("twampServerStop", payload=payload, response_object=None)
