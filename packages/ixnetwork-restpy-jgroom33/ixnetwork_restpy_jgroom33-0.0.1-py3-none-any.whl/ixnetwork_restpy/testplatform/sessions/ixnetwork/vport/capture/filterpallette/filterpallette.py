...
class FilterPallette(Base):
    ...
    def PatternOffsetType2(self):
        ...
        Returns
        -------
        - str(filterPalletteOffsetStartOfFrame | filterPalletteOffsetStartOfIp | filterPalletteOffsetStartOfProtocol): For ports that support the portFeaturePatternOffsetFlexible feature, this option specifies the place that patternOffset2 is relative to.
        """
    ...
    def update(
        ...
        PatternOffset1=None,
        PatternOffset2=None,
        PatternOffsetType1=None,
        PatternOffsetType2=None,
    ):
        ...
        - PatternOffsetType2 (str(filterPalletteOffsetStartOfFrame | filterPalletteOffsetStartOfIp | filterPalletteOffsetStartOfProtocol)): For ports that support the portFeaturePatternOffsetFlexible feature, this option specifies the place that patternOffset2 is relative to.
