...
class DcbxTlvAppQaz(Base):
    ...
    def DcbxAppPriorityAtt(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dcbxapppriorityatt_ad5afe5a2771fcd58c880d8c0a2d3eac.DcbxAppPriorityAtt): An instance of the DcbxAppPriorityAtt class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dcbxapppriorityatt_ad5afe5a2771fcd58c880d8c0a2d3eac import (
            DcbxAppPriorityAtt,
        )
