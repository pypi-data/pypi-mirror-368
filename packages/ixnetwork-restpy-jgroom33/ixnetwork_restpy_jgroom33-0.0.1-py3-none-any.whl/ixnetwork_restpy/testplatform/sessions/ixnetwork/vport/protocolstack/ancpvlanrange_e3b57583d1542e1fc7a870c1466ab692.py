...
class AncpVlanRange(Base):
    ...
    def VlanIdInfo(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_d1ad35a1b0ecaac04fbae095e121fde7.VlanIdInfo): An instance of the VlanIdInfo class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_d1ad35a1b0ecaac04fbae095e121fde7 import (
            VlanIdInfo,
        )
