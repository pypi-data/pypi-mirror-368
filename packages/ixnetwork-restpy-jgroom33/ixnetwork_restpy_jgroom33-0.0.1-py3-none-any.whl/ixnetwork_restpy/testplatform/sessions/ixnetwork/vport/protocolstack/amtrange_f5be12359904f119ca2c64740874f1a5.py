...
class AmtRange(Base):
    ...
    The AmtRange class encapsulates a list of amtRange resources that are managed by the user.
    A list of resources can be retrieved from the server using the AmtRange.find() method.
    The list can be managed by using the AmtRange.add() and AmtRange.remove() methods.
    """
    ...
    def add(
        ...
        Returns
        -------
        - self: This instance with all currently retrieved amtRange resources using find and the newly added amtRange resources available through an iterator or index
    ...
    def remove(self):
        """Deletes all the contained amtRange resources in this instance from the server.
    ...
    def find(
        ...
        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve amtRange resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all amtRange resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching amtRange resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        ...
        Returns
        -------
        - self: This instance with the amtRange resources from the server available through an iterator or index
