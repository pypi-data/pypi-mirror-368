...
class UpIpRangeS5S8(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(UpIpRangeS5S8, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, int, bool, bool, str, str, str, str, str, str, int, str, int) -> UpIpRangeS5S8
        """Updates upIpRangeS5S8 resource on the server.
    ...
    def find(
        ...
        # type: (bool, int, bool, bool, str, str, str, str, str, str, int, str, str, int) -> UpIpRangeS5S8
        """Finds and retrieves upIpRangeS5S8 resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve upIpRangeS5S8 resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all upIpRangeS5S8 resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching upIpRangeS5S8 resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of upIpRangeS5S8 data from the server.
        ...
        Returns
        -------
        - self: This instance with the upIpRangeS5S8 resources from the server available through an iterator or index
