...
class Ipv6mpls(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(Ipv6mpls, self).__init__(parent, list_op)
    ...
    def add(self):
        """Adds a new ipv6mpls resource on the json, only valid with batch add utility

        Returns
        -------
        - self: This instance with all currently retrieved ipv6mpls resources using find and the newly added ipv6mpls resources available through an iterator or index
    ...
    def find(
        ...
        # type: (str, int, int, bool, str, int, int, int, int, str, str, str, int, str, bool, int) -> Ipv6mpls
