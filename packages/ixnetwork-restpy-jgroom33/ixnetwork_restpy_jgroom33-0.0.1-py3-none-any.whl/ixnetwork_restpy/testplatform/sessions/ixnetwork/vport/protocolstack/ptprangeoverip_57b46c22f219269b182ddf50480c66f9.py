...
class PtpRangeOverIp(Base):
    ...
    The PtpRangeOverIp class encapsulates a list of ptpRangeOverIp resources that are managed by the user.
    A list of resources can be retrieved from the server using the PtpRangeOverIp.find() method.
    The list can be managed by using the PtpRangeOverIp.add() and PtpRangeOverIp.remove() methods.
    """
    ...
    def add(
        ...
        Returns
        -------
        - self: This instance with all currently retrieved ptpRangeOverIp resources using find and the newly added ptpRangeOverIp resources available through an iterator or index
    ...
    def remove(self):
        """Deletes all the contained ptpRangeOverIp resources in this instance from the server.
    ...
    def find(
        ...
        By default the find method takes no parameters and will retrieve all ptpRangeOverIp resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching ptpRangeOverIp resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        ...
        Returns
        -------
        - self: This instance with the ptpRangeOverIp resources from the server available through an iterator or index
