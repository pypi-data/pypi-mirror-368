...
class AncpMacRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(AncpMacRange, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (int, bool, str, str, int, str) -> AncpMacRange
        """Updates ancpMacRange resource on the server.
    ...
    def find(
        ...
        # type: (int, bool, str, str, int, str, str) -> AncpMacRange
        """Finds and retrieves ancpMacRange resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve ancpMacRange resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all ancpMacRange resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching ancpMacRange resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of ancpMacRange data from the server.
        ...
        Returns
        -------
        - self: This instance with the ancpMacRange resources from the server available through an iterator or index
