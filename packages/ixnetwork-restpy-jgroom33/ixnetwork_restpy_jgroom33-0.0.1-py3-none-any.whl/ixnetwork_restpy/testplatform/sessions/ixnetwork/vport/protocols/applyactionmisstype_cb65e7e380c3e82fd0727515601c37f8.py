...
class ApplyActionMissType(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(ApplyActionMissType, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool) -> ApplyActionMissType
    ...
    def find(
        ...
        # type: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool) -> ApplyActionMissType
        """Finds and retrieves applyActionMissType resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve applyActionMissType resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all applyActionMissType resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching applyActionMissType resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of applyActionMissType data from the server.
        ...
        Returns
        -------
        - self: This instance with the applyActionMissType resources from the server available through an iterator or index
