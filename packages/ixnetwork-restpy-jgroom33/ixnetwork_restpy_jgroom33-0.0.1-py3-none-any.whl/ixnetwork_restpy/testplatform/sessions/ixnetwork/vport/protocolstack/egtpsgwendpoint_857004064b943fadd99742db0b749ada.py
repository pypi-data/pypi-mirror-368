...
class EgtpSgwEndpoint(Base):
    """Range settings generated by SMPluginGen
    The EgtpSgwEndpoint class encapsulates a list of egtpSgwEndpoint resources that are managed by the user.
    A list of resources can be retrieved from the server using the EgtpSgwEndpoint.find() method.
    The list can be managed by using the EgtpSgwEndpoint.add() and EgtpSgwEndpoint.remove() methods.
    """

    __slots__ = ()
    _SDM_NAME = "egtpSgwEndpoint"
    _SDM_ATT_MAP = {
        "Name": "name",
        "ObjectId": "objectId",
    }
    ...
    def __init__(self, parent, list_op=False):
        super(EgtpSgwEndpoint, self).__init__(parent, list_op)

    @property
    def PcrfSecondaryRange(self):
        """
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.pcrfsecondaryrange_ae0efcc659d603f0eb8549457012f29f.PcrfSecondaryRange): An instance of the PcrfSecondaryRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.pcrfsecondaryrange_ae0efcc659d603f0eb8549457012f29f import (
            PcrfSecondaryRange,
        )

        if len(self._object_properties) > 0:
            if self._properties.get("PcrfSecondaryRange", None) is not None:
                return self._properties.get("PcrfSecondaryRange")
        return PcrfSecondaryRange(self)
    ...
    def Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_58ef2d157378f1fc5409888ddd475c8e.Range): An instance of the Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_58ef2d157378f1fc5409888ddd475c8e import (
            Range,
        )
    ...
    def update(self, Name=None):
        # type: (str) -> EgtpSgwEndpoint
        """Updates egtpSgwEndpoint resource on the server.
    ...
    def add(self, Name=None):
        # type: (str) -> EgtpSgwEndpoint
        """Adds a new egtpSgwEndpoint resource on the server and adds it to the container.
        ...
        Returns
        -------
        - self: This instance with all currently retrieved egtpSgwEndpoint resources using find and the newly added egtpSgwEndpoint resources available through an iterator or index
    ...
    def remove(self):
        """Deletes all the contained egtpSgwEndpoint resources in this instance from the server.
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> EgtpSgwEndpoint
        """Finds and retrieves egtpSgwEndpoint resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve egtpSgwEndpoint resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all egtpSgwEndpoint resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching egtpSgwEndpoint resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of egtpSgwEndpoint data from the server.
        ...
        Returns
        -------
        - self: This instance with the egtpSgwEndpoint resources from the server available through an iterator or index
