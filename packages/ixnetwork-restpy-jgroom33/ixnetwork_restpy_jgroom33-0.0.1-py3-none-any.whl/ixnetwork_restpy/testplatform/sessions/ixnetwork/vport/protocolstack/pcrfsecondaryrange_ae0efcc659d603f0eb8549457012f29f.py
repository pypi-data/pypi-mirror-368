...
class PcrfSecondaryRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(PcrfSecondaryRange, self).__init__(parent, list_op)
    ...
    def EgtpSgwRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpsgwrange_5d015b8d071bfaa584bd07b6fc617924.EgtpSgwRange): An instance of the EgtpSgwRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpsgwrange_5d015b8d071bfaa584bd07b6fc617924 import (
            EgtpSgwRange,
        )

        if len(self._object_properties) > 0:
            if self._properties.get("EgtpSgwRange", None) is not None:
