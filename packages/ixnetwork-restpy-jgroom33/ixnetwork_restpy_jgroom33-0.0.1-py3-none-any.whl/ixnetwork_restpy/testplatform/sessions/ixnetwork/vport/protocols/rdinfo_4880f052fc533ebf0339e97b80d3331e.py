...
class RdInfo(Base):
    ...
    def EthernetTagInfo(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.ethernettaginfo_92759388a5719067442f4fe9d2739229.EthernetTagInfo): An instance of the EthernetTagInfo class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.ethernettaginfo_92759388a5719067442f4fe9d2739229 import (
            EthernetTagInfo,
        )
