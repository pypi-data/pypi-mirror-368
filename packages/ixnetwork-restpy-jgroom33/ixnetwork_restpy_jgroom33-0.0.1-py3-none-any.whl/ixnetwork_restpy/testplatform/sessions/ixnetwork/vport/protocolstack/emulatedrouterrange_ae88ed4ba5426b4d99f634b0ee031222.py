...
class EmulatedRouterRange(Base):
    ...
    def find(
        ...
        # type: (bool, bool, int, bool, bool, str, str, str, str, str, str, int, str, str, int) -> EmulatedRouterRange
        """Finds and retrieves emulatedRouterRange resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve emulatedRouterRange resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all emulatedRouterRange resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching emulatedRouterRange resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of emulatedRouterRange data from the server.
        ...
        Returns
        -------
        - self: This instance with the emulatedRouterRange resources from the server available through an iterator or index
