...
class InstructionMissLearnedInfo(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(InstructionMissLearnedInfo, self).__init__(parent, list_op)
    ...
    def add(self):
        """Adds a new instructionMissLearnedInfo resource on the json, only valid with batch add utility
    ...
    def find(
        ...
        # type: (str, int, int, str, str, str) -> InstructionMissLearnedInfo
