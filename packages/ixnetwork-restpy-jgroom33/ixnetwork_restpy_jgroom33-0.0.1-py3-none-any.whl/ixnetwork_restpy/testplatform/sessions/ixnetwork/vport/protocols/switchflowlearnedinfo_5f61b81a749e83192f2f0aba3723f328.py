...
class SwitchFlowLearnedInfo(Base):
    ...
    def SwitchActionLearnedInfo(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.switchactionlearnedinfo_9e46c41b8abd4718021189fe5e5af931.SwitchActionLearnedInfo): An instance of the SwitchActionLearnedInfo class
    ...
    def SwitchFlowInstructionLearnedInfo(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.switchflowinstructionlearnedinfo_18876b6839ad8af19f820bd250cf246f.SwitchFlowInstructionLearnedInfo): An instance of the SwitchFlowInstructionLearnedInfo class
