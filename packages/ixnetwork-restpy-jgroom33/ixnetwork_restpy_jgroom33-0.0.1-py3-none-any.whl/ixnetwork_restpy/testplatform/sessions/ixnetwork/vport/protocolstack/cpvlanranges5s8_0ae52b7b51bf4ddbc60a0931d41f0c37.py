...
class CpVlanRangeS5S8(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(CpVlanRangeS5S8, self).__init__(parent, list_op)
    ...
    def VlanIdInfo(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_62b9b270940ecdbc405cf17fa98aa06f.VlanIdInfo): An instance of the VlanIdInfo class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_62b9b270940ecdbc405cf17fa98aa06f import (
            VlanIdInfo,
        )
    ...
    def update(
        ...
        # type: (bool, int, int, int, int, bool, int, int, int, int, str, int, str, int, str, int) -> CpVlanRangeS5S8
    ...
    def find(
        ...
        # type: (bool, int, int, int, int, bool, int, int, int, int, str, int, str, str, int, str, int) -> CpVlanRangeS5S8
        """Finds and retrieves cpVlanRangeS5S8 resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve cpVlanRangeS5S8 resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all cpVlanRangeS5S8 resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching cpVlanRangeS5S8 resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of cpVlanRangeS5S8 data from the server.
        ...
        Returns
        -------
        - self: This instance with the cpVlanRangeS5S8 resources from the server available through an iterator or index
