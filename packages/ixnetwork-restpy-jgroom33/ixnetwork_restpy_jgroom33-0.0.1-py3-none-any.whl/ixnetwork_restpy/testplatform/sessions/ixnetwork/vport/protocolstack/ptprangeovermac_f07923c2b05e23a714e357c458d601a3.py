...
class PtpRangeOverMac(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(PtpRangeOverMac, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, int, bool, bool, bool, bool, int, bool, int, str, str, str, str, str, int, str, str, str, int, int, int, int, int, bool, bool, bool, bool, str, int, int, int, int, int, int, int, int, bool, int, int, int, int, str, str, str, str, str, str, str, int, int, int, int, bool, int, int, int, int, int, bool, bool, bool, int, str, str, int, bool, int, int, str, int, int, int, bool, bool) -> PtpRangeOverMac
    ...
    def find(
        ...
        # type: (bool, int, bool, bool, bool, bool, int, bool, int, str, str, str, str, str, int, str, str, str, int, int, int, int, int, bool, bool, bool, bool, str, int, int, int, int, int, int, int, int, bool, int, int, int, int, str, str, str, str, str, str, str, str, int, int, int, int, bool, int, int, int, int, int, bool, bool, bool, int, str, str, int, bool, int, int, str, int, int, int, bool, bool) -> PtpRangeOverMac
