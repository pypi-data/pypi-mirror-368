...
class Evc(Base):
    ...
    def BwProfile(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.bwprofile_c7210d4d2555c28ee509abc680d0b951.BwProfile): An instance of the BwProfile class
    ...
    def CeVlanIdRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.cevlanidrange_c020c993f4d4b311a0a67accf3fbe3cd.CeVlanIdRange): An instance of the CeVlanIdRange class
