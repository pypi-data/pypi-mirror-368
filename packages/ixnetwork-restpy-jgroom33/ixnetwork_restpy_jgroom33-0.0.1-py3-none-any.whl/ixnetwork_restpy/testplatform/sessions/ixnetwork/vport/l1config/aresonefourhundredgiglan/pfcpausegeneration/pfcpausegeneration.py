...
class PfcPauseGeneration(Base):
    ...
    def Priority(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresonefourhundredgiglan.pfcpausegeneration.priority.priority.Priority): An instance of the Priority class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresonefourhundredgiglan.pfcpausegeneration.priority.priority import (
            Priority,
        )
