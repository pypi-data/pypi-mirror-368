...
class UeS5S8SecondaryRange(Base):
    ...
    def EgtpUeS5S8Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpues5s8range_898c6ddf10c49e5943dc4aa421c536a8.EgtpUeS5S8Range): An instance of the EgtpUeS5S8Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpues5s8range_898c6ddf10c49e5943dc4aa421c536a8 import (
            EgtpUeS5S8Range,
        )
