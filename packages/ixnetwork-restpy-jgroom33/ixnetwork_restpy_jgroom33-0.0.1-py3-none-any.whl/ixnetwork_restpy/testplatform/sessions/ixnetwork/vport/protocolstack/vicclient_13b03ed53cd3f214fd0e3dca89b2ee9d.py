...
class VicClient(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(VicClient, self).__init__(parent, list_op)
    ...
    def VicClientClearStats(self, *args, **kwargs):
        ...
        for item in kwargs.items():
            payload[item[0]] = item[1]
        return self._execute(
            "vicClientClearStats", payload=payload, response_object=None
        )
    ...
    def VicClientFastDeconfigure(self, *args, **kwargs):
        ...
        vicClientFastDeconfigure(async_operation=bool)
        ----------------------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        vicClientFastDeconfigure(Arg2=enum, async_operation=bool)
        ---------------------------------------------------------
        ...
        for item in kwargs.items():
            payload[item[0]] = item[1]
        return self._execute(
            "vicClientFastDeconfigure", payload=payload, response_object=None
        )

    def VicClientOpen(self, *args, **kwargs):
        # type: (*Any, **Any) -> None
        """Executes the vicClientOpen operation on the server.

        Send VIC-OPEN for selected plugins

        vicClientOpen(async_operation=bool)
        -----------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
