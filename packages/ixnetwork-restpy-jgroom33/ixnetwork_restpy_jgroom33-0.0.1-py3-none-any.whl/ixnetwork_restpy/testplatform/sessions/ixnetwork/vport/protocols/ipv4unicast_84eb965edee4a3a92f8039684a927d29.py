...
class Ipv4Unicast(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(Ipv4Unicast, self).__init__(parent, list_op)
    ...
    def add(self):
        """Adds a new ipv4Unicast resource on the json, only valid with batch add utility
    ...
    def find(
        ...
        # type: (str, int, int, bool, str, int, int, int, int, str, str, str, int, str, bool, int) -> Ipv4Unicast
