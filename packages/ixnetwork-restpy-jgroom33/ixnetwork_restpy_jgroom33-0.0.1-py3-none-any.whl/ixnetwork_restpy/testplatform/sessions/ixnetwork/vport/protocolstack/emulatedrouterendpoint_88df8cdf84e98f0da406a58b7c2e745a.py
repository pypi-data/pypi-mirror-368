...
class EmulatedRouterEndpoint(Base):
    ...
    The EmulatedRouterEndpoint class encapsulates a list of emulatedRouterEndpoint resources that are managed by the user.
    A list of resources can be retrieved from the server using the EmulatedRouterEndpoint.find() method.
    The list can be managed by using the EmulatedRouterEndpoint.add() and EmulatedRouterEndpoint.remove() methods.
    """

    __slots__ = ()
    _SDM_NAME = "emulatedRouterEndpoint"
    _SDM_ATT_MAP = {
        "Name": "name",
        "ObjectId": "objectId",
    }
    ...
    def __init__(self, parent, list_op=False):
        super(EmulatedRouterEndpoint, self).__init__(parent, list_op)
    ...
    def Amt(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.amt_ef401962adfc153a014f56fc10c63112.Amt): An instance of the Amt class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.amt_ef401962adfc153a014f56fc10c63112 import (
            Amt,
        )
    ...
    def update(self, Name=None):
        # type: (str) -> EmulatedRouterEndpoint
        """Updates emulatedRouterEndpoint resource on the server.
    ...
    def add(self, Name=None):
        # type: (str) -> EmulatedRouterEndpoint
        """Adds a new emulatedRouterEndpoint resource on the server and adds it to the container.
        ...
        Returns
        -------
        - self: This instance with all currently retrieved emulatedRouterEndpoint resources using find and the newly added emulatedRouterEndpoint resources available through an iterator or index
    ...
    def remove(self):
        """Deletes all the contained emulatedRouterEndpoint resources in this instance from the server.
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> EmulatedRouterEndpoint
        """Finds and retrieves emulatedRouterEndpoint resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve emulatedRouterEndpoint resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all emulatedRouterEndpoint resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching emulatedRouterEndpoint resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of emulatedRouterEndpoint data from the server.
        ...
        Returns
        -------
        - self: This instance with the emulatedRouterEndpoint resources from the server available through an iterator or index
