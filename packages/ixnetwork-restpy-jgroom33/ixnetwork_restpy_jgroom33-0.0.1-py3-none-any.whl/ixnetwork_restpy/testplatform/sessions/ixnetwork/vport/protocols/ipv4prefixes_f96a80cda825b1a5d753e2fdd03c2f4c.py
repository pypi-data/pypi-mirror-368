...
class Ipv4Prefixes(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(Ipv4Prefixes, self).__init__(parent, list_op)
    ...
    def add(self):
        """Adds a new ipv4Prefixes resource on the json, only valid with batch add utility
    ...
    def find(
        ...
        # type: (int, str, str, str, str, int, int) -> Ipv4Prefixes
