...
class PgwS5S8PcrfSecondaryRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(PgwS5S8PcrfSecondaryRange, self).__init__(parent, list_op)
    ...
    def EgtpPcrfS5S8Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtppcrfs5s8range_47eec8dc2a0e465133d62111d641cf65.EgtpPcrfS5S8Range): An instance of the EgtpPcrfS5S8Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtppcrfs5s8range_47eec8dc2a0e465133d62111d641cf65 import (
            EgtpPcrfS5S8Range,
        )
