...
class ApplyActionsMiss(Base):
    ...
    def update(
        ...
        # type: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool) -> ApplyActionsMiss
    ...
    def find(
        ...
        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve applyActionsMiss resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all applyActionsMiss resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching applyActionsMiss resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of applyActionsMiss data from the server.
        ...
        Returns
        -------
        - self: This instance with the applyActionsMiss resources from the server available through an iterator or index
