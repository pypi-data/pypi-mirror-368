...
class EgtpS5S8PgwEndpoint(Base):
    ...
    The EgtpS5S8PgwEndpoint class encapsulates a list of egtpS5S8PgwEndpoint resources that are managed by the user.
    A list of resources can be retrieved from the server using the EgtpS5S8PgwEndpoint.find() method.
    The list can be managed by using the EgtpS5S8PgwEndpoint.add() and EgtpS5S8PgwEndpoint.remove() methods.
    """

    __slots__ = ()
    _SDM_NAME = "egtpS5S8PgwEndpoint"
    _SDM_ATT_MAP = {
        "Name": "name",
        "ObjectId": "objectId",
    }
    ...
    def __init__(self, parent, list_op=False):
        super(EgtpS5S8PgwEndpoint, self).__init__(parent, list_op)

    @property
    def PgwS5S8PcrfSecondaryRange(self):
        """
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.pgws5s8pcrfsecondaryrange_edf0603e83bd15a31fa955a1d0751128.PgwS5S8PcrfSecondaryRange): An instance of the PgwS5S8PcrfSecondaryRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.pgws5s8pcrfsecondaryrange_edf0603e83bd15a31fa955a1d0751128 import (
            PgwS5S8PcrfSecondaryRange,
        )
    ...
    def Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_f573006ce8cded3d52938da7d7fd7457.Range): An instance of the Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_f573006ce8cded3d52938da7d7fd7457 import (
            Range,
        )
    ...
    def update(self, Name=None):
        # type: (str) -> EgtpS5S8PgwEndpoint
        """Updates egtpS5S8PgwEndpoint resource on the server.
    ...
    def add(self, Name=None):
        # type: (str) -> EgtpS5S8PgwEndpoint
        """Adds a new egtpS5S8PgwEndpoint resource on the server and adds it to the container.
        ...
        Returns
        -------
        - self: This instance with all currently retrieved egtpS5S8PgwEndpoint resources using find and the newly added egtpS5S8PgwEndpoint resources available through an iterator or index
    ...
    def remove(self):
        """Deletes all the contained egtpS5S8PgwEndpoint resources in this instance from the server.
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> EgtpS5S8PgwEndpoint
        """Finds and retrieves egtpS5S8PgwEndpoint resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve egtpS5S8PgwEndpoint resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all egtpS5S8PgwEndpoint resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching egtpS5S8PgwEndpoint resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of egtpS5S8PgwEndpoint data from the server.
        ...
        Returns
        -------
        - self: This instance with the egtpS5S8PgwEndpoint resources from the server available through an iterator or index
