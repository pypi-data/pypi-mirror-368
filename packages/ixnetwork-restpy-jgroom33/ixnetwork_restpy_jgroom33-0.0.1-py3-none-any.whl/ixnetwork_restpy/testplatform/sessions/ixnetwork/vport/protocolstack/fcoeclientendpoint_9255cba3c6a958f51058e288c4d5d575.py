...
class FcoeClientEndpoint(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(FcoeClientEndpoint, self).__init__(parent, list_op)
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> FcoeClientEndpoint
    ...
    def FcoeClientClearStats(self, *args, **kwargs):
        ...
        for item in kwargs.items():
            payload[item[0]] = item[1]
        return self._execute(
            "fcoeClientClearStats", payload=payload, response_object=None
        )
