...
class L2tp(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(L2tp, self).__init__(parent, list_op)
    ...
    def Dhcp2v6Client(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcp2v6client_37a4b625a214f7485cac8baa0f4f241a.Dhcp2v6Client): An instance of the Dhcp2v6Client class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcp2v6client_37a4b625a214f7485cac8baa0f4f241a import (
            Dhcp2v6Client,
        )
    ...
    def DhcpoLacEndpoint(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcpolacendpoint_6a2e5d6ed8f697899ea34096e99b027f.DhcpoLacEndpoint): An instance of the DhcpoLacEndpoint class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcpolacendpoint_6a2e5d6ed8f697899ea34096e99b027f import (
            DhcpoLacEndpoint,
        )
    ...
    def DhcpoLnsEndpoint(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcpolnsendpoint_5115610c6cd826a379e6cbdaee2b875e.DhcpoLnsEndpoint): An instance of the DhcpoLnsEndpoint class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcpolnsendpoint_5115610c6cd826a379e6cbdaee2b875e import (
            DhcpoLnsEndpoint,
        )
    ...
    def Dhcpv6Client(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcpv6client_d284fd7c56a3a567f172fcb1878fbbf9.Dhcpv6Client): An instance of the Dhcpv6Client class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcpv6client_d284fd7c56a3a567f172fcb1878fbbf9 import (
            Dhcpv6Client,
        )
    ...
    def Dhcpv6Server(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcpv6server_813d100dd9c195d81b46155d86bb1b57.Dhcpv6Server): An instance of the Dhcpv6Server class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dhcpv6server_813d100dd9c195d81b46155d86bb1b57 import (
            Dhcpv6Server,
        )
    ...
    def Radius(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.radius_678a6c3e0b7ce969abfb8d80a8df9295.Radius): An instance of the Radius class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.radius_678a6c3e0b7ce969abfb8d80a8df9295 import (
            Radius,
        )
    ...
    def L2tpClearStats(self, *args, **kwargs):
        ...
        l2tpClearStats(async_operation=bool)
        ------------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        l2tpClearStats(Arg2=enum, async_operation=bool)
        -----------------------------------------------
    ...
    def L2tpNegotiateTo(self, *args, **kwargs):
        ...
        l2tpNegotiateTo(Arg2=number, async_operation=bool)
        --------------------------------------------------
        - Arg2 (number): kArray[kObjref=/vport/protocolStack/atm/emulatedRouter/ip/l2tp,/vport/protocolStack/atm/emulatedRouter/ip/l2tpEndpoint,/vport/protocolStack/atm/ip/l2tp,/vport/protocolStack/atm/ip/l2tpEndpoint,/vport/protocolStack/ethernet/emulatedRouter/ip/l2tp,/vport/protocolStack/ethernet/emulatedRouter/ip/l2tpEndpoint,/vport/protocolStack/ethernet/ip/l2tp,/vport/protocolStack/ethernet/ip/l2tpEndpoint]
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        l2tpNegotiateTo(Arg2=number, Arg3=enum, async_operation=bool)
        -------------------------------------------------------------
        - Arg2 (number): kArray[kObjref=/vport/protocolStack/atm/emulatedRouter/ip/l2tp,/vport/protocolStack/atm/emulatedRouter/ip/l2tpEndpoint,/vport/protocolStack/atm/ip/l2tp,/vport/protocolStack/atm/ip/l2tpEndpoint,/vport/protocolStack/ethernet/emulatedRouter/ip/l2tp,/vport/protocolStack/ethernet/emulatedRouter/ip/l2tpEndpoint,/vport/protocolStack/ethernet/ip/l2tp,/vport/protocolStack/ethernet/ip/l2tpEndpoint]
