...
class UpMacRangeS5S8(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(UpMacRangeS5S8, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (int, bool, str, str, int, str) -> UpMacRangeS5S8
        """Updates upMacRangeS5S8 resource on the server.
    ...
    def find(
        ...
        # type: (int, bool, str, str, int, str, str) -> UpMacRangeS5S8
        """Finds and retrieves upMacRangeS5S8 resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve upMacRangeS5S8 resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all upMacRangeS5S8 resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching upMacRangeS5S8 resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of upMacRangeS5S8 data from the server.
        ...
        Returns
        -------
        - self: This instance with the upMacRangeS5S8 resources from the server available through an iterator or index
