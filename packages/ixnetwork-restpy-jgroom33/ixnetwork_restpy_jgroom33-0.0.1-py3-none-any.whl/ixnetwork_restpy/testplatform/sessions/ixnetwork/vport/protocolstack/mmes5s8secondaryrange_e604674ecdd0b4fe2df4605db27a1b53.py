...
class MmeS5S8SecondaryRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(MmeS5S8SecondaryRange, self).__init__(parent, list_op)
    ...
    def EgtpMmeS5S8Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpmmes5s8range_6ebebb309c6bd5e655b98a286ebd3e06.EgtpMmeS5S8Range): An instance of the EgtpMmeS5S8Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpmmes5s8range_6ebebb309c6bd5e655b98a286ebd3e06 import (
            EgtpMmeS5S8Range,
        )

        if len(self._object_properties) > 0:
            if self._properties.get("EgtpMmeS5S8Range", None) is not None:
