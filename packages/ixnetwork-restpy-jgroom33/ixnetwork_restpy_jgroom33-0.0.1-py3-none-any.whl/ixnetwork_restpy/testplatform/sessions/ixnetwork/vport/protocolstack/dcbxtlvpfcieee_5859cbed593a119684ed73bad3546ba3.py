...
class DcbxTlvPfcIeee(Base):
    ...
    def find(self, ObjectId=None, PriorityMap=None, TcsSupported=None):
        # type: (str, List[int], int) -> DcbxTlvPfcIeee
        """Finds and retrieves dcbxTlvPfcIeee resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve dcbxTlvPfcIeee resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all dcbxTlvPfcIeee resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching dcbxTlvPfcIeee resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of dcbxTlvPfcIeee data from the server.
        ...
        Returns
        -------
        - self: This instance with the dcbxTlvPfcIeee resources from the server available through an iterator or index
