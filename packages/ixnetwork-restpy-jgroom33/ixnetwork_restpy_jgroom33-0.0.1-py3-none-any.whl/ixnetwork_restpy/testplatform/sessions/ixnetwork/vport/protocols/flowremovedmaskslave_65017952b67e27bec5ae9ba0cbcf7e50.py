...
class FlowRemovedMaskSlave(Base):
    ...
    def find(self, Delete=None, GroupDelete=None, HardTimeout=None, IdleTimeout=None):
        # type: (bool, bool, bool, bool) -> FlowRemovedMaskSlave
        """Finds and retrieves flowRemovedMaskSlave resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve flowRemovedMaskSlave resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all flowRemovedMaskSlave resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching flowRemovedMaskSlave resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of flowRemovedMaskSlave data from the server.
        ...
        Returns
        -------
        - self: This instance with the flowRemovedMaskSlave resources from the server available through an iterator or index
