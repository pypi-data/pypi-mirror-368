...
class ExtendedCommunity(Base):
    ...
    def ExtendedCommunity(self):
        ...
        Returns
        -------
        - list(dict(arg1:str[decimal | hex | ip | ieeeFloat],arg2:str[decimal | hex | ip | ieeeFloat],arg3:str[twoOctetAs | ip | fourOctetAs | opaque | administratorAsTwoOctetLinkBw],arg4:str[routeTarget | origin | extendedBandwidthSubType],arg5:str)): Associates BGP4 extended community attributes with a route item.
        """
    ...
    def find(self, ExtendedCommunity=None):
        """Finds and retrieves extendedCommunity resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve extendedCommunity resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all extendedCommunity resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching extendedCommunity resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of extendedCommunity data from the server.
        ...
        Returns
        -------
        - self: This instance with the extendedCommunity resources from the server available through an iterator or index
