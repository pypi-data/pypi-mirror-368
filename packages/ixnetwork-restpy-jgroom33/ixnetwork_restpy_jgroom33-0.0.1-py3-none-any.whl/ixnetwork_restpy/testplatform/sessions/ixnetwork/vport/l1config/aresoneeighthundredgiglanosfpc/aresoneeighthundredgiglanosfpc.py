...
class AresOneEightHundredGigLanOsfpC(Base):
    """
    The AresOneEightHundredGigLanOsfpC class encapsulates a required aresOneEightHundredGigLanOsfpC resource which will be retrieved from the server every time the property is accessed.
    """

    __slots__ = ()
    _SDM_NAME = "aresOneEightHundredGigLanOsfpC"
    _SDM_ATT_MAP = {
    ...
    def __init__(self, parent, list_op=False):
        super(AresOneEightHundredGigLanOsfpC, self).__init__(parent, list_op)
    ...
    def Fcoe(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresoneeighthundredgiglanosfpc.fcoe.fcoe.Fcoe): An instance of the Fcoe class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresoneeighthundredgiglanosfpc.fcoe.fcoe import (
            Fcoe,
        )
    ...
    def TxLane(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresoneeighthundredgiglanosfpc.txlane.txlane.TxLane): An instance of the TxLane class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresoneeighthundredgiglanosfpc.txlane.txlane import (
            TxLane,
        )
    ...
    def update(
        ...
        # type: (str, int, bool, bool, bool, str, bool, bool, int, bool, bool, bool, bool, int, bool, str, int, bool, List[str], str, str, bool, bool, str, str, bool) -> AresOneEightHundredGigLanOsfpC
        """Updates aresOneEightHundredGigLanOsfpC resource on the server.
    ...
    def find(
        ...
        # type: (str, List[str], int, bool, bool, bool, bool, bool, str, bool, bool, int, bool, bool, bool, bool, int, bool, str, int, bool, List[str], str, str, bool, bool, str, str, bool) -> AresOneEightHundredGigLanOsfpC
        """Finds and retrieves aresOneEightHundredGigLanOsfpC resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve aresOneEightHundredGigLanOsfpC resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all aresOneEightHundredGigLanOsfpC resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching aresOneEightHundredGigLanOsfpC resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of aresOneEightHundredGigLanOsfpC data from the server.
        ...
        Returns
        -------
        - self: This instance with the aresOneEightHundredGigLanOsfpC resources from the server available through an iterator or index
