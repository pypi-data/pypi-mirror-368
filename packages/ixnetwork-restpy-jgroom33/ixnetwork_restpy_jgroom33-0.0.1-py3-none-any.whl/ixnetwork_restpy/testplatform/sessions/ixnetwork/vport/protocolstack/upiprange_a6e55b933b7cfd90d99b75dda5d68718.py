...
class UpIpRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(UpIpRange, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, int, bool, bool, str, str, str, str, str, str, int, str, int) -> UpIpRange
    ...
    def find(
        ...
        # type: (bool, int, bool, bool, str, str, str, str, str, str, int, str, str, int) -> UpIpRange
        """Finds and retrieves upIpRange resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve upIpRange resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all upIpRange resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching upIpRange resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of upIpRange data from the server.
        ...
        Returns
        -------
        - self: This instance with the upIpRange resources from the server available through an iterator or index
