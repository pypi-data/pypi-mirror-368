...
class Device(Base):
    ...
    def Interface(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.interface_dfb69d588f2b15dfce9b51a039348724.Interface): An instance of the Interface class
