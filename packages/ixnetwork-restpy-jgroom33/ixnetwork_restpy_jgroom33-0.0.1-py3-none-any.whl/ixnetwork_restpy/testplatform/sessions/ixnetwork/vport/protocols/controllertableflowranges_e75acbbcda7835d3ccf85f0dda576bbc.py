...
class ControllerTableFlowRanges(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(ControllerTableFlowRanges, self).__init__(parent, list_op)
    ...
    def Instructions(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.instructions_a545a16ec203e97934be61b56f3be2b6.Instructions): An instance of the Instructions class
