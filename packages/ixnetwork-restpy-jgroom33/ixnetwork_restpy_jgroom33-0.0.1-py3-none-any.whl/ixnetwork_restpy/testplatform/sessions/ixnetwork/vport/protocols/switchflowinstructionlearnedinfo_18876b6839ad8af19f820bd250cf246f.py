...
class SwitchFlowInstructionLearnedInfo(Base):
    ...
    def SwitchActionV131LearnedInfo(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.switchactionv131learnedinfo_86007ee49ffb3db3e01e332902e297a7.SwitchActionV131LearnedInfo): An instance of the SwitchActionV131LearnedInfo class
