...
class Col(Base):
    ...
    def CellTable(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.lag.celltable_bf0a929f20d1c9f1dd3a8704ab2b1a4d.CellTable): An instance of the CellTable class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.lag.celltable_bf0a929f20d1c9f1dd3a8704ab2b1a4d import (
            CellTable,
        )
    ...
    def Row(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.lag.row_45173689e454bc6eba4167d6c8a281c5.Row): An instance of the Row class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.lag.row_45173689e454bc6eba4167d6c8a281c5 import (
            Row,
        )
