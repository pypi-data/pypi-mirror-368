...
class OpenFlowLayer3LearningRate(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(OpenFlowLayer3LearningRate, self).__init__(parent, list_op)
    ...
    def Results(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_97286500514f79e039ab46a457c76628.Results): An instance of the Results class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_97286500514f79e039ab46a457c76628 import (
            Results,
        )
    ...
    def TestConfig(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_e410fd4a44d584244af938efb10566b0.TestConfig): An instance of the TestConfig class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_e410fd4a44d584244af938efb10566b0 import (
            TestConfig,
        )
    ...
    def TrafficSelection(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_6a10911bc4b39d66fba99dafbb86ecfd.TrafficSelection): An instance of the TrafficSelection class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_6a10911bc4b39d66fba99dafbb86ecfd import (
            TrafficSelection,
        )
    ...
    def update(
        ...
        # type: (bool, str, str, str) -> OpenFlowLayer3LearningRate
