...
class FcoeMaxNoDropThroughput(Base):
    ...
    def PassCriteria(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.passcriteria_d639e58651f1a7402043c8ccd0ce93f1 import (
            PassCriteria,
        )
    ...
    def Results(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_85d333490f45cea2767b5e7af198ab2f import (
            Results,
        )
    ...
    def TestConfig(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_18231a8a1ef495dda0a1ec6fa8d2eab8 import (
            TestConfig,
        )
    ...
    def TrafficSelection(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_9b552c1eb749a18e0c9ea501856467ab import (
            TrafficSelection,
        )
