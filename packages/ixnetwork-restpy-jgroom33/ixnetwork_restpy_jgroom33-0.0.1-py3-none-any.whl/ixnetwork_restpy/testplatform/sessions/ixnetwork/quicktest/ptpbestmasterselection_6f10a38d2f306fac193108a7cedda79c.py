...
class PtpBestMasterSelection(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(PtpBestMasterSelection, self).__init__(parent, list_op)
    ...
    def Results(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_1d69b7f6456871db50e8959b8c2b3234 import (
            Results,
        )
    ...
    def TestConfig(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_4f256c2aad08b4874b63c5f688afb1de import (
            TestConfig,
        )
    ...
    def update(
        ...
        # type: (bool, str, str, str) -> PtpBestMasterSelection
