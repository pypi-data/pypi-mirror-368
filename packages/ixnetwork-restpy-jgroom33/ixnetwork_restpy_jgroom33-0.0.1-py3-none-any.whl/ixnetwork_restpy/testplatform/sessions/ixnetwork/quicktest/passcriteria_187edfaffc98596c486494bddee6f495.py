...
class PassCriteria(Base):
    ...
    def LatencyThresholdMode(self):
        ...
        Returns
        -------
        - str(average | maximum): The upstream traffic latency threshold mode.
        """
    ...
    def LatencyThresholdScale(self):
        ...
        Returns
        -------
        - str(ms | ns | us): The latency threshold scale for downstream traffic.
        """
    ...
    def LatencyVarThresholdMode(self):
        ...
        Returns
        -------
        - str(average | maximum): Signifies the latency variation threshold mode.
        """
    ...
    def LatencyVariationThresholdScale(self):
        ...
        Returns
        -------
        - str(ms | ns | us): The upstream traffic latency variation threshold scale.
        """
