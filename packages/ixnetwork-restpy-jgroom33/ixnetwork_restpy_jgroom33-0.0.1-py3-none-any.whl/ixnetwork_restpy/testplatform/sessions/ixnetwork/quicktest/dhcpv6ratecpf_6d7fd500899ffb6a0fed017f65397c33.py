...
class Dhcpv6RateCpf(Base):
    ...
    def Results(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_ea5b17fb9e92e99dd19e87ec238a3bb6 import (
            Results,
        )
    ...
    def TestConfig(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_082d5de4bf8808f63ffee5f08adb2723 import (
            TestConfig,
        )
