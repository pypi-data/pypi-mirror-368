...
class Rfc2889oneToMany(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(Rfc2889oneToMany, self).__init__(parent, list_op)
    ...
    def LearnFrames(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.learnframes_412b98b49a95dee5fcdd552af0697934 import (
            LearnFrames,
        )
    ...
    def PassCriteria(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.passcriteria_7617fa50fdfdfff9e495f84950cddab0 import (
            PassCriteria,
        )
    ...
    def Results(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_619f0ff89bd5aa9ac20c9fd7ae883630 import (
            Results,
        )
    ...
    def TestConfig(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_a546b1621b9177a9c744ae89d3077c3a import (
            TestConfig,
        )
    ...
    def TrafficSelection(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_fb18240dd8d510e46ff2fd8dd304551a import (
            TrafficSelection,
        )
    ...
    def update(
        ...
        # type: (bool, str, str, str) -> Rfc2889oneToMany
