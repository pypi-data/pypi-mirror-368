...
class LearnFrames(Base):
    ...
    def LearnFrameSize(self):
        ...
        Returns
        -------
        - number: The size of the learning frames.
        """
    ...
    def LearnFrequency(self):
        ...
        Returns
        -------
        - str(never | onBinaryIteration | oncePerFramesize | oncePerTest | onTrial): This object allows you to configure learning frequency.
        """
    ...
    def LearnNumFrames(self):
        ...
        Returns
        -------
        - number: This object allows you to configure learning frequency.
        """
    ...
    def LearnRate(self):
        ...
        Returns
        -------
        - number: The rate at which IxNetwork sends learn frames to the DUT.
        """
