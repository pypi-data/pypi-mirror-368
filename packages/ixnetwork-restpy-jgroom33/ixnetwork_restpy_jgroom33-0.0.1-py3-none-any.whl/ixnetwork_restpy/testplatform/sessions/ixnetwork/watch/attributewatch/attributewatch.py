...
class AttributeWatch(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(AttributeWatch, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (List[str], int, str, int, str) -> AttributeWatch
    ...
    def find(
        ...
        # type: (List[str], int, bool, int, str, int, str, int, int, str) -> AttributeWatch
