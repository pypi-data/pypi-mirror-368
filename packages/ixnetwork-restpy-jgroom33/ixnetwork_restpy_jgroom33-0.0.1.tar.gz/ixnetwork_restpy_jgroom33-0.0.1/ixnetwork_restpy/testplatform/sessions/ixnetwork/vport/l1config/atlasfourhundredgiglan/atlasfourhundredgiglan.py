...
class AtlasFourHundredGigLan(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(AtlasFourHundredGigLan, self).__init__(parent, list_op)
    ...
    def Fcoe(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.atlasfourhundredgiglan.fcoe.fcoe import (
            Fcoe,
        )
    ...
    def TxLane(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.atlasfourhundredgiglan.txlane.txlane.TxLane): An instance of the TxLane class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.atlasfourhundredgiglan.txlane.txlane import (
            TxLane,
        )
    ...
    def update(
        ...
        # type: (str, int, bool, bool, bool, bool, bool, bool, bool, bool, bool, str, bool, int, bool, bool, bool, int, bool, str, int, bool, bool, bool, str, str, bool, bool, str, str, bool) -> AtlasFourHundredGigLan
