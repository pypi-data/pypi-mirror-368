...
class EgtpSgwRange(Base):
    ...
    def DedicatedBearer(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dedicatedbearer_8e58d0228e67f81e78a4fba859329bd4.DedicatedBearer): An instance of the DedicatedBearer class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dedicatedbearer_8e58d0228e67f81e78a4fba859329bd4 import (
            DedicatedBearer,
        )
    ...
    def TrafficProfileProxiesSgw(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.trafficprofileproxiessgw_2ba50e3f68406543d68c8adab06c0e1b.TrafficProfileProxiesSgw): An instance of the TrafficProfileProxiesSgw class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.trafficprofileproxiessgw_2ba50e3f68406543d68c8adab06c0e1b import (
