...
class IgmpMldRange(Base):
    ...
    def JoinLeaveMulticastGroupRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.joinleavemulticastgrouprange_055eb0fbf2ee3adf27a435ca7a9e9d5c.JoinLeaveMulticastGroupRange): An instance of the JoinLeaveMulticastGroupRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.joinleavemulticastgrouprange_055eb0fbf2ee3adf27a435ca7a9e9d5c import (
    ...
    def MulticastGroupRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.multicastgrouprange_52b54425b26e866e2c1001d076964fdd.MulticastGroupRange): An instance of the MulticastGroupRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.multicastgrouprange_52b54425b26e866e2c1001d076964fdd import (
            MulticastGroupRange,
        )
