...
class StartRate(Base):
    ...
    def find(self, Count=None, RowNames=None, ScaleMode=None):
        # type: (int, List[str], str) -> StartRate
        """Finds and retrieves startRate resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve startRate resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all startRate resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching startRate resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of startRate data from the server.
        ...
        Returns
        -------
        - self: This instance with the startRate resources from the server available through an iterator or index
