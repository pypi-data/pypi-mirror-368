...
class Range(Base):
    ...
    @property
    def FcFportVxPort(self):
        """
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.fcfportvxport_b424cfaec81485070a734f5af5eb0087.FcFportVxPort): An instance of the FcFportVxPort class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.fcfportvxport_b424cfaec81485070a734f5af5eb0087 import (
            FcFportVxPort,
        )
