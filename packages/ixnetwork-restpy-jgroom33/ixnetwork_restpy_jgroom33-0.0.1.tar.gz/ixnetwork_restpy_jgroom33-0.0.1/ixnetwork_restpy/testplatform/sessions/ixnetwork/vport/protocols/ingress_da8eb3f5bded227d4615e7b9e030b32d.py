...
class Ingress(Base):
    ...
    def SenderRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.senderrange_5f32a5353c2a36df08769d2b836cbf75.SenderRange): An instance of the SenderRange class
