...
class Eigrp(Base):
    ...
    def Router(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.router_06d5f45287e8caa708194cbd2d5fd257 import (
            Router,
        )
    ...
    def find(self, Enabled=None, RunningState=None):
        # type: (bool, str) -> Eigrp
        """Finds and retrieves eigrp resources from the server.
    ...
    def read(self, href):
        """Retrieves a single instance of eigrp data from the server.
