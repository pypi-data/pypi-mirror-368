...
class Stack(Base):
    ...
    def AppendProtocol(self, *args, **kwargs):
        ...
        - Arg2 (str(None | /api/v1/sessions/1/ixnetwork/traffic/protocolTemplate)): A valid /traffic/protocolTemplate object reference.
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
        - Returns str(None | /api/v1/sessions/1/ixnetwork/traffic/trafficItem/egressTracking/fieldOffset/stack): This exec returns an object reference to the newly appended stack item.
    ...
    def InsertProtocol(self, *args, **kwargs):
        ...
        - Arg2 (str(None | /api/v1/sessions/1/ixnetwork/traffic/protocolTemplate)): A valid /traffic/protocolTemplate object reference
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
        - Returns str(None | /api/v1/sessions/1/ixnetwork/traffic/trafficItem/egressTracking/fieldOffset/stack): This exec returns an object reference to the newly inserted stack item.
