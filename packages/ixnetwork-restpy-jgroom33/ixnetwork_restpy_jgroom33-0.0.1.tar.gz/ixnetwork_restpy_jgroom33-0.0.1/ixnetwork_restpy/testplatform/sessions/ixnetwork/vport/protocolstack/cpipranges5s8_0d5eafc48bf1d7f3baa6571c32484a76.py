...
class CpIpRangeS5S8(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(CpIpRangeS5S8, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, int, bool, bool, str, str, str, str, str, str, int, str, int) -> CpIpRangeS5S8
        """Updates cpIpRangeS5S8 resource on the server.
    ...
    def find(
        ...
        # type: (bool, int, bool, bool, str, str, str, str, str, str, int, str, str, int) -> CpIpRangeS5S8
        """Finds and retrieves cpIpRangeS5S8 resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve cpIpRangeS5S8 resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all cpIpRangeS5S8 resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching cpIpRangeS5S8 resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of cpIpRangeS5S8 data from the server.
        ...
        Returns
        -------
        - self: This instance with the cpIpRangeS5S8 resources from the server available through an iterator or index
