...
class ApplySetFieldMask(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(ApplySetFieldMask, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool) -> ApplySetFieldMask
    ...
    def find(
        ...
        # type: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool) -> ApplySetFieldMask
        """Finds and retrieves applySetFieldMask resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve applySetFieldMask resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all applySetFieldMask resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching applySetFieldMask resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of applySetFieldMask data from the server.
        ...
        Returns
        -------
        - self: This instance with the applySetFieldMask resources from the server available through an iterator or index
