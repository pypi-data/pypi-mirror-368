...
class SpbTopologyRange(Base):
    ...
    def SpbBaseVidRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.spbbasevidrange_1c9fe669457e475f948c1f67d34ad28c.SpbBaseVidRange): An instance of the SpbBaseVidRange class
