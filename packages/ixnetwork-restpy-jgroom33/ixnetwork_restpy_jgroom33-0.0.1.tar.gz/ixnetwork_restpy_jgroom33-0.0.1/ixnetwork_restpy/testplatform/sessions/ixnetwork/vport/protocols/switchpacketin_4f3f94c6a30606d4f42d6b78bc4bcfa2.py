...
class SwitchPacketIn(Base):
    ...
    def PacketInHeaders(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.packetinheaders_049c490437f5daa721b6e6c0d3b91b8e.PacketInHeaders): An instance of the PacketInHeaders class
