...
class Ptprobeinstancesrv6(Base):
    """Path Trace Port level Configuration
    The Ptprobeinstancesrv6 class encapsulates a required ptprobeinstancesrv6 resource which will be retrieved from the server every time the property is accessed.
    """
    ...
    def TimeStamp(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.multivalue.Multivalue): Timestamp Format.
        """
    ...
    def find(self, Count=None, DescriptiveName=None, Name=None, RowNames=None):
        # type: (int, str, str, List[str]) -> Ptprobeinstancesrv6
    ...
    def get_device_ids(self, PortNames=None, TimeStamp=None):
