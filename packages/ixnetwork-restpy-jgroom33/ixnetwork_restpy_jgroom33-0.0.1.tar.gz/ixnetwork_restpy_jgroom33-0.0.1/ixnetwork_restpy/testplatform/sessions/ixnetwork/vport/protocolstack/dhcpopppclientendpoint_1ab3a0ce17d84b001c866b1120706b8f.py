...
class DhcpoPppClientEndpoint(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(DhcpoPppClientEndpoint, self).__init__(parent, list_op)
    ...
    def Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_9d890958a285636b6a8f974eb82514e9.Range): An instance of the Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_9d890958a285636b6a8f974eb82514e9 import (
            Range,
        )
    ...
    def update(self, Name=None):
        # type: (str) -> DhcpoPppClientEndpoint
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> DhcpoPppClientEndpoint
    ...
    def DhcpHostsClearStats(self, *args, **kwargs):
        ...
        for item in kwargs.items():
            payload[item[0]] = item[1]
        return self._execute(
            "dhcpHostsClearStats", payload=payload, response_object=None
        )
