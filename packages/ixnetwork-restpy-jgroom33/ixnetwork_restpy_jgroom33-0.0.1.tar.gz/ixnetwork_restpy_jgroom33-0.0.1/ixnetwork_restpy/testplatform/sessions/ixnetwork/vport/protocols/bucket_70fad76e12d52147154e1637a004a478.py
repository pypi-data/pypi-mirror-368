...
class Bucket(Base):
    ...
    def BucketAction(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.bucketaction_965ab5c99e9b19e16bf56a5314ddc36b.BucketAction): An instance of the BucketAction class
