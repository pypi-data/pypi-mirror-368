...
class IgmpMldRange(Base):
    ...
    def JoinLeaveMulticastGroupRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.joinleavemulticastgrouprange_736d39c4a3d7335aaa18db45a1111dfe.JoinLeaveMulticastGroupRange): An instance of the JoinLeaveMulticastGroupRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.joinleavemulticastgrouprange_736d39c4a3d7335aaa18db45a1111dfe import (
    ...
    def MulticastGroupRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.multicastgrouprange_fb25a02e8dbfec08454389ba3219f312.MulticastGroupRange): An instance of the MulticastGroupRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.multicastgrouprange_fb25a02e8dbfec08454389ba3219f312 import (
            MulticastGroupRange,
        )
