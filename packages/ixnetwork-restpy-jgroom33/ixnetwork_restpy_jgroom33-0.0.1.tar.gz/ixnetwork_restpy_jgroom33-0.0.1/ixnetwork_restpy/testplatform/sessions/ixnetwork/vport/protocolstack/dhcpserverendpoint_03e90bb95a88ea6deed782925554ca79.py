...
class DhcpServerEndpoint(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(DhcpServerEndpoint, self).__init__(parent, list_op)
    ...
    def IgmpQuerier(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.igmpquerier_3adca24bf83e1fdd345ebe777abd5008.IgmpQuerier): An instance of the IgmpQuerier class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.igmpquerier_3adca24bf83e1fdd345ebe777abd5008 import (
            IgmpQuerier,
        )
    ...
    def Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_d5c0ea39818d101c2ff062e575aab5f6.Range): An instance of the Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_d5c0ea39818d101c2ff062e575aab5f6 import (
            Range,
        )
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> DhcpServerEndpoint
    ...
    def DhcpServerClearStats(self, *args, **kwargs):
        ...
        for item in kwargs.items():
            payload[item[0]] = item[1]
        return self._execute(
            "dhcpServerClearStats", payload=payload, response_object=None
        )

    def DhcpServerStart(self, *args, **kwargs):
        # type: (*Any, **Any) -> None
        """Executes the dhcpServerStart operation on the server.

        Start DHCP server for selected plugins

        dhcpServerStart(async_operation=bool)
        -------------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
