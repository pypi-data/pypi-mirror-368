...
class CpIpRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(CpIpRange, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, int, bool, bool, str, str, str, str, str, str, int, str, int) -> CpIpRange
        """Updates cpIpRange resource on the server.
