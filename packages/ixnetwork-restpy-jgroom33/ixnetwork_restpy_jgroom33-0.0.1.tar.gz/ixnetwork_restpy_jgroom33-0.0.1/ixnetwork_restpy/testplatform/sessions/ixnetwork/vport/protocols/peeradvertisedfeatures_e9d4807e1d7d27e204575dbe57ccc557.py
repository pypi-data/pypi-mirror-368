...
class PeerAdvertisedFeatures(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(PeerAdvertisedFeatures, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool) -> PeerAdvertisedFeatures
    ...
    def find(
        ...
        # type: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool) -> PeerAdvertisedFeatures
        """Finds and retrieves peerAdvertisedFeatures resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve peerAdvertisedFeatures resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all peerAdvertisedFeatures resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching peerAdvertisedFeatures resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of peerAdvertisedFeatures data from the server.
        ...
        Returns
        -------
        - self: This instance with the peerAdvertisedFeatures resources from the server available through an iterator or index
