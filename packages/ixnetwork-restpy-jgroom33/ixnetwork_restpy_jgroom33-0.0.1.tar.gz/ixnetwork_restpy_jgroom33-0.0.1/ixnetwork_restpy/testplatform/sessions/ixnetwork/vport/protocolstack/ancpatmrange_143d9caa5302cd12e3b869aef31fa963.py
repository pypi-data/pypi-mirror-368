...
class AncpAtmRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(AncpAtmRange, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (int, bool, str, str, str, int, str) -> AncpAtmRange
        """Updates ancpAtmRange resource on the server.
    ...
    def find(
        ...
        # type: (int, bool, str, str, str, int, str, str) -> AncpAtmRange
        """Finds and retrieves ancpAtmRange resources from the server.
    ...
    def read(self, href):
        """Retrieves a single instance of ancpAtmRange data from the server.
