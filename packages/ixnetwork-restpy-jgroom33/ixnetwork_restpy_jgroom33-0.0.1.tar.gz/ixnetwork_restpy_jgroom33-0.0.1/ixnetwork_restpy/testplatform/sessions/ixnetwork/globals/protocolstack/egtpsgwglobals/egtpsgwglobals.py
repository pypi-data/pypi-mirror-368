...
class EgtpSgwGlobals(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(EgtpSgwGlobals, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, bool, int, int, int, int, int, bool, int, int, str, bool) -> EgtpSgwGlobals
    ...
    def find(
        ...
        # type: (bool, bool, int, int, int, int, int, str, bool, int, int, str, bool) -> EgtpSgwGlobals
