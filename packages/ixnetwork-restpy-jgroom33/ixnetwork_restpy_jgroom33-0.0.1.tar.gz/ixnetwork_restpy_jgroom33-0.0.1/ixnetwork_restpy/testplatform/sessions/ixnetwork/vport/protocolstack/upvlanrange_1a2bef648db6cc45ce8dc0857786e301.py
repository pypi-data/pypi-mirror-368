...
class UpVlanRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(UpVlanRange, self).__init__(parent, list_op)
    ...
    def VlanIdInfo(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_e181ca63fc81123cc3bc668e12c93ce1.VlanIdInfo): An instance of the VlanIdInfo class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_e181ca63fc81123cc3bc668e12c93ce1 import (
            VlanIdInfo,
        )
    ...
    def update(
        ...
        # type: (bool, int, int, int, int, bool, int, int, int, int, str, int, str, int, str, int) -> UpVlanRange
        """Updates upVlanRange resource on the server.
    ...
    def find(
        ...
        # type: (bool, int, int, int, int, bool, int, int, int, int, str, int, str, str, int, str, int) -> UpVlanRange
        """Finds and retrieves upVlanRange resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve upVlanRange resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all upVlanRange resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching upVlanRange resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of upVlanRange data from the server.
        ...
        Returns
        -------
        - self: This instance with the upVlanRange resources from the server available through an iterator or index
