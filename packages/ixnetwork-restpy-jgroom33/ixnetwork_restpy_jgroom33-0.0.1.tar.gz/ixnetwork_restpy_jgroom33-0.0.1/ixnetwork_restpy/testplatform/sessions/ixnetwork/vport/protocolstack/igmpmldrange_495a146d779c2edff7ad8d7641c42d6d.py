...
class IgmpMldRange(Base):
    ...
    def JoinLeaveMulticastGroupRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.joinleavemulticastgrouprange_3cac60f2c24ceccabe4361aebc802ec1.JoinLeaveMulticastGroupRange): An instance of the JoinLeaveMulticastGroupRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.joinleavemulticastgrouprange_3cac60f2c24ceccabe4361aebc802ec1 import (
    ...
    def MulticastGroupRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.multicastgrouprange_6bed97c4d2c300ecb1e1660a488580ae.MulticastGroupRange): An instance of the MulticastGroupRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.multicastgrouprange_6bed97c4d2c300ecb1e1660a488580ae import (
            MulticastGroupRange,
        )
