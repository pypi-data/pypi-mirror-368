...
class SwitchFlowMatchCriteria131TriggerAttributes(Base):
    ...
    def find(
        ...
        By default the find method takes no parameters and will retrieve all switchFlowMatchCriteria131TriggerAttributes resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching switchFlowMatchCriteria131TriggerAttributes resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of switchFlowMatchCriteria131TriggerAttributes data from the server.
        ...
        Returns
        -------
        - self: This instance with the switchFlowMatchCriteria131TriggerAttributes resources from the server available through an iterator or index
