...
class PortStatusMaskMaster(Base):
    ...
    def find(self, PortAdd=None, PortDelete=None, PortModify=None):
        # type: (bool, bool, bool) -> PortStatusMaskMaster
        """Finds and retrieves portStatusMaskMaster resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve portStatusMaskMaster resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all portStatusMaskMaster resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching portStatusMaskMaster resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of portStatusMaskMaster data from the server.
        ...
        Returns
        -------
        - self: This instance with the portStatusMaskMaster resources from the server available through an iterator or index
