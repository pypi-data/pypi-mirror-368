...
class IptvChannelZapping(Base):
    ...
    def PassCriteria(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.passcriteria_2aee0732b4b39a7954484cbeebe7d0b2.PassCriteria): An instance of the PassCriteria class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.passcriteria_2aee0732b4b39a7954484cbeebe7d0b2 import (
            PassCriteria,
        )
    ...
    def Results(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_1e32c8c1705e54282468d0b9b2534af0.Results): An instance of the Results class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_1e32c8c1705e54282468d0b9b2534af0 import (
            Results,
        )
    ...
    def TestConfig(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_1ffc215dd29a0a4a548359d5fc44fcc7.TestConfig): An instance of the TestConfig class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_1ffc215dd29a0a4a548359d5fc44fcc7 import (
            TestConfig,
        )
    ...
    def TrafficSelection(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_45858807eefa78d1672d884e5175f810.TrafficSelection): An instance of the TrafficSelection class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_45858807eefa78d1672d884e5175f810 import (
            TrafficSelection,
        )
