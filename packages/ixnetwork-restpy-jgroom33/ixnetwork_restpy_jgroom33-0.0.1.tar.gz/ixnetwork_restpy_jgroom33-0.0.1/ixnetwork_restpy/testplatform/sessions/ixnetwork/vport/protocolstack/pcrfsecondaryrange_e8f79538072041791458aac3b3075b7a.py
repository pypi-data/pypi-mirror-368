...
class PcrfSecondaryRange(Base):
    ...
    def EgtpSgwRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpsgwrange_a17afcadb647de23d7549f587f45d27e.EgtpSgwRange): An instance of the EgtpSgwRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpsgwrange_a17afcadb647de23d7549f587f45d27e import (
            EgtpSgwRange,
        )
