...
class Igmp(Base):
    ...
    def Host(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.host_0710de542a7934016dc82d18924d1082 import (
            Host,
        )
    ...
    def Querier(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.querier_caaf4682cc5c2a511c8c68d13991790f import (
            Querier,
        )
    ...
    def update(
        ...
        SendLeaveOnHostDisable=None,
        SendLeaveOnStop=None,
        StatsEnabled=None,
        TimePeriod=None,
    ):
    ...
    def find(
        ...
        # type: (bool, bool, int, int, int, str, bool, bool, bool, int) -> Igmp
        """Finds and retrieves igmp resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve igmp resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all igmp resources from the server.
        ...
        - NumberOfQueries (number): Provides a means of throttling the amount of IGMP queries generated by the port.
        - QueryTimePeriod (number): The time, in milliseconds, between queries.
        - RunningState (str(unknown | stopped | stopping | starting | started)): The current running state of the IGMP server.
        - SendLeaveOnHostDisable (bool): Send Leave On Host Disable
        - SendLeaveOnStop (bool): Send leaves on stop (v2 and v3 only).
        - StatsEnabled (bool): If true, this object enables the IGMP statistics.
        - TimePeriod (number): Specifies the length of each time period during which the specified number of IGMP groups will be advertised.
        ...
        Returns
        -------
        - self: This instance with matching igmp resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of igmp data from the server.
        ...
        Returns
        -------
        - self: This instance with the igmp resources from the server available through an iterator or index
