...
class EnbS5S8SecondaryRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(EnbS5S8SecondaryRange, self).__init__(parent, list_op)
    ...
    def EgtpNbS5S8Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpnbs5s8range_774e1af02a04fb9bebdeb4c0ef7ca2f3.EgtpNbS5S8Range): An instance of the EgtpNbS5S8Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.egtpnbs5s8range_774e1af02a04fb9bebdeb4c0ef7ca2f3 import (
            EgtpNbS5S8Range,
        )

        if len(self._object_properties) > 0:
            if self._properties.get("EgtpNbS5S8Range", None) is not None:
