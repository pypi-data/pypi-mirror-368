...
class PassCriteria(Base):
    ...
    def DataErrorThresholdMode(self):
        ...
        Returns
        -------
        - str(average | maximum): The threshold mode for the data error. Possible values include:
        """
    ...
    def LatencyThresholdMode(self):
        ...
        Returns
        -------
        - str(average | maximum): The threshold latency mode value. Possible values include:
        """
    ...
    def LatencyThresholdScale(self):
        ...
        Returns
        -------
        - str(ms | ns | us): The latency threshold scale value. Possible values include:
        """
    ...
    def LatencyVarThresholdMode(self):
        ...
        Returns
        -------
        - str(average | maximum): The latency variation threshold mode value. Possible values include:
        """
    ...
    def LatencyVariationThresholdScale(self):
        ...
        Returns
        -------
        - str(ms | ns | us): The value latency variation threshold scale. Possible values include:
        """
    ...
    def PassCriteriaLoadRateMode(self):
        ...
        Returns
        -------
        - str(average | minimum): The Pass Criteria per trial rate at which the DUT should be able to transmit and receive, expressed as a percentage of the maximum theoretical line speed or in terms of frames per second. Possible values include:
        """
    ...
    def PassCriteriaLoadRateScale(self):
        ...
        Returns
        -------
        - str(fps | gbps | kbps | mbps | percent): The load rate scale for the Pass Criteria per trial. Possible values include:
        """
    ...
    def SeqErrorsThresholdMode(self):
        ...
        Returns
        -------
        - str(average | maximum): The sequence error value for the threshold mode. Possible values include:
        """
