...
class MatchLearnedInfo(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(MatchLearnedInfo, self).__init__(parent, list_op)
    ...
    def add(self):
        """Adds a new matchLearnedInfo resource on the json, only valid with batch add utility

        Returns
        -------
        - self: This instance with all currently retrieved matchLearnedInfo resources using find and the newly added matchLearnedInfo resources available through an iterator or index
    ...
    def find(
        ...
        # type: (str, int, int, str, str, str) -> MatchLearnedInfo
