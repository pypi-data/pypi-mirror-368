...
class Vxlangpe(Base):
    ...
    The Vxlangpe class encapsulates a required vxlangpe resource which will be retrieved from the server every time the property is accessed.
    """
    ...
    def find(self, Count=None, DescriptiveName=None, Name=None, RowNames=None):
        # type: (int, str, str, List[str]) -> Vxlangpe
