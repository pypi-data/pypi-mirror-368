...
class MisdirectedPacketCount(Base):
    """
    The MisdirectedPacketCount class encapsulates a required misdirectedPacketCount resource which will be retrieved from the server every time the property is accessed.
    """

    __slots__ = ()
    _SDM_NAME = "misdirectedPacketCount"
    _SDM_ATT_MAP = {
        "Enable": "enable",
        "Name": "name",
        "Notes": "notes",
    ...
    def __init__(self, parent, list_op=False):
        super(MisdirectedPacketCount, self).__init__(parent, list_op)
    ...
    def update(self, Enable=None, Value=None):
        # type: (bool, int) -> MisdirectedPacketCount
        """Updates misdirectedPacketCount resource on the server.
    ...
    def find(
        ...
        # type: (bool, str, str, str, str, int) -> MisdirectedPacketCount
        """Finds and retrieves misdirectedPacketCount resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve misdirectedPacketCount resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all misdirectedPacketCount resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching misdirectedPacketCount resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of misdirectedPacketCount data from the server.
        ...
        Returns
        -------
        - self: This instance with the misdirectedPacketCount resources from the server available through an iterator or index
