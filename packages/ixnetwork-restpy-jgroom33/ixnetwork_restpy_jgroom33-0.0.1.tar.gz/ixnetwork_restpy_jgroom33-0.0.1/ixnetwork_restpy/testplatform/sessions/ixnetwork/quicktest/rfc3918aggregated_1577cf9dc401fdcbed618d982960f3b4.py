...
class Rfc3918aggregated(Base):
    ...
    def LearnFrames(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.learnframes_8a9f1f61db310def2db3680dcdff9370.LearnFrames): An instance of the LearnFrames class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.learnframes_8a9f1f61db310def2db3680dcdff9370 import (
            LearnFrames,
        )
    ...
    def PassCriteria(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.passcriteria_1776da6e3ffa36ba4c9327b26b0ced2b.PassCriteria): An instance of the PassCriteria class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.passcriteria_1776da6e3ffa36ba4c9327b26b0ced2b import (
            PassCriteria,
        )
    ...
    def Results(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_1ffe3ef3557d91e5aa8474db7887bc5c.Results): An instance of the Results class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_1ffe3ef3557d91e5aa8474db7887bc5c import (
            Results,
        )
    ...
    def TrafficSelection(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_dce49dfe9845499a630256faeb5fc64a.TrafficSelection): An instance of the TrafficSelection class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_dce49dfe9845499a630256faeb5fc64a import (
            TrafficSelection,
        )
