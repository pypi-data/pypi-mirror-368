...
class CpVlanRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(CpVlanRange, self).__init__(parent, list_op)
    ...
    def VlanIdInfo(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_dc7fce96e7255e221d6df0dbf446f71c.VlanIdInfo): An instance of the VlanIdInfo class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanidinfo_dc7fce96e7255e221d6df0dbf446f71c import (
            VlanIdInfo,
        )
    ...
    def update(
        ...
        # type: (bool, int, int, int, int, bool, int, int, int, int, str, int, str, int, str, int) -> CpVlanRange
        """Updates cpVlanRange resource on the server.
    ...
    def find(
        ...
        # type: (bool, int, int, int, int, bool, int, int, int, int, str, int, str, str, int, str, int) -> CpVlanRange
        """Finds and retrieves cpVlanRange resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve cpVlanRange resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all cpVlanRange resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching cpVlanRange resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of cpVlanRange data from the server.
        ...
        Returns
        -------
        - self: This instance with the cpVlanRange resources from the server available through an iterator or index
