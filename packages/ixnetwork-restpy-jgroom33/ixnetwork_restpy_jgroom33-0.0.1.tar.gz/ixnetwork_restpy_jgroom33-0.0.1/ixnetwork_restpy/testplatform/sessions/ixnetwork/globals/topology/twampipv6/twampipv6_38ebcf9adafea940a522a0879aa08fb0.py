...
class TwampIpv6(Base):
    """
    The TwampIpv6 class encapsulates a required twampIpv6 resource which will be retrieved from the server every time the property is accessed.
    """
    ...
    def find(self, Count=None, DescriptiveName=None, Name=None, RowNames=None):
        # type: (int, str, str, List[str]) -> TwampIpv6
