...
class FcFportFwdEndpoint(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(FcFportFwdEndpoint, self).__init__(parent, list_op)
    ...
    def Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_5251d4fee6fd7b476180b66ee4a3a820.Range): An instance of the Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_5251d4fee6fd7b476180b66ee4a3a820 import (
            Range,
        )
    ...
    def SecondaryRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.secondaryrange_7fc8d2489719eb1630e53e48fa7a83b0.SecondaryRange): An instance of the SecondaryRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.secondaryrange_7fc8d2489719eb1630e53e48fa7a83b0 import (
            SecondaryRange,
        )
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> FcFportFwdEndpoint
    ...
    def FcFportStart(self, *args, **kwargs):
        ...
        fcFportStart(async_operation=bool)
        ----------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        fcFportStart(Arg2=enum, async_operation=bool)
        ---------------------------------------------
    ...
    def FcFportStop(self, *args, **kwargs):
        ...
        fcFportStop(async_operation=bool)
        ---------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        fcFportStop(Arg2=enum, async_operation=bool)
        --------------------------------------------
        - Arg2 (str(async | sync)): kArray[kObjref=/vport/protocolStack/fcFportFwdEndpoint,/vport/protocolStack/fcFportFwdEndpoint/range,/vport/protocolStack/fcFportFwdEndpoint/secondaryRange]
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
