...
class DhcpoPppServerEndpoint(Base):
    """Plugin that manages StaticHosts on port.
    The DhcpoPppServerEndpoint class encapsulates a list of dhcpoPppServerEndpoint resources that are managed by the user.
    A list of resources can be retrieved from the server using the DhcpoPppServerEndpoint.find() method.
    The list can be managed by using the DhcpoPppServerEndpoint.add() and DhcpoPppServerEndpoint.remove() methods.
    """

    __slots__ = ()
    _SDM_NAME = "dhcpoPppServerEndpoint"
    _SDM_ATT_MAP = {
        "Name": "name",
        "ObjectId": "objectId",
    }
    ...
    def __init__(self, parent, list_op=False):
        super(DhcpoPppServerEndpoint, self).__init__(parent, list_op)
    ...
    def Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_e3e612b996a0f507e56f66b90ba5768b.Range): An instance of the Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_e3e612b996a0f507e56f66b90ba5768b import (
            Range,
        )
    ...
    def update(self, Name=None):
        # type: (str) -> DhcpoPppServerEndpoint
        """Updates dhcpoPppServerEndpoint resource on the server.
    ...
    def add(self, Name=None):
        # type: (str) -> DhcpoPppServerEndpoint
        """Adds a new dhcpoPppServerEndpoint resource on the server and adds it to the container.
        ...
        Returns
        -------
        - self: This instance with all currently retrieved dhcpoPppServerEndpoint resources using find and the newly added dhcpoPppServerEndpoint resources available through an iterator or index
    ...
    def remove(self):
        """Deletes all the contained dhcpoPppServerEndpoint resources in this instance from the server.
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> DhcpoPppServerEndpoint
        """Finds and retrieves dhcpoPppServerEndpoint resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve dhcpoPppServerEndpoint resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all dhcpoPppServerEndpoint resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching dhcpoPppServerEndpoint resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of dhcpoPppServerEndpoint data from the server.
        ...
        Returns
        -------
        - self: This instance with the dhcpoPppServerEndpoint resources from the server available through an iterator or index
    ...
    def StaticHostsClearStats(self, *args, **kwargs):
        # type: (*Any, **Any) -> None
        """Executes the staticHostsClearStats operation on the server.

        Clear StaticHosts statistics for selected plugins

        staticHostsClearStats(async_operation=bool)
        -------------------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
        ...
        for item in kwargs.items():
            payload[item[0]] = item[1]
        return self._execute(
            "staticHostsClearStats", payload=payload, response_object=None
        )
