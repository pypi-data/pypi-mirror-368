...
class IpRange(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(IpRange, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, int, bool, bool, str, str, str, str, str, str, int, str, int) -> IpRange
        """Updates ipRange resource on the server.
    ...
    def find(
        ...
        # type: (bool, int, bool, bool, str, str, str, str, str, str, int, str, str, int) -> IpRange
        """Finds and retrieves ipRange resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve ipRange resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all ipRange resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching ipRange resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of ipRange data from the server.
        ...
        Returns
        -------
        - self: This instance with the ipRange resources from the server available through an iterator or index
