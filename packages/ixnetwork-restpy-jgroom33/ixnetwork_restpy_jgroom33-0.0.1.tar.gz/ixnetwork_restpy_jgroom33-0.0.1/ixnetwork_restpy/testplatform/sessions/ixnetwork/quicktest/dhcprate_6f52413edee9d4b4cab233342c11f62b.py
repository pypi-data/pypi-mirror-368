...
class DhcpRate(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(DhcpRate, self).__init__(parent, list_op)
    ...
    def Results(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_7cf4ddb82cae25cfc64f10cc5f242bde.Results): An instance of the Results class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_7cf4ddb82cae25cfc64f10cc5f242bde import (
            Results,
        )
    ...
    def TestConfig(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_94598147017a80c5526335a86ac8f41c.TestConfig): An instance of the TestConfig class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_94598147017a80c5526335a86ac8f41c import (
            TestConfig,
        )
