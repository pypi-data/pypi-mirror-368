...
class SwitchPortQueues(Base):
    ...
    def QueueProperty(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.queueproperty_a755ca2d7ba5959c2e5e1aa284875864.QueueProperty): An instance of the QueueProperty class
