...
class AresOneEightHundredGigLanQddC(Base):
    """
    The AresOneEightHundredGigLanQddC class encapsulates a required aresOneEightHundredGigLanQddC resource which will be retrieved from the server every time the property is accessed.
    """

    __slots__ = ()
    _SDM_NAME = "aresOneEightHundredGigLanQddC"
    _SDM_ATT_MAP = {
    ...
    def __init__(self, parent, list_op=False):
        super(AresOneEightHundredGigLanQddC, self).__init__(parent, list_op)
    ...
    def Fcoe(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresoneeighthundredgiglanqddc.fcoe.fcoe.Fcoe): An instance of the Fcoe class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresoneeighthundredgiglanqddc.fcoe.fcoe import (
            Fcoe,
        )
    ...
    def TxLane(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresoneeighthundredgiglanqddc.txlane.txlane.TxLane): An instance of the TxLane class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.l1config.aresoneeighthundredgiglanqddc.txlane.txlane import (
            TxLane,
        )
    ...
    def find(
        ...
        By default the find method takes no parameters and will retrieve all aresOneEightHundredGigLanQddC resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching aresOneEightHundredGigLanQddC resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of aresOneEightHundredGigLanQddC data from the server.
        ...
        Returns
        -------
        - self: This instance with the aresOneEightHundredGigLanQddC resources from the server available through an iterator or index
