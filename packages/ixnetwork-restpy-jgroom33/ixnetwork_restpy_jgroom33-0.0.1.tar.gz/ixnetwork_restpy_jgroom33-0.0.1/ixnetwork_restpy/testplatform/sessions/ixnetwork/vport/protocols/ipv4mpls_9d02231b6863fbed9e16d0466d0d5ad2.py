...
class Ipv4mpls(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(Ipv4mpls, self).__init__(parent, list_op)
    ...
    def add(self):
        """Adds a new ipv4mpls resource on the json, only valid with batch add utility

        Returns
        -------
        - self: This instance with all currently retrieved ipv4mpls resources using find and the newly added ipv4mpls resources available through an iterator or index
    ...
    def find(
        ...
        # type: (str, int, int, bool, str, int, int, int, int, str, str, str, int, str, bool, int) -> Ipv4mpls
