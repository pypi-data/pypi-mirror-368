...
class TrafficItemFilters(Base):
    """Contains list of all the traffic items available which can be enabled for the custom view.
    ...
    def __init__(self, parent, list_op=False):
        super(TrafficItemFilters, self).__init__(parent, list_op)
    ...
    def RxPorts(self):
        ...
        """
        return self._get_attribute(self._SDM_ATT_MAP["RxPorts"])

    def update(self, Enabled=None):
        # type: (bool) -> TrafficItemFilters
        """Updates trafficItemFilters resource on the server.
    ...
    def add(self, Enabled=None):
        # type: (bool) -> TrafficItemFilters
        """Adds a new trafficItemFilters resource on the json, only valid with batch add utility
    ...
    def find(self, Enabled=None, Name=None, RxPorts=None):
        # type: (bool, str, List[str]) -> TrafficItemFilters
        """Finds and retrieves trafficItemFilters resources from the server.
    ...
    def read(self, href):
        """Retrieves a single instance of trafficItemFilters data from the server.
