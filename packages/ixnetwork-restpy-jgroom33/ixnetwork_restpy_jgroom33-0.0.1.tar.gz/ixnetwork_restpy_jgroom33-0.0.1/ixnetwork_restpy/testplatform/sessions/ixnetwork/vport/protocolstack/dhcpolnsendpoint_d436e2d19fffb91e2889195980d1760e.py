...
class DhcpoLnsEndpoint(Base):
    """Plugin that manages StaticHosts on port.
    The DhcpoLnsEndpoint class encapsulates a list of dhcpoLnsEndpoint resources that are managed by the user.
    A list of resources can be retrieved from the server using the DhcpoLnsEndpoint.find() method.
    The list can be managed by using the DhcpoLnsEndpoint.add() and DhcpoLnsEndpoint.remove() methods.
    """

    __slots__ = ()
    _SDM_NAME = "dhcpoLnsEndpoint"
    _SDM_ATT_MAP = {
        "Name": "name",
        "ObjectId": "objectId",
    }
    ...
    def __init__(self, parent, list_op=False):
        super(DhcpoLnsEndpoint, self).__init__(parent, list_op)
    ...
    def Range(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_e59851be16b3aa8c14c7fa65e4557e23.Range): An instance of the Range class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.range_e59851be16b3aa8c14c7fa65e4557e23 import (
            Range,
        )
    ...
    def update(self, Name=None):
        # type: (str) -> DhcpoLnsEndpoint
        """Updates dhcpoLnsEndpoint resource on the server.
    ...
    def add(self, Name=None):
        # type: (str) -> DhcpoLnsEndpoint
        """Adds a new dhcpoLnsEndpoint resource on the server and adds it to the container.
        ...
        Returns
        -------
        - self: This instance with all currently retrieved dhcpoLnsEndpoint resources using find and the newly added dhcpoLnsEndpoint resources available through an iterator or index
    ...
    def remove(self):
        """Deletes all the contained dhcpoLnsEndpoint resources in this instance from the server.
    ...
    def find(self, Name=None, ObjectId=None):
        # type: (str, str) -> DhcpoLnsEndpoint
        """Finds and retrieves dhcpoLnsEndpoint resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve dhcpoLnsEndpoint resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all dhcpoLnsEndpoint resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching dhcpoLnsEndpoint resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of dhcpoLnsEndpoint data from the server.
        ...
        Returns
        -------
        - self: This instance with the dhcpoLnsEndpoint resources from the server available through an iterator or index
