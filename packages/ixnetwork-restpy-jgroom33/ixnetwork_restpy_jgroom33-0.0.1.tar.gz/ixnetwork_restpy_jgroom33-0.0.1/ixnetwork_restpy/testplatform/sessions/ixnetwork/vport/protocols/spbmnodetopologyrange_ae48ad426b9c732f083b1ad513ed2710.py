...
class SpbmNodeTopologyRange(Base):
    ...
    def SpbmNodeBaseVidRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocols.spbmnodebasevidrange_85f95f8cdb0a1237fbe8b8d83aa8f732.SpbmNodeBaseVidRange): An instance of the SpbmNodeBaseVidRange class
