...
class Range(Base):
    ...
    def FcClientFdiscRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.fcclientfdiscrange_4f65e1cb0736d0e25d41722411f1696d.FcClientFdiscRange): An instance of the FcClientFdiscRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.fcclientfdiscrange_4f65e1cb0736d0e25d41722411f1696d import (
            FcClientFdiscRange,
        )
    ...
    def FcClientFlogiRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.fcclientflogirange_769b8cb65653ef5dc38dd106c278385d.FcClientFlogiRange): An instance of the FcClientFlogiRange class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.fcclientflogirange_769b8cb65653ef5dc38dd106c278385d import (
            FcClientFlogiRange,
        )
