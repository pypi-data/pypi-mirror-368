...
class Range(Base):
    ...
    def Dot1xRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.dot1xrange_9d93800659991ecd0718356349feeb3f.Dot1xRange): An instance of the Dot1xRange class
    ...
    def EsmcRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.esmcrange_66e439c6dcc766717e9e3d164bc3e4af.EsmcRange): An instance of the EsmcRange class
    ...
    def EvbStationRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.evbstationrange_c3efa4df889be0d6eec25995cf561ab5.EvbStationRange): An instance of the EvbStationRange class
    ...
    def MacRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.macrange_630ea614574822d48519dd27394ba9b8.MacRange): An instance of the MacRange class
    ...
    def PtpRangeOverMac(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.ptprangeovermac_b960b3f225ceaa1801af467293b96db5.PtpRangeOverMac): An instance of the PtpRangeOverMac class
    ...
    def VicClientRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vicclientrange_4bd197e2978c6824cffa38aac838d6c4.VicClientRange): An instance of the VicClientRange class
    ...
    def VlanRange(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.vport.protocolstack.vlanrange_918ebbe7f8f44713fbb623d4b0d7c829.VlanRange): An instance of the VlanRange class
    ...
    def ApplyOnTheFly(self, *args, **kwargs):
        ...
        applyOnTheFly(async_operation=bool)
        -----------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
    ...
    def RevertOnTheFly(self, *args, **kwargs):
        ...
        revertOnTheFly(async_operation=bool)
        ------------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
    ...
    def VepaStart(self, *args, **kwargs):
        ...
        vepaStart(async_operation=bool)
        -------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        vepaStart(Arg2=enum, async_operation=bool)
        ------------------------------------------
    ...
    def VepaStop(self, *args, **kwargs):
        ...
        vepaStop(async_operation=bool)
        ------------------------------
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.

        vepaStop(Arg2=enum, async_operation=bool)
        -----------------------------------------
        - Arg2 (str(async | sync)): kArray[kObjref=/vport/protocolStack/ethernet/vepaEndpoint,/vport/protocolStack/ethernet/vepaEndpoint/range]
        - async_operation (bool=False): True to execute the operation asynchronously. Any subsequent rest api calls made through the Connection class will block until the operation is complete.
