...
class OpenFlowTableCapacity(Base):
    ...
    def PassCriteria(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.passcriteria_4224acf5d8a4be0ca7879c532ce0a408.PassCriteria): An instance of the PassCriteria class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.passcriteria_4224acf5d8a4be0ca7879c532ce0a408 import (
            PassCriteria,
        )
    ...
    def Results(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_e206b3c25fa7659bcd9b7e839eb69288.Results): An instance of the Results class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_e206b3c25fa7659bcd9b7e839eb69288 import (
            Results,
        )
    ...
    def TestConfig(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_9f27c4c121a6415dba2b4e09edba31df.TestConfig): An instance of the TestConfig class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_9f27c4c121a6415dba2b4e09edba31df import (
            TestConfig,
        )
    ...
    def TrafficSelection(self):
        ...
        Returns
        -------
        - obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_5fc8c338cdb89d2e5bd73f6001b4e882.TrafficSelection): An instance of the TrafficSelection class

        Raises
        ------
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.trafficselection_5fc8c338cdb89d2e5bd73f6001b4e882 import (
            TrafficSelection,
        )
