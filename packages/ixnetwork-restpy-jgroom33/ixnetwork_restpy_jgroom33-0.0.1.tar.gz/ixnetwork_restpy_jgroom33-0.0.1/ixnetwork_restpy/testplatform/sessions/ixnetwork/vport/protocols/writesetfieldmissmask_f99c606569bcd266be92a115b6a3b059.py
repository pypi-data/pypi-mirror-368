...
class WriteSetFieldMissMask(Base):
    ...
    def find(
        ...
        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve writeSetFieldMissMask resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all writeSetFieldMissMask resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching writeSetFieldMissMask resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of writeSetFieldMissMask data from the server.
        ...
        Returns
        -------
        - self: This instance with the writeSetFieldMissMask resources from the server available through an iterator or index
