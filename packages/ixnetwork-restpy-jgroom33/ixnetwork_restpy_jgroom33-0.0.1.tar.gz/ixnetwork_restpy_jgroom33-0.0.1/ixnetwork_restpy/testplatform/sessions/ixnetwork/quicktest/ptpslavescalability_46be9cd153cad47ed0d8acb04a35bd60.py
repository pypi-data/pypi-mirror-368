...
class PtpSlaveScalability(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(PtpSlaveScalability, self).__init__(parent, list_op)
    ...
    def Results(self):
        ...
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.results_0b5ef62e8bd5c3fd75d3098b4d67d2bc import (
            Results,
        )
    ...
    def TestConfig(self):
        ...
        - ServerError: The server has encountered an uncategorized error condition
        """
        from ixnetwork_restpy.testplatform.sessions.ixnetwork.quicktest.testconfig_aa011dabd812f199bc41a4603fac6cde import (
            TestConfig,
        )
    ...
    def update(
        ...
        # type: (bool, str, str, str) -> PtpSlaveScalability
