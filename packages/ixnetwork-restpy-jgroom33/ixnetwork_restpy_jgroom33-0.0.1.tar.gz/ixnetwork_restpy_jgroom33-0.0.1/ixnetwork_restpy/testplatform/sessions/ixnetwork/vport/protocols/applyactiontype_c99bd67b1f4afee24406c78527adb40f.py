...
class ApplyActionType(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(ApplyActionType, self).__init__(parent, list_op)
    ...
    def update(
        ...
        # type: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool) -> ApplyActionType
    ...
    def find(
        ...
        # type: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, bool) -> ApplyActionType
        """Finds and retrieves applyActionType resources from the server.

        All named parameters are evaluated on the server using regex. The named parameters can be used to selectively retrieve applyActionType resources from the server.
        To retrieve an exact match ensure the parameter value starts with ^ and ends with $
        By default the find method takes no parameters and will retrieve all applyActionType resources from the server.
        ...
        Returns
        -------
        - self: This instance with matching applyActionType resources retrieved from the server available through an iterator or index
    ...
    def read(self, href):
        """Retrieves a single instance of applyActionType data from the server.
        ...
        Returns
        -------
        - self: This instance with the applyActionType resources from the server available through an iterator or index
