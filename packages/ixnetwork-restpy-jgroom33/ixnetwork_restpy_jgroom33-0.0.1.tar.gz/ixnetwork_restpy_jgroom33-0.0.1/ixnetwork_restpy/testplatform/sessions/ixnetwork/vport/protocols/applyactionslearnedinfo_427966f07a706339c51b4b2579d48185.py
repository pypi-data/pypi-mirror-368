...
class ApplyActionsLearnedInfo(Base):
    ...
    def __init__(self, parent, list_op=False):
        super(ApplyActionsLearnedInfo, self).__init__(parent, list_op)
    ...
    def add(self):
        """Adds a new applyActionsLearnedInfo resource on the json, only valid with batch add utility
    ...
    def find(
        ...
        # type: (str, int, int, str, str, str) -> ApplyActionsLearnedInfo
