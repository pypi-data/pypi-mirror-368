...
class DMTLearn:
    ...
    def fit(self, dm):
        ...
        if self.save_ckpt_path is not None:
            ...
            lightning_save_ckpt_callback = pl.callbacks.ModelCheckpoint(
                dirpath=os.path.dirname(self.save_ckpt_path),
        ...
        self.trainer.fit(self.model, dm, callbacks=callbacks)
